var ca=Object.defineProperty;var We=(t,e)=>()=>(t&&(e=t(t=0)),e);var Ye=(t,e)=>{for(var r in e)ca(t,r,{get:e[r],enumerable:!0})};var ye={};Ye(ye,{API:()=>ht,CLIENT_SIDE_MAX_ROWS:()=>De,IS_DEVELOPMENT:()=>Xe,apiFetch:()=>v,clearToken:()=>Be,getToken:()=>Ie,getUser:()=>ge,setToken:()=>Ze,setUser:()=>Pe});function Ie(){return localStorage.getItem("fm_token")}function Ze(t){localStorage.setItem("fm_token",t)}function Be(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function ge(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Pe(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function v(t,e={}){let r=Ie(),a={"Content-Type":"application/json",...r?{Authorization:`Bearer ${r}`}:{},...e.headers||{}};try{let l=t;l.startsWith("/api/")&&!l.startsWith("/api/v1/")&&(l="/api/v1/"+l.substring(5));let o=`cb=${Date.now()}`,i=l.includes("?")?"&":"?",c=`${ht}${l}${i}${o}`,n=await fetch(c,{...e,headers:a}),s;try{let m=await n.text();try{s=JSON.parse(m)}catch{s={error:`Server Error (${n.status}): ${m.substring(0,80)}...`}}}catch{s={error:"Gagal membaca respon dari server"}}return n.status===401&&(Be(),window.location.hash="#/login"),{ok:n.ok,status:n.status,data:s}}catch(l){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${l.message})`}}}}var Xe,da,ht,De,B=We(()=>{Xe=!1,da="https://fm-operations-api.facilitycare-audydental.workers.dev",ht=da,De=1e4});var vt={};Ye(vt,{confirmDialog:()=>tt,createModal:()=>le});function le({title:t,content:e,onConfirm:r,onCancel:a,confirmText:l="Simpan",cancelText:o="Batal",size:i="md",confirmClass:c="btn-primary"}){let n={sm:"400px",md:"560px",lg:"720px",xl:"900px"},s=document.createElement("div");s.className="modal-overlay",s.innerHTML=`
  ...
  `}var A=We(()=>{});B();var et={},qe=null;function M(t,e){et[t]=e}function fe(t){window.location.hash=t}function yt(){async function t(){let e=window.location.hash.replace("#","")||"/dashboard",[r,...a]=e.split("?"),l=et[r];if(!l){for(let[i,c]of Object.entries(et))if(i.endsWith("/*")&&r.startsWith(i.slice(0,-2))){l=c;break}}qe&&(qe(),qe=null);let o=document.getElementById("main-content");if(o&&(o.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),l){let i=new URLSearchParams(a.join("?")),c=r.split("/").filter(Boolean),n=await l({path:r,params:i,segments:c,main:o});n&&(qe=n)}else{let i=o||document.getElementById("app");i&&(i.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",t),t()}var Le;function pa(){return Le||(Le=document.createElement("div"),Le.id="toast-container",document.body.appendChild(Le)),Le}function ft(t,e="info",r=3500){let a=pa(),l=document.createElement("div");l.className=`toast toast-${e}`;let o={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};l.innerHTML=`<span class="toast-icon">${o[e]||"\u2139"}</span><span class="toast-msg">${t}</span>`,a.appendChild(l),requestAnimationFrame(()=>l.classList.add("show")),setTimeout(()=>{l.classList.remove("show"),setTimeout(()=>l.remove(),350)},r)}var V=t=>ft(t,"success"),Y=t=>ft(t,"error");Ae();B();B();function kt({columns:t,data:e,onEdit:r,onDelete:a,onView:l,actions:o=[],emptyText:i="Tidak ada data",bulkSelect:c=null}){let n=document.createElement("div");if(n.className="table-wrapper",!e||e.length===0)return n.innerHTML=`<div class="empty-state"><p>${i}</p></div>`,n;let s=document.createElement("table");s.className="data-table";let m=document.createElement("thead"),d=document.createElement("tr");if(c){let u=document.createElement("th");u.style.width="40px",u.style.textAlign="center";let h=document.createElement("input");h.type="checkbox",h.id="select-all-checkbox",h.title="Pilih semua",h.addEventListener("change",()=>{e.forEach(b=>{h.checked?c.selectedIds.add(b.id):c.selectedIds.delete(b.id)}),n.querySelectorAll(".row-checkbox").forEach(b=>b.checked=h.checked),c.onToggle()}),u.appendChild(h),d.appendChild(u)}if(t.forEach(u=>{let h=document.createElement("th");h.textContent=u.label,u.width&&(h.style.width=u.width),d.appendChild(h)}),r||a||l||o.length>0){let u=document.createElement("th");u.textContent="Aksi",u.style.width="120px",d.appendChild(u)}m.appendChild(d),s.appendChild(m);let p=document.createElement("tbody");return e.forEach(u=>{let h=document.createElement("tr");if(c){let b=document.createElement("td");b.style.textAlign="center",b.style.width="40px";let g=document.createElement("input");g.type="checkbox",g.className="row-checkbox",g.value=u.id,g.checked=c.selectedIds.has(u.id),g.addEventListener("change",()=>{if(g.checked)c.selectedIds.add(u.id);else{c.selectedIds.delete(u.id);let y=document.getElementById("select-all-checkbox");y&&(y.checked=!1)}c.onToggle()}),b.appendChild(g),h.appendChild(b)}if(t.forEach(b=>{let g=document.createElement("td");if(b.render){let y=b.render(u[b.key],u);y instanceof HTMLElement?g.appendChild(y):g.innerHTML=y||""}else g.textContent=u[b.key]!==null&&u[b.key]!==void 0&&u[b.key]!==""?u[b.key]:"";b.nowrap&&(g.style.whiteSpace="nowrap"),h.appendChild(g)}),r||a||l||o.length>0){let b=document.createElement("td");b.className="actions-cell";let g=document.createElement("div");if(g.className="btn-group",l){let y=document.createElement("button");y.className="btn btn-xs btn-ghost",y.innerHTML="\u{1F441}",y.title="Lihat",y.addEventListener("click",()=>l(u)),g.appendChild(y)}if(r){let y=document.createElement("button");y.className="btn btn-xs btn-secondary",y.innerHTML="\u270F\uFE0F",y.title="Edit",y.addEventListener("click",()=>r(u)),g.appendChild(y)}o.forEach(y=>{let k=document.createElement("button");k.className=`btn btn-xs ${y.class||"btn-ghost"}`,k.innerHTML=y.icon||y.label,k.title=y.label,k.addEventListener("click",()=>y.handler(u)),g.appendChild(k)}),b.appendChild(g),h.appendChild(b)}p.appendChild(h)}),s.appendChild(p),n.appendChild(s),n}function St({page:t,pages:e,total:r,limit:a,onPage:l}){if(e<=1)return null;let o=document.createElement("div");o.className="pagination";let i=document.createElement("span");i.className="pagination-info",i.textContent=`Total: ${r} data`,o.appendChild(i);let c=document.createElement("div");c.className="pagination-btns";let n=(d,p,u=!1,h=!1)=>{let b=document.createElement("button");b.className=`btn btn-sm ${h?"btn-primary":"btn-ghost"} pagination-btn`,b.textContent=d,b.disabled=u,b.addEventListener("click",()=>l(p)),c.appendChild(b)};n("\xAB",1,t===1),n("\u2039",t-1,t===1);let s=Math.max(1,t-2),m=Math.min(e,t+2);for(let d=s;d<=m;d++)n(d,d,!1,d===t);return n("\u203A",t+1,t===e),n("\xBB",e,t===e),o.appendChild(c),o}Ae();function at(t){return t.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="html")return e.html||"";if(e.type==="row")return`<div class="form-row">${at(e.fields)}</div>`;let r=e.required?"required":"",a=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",l="";switch(e.type){case"textarea":l=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${r} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let i=(e.options||[]).map(d=>{let p=typeof d=="object"?d.value:d,u=typeof d=="object"?d.label:d,h=e.value==p?"selected":"";return`<option value="${p}" ${h}>${u}</option>`}).join("");l=`<select name="${e.name}" class="form-control" ${r}><option value="">-- Pilih ${e.label||""} --</option>${i}</select>`;break;case"combobox":let c=`dl-${e.name}-${Math.random().toString(36).substring(7)}`,n=(e.options||[]).map(d=>{let p=typeof d=="object"?d.value:d,u=typeof d=="object"?d.label||d.value||"":d||"";return(u==="undefined"||u==="[object Object]"||u==="null")&&(u=""),u?`<option value="${u}"></option>`:""}).join(""),s=e.value||"";if(e.value){let d=(e.options||[]).find(p=>(typeof p=="object"?p.value:p)==e.value);if(d){let p=typeof d=="object"?d.label||d.value||"":d||"";p&&p!=="undefined"&&p!=="[object Object]"&&p!=="null"&&(s=p)}}l=`
    ...
    <div class="filter-bar card">
      <div class="filter-bar-inner">
        ${i.map(x=>x.type==="search"?`<div class="filter-search"><input type="search" class="form-control" placeholder="${x.placeholder||"Cari..."}" id="filter-search" value="${_.search||""}"></div>`:x.type==="select"||x.type==="combobox"?`<select class="form-control filter-select" name="${x.name}" id="filter-${x.name}"><option value="">-- ${x.label} --</option>${(x.options||[]).map(w=>`<option value="${typeof w=="object"?w.value:w}" ${_[x.name]===(typeof w=="object"?w.value:w)?"selected":""}>${typeof w=="object"?w.label:w}</option>`).join("")}</select>`:"").join("")}
  ...
  `;function L(){if(!document.getElementById("bulk-toolbar"))return;let w=document.getElementById("bulk-count"),I=document.getElementById("btn-bulk-delete"),G=document.getElementById("btn-bulk-cancel");w.textContent=`${T.size} item dipilih`,T.size>0?(I.disabled=!1,G.disabled=!1):(I.disabled=!0,G.disabled=!0);let J=document.getElementById("select-all-checkbox");if(J){let X=document.querySelectorAll(".row-checkbox");if(X.length>0){let O=[...X].every(ue=>ue.checked),j=[...X].some(ue=>ue.checked);J.checked=O,J.indeterminate=j&&!O}else J.checked=!1,J.indeterminate=!1}}document.getElementById("btn-bulk-cancel")?.addEventListener("click",()=>{T.clear(),document.querySelectorAll(".row-checkbox").forEach(w=>w.checked=!1);let x=document.getElementById("select-all-checkbox");x&&(x.checked=!1),L()}),document.getElementById("btn-bulk-delete")?.addEventListener("click",()=>{if(T.size===0)return;let x=[...T],w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9999;display:flex;align-items:center;justify-content:center",w.innerHTML=`
    ...
    `,document.body.appendChild(w),w.querySelector("#bulk-cancel-btn").addEventListener("click",()=>w.remove()),w.querySelector("#bulk-confirm-btn").addEventListener("click",async()=>{let I=w.querySelector("#bulk-confirm-btn");I.disabled=!0,I.textContent="Menghapus...";let G=await v(`${a}/bulk`,{method:"DELETE",body:JSON.stringify({ids:x})});w.remove(),G.ok?(V(`${x.length} ${n} berhasil dihapus.`),T.clear(),L(),be(a),D()):Y(G.data?.error||"Gagal menghapus data.")})});let C=document.getElementById("filter-search"),K;if(C?.addEventListener("input",x=>{clearTimeout(K),K=setTimeout(()=>{_.search=x.target.value,S=1,T.clear(),L(),D()},400)}),i?.forEach(x=>{(x.type==="select"||x.type==="combobox")&&document.getElementById(`filter-${x.name}`)?.addEventListener("change",w=>{_[x.name]=w.target.value,S=1,T.clear(),L(),D()})}),document.getElementById("btn-reset-filter")?.addEventListener("click",()=>{_={},C&&(C.value=""),i?.forEach(x=>{let w=document.getElementById(`filter-${x.name}`);w&&(w.value="")}),S=1,T.clear(),L(),D()}),document.getElementById("btn-create")?.addEventListener("click",()=>U(null)),y){document.getElementById(`btn-export-${y.moduleName}`)?.addEventListener("click",async w=>{let I=w.target,G=I.innerHTML;I.innerHTML="\u23F3 Loading...",I.disabled=!0;try{await y.onExport()}catch{Y("Gagal export data")}finally{I.innerHTML=G,I.disabled=!1}}),document.getElementById(`btn-template-${y.moduleName}`)?.addEventListener("click",()=>{y.onTemplate()});let x=document.getElementById(`input-import-${y.moduleName}`);x?.addEventListener("change",async w=>{let I=w.target.files[0];if(!I)return;let G=document.getElementById(`label-import-${y.moduleName}`),J=G?G.querySelector(".import-text"):null,X=J?J.innerText:"";J&&(J.innerText="\u231B Memproses..."),G&&(G.style.pointerEvents="none"),x.disabled=!0;try{let O=await nt(I);if(O.length===0)throw new Error("File kosong atau format salah");await y.onImport(O),V("Import berhasil!"),be(a),D()}catch(O){Y(O.message||"Gagal import data")}finally{J&&(J.innerText=X),G&&(G.style.pointerEvents="auto"),x.disabled=!1,x.value=""}})}async function D(){L();let x=document.getElementById("table-container");if(!x)return;x.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';let w=f==="client",I=w?1:S,G=w?De:20,J=new URLSearchParams({page:I,limit:G,...Object.fromEntries(Object.entries(_).filter(([,W])=>W))}),X=await v(`${a}?${J}`);if(!X.ok){x.innerHTML=`<div class="empty-state"><p class="text-danger">Gagal memuat data: ${X.data?.error||"Error"}</p></div>`;return}let O=X.data?.data||X.data||[],j=X.data?.pagination,ue=O.length;if(w){O=h(O);let W=O.length,te=20,pe=Math.ceil(W/te);S>pe&&pe>0&&(S=pe);let z=(S-1)*te,he=S*te;O=O.slice(z,he),j={page:S,limit:te,total:W,pages:pe}}!1,u&&u(O);let Re=kt({columns:l,data:O,onEdit:m?W=>U(W):null,actions:b.map(W=>({...W,handler:te=>W.handler(te,D)})),emptyText:`Tidak ada ${String(n||"").toLowerCase()}`,bulkSelect:k?{selectedIds:T,onToggle:L}:null});x.innerHTML="",x.appendChild(Re);let Ee=document.getElementById("pagination-container");if(Ee&&(Ee.innerHTML="",j&&j.pages>1)){let W=St({page:j.page,pages:j.pages,total:j.total,limit:j.limit,onPage:te=>{S=te,D()}});W&&Ee.appendChild(W)}}function N(x){let w=typeof o=="function"?o(x):o;return at(w)}function U(x){let w=!!x,I=document.createElement("form");if(I.noValidate=!0,I.innerHTML=N(x),w){let J=typeof o=="function"?o(x):o;_t(I,x)}let{close:G}=le({title:w?`Edit ${n}`:`Tambah ${n}`,content:I,size:"lg",confirmText:w?"Simpan Perubahan":`Tambah ${n}`,onConfirm:async(J,X)=>{if(!I.reportValidity())return;let O=J.querySelector(".modal-confirm");O.disabled=!0,O.textContent="Menyimpan...";let j=wt(I),ue=typeof o=="function"?o(x):o,Re=async pe=>{for(let z of pe)if(z.type==="row")await Re(z.fields);else if(z.type==="combobox"&&j[z.name]){let he=j[z.name],je=(z.options||[]).find(re=>{let me=String(typeof re=="object"?re.value:re),la=String(typeof re=="object"?re.label:re);return me===he||la===he});if(je)j[z.name]=typeof je=="object"?je.value:je;else if(z.createApi){let re={};re[z.createApi.field]=he,z.createApi.extra&&Object.assign(re,z.createApi.extra);let me=await v(z.createApi.path,{method:"POST",body:JSON.stringify(re)});if(me.ok&&me.data?.id)j[z.name]=me.data.id;else if(me.ok&&!me.data?.id)j[z.name]=he;else throw new Error(`Gagal membuat master data: ${me.data?.error||"Unknown error"}`)}}};try{await Re(ue)}catch(pe){Y(pe.message),O.disabled=!1,O.textContent=w?"Simpan Perubahan":`Tambah ${n}`;return}p&&(j=await p(j,x));let Ee=w?"PUT":"POST",W=w?`${a}/${x.id}`:a,te=await v(W,{method:Ee,body:JSON.stringify(j)});te.ok?(V(w?`${n} berhasil diperbarui.`:`${n} berhasil ditambahkan.`),X(),be(a),D()):(Y(te.data?.error||"Gagal menyimpan data."),O.disabled=!1,O.textContent=w?"Simpan Perubahan":`Tambah ${n}`)}})}function ee(x){tt(`Hapus ${n} ini? Tindakan tidak dapat dibatalkan.`,async()=>{let w=await v(`${a}/${x.id}`,{method:"DELETE"});w.ok?(V(`${n} berhasil dihapus.`),be(a),D()):Y(w.data?.error||"Gagal menghapus.")},`Hapus ${n}`)}return D(),D}B();B();var ve=null,He=null;async function ke(t=!1){if(ve&&!t)return console.log("Employees Raw (Cache Hit)",ve.slice(0,5)),ve;let e=await v(`/api/employees?limit=${De}&status=Aktif`);return ve=(e.data?.data||[]).map(r=>({value:r.id,label:r.full_name})),console.log("Employees Raw",e.data?.data?.slice(0,5)),console.log("Employees Mapped (ID)",ve.slice(0,5)),ve}async function q(t=!1){let r=(await ke(t)).map(a=>({value:a.label,label:a.label}));return console.log("Employee Options",r.slice(0,5)),r}async function P(t=!1){return He&&!t||(He=((await v("/api/branches?all=1")).data?.data||[]).map(r=>({value:r.id,label:r.full_name}))),He}function F(t){let e={Done:"badge-success",Aktif:"badge-success",Open:"badge-warning","In Progress":"badge-info",Pending:"badge-warning",Diproses:"badge-info",Selesai:"badge-success","Tidak Aktif":"badge-neutral",Resign:"badge-neutral",Cut:"badge-danger","Tidak Datang":"badge-danger"};return!t||t==="-"||String(t).trim()===""?"":`<span class="badge ${e[t]||"badge-neutral"}">${t}</span>`}function rt(t){return t==null?'<span class="badge badge-neutral">-</span>':t<0?`<span class="badge badge-danger">Expired (${Math.abs(t)}h)</span>`:t<=14?`<span class="badge badge-danger">${t} hari</span>`:t<=30?`<span class="badge badge-warning">${t} hari</span>`:`<span class="badge badge-success">${t} hari</span>`}function Se(t){return`<span class="badge ${{"FACILITY CARE":"badge-info",SECURITY:"badge-secondary"}[t]||"badge-neutral"}">${t||"-"}</span>`}function st(t){return`<span class="badge ${{"Inspeksi Hygiene & Aset Bangunan":"badge-info","General Cleaning":"badge-success","Deep Cleaning":"badge-purple",Fogging:"badge-warning"}[t]||"badge-neutral"}">${t||"-"}</span>`}function ae(t){return`<span class="badge ${{Q1:"badge-info",Q2:"badge-success",Q3:"badge-warning",Q4:"badge-danger"}[t]||"badge-neutral"}">${t||"-"}</span>`}A();function ot(t,e){if(t.period!=="Q3")return!1;let r=String(t.status||"").toLowerCase();if(r!=="selesai"&&r!=="completed"&&r!=="done")return!1;let a=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?a.includes("inspeksi"):e==="gcdc"?a.includes("general cleaning")||a.includes("deep cleaning"):!1}B();A();function xt(t,e){let r=String(t.status||"").toLowerCase();return e==="active"?r==="aktif":!1}B();A();function lt(t,e){if(String(t.status||"").toLowerCase()!=="aktif")return!1;if(e==="active")return!0;if(e==="expiring30"){if(!t.end_date)return!1;let a=new Date;a.setHours(0,0,0,0);let l=new Date(a);l.setDate(a.getDate()+30);let o=new Date(t.end_date);return o.setHours(0,0,0,0),o>=a&&o<=l}return!1}B();A();function Ct(t,e){let r=String(t.status||"").toLowerCase();return e==="open"?r==="open":!1}B();function Tt(t,e){let r=String(t.status||"").toLowerCase();return e==="pending"?r==="pending":!1}var de={};function xe(t){if(de[t]){try{de[t].destroy()}catch{}delete de[t]}}function ua(){Object.keys(de).forEach(xe)}var se=(t,e=0)=>{let r=Number(t);return isNaN(r)||t===null||t===void 0?e:r},we=(t,e="\u2014")=>{if(t==null||t==="")return e;let r=String(t).trim();return r===""||r==="[object Object]"?e:r};function Et(t,e,r=900){if(!t)return;let a=Math.max(0,Math.round(se(e)));if(a===0){t.textContent="0";return}let l=Date.now(),o=()=>{let i=Math.min((Date.now()-l)/r,1),c=1-Math.pow(1-i,3);t.textContent=Math.round(c*a).toLocaleString("id-ID"),i<1?requestAnimationFrame(o):t.textContent=a.toLocaleString("id-ID")};requestAnimationFrame(o)}var ga={Done:"pill-success",Aktif:"pill-success",Selesai:"pill-success",Open:"pill-danger",Pending:"pill-warning","In Progress":"pill-info","Tidak Aktif":"pill-neutral",Resign:"pill-neutral",Cut:"pill-neutral"},ba=t=>{let e=we(t,"\u2014");return`<span class="status-pill ${ga[e]||"pill-neutral"}">${e}</span>`};var ne={family:"Inter",size:11},oe="#94A3B8",_e="#F1F5F9",ct=["#2563EB","#10B981","#F59E0B","#EF4444","#8B5CF6","#0EA5E9","#F97316","#14B8A6","#6366F1","#EC4899"],ha=()=>window.innerWidth<768;function Je(t={}){return{responsive:!0,maintainAspectRatio:!1,animation:{duration:700,easing:"easeOutQuart"},plugins:{legend:{position:ha()?"bottom":"top",labels:{font:ne,color:"#64748B",usePointStyle:!0,padding:10,boxWidth:8,boxHeight:8}},tooltip:{mode:"index",intersect:!1,bodyFont:ne,titleFont:{...ne,weight:"700"}}},scales:{x:{grid:{color:_e},ticks:{font:ne,color:oe,maxRotation:0}},y:{grid:{color:_e},ticks:{font:ne,color:oe},beginAtZero:!0}},...t}}var ya=()=>Array(5).fill(0).map(()=>`
  ...
  </div>`).join("");function $t(t=3){return Array(t).fill(0).map((e,r)=>`<div class="skeleton skeleton-text" style="height:38px;margin-bottom:${r<t-1?"6px":"0"};border-radius:6px"></div>`).join("")}async function Q(t,e,r=8e3){try{let a=new AbortController,l=setTimeout(()=>a.abort(),r),o=await v(t,{signal:a.signal}).catch(()=>null);if(clearTimeout(l),!o||!o.ok)return e;let i=o.data;return i?i.data!==void 0?i.data??e:i:e}catch{return e}}function va(){["skel-donut","skel-trend","skel-insp","skel-contract","skel-jadwal"].forEach(a=>{let l=document.getElementById(a);l&&(l.style.display="none")}),["chart-donut","chart-trend","chart-insp","chart-contract","chart-jadwal"].forEach(a=>{let l=document.getElementById(a);if(l&&l.style.display==="none"){l.style.display="block";let o=l.parentElement;if(o&&!o.querySelector(".chart-empty")){let i=document.createElement("div");i.className="chart-empty",i.textContent="Belum ada data",l.style.display="none",o.appendChild(i)}}});let t=document.getElementById("kpi-row");t&&t.querySelector(".skeleton")&&It({});let e=document.getElementById("mini-stats-row");e&&e.querySelector(".skeleton")&&Bt({}),["table-contracts","table-issues"].forEach(a=>{let l=document.getElementById(a);l&&l.querySelector(".skeleton")&&(l.innerHTML='<div class="chart-empty">Belum ada data</div>')});let r=document.getElementById("activity-log");r&&r.querySelector(".skeleton")&&(r.innerHTML='<div class="chart-empty">Belum ada aktivitas</div>')}async function Dt(t){ua(),t._dashRefresh&&clearInterval(t._dashRefresh),t._skelTimeout&&clearTimeout(t._skelTimeout);let e=new Date().toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});t.innerHTML=`
    <div class="dashboard-wrap" id="dash-root">
      ...
      <div class="bottom-row" style="margin-top:24px;">
        ...
        <div class="chart-card">
          ...
          <div id="widget-agenda" class="dash-table-wrap" style="height:160px;overflow-y:auto;overflow-x:hidden">${$t(3)}</div>
        </div>
        ...
        <div class="chart-card">
          ...
          <div id="table-issues" class="dash-table-wrap" style="height:160px;overflow-y:auto">${$t(3)}</div>
        </div>
        <!-- Kontrak Akan Habis -->
        <div class="chart-card">
          <div class="chart-card-header">
  ...
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>dt(t)),document.getElementById("filter-jadwal-year")?.addEventListener("change",async r=>{let a=r.target.value,l=document.getElementById("jadwal-year-label");l&&(l.textContent=a);let o=document.getElementById("skel-jadwal"),i=document.getElementById("chart-jadwal");o&&(o.style.display="block",o.style.position="absolute"),i&&(i.style.display="none");let c=await Q(`/api/dashboard/schedule-chart?year=${a}`,{},8e3);try{Pt(c)}catch(n){console.warn("ScheduleChart render:",n),ie("skel-jadwal","chart-jadwal")}}),document.getElementById("filter-insp-month")?.addEventListener("change",async r=>{let a=r.target.value,l=a?`/api/dashboard/inspection-bar?month=${a}`:"/api/dashboard/inspection-bar",o=document.getElementById("skel-insp"),i=document.getElementById("chart-insp");o&&(o.style.display="block",o.style.position="absolute"),i&&(i.style.display="none");let c=await Q(l,{},8e3);try{Lt(c)}catch(n){console.warn("InspBar render:",n),ie("skel-insp","chart-insp")}}),t._skelTimeout=setTimeout(()=>va(),5e3),await dt(t),t._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?dt(t):clearInterval(t._dashRefresh)},6e4)}async function dt(t){t._skelTimeout&&(clearTimeout(t._skelTimeout),t._skelTimeout=null);let[e,r,a,l,o,i,c,n,s,m,d,p,u,h]=await Promise.all([Q("/api/dashboard/kpi",{},8e3),Q("/api/dashboard/issues-trend",{},8e3),Q("/api/dashboard/issues-summary",{},8e3),Q("/api/dashboard/stats",{},8e3),Q("/api/dashboard/calendar",[],8e3),Q("/api/schedule?limit=10000",{data:[]},8e3),Q("/api/employees?limit=10000",{data:[]},8e3),Q("/api/contracts?limit=10000",{data:[]},8e3),Q("/api/issues?limit=10000",{data:[]},8e3),Q("/api/one-on-one?limit=10000",{data:[]},8e3),Q("/api/dashboard/contracts-chart",{labels:[],data:[]},8e3),Q(`/api/dashboard/schedule-chart?year=${document.getElementById("filter-jadwal-year")?.value||new Date().getFullYear()}`,{},8e3),Q("/api/relievers?limit=10000",{data:[]},8e3),Q("/api/reports/fogging?limit=10000",{data:[]},8e3)]),b=document.getElementById("filter-insp-month"),g=b?b.value:"",y=g?`/api/dashboard/inspection-bar?month=${g}`:"/api/dashboard/inspection-bar",k=await Q(y,{},8e3);if(e){let f=Array.isArray(i?.data)?i.data:Array.isArray(i)?i:[];window.dashboardSchedules=f;let S=Array.isArray(c?.data)?c.data:Array.isArray(c)?c:[],_=Array.isArray(n?.data)?n.data:Array.isArray(n)?n:[],T=Array.isArray(s?.data)?s.data:Array.isArray(s)?s:[],L=Array.isArray(m?.data)?m.data:Array.isArray(m)?m:[],C=Array.isArray(u?.data)?u.data:Array.isArray(u)?u:[];window.dashboardRelievers=C;let K=Array.isArray(h?.data)?h.data:Array.isArray(h)?h:[];window.dashboardFogging=K,e.employees&&(e.employees.current=S.filter(D=>xt(D,"active")).length),e.contracts&&(e.contracts.current=_.filter(D=>lt(D,"active")).length),e.expiring30&&(e.expiring30={current:_.filter(D=>lt(D,"expiring30")).length}),e.issues&&(e.issues.current=T.filter(D=>Ct(D,"open")).length),e.one_on_one&&(e.one_on_one.current=L.filter(D=>Tt(D,"pending")).length),e.inspection_month&&(e.inspection_month.current=f.filter(D=>ot(D,"inspeksi")).length),e.cleaning_month&&(e.cleaning_month.current=f.filter(D=>ot(D,"gcdc")).length)}try{It(e)}catch(f){console.warn("KPI render:",f)}try{Bt(e)}catch(f){console.warn("MiniStats render:",f)}try{Pt(p)}catch(f){console.warn("ScheduleChart render:",f),ie("skel-jadwal","chart-jadwal")}try{ka(Array.isArray(a?.by_category)?a.by_category:[])}catch(f){console.warn("Donut render:",f),ie("skel-donut","chart-donut")}try{Sa(r)}catch(f){console.warn("Trend render:",f),ie("skel-trend","chart-trend")}try{Lt(k)}catch(f){console.warn("InspBar render:",f),ie("skel-insp","chart-insp")}try{let f=Array.isArray(l)?l:Array.isArray(l?.recent_issues)?l.recent_issues:[];_a(f)}catch(f){console.warn("IssuesTable render:",f)}try{let f=Array.isArray(l?.expiring_contracts)?l.expiring_contracts:[];wa(d)}catch(f){console.warn("ContractsTable render:",f)}try{xa(Array.isArray(o)?o:[])}catch(f){console.warn("Agenda render:",f)}try{Ca()}catch(f){console.warn("Quick Actions render:",f)}}function It(t){let e=document.getElementById("kpi-row");if(!e)return;t=t||{};let r=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees?dash_filter=active",color:"kpi-blue",key:"employees",trendPct:"+2%",trendColor:"#10B981",points:"0,20 10,18 20,22 30,12 40,15 50,8 60,10 70,5 80,6 90,2 100,0"},{icon:"\u{1F504}",label:"Reliefer Aktif",sub:"Karyawan reliefer",href:"#/employees?dash_filter=reliefer",color:"kpi-purple",key:"reliever_total",trendPct:"0%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts?dash_filter=active",color:"kpi-green",key:"contracts",trendPct:"+1%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u23F3",label:"Kontrak Habis 30 Hari",sub:"Akan segera berakhir",href:"#/contracts?dash_filter=expiring30",color:"kpi-warn",key:"expiring30",trendPct:"+25%",trendColor:"#F59E0B",points:"0,25 20,22 40,24 60,15 80,18 100,5"},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues?dash_filter=open",color:"kpi-red",key:"issues",trendPct:"0%",trendColor:"#EF4444",points:"0,20 20,18 40,22 60,19 80,21 100,20"},{icon:"\u{1F4AC}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one?dash_filter=pending",color:"kpi-purple",key:"one_on_one",trendPct:"+8%",trendColor:"#10B981",points:"0,25 20,15 40,18 60,8 80,10 100,2"}];e.innerHTML=r.map(a=>{let l=se(t[a.key]?.current,0);return`
      ...
      </a>`}).join(""),e.querySelectorAll(".kpi-value").forEach(a=>{Et(a,parseInt(a.dataset.target)||0)})}function Bt(t){let e=document.getElementById("mini-stats-row");if(!e)return;t=t||{};let r=`Q${Math.ceil((new Date().getMonth()+1)/3)}`,a=new Date().getFullYear(),l=String(new Date().getMonth()+1).padStart(2,"0"),o=`${a}-${l}`,i=d=>`
  ...
  `,c=[{id:"mini-jadwal",icon:"\u{1F4C5}",label:"Jadwal",dropdown:`
    ...
    <a href="${d.href}" class="mini-stat ${d.color}" style="text-decoration:none" id="${d.id||""}">
      ...
      <div class="mini-stat-body" style="flex:1; min-width:0; overflow:visible;">
        <div style="display:flex; align-items:baseline; gap:3px;">
          <div class="mini-stat-value" data-target="${se(d.val)}">0</div>
          ${d.dropdown?d.dropdown:""}
        </div>
        <div class="mini-stat-text">${d.label}</div>
      </div>
    </a>`).join(""),e.querySelectorAll(".mini-stat-value").forEach(d=>Et(d,parseInt(d.dataset.target)||0,700));let n=document.getElementById("dash-jadwal-period");n&&n.addEventListener("change",d=>{let p=d.target.value,u=(window.dashboardSchedules||[]).filter(g=>g.period===p).length,h=document.querySelector("#mini-jadwal .mini-stat-value");h&&(h.dataset.target=u,h.textContent=u);let b=document.getElementById("mini-jadwal");b&&(b.href=`#/timeline?dash_filter=period_${p.toLowerCase()}`)});let s=(d,p,u,h,b)=>{let g=document.getElementById(d);if(g){let y=k=>{let f=(u||[]).filter(T=>h(T,k)).length,S=document.querySelector(`#${p} .mini-stat-value`);S&&(S.dataset.target=f,S.textContent=f);let _=document.getElementById(p);_&&(_.href=`${b}&month=${k}`)};y(g.value),g.addEventListener("change",k=>y(k.target.value))}},m=d=>{let p=String(d.status||"").toLowerCase();return p==="done"||p==="selesai"||p==="completed"};s("dash-reliefer-month","mini-reliefer",window.dashboardRelievers,(d,p)=>window.parseFlexibleDate(d.backup_date).startsWith(p)&&m(d),"#/relievers?dash_filter=reliever"),s("dash-inspeksi-month","mini-inspeksi",window.dashboardSchedules,(d,p)=>d.activity_type==="Inspeksi Hygiene"&&m(d)&&window.parseFlexibleDate(d.completion_date||d.target_date).startsWith(p),"#/timeline?dash_filter=inspeksi"),s("dash-gcdc-month","mini-gcdc",window.dashboardSchedules,(d,p)=>(d.activity_type==="General Cleaning"||d.activity_type==="Deep Cleaning")&&m(d)&&window.parseFlexibleDate(d.completion_date||d.target_date).startsWith(p),"#/timeline?dash_filter=gcdc"),s("dash-fogging-month","mini-fogging",window.dashboardFogging,(d,p)=>m(d)&&window.parseFlexibleDate(d.activity_date).startsWith(p),"#/reports/fogging?dash_filter=fogging")}function ka(t){ie("skel-donut","chart-donut");let e=document.getElementById("chart-donut"),r=document.getElementById("donut-legend");if(!e||!r)return;xe("donut");let a=(t||[]).filter(n=>se(n.count)>0);if(!a.length){Fe(e,"Belum ada data permasalahan");return}let l=a.map(n=>`${we(n.category,"Lainnya")}`),o=a.map(n=>se(n.count)),i=o.reduce((n,s)=>n+s,0);r.innerHTML=a.map((n,s)=>{let m=ct[s%ct.length],d=i>0?Math.round(n.count/i*100):0;return`
    ...
    `}).join("");let c={id:"centerText",beforeDraw:function(n){let s=n.width,m=n.height,d=n.ctx;d.restore();let p=(m/80).toFixed(2);d.font="bold "+p+"em Inter",d.textBaseline="middle",d.fillStyle="#1E293B";let u=i.toString(),h=Math.round((s-d.measureText(u).width)/2),b=m/2;d.fillText(u,h,b-4),d.font="600 "+(p*.35).toFixed(2)+"em Inter",d.fillStyle="#64748B";let g="Total",y=Math.round((s-d.measureText(g).width)/2);d.fillText(g,y,b+10),d.save()}};de.donut=new Chart(e,{type:"doughnut",data:{labels:l,datasets:[{data:o,backgroundColor:ct,borderWidth:2,borderColor:"#fff",hoverBorderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,animation:{duration:700},plugins:{legend:{display:!1},tooltip:{bodyFont:ne,titleFont:{...ne,weight:"700"},callbacks:{label:n=>` ${n.label}: ${n.parsed} kasus`}}},cutout:"75%"},plugins:[c]})}function Sa(t){ie("skel-trend","chart-trend");let e=document.getElementById("chart-trend");if(!e)return;xe("trend"),t=t||{};let r=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],a=(t.labels||[]).map(i=>{if(!i||typeof i!="string")return"";try{let[c,n]=i.split("-");return(r[Number(n)-1]||n)+" "+String(c).slice(-2)}catch{return i}}),l=(t.open||[]).map(i=>se(i)),o=(t.closed||[]).map(i=>se(i));if(!a.length){Fe(e,"Belum ada data trend");return}de.trend=new Chart(e,{type:"line",data:{labels:a,datasets:[{label:"Open",data:l,borderColor:"#EF4444",backgroundColor:"rgba(239,68,68,.08)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#EF4444",borderWidth:2},{label:"Closed",data:o,borderColor:"#10B981",backgroundColor:"rgba(16,185,129,.1)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#10B981",borderWidth:2}]},options:Je({plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{family:"Inter",size:9},color:oe,maxRotation:0,autoSkip:!1}},y:{grid:{color:_e},ticks:{font:{family:"Inter",size:9},color:oe},beginAtZero:!0}}})})}function Pt(t){ie("skel-jadwal","chart-jadwal");let e=document.getElementById("chart-jadwal");if(!e)return;xe("jadwal"),t=t||{};let r=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"];if(!Object.values(t).some(n=>Array.isArray(n)&&n.some(s=>s>0))){Fe(e,"Belum ada data jadwal");return}let l=t["Inspeksi Hygiene"]||Array(12).fill(0),o=t["General Cleaning"]||Array(12).fill(0),i=t["Deep Cleaning"]||Array(12).fill(0),c=t.Fogging||Array(12).fill(0);de.jadwal=new Chart(e,{type:"bar",data:{labels:r,datasets:[{label:"Inspeksi",data:l,backgroundColor:"#3B82F6"},{label:"General Cleaning",data:o,backgroundColor:"#10B981"},{label:"Deep Cleaning",data:i,backgroundColor:"#F59E0B"},{label:"Fogging",data:c,backgroundColor:"#EF4444"}]},options:Je({plugins:{legend:{display:!1}},datasets:{bar:{barPercentage:.85,categoryPercentage:.9}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{family:"Inter",size:9},color:oe,maxRotation:0,autoSkip:!1}},y:{stacked:!0,grid:{color:_e},ticks:{font:{family:"Inter",size:9},color:oe},min:0}}})})}function Lt(t){ie("skel-insp","chart-insp");let e=document.getElementById("chart-insp");if(!e)return;xe("inspBar"),t=t||{};let r=t.labels||[],a=(t.fc||[]).map(o=>se(o)),l=(t.spv||[]).map(o=>se(o));if(!r.length){Fe(e,"Belum ada data inspeksi");return}de.inspBar=new Chart(e,{type:"bar",data:{labels:r,datasets:[{label:"Skor FC",data:a,backgroundColor:"rgba(37,99,235,.75)",borderRadius:4,borderSkipped:!1},{label:"Skor SPV",data:l,backgroundColor:"rgba(16,185,129,.75)",borderRadius:4,borderSkipped:!1}]},options:Je({plugins:{legend:{position:"top"}},scales:{x:{grid:{display:!1},ticks:{font:ne,color:oe,maxRotation:45,minRotation:30}},y:{grid:{color:_e},ticks:{font:ne,color:oe},min:0,max:100}}})})}function wa(t){ie("skel-contract-mini","chart-contract-mini");let e=document.getElementById("chart-contract-mini");if(!e)return;xe("contractMiniBar"),t=t||{};let r={"06":"Jun","07":"Jul","08":"Agu","09":"Sep",10:"Okt",11:"Nov",12:"Des"},a=(t.labels||[]).map(i=>{let c=i.split("-")[1];return r[c]||i}),l=(t.data||[]).map(i=>se(i));if(!a.length){Fe(e,"Belum ada data");return}let o=e.getContext("2d");de.contractMiniBar=new Chart(e,{type:"bar",data:{labels:a,datasets:[{label:"Kontrak Habis",data:l,backgroundColor:"#3B82F6",borderRadius:4,borderSkipped:!1,barPercentage:.6,categoryPercentage:.7}]},options:Je({onClick:(i,c)=>{if(c&&c.length>0){let n=c[0].index,s=(t.labels||[])[n];s&&(window.location.hash="#/contracts?month_expiry="+s)}},plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:ne,color:oe,maxRotation:0,autoSkip:!1}},y:{grid:{color:_e,borderDash:[4,4],drawBorder:!1},ticks:{font:ne,color:oe,precision:0,maxTicksLimit:5},min:0}},animation:{y:{duration:1e3,easing:"easeOutQuart"}}})})}function _a(t){let e=document.getElementById("table-issues");if(!e)return;let r=(t||[]).slice(0,8);if(!r.length){e.innerHTML='<div class="chart-empty">\u2705 Tidak ada permasalahan terbuka</div>';return}e.innerHTML=`
    <div class="dash-list">
      ${r.map(a=>`
        <div class="dash-list-item">
          <div style="flex-shrink:0">${ba(a.status)}</div>
          <div style="flex:1;min-width:0;margin-left:4px">
            <div style="font-size:0.85rem;font-weight:700;color:var(--text-1);display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden;line-height:1.3">${we(a.complaint)}</div>
            <div style="font-size:0.75rem;color:var(--text-3);margin-top:2px">${we(a.branch_name)}</div>
          </div>
        </div>
      `).join("")}
    </div>`}function xa(t){let e=document.getElementById("widget-agenda");if(!e)return;let r=new Date,a=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}-${String(r.getDate()).padStart(2,"0")}`,o=(t||[]).filter(i=>(i.event_date||"").startsWith(a)).slice(0,10);if(!o.length){e.innerHTML="";return}e.innerHTML=`
    <div style="display:flex;flex-direction:column;gap:12px;padding-right:8px">
      ${o.map(i=>{let c="#3B82F6",n="#EFF6FF",s="Agenda",m=(i.title||"").toLowerCase();return m.includes("inspeksi")?(c="#10B981",n="#ECFDF5",s="Inspeksi"):m.includes("cleaning")||m.includes("gcdc")?(c="#3B82F6",n="#EFF6FF",s="Cleaning"):m.includes("reliefer")?(c="#F59E0B",n="#FFFBEB",s="Reliefer"):m.includes("fogging")&&(c="#8B5CF6",n="#F5F3FF",s="Fogging"),`
        <div style="display:flex;gap:12px;align-items:flex-start;padding-bottom:12px;border-bottom:1px solid var(--border)">
          ...
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;font-size:0.85rem;color:var(--text-1);line-height:1.2;margin:0 0 4px 0">${we(i.title)}</div>
            <div style="font-size:0.75rem;color:var(--text-3);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${we(i.branch_name)}</div>
          </div>
  ...
  `).join("")}function ie(t,e){let r=document.getElementById(t),a=document.getElementById(e);if(r&&(r.style.display="none",r.style.position=""),a){a.style.display="block";let l=a.parentElement;if(l){let o=l.querySelector(".chart-empty");o&&o.remove()}}}function Fe(t,e="Belum ada data"){if(!t)return;t.style.display="none";let r=t.parentElement;if(!r)return;if(!r.querySelector(".chart-empty")){let l=document.createElement("div");l.className="chart-empty",l.textContent=e,r.appendChild(l)}}B();async function At(t){document.getElementById("app").innerHTML=`
  ...
  `;let e=document.getElementById("login-form"),r=document.getElementById("login-error"),a=document.getElementById("login-btn"),l=document.getElementById("toggle-password"),o=document.getElementById("login-password");l?.addEventListener("click",()=>{let i=o.type==="text";o.type=i?"password":"text",l.style.color=i?"":"var(--primary)"}),e?.addEventListener("submit",async i=>{i.preventDefault(),r.style.display="none";let c=e.username.value.trim(),n=e.password.value;if(!c||!n){r.textContent="Username dan password wajib diisi.",r.style.display="block";return}a.querySelector(".btn-text").style.display="none",a.querySelector(".btn-spinner").style.display="",a.disabled=!0;try{let s=await v("/api/auth/login",{method:"POST",body:JSON.stringify({username:c,password:n})});s.ok&&s.data.success?(Ze(s.data.data.token),Pe(s.data.data.user),V("Login berhasil! Selamat datang \u{1F44B}"),window.dispatchEvent(new Event("fm:login"))):(r.textContent=s.data.error||"Username atau password salah.",r.style.display="block",a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),600))}catch{r.textContent="Gagal terhubung ke server. Periksa koneksi internet.",r.style.display="block"}finally{a.querySelector(".btn-text").style.display="",a.querySelector(".btn-spinner").style.display="none",a.disabled=!1}})}B();A();async function Ta(){return await P()}async function Nt(t,e){let r=e?e.get("dash_filter"):null,a=await Ta();$({container:t,title:"Karyawan",icon:"\u{1F465}",apiPath:"/api/employees",itemLabel:"Karyawan",bulkDelete:!0,paginationMode:"client",defaultFilters:{status:r==="active"?"Aktif":""},onDataLoaded:o=>o,columns:[{key:"full_name",label:"Nama Lengkap"},{key:"branch_name",label:"Cabang"},{key:"division",label:"Divisi",render:o=>Se(o)},{key:"phone",label:"No. HP",render:o=>o?`<a href="tel:${o}">${o}</a>`:"-"},{key:"join_date",label:"Tgl Masuk",render:o=>window.formatDate(o)},{key:"status",label:"Status",render:o=>F(o)}],filterFields:[{type:"search",placeholder:"Cari nama karyawan..."},{type:"combobox",name:"branch_id",label:"Cabang",options:a},{type:"select",name:"division",label:"Divisi",options:["FACILITY CARE","SECURITY"]},{type:"select",name:"status",label:"Status",options:["Aktif","Tidak Aktif","Resign","Cut"]}],formFields:o=>[{type:"row",fields:[{name:"full_name",label:"Nama Lengkap",required:!0,placeholder:"Nama lengkap karyawan",value:o?.full_name},{name:"phone",label:"No. HP",placeholder:"08xx-xxxx-xxxx",value:o?.phone}]},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",options:a,value:o?.branch_id},{name:"division",label:"Divisi",type:"select",required:!0,options:["FACILITY CARE","SECURITY"],value:o?.division||"FACILITY CARE"}]},{type:"row",fields:[{name:"join_date",label:"Tanggal Masuk",type:"date",value:o?.join_date},{name:"status",label:"Status",type:"select",required:!0,options:["Aktif","Tidak Aktif","Resign","Cut"],value:o?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:o?.notes}],exportOptions:{moduleName:"employees",onExport:async()=>{let o=await v(`/api/employees${window.location.search?window.location.search+"&":"?"}limit=10000`);if(o.ok){let i=o.data.data.map(c=>({"Nama Lengkap":c.full_name,Cabang:c.branch_name||"",Divisi:c.division||"","No. HP":c.phone||"","Tgl Masuk":c.join_date||"",Status:c.status||""}));E(i,"Data_Karyawan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{"Nama Lengkap":"Budi Santoso",Cabang:"001. Pondok Bambu",Divisi:"FACILITY CARE","No. HP":"08123456789","Tgl Masuk":"2024-01-15",Status:"Aktif"},{"Nama Lengkap":"Andi Saputra",Cabang:"002. Bintaro",Divisi:"SECURITY","No. HP":"08987654321","Tgl Masuk":"2023-11-01",Status:"Aktif"}],"Template_Import_Karyawan")},onImport:async o=>{let i=s=>{if(!s)return null;let m=String(s||"").toLowerCase(),d=a.find(p=>String(p.label||"").toLowerCase()===m);return d?d.value:null},c=o.map(s=>({full_name:String(s["Nama Lengkap"]||"").trim(),branch_id:i(String(s.Cabang||"").trim()),division:String(s.Divisi||"").trim()||"FACILITY CARE",phone:String(s["No. HP"]||"").trim(),join_date:String(s["Tgl Masuk"]||"").trim(),status:String(s.Status||"").trim(),notes:String(s.Catatan||"").trim()})).filter(s=>s.full_name),n=await v("/api/employees/import",{method:"POST",body:JSON.stringify(c)});if(!n.ok)throw new Error(n.data?.error||"Import gagal")}}})}B();A();var mt=[],Ft=[];async function $a(){mt=await P(),Ft=await ke()}var pt=async t=>{let e=[],r=1;for(;;){let l=await(await Promise.resolve().then(()=>(B(),ye))).apiFetch(`${t}${t.includes("?")?"&":"?"}limit=100&page=${r}`);if(!l.ok)break;let o=l.data?.data||l.data||[],i=Array.isArray(o)?o:[];if(e=e.concat(i),i.length<100||l.data?.pagination&&r>=l.data.pagination.pages)break;r++}return e};async function Ue(t,e){await $a(),$({container:t,title:"Data Kontrak",icon:"\u{1F4CB}",apiPath:"/api/contracts",bulkDelete:!0,itemLabel:"Kontrak",paginationMode:"client",defaultFilters:{},onDataLoaded:a=>a,columns:[{key:"employee_name",label:"Nama Lengkap"},{key:"branch_name",label:"Cabang"},{key:"division",label:"Div / Bagian",render:a=>Se(a)},{key:"start_date",label:"Tanggal Mulai",nowrap:!0,render:a=>window.formatDate(a)},{key:"end_date",label:"Tanggal Selesai",nowrap:!0,render:a=>!a||String(a).startsWith("2099")?"Tetap / PKWTT":window.formatDate(a)},{key:"days_remaining",label:"Sisa Kontrak",render:(a,l)=>l.end_date&&String(l.end_date).startsWith("2099")?'<span class="badge badge-success" style="background:#10B981;color:white;padding:4px 8px;border-radius:6px;font-size:0.75rem;font-weight:600">Tetap</span>':rt(a)},{key:"status",label:"Status",render:a=>F(a)}],filterFields:[{type:"search",placeholder:"Cari nama karyawan..."},{type:"combobox",name:"branch_id",label:"Cabang",options:mt},{type:"select",name:"status",label:"Status",options:["Aktif","Tidak Aktif","Resign","Cut"]},{type:"select",name:"expiring_days",label:"Akan Habis",options:[{value:"7",label:"7 Hari"},{value:"14",label:"14 Hari"},{value:"30",label:"30 Hari"},{value:"60",label:"60 Hari"}]}],onBeforeSubmit:a=>(a.end_date||(a.end_date="2099-12-31"),a),onAfterLoad:()=>{if(!document.getElementById("btn-find-missing")){let a=document.createElement("button");a.id="btn-find-missing",a.className="btn btn-ghost",a.innerHTML="\u{1F50D} Cek Selisih Karyawan",a.style.marginLeft="8px",a.style.color="#EF4444",a.style.border="1px solid currentColor",a.onclick=async()=>{a.innerHTML="\u231B Mencari...",a.disabled=!0;try{let[o,i]=await Promise.all([pt("/api/employees?status=Aktif"),pt("/api/contracts")]);if(o.length>0){let c=i.filter(d=>d.status==="Aktif"),n=new Set(c.map(d=>d.employee_id)),s=o.filter(d=>!n.has(d.id)),m=`<p style="margin-bottom:12px">Data yang terbaca: <b>${o.length}</b> Karyawan Aktif, dan <b>${c.length}</b> Kontrak Aktif.</p>
              <p style="margin-bottom:12px">Terdapat <b>${s.length}</b> karyawan aktif yang tidak memiliki "Kontrak Aktif". Berikut daftarnya:</p><ul style="padding-left:20px; max-height:400px; overflow-y:auto">`;s.forEach(d=>{let p=i.filter(h=>h.employee_id===d.id),u='<span style="color:#F59E0B">Belum pernah di-input kontrak</span>';if(p.length>0){let h=p[0];u=`Pernah ada kontrak (Status: <b style="color:#EF4444">${h.status}</b>, Selesai: ${window.formatDate(h.end_date)})`}m+=`<li style="margin-bottom:8px"><b>${d.full_name}</b> <br><span style="font-size:0.85em;color:var(--text-2)">Cabang: ${d.branch_name||"-"} | ${u}</span></li>`}),m+="</ul>",Promise.resolve().then(()=>(Ae(),vt)).then(d=>d.createModal({title:"Karyawan Tanpa Kontrak Aktif",content:m,cancelText:"Tutup"}))}}catch(o){console.error(o)}a.innerHTML="\u{1F50D} Cek Selisih Karyawan",a.disabled=!1};let l=document.querySelector(".page-actions");l&&l.appendChild(a)}},formFields:a=>[{type:"row",fields:[{name:"employee_id",label:"Nama Lengkap",type:"combobox",required:!0,options:Ft,value:a?.employee_id},{name:"branch_id",label:"Cabang",type:"combobox",options:mt,value:a?.branch_id}]},{type:"row",fields:[{name:"division",label:"Div / Bagian",type:"select",required:!0,options:["FACILITY CARE","SECURITY"],value:a?.division||"FACILITY CARE"},{name:"status",label:"Status",type:"select",required:!0,options:["Aktif","Tidak Aktif","Resign","Cut"],value:a?.status||""}]},{type:"row",fields:[{name:"start_date",label:"Tanggal Mulai",type:"date",value:a?.start_date},{name:"end_date",label:"Tanggal Selesai",type:"date",value:a?.end_date&&!String(a.end_date).startsWith("2099")?a.end_date:""}]},{type:"row",fields:[{name:"contract_type",label:"Tipe Kontrak",type:"select",options:["KONTRAK 6 BULAN","KONTRAK 1 TAHUN","KONTRAK 2 TAHUN"],value:a?.contract_type},{name:"pkwt_number",label:"No. PKWT",type:"select",options:["PKWT 1","PKWT 2","PKWT 3","PKWT 4","PKWT 5","PKWT 6"],value:a?.pkwt_number}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:a?.notes}],exportOptions:{moduleName:"contracts",onExport:async()=>{let a=await v(`/api/contracts${window.location.search?window.location.search+"&":"?"}limit=10000`);if(a.ok){let l=a.data.data.map(o=>({"Nama Lengkap":o.employee_name,Cabang:o.branch_name||"","Div / Bagian":o.division||"","Tanggal Mulai":o.start_date||"","Tanggal Selesai":o.end_date&&String(o.end_date).startsWith("2099")?"":o.end_date||"","Sisa Kontrak":o.end_date&&String(o.end_date).startsWith("2099")?"Tetap":o.days_remaining!==null&&o.days_remaining!==void 0?`${o.days_remaining} Hari`:"",Status:o.status||""}));E(l,"Data_Kontrak")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{"Nama Lengkap":"Budi Santoso",Cabang:"001. Pondok Bambu","Div / Bagian":"FACILITY CARE","Tanggal Mulai":"2024-01-01","Tanggal Selesai":"2024-12-31","Sisa Kontrak":"365 Hari",Status:"Aktif"}],"Template_Import_Kontrak")},onImport:async a=>{let[l,o]=await Promise.all([v("/api/branches?limit=10000"),pt("/api/employees")]),i=l.data?.data||[],c=o||[];console.log(`Total employee yang berhasil dimuat dari database : ${c.length}`),c.length>0&&(console.log("Contoh 5 employee pertama:"),c.slice(0,5).forEach((g,y)=>{console.log(`${y+1}. ID: ${g.id}, Name: ${g.full_name}, Status: ${g.status}`)}));let n=g=>{if(!g)return null;let y=String(g||"").replace(/\s+/g," ").toLowerCase().trim(),k=i.find(f=>String(f.full_name||"").replace(/\s+/g," ").toLowerCase().trim()===y||String(f.code||"").replace(/\s+/g," ").toLowerCase().trim()===y||String(f.name||"").replace(/\s+/g," ").toLowerCase().trim()===y);return k?k.id:null},s=(g,y)=>{if(console.log("------------------------------------------------"),console.log(`Row Excel : ${y}`),console.log(`Nama dari Excel : "${g}"`),!g)return console.log("Alasan gagal mapping : Nama kosong"),null;let k=String(g||"").replace(/\s+/g," ").toLowerCase().trim();console.log(`Nama setelah normalisasi : "${k}"`),console.log(`Jumlah employee di database : ${c.length}`);let f=c.find(S=>String(S.full_name||"").replace(/\s+/g," ").toLowerCase().trim()===k);return f?(console.log("Employee ditemukan atau tidak : Ditemukan"),console.log(`Employee ID jika ditemukan : ${f.id}`),f.id):(console.log("Employee ditemukan atau tidak : TIDAK Ditemukan"),console.log("Alasan gagal mapping : Tidak ada kecocokan full_name setelah normalisasi"),null)},m=g=>{if(!g)return"";if(g instanceof Date&&!isNaN(g.getTime()))return g.toISOString().slice(0,10);let y=String(g).trim();if(/^\d{4,5}(\.\d+)?$/.test(y)){let f=Math.floor(Number(y));if(f>2e4&&f<99999){let S=new Date(Date.UTC(1899,11,30)+f*864e5);return isNaN(S.getTime())?"":S.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(y))return y.slice(0,10);let k=y.split(/[\/\-\.]/);if(k.length===3){let[f,S,_]=k.map(T=>T.trim());if(f.length===4&&S.length<=2&&_.length<=2)return`${f}-${S.padStart(2,"0")}-${_.padStart(2,"0")}`;if(_.length===4&&S.length<=2&&f.length<=2)return`${_}-${S.padStart(2,"0")}-${f.padStart(2,"0")}`}return y},d=a.map((g,y)=>{let k=y+2,f=String(g["Nama Lengkap"]||"").trim(),S=g["Tanggal Mulai"],_=m(S);if(!_){let C=a.__worksheet,K=a.__headers||[],D=K.indexOf("Tanggal Mulai"),N="N/A",U="N/A",ee="N/A";if(D!==-1&&C&&window.XLSX){let w=window.XLSX.utils.encode_cell({c:D,r:k-1});ee=w;let I=C[w];I?(N=I.t||"undefined",U=I.w||"undefined"):N="CELL KOSONG/TIDAK ADA DI WORKSHEET"}let x="Unknown";S==null||S===""?x="Kondisi IF: Nilai murni undefined, null, atau string kosong dari parsed JSON.":S instanceof Date&&isNaN(S.getTime())?x="Kondisi IF: Nilai adalah object Date namun invalid (isNaN).":x="Kondisi IF: Tidak lolos Regex YYYY-MM-DD maupun konversi serial number Excel.",console.log("=========================="),console.log("[DEBUG] DATE PARSING FAILED"),console.log("=========================="),console.log(`Excel Row Number : ${k}`),console.log(`Employee Name : ${f}`),console.log(`Column Header Used : "Tanggal Mulai" (Index: ${D})`),console.log(`Raw Cell Value : "${S}"`),console.log(`JavaScript Type : ${typeof S}`),console.log(`SheetJS Cell Type : ${N}`),console.log(`SheetJS Formatted Value : "${U}"`),console.log(`Value After Trim : "${String(S||"").trim()}"`),console.log(`Value After Date Parser : "${_}"`),console.log(`Is Empty : ${!S}`),console.log(`Is Invalid Date : ${S instanceof Date?isNaN(S.getTime()):"Bukan JS Date Object"}`),console.log(`Reason : ${x}`),console.log(`Workbook Sheet : ${C?"Ada":"Tidak Ditemukan"}`),console.log(`Excel Cell Address : ${ee}`),console.log(`
--- Seluruh Kolom Pada Baris Ini (Mencegah Column Shift) ---`),console.log(JSON.stringify(g,null,2)),console.log(`
--- Daftar Seluruh Header Yang Terbaca ---`),console.log(JSON.stringify(K)),console.log(`==========================
`)}let T=s(f,k),L=null;return T?_||(L="Tanggal Mulai kosong atau tidak berformat tanggal"):L="Karyawan tidak ditemukan di Database",{isValid:!!(T&&_),invalidReason:L,rowNum:k,data:{employee_id:T,branch_id:n(String(g.Cabang||"").trim()),division:String(g["Div / Bagian"]||"").trim()||"FACILITY CARE",start_date:_,end_date:m(g["Tanggal Selesai"])||"2099-12-31",status:String(g.Status||"").trim(),_rawName:f}}}),p=[],u=[];if(d.forEach(g=>{g.isValid?p.push(g.data):u.push({rowNum:g.rowNum,name:g.data._rawName,reason:g.invalidReason})}),console.log(`Split Validation - Valid: ${p.length}, Invalid: ${u.length}`),p.length===0){let g=`SEMUA BARIS GAGAL IMPORT!
...
`})),alert(b),typeof Ue=="function"&&Ue()}}})}B();A();var ut=[],Oe=[];function Ea(t){if(!Array.isArray(t))return"Q3";let e=["Q4","Q3","Q2","Q1"];for(let r of e)if(t.some(a=>a.period===r))return r;return"Q3"}function Da(t,e){if(t.period!=="Q3")return!1;let r=String(t.status||"").toLowerCase();if(r!=="selesai"&&r!=="completed"&&r!=="done")return!1;let a=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?a.includes("inspeksi"):e==="gcdc"?a.includes("general cleaning")||a.includes("deep cleaning"):!1}async function Ot(t,e){ut=await P();let r=await q();Oe=["Ade Surahman","Berlin Ariansyah","Mizwar","Fajar","Ade","Berlin"];let a=s=>s&&!Oe.find(m=>(typeof m=="object"?m.value:m)===s)?[...Oe,s]:Oe,l=await v(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`),o=s=>{if(!s||s==="-"||String(s).trim()==="")return"";let m=String(s).split("-");return m.length===3&&m[0].length===4?`${m[2]}-${m[1]}-${m[0]}`:s},i=l.data?.data||[],c=Ea(i),n=e?e.get("dash_filter"):null;$({container:t,title:"Jadwal Kegiatan",icon:"\u{1F4C5}",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",paginationMode:"client",defaultFilters:n?{period:"Q3"}:{},onDataLoaded:s=>(n&&(s=s.filter(m=>Da(m,n))),s.sort((m,d)=>{let p=m.target_date?new Date(m.target_date).getTime():m.opening_date?new Date(m.opening_date).getTime():0;return(d.target_date?new Date(d.target_date).getTime():d.opening_date?new Date(d.opening_date).getTime():0)-p})),columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:s=>st(s)},{key:"period",label:"Periode",render:s=>ae(s)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:s=>o(s)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:s=>o(s)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:s=>o(s)},{key:"status",label:"Status",render:s=>F(s)}],filterFields:[{type:"combobox",name:"branch_id",label:"Cabang",options:ut},{type:"select",name:"activity_type",label:"Kegiatan",options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"combobox",name:"pic",label:"PIC",options:Oe}],formFields:s=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:ut,value:s?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"],value:s?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:s?.period},{name:"pic",label:"PIC",type:"combobox",options:a(s?.pic),value:s?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:s?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:s?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:s?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:s?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:s?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let s=await v(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`);if(s.ok){let m=s.data.data.map(d=>({ID:d.id||"",Cabang:d.branch_name||"",Kegiatan:d.activity_type||"",Periode:d.period||"",PIC:d.pic||"","Tgl Opening":d.opening_date||"","Tgl Target":d.target_date||"","Tgl Selesai":d.completion_date||"",Status:d.status||""}));E(m,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{ID:"",Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done"}],"Template_Import_Jadwal")},onImport:async s=>{let d=(await v("/api/branches?all=1")).data?.data||[],p=g=>{if(!g)return null;let y=String(g||"").toLowerCase(),k=d.find(f=>String(f.full_name||"").toLowerCase()===y||String(f.code||"").toLowerCase()===y||String(f.name||"").toLowerCase()===y);return k?k.id:null},u=g=>{if(g==null||g==="")return"";if(g instanceof Date&&!isNaN(g.getTime()))return g.toISOString().slice(0,10);let y=String(g).trim();if(y===""||y==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(y))return y.slice(0,10);if(/^\d{4,5}$/.test(y)){let f=Number(y);if(f>2e4&&f<99999){let S=new Date(Date.UTC(1899,11,30)+f*864e5);return isNaN(S.getTime())?"":S.toISOString().slice(0,10)}}let k=y.split(/[\/\-\.]/);if(k.length===3){let[f,S,_]=k.map(T=>T.trim());if(f.length===4&&S.length<=2&&_.length<=2)return`${f}-${S.padStart(2,"0")}-${_.padStart(2,"0")}`;if(_.length===4&&S.length<=2&&f.length<=2)return`${_}-${S.padStart(2,"0")}-${f.padStart(2,"0")}`}return y},h=s.map(g=>({id:g.ID||null,branch_id:p(String(g.Cabang||"").trim()),activity_type:String(g.Kegiatan||"").trim(),period:String(g.Periode||"").trim(),pic:String(g.PIC||g.Pic||"").trim(),opening_date:u(g["Tgl Opening"]||g["Tanggal Opening"]||g["Tgl Openir"]),target_date:u(g["Tgl Target"]||g["Tanggal Target"]),completion_date:u(g["Tgl Selesai"]||g["Tanggal Selesai"]),status:String(g.Status||"").trim(),notes:String(g.Catatan||g.Keterangan||"").trim()})).filter(g=>g.activity_type&&g.period),b=await v("/api/schedule/import",{method:"POST",body:JSON.stringify(h)});if(!b.ok)throw new Error(b.data?.error||"Import gagal")}}})}B();A();var gt=[],Ge=[];async function Mt(t,e){let r=e?e.get("dash_filter"):null;gt=await P(),Ge=await q();let a=i=>i&&!Ge.find(c=>c.value===i)?[...Ge,{value:i,label:i}]:Ge,l=new Date().getFullYear(),o=Array.from({length:5},(i,c)=>String(l-c));$({container:t,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,itemLabel:"Permasalahan",paginationMode:"client",defaultFilters:{status:r==="open"?"Open":""},onDataLoaded:i=>i,columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:i=>window.formatDate(i)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:i=>`<span class="badge badge-secondary">${i}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:i=>`<span title="${i}">${i?.length>50?i.slice(0,50)+"\u2026":i}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:i=>`<span title="${i||""}">${i?.length>40?i.slice(0,40)+"\u2026":i||"-"}</span>`},{key:"status",label:"Status",render:i=>F(i)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:i=>window.formatDate(i)},{key:"day_count",label:"Hari",render:i=>i??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"combobox",name:"branch_id",label:"Cabang",options:gt},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:o}],formFields:i=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:i?.report_date},{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:gt,value:i?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:i?.category},{name:"source",label:"Sumber Laporan",type:"combobox",options:["SPV","AM","RCP","Perawat","FC","Berlin","Ade","Pattrel","Dentrel"],value:i?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:i?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"combobox",options:a(i?.employee_name),value:i?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"combobox",options:a(i?.fc_specialist),value:i?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:i?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:i?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:i?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let i=await v(`/api/issues${window.location.search?window.location.search+"&":"?"}limit=10000`);if(i.ok){let c=i.data.data.map(n=>({Tanggal:n.report_date||"",Cabang:n.branch_name||"",Kategori:n.category||"",Sumber:n.source||"",Keluhan:n.complaint||"","Nama FC":n.employee_name||"","FC Spesialis":n.fc_specialist||"",Solusi:n.solution||"","Tgl Selesai":n.completion_date||"",Status:n.status||""}));E(c,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async i=>{let n=(await v("/api/branches?all=1")).data?.data||[],s=p=>{if(!p)return null;let u=String(p||"").toLowerCase(),h=n.find(b=>String(b.full_name||"").toLowerCase()===u||String(b.code||"").toLowerCase()===u||String(b.name||"").toLowerCase()===u);return h?h.id:null},m=i.map(p=>({branch_id:s(String(p.Cabang||"").trim()),report_date:String(p.Tanggal||"").trim(),category:String(p.Kategori||"").trim(),source:String(p.Sumber||"").trim(),complaint:String(p.Keluhan||"").trim(),employee_name:String(p["Nama FC"]||"").trim(),fc_specialist:String(p["FC Spesialis"]||"").trim(),solution:String(p.Solusi||"").trim(),completion_date:String(p["Tgl Selesai"]||"").trim(),status:String(p.Status||"").trim()})).filter(p=>p.report_date&&p.complaint&&p.category),d=await v("/api/issues/import",{method:"POST",body:JSON.stringify(m)});if(!d.ok)throw new Error(d.data?.error||"Import gagal")}}})}B();var Ce=[];async function Kt(t,e){let r=e?e.get("dash_filter"):null;Ce=await P();let a=await q(),l=["Ade Surahman","Berlin Ariansyah","Mizwar","Fajar","Ade","Berlin"],o=c=>c&&!a.find(n=>n.value===c)?[...a,{value:c,label:c}]:a,i=c=>c&&!l.find(n=>(typeof n=="object"?n.value:n)===c)?[...l,c]:l;$({container:t,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,itemLabel:"One on One",paginationMode:"client",defaultFilters:{status:r==="pending"?"Open":""},onDataLoaded:c=>c,columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:c=>window.formatDate(c)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:c=>`<span title="${c||""}">${c?.length>50?c.slice(0,50)+"\u2026":c||"-"}</span>`},{key:"solution",label:"Solusi",render:c=>`<span title="${c||""}">${c?.length>40?c.slice(0,40)+"\u2026":c||"-"}</span>`},{key:"status",label:"Status",render:c=>F(c)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:c=>window.formatDate(c)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:c=>c?`<a href="${c}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"combobox",name:"branch_id",label:"Cabang",options:Ce},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async c=>{let n=new URLSearchParams(c||{}).toString(),s=await v(`/api/one-on-one?limit=10000&${n}`);if(s.ok){let m=s.data.data.map(p=>({Tanggal:p.meeting_date||"",Cabang:p.branch_name||"","Nama Karyawan":p.employee_name||"",PIC:p.pic||"",Masalah:p.problem||"",Solusi:p.solution||"",Status:p.status||"","Tgl Selesai":p.completion_date||"",Dokumen:p.document_link||""})),{downloadExcel:d}=await Promise.resolve().then(()=>(A(),Z));d(m,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let c=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(A(),Z));n(c,"Template_Import_OneOnOne")},onImport:async c=>{let n=p=>{if(!p)return null;let u=String(p||"").toLowerCase(),h=Ce.find(b=>String(b.label||"").toLowerCase()===u);return h?h.value:null},s=p=>{if(!p)return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let u=String(p).trim();if(/^\d{4,5}$/.test(u)){let b=Number(u);if(b>2e4&&b<99999){let g=new Date(Date.UTC(1899,11,30)+b*864e5);return isNaN(g.getTime())?"":g.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(u))return u.slice(0,10);let h=u.split(/[\/\-\.]/);if(h.length===3){let[b,g,y]=h.map(k=>k.trim());if(b.length===4&&g.length<=2&&y.length<=2)return`${b}-${g.padStart(2,"0")}-${y.padStart(2,"0")}`;if(y.length===4&&g.length<=2&&b.length<=2)return`${y}-${g.padStart(2,"0")}-${b.padStart(2,"0")}`}return u},m=c.map(p=>({meeting_date:s(p.Tanggal),employee_name:String(p["Nama Karyawan"]||"").trim(),branch_id:n(String(p.Cabang||"").trim()),pic:String(p.PIC||"").trim(),problem:String(p.Masalah||"").trim(),solution:String(p.Solusi||"").trim(),status:String(p.Status||"").trim(),completion_date:s(p["Tgl Selesai"]),document_link:String(p.Dokumen||"").trim()})).filter(p=>p.meeting_date&&p.employee_name&&p.branch_id),d=await v("/api/one-on-one/import",{method:"POST",body:JSON.stringify(m)});if(!d.ok)throw new Error(d.data?.error||"Import gagal")}},formFields:c=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:c?.meeting_date},{name:"branch_id",label:"Cabang",type:"combobox",options:c?.branch_id&&!Ce.find(n=>n.value==c.branch_id)?[...Ce,{value:c.branch_id,label:c.branch_name||c.branch_id}]:Ce,createApi:{path:"/api/branches",field:"full_name"},value:c?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"combobox",required:!0,options:o(c?.employee_name),value:c?.employee_name},{name:"pic",label:"PIC",type:"combobox",options:i(c?.pic),createApi:{path:"/api/pic",field:"name"},value:c?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:c?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:c?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:c?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:c?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:c?.document_link}]})}B();async function Rt(t){let e=await P(),r=await q(),a=["Ade Surahman","Berlin Ariansyah","Mizwar","Fajar","Ade","Berlin"],l=n=>n&&!r.find(s=>s.value===n)?[...r,{value:n,label:n}]:r,o=n=>n&&!a.find(s=>(typeof s=="object"?s.value:s)===n)?[...a,n]:a,i=Array.from({length:5},(n,s)=>String(new Date().getFullYear()-s));$({container:t,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:n=>window.formatDate(n)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:n=>{try{let s=JSON.parse(n);return Array.isArray(s)?s.join(", "):n||"-"}catch{return n||"-"}}},{key:"score",label:"Nilai",render:n=>n!=null?`<strong>${n}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:n=>n?`<a href="${n}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer / peserta..."},{type:"select",name:"batch",label:"Pilih Batch",options:["Batch 1","Batch 2","Batch 3","Batch 4","Batch 5"]},{type:"combobox",name:"branch_id",label:"Pilih Cabang",options:e},{type:"select",name:"trainer",label:"Pilih Trainer",options:["Berlin Ariansyah","Ade Surahman","Mizwar","Fajar"]},{type:"select",name:"year",label:"Pilih Tahun",options:i}],exportOptions:{moduleName:"training",onExport:async n=>{let s=new URLSearchParams(n||{}).toString(),m=await v(`/api/training?limit=10000&${s}`);if(m.ok){let d=m.data.data.map(u=>{let h=u.participants||"";try{let b=JSON.parse(h);h=Array.isArray(b)?b.join(", "):h}catch{}return{Tanggal:u.training_date||"",Batch:u.batch||"",Materi:u.subject||"",Cabang:u.branch_name||"",Trainer:u.trainer||"",Peserta:h,Nilai:u.score!==null&&u.score!==void 0?u.score:"",Dokumen:u.document_link||""}}),{downloadExcel:p}=await Promise.resolve().then(()=>(A(),Z));p(d,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let n=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:s}=await Promise.resolve().then(()=>(A(),Z));s(n,"Template_Import_Training")},onImport:async n=>{let s=u=>{if(!u)return null;let h=String(u||"").toLowerCase(),b=e.find(g=>String(g.label||"").toLowerCase()===h);return b?b.value:null},m=u=>{if(!u)return"";if(u instanceof Date&&!isNaN(u.getTime()))return u.toISOString().slice(0,10);let h=String(u).trim();if(/^\d{4,5}$/.test(h)){let g=Number(h);if(g>2e4&&g<99999){let y=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(y.getTime())?"":y.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(h))return h.slice(0,10);let b=h.split(/[\/\-\.]/);if(b.length===3){let[g,y,k]=b.map(f=>f.trim());if(g.length===4&&y.length<=2&&k.length<=2)return`${g}-${y.padStart(2,"0")}-${k.padStart(2,"0")}`;if(k.length===4&&y.length<=2&&g.length<=2)return`${k}-${y.padStart(2,"0")}-${g.padStart(2,"0")}`}return h},d=n.map(u=>({training_date:m(u.Tanggal),batch:String(u.Batch||"").trim(),subject:String(u.Materi||"").trim(),branch_id:s(String(u.Cabang||"").trim()),trainer:String(u.Trainer||"").trim(),participants:String(u.Peserta||"").trim(),score:u.Nilai?Number(u.Nilai):null,document_link:String(u.Dokumen||"").trim()})).filter(u=>u.training_date&&u.subject&&u.branch_id),p=await v("/api/training/import",{method:"POST",body:JSON.stringify(d)});if(!p.ok)throw new Error(p.data?.error||"Import gagal")}},formFields:n=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:n?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:n?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:n?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",options:e,value:n?.branch_id},{name:"trainer",label:"Trainer",type:"combobox",options:o(n?.trainer),value:n?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let s=JSON.parse(n?.participants);return Array.isArray(s)?s.join(", "):n?.participants||""}catch{return n?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:n?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:n?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:n?.notes}],onBeforeSubmit:async n=>(n.participants&&(n.participants=JSON.stringify(n.participants.split(",").map(s=>s.trim()).filter(Boolean))),n)})}B();A();async function jt(t,e){window.__RELIEVER_BUILD__="V3",console.log("RELIEVER PAGE LOADED");let r=await P(),a=await q(),l=e?e.get("dash_filter"):null;console.log("RAW",await ke()),console.log("OPTIONS",a);let o=n=>n&&!a.find(s=>s.value===n)?[...a,{value:n,label:n}]:a,i=["Agung Septiadi","Wasrikin","IQBAL AL BANNA","Muhammad Tri Ismandanu"],c=n=>n&&!i.includes(n)?[...i,n]:i;$({container:t,title:"Jadwal Reliefer",icon:"\u{1F504}",apiPath:"/api/relievers",bulkDelete:!0,itemLabel:"Reliefer",paginationMode:"client",onDataLoaded:n=>{if(l==="reliever"){let s=new Date,m=s.getFullYear(),d=String(s.getMonth()+1).padStart(2,"0");return n.filter(p=>{if(String(p.status||"").toLowerCase()!=="done")return!1;let u=p.backup_date||"";if(u.includes("/")){let h=u.split("/");if(h.length===3&&(h[2].length===4?h[2]:`20${h[2]}`)==m&&h[1].padStart(2,"0")==d)return!0}else if(u.includes("-")&&u.startsWith(`${m}-${d}`))return!0;return!1})}return n},columns:[{key:"branch_name",label:"Cabang"},{key:"original_fc_name",label:"Nama Facility care"},{key:"period",label:"Periode",render:n=>ae(n)},{key:"reliever_name",label:"Relifer"},{key:"backup_date",label:"Tanggal Back Up",nowrap:!0,render:n=>window.formatDate(n)},{key:"completion_date",label:"Tanggal Selesai",nowrap:!0,render:n=>window.formatDate(n)},{key:"reason",label:"Keterangan"},{key:"shift",label:"Shift",render:n=>n?`<span class="badge badge-info">${n}</span>`:"-"},{key:"status",label:"Status",render:n=>F(n)}],filterFields:[{type:"search",placeholder:"Cari reliefer / FC..."},{type:"combobox",name:"branch_id",label:"Cabang",options:r},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done","Tidak Datang"]}],formFields:n=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:r,value:n?.branch_id},{name:"period",label:"Periode",type:"combobox",options:["Q1","Q2","Q3","Q4"],value:n?.period}]},{type:"row",fields:[{name:"original_fc_name",label:"Nama Facility care",type:"combobox",options:o(n?.original_fc_name),value:n?.original_fc_name},{name:"reliever_name",label:"Relifer",type:"combobox",required:!0,options:c(n?.reliever_name),value:n?.reliever_name}]},{type:"row",fields:[{name:"backup_date",label:"Tanggal Back Up",type:"date",required:!0,value:n?.backup_date},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:n?.completion_date}]},{type:"row",fields:[{name:"reason",label:"Keterangan",type:"combobox",options:["Cuti","Mengisi Kekosongan","Back Up Training","Deep Cleaning","Training Praktek Skill","Sakit","Lainnya"],value:n?.reason},{name:"shift",label:"Shift",type:"combobox",options:["Pagi","Siang","Full Shift","Middle"],value:n?.shift}]},{name:"status",label:"Status",type:"combobox",required:!0,options:["Pending","Done","Tidak Datang"],value:n?.status||""}],exportOptions:{moduleName:"relievers",onExport:async()=>{let n=await v(`/api/relievers${window.location.search?window.location.search+"&":"?"}limit=10000`);if(n.ok){let s=n.data.data.map(m=>({Cabang:m.branch_name||"","Nama Facility care":m.original_fc_name||"",Periode:m.period||"",Relifer:m.reliever_name||"","Tanggal Back Up":m.backup_date||"","Tanggal Selesai":m.completion_date||"",Keterangan:m.reason||"",Shift:m.shift||"",Status:m.status||""}));s.length===0&&s.push({Cabang:"","Nama Facility care":"",Periode:"",Relifer:"","Tanggal Back Up":"","Tanggal Selesai":"",Keterangan:"",Shift:"",Status:""}),E(s,"Data_Reliefer")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Cabang:"001. Pondok Bambu","Nama Facility care":"Budi Santoso",Periode:"Q1",Relifer:"Andi","Tanggal Back Up":"2024-03-10","Tanggal Selesai":"2024-03-10",Keterangan:"Sakit",Shift:"Pagi",Status:"Done"}],"Template_Import_Reliefer")},onImport:async n=>{let m=(await v("/api/branches?all=1")).data?.data||[],d=h=>{if(!h)return null;let b=String(h||"").toLowerCase(),g=m.find(y=>String(y.full_name||"").toLowerCase()===b||String(y.code||"").toLowerCase()===b||String(y.name||"").toLowerCase()===b);return g?g.id:null},p=n.map(h=>({branch_name:String(h.Cabang||"").trim(),backup_date:String(h["Tanggal Back Up"]||h["Tanggal Backup"]||"").trim(),original_fc_name:String(h["Nama Facility care"]||h["FC Digantikan"]||"").trim(),reliever_name:String(h.Relifer||h.Reliefer||"").trim(),period:String(h.Periode||"").trim(),reason:String(h.Keterangan||"").trim(),shift:String(h.Shift||"").trim(),completion_date:String(h["Tanggal Selesai"]||"").trim(),status:String(h.Status||"").trim()})).filter(h=>h.reliever_name&&h.backup_date),u=await v("/api/import/relievers",{method:"POST",body:JSON.stringify({rows:p})});if(!u.ok)throw new Error(u.data?.error||"Import gagal")}}})}B();A();async function qt(t){let e=await P(),r=Array.from({length:4},(a,l)=>String(new Date().getFullYear()-l));$({container:t,title:"Laporan Inspeksi Hygiene",icon:"\u{1F50D}",apiPath:"/api/reports/inspection",itemLabel:"Laporan Inspeksi",bulkDelete:!0,columns:[{key:"branch_name",label:"Cabang"},{key:"period",label:"Periode",render:a=>ae(a)},{key:"inspection_date",label:"Tanggal",nowrap:!0,render:a=>window.formatDate(a)},{key:"fc_score",label:"Point FC",render:a=>a!=null?`<strong class="${a>=80?"text-success":a>=60?"text-warning":"text-danger"}">${a}</strong>`:"-"},{key:"spv_score",label:"Point SPV",render:a=>a!=null?`<strong>${a}</strong>`:"-"},{key:"status",label:"Status",render:a=>F(a)},{key:"document_link",label:"Dokumen",render:a=>a?`<a href="${a}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari cabang / PIC..."},{type:"combobox",name:"branch_id",label:"Cabang",options:e},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done"]},{type:"select",name:"year",label:"Tahun",options:r}],formFields:a=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:e,value:a?.branch_id},{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:a?.period}]},{type:"row",fields:[{name:"inspection_date",label:"Tanggal Inspeksi",type:"date",required:!0,value:a?.inspection_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done"],value:a?.status||""}]},{type:"row",fields:[{name:"fc_score",label:"Point FC",type:"number",step:"0.1",min:"0",max:"100",value:a?.fc_score},{name:"spv_score",label:"Point SPV",type:"number",step:"0.1",min:"0",max:"100",value:a?.spv_score}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:a?.document_link},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:a?.notes}],exportOptions:{moduleName:"inspection_reports",onExport:async a=>{let l=new URLSearchParams(a||{}).toString(),o=await v(`/api/reports/inspection?limit=10000&${l}`);if(o.ok){let i=o.data.data.map(c=>({Cabang:c.branch_name||"",Periode:c.period||"",Tanggal:c.inspection_date||"","Point FC":c.fc_score!==null&&c.fc_score!==void 0?c.fc_score:"","Point SPV":c.spv_score!==null&&c.spv_score!==void 0?c.spv_score:"",Status:c.status||"","Link Dokumen":c.document_link||""}));E(i,`Laporan_Inspeksi_Hygiene_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Cabang:"001. Pondok Bambu",Periode:"Q1",Tanggal:"2026-01-08","Point FC":85,"Point SPV":90,Status:"Done","Link Dokumen":"https://drive.google.com/..."}],"Template_Import_Inspeksi")},onImport:async a=>{let l=n=>{if(!n)return null;let s=String(n||"").toLowerCase(),m=e.find(d=>String(d.label||"").toLowerCase()===s);return m?m.value:null},o=n=>{if(n==null||n==="")return"";if(n instanceof Date&&!isNaN(n.getTime()))return n.toISOString().slice(0,10);let s=String(n).trim();if(s===""||s==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(s))return s.slice(0,10);if(/^\d{4,5}$/.test(s)){let d=Number(s);if(d>2e4&&d<99999){let p=new Date(Date.UTC(1899,11,30)+d*864e5);return isNaN(p.getTime())?"":p.toISOString().slice(0,10)}}let m=s.split(/[\/\-\.]/);if(m.length===3){let[d,p,u]=m.map(h=>h.trim());if(d.length===4&&p.length<=2&&u.length<=2)return`${d}-${p.padStart(2,"0")}-${u.padStart(2,"0")}`;if(u.length===4&&p.length<=2&&d.length<=2)return`${u}-${p.padStart(2,"0")}-${d.padStart(2,"0")}`}return s},i=a.map(n=>({branch_id:l(String(n.Cabang||"").trim()),period:String(n.Periode||"").trim(),inspection_date:o(n.Tanggal),fc_score:n["Point FC"]!==void 0&&n["Point FC"]!==""?Number(n["Point FC"]):null,spv_score:n["Point SPV"]!==void 0&&n["Point SPV"]!==""?Number(n["Point SPV"]):null,status:String(n.Status||"").trim(),document_link:String(n["Link Dokumen"]||"").trim(),notes:String(n.Catatan||n.Keterangan||"").trim()})).filter(n=>n.branch_id&&n.period&&n.inspection_date),c=await v("/api/reports/inspection/import",{method:"POST",body:JSON.stringify(i)});if(!c.ok)throw new Error(c.data?.error||"Import gagal")}}})}B();A();async function Ht(t){let e=await P(),r=Array.from({length:4},(a,l)=>String(new Date().getFullYear()-l));$({container:t,title:"Laporan General Cleaning & Deep Cleaning",icon:"\u{1F9F9}",apiPath:"/api/reports/cleaning",itemLabel:"Laporan GC/DC",bulkDelete:!0,columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Jenis",render:a=>`<span class="badge ${a==="Deep Cleaning"?"badge-purple":"badge-success"}">${a}</span>`},{key:"period",label:"Periode",render:a=>ae(a)},{key:"activity_date",label:"Tanggal",nowrap:!0,render:a=>window.formatDate(a)},{key:"status",label:"Status",render:a=>F(a)},{key:"document_link",label:"Dokumen",render:a=>a?`<a href="${a}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama cabang/lokasi..."},{type:"combobox",name:"branch_id",label:"Cabang",options:e},{type:"select",name:"activity_type",label:"Jenis",options:["General Cleaning","Deep Cleaning"]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done"]},{type:"select",name:"year",label:"Tahun",options:r}],formFields:a=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:e,value:a?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["General Cleaning","Deep Cleaning"],value:a?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:a?.period},{name:"activity_date",label:"Tanggal",type:"date",required:!0,value:a?.activity_date}]},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done"],value:a?.status||""},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:a?.document_link},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:a?.notes}],exportOptions:{moduleName:"cleaning_reports",onExport:async a=>{let l=new URLSearchParams(a||{}).toString(),o=await v(`/api/reports/cleaning?limit=10000&${l}`);if(o.ok){let i=o.data.data.map(c=>({Cabang:c.branch_name||"",Jenis:c.activity_type||"",Periode:c.period||"",Tanggal:c.activity_date||"",Status:c.status||"","Link Dokumen":c.document_link||""}));E(i,`Laporan_GCDC_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Cabang:"001. Pondok Bambu",Jenis:"General Cleaning",Periode:"Q1",Tanggal:"2026-01-08",Status:"Done","Link Dokumen":"https://drive.google.com/..."}],"Template_Import_GCDC")},onImport:async a=>{let l=n=>{if(!n)return null;let s=String(n||"").toLowerCase(),m=e.find(d=>String(d.label||"").toLowerCase()===s);return m?m.value:null},o=n=>{if(n==null||n==="")return"";if(n instanceof Date&&!isNaN(n.getTime()))return n.toISOString().slice(0,10);let s=String(n).trim();if(s===""||s==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(s))return s.slice(0,10);if(/^\d{4,5}$/.test(s)){let d=Number(s);if(d>2e4&&d<99999){let p=new Date(Date.UTC(1899,11,30)+d*864e5);return isNaN(p.getTime())?"":p.toISOString().slice(0,10)}}let m=s.split(/[\/\-\.]/);if(m.length===3){let[d,p,u]=m.map(h=>h.trim());if(d.length===4&&p.length<=2&&u.length<=2)return`${d}-${p.padStart(2,"0")}-${u.padStart(2,"0")}`;if(u.length===4&&p.length<=2&&d.length<=2)return`${u}-${p.padStart(2,"0")}-${d.padStart(2,"0")}`}return s},i=a.map(n=>({branch_id:l(String(n.Cabang||"").trim()),activity_type:String(n.Jenis||n.Kegiatan||"").trim(),period:String(n.Periode||"").trim(),activity_date:o(n.Tanggal),status:String(n.Status||"").trim(),document_link:String(n["Link Dokumen"]||"").trim(),notes:String(n.Catatan||n.Keterangan||"").trim()})).filter(n=>n.branch_id&&n.activity_type&&n.period&&n.activity_date),c=await v("/api/reports/cleaning/import",{method:"POST",body:JSON.stringify(i)});if(!c.ok)throw new Error(c.data?.error||"Import gagal")}}})}B();A();async function Jt(t){let e=await P(),r=Array.from({length:4},(a,l)=>String(new Date().getFullYear()-l));$({container:t,title:"Rekap Fogging",icon:"\u{1F4A8}",apiPath:"/api/reports/fogging",itemLabel:"Fogging",bulkDelete:!0,columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Jenis",render:a=>`<span class="badge badge-warning">${a}</span>`},{key:"period",label:"Periode",render:a=>ae(a)},{key:"activity_date",label:"Tanggal",nowrap:!0,render:a=>window.formatDate(a)},{key:"status",label:"Status",render:a=>F(a)},{key:"document_link",label:"Dokumen",render:a=>a?`<a href="${a}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"},{key:"notes",label:"Catatan",render:a=>a||"-"}],filterFields:[{type:"search",placeholder:"Cari nama cabang/lokasi..."},{type:"combobox",name:"branch_id",label:"Cabang",options:e},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done"]},{type:"select",name:"year",label:"Tahun",options:r}],formFields:a=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:e,value:a?.branch_id},{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:a?.period}]},{type:"row",fields:[{name:"activity_date",label:"Tanggal",type:"date",value:a?.activity_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done"],value:a?.status||""}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:a?.document_link},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:a?.notes}],exportOptions:{moduleName:"fogging_reports",onExport:async a=>{let l=new URLSearchParams(a||{}).toString(),o=await v(`/api/reports/fogging?limit=10000&${l}`);if(o.ok){let i=o.data.data.map(c=>({Cabang:c.branch_name||"",Jenis:c.activity_type||"Fogging",Periode:c.period||"",Tanggal:c.activity_date||"",Status:c.status||"","Link Dokumen":c.document_link||""}));E(i,`Laporan_Fogging_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Cabang:"001. Pondok Bambu",Jenis:"Fogging",Periode:"Q1",Tanggal:"2026-01-08",Status:"Done","Link Dokumen":"https://drive.google.com/..."}],"Template_Import_Fogging")},onImport:async a=>{let l=n=>{if(!n)return null;let s=String(n||"").toLowerCase(),m=e.find(d=>String(d.label||"").toLowerCase()===s);return m?m.value:null},o=n=>{if(n==null||n==="")return"";if(n instanceof Date&&!isNaN(n.getTime()))return n.toISOString().slice(0,10);let s=String(n).trim();if(s===""||s==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(s))return s.slice(0,10);if(/^\d{4,5}$/.test(s)){let d=Number(s);if(d>2e4&&d<99999){let p=new Date(Date.UTC(1899,11,30)+d*864e5);return isNaN(p.getTime())?"":p.toISOString().slice(0,10)}}let m=s.split(/[\/\-\.]/);if(m.length===3){let[d,p,u]=m.map(h=>h.trim());if(d.length===4&&p.length<=2&&u.length<=2)return`${d}-${p.padStart(2,"0")}-${u.padStart(2,"0")}`;if(u.length===4&&p.length<=2&&d.length<=2)return`${u}-${p.padStart(2,"0")}-${d.padStart(2,"0")}`}return s},i=a.map(n=>({branch_id:l(String(n.Cabang||"").trim()),activity_type:String(n.Jenis||n.Kegiatan||"Fogging").trim(),period:String(n.Periode||"").trim(),activity_date:o(n.Tanggal),status:String(n.Status||"").trim(),document_link:String(n["Link Dokumen"]||"").trim(),notes:String(n.Catatan||n.Keterangan||"").trim()})).filter(n=>n.branch_id&&n.period&&n.activity_date),c=await v("/api/reports/fogging/import",{method:"POST",body:JSON.stringify(i)});if(!c.ok)throw new Error(c.data?.error||"Import gagal")}}})}B();A();async function Ut(t){let e=await P(),r=await q(),a=r,l=i=>i&&!r.find(c=>c.value===i)?[...r,{value:i,label:i}]:r,o=i=>i&&!a.find(c=>c.value===i)?[...a,{value:i,label:i}]:a;$({container:t,title:"Rekap Laporan Basecamp",icon:"\u{1F4DD}",apiPath:"/api/reports/basecamp",bulkDelete:!0,itemLabel:"Laporan Basecamp",columns:[{key:"info_date",label:"Tgl Info",nowrap:!0,render:i=>window.formatDate(i)},{key:"branch_name",label:"Cabang"},{key:"problem",label:"Permasalahan",render:i=>`<span title="${i||""}">${i?.length>60?i.slice(0,60)+"\u2026":i||"-"}</span>`},{key:"pic",label:"PIC"},{key:"done_date",label:"Tgl Done",nowrap:!0,render:i=>window.formatDate(i)},{key:"status",label:"Status",render:i=>F(i)},{key:"notes",label:"Keterangan",render:i=>i?.length>40?i.slice(0,40)+"\u2026":i||"-"}],filterFields:[{type:"search",placeholder:"Cari permasalahan / PIC..."},{type:"combobox",name:"branch_id",label:"Cabang",options:e},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]}],formFields:i=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:e,value:i?.branch_id},{name:"pic",label:"PIC",type:"combobox",options:o(i?.pic),value:i?.pic}]},{name:"problem",label:"Permasalahan",type:"textarea",required:!0,rows:3,value:i?.problem},{type:"row",fields:[{name:"info_date",label:"Tanggal Info",type:"date",required:!0,value:i?.info_date},{name:"done_date",label:"Tanggal Done",type:"date",value:i?.done_date}]},{name:"status",label:"Status",type:"select",options:["Open","In Progress","Done"],value:i?.status||"Open"},{name:"notes",label:"Keterangan / Tindak Lanjut",type:"textarea",rows:2,value:i?.notes}],exportOptions:{moduleName:"basecamp_reports",onExport:async i=>{let c=new URLSearchParams(i||{}).toString(),n=await v(`/api/reports/basecamp?limit=10000&${c}`);if(n.ok){let s=n.data.data.map(m=>({"Tgl Info":m.info_date||"",Cabang:m.branch_name||"",Permasalahan:m.problem||"",PIC:m.pic||"","Tgl Done":m.done_date||"",Status:m.status||"",Keterangan:m.notes||""}));E(s,`Rekap_Laporan_Basecamp_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{"Tgl Info":"2026-01-08",Cabang:"001. Pondok Bambu",Permasalahan:"Request fogging karena banyak nyamuk",PIC:"Fajar","Tgl Done":"2026-01-10",Status:"Done",Keterangan:"Sudah difogging"}],"Template_Import_Basecamp")},onImport:async i=>{let c=d=>{if(!d)return null;let p=String(d||"").toLowerCase(),u=e.find(h=>String(h.label||"").toLowerCase()===p);return u?u.value:null},n=d=>{if(d==null||d==="")return"";if(d instanceof Date&&!isNaN(d.getTime()))return d.toISOString().slice(0,10);let p=String(d).trim();if(p===""||p==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(p))return p.slice(0,10);if(/^\d{4,5}$/.test(p)){let h=Number(p);if(h>2e4&&h<99999){let b=new Date(Date.UTC(1899,11,30)+h*864e5);return isNaN(b.getTime())?"":b.toISOString().slice(0,10)}}let u=p.split(/[\/\-\.]/);if(u.length===3){let[h,b,g]=u.map(y=>y.trim());if(h.length===4&&b.length<=2&&g.length<=2)return`${h}-${b.padStart(2,"0")}-${g.padStart(2,"0")}`;if(g.length===4&&b.length<=2&&h.length<=2)return`${g}-${b.padStart(2,"0")}-${h.padStart(2,"0")}`}return p},s=i.map(d=>({info_date:n(d["Tgl Info"]||d["Tanggal Info"]),branch_id:c(String(d.Cabang||"").trim()),problem:String(d.Permasalahan||"").trim(),pic:String(d.PIC||"").trim(),done_date:n(d["Tgl Done"]||d["Tanggal Done"]),status:String(d.Status||"").trim(),notes:String(d.Keterangan||d.Catatan||"").trim()})).filter(d=>d.info_date&&d.branch_id&&d.problem),m=await v("/api/reports/basecamp/import",{method:"POST",body:JSON.stringify(s)});if(!m.ok)throw new Error(m.data?.error||"Import gagal")}}})}async function Gt(t){$({container:t,title:"SOP",icon:"\u{1F4D6}",apiPath:"/api/sop",bulkDelete:!0,itemLabel:"SOP",columns:[{key:"name",label:"Nama SOP"},{key:"category",label:"Kategori"},{key:"document_link",label:"Dokumen",render:e=>e?`<a href="${e}" target="_blank" rel="noopener" class="btn btn-sm btn-primary">\u{1F4C4} Buka Dokumen</a>`:"-"},{key:"notes",label:"Catatan"}],filterFields:[{type:"search",placeholder:"Cari nama SOP..."}],exportOptions:{moduleName:"sop",onExport:async e=>{let r=new URLSearchParams(e||{}).toString(),{apiFetch:a}=await Promise.resolve().then(()=>(B(),ye)),l=await a(`/api/sop?limit=10000&${r}`);if(l.ok){let o=l.data.data.map(c=>({"Nama SOP":c.name||"",Kategori:c.category||"",Dokumen:c.document_link||"",Catatan:c.notes||c.description||""})),{downloadExcel:i}=await Promise.resolve().then(()=>(A(),Z));i(o,`Master_SOP_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let e=[{"Nama SOP":"SOP Cuci Tangan",Kategori:"Ketentuan & Basic",Dokumen:"https://link.com",Catatan:"Catatan singkat"}],{downloadExcel:r}=await Promise.resolve().then(()=>(A(),Z));r(e,"Template_Import_SOP")},onImport:async e=>{let r=e.map(o=>({name:String(o["Nama SOP"]||"").trim(),category:String(o.Kategori||"").trim(),document_link:String(o.Dokumen||"").trim(),description:String(o.Catatan||"").trim()})).filter(o=>o.name),{apiFetch:a}=await Promise.resolve().then(()=>(B(),ye)),l=await a("/api/sop/import",{method:"POST",body:JSON.stringify(r)});if(!l.ok)throw new Error(l.data?.error||"Import gagal")}},formFields:e=>[{name:"name",label:"Nama SOP",required:!0,placeholder:"Nama SOP",value:e?.name},{name:"category",label:"Kategori",placeholder:"Ketentuan & Basic, Kualitas & Grooming, dst.",value:e?.category},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://docs.google.com/...",value:e?.document_link},{name:"description",label:"Deskripsi / Catatan",type:"textarea",rows:3,value:e?.description}]})}async function Qt(t){$({container:t,title:"Master Checklist",icon:"\u2705",apiPath:"/api/checklist",bulkDelete:!0,itemLabel:"Checklist",columns:[{key:"name",label:"Nama Checklist"},{key:"category",label:"Kategori"},{key:"document_link",label:"Dokumen",render:e=>e?`<a href="${e}" target="_blank" rel="noopener" class="btn btn-sm btn-primary">\u{1F4C4} Buka Dokumen</a>`:"-"},{key:"description",label:"Deskripsi"}],filterFields:[{type:"search",placeholder:"Cari checklist..."}],exportOptions:{moduleName:"checklist",onExport:async e=>{let r=new URLSearchParams(e||{}).toString(),{apiFetch:a}=await Promise.resolve().then(()=>(B(),ye)),l=await a(`/api/checklist?limit=10000&${r}`);if(l.ok){let o=l.data.data.map(c=>({"Nama Checklist":c.name||"",Kategori:c.category||"",Dokumen:c.document_link||"",Deskripsi:c.description||""})),{downloadExcel:i}=await Promise.resolve().then(()=>(A(),Z));i(o,`Master_Checklist_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let e=[{"Nama Checklist":"Checklist Kebersihan Mingguan",Kategori:"Master Cleaning Program",Dokumen:"https://link.com",Deskripsi:"Deskripsi singkat"}],{downloadExcel:r}=await Promise.resolve().then(()=>(A(),Z));r(e,"Template_Import_Checklist")},onImport:async e=>{let r=e.map(o=>({name:String(o["Nama Checklist"]||"").trim(),category:String(o.Kategori||"").trim(),document_link:String(o.Dokumen||"").trim(),description:String(o.Deskripsi||"").trim()})).filter(o=>o.name),{apiFetch:a}=await Promise.resolve().then(()=>(B(),ye)),l=await a("/api/checklist/import",{method:"POST",body:JSON.stringify(r)});if(!l.ok)throw new Error(l.data?.error||"Import gagal")}},formFields:e=>[{name:"name",label:"Nama Checklist",required:!0,placeholder:"Nama checklist",value:e?.name},{name:"category",label:"Kategori",placeholder:"Master Cleaning Program, dll.",value:e?.category},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://docs.google.com/...",value:e?.document_link},{name:"description",label:"Deskripsi",type:"textarea",rows:3,value:e?.description}]})}B();Ae();A();async function bt(t,e="forms"){if(e==="supply")return Ba(t);Ia(t)}function Ia(t){$({container:t,title:"Master Form",icon:"\u{1F4C4}",apiPath:"/api/forms",bulkDelete:!0,itemLabel:"Form",columns:[{key:"name",label:"Nama Form"},{key:"category",label:"Kategori"},{key:"document_link",label:"Dokumen",render:e=>e?`<a href="${e}" target="_blank" rel="noopener" class="btn btn-sm btn-primary">\u{1F4C4} Buka</a>`:"-"},{key:"is_public",label:"Publik",render:e=>e?'<span class="badge badge-success">Ya</span>':'<span class="badge badge-neutral">Tidak</span>'},{key:"description",label:"Deskripsi"}],filterFields:[{type:"search",placeholder:"Cari form..."}],formFields:e=>[{name:"name",label:"Nama Form",required:!0,placeholder:"Nama form",value:e?.name},{name:"category",label:"Kategori",placeholder:"Permintaan Barang, Penilaian, dll.",value:e?.category},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:e?.document_link},{name:"description",label:"Deskripsi",type:"textarea",rows:2,value:e?.description},{name:"is_public",label:"Akses Publik",type:"checkbox",checkLabel:"Form dapat diakses tanpa login",value:e?.is_public}]})}async function Ba(t){let r=((await v("/api/branches?all=1")).data?.data||[]).map(a=>({value:a.id,label:a.full_name}));$({container:t,title:"Permintaan Barang & Chemical",icon:"\u{1F4E6}",apiPath:"/api/reports/supply",bulkDelete:!0,itemLabel:"Permintaan",canCreate:!0,columns:[{key:"submitted_at",label:"Waktu",nowrap:!0,render:a=>a?new Date(a).toLocaleString("id-ID"):"-"},{key:"submitter_name",label:"Pengirim"},{key:"branch_name",label:"Cabang",render:(a,l)=>l.branch_name_ref||l.branch_name||"-"},{key:"tools_items",label:"Alat/Barang",render:a=>{try{let l=JSON.parse(a);return Array.isArray(l)?l.join(", "):a}catch{return a||"-"}}},{key:"chemical_items",label:"Chemical",render:a=>{try{let l=JSON.parse(a);return Array.isArray(l)?l.join(", "):a}catch{return a||"-"}}},{key:"additional_notes",label:"Catatan",render:a=>a?.length>40?a.slice(0,40)+"\u2026":a||"-"},{key:"status",label:"Status",render:a=>F(a)},{key:"processed_by",label:"Diproses Oleh"}],filterFields:[{type:"select",name:"status",label:"Status",options:["Pending","Diproses","Selesai"]}],formFields:a=>{let l=a?.tools_items;try{l=Array.isArray(JSON.parse(l))?JSON.parse(l).join(", "):l}catch{}let o=a?.chemical_items;try{o=Array.isArray(JSON.parse(o))?JSON.parse(o).join(", "):o}catch{}return[{type:"row",fields:[{name:"submitter_name",label:"Nama Pengirim",required:!0,value:a?.submitter_name},{name:"branch_id",label:"Cabang",type:"combobox",options:a?.branch_id&&!r.find(i=>i.value==a.branch_id)?[...r,{value:a.branch_id,label:a.branch_name||a.branch_id}]:r,createApi:{path:"/api/branches",field:"full_name"},value:a?.branch_id}]},{type:"row",fields:[{name:"tools_items",label:"Alat / Barang",placeholder:"Pisahkan dengan koma (Sapu, Mop)",value:l},{name:"tools_quantity",label:"Jumlah Alat",type:"number",value:a?.tools_quantity}]},{type:"row",fields:[{name:"chemical_items",label:"Chemical",placeholder:"Pisahkan dengan koma",value:o},{name:"chemical_quantity",label:"Jumlah Chemical",type:"number",value:a?.chemical_quantity}]},{name:"additional_notes",label:"Catatan",type:"textarea",rows:2,value:a?.additional_notes},{name:"status",label:"Status",type:"select",options:["Pending","Diproses","Selesai"],value:a?.status||""},{name:"processed_by",label:"Diproses Oleh",value:a?.processed_by}]},exportOptions:{moduleName:"supply_requests",onExport:async a=>{let l=new URLSearchParams(a||{}).toString(),o=await v(`/api/reports/supply?limit=10000&${l}`);if(o.ok){let i=o.data.data.map(c=>{let n=c.tools_items;try{n=Array.isArray(JSON.parse(n))?JSON.parse(n).join(", "):n}catch{}let s=c.chemical_items;try{s=Array.isArray(JSON.parse(s))?JSON.parse(s).join(", "):s}catch{}return{Waktu:c.submitted_at||"",Pengirim:c.submitter_name||"",Cabang:c.branch_name_ref||c.branch_name||"","Alat/Barang":n||"",Chemical:s||"",Catatan:c.additional_notes||"",Status:c.status||"","Diproses Oleh":c.processed_by||""}});E(i,`Permintaan_Barang_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Waktu:"2026-01-08",Pengirim:"Fajar",Cabang:"001. Pondok Bambu","Alat/Barang":"Sapu, Mop",Chemical:"Karbol",Catatan:"Mendesak",Status:"Pending","Diproses Oleh":""}],"Template_Import_Permintaan")},onImport:async a=>{let o=(await v("/api/branches?all=1")).data?.data||[],i=m=>{if(!m)return null;let d=String(m||"").toLowerCase(),p=o.find(u=>String(u.full_name||"").toLowerCase()===d||String(u.code||"").toLowerCase()===d||String(u.name||"").toLowerCase()===d);return p?p.id:null},c=m=>{if(m==null||m==="")return"";if(m instanceof Date&&!isNaN(m.getTime()))return m.toISOString().slice(0,10);let d=String(m).trim();if(d===""||d==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(d))return d.slice(0,10);if(/^\d{4,5}$/.test(d)){let u=Number(d);if(u>2e4&&u<99999){let h=new Date(Date.UTC(1899,11,30)+u*864e5);return isNaN(h.getTime())?"":h.toISOString().slice(0,10)}}let p=d.split(/[\/\-\.]/);if(p.length===3){let[u,h,b]=p.map(g=>g.trim());if(u.length===4&&h.length<=2&&b.length<=2)return`${u}-${h.padStart(2,"0")}-${b.padStart(2,"0")}`;if(b.length===4&&h.length<=2&&u.length<=2)return`${b}-${h.padStart(2,"0")}-${u.padStart(2,"0")}`}return d},n=a.map(m=>({submitted_at:c(m.Waktu||m.Tanggal),submitter_name:String(m.Pengirim||"").trim(),branch_id:i(String(m.Cabang||"").trim()),tools_items:String(m["Alat/Barang"]||m.Alat||"").trim(),chemical_items:String(m.Chemical||"").trim(),additional_notes:String(m.Catatan||m.Keterangan||"").trim(),status:String(m.Status||"").trim(),processed_by:String(m["Diproses Oleh"]||m.PIC||"").trim()})).filter(m=>m.submitted_at&&m.submitter_name&&m.branch_id),s=await v("/api/reports/supply/import",{method:"POST",body:JSON.stringify(n)});if(!s.ok)throw new Error(s.data?.error||"Import gagal")}},extraActions:[{label:"Update Status",icon:"\u{1F504}",class:"btn-secondary",handler:(a,l)=>{let o=le({title:"Update Status Permintaan",content:`
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),m()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),m()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.getElementById("cal-refresh-btn").addEventListener("click",()=>{s(),m(!0)}),document.querySelectorAll(".cal-filter").forEach(p=>p.addEventListener("change",()=>m()));let i=p=>{a||(clearTimeout(l),l=setTimeout(()=>{a||(s(),n().then(()=>d()))},300))};Ne.on("data:changed",i),o=setInterval(()=>{a||n().then(()=>d())},6e4);let c=()=>{a=!0,clearTimeout(l),clearInterval(o),Ne.off("data:changed",i)};async function n(){try{let p=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`,u=await v(`/api/dashboard/calendar?month=${p}`);a||(r=u.data?.data||[])}catch(p){console.warn("[Calendar] Failed to load events:",p)}}function s(){let p=document.getElementById("cal-sync-status");p&&(p.textContent="\u{1F504} Memuat...",p.className="cal-sync-badge sync-loading",setTimeout(()=>{a||(p.textContent="\u{1F7E2} Real-Time Live",p.className="cal-sync-badge sync-live")},1200))}async function m(p=!1){let u=document.getElementById("calendar-grid");u&&((p||r.length===0)&&(u.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
      ...
      </div>`),await n(),d())}function d(){if(a)return;let p=document.getElementById("calendar-grid");if(p)try{let u=e.getFullYear(),h=e.getMonth(),b=e.toLocaleDateString("id-ID",{month:"long",year:"numeric"}),g=document.getElementById("cal-month-label");g&&(g.textContent=b);let y=new Set(Array.from(document.querySelectorAll(".cal-filter:checked")).map(N=>N.value)),k=r.filter(N=>y.has(N.type)),f={};k.forEach(N=>{let U=(N.event_date||"").slice(0,10);f[U]||(f[U]=[]),f[U].push(N)});let S=new Date(u,h,1).getDay(),_=new Date(u,h+1,0).getDate(),T=["Min","Sen","Sel","Rab","Kam","Jum","Sab"],L=new Date().toISOString().slice(0,10),C='<div class="calendar-grid">';T.forEach(N=>{C+=`<div class="cal-day-header">${N}</div>`});for(let N=0;N<S;N++)C+='<div class="cal-cell cal-cell-empty"></div>';for(let N=1;N<=_;N++){let U=`${u}-${String(h+1).padStart(2,"0")}-${String(N).padStart(2,"0")}`,ee=f[U]||[],x=U===L;C+=`
          <div class="cal-cell ${x?"cal-today":""} ${ee.length?"cal-has-events":""}"
               data-date="${U}" tabindex="0" role="button" aria-label="${U}">
            <div class="cal-day-num ${x?"today-num":""}">${N}</div>
            <div class="cal-events-preview">
              ${ee.slice(0,3).map(w=>`
                <div class="cal-event-dot cal-color-${w.color||"gray"}" title="${Qe(w.title||w.type)}">
                  <span class="cal-event-dot-label">${Pa(w.title||w.branch_name||w.type,18)}</span>
                </div>
              `).join("")}
              ${ee.length>3?`<div class="cal-more">+${ee.length-3} lagi</div>`:""}
            </div>
          </div>`}let D=(S+_)%7;if(D!==0)for(let N=0;N<7-D;N++)C+='<div class="cal-cell cal-cell-empty"></div>';C+="</div>",p.innerHTML=C,p.querySelectorAll(".cal-cell[data-date]").forEach(N=>{N.addEventListener("click",()=>{let U=N.dataset.date,ee=f[U]||[];if(!ee.length)return;let x=document.getElementById("cal-event-list"),w=new Date(U+"T00:00:00").toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});document.getElementById("cal-event-date").textContent=w,document.getElementById("cal-event-items").innerHTML=ee.map(I=>`
            <div class="cal-event-item cal-color-border-${I.color||"gray"}">
              <div class="cal-event-type">${La(I.type)}</div>
              <div class="cal-event-title">${Qe(I.title||"-")}</div>
              <div class="cal-event-branch">${Qe(I.branch_name||"")}</div>
              ${I.status?`<div class="cal-event-status">${Qe(I.status)}</div>`:""}
              ${I.days_remaining!==void 0?`<div class="cal-event-extra">Sisa: ${I.days_remaining} hari</div>`:""}
            </div>
          `).join(""),x.style.display="block"})})}catch(u){console.error("[Calendar] Render error:",u)}}return await m(!0),c}function Pa(t,e){return t?t.length>e?t.slice(0,e)+"\u2026":t:""}function Qe(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function La(t){return{schedule:"\u{1F5D3} Jadwal",reliever:"\u{1F504} Reliefer",cleaning:"\u{1F9F9} Cleaning",inspection:"\u{1F50E} Inspeksi",fogging:"\u{1F4A8} Fogging",contract_expiry:"\u{1F4CB} Kontrak Habis",issue:"\u26A0\uFE0F Permasalahan",training:"\u{1F4DA} Training",one_on_one:"\u{1F4AC} One on One",basecamp:"\u{1F4DD} Basecamp",supply:"\u{1F4E6} Permintaan"}[t]||t}B();async function Yt(t){let e=ge(),r=(e?.full_name||e?.username||"U")[0].toUpperCase(),l={superadmin:"#7C3AED",admin:"#2563EB",manager:"#0891B2",spv:"#059669",viewer:"#64748B"}[e?.role]||"#64748B";t.innerHTML=`
    <div class="page-header">
        ...
        <div class="card-body">
          <div class="import-info-box">
            ...
            <div class="import-sheet-list">
              ${Object.entries(ze).map(([b,{label:g}])=>`<span class="import-sheet-tag">\u{1F4C4} ${b} \u2192 ${g}</span>`).join("")}
            </div>
          </div>
  ...
  `;let e=null,r=null,a=0,l={upload:document.getElementById("step-upload"),validating:document.getElementById("step-validating"),preview:document.getElementById("step-preview"),importing:document.getElementById("step-importing"),summary:document.getElementById("step-summary")};function o(b){Object.entries(l).forEach(([g,y])=>{y.style.display=g===b?"":"none"})}document.getElementById("btn-backup-db")?.addEventListener("click",async()=>{let b=document.getElementById("btn-backup-db");b.disabled=!0,b.textContent="\u23F3 Memproses Backup...";try{let g=await v("/api/import/backup");if(g.ok){let y=new Blob([JSON.stringify(g.data,null,2)],{type:"application/json"}),k=URL.createObjectURL(y),f=document.createElement("a");f.href=k,f.download=`FCMS_Database_Backup_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(f),f.click(),document.body.removeChild(f),URL.revokeObjectURL(k),V("Backup berhasil diunduh!")}else Y("Gagal memproses backup: "+(g.data?.error||"Unknown error"))}catch(g){Y("Gagal memproses backup: "+g.message)}finally{b.disabled=!1,b.textContent="\u{1F4E6} Backup Database"}});let i=document.getElementById("btn-sync-google");i&&i.addEventListener("click",async()=>{if(!confirm("Peringatan: Mensinkronkan data dengan Google Sheets akan memperbarui dan menambahkan data baru dari Google Sheets ke dalam FCMS. Data yang sudah Anda buat di FCMS TIDAK akan terhapus. Lanjutkan?"))return;let b=i.innerHTML;i.innerHTML='<span class="spinner"></span> Menyinkronkan...',i.disabled=!0;try{let g=await v("/api/sync/google-sheets",{method:"POST"});g.ok?alert("Sinkronisasi Berhasil: "+(g.data?.message||"Data Karyawan & PIC telah diperbarui.")):alert("Gagal Sinkronisasi: "+(g.data?.error||"Unknown error"))}catch{alert("Terjadi kesalahan koneksi.")}finally{i.innerHTML=b,i.disabled=!1}}),document.getElementById("btn-download-template").addEventListener("click",()=>{ea(),V("Template Excel berhasil didownload!")});let c=document.getElementById("file-input"),n=document.getElementById("upload-zone");document.getElementById("btn-browse").addEventListener("click",b=>{b.stopPropagation(),c.click()}),c.addEventListener("change",b=>{b.target.files[0]&&s(b.target.files[0])}),n.addEventListener("dragover",b=>{b.preventDefault(),n.classList.add("drag-over")}),n.addEventListener("dragleave",()=>n.classList.remove("drag-over")),n.addEventListener("drop",b=>{b.preventDefault(),n.classList.remove("drag-over");let g=b.dataTransfer.files[0];g&&g.name.match(/\.xlsx?$/i)?s(g):Y("Hanya file .xlsx atau .xls yang didukung.")}),document.getElementById("btn-clear-file").addEventListener("click",()=>{e=null,c.value="",document.getElementById("file-info").style.display="none",n.style.display="",o("upload")});async function s(b){e=b,document.getElementById("file-name-display").textContent=`\u{1F4C4} ${b.name} (${(b.size/1024).toFixed(1)} KB)`,document.getElementById("file-info").style.display="flex",n.style.display="none",await m(b)}async function m(b){o("validating");let g=document.getElementById("validation-status"),y=document.getElementById("validation-bar");try{if(!window.XLSX)throw new Error("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");g.textContent="Membaca file Excel...",y.style.width="20%",await Me(200);let k=await b.arrayBuffer(),f=window.XLSX.read(k,{type:"array",cellDates:!0});g.textContent=`Memvalidasi ${f.SheetNames.length} sheet...`,y.style.width="50%",await Me(100),r=Zt(f),y.style.width="100%",g.textContent="Validasi selesai!",await Me(300),d()}catch(k){o("upload"),Y("Gagal memproses file: "+k.message),document.getElementById("file-info").style.display="flex",n.style.display="none"}}function d(){o("preview");let b=r.filter(C=>!C.skipped).length,g=r.reduce((C,K)=>C+K.total,0),y=r.reduce((C,K)=>C+K.valid,0),k=r.reduce((C,K)=>C+K.errorCount,0),f=g>0?Math.round(y/g*100):0;document.getElementById("preview-summary-badges").innerHTML=`
        ...
        <tbody>
          ${r.map((C,K)=>`
            <tr class="${C.errorCount>0?"row-error":C.skipped?"row-skipped":"row-ok"}">
              ...
              <td style="text-align:center">
                ${C.errorCount>0?`<button class="btn btn-ghost btn-sm btn-detail-error" data-idx="${K}">\u{1F50D} ${C.errorCount} Error</button>`:'<span class="text-muted">\u2013</span>'}
              </td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    `,S.querySelectorAll(".btn-detail-error").forEach(C=>{C.addEventListener("click",()=>{let K=r[Number(C.dataset.idx)];p(K)})});let _=document.getElementById("error-detail-section"),T=document.getElementById("error-detail-container");T.innerHTML="",_.style.display="none";let L=document.getElementById("btn-start-import");y===0?(L.disabled=!0,L.innerHTML="\u26A0\uFE0F Tidak Ada Data Valid"):(L.disabled=!1,k>0?(L.innerHTML=`\u{1F680} Import ${y} Data Valid (${k} dilewati)`,L.title="Baris error akan dilewati, baris valid tetap diimport"):L.innerHTML=`\u{1F680} Mulai Import ${y} Data`)}function p(b){let g=document.getElementById("error-detail-section"),y=document.getElementById("error-detail-container");g.style.display="";let k=b.errors.slice(0,100).map(f=>(Array.isArray(f.errors)?f.errors:[]).map(_=>{let T=typeof _=="object";return`
          <tr>
            <td style="text-align:center"><span class="badge badge-danger">Baris ${f.row}</span></td>
            <td><strong>${T?_.column:"\u2014"}</strong></td>
            <td><code style="font-size:.78rem;color:var(--text-secondary)">${T&&_.originalValue!==void 0?_.originalValue||"(kosong)":"\u2014"}</code></td>
            <td class="error-msg">${T?_.reason:_}</td>
            <td style="font-size:.78rem;color:var(--success)">
              ${T&&_.aliases?`Gunakan salah satu nama kolom:<br><em>${_.aliases}</em>`:T&&_.hint?_.hint:""}
            </td>
          </tr>
    ...
    `,g.scrollIntoView({behavior:"smooth",block:"start"})}document.getElementById("btn-back-to-upload").addEventListener("click",()=>{o("upload"),document.getElementById("file-info").style.display="none",n.style.display="",e=null,c.value=""}),document.getElementById("btn-download-log").addEventListener("click",()=>{if(!r)return;ta(r)?V("Log error berhasil didownload."):V("Tidak ada error untuk didownload.")}),document.getElementById("btn-start-import").addEventListener("click",()=>{let b=document.querySelector('input[name="dup-strategy"]:checked')?.value||"skip";u(b)});async function u(b){o("importing"),a=Date.now();let g=[];Fa.forEach(_=>{let T=r?.find(L=>L.module===_&&L.mapped?.length>0);T&&g.push(T)});let y=document.getElementById("import-steps-list");y.innerHTML=g.map(_=>`
    ...
    `).join("");let k=document.getElementById("import-bar"),f=document.getElementById("import-current-status"),S={totalSheets:g.length,totalRows:g.reduce((_,T)=>_+T.mapped.length,0),inserted:0,skipped:0,failed:0,moduleResults:[]};for(let _=0;_<g.length;_++){let T=g[_],L=document.getElementById(`step-icon-${T.module}`),C=document.getElementById(`step-status-${T.module}`);L.textContent="\u{1F504}",C.textContent="Mengimport...",f.textContent=`Mengimport ${T.label}...`,k.style.width=`${Math.round(_/g.length*100)}%`;try{let K=await v(`/api/import/${T.module}`,{method:"POST",body:JSON.stringify({rows:T.mapped,onDuplicate:b})});if(K.ok){let D=K.data;S.inserted+=D.inserted||0,S.skipped+=D.skipped||0,S.moduleResults.push({label:T.label,inserted:D.inserted||0,skipped:D.skipped||0,status:"ok"}),L.textContent="\u2705",C.innerHTML=`<span class="badge badge-success">${D.inserted||0} berhasil</span>${D.skipped>0?` <span class="badge badge-neutral">${D.skipped} skip</span>`:""}`}else S.failed++,S.moduleResults.push({label:T.label,inserted:0,skipped:0,status:"error",error:K.data?.error}),L.textContent="\u274C",C.innerHTML='<span class="badge badge-danger">Gagal</span>'}catch(K){S.failed++,S.moduleResults.push({label:T.label,inserted:0,skipped:0,status:"error",error:K.message}),L.textContent="\u274C",C.innerHTML='<span class="badge badge-danger">Gagal</span>'}await Me(150)}k.style.width="100%",f.textContent="Selesai!",await Me(400),be("schedule"),h(S)}function h(b){o("summary");let g=((Date.now()-a)/1e3).toFixed(1),y=b.failed===0;document.getElementById("summary-status-icon").innerHTML=`
  ...
  `;le({title:`Notifikasi (${$e.length})`,content:t,confirmText:"Tutup",onConfirm:(e,r)=>r()})}function oa(){let t=ge(),e=(t?.full_name||"U")[0].toUpperCase();document.getElementById("app").innerHTML=`
  ...
  `;let r=document.getElementById("sidebar"),a=document.getElementById("sidebar-overlay"),l=document.getElementById("topbar-menu-btn"),o=document.getElementById("sidebar-close"),i=()=>{r.classList.add("open"),a.classList.add("show")},c=()=>{r.classList.remove("open"),a.classList.remove("show")};l?.addEventListener("click",i),o?.addEventListener("click",c),a?.addEventListener("click",c),document.querySelectorAll(".nav-item").forEach(s=>s.addEventListener("click",c));function n(){let s=window.location.hash.replace("#","")||"/dashboard";document.querySelectorAll(".nav-item").forEach(p=>{let u=p.dataset.route;p.classList.toggle("active",s===u||u!=="/dashboard"&&s.startsWith(u))});let m=document.getElementById("topbar-title"),d=document.querySelector(".nav-item.active .nav-label");m&&d&&(m.textContent=d.textContent)}window.addEventListener("hashchange",n),n(),Oa(),document.getElementById("btn-fullscreen")?.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.()}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await v("/api/auth/logout",{method:"POST"}),Be(),Ke&&clearInterval(Ke),fe("/login")}),Ma(),Ka(),document.getElementById("btn-notif")?.addEventListener("click",s=>{s.preventDefault(),Ra()})}async function ja(){M("/login",({main:e})=>At(e)),M("/dashboard",R(({main:e})=>Dt(e))),M("/calendar",R(({main:e})=>Wt(e))),M("/employees",R(({main:e,params:r})=>Nt(e,r))),M("/contracts",R(({main:e,params:r})=>Ue(e,r))),M("/sp",R(({main:e})=>ia(e))),M("/mutasi",R(({main:e})=>sa(e))),M("/timeline",R(({main:e,params:r})=>Ot(e,r))),M("/issues",R(({main:e,params:r})=>Mt(e,r))),M("/one-on-one",R(({main:e,params:r})=>Kt(e,r))),M("/training",R(({main:e})=>Rt(e))),M("/relievers",R(({main:e,params:r})=>jt(e,r))),M("/reports/inspection",R(({main:e})=>qt(e))),M("/reports/cleaning",R(({main:e})=>Ht(e))),M("/reports/fogging",R(({main:e})=>Jt(e))),M("/reports/basecamp",R(({main:e})=>Ut(e))),M("/reports/supply",R(({main:e})=>bt(e,"supply"))),M("/sop",R(({main:e})=>Gt(e))),M("/checklist",R(({main:e})=>Qt(e))),M("/forms",R(({main:e})=>bt(e))),M("/users",R(({main:e})=>zt(e))),M("/branches",R(({main:e})=>Vt(e))),M("/profile",R(({main:e})=>Yt(e))),M("/settings/import",R(({main:e})=>aa(e)));let t=Ie();if(!t&&window.location.hash!=="#/login"&&fe("/login"),t){let e=await v("/api/auth/me");e.ok?(Pe(e.data.data),oa()):(Be(),fe("/login"))}window.addEventListener("fm:login",()=>{oa(),fe("/dashboard")}),yt()}ja();
