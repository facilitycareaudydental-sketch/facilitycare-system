...
try {
  ...
  for (let i = lines.length - 1; i >= 0; i--) {
    ...
    try {
      ...
      if (obj.type === 'USER_INPUT' && obj.content && obj.content.includes('begooooooo') && obj.content.includes('"success": true')) {
  ...
  if (jsonStr) {
    fs.writeFileSync('C:/Users/Facility Care/.gemini/antigravity/scratch/facilitycare-system/api/dump.json', jsonStr);
