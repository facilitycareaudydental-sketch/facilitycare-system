  ...
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      if (path.startsWith('/api/sop') || path.startsWith('/api/checklist') ||
        ...
        path.startsWith('/api/options') || path.startsWith('/api/audit-emp') || path.startsWith('/api/audit-clean-up-4') || path.startsWith('/api/audit-clean-up-3') || path.startsWith('/api/audit-emp-clean') || path.startsWith('/api/audit-emp-fixdates') || path.startsWith('/api/audit-emp-dupes') || path.startsWith('/api/audit-duplicates-2')) {
