    ...
    <div class="dashboard-wrap" id="dash-root">
      ...
      <div class="charts-row" style="grid-template-columns: 5fr 3fr 5fr;">
        ...
        <div class="chart-card">
          ...
          <div class="chart-canvas-wrap" style="height:150px;position:relative;margin-top:10px">
        ...
        <div class="chart-card" style="display:flex; flex-direction:column;">
          ...
          <div style="flex:1; display:flex; flex-direction:column; justify-content:center;">
            <div style="display:flex; align-items:center; justify-content:center; gap:0px; min-height:140px">
