var oa=Object.defineProperty;var at=(t,e)=>()=>(t&&(e=t(t=0)),e);var nt=(t,e)=>{for(var l in e)oa(t,l,{get:e[l],enumerable:!0})};var ke={};nt(ke,{API:()=>yt,CLIENT_SIDE_MAX_ROWS:()=>be,IS_DEVELOPMENT:()=>Pe,apiFetch:()=>k,clearToken:()=>Le,getToken:()=>Be,getUser:()=>he,setToken:()=>it,setUser:()=>Ne});function Be(){return localStorage.getItem("fm_token")}function it(t){localStorage.setItem("fm_token",t)}function Le(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function he(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Ne(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function k(t,e={}){let l=Be(),a={"Content-Type":"application/json",...l?{Authorization:`Bearer ${l}`}:{},...e.headers||{}};try{let s=`cb=${Date.now()}`,d=t.includes("?")?"&":"?",i=`${yt}${t}${d}${s}`,r=await fetch(i,{...e,headers:a}),n;try{let o=await r.text();try{n=JSON.parse(o)}catch{n={error:`Server Error (${r.status}): ${o.substring(0,80)}...`}}}catch{n={error:"Gagal membaca respon dari server"}}return r.status===401&&(Le(),window.location.hash="#/login"),{ok:r.ok,status:r.status,data:n}}catch(s){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${s.message})`}}}}var Pe,da,yt,be,F=at(()=>{Pe=!1,da="https://fm-operations-api.facilitycare-audydental.workers.dev",yt=da,be=1e4});var kt={};nt(kt,{confirmDialog:()=>Fe,createModal:()=>se});function se({title:t,content:e,onConfirm:l,onCancel:a,confirmText:s="Simpan",cancelText:d="Batal",size:i="md",confirmClass:r="btn-primary"}){let n={sm:"400px",md:"560px",lg:"720px",xl:"900px"},o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
  ...
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>pt(t)),document.getElementById("filter-jadwal-year")?.addEventListener("change",async l=>{let a=l.target.value;document.getElementById("jadwal-year-label").textContent=a;let s=document.getElementById("skel-jadwal"),d=document.getElementById("chart-jadwal");s&&(s.style.display="block",s.style.position="absolute"),d&&(d.style.display="none");let i=await re(`/api/dashboard/schedule-chart?year=${a}`,{},8e3);try{Dt(i)}catch(r){console.warn("ScheduleChart render:",r),ce("skel-jadwal","chart-jadwal")}}),document.getElementById("filter-insp-month")?.addEventListener("change",async l=>{let a=l.target.value,s=a?`/api/dashboard/inspection-bar?month=${a}`:"/api/dashboard/inspection-bar",d=document.getElementById("skel-insp"),i=document.getElementById("chart-insp");d&&(d.style.display="block",d.style.position="absolute"),i&&(i.style.display="none");let r=await re(s,{},8e3);try{It(r)}catch(n){console.warn("InspBar render:",n),ce("skel-insp","chart-insp")}}),t._skelTimeout=setTimeout(()=>ya(),5e3),await pt(t),t._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?pt(t):clearInterval(t._dashRefresh)},6e4)}async function pt(t){t._skelTimeout&&(clearTimeout(t._skelTimeout),t._skelTimeout=null);let[e,l,a,s,d,i,r,n,o,m,c,p]=await Promise.all([re("/api/dashboard/kpi",{},8e3),re("/api/dashboard/issues-trend",{},8e3),re("/api/dashboard/issues-summary",{},8e3),re("/api/dashboard/stats",{},8e3),re("/api/dashboard/calendar",[],8e3),re("/api/schedule?limit=10000",{data:[]},8e3),re("/api/employees?limit=10000",{data:[]},8e3),re("/api/contracts?limit=10000",{data:[]},8e3),re("/api/issues?limit=10000",{data:[]},8e3),re("/api/one-on-one?limit=10000",{data:[]},8e3),re("/api/dashboard/contracts-chart",{labels:[],data:[]},8e3),re(`/api/dashboard/schedule-chart?year=${document.getElementById("filter-jadwal-year")?.value||new Date().getFullYear()}`,{},8e3)]),g=document.getElementById("filter-insp-month"),y=g?g.value:"",u=y?`/api/dashboard/inspection-bar?month=${y}`:"/api/dashboard/inspection-bar",b=await re(u,{},8e3);if(e){let h=Array.isArray(i?.data)?i.data:Array.isArray(i)?i:[],_=Array.isArray(r?.data)?r.data:Array.isArray(r)?r:[],C=Array.isArray(n?.data)?n.data:Array.isArray(n)?n:[],S=Array.isArray(o?.data)?o.data:Array.isArray(o)?o:[],x=Array.isArray(m?.data)?m.data:Array.isArray(m)?m:[];e.employees&&(e.employees.current=_.filter(w=>St(w,"active")).length),e.contracts&&(e.contracts.current=C.filter(w=>dt(w,"active")).length),e.expiring30&&(e.expiring30={current:C.filter(w=>dt(w,"expiring30")).length}),e.issues&&(e.issues.current=S.filter(w=>xt(w,"open")).length),e.one_on_one&&(e.one_on_one.current=x.filter(w=>wt(w,"pending")).length),e.inspection_month&&(e.inspection_month.current=h.filter(w=>ot(w,"inspeksi")).length),e.cleaning_month&&(e.cleaning_month.current=h.filter(w=>ot(w,"gcdc")).length)}try{Et(e)}catch(h){console.warn("KPI render:",h)}try{$t(e)}catch(h){console.warn("MiniStats render:",h)}try{Dt(p)}catch(h){console.warn("ScheduleChart render:",h),ce("skel-jadwal","chart-jadwal")}try{fa(Array.isArray(a?.by_category)?a.by_category:[])}catch(h){console.warn("Donut render:",h),ce("skel-donut","chart-donut")}try{va(l)}catch(h){console.warn("Trend render:",h),ce("skel-trend","chart-trend")}try{It(b)}catch(h){console.warn("InspBar render:",h),ce("skel-insp","chart-insp")}try{let h=Array.isArray(s)?s:Array.isArray(s?.recent_issues)?s.recent_issues:[];Sa(h)}catch(h){console.warn("IssuesTable render:",h)}try{let h=Array.isArray(s?.expiring_contracts)?s.expiring_contracts:[];ka(c)}catch(h){console.warn("ContractsTable render:",h)}try{xa(Array.isArray(d)?d:[])}catch(h){console.warn("Agenda render:",h)}try{wa()}catch(h){console.warn("Quick Actions render:",h)}}function Et(t){let e=document.getElementById("kpi-row");if(!e)return;t=t||{};let l=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees?dash_filter=active",color:"kpi-blue",key:"employees",trendPct:"+2%",trendColor:"#10B981",points:"0,20 10,18 20,22 30,12 40,15 50,8 60,10 70,5 80,6 90,2 100,0"},{icon:"\u{1F504}",label:"Reliefer Aktif",sub:"Karyawan reliefer",href:"#/employees?dash_filter=reliefer",color:"kpi-purple",key:"reliever_total",trendPct:"0%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts?dash_filter=active",color:"kpi-green",key:"contracts",trendPct:"+1%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u23F3",label:"Kontrak Habis 30 Hari",sub:"Akan segera berakhir",href:"#/contracts?dash_filter=expiring30",color:"kpi-warn",key:"expiring30",trendPct:"+25%",trendColor:"#F59E0B",points:"0,25 20,22 40,24 60,15 80,18 100,5"},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues?dash_filter=open",color:"kpi-red",key:"issues",trendPct:"0%",trendColor:"#EF4444",points:"0,20 20,18 40,22 60,19 80,21 100,20"},{icon:"\u{1F4AC}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one?dash_filter=pending",color:"kpi-purple",key:"one_on_one",trendPct:"+8%",trendColor:"#10B981",points:"0,25 20,15 40,18 60,8 80,10 100,2"}];e.innerHTML=l.map(a=>{let s=pe(t[a.key]?.current,0);return`
    ...
    `}).join("");let r={id:"centerText",beforeDraw:function(n){let o=n.width,m=n.height,c=n.ctx;c.restore();let p=(m/80).toFixed(2);c.font="bold "+p+"em Inter",c.textBaseline="middle",c.fillStyle="#1E293B";let g=i.toString(),y=Math.round((o-c.measureText(g).width)/2),u=m/2;c.fillText(g,y,u-4),c.font="600 "+(p*.35).toFixed(2)+"em Inter",c.fillStyle="#64748B";let b="Total",h=Math.round((o-c.measureText(b).width)/2);c.fillText(b,h,u+10),c.save()}};ue.donut=new Chart(e,{type:"doughnut",data:{labels:s,datasets:[{data:d,backgroundColor:ct,borderWidth:2,borderColor:"#fff",hoverBorderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,animation:{duration:700},plugins:{legend:{display:!1},tooltip:{bodyFont:de,titleFont:{...de,weight:"700"},callbacks:{label:n=>` ${n.label}: ${n.parsed} kasus`}}},cutout:"75%"},plugins:[r]})}function va(t){ce("skel-trend","chart-trend");let e=document.getElementById("chart-trend");if(!e)return;Ee("trend"),t=t||{};let l=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],a=(t.labels||[]).map(i=>{if(!i||typeof i!="string")return"";try{let[r,n]=i.split("-");return(l[Number(n)-1]||n)+" "+String(r).slice(-2)}catch{return i}}),s=(t.open||[]).map(i=>pe(i)),d=(t.closed||[]).map(i=>pe(i));if(!a.length){Ke(e,"Belum ada data trend");return}ue.trend=new Chart(e,{type:"line",data:{labels:a,datasets:[{label:"Open",data:s,borderColor:"#EF4444",backgroundColor:"rgba(239,68,68,.08)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#EF4444",borderWidth:2},{label:"Closed",data:d,borderColor:"#10B981",backgroundColor:"rgba(16,185,129,.1)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#10B981",borderWidth:2}]},options:We({plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{family:"Inter",size:9},color:me,maxRotation:0,autoSkip:!1}},y:{grid:{color:Te},ticks:{font:{family:"Inter",size:9},color:me},beginAtZero:!0}}})})}function Dt(t){ce("skel-jadwal","chart-jadwal");let e=document.getElementById("chart-jadwal");if(!e)return;Ee("jadwal"),t=t||{};let l=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"];if(!Object.values(t).some(n=>Array.isArray(n)&&n.some(o=>o>0))){Ke(e,"Belum ada data jadwal");return}let s=t["Inspeksi Hygiene"]||Array(12).fill(0),d=t["General Cleaning"]||Array(12).fill(0),i=t["Deep Cleaning"]||Array(12).fill(0),r=t.Fogging||Array(12).fill(0);ue.jadwal=new Chart(e,{type:"bar",data:{labels:l,datasets:[{label:"Inspeksi",data:s,backgroundColor:"#3B82F6"},{label:"General Cleaning",data:d,backgroundColor:"#10B981"},{label:"Deep Cleaning",data:i,backgroundColor:"#F59E0B"},{label:"Fogging",data:r,backgroundColor:"#EF4444"}]},options:We({plugins:{legend:{display:!1}},datasets:{bar:{barPercentage:.85,categoryPercentage:.9}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{family:"Inter",size:9},color:me,maxRotation:0,autoSkip:!1}},y:{stacked:!0,grid:{color:Te},ticks:{font:{family:"Inter",size:9},color:me},min:0}}})})}function It(t){ce("skel-insp","chart-insp");let e=document.getElementById("chart-insp");if(!e)return;Ee("inspBar"),t=t||{};let l=t.labels||[],a=(t.fc||[]).map(d=>pe(d)),s=(t.spv||[]).map(d=>pe(d));if(!l.length){Ke(e,"Belum ada data inspeksi");return}ue.inspBar=new Chart(e,{type:"bar",data:{labels:l,datasets:[{label:"Skor FC",data:a,backgroundColor:"rgba(37,99,235,.75)",borderRadius:4,borderSkipped:!1},{label:"Skor SPV",data:s,backgroundColor:"rgba(16,185,129,.75)",borderRadius:4,borderSkipped:!1}]},options:We({plugins:{legend:{position:"top"}},scales:{x:{grid:{display:!1},ticks:{font:de,color:me,maxRotation:45,minRotation:30}},y:{grid:{color:Te},ticks:{font:de,color:me},min:0,max:100}}})})}function ka(t){ce("skel-contract-mini","chart-contract-mini");let e=document.getElementById("chart-contract-mini");if(!e)return;Ee("contractMiniBar"),t=t||{};let l={"06":"Jun","07":"Jul","08":"Agu","09":"Sep",10:"Okt",11:"Nov",12:"Des"},a=(t.labels||[]).map(i=>{let r=i.split("-")[1];return l[r]||i}),s=(t.data||[]).map(i=>pe(i));if(!a.length){Ke(e,"Belum ada data");return}let d=e.getContext("2d");ue.contractMiniBar=new Chart(e,{type:"bar",data:{labels:a,datasets:[{label:"Kontrak Habis",data:s,backgroundColor:"#3B82F6",borderRadius:4,borderSkipped:!1,barPercentage:.6,categoryPercentage:.7}]},options:We({onClick:(i,r)=>{if(r&&r.length>0){let n=r[0].index,o=(t.labels||[])[n];o&&(window.location.hash="#/contracts?month_expiry="+o)}},plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:de,color:me,maxRotation:0,autoSkip:!1}},y:{grid:{color:Te,borderDash:[4,4],drawBorder:!1},ticks:{font:de,color:me,precision:0,maxTicksLimit:5},min:0}},animation:{y:{duration:1e3,easing:"easeOutQuart"}}})})}function Sa(t){let e=document.getElementById("table-issues");if(!e)return;let l=(t||[]).slice(0,8);if(!l.length){e.innerHTML='<div class="chart-empty">\u2705 Tidak ada permasalahan terbuka</div>';return}e.innerHTML=`
    <div class="dash-list">
      ${l.map(a=>`
