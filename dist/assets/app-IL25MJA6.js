var fa=Object.defineProperty;var dt=(t,e)=>()=>(t&&(e=t(t=0)),e);var ct=(t,e)=>{for(var i in e)fa(t,i,{get:e[i],enumerable:!0})};var Le={};ct(Le,{API:()=>Et,CLIENT_SIDE_MAX_ROWS:()=>Se,IS_DEVELOPMENT:()=>$e,apiFetch:()=>k,clearToken:()=>We,getToken:()=>Qe,getUser:()=>oe,setToken:()=>pt,setUser:()=>Ve});function Qe(){return localStorage.getItem("fm_token")}function pt(t){localStorage.setItem("fm_token",t)}function We(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function oe(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Ve(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function k(t,e={}){let i=Qe(),a={"Content-Type":"application/json",...i?{Authorization:`Bearer ${i}`}:{},...e.headers||{}};try{let o=`cb=${Date.now()}`,d=t.includes("?")?"&":"?",l=`${Et}${t}${d}${o}`,n=await fetch(l,{...e,headers:a}),s;try{let r=await n.text();try{s=JSON.parse(r)}catch{s={error:`Server Error (${n.status}): ${r.substring(0,80)}...`}}}catch{s={error:"Gagal membaca respon dari server"}}return n.status===401&&(We(),window.location.hash="#/login"),{ok:n.ok,status:n.status,data:s}}catch(o){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${o.message})`}}}}var $e,va,Et,Se,j=dt(()=>{$e=!1,va="https://fm-operations-api.facilitycare-audydental.workers.dev",Et=va,Se=1e4});var mt={};ct(mt,{confirmDialog:()=>Ee,createModal:()=>de});function de({title:t,content:e,onConfirm:i,onCancel:a,confirmText:o="Simpan",cancelText:d="Batal",size:l="md",confirmClass:n="btn-primary"}){let s={sm:"400px",md:"560px",lg:"720px",xl:"900px"},r=document.createElement("div");r.className="modal-overlay",r.innerHTML=`
  ...
  `,e instanceof HTMLElement&&r.querySelector(".modal-body").appendChild(e);let h=()=>{r.classList.remove("show"),setTimeout(()=>r.remove(),250)};return r.querySelector(".modal-close").addEventListener("click",()=>{a&&a(),h()}),r.querySelector(".modal-cancel").addEventListener("click",()=>{a&&a(),h()}),i&&r.querySelector(".modal-confirm").addEventListener("click",()=>i(r,h)),r.addEventListener("click",p=>{p.target===r&&(a&&a(),h())}),document.body.appendChild(r),requestAnimationFrame(()=>r.classList.add("show")),{overlay:r,close:h}}function Ee(t,e,i="Konfirmasi"){return de({title:i,content:`<p>${t}</p>`,onConfirm:(a,o)=>{e(),o()},confirmText:"Ya, Lanjutkan",confirmClass:"btn-danger"})}var we=dt(()=>{});var ce={};ct(ce,{downloadExcel:()=>R,parseExcel:()=>De,renderExcelButtons:()=>Ie});function De(t){return new Promise((e,i)=>{let a=new FileReader;a.onload=o=>{try{let d=new Uint8Array(o.target.result),l=XLSX.read(d,{type:"array"}),n=l.SheetNames[0],s=l.Sheets[n];console.log("--- START EXCEL PARSING ---"),console.log(`File Name: ${t.name}`),console.log(`File Size: ${(t.size/1024).toFixed(2)} KB`),console.log(`File Type: ${t.type||"unknown"}`),console.log(`Sheets Found: ${l.SheetNames.join(", ")}`),console.log(`Sheet Used: ${n}`);let r=XLSX.utils.decode_range(s["!ref"]||"A1:A1"),h=r.e.r-r.s.r+1,p=r.e.c-r.s.c+1;console.log(`Total Rows (including empty): ${h}`),console.log(`Total Columns: ${p}`);let u=[];for(let y=r.s.c;y<=r.e.c;++y){let g=s[XLSX.utils.encode_cell({c:y,r:r.s.r})];g&&g.v&&u.push(g.v)}console.log(`Headers Found: ${u.join(", ")}`),console.log("---------------------------");let m=XLSX.utils.sheet_to_json(s,{defval:""});Object.defineProperty(m,"__worksheet",{value:s,enumerable:!1}),Object.defineProperty(m,"__headers",{value:u,enumerable:!1}),e(m)}catch(d){i(d)}},a.onerror=o=>i(o),a.readAsArrayBuffer(t)})}function R(t,e){try{let i=XLSX.utils.json_to_sheet(t),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,i,"Data"),XLSX.writeFile(a,`${e}.xlsx`)}catch(i){throw console.error("Error generating Excel file:",i),i}}function Ie(t){return`
  ...
  `}var G=dt(()=>{});j();var ut={},at=null;function Y(t,e){ut[t]=e}function Pe(t){window.location.hash=t}function Tt(){async function t(){let e=window.location.hash.replace("#","")||"/dashboard",[i,...a]=e.split("?"),o=ut[i];if(!o){for(let[l,n]of Object.entries(ut))if(l.endsWith("/*")&&i.startsWith(l.slice(0,-2))){o=n;break}}at&&(at(),at=null);let d=document.getElementById("main-content");if(d&&(d.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),o){let l=new URLSearchParams(a.join("?")),n=i.split("/").filter(Boolean),s=await o({path:i,params:l,segments:n,main:d});s&&(at=s)}else{let l=d||document.getElementById("app");l&&(l.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",t),t()}var Ye;function ka(){return Ye||(Ye=document.createElement("div"),Ye.id="toast-container",document.body.appendChild(Ye)),Ye}function Dt(t,e="info",i=3500){let a=ka(),o=document.createElement("div");o.className=`toast toast-${e}`;let d={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};o.innerHTML=`<span class="toast-icon">${d[e]||"\u2139"}</span><span class="toast-msg">${t}</span>`,a.appendChild(o),requestAnimationFrame(()=>o.classList.add("show")),setTimeout(()=>{o.classList.remove("show"),setTimeout(()=>o.remove(),350)},i)}var ne=t=>Dt(t,"success"),z=t=>Dt(t,"error");we();j();j();we();function Be({columns:t,data:e,onEdit:i,onDelete:a,onView:o,actions:d=[],emptyText:l="Tidak ada data",bulkSelect:n=null}){let s=document.createElement("div");if(s.className="table-wrapper",!e||e.length===0)return s.innerHTML=`<div class="empty-state"><p>${l}</p></div>`,s;let r=document.createElement("table");r.className="data-table";let h=document.createElement("thead"),p=document.createElement("tr");if(n){let m=document.createElement("th");m.style.width="40px",m.style.textAlign="center";let y=document.createElement("input");y.type="checkbox",y.id="select-all-checkbox",y.title="Pilih semua",y.addEventListener("change",()=>{e.forEach(g=>{y.checked?n.selectedIds.add(g.id):n.selectedIds.delete(g.id)}),s.querySelectorAll(".row-checkbox").forEach(g=>g.checked=y.checked),n.onToggle()}),m.appendChild(y),p.appendChild(m)}if(t.forEach(m=>{let y=document.createElement("th");y.textContent=m.label,m.width&&(y.style.width=m.width),p.appendChild(y)}),i||a||o||d.length>0){let m=document.createElement("th");m.textContent="Aksi",m.style.width="120px",p.appendChild(m)}h.appendChild(p),r.appendChild(h);let u=document.createElement("tbody");return e.forEach(m=>{let y=document.createElement("tr");if(n){let g=document.createElement("td");g.style.textAlign="center",g.style.width="40px";let f=document.createElement("input");f.type="checkbox",f.className="row-checkbox",f.checked=n.selectedIds.has(m.id),f.addEventListener("change",()=>{if(f.checked)n.selectedIds.add(m.id);else{n.selectedIds.delete(m.id);let v=document.getElementById("select-all-checkbox");v&&(v.checked=!1)}n.onToggle()}),g.appendChild(f),y.appendChild(g)}if(t.forEach(g=>{let f=document.createElement("td");if(g.render){let v=g.render(m[g.key],m);v instanceof HTMLElement?f.appendChild(v):f.innerHTML=v||""}else f.textContent=m[g.key]!==null&&m[g.key]!==void 0&&m[g.key]!==""?m[g.key]:"";g.nowrap&&(f.style.whiteSpace="nowrap"),y.appendChild(f)}),i||a||o||d.length>0){let g=document.createElement("td");g.className="actions-cell";let f=document.createElement("div");if(f.className="btn-group",o){let v=document.createElement("button");v.className="btn btn-xs btn-ghost",v.innerHTML="\u{1F441}",v.title="Lihat",v.addEventListener("click",()=>o(m)),f.appendChild(v)}if(i){let v=document.createElement("button");v.className="btn btn-xs btn-secondary",v.innerHTML="\u270F\uFE0F",v.title="Edit",v.addEventListener("click",()=>i(m)),f.appendChild(v)}d.forEach(v=>{let S=document.createElement("button");S.className=`btn btn-xs ${v.class||"btn-ghost"}`,S.innerHTML=v.icon||v.label,S.title=v.label,S.addEventListener("click",()=>v.handler(m)),f.appendChild(S)}),g.appendChild(f),y.appendChild(g)}u.appendChild(y)}),r.appendChild(u),s.appendChild(r),s}function Ae({page:t,pages:e,total:i,limit:a,onPage:o}){if(e<=1)return null;let d=document.createElement("div");d.className="pagination";let l=document.createElement("span");l.className="pagination-info",l.textContent=`Total: ${i} data`,d.appendChild(l);let n=document.createElement("div");n.className="pagination-btns";let s=(p,u,m=!1,y=!1)=>{let g=document.createElement("button");g.className=`btn btn-sm ${y?"btn-primary":"btn-ghost"} pagination-btn`,g.textContent=p,g.disabled=m,g.addEventListener("click",()=>o(u)),n.appendChild(g)};s("\xAB",1,t===1),s("\u2039",t-1,t===1);let r=Math.max(1,t-2),h=Math.min(e,t+2);for(let p=r;p<=h;p++)s(p,p,!1,p===t);return s("\u203A",t+1,t===e),s("\xBB",e,t===e),d.appendChild(n),d}we();function Te(t){return t.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="html")return e.html||"";if(e.type==="row")return`<div class="form-row">${Te(e.fields)}</div>`;let i=e.required?"required":"",a=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",o="";switch(e.type){case"textarea":o=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${i} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let l=(e.options||[]).map(p=>{let u=typeof p=="object"?p.value:p,m=typeof p=="object"?p.label:p,y=e.value==u?"selected":"";return`<option value="${u}" ${y}>${m}</option>`}).join("");o=`<select name="${e.name}" class="form-control" ${i}><option value="">-- Pilih ${e.label||""} --</option>${l}</select>`;break;case"combobox":let n=`dl-${e.name}-${Math.random().toString(36).substring(7)}`,s=(e.options||[]).map(p=>{let u=typeof p=="object"?p.value:p,m=typeof p=="object"?p.label||p.value||"":p||"";return(m==="undefined"||m==="[object Object]"||m==="null")&&(m=""),m?`<option value="${m}"></option>`:""}).join(""),r=e.value||"";if(e.value){let p=(e.options||[]).find(u=>(typeof u=="object"?u.value:u)==e.value);if(p){let u=typeof p=="object"?p.label||p.value||"":p||"";u&&u!=="undefined"&&u!=="[object Object]"&&u!=="null"&&(r=u)}}o=`
          <input type="text" name="${e.name}" list="${n}" class="form-control" value="${r}" placeholder="Pilih atau ketik baru..." ${i} autocomplete="off">
          <datalist id="${n}">${s}</datalist>
        `;break;case"checkbox":o=`<label class="checkbox-label"><input type="checkbox" name="${e.name}" value="1" ${e.value?"checked":""}> ${e.checkLabel||e.label}</label>`;break;case"date":let h=window.parseFlexibleDate&&e.value?window.parseFlexibleDate(e.value):e.value||"";o=`<input type="date" name="${e.name}" class="form-control" value="${h}" ${i}>`;break;case"number":o=`<input type="number" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" min="${e.min||""}" max="${e.max||""}" step="${e.step||"1"}" ${i}>`;break;case"email":o=`<input type="email" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${i}>`;break;case"url":o=`<input type="url" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||"https://..."}" ${i}>`;break;default:o=`<input type="${e.type||"text"}" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${i} autocomplete="off">`}let d=e.hint?`<div class="form-hint">${e.hint}</div>`:"";return`<div class="form-group ${e.class||""}">${a}${o}${d}</div>`}).join("")}function Me(t){let e={},i=new FormData(t);for(let[a,o]of i.entries())e[a]=o===""?null:o;return t.querySelectorAll("input[type=checkbox]").forEach(a=>{a.checked||(e[a.name]=null)}),e}function Ne(t,e){e&&Object.entries(e).forEach(([i,a])=>{let o=t.querySelector(`[name="${i}"]`);o&&(o.hasAttribute("list")||(o.type==="checkbox"?o.checked=!!a:o.type==="date"&&a&&window.parseFlexibleDate?o.value=window.parseFlexibleDate(a):o.value=a??""))})}G();function gt({container:t,title:e,icon:i,apiPath:a,columns:o,formFields:d,filterFields:l,defaultFilters:n={},enableMobileFilterSheet:s=!1,itemLabel:r="Data",canCreate:h=!0,canEdit:p=!0,canDelete:u=!0,onBeforeSubmit:m,onAfterLoad:y,onDataLoaded:g,extraActions:f=[],initialSearch:v="",exportOptions:S=null,bulkDelete:D=!1,paginationMode:C="server"}){let B=oe();B&&typeof B=="object"&&B.role==="viewer"&&(h=!1,p=!1,u=!1,D=!1,S=null);let $=1,L={...n};v&&(L.search=v);let E=new Set;t.innerHTML=`
    <div class="crud-layout-wrapper ${s?"mobile-active":""}">
      <div class="page-header">
      <h1 class="page-title">${i} ${e}</h1>
      <div class="page-actions">
        ${h?`<button class="btn btn-primary" id="btn-create">+ Tambah ${r}</button>`:""}
    ...
    <div class="filter-bar card ${s?"has-mobile-sheet":""}" style="padding: 1rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
        ${l.filter(c=>c.type==="search"||c.type==="search-combo").map(c=>{if(c.type==="search")return`<div class="filter-search" style="flex:1; min-width:120px;"><input type="text" class="form-control" autocomplete="off" placeholder="${c.placeholder||"Cari..."}" id="filter-search" value="${L.search||""}"></div>`;if(c.type==="search-combo"){let b="dl-filter-search",w=(c.options||[]).map(x=>`<option value="${typeof x=="object"?x.label:x}"></option>`).join("");return`<div class="filter-search" style="flex:1; min-width:120px;"><input type="text" list="${b}" class="form-control" autocomplete="off" placeholder="${c.placeholder||"Cari..."}" id="filter-search" value="${L.search||""}"><datalist id="${b}">${w}</datalist></div>`}return""}).join("")}
        ...
        <div class="filter-options" id="filter-options-wrapper">
          ...
          ${l.filter(c=>c.type!=="search"&&c.type!=="search-combo").map(c=>{if(c.type==="select")return`<select class="form-control filter-select" style="flex:1; min-width:100px;" name="${c.name}" id="filter-${c.name}"><option value="">Pilih ${c.label}</option>${(c.options||[]).map(b=>`<option value="${typeof b=="object"?b.value:b}" ${L[c.name]===(typeof b=="object"?b.value:b)?"selected":""}>${typeof b=="object"?b.label:b}</option>`).join("")}</select>`;if(c.type==="combobox"){let b=`dl-filter-${c.name}`,w=(c.options||[]).map(T=>{let _=typeof T=="object"?T.label||T.value||"":T||"";return(_==="undefined"||_==="[object Object]"||_==="null")&&(_=""),_?`<option value="${_}"></option>`:""}).join(""),x=L[c.name]||"";if(L[c.name]){let T=(c.options||[]).find(_=>String(typeof _=="object"?_.value:_)==String(L[c.name]));if(T){let _=typeof T=="object"?T.label||T.value||"":T||"";_&&_!=="undefined"&&_!=="[object Object]"&&_!=="null"&&(x=_)}}return`<div class="filter-combobox" style="flex:1; min-width:120px;">
                <input type="text" name="${c.name}" id="filter-${c.name}" list="${b}" class="form-control filter-combobox-input" value="${x}" placeholder="Pilih ${c.label}..." autocomplete="off">
  ...
  `;function F(){let c=document.getElementById("bulk-toolbar");if(!c)return;let b=document.getElementById("bulk-count"),w=document.getElementById("btn-bulk-delete"),x=document.getElementById("btn-bulk-cancel");b.textContent=`${E.size} item dipilih`,E.size>0?(c.style.display="flex",c.classList.add("has-items"),w.disabled=!1,x.disabled=!1,window.innerWidth<=768?(c.style.setProperty("top","auto","important"),c.style.setProperty("bottom","0","important")):(c.style.removeProperty("top"),c.style.removeProperty("bottom"))):(c.style.display="none",c.classList.remove("has-items"),w.disabled=!0,x.disabled=!0)}document.getElementById("btn-bulk-cancel")?.addEventListener("click",()=>{E.clear(),document.querySelectorAll(".row-checkbox").forEach(b=>b.checked=!1);let c=document.getElementById("select-all-checkbox");c&&(c.checked=!1),F()}),document.getElementById("btn-bulk-delete")?.addEventListener("click",()=>{if(E.size===0)return;let c=[...E],b=document.createElement("div");b.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9999;display:flex;align-items:center;justify-content:center",b.innerHTML=`
      <div style="background:var(--bg-card);border-radius:var(--radius-xl);padding:28px;max-width:420px;width:90%;box-shadow:var(--shadow-lg);animation:fadeInUp .2s ease">
        <h3 style="margin:0 0 8px;color:var(--text-1);font-size:1rem;font-weight:700">\u26A0\uFE0F Hapus ${c.length} ${r}?</h3>
    ...
    `,document.body.appendChild(b),b.querySelector("#bulk-cancel-btn").addEventListener("click",()=>b.remove()),b.querySelector("#bulk-confirm-btn").addEventListener("click",async()=>{let w=b.querySelector("#bulk-confirm-btn");w.disabled=!0,w.textContent="Menghapus...";let x=await k(`${a}/bulk`,{method:"DELETE",body:JSON.stringify({ids:c})});b.remove(),x.ok?(ne(`${c.length} ${r} berhasil dihapus.`),E.clear(),F(),q()):z(x.data?.error||"Gagal menghapus data.")})});let K=document.getElementById("filter-search"),ue;K?.addEventListener("input",c=>{clearTimeout(ue),ue=setTimeout(()=>{L.search=c.target.value,$=1,E.clear(),q()},400)}),l?.forEach(c=>{c.type==="select"&&document.getElementById(`filter-${c.name}`)?.addEventListener("change",b=>{L[c.name]=b.target.value,$=1,E.clear(),q()}),c.type==="combobox"&&document.getElementById(`filter-${c.name}`)?.addEventListener("change",b=>{let w=b.target.value,x=(c.options||[]).find(T=>{let _=String(typeof T=="object"?T.value:T),P=String(typeof T=="object"?T.label:T);return _===w||P===w});w?L[c.name]=x?typeof x=="object"?x.value:x:w:L[c.name]="",$=1,E.clear(),q()})}),document.getElementById("btn-reset-filter")?.addEventListener("click",()=>{L={...n},K&&(K.value=""),l?.forEach(c=>{let b=document.getElementById(`filter-${c.name}`);b&&(b.value="")}),$=1,E.clear(),q()});let me=document.getElementById("btn-mobile-filter"),ie=document.getElementById("filter-options-wrapper"),ge=document.getElementById("btn-close-filter-sheet");if(me&&ie){me.addEventListener("click",b=>{b.preventDefault(),ie.classList.add("sheet-open")}),ge&&ge.addEventListener("click",b=>{b.preventDefault(),ie.classList.remove("sheet-open")});let c=document.getElementById("btn-apply-filter");c&&c.addEventListener("click",b=>{b.preventDefault(),ie.classList.remove("sheet-open")})}let pe=document.getElementById("btn-mobile-aksi"),be=document.getElementById("excel-actions-wrapper"),_e=document.getElementById("btn-close-aksi-sheet");if(pe&&be&&(pe.addEventListener("click",c=>{c.preventDefault(),be.classList.add("sheet-open")}),_e&&_e.addEventListener("click",c=>{c.preventDefault(),be.classList.remove("sheet-open")})),document.getElementById("btn-create")?.addEventListener("click",()=>Ce(null)),S){document.getElementById(`btn-export-${S.moduleName}`)?.addEventListener("click",async b=>{let w=b.target,x=w.innerHTML;w.innerHTML="\u23F3 Loading...",w.disabled=!0;try{await S.onExport()}catch{z("Gagal export data")}finally{w.innerHTML=x,w.disabled=!1}}),document.getElementById(`btn-template-${S.moduleName}`)?.addEventListener("click",()=>{S.onTemplate()});let c=document.getElementById(`input-import-${S.moduleName}`);c?.addEventListener("change",async b=>{let w=b.target.files[0];if(!w)return;c.disabled=!0;let x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.7);z-index:9999;display:flex;align-items:center;justify-content:center",x.innerHTML=`
      ...
      `,document.body.appendChild(x);let T=x.querySelector("#import-progress-text"),_=x.querySelector("#import-progress-bar"),P=x.querySelector("#import-summary"),A=x.querySelector("#import-close-btn");A.addEventListener("click",()=>{x.remove(),q()});try{let W=await De(w);if(W.length===0)throw new Error("File kosong atau format salah");let V=500,ae=0,Z=0,M=0,N=W.length;T.textContent=`Ditemukan ${N} baris data. Memulai import...`;for(let I=0;I<N;I+=V){let J=W.slice(I,I+V);T.textContent=`Mengimport baris ${I+1} - ${Math.min(I+V,N)} dari ${N}...`,_.style.width=`${Math.round(I/N*100)}%`;try{let O=await S.onImport(J);O?(ae+=O.inserted||O.metrics?.inserted||J.length,Z+=O.skipped||O.metrics?.updated||0):ae+=J.length}catch(O){console.error("Chunk import failed:",O),M+=J.length}}_.style.width="100%",T.innerHTML='<strong style="color:var(--success)">\u2705 Import Selesai!</strong>',P.style.display="block",P.innerHTML=`
          <div style="display:flex;justify-content:space-between;margin-bottom:8px"><span>Total Data:</span> <strong>${N}</strong></div>
        ...
        `,M>0&&(P.innerHTML+='<p style="margin-top:12px;font-size:0.8rem;color:var(--danger)">Sebagian data gagal diimport. Pastikan format kolom sesuai template dan tidak ada data kosong pada kolom wajib.</p>'),A.style.display="block",c.value=""}catch(W){T.innerHTML=`<strong style="color:var(--danger)">\u274C Gagal Memproses File</strong><br>${W.message}`,_.style.background="var(--danger)",_.style.width="100%",A.style.display="block",c.value=""}finally{c.disabled=!1}})}async function q(){F();let c=document.getElementById("table-container");if(!c)return;c.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';let b=C==="client",w=b?1:$,x=b?Se:20,T=new URLSearchParams({page:w,limit:x,...Object.fromEntries(Object.entries(L).filter(([,M])=>M))}),_=await k(`${a}?${T}`);if(!_.ok){c.innerHTML=`<div class="empty-state"><p class="text-danger">Gagal memuat data: ${_.data?.error||"Error"}</p></div>`;return}let P=_.data?.data||_.data||[],A=_.data?.pagination,W=P.length,V=P;if(b){P=g(P),V=P;let M=P.length,N=20,I=Math.ceil(M/N);$>I&&I>0&&($=I);let J=($-1)*N,O=$*N;P=P.slice(J,O),A={page:$,limit:N,total:M,pages:I}}!1,y&&y(P);let ae=Be({columns:o,data:P,fullData:V,onEdit:p?M=>Ce(M):null,actions:f.map(M=>({...M,handler:N=>M.handler(N,q)})),emptyText:`Tidak ada ${String(r||"").toLowerCase()}`,bulkSelect:D?{selectedIds:E,onToggle:F}:null});c.innerHTML="",c.appendChild(ae);let Z=document.getElementById("pagination-container");if(Z&&(Z.innerHTML="",A&&A.pages>1)){let M=Ae({page:A.page,pages:A.pages,total:A.total,limit:A.limit,onPage:N=>{$=N,q()}});M&&Z.appendChild(M)}}function Ge(c){let b=typeof d=="function"?d(c):d;return Te(b)}function Ce(c){let b=!!c,w=document.createElement("form");if(w.noValidate=!0,w.innerHTML=Ge(c),b){let T=typeof d=="function"?d(c):d;Ne(w,c)}let{close:x}=de({title:b?`Edit ${r}`:`Tambah ${r}`,content:w,size:"lg",confirmText:b?"Simpan Perubahan":`Tambah ${r}`,onConfirm:async(T,_)=>{if(!w.reportValidity())return;let P=T.querySelector(".modal-confirm");P.disabled=!0,P.textContent="Menyimpan...";let A=Me(w),W=typeof d=="function"?d(c):d,V=async N=>{for(let I of N)if(I.type==="row")await V(I.fields);else if(I.type==="combobox"&&A[I.name]){let J=A[I.name],O=(I.options||[]).find(U=>{let ee=String(typeof U=="object"?U.value:U),ze=String(typeof U=="object"?U.label:U);return ee===J||ze===J});if(O)A[I.name]=typeof O=="object"?O.value:O;else if(I.createApi){let U={};U[I.createApi.field]=J,I.createApi.extra&&Object.assign(U,I.createApi.extra);let ee=await k(I.createApi.path,{method:"POST",body:JSON.stringify(U)});if(ee.ok&&ee.data?.id)A[I.name]=ee.data.id;else if(ee.ok&&!ee.data?.id)A[I.name]=J;else throw new Error(`Gagal membuat master data: ${ee.data?.error||"Unknown error"}`)}}};try{await V(W)}catch(N){z(N.message),P.disabled=!1,P.textContent=b?"Simpan Perubahan":`Tambah ${r}`;return}m&&(A=await m(A,c));let ae=b?"PUT":"POST",Z=b?`${a}/${c.id}`:a,M=await k(Z,{method:ae,body:JSON.stringify(A)});M.ok?(ne(b?`${r} berhasil diperbarui.`:`${r} berhasil ditambahkan.`),_(),q()):(z(M.data?.error||"Gagal menyimpan data."),P.disabled=!1,P.textContent=b?"Simpan Perubahan":`Tambah ${r}`)}})}function $t(c){Ee(`Hapus ${r} ini? Tindakan tidak dapat dibatalkan.`,async()=>{let b=await k(`${a}/${c.id}`,{method:"DELETE"});b.ok?(ne(`${r} berhasil dihapus.`),q()):z(b.data?.error||"Gagal menghapus.")},`Hapus ${r}`)}return q(),q}j();j();var Fe=null,nt=null;async function Oe(t=!1){if(Fe&&!t)return console.log("Employees Raw (Cache Hit)",Fe.slice(0,5)),Fe;let e=await k(`/api/employees?limit=${Se}&status=Aktif`);return Fe=(e.data?.data||[]).map(i=>({value:i.id,label:i.full_name})),console.log("Employees Raw",e.data?.data?.slice(0,5)),console.log("Employees Mapped (ID)",Fe.slice(0,5)),Fe}async function le(t=!1){let i=(await Oe(t)).map(a=>({value:a.label,label:a.label}));return console.log("Employee Options",i.slice(0,5)),i}async function Q(t=!1){return nt&&!t||(nt=((await k("/api/branches?all=1")).data?.data||[]).map(i=>({value:i.id,label:i.full_name}))),nt}function X(t){let e={Done:"badge-success",Aktif:"badge-success",Open:"badge-warning","In Progress":"badge-info",Pending:"badge-warning",Diproses:"badge-info",Selesai:"badge-success","Tidak Aktif":"badge-neutral",Resign:"badge-neutral",Cut:"badge-danger","Tidak Datang":"badge-danger"};return!t||t==="-"||String(t).trim()===""?"":`<span class="badge ${e[t]||"badge-neutral"}">${t}</span>`}function bt(t){return t==null?'<span class="badge badge-neutral">-</span>':t<0?`<span class="badge badge-danger">Expired (${Math.abs(t)}h)</span>`:t<=14?`<span class="badge badge-danger">${t} hari</span>`:t<=30?`<span class="badge badge-warning">${t} hari</span>`:`<span class="badge badge-success">${t} hari</span>`}function Re(t){return`<span class="badge ${{"FACILITY CARE":"badge-info",SECURITY:"badge-secondary"}[t]||"badge-neutral"}">${t||"-"}</span>`}function ht(t){return`<span class="badge ${{"Inspeksi Hygiene & Aset Bangunan":"badge-info","General Cleaning":"badge-success","Deep Cleaning":"badge-purple",Fogging:"badge-warning"}[t]||"badge-neutral"}">${t||"-"}</span>`}function he(t){return`<span class="badge ${{Q1:"badge-info",Q2:"badge-success",Q3:"badge-warning",Q4:"badge-danger"}[t]||"badge-neutral"}">${t||"-"}</span>`}G();function yt(t,e){let i=new Date,a=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}`;if(!(t.target_date||t.opening_date||"").startsWith(a))return!1;let d=String(t.status||"").toLowerCase();if(d!=="selesai"&&d!=="completed"&&d!=="done")return!1;let l=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?l.includes("inspeksi"):e==="gcdc"?l.includes("general cleaning")||l.includes("deep cleaning"):!1}j();we();G();function H({container:t,title:e,icon:i,apiPath:a,columns:o,formFields:d,filterFields:l,defaultFilters:n={},enableMobileFilterSheet:s=!1,itemLabel:r="Data",canCreate:h=!0,canEdit:p=!0,canDelete:u=!0,onBeforeSubmit:m,onAfterLoad:y,onDataLoaded:g,extraActions:f=[],initialSearch:v="",exportOptions:S=null,bulkDelete:D=!1,paginationMode:C="server"}){let B=oe();B&&typeof B=="object"&&B.role==="viewer"&&(h=!1,p=!1,u=!1,D=!1,S=null);let $=1,L={...n};v&&(L.search=v);let E=new Set;t.innerHTML=`
    <div class="crud-layout-wrapper ${s?"mobile-active":""}">
      <div class="page-header">
      <h1 class="page-title">${i} ${e}</h1>
      <div class="page-actions">
  ...
  </div>`).join("");function Bt(t=3){return Array(t).fill(0).map((e,i)=>`<div class="skeleton skeleton-text" style="height:38px;margin-bottom:${i<t-1?"6px":"0"};border-radius:6px"></div>`).join("")}async function se(t,e,i=8e3){try{let a=new AbortController,o=setTimeout(()=>a.abort(),i),d=await k(t,{signal:a.signal}).catch(()=>null);if(clearTimeout(o),!d||!d.ok)return e;let l=d.data;return l?l.data!==void 0?l.data??e:l:e}catch{return e}}function Ea(){["skel-donut","skel-trend","skel-insp","skel-contract","skel-jadwal"].forEach(a=>{let o=document.getElementById(a);o&&(o.style.display="none")}),["chart-donut","chart-trend","chart-insp","chart-contract","chart-jadwal"].forEach(a=>{let o=document.getElementById(a);if(o&&o.style.display==="none"){o.style.display="block";let d=o.parentElement;if(d&&!d.querySelector(".chart-empty")){let l=document.createElement("div");l.className="chart-empty",l.textContent="Belum ada data",o.style.display="none",d.appendChild(l)}}});let t=document.getElementById("kpi-row");t&&t.querySelector(".skeleton")&&Nt({});let e=document.getElementById("mini-stats-row");e&&e.querySelector(".skeleton")&&Ft({}),["table-contracts","table-issues"].forEach(a=>{let o=document.getElementById(a);o&&o.querySelector(".skeleton")&&(o.innerHTML='<div class="chart-empty">Belum ada data</div>')});let i=document.getElementById("activity-log");i&&i.querySelector(".skeleton")&&(i.innerHTML='<div class="chart-empty">Belum ada aktivitas</div>')}async function Mt(t){Sa(),t._dashRefresh&&clearInterval(t._dashRefresh),t._skelTimeout&&clearTimeout(t._skelTimeout);let e=new Date().toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});t.innerHTML=`
  ...
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>kt(t)),document.getElementById("filter-jadwal-year")?.addEventListener("change",async i=>{let a=i.target.value,o=document.getElementById("jadwal-year-label");o&&(o.textContent=a);let d=document.getElementById("skel-jadwal"),l=document.getElementById("chart-jadwal");d&&(d.style.display="block",d.style.position="absolute"),l&&(l.style.display="none");let n=await se(`/api/dashboard/schedule-chart?year=${a}`,{},8e3);try{Ot(n)}catch(s){console.warn("ScheduleChart render:",s),fe("skel-jadwal","chart-jadwal")}}),document.getElementById("filter-insp-month")?.addEventListener("change",async i=>{let a=i.target.value,o=a?`/api/dashboard/inspection-bar?month=${a}`:"/api/dashboard/inspection-bar",d=document.getElementById("skel-insp"),l=document.getElementById("chart-insp");d&&(d.style.display="block",d.style.position="absolute"),l&&(l.style.display="none");let n=await se(o,{},8e3);try{Rt(n)}catch(s){console.warn("InspBar render:",s),fe("skel-insp","chart-insp")}}),t._skelTimeout=setTimeout(()=>Ea(),5e3),await kt(t),t._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?kt(t):clearInterval(t._dashRefresh)},6e4)}async function kt(t){t._skelTimeout&&(clearTimeout(t._skelTimeout),t._skelTimeout=null);let[e,i,a,o,d,l,n,s,r,h,p,u,m,y]=await Promise.all([se("/api/dashboard/kpi",{},8e3),se("/api/dashboard/issues-trend",{},8e3),se("/api/dashboard/issues-summary",{},8e3),se("/api/dashboard/stats",{},8e3),se("/api/dashboard/calendar",[],8e3),se("/api/schedule?limit=10000",{data:[]},8e3),se("/api/employees?limit=10000",{data:[]},8e3),se("/api/contracts?limit=10000",{data:[]},8e3),se("/api/issues?limit=10000",{data:[]},8e3),se("/api/one-on-one?limit=10000",{data:[]},8e3),se("/api/dashboard/contracts-chart",{labels:[],data:[]},8e3),se(`/api/dashboard/schedule-chart?year=${document.getElementById("filter-jadwal-year")?.value||new Date().getFullYear()}`,{},8e3),se("/api/relievers?limit=10000",{data:[]},8e3),se("/api/reports/fogging?limit=10000",{data:[]},8e3)]),g=document.getElementById("filter-insp-month"),f=g?g.value:"",v=f?`/api/dashboard/inspection-bar?month=${f}`:"/api/dashboard/inspection-bar",S=await se(v,{},8e3);if(e){let D=Array.isArray(l?.data)?l.data:Array.isArray(l)?l:[];window.dashboardSchedules=D;let C=Array.isArray(n?.data)?n.data:Array.isArray(n)?n:[],B=Array.isArray(s?.data)?s.data:Array.isArray(s)?s:[],$=Array.isArray(r?.data)?r.data:Array.isArray(r)?r:[],L=Array.isArray(h?.data)?h.data:Array.isArray(h)?h:[],E=Array.isArray(m?.data)?m.data:Array.isArray(m)?m:[];window.dashboardRelievers=E;let F=Array.isArray(y?.data)?y.data:Array.isArray(y)?y:[];window.dashboardFogging=F,e.employees&&(e.employees.current=C.filter(K=>It(K,"active")).length),e.contracts&&(e.contracts.current=B.filter(K=>ft(K,"active")).length),e.expiring30&&(e.expiring30={current:B.filter(K=>ft(K,"expiring30")).length}),e.issues&&(e.issues.current=$.filter(K=>Lt(K,"open")).length),e.one_on_one&&(e.one_on_one.current=L.filter(K=>Pt(K,"pending")).length),e.inspection_month&&(e.inspection_month.current=D.filter(K=>yt(K,"inspeksi")).length),e.cleaning_month&&(e.cleaning_month.current=D.filter(K=>yt(K,"gcdc")).length)}try{Nt(e)}catch(D){console.warn("KPI render:",D)}try{Ft(e)}catch(D){console.warn("MiniStats render:",D)}try{Ot(u)}catch(D){console.warn("ScheduleChart render:",D),fe("skel-jadwal","chart-jadwal")}try{Ta(Array.isArray(a?.by_category)?a.by_category:[])}catch(D){console.warn("Donut render:",D),fe("skel-donut","chart-donut")}try{Da(i)}catch(D){console.warn("Trend render:",D),fe("skel-trend","chart-trend")}try{Rt(S)}catch(D){console.warn("InspBar render:",D),fe("skel-insp","chart-insp")}try{let D=Array.isArray(o)?o:Array.isArray(o?.recent_issues)?o.recent_issues:[];La(D)}catch(D){console.warn("IssuesTable render:",D)}try{let D=Array.isArray(o?.expiring_contracts)?o.expiring_contracts:[];Ia(p)}catch(D){console.warn("ContractsTable render:",D)}try{Pa(Array.isArray(d)?d:[])}catch(D){console.warn("Agenda render:",D)}try{Ba()}catch(D){console.warn("Quick Actions render:",D)}}function Nt(t){let e=document.getElementById("kpi-row");if(!e)return;t=t||{};let i=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees?dash_filter=active",color:"kpi-blue",key:"employees",trendPct:"+2%",trendColor:"#10B981",points:"0,20 10,18 20,22 30,12 40,15 50,8 60,10 70,5 80,6 90,2 100,0"},{icon:"\u{1F504}",label:"Reliefer Aktif",sub:"Karyawan reliefer",href:"#/employees?dash_filter=reliefer",color:"kpi-purple",key:"reliever_total",trendPct:"0%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts?dash_filter=active",color:"kpi-green",key:"contracts",trendPct:"+1%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u23F3",label:"Kontrak Habis 30 Hari",sub:"Akan segera berakhir",href:"#/contracts?dash_filter=expiring30",color:"kpi-warn",key:"expiring30",trendPct:"+25%",trendColor:"#F59E0B",points:"0,25 20,22 40,24 60,15 80,18 100,5"},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues?dash_filter=open",color:"kpi-red",key:"issues",trendPct:"0%",trendColor:"#EF4444",points:"0,20 20,18 40,22 60,19 80,21 100,20"},{icon:"\u{1F4AC}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one?dash_filter=pending",color:"kpi-purple",key:"one_on_one",trendPct:"+8%",trendColor:"#10B981",points:"0,25 20,15 40,18 60,8 80,10 100,2"}];e.innerHTML=i.map(a=>{let o=ve(t[a.key]?.current,0);return`
      ...
      </a>`}).join(""),e.querySelectorAll(".kpi-value").forEach(a=>{At(a,parseInt(a.dataset.target)||0)})}function Ft(t){let e=document.getElementById("mini-stats-row");if(!e)return;t=t||{};let i=`Q${Math.ceil((new Date().getMonth()+1)/3)}`,a=new Date().getFullYear(),o=String(new Date().getMonth()+1).padStart(2,"0"),d=`${a}-${o}`,l=p=>`
  ...
  `,n=[{id:"mini-jadwal",icon:"\u{1F4C5}",label:"Jadwal",dropdown:`
      ...
      `,val:t.schedule?.current,href:`#/timeline?dash_filter=period_${i.toLowerCase()}`,color:"mini-blue"},{icon:"\u{1F393}",label:"Training",val:t.training_month?.current,href:"#/training",color:"mini-gray"},{id:"mini-reliefer",icon:"\u{1F504}",label:"Report Reliefer",dropdown:l("dash-reliefer-month"),val:t.reliever_completed?.current,href:`#/relievers?dash_filter=reliever&month=${d}`,color:"mini-teal"},{id:"mini-inspeksi",icon:"\u{1F50D}",label:"Report Inspeksi",dropdown:l("dash-inspeksi-month"),val:t.inspection_month?.current,href:`#/timeline?dash_filter=inspeksi&month=${d}`,color:"mini-blue"},{id:"mini-gcdc",icon:"\u{1F9F9}",label:"Report GCDC",dropdown:l("dash-gcdc-month"),val:t.cleaning_month?.current,href:`#/timeline?dash_filter=gcdc&month=${d}`,color:"mini-green"},{id:"mini-fogging",icon:"\u{1F4A8}",label:"Report Fogging",dropdown:l("dash-fogging-month"),val:t.fogging_month?.current,href:`#/reports/fogging?dash_filter=fogging&month=${d}`,color:"mini-purple"},{icon:"\u{1F3E2}",label:"Cabang",val:t.branches?.current,href:"#/branches",color:"mini-teal"}];e.innerHTML=n.map(p=>`
    <a href="${p.href}" class="mini-stat ${p.color}" style="text-decoration:none" id="${p.id||""}">
      ...
      <div class="mini-stat-body" style="flex:1; min-width:0; overflow:visible;">
        <div style="display:flex; align-items:baseline; gap:3px;">
          <div class="mini-stat-value" data-target="${ve(p.val)}">0</div>
          ${p.dropdown?p.dropdown:""}
        </div>
        <div class="mini-stat-text">${p.label}</div>
      </div>
    </a>`).join(""),e.querySelectorAll(".mini-stat-value").forEach(p=>At(p,parseInt(p.dataset.target)||0,700));let s=document.getElementById("dash-jadwal-period");s&&s.addEventListener("change",p=>{let u=p.target.value,m=(window.dashboardSchedules||[]).filter(f=>f.period===u).length,y=document.querySelector("#mini-jadwal .mini-stat-value");y&&(y.dataset.target=m,y.textContent=m);let g=document.getElementById("mini-jadwal");g&&(g.href=`#/timeline?dash_filter=period_${u.toLowerCase()}`)});let r=(p,u,m,y,g)=>{let f=document.getElementById(p);f&&f.addEventListener("change",v=>{let S=v.target.value,D=(m||[]).filter($=>y($,S)).length,C=document.querySelector(`#${u} .mini-stat-value`);C&&(C.dataset.target=D,C.textContent=D);let B=document.getElementById(u);B&&(B.href=`${g}&month=${S}`)})},h=p=>{let u=String(p.status||"").toLowerCase();return u==="done"||u==="selesai"||u==="completed"};r("dash-reliefer-month","mini-reliefer",window.dashboardRelievers,(p,u)=>window.parseFlexibleDate(p.backup_date).startsWith(u)&&h(p),"#/relievers?dash_filter=reliever"),r("dash-inspeksi-month","mini-inspeksi",window.dashboardSchedules,(p,u)=>p.activity_type==="Inspeksi Hygiene"&&h(p)&&window.parseFlexibleDate(p.opening_date||p.target_date).startsWith(u),"#/timeline?dash_filter=inspeksi"),r("dash-gcdc-month","mini-gcdc",window.dashboardSchedules,(p,u)=>(p.activity_type==="General Cleaning"||p.activity_type==="Deep Cleaning")&&h(p)&&window.parseFlexibleDate(p.opening_date||p.target_date).startsWith(u),"#/timeline?dash_filter=gcdc"),r("dash-fogging-month","mini-fogging",window.dashboardFogging,(p,u)=>h(p)&&window.parseFlexibleDate(p.activity_date).startsWith(u),"#/reports/fogging?dash_filter=fogging")}function Ta(t){fe("skel-donut","chart-donut");let e=document.getElementById("chart-donut"),i=document.getElementById("donut-legend");if(!e||!i)return;He("donut");let a=(t||[]).filter(s=>ve(s.count)>0);if(!a.length){Xe(e,"Belum ada data permasalahan");return}let o=a.map(s=>`${Ke(s.category,"Lainnya")}`),d=a.map(s=>ve(s.count)),l=d.reduce((s,r)=>s+r,0);i.innerHTML=a.map((s,r)=>{let h=vt[r%vt.length],p=l>0?Math.round(s.count/l*100):0;return`
      <div class="donut-legend-item">
        <div class="donut-legend-color" style="background:${h}"></div>
        <div>
          <div class="donut-legend-val"><span style="color:var(--text-1)">${s.count}</span> <span style="font-size:0.7rem;font-weight:600;color:var(--text-3)">(${p}%)</span></div>
          <div class="donut-legend-label">${o[r]}</div>
        </div>
      </div>
    `}).join("");let n={id:"centerText",beforeDraw:function(s){let r=s.width,h=s.height,p=s.ctx;p.restore();let u=(h/80).toFixed(2);p.font="bold "+u+"em Inter",p.textBaseline="middle",p.fillStyle="#1E293B";let m=l.toString(),y=Math.round((r-p.measureText(m).width)/2),g=h/2;p.fillText(m,y,g-4),p.font="600 "+(u*.35).toFixed(2)+"em Inter",p.fillStyle="#64748B";let f="Total",v=Math.round((r-p.measureText(f).width)/2);p.fillText(f,v,g+10),p.save()}};xe.donut=new Chart(e,{type:"doughnut",data:{labels:o,datasets:[{data:d,backgroundColor:vt,borderWidth:2,borderColor:"#fff",hoverBorderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,animation:{duration:700},plugins:{legend:{display:!1},tooltip:{bodyFont:ye,titleFont:{...ye,weight:"700"},callbacks:{label:s=>` ${s.label}: ${s.parsed} kasus`}}},cutout:"75%"},plugins:[n]})}function Da(t){fe("skel-trend","chart-trend");let e=document.getElementById("chart-trend");if(!e)return;He("trend"),t=t||{};let i=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],a=(t.labels||[]).map(l=>{if(!l||typeof l!="string")return"";try{let[n,s]=l.split("-");return(i[Number(s)-1]||s)+" "+String(n).slice(-2)}catch{return l}}),o=(t.open||[]).map(l=>ve(l)),d=(t.closed||[]).map(l=>ve(l));if(!a.length){Xe(e,"Belum ada data trend");return}xe.trend=new Chart(e,{type:"line",data:{labels:a,datasets:[{label:"Open",data:o,borderColor:"#EF4444",backgroundColor:"rgba(239,68,68,.08)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#EF4444",borderWidth:2},{label:"Closed",data:d,borderColor:"#10B981",backgroundColor:"rgba(16,185,129,.1)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#10B981",borderWidth:2}]},options:it({plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{family:"Inter",size:9},color:ke,maxRotation:0,autoSkip:!1}},y:{grid:{color:je},ticks:{font:{family:"Inter",size:9},color:ke},beginAtZero:!0}}})})}function Ot(t){fe("skel-jadwal","chart-jadwal");let e=document.getElementById("chart-jadwal");if(!e)return;He("jadwal"),t=t||{};let i=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"];if(!Object.values(t).some(s=>Array.isArray(s)&&s.some(r=>r>0))){Xe(e,"Belum ada data jadwal");return}let o=t["Inspeksi Hygiene"]||Array(12).fill(0),d=t["General Cleaning"]||Array(12).fill(0),l=t["Deep Cleaning"]||Array(12).fill(0),n=t.Fogging||Array(12).fill(0);xe.jadwal=new Chart(e,{type:"bar",data:{labels:i,datasets:[{label:"Inspeksi",data:o,backgroundColor:"#3B82F6"},{label:"General Cleaning",data:d,backgroundColor:"#10B981"},{label:"Deep Cleaning",data:l,backgroundColor:"#F59E0B"},{label:"Fogging",data:n,backgroundColor:"#EF4444"}]},options:it({plugins:{legend:{display:!1}},datasets:{bar:{barPercentage:.85,categoryPercentage:.9}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{family:"Inter",size:9},color:ke,maxRotation:0,autoSkip:!1}},y:{stacked:!0,grid:{color:je},ticks:{font:{family:"Inter",size:9},color:ke},min:0}}})})}function Rt(t){fe("skel-insp","chart-insp");let e=document.getElementById("chart-insp");if(!e)return;He("inspBar"),t=t||{};let i=t.labels||[],a=(t.fc||[]).map(d=>ve(d)),o=(t.spv||[]).map(d=>ve(d));if(!i.length){Xe(e,"Belum ada data inspeksi");return}xe.inspBar=new Chart(e,{type:"bar",data:{labels:i,datasets:[{label:"Skor FC",data:a,backgroundColor:"rgba(37,99,235,.75)",borderRadius:4,borderSkipped:!1},{label:"Skor SPV",data:o,backgroundColor:"rgba(16,185,129,.75)",borderRadius:4,borderSkipped:!1}]},options:it({plugins:{legend:{position:"top"}},scales:{x:{grid:{display:!1},ticks:{font:ye,color:ke,maxRotation:45,minRotation:30}},y:{grid:{color:je},ticks:{font:ye,color:ke},min:0,max:100}}})})}function Ia(t){fe("skel-contract-mini","chart-contract-mini");let e=document.getElementById("chart-contract-mini");if(!e)return;He("contractMiniBar"),t=t||{};let i={"06":"Jun","07":"Jul","08":"Agu","09":"Sep",10:"Okt",11:"Nov",12:"Des"},a=(t.labels||[]).map(l=>{let n=l.split("-")[1];return i[n]||l}),o=(t.data||[]).map(l=>ve(l));if(!a.length){Xe(e,"Belum ada data");return}let d=e.getContext("2d");xe.contractMiniBar=new Chart(e,{type:"bar",data:{labels:a,datasets:[{label:"Kontrak Habis",data:o,backgroundColor:"#3B82F6",borderRadius:4,borderSkipped:!1,barPercentage:.6,categoryPercentage:.7}]},options:it({onClick:(l,n)=>{if(n&&n.length>0){let s=n[0].index,r=(t.labels||[])[s];r&&(window.location.hash="#/contracts?month_expiry="+r)}},plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:ye,color:ke,maxRotation:0,autoSkip:!1}},y:{grid:{color:je,borderDash:[4,4],drawBorder:!1},ticks:{font:ye,color:ke,precision:0,maxTicksLimit:5},min:0}},animation:{y:{duration:1e3,easing:"easeOutQuart"}}})})}function La(t){let e=document.getElementById("table-issues");if(!e)return;let i=(t||[]).slice(0,8);if(!i.length){e.innerHTML='<div class="chart-empty">\u2705 Tidak ada permasalahan terbuka</div>';return}e.innerHTML=`
    <div class="dash-list">
      ${i.map(a=>`
      ...
      `).join("")}
    </div>`}function Pa(t){let e=document.getElementById("widget-agenda");if(!e)return;let i=new Date,a=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}-${String(i.getDate()).padStart(2,"0")}`,d=(t||[]).filter(l=>(l.event_date||"").startsWith(a)).slice(0,10);if(!d.length){e.innerHTML="";return}e.innerHTML=`
    <div style="display:flex;flex-direction:column;gap:12px;padding-right:8px">
      ${d.map(l=>{let n="#3B82F6",s="#EFF6FF",r="Agenda",h=(l.title||"").toLowerCase();return h.includes("inspeksi")?(n="#10B981",s="#ECFDF5",r="Inspeksi"):h.includes("cleaning")||h.includes("gcdc")?(n="#3B82F6",s="#EFF6FF",r="Cleaning"):h.includes("reliefer")?(n="#F59E0B",s="#FFFBEB",r="Reliefer"):h.includes("fogging")&&(n="#8B5CF6",s="#F5F3FF",r="Fogging"),`
        <div style="display:flex;gap:12px;align-items:flex-start;padding-bottom:12px;border-bottom:1px solid var(--border)">
          ...
          <div style="flex:1;min-width:0">
            <div style="font-weight:700;font-size:0.85rem;color:var(--text-1);line-height:1.2;margin:0 0 4px 0">${Ke(l.title)}</div>
            <div style="font-size:0.75rem;color:var(--text-3);white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${Ke(l.branch_name)}</div>
          </div>
          <div style="flex-shrink:0;font-size:0.7rem;font-weight:600;padding:2px 8px;border-radius:6px;background:${s};color:${n}">${r}</div>
        </div>
      `}).join("")}
    </div>
...
`)}let B=r(S,v),$=null;return B||($="Karyawan tidak ditemukan di Database"),{isValid:!!B,invalidReason:$,rowNum:v,data:{employee_id:B,branch_id:s(String(g.Cabang||"").trim()),division:String(g["Div / Bagian"]||"").trim()||"FACILITY CARE",start_date:C,end_date:h(g["Tanggal Selesai"])||"2099-12-31",status:String(g.Status||"").trim(),_rawName:S}}}),u=[],m=[];if(p.forEach(g=>{g.isValid?u.push(g.data):m.push({rowNum:g.rowNum,name:g.data._rawName,reason:g.invalidReason})}),console.log(`Split Validation - Valid: ${u.length}, Invalid: ${m.length}`),u.length===0)return{inserted:0,skipped:a.length,failed:a.length};let y=await k("/api/import/contracts",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!y.ok)throw new Error(y.data?.error||"Import gagal");return y.data}}})}j();G();var xt=[],Ze=[];function Oa(t){if(!Array.isArray(t))return"Q3";let e=["Q4","Q3","Q2","Q1"];for(let i of e)if(t.some(a=>a.period===i))return i;return"Q3"}async function Jt(t,e){xt=await Q();let i=await le();Ze=["Berlin Ariansyah","Ade Surahman"];let a=m=>m&&!Ze.find(y=>String(typeof y=="object"?y.value:y).toLowerCase()===String(m).toLowerCase())?[...Ze,m]:Ze,o=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`),d=m=>{if(!m||m==="-"||String(m).trim()==="")return"";let y=String(m).split("-");return y.length===3&&y[0].length===4?`${y[2]}-${y[1]}-${y[0]}`:m},l=o.data?.data||[],n=Oa(l),s=e?e.get("dash_filter"):null,r=new Date,h=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`,p={},u=e&&e.get("month")?e.get("month"):null;s==="inspeksi"?p={status:"Done",activity_type:"Inspeksi Hygiene",month:u}:s==="gcdc"?p={status:"Done",activity_type:"GCDC",month:u}:s&&s.startsWith("period_")&&(p={period:s.replace("period_","").toUpperCase()}),gt({container:t,title:"Jadwal Kegiatan",icon:"\u{1F4C5}",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",paginationMode:"client",enableMobileFilterSheet:!0,defaultFilters:p,onDataLoaded:m=>m.sort((y,g)=>{let f=y.opening_date?new Date(y.opening_date).getTime():0;return(g.opening_date?new Date(g.opening_date).getTime():0)-f}),columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:m=>ht(m)},{key:"period",label:"Periode",render:m=>he(m)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:m=>d(m)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:m=>d(m)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:m=>d(m)},{key:"status",label:"Status",render:m=>X(m)}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:xt},{type:"select",name:"activity_type",label:"Kegiatan",options:[{value:"Inspeksi Hygiene",label:"Inspeksi Hygiene"},{value:"General Cleaning",label:"General Cleaning"},{value:"Deep Cleaning",label:"Deep Cleaning"},{value:"Fogging",label:"Fogging"},{value:"GCDC",label:"GCDC (GC & DC)"}]},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"select",name:"pic",label:"PIC",options:Ze}],formFields:m=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",required:!0,options:xt,value:m?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"],value:m?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:m?.period},{name:"pic",label:"PIC",type:"select",options:a(m?.pic),value:m?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:m?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:m?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:m?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:m?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:m?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let m=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`);if(m.ok){let y=m.data.data.map(g=>({Cabang:g.branch_name||"",Kegiatan:g.activity_type||"",Periode:g.period||"",PIC:g.pic||"","Tgl Opening":g.opening_date||"","Tgl Target":g.target_date||"","Tgl Selesai":g.completion_date||"",Status:g.status||""}));R(y,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{R([{Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done"}],"Template_Import_Jadwal")},onImport:async m=>{let g=(await k("/api/branches?all=1")).data?.data||[],f=C=>{if(!C)return null;let B=String(C||"").toLowerCase(),$=g.find(L=>String(L.full_name||"").toLowerCase()===B||String(L.code||"").toLowerCase()===B||String(L.name||"").toLowerCase()===B);return $?$.id:null},v=C=>{if(C==null||C==="")return"";if(C instanceof Date&&!isNaN(C.getTime()))return C.toISOString().slice(0,10);let B=String(C).trim();if(B===""||B==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(B))return B.slice(0,10);if(/^\d{4,5}$/.test(B)){let L=Number(B);if(L>2e4&&L<99999){let E=new Date(Date.UTC(1899,11,30)+L*864e5);return isNaN(E.getTime())?"":E.toISOString().slice(0,10)}}let $=B.split(/[\/\-\.]/);if($.length===3){let[L,E,F]=$.map(K=>K.trim());if(L.length===4&&E.length<=2&&F.length<=2)return`${L}-${E.padStart(2,"0")}-${F.padStart(2,"0")}`;if(F.length===4&&E.length<=2&&L.length<=2)return`${F}-${E.padStart(2,"0")}-${L.padStart(2,"0")}`}return B},S=m.map(C=>({branch_id:f(String(C.Cabang||"").trim()),activity_type:String(C.Kegiatan||"").trim(),period:String(C.Periode||"").trim(),pic:String(C.PIC||C.Pic||"").trim(),opening_date:v(C["Tgl Opening"]||C["Tanggal Opening"]||C["Tgl Openir"]),target_date:v(C["Tgl Target"]||C["Tanggal Target"]),completion_date:v(C["Tgl Selesai"]||C["Tanggal Selesai"]),status:String(C.Status||"").trim(),notes:String(C.Catatan||C.Keterangan||"").trim()})).filter(C=>C.activity_type&&C.period),D=await k("/api/import/schedule",{method:"POST",body:JSON.stringify({rows:S,onDuplicate:"update"})});if(!D.ok)throw new Error(D.data?.error||"Import gagal");return D.data}}})}j();G();var _t=[],lt=[];function Ra(t,e){let i=String(t.status||"").toLowerCase();return e==="open"?i==="open":!1}async function Ut(t,e){let i=e?e.get("dash_filter"):null;_t=await Q(),lt=await le();let a=l=>l&&!lt.find(n=>n.value===l)?[...lt,{value:l,label:l}]:lt,o=new Date().getFullYear();H({container:t,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,enableMobileFilterSheet:!0,itemLabel:"Permasalahan",paginationMode:"client",onDataLoaded:l=>i?l.filter(n=>Ra(n,i)):l,columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:l=>window.formatDate(l)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:l=>`<span class="badge badge-secondary">${l}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:l=>`<span title="${l}">${l?.length>50?l.slice(0,50)+"\u2026":l}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:l=>`<span title="${l||""}">${l?.length>40?l.slice(0,40)+"\u2026":l||"-"}</span>`},{key:"status",label:"Status",render:l=>X(l)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:l=>window.formatDate(l)},{key:"day_count",label:"Hari",render:l=>l??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"select",name:"branch_id",label:"Cabang",options:_t},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:["2025","2026","2027","2028","2029","2030"]}],formFields:l=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:l?.report_date},{name:"branch_id",label:"Cabang",type:"select",required:!0,options:_t,value:l?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:l?.category},{name:"source",label:"Sumber Laporan",type:"select",options:["SPV","AM","RCP","Perawat","FC","Berlin","Ade","Pattrel","Dentrel"],value:l?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:l?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"select",options:a(l?.employee_name),value:l?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"select",options:a(l?.fc_specialist),value:l?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:l?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:l?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:l?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let l=await k(`/api/issues${window.location.search?window.location.search+"&":"?"}limit=10000`);if(l.ok){let n=l.data.data.map(s=>({Tanggal:s.report_date||"",Cabang:s.branch_name||"",Kategori:s.category||"",Sumber:s.source||"",Keluhan:s.complaint||"","Nama FC":s.employee_name||"","FC Spesialis":s.fc_specialist||"",Solusi:s.solution||"","Tgl Selesai":s.completion_date||"",Status:s.status||""}));R(n,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{R([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async l=>{let s=(await k("/api/branches?all=1")).data?.data||[],r=u=>{if(!u)return null;let m=String(u||"").toLowerCase(),y=s.find(g=>String(g.full_name||"").toLowerCase()===m||String(g.code||"").toLowerCase()===m||String(g.name||"").toLowerCase()===m);return y?y.id:null},h=l.map(u=>({branch_id:r(String(u.Cabang||"").trim()),report_date:String(u.Tanggal||"").trim(),category:String(u.Kategori||"").trim(),source:String(u.Sumber||"").trim(),complaint:String(u.Keluhan||"").trim(),employee_name:String(u["Nama FC"]||"").trim(),fc_specialist:String(u["FC Spesialis"]||"").trim(),solution:String(u.Solusi||"").trim(),completion_date:String(u["Tgl Selesai"]||"").trim(),status:String(u.Status||"").trim()})).filter(u=>u.report_date&&u.complaint&&u.category),p=await k("/api/import/issues",{method:"POST",body:JSON.stringify({rows:h,onDuplicate:"update"})});if(!p.ok)throw new Error(p.data?.error||"Import gagal");return p.data}}})}j();var qe=[];function Ka(t,e){let i=String(t.status||"").toLowerCase();return e==="pending"?i==="pending":!1}async function Gt(t,e){let i=e?e.get("dash_filter"):null;qe=await Q();let a=await le(),o=["Ade","Berlin"],d=n=>n&&!a.find(s=>s.value===n)?[...a,{value:n,label:n}]:a,l=n=>n&&!o.find(s=>(typeof s=="object"?s.value:s)===n)?[...o,n]:o;H({container:t,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,enableMobileFilterSheet:!0,itemLabel:"One on One",paginationMode:"client",onDataLoaded:n=>i?n.filter(s=>Ka(s,i)):n,columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:n=>window.formatDate(n)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:n=>`<span title="${n||""}">${n?.length>50?n.slice(0,50)+"\u2026":n||"-"}</span>`},{key:"solution",label:"Solusi",render:n=>`<span title="${n||""}">${n?.length>40?n.slice(0,40)+"\u2026":n||"-"}</span>`},{key:"status",label:"Status",render:n=>X(n)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:n=>window.formatDate(n)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:n=>n?`<a href="${n}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"select",name:"branch_id",label:"Cabang",options:qe},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async n=>{let s=new URLSearchParams(n||{}).toString(),r=await k(`/api/one-on-one?limit=10000&${s}`);if(r.ok){let h=r.data.data.map(u=>({Tanggal:u.meeting_date||"",Cabang:u.branch_name||"","Nama Karyawan":u.employee_name||"",PIC:u.pic||"",Masalah:u.problem||"",Solusi:u.solution||"",Status:u.status||"","Tgl Selesai":u.completion_date||"",Dokumen:u.document_link||""})),{downloadExcel:p}=await Promise.resolve().then(()=>(G(),ce));p(h,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let n=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:s}=await Promise.resolve().then(()=>(G(),ce));s(n,"Template_Import_OneOnOne")},onImport:async n=>{let s=u=>{if(!u)return null;let m=String(u||"").toLowerCase(),y=qe.find(g=>String(g.label||"").toLowerCase()===m);return y?y.value:null},r=u=>{if(!u)return"";if(u instanceof Date&&!isNaN(u.getTime()))return u.toISOString().slice(0,10);let m=String(u).trim();if(/^\d{4,5}$/.test(m)){let g=Number(m);if(g>2e4&&g<99999){let f=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(f.getTime())?"":f.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(m))return m.slice(0,10);let y=m.split(/[\/\-\.]/);if(y.length===3){let[g,f,v]=y.map(S=>S.trim());if(g.length===4&&f.length<=2&&v.length<=2)return`${g}-${f.padStart(2,"0")}-${v.padStart(2,"0")}`;if(v.length===4&&f.length<=2&&g.length<=2)return`${v}-${f.padStart(2,"0")}-${g.padStart(2,"0")}`}return m},h=n.map(u=>({meeting_date:r(u.Tanggal),employee_name:String(u["Nama Karyawan"]||"").trim(),branch_id:s(String(u.Cabang||"").trim()),pic:String(u.PIC||"").trim(),problem:String(u.Masalah||"").trim(),solution:String(u.Solusi||"").trim(),status:String(u.Status||"").trim(),completion_date:r(u["Tgl Selesai"]),document_link:String(u.Dokumen||"").trim()})).filter(u=>u.meeting_date&&u.employee_name&&u.branch_id),p=await k("/api/import/one_on_one",{method:"POST",body:JSON.stringify({rows:h,onDuplicate:"update"})});if(!p.ok)throw new Error(p.data?.error||"Import gagal");return p.data}},formFields:n=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:n?.meeting_date},{name:"branch_id",label:"Cabang",type:"select",options:n?.branch_id&&!qe.find(s=>s.value==n.branch_id)?[...qe,{value:n.branch_id,label:n.branch_name||n.branch_id}]:qe,createApi:{path:"/api/branches",field:"full_name"},value:n?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"select",required:!0,options:d(n?.employee_name),value:n?.employee_name},{name:"pic",label:"PIC",type:"select",options:l(n?.pic),createApi:{path:"/api/pic",field:"name"},value:n?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:n?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:n?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:n?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:n?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:n?.document_link}]})}j();async function zt(t){let e=await Q(),i=await le(),a=["Ade","Berlin"],o=n=>n&&!i.find(s=>s.value===n)?[...i,{value:n,label:n}]:i,d=n=>n&&!a.find(s=>(typeof s=="object"?s.value:s)===n)?[...a,n]:a,l=Array.from({length:5},(n,s)=>String(new Date().getFullYear()-s));H({container:t,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,enableMobileFilterSheet:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:n=>window.formatDate(n)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:n=>{try{let s=JSON.parse(n);return Array.isArray(s)?s.join(", "):n||"-"}catch{return n||"-"}}},{key:"score",label:"Nilai",render:n=>n!=null?`<strong>${n}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:n=>n?`<a href="${n}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer..."},{type:"select",name:"year",label:"Tahun",options:l}],exportOptions:{moduleName:"training",onExport:async n=>{let s=new URLSearchParams(n||{}).toString(),r=await k(`/api/training?limit=10000&${s}`);if(r.ok){let h=r.data.data.map(u=>{let m=u.participants||"";try{let y=JSON.parse(m);m=Array.isArray(y)?y.join(", "):m}catch{}return{Tanggal:u.training_date||"",Batch:u.batch||"",Materi:u.subject||"",Cabang:u.branch_name||"",Trainer:u.trainer||"",Peserta:m,Nilai:u.score!==null&&u.score!==void 0?u.score:"",Dokumen:u.document_link||""}}),{downloadExcel:p}=await Promise.resolve().then(()=>(G(),ce));p(h,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let n=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:s}=await Promise.resolve().then(()=>(G(),ce));s(n,"Template_Import_Training")},onImport:async n=>{let s=u=>{if(!u)return null;let m=String(u||"").toLowerCase(),y=e.find(g=>String(g.label||"").toLowerCase()===m);return y?y.value:null},r=u=>{if(!u)return"";if(u instanceof Date&&!isNaN(u.getTime()))return u.toISOString().slice(0,10);let m=String(u).trim();if(/^\d{4,5}$/.test(m)){let g=Number(m);if(g>2e4&&g<99999){let f=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(f.getTime())?"":f.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(m))return m.slice(0,10);let y=m.split(/[\/\-\.]/);if(y.length===3){let[g,f,v]=y.map(S=>S.trim());if(g.length===4&&f.length<=2&&v.length<=2)return`${g}-${f.padStart(2,"0")}-${v.padStart(2,"0")}`;if(v.length===4&&f.length<=2&&g.length<=2)return`${v}-${f.padStart(2,"0")}-${g.padStart(2,"0")}`}return m},h=n.map(u=>({training_date:r(u.Tanggal),batch:String(u.Batch||"").trim(),subject:String(u.Materi||"").trim(),branch_id:s(String(u.Cabang||"").trim()),trainer:String(u.Trainer||"").trim(),participants:String(u.Peserta||"").trim(),score:u.Nilai?Number(u.Nilai):null,document_link:String(u.Dokumen||"").trim()})).filter(u=>u.training_date&&u.subject&&u.branch_id),p=await k("/api/import/training",{method:"POST",body:JSON.stringify({rows:h,onDuplicate:"update"})});if(!p.ok)throw new Error(p.data?.error||"Import gagal");return p.data}},formFields:n=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:n?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:n?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:n?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",options:e,value:n?.branch_id},{name:"trainer",label:"Trainer",type:"select",options:d(n?.trainer),value:n?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let s=JSON.parse(n?.participants);return Array.isArray(s)?s.join(", "):n?.participants||""}catch{return n?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:n?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:n?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:n?.notes}],onBeforeSubmit:async n=>(n.participants&&(n.participants=JSON.stringify(n.participants.split(",").map(s=>s.trim()).filter(Boolean))),n)})}j();we();G();function Qt({container:t,title:e,icon:i,apiPath:a,columns:o,formFields:d,filterFields:l,defaultFilters:n={},enableMobileFilterSheet:s=!1,itemLabel:r="Data",canCreate:h=!0,canEdit:p=!0,canDelete:u=!0,onBeforeSubmit:m,onAfterLoad:y,onDataLoaded:g,extraActions:f=[],initialSearch:v="",exportOptions:S=null,bulkDelete:D=!1,paginationMode:C="server"}){let B=oe();B&&typeof B=="object"&&B.role==="viewer"&&(h=!1,p=!1,u=!1,D=!1,S=null);let $=1,L={...n};v&&(L.search=v);let E=new Set;t.innerHTML=`
    <div class="crud-layout-wrapper ${s?"mobile-active":""}">
      <div class="page-header">
      <h1 class="page-title">${i} ${e}</h1>
      <div class="page-actions">
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),o()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),o()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.querySelectorAll(".cal-filter").forEach(d=>d.addEventListener("change",o));async function a(){try{let d=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`;i=(await k(`/api/dashboard/calendar?month=${d}`)).data?.data||[]}catch(d){console.warn("[Calendar] Failed to load events, rendering empty grid:",d),i=[]}}async function o(){let d=document.getElementById("calendar-grid");if(d){d.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
      ${Array(35).fill('<div style="background:#f8fafc;min-height:70px;"></div>').join("")}
    </div>`,await a();try{let l=e.getFullYear(),n=e.getMonth(),s=e.toLocaleDateString("id-ID",{month:"long",year:"numeric"}),r=document.getElementById("cal-month-label");r&&(r.textContent=s);let h=new Set(Array.from(document.querySelectorAll(".cal-filter:checked")).map(C=>C.value)),p=i.filter(C=>h.has(C.type)),u={};p.forEach(C=>{let B=(C.event_date||"").slice(0,10);u[B]||(u[B]=[]),u[B].push(C)});let m=new Date(l,n,1).getDay(),y=new Date(l,n+1,0).getDate(),g=["Min","Sen","Sel","Rab","Kam","Jum","Sab"],f=new Date().toISOString().slice(0,10),v='<div class="calendar-grid">';g.forEach(C=>{v+=`<div class="cal-day-header">${C}</div>`});for(let C=0;C<m;C++)v+='<div class="cal-cell cal-cell-empty"></div>';for(let C=1;C<=y;C++){let B=`${l}-${String(n+1).padStart(2,"0")}-${String(C).padStart(2,"0")}`,$=u[B]||[],L=B===f;v+=`
          <div class="cal-cell ${L?"cal-today":""} ${$.length?"cal-has-events":""}"
            ...
            <div class="cal-events-preview">
              ${$.slice(0,3).map(E=>`
                <div class="cal-event-dot cal-color-${E.color||"gray"}" title="${rt(E.title||E.type)}">
                  <span class="cal-event-dot-label">${qa(E.title||E.branch_name||E.type,18)}</span>
                </div>
              `).join("")}
              ${$.length>3?`<div class="cal-more">+${$.length-3} lagi</div>`:""}
            </div>
          </div>`}let D=(m+y)%7;if(D!==0)for(let C=0;C<7-D;C++)v+='<div class="cal-cell cal-cell-empty"></div>';v+="</div>",d.innerHTML=v,d.querySelectorAll(".cal-cell[data-date]").forEach(C=>{C.addEventListener("click",()=>{let B=C.dataset.date,$=u[B]||[];if(!$.length)return;let L=document.getElementById("cal-event-list"),E=new Date(B+"T00:00:00").toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});document.getElementById("cal-event-date").textContent=E,document.getElementById("cal-event-items").innerHTML=$.map(F=>`
            <div class="cal-event-item cal-color-border-${F.color||"gray"}">
              <div class="cal-event-type">${Ja(F.type)}</div>
              <div class="cal-event-title">${rt(F.title||"-")}</div>
              <div class="cal-event-branch">${rt(F.branch_name||"")}</div>
              ${F.status?`<div class="cal-event-status">${rt(F.status)}</div>`:""}
              ${F.days_remaining!==void 0?`<div class="cal-event-extra">Sisa: ${F.days_remaining} hari</div>`:""}
            </div>
          `).join(""),L.style.display="block"})})}catch(l){console.error("[Calendar] Render error:",l),d&&(d.innerHTML=`
          <div style="padding:40px;text-align:center;color:var(--text-3)">
            <div style="font-size:2rem;margin-bottom:8px">\u{1F4C5}</div>
            <div>Gagal memuat kalender. Silakan refresh.</div>
          </div>`)}}}o()}function qa(t,e){return t?t.length>e?t.slice(0,e)+"\u2026":t:""}function rt(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function Ja(t){return{schedule:"\u{1F5D3} Jadwal",issue:"\u26A0\uFE0F Permasalahan",reliever:"\u{1F504} Reliefer",training:"\u{1F393} Training",contract_expiry:"\u{1F4CB} Kontrak Habis"}[t]||t}j();async function ra(t){let e=oe(),i=(e?.full_name||e?.username||"U")[0].toUpperCase(),o={superadmin:"#7C3AED",admin:"#2563EB",manager:"#0891B2",spv:"#059669",viewer:"#64748B"}[e?.role]||"#64748B";t.innerHTML=`
    <div class="page-header">
  ...
  `;let e=null,i=null,a=0,o={upload:document.getElementById("step-upload"),validating:document.getElementById("step-validating"),preview:document.getElementById("step-preview"),importing:document.getElementById("step-importing"),summary:document.getElementById("step-summary")};function d(g){Object.entries(o).forEach(([f,v])=>{v.style.display=f===g?"":"none"})}document.getElementById("btn-backup-db")?.addEventListener("click",async()=>{let g=document.getElementById("btn-backup-db");g.disabled=!0,g.textContent="\u23F3 Memproses Backup...";try{let f=await k("/api/import/backup");if(f.ok){if(!window.XLSX){z("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");return}let v=window.XLSX,S=v.utils.book_new();Object.entries(f.data.database).forEach(([D,C])=>{let B=C.length>0?C:[{}],$=v.utils.json_to_sheet(B);v.utils.book_append_sheet(S,$,D.substring(0,31))}),v.writeFile(S,`FCMS_Database_Backup_${new Date().toISOString().slice(0,10)}.xlsx`),ne("Backup berhasil diunduh!")}else z("Gagal memproses backup: "+(f.data?.error||"Unknown error"))}catch(f){z("Gagal memproses backup: "+f.message)}finally{g.disabled=!1,g.textContent="\u{1F4E6} Backup Database"}});let l=document.getElementById("btn-sync-google");l&&l.addEventListener("click",async()=>{if(!confirm("Peringatan: Mensinkronkan data dengan Google Sheets akan memperbarui dan menambahkan data baru dari Google Sheets ke dalam FCMS. Data yang sudah Anda buat di FCMS TIDAK akan terhapus. Lanjutkan?"))return;let g=l.innerHTML;l.innerHTML='<span class="spinner"></span> Menyinkronkan...',l.disabled=!0;try{let f=await k("/api/sync/google-sheets",{method:"POST"});f.ok?alert("Sinkronisasi Berhasil: "+(f.data?.message||"Data Karyawan & PIC telah diperbarui.")):alert("Gagal Sinkronisasi: "+(f.data?.error||"Unknown error"))}catch{alert("Terjadi kesalahan koneksi.")}finally{l.innerHTML=g,l.disabled=!1}}),document.getElementById("btn-download-template").addEventListener("click",()=>{da(),ne("Template Excel berhasil didownload!")});let n=document.getElementById("file-input"),s=document.getElementById("upload-zone");document.getElementById("btn-browse").addEventListener("click",g=>{g.stopPropagation(),n.click()}),n.addEventListener("change",g=>{g.target.files[0]&&r(g.target.files[0])}),s.addEventListener("dragover",g=>{g.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",g=>{g.preventDefault(),s.classList.remove("drag-over");let f=g.dataTransfer.files[0];f&&f.name.match(/\.xlsx?$/i)?r(f):z("Hanya file .xlsx atau .xls yang didukung.")}),document.getElementById("btn-clear-file").addEventListener("click",()=>{e=null,n.value="",document.getElementById("file-info").style.display="none",s.style.display="",d("upload")});async function r(g){e=g,document.getElementById("file-name-display").textContent=`\u{1F4C4} ${g.name} (${(g.size/1024).toFixed(1)} KB)`,document.getElementById("file-info").style.display="flex",s.style.display="none",await h(g)}async function h(g){d("validating");let f=document.getElementById("validation-status"),v=document.getElementById("validation-bar");try{if(!window.XLSX)throw new Error("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");f.textContent="Membaca file Excel...",v.style.width="20%",await et(200);let S=await g.arrayBuffer(),D=window.XLSX.read(S,{type:"array",cellDates:!0});f.textContent=`Memvalidasi ${D.SheetNames.length} sheet...`,v.style.width="50%",await et(100),i=oa(D),v.style.width="100%",f.textContent="Validasi selesai!",await et(300),p()}catch(S){d("upload"),z("Gagal memproses file: "+S.message),document.getElementById("file-info").style.display="flex",s.style.display="none"}}function p(){d("preview");let g=i.filter(E=>!E.skipped).length,f=i.reduce((E,F)=>E+F.total,0),v=i.reduce((E,F)=>E+F.valid,0),S=i.reduce((E,F)=>E+F.errorCount,0),D=f>0?Math.round(v/f*100):0;document.getElementById("preview-summary-badges").innerHTML=`
    ...
    `,f.scrollIntoView({behavior:"smooth",block:"start"})}document.getElementById("btn-back-to-upload").addEventListener("click",()=>{d("upload"),document.getElementById("file-info").style.display="none",s.style.display="",e=null,n.value=""}),document.getElementById("btn-download-log").addEventListener("click",()=>{if(!i)return;ca(i)?ne("Log error berhasil didownload."):ne("Tidak ada error untuk didownload.")}),document.getElementById("btn-start-import").addEventListener("click",()=>{let g=document.querySelector('input[name="dup-strategy"]:checked')?.value||"skip";m(g)});async function m(g){d("importing"),a=Date.now();let f=[];za.forEach(B=>{let $=i?.find(L=>L.module===B&&L.mapped?.length>0);$&&f.push($)});let v=document.getElementById("import-steps-list");v.innerHTML=f.map(B=>`
  ...
  `;let e=document.getElementById("btnRefreshSync"),i=document.getElementById("queueStatusFilter");e.addEventListener("click",o),i.addEventListener("change",n),document.getElementById("btnRetryAll").addEventListener("click",()=>a("retry",{allFailed:!0})),document.getElementById("btnResetStuck").addEventListener("click",()=>a("reset-stuck",{})),document.getElementById("btnPauseSync").addEventListener("click",()=>a("pause",{})),document.getElementById("btnResumeSync").addEventListener("click",()=>a("resume",{})),document.getElementById("btnReconcile").addEventListener("click",()=>a("reconcile",{module:"ALL",repairMode:!0})),document.getElementById("btnRetrySelected").addEventListener("click",()=>{let r=Array.from(document.querySelectorAll(".chk-queue:checked")).map(h=>h.value);if(r.length===0)return alert("No items selected");a("retry",{ids:r})}),document.getElementById("chkAllQueue").addEventListener("change",r=>{document.querySelectorAll(".chk-queue").forEach(h=>h.checked=r.target.checked)});async function a(r,h){if(confirm(`Are you sure you want to execute action: ${r}?`)){showLoading();try{let p=await k(`/api/sync/actions/${r}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(h)});p.ok?(alert(p.data?.message||"Success"),o()):z(p.error||"Action failed")}catch(p){z(p.message)}hideLoading()}}await o();async function o(){showLoading(),await Promise.all([l(),n(),d(),s()]),hideLoading()}async function d(){try{let r=await k("/api/sync/performance");if(!r.ok)return;let{webhook:h,google_api:p,d1:u,queue:m,throughput:y}=r.data;document.getElementById("latencyHistograms").innerHTML=`
      ...
      `,document.getElementById("lblSnapshotStatus").innerHTML='Checked 10 modules. Status: <b>COMPLETED</b><br><span class="text-xs text-gray-500">Run today at 02:00</span>'}catch(r){console.error(r)}}async function l(){try{let r=await k("/api/sync/health");if(!r.ok)return z("Failed to fetch sync health");let{status:h,queue:p,circuit_breaker:u}=r.data,m=`
      ...
      `;document.getElementById("syncOverviewCards").innerHTML=m;let y=document.getElementById("cbStateBadge"),g=document.getElementById("cbStateDesc"),f=document.getElementById("cbStatusCard");f.className="bg-white rounded-lg shadow p-6 border-l-4",u==="CLOSED"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800",y.textContent="CLOSED",g.textContent="Traffic is flowing normally to Google Sheets.",f.classList.add("border-green-500")):u==="OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800",y.textContent="OPEN",g.textContent="Failing fast. Traffic to Google Sheets is paused due to repeated failures.",f.classList.add("border-red-500")):u==="HALF_OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",y.textContent="HALF-OPEN",g.textContent="Testing recovery. Permitting limited traffic to verify stability.",f.classList.add("border-yellow-500")):y.textContent=u||"UNKNOWN"}catch(r){console.error(r)}}async function n(){try{let r=document.getElementById("queueStatusFilter").value,h=await k("/api/sync/queue?limit=15"+(r?"&status="+r:""));if(!h.ok)return;let p=document.getElementById("queueTableBody"),u=h.data?.data||h.data||[];if(u.length===0){p.innerHTML='<tr><td colspan="6" class="px-4 py-4 text-center text-gray-500">No events found</td></tr>';return}p.innerHTML=u.map(m=>`
      ...
      `).join("")}catch(r){console.error(r)}}async function s(){try{let r=await k("/api/sync/metrics");if(!r.ok)return;let h=document.getElementById("metricsTableBody"),p=r.data||[];if(p.length===0){h.innerHTML='<tr><td colspan="5" class="px-4 py-4 text-center text-gray-500">No metrics found in last 24h</td></tr>';return}h.innerHTML=p.map(u=>`
        <tr class="hover:bg-gray-50">
          ...
          <div class="topbar-left">
            ...
            <div class="topbar-welcome">
              <div class="topbar-greeting">
                <span class="topbar-greeting-time">${(()=>{let r=new Date().getHours();return r>=4&&r<11?"Selamat Pagi":r>=11&&r<15?"Selamat Siang":r>=15&&r<18?"Selamat Sore":"Selamat Malam"})()}, </span><span class="topbar-greeting-name">${t?.full_name||"Admin"}</span> \u{1F44B}
              </div>
  ...
  `;let i=document.getElementById("sidebar"),a=document.getElementById("sidebar-overlay"),o=document.getElementById("topbar-menu-btn"),d=document.getElementById("sidebar-close"),l=()=>{i.classList.add("open"),a.classList.add("show")},n=()=>{i.classList.remove("open"),a.classList.remove("show")};o?.addEventListener("click",l),d?.addEventListener("click",n),a?.addEventListener("click",n),document.querySelectorAll(".nav-item").forEach(r=>r.addEventListener("click",n));function s(){let r=window.location.hash.replace("#","")||"/dashboard";document.querySelectorAll(".nav-item").forEach(u=>{let m=u.dataset.route;u.classList.toggle("active",r===m||m!=="/dashboard"&&r.startsWith(m))});let h=document.getElementById("topbar-title"),p=document.querySelector(".nav-item.active .nav-label");h&&p&&(h.textContent=p.textContent)}window.addEventListener("hashchange",s),s(),Qa(),document.getElementById("btn-fullscreen")?.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.()}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await k("/api/auth/logout",{method:"POST"}),We(),tt&&clearInterval(tt),Pe("/login")}),Wa(),Va(),document.getElementById("btn-notif")?.addEventListener("click",r=>{r.preventDefault(),Ya()})}document.addEventListener("keydown",t=>{if(t.target.tagName==="SELECT"&&t.key.length===1&&/[a-zA-Z]/.test(t.key)){let e=t.key.toLowerCase(),i=Array.from(t.target.options);if(i.length===0)return;let a=t.target.selectedIndex+1;(a>=i.length||a<0)&&(a=0);let o=-1;for(let d=0;d<i.length;d++){let l=(a+d)%i.length;if(i[l].text.toLowerCase().replace(/^[\d\.\s\-]+/,"").startsWith(e)){o=l;break}}o!==-1&&o!==t.target.selectedIndex&&(t.target.selectedIndex=o,t.preventDefault(),t.target.dispatchEvent(new Event("change")))}});async function Xa(){Y("/login",({main:e})=>Kt(e)),Y("/dashboard",te(({main:e})=>Mt(e))),Y("/calendar",te(({main:e})=>la(e))),Y("/employees",te(({main:e,params:i})=>jt(e,i))),Y("/contracts",te(({main:e,params:i})=>qt(e,i))),Y("/sp",te(({main:e})=>ma(e))),Y("/mutasi",te(({main:e})=>ba(e))),Y("/sync-dashboard",te(({main:e})=>ha(e))),Y("/timeline",te(({main:e,params:i})=>Jt(e,i))),Y("/issues",te(({main:e,params:i})=>Ut(e,i))),Y("/one-on-one",te(({main:e,params:i})=>Gt(e,i))),Y("/training",te(({main:e})=>zt(e))),Y("/relievers",te(({main:e,params:i})=>Wt(e,i))),Y("/reports/inspection",te(({main:e})=>Vt(e))),Y("/reports/cleaning",te(({main:e})=>Yt(e))),Y("/reports/fogging",te(({main:e})=>Xt(e))),Y("/reports/basecamp",te(({main:e})=>Zt(e))),Y("/reports/supply",te(({main:e})=>Ct(e,"supply"))),Y("/sop",te(({main:e})=>ea(e))),Y("/checklist",te(({main:e})=>ta(e))),Y("/forms",te(({main:e})=>Ct(e))),Y("/users",te(({main:e})=>na(e))),Y("/branches",te(({main:e})=>ia(e))),Y("/profile",te(({main:e})=>ra(e))),Y("/settings/import",te(({main:e})=>pa(e))),Y("/audit-logs",te(({main:e})=>aa(e)));let t=Qe();if(!t&&window.location.hash!=="#/login"&&Pe("/login"),t){let e=await k("/api/auth/me");e.ok?(Ve(e.data.data),ya()):(We(),Pe("/login"))}window.addEventListener("fm:login",()=>{ya(),Pe("/dashboard")}),Tt()}Xa();
