    ...
    <div class="dashboard-wrap" id="dash-root">
      ...
      <div class="charts-row" style="grid-template-columns: 2fr 1fr 1fr;">
        ...
        <div class="chart-card" style="display:flex; flex-direction:column;">
          ...
          <div style="display:flex; flex-direction:column; gap:20px; align-items:center; justify-content:center; flex:1; padding: 10px 0;">
        ...
        <div class="chart-card" style="display:flex; flex-direction:column;">
          ...
          <div class="chart-canvas-wrap" style="flex:1; width:100%; position:relative; min-height: 150px; margin-top:10px;">
