var fa=Object.defineProperty;var dt=(t,e)=>()=>(t&&(e=t(t=0)),e);var ct=(t,e)=>{for(var r in e)fa(t,r,{get:e[r],enumerable:!0})};var Le={};ct(Le,{API:()=>Et,CLIENT_SIDE_MAX_ROWS:()=>xe,IS_DEVELOPMENT:()=>$e,apiFetch:()=>k,clearToken:()=>We,getToken:()=>Qe,getUser:()=>oe,setToken:()=>pt,setUser:()=>Ve});function Qe(){return localStorage.getItem("fm_token")}function pt(t){localStorage.setItem("fm_token",t)}function We(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function oe(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Ve(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function k(t,e={}){let r=Qe(),a={"Content-Type":"application/json",...r?{Authorization:`Bearer ${r}`}:{},...e.headers||{}};try{let o=`cb=${Date.now()}`,d=t.includes("?")?"&":"?",i=`${Et}${t}${d}${o}`,n=await fetch(i,{...e,headers:a}),s;try{let l=await n.text();try{s=JSON.parse(l)}catch{s={error:`Server Error (${n.status}): ${l.substring(0,80)}...`}}}catch{s={error:"Gagal membaca respon dari server"}}return n.status===401&&(We(),window.location.hash="#/login"),{ok:n.ok,status:n.status,data:s}}catch(o){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${o.message})`}}}}var $e,va,Et,xe,j=dt(()=>{$e=!1,va="https://fm-operations-api.facilitycare-audydental.workers.dev",Et=va,xe=1e4});var mt={};ct(mt,{confirmDialog:()=>Ee,createModal:()=>de});function de({title:t,content:e,onConfirm:r,onCancel:a,confirmText:o="Simpan",cancelText:d="Batal",size:i="md",confirmClass:n="btn-primary"}){let s={sm:"400px",md:"560px",lg:"720px",xl:"900px"},l=document.createElement("div");l.className="modal-overlay",l.innerHTML=`
  ...
  `}var G=dt(()=>{});j();var ut={},at=null;function Y(t,e){ut[t]=e}function Be(t){window.location.hash=t}function Tt(){async function t(){let e=window.location.hash.replace("#","")||"/dashboard",[r,...a]=e.split("?"),o=ut[r];if(!o){for(let[i,n]of Object.entries(ut))if(i.endsWith("/*")&&r.startsWith(i.slice(0,-2))){o=n;break}}at&&(at(),at=null);let d=document.getElementById("main-content");if(d&&(d.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),o){let i=new URLSearchParams(a.join("?")),n=r.split("/").filter(Boolean),s=await o({path:r,params:i,segments:n,main:d});s&&(at=s)}else{let i=d||document.getElementById("app");i&&(i.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",t),t()}var Ye;function ka(){return Ye||(Ye=document.createElement("div"),Ye.id="toast-container",document.body.appendChild(Ye)),Ye}function Dt(t,e="info",r=3500){let a=ka(),o=document.createElement("div");o.className=`toast toast-${e}`;let d={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};o.innerHTML=`<span class="toast-icon">${d[e]||"\u2139"}</span><span class="toast-msg">${t}</span>`,a.appendChild(o),requestAnimationFrame(()=>o.classList.add("show")),setTimeout(()=>{o.classList.remove("show"),setTimeout(()=>o.remove(),350)},r)}var ne=t=>Dt(t,"success"),z=t=>Dt(t,"error");Se();j();j();Se();function Pe({columns:t,data:e,onEdit:r,onDelete:a,onView:o,actions:d=[],emptyText:i="Tidak ada data",bulkSelect:n=null}){let s=document.createElement("div");if(s.className="table-wrapper",!e||e.length===0)return s.innerHTML=`<div class="empty-state"><p>${i}</p></div>`,s;let l=document.createElement("table");l.className="data-table";let b=document.createElement("thead"),c=document.createElement("tr");if(n){let m=document.createElement("th");m.style.width="40px",m.style.textAlign="center";let y=document.createElement("input");y.type="checkbox",y.id="select-all-checkbox",y.title="Pilih semua",y.addEventListener("change",()=>{e.forEach(g=>{y.checked?n.selectedIds.add(g.id):n.selectedIds.delete(g.id)}),s.querySelectorAll(".row-checkbox").forEach(g=>g.checked=y.checked),n.onToggle()}),m.appendChild(y),c.appendChild(m)}if(t.forEach(m=>{let y=document.createElement("th");y.textContent=m.label,m.width&&(y.style.width=m.width),c.appendChild(y)}),r||a||o||d.length>0){let m=document.createElement("th");m.textContent="Aksi",m.style.width="120px",c.appendChild(m)}b.appendChild(c),l.appendChild(b);let p=document.createElement("tbody");return e.forEach(m=>{let y=document.createElement("tr");if(n){let g=document.createElement("td");g.style.textAlign="center",g.style.width="40px";let f=document.createElement("input");f.type="checkbox",f.className="row-checkbox",f.checked=n.selectedIds.has(m.id),f.addEventListener("change",()=>{if(f.checked)n.selectedIds.add(m.id);else{n.selectedIds.delete(m.id);let v=document.getElementById("select-all-checkbox");v&&(v.checked=!1)}n.onToggle()}),g.appendChild(f),y.appendChild(g)}if(t.forEach(g=>{let f=document.createElement("td");if(g.render){let v=g.render(m[g.key],m);v instanceof HTMLElement?f.appendChild(v):f.innerHTML=v||""}else f.textContent=m[g.key]!==null&&m[g.key]!==void 0&&m[g.key]!==""?m[g.key]:"";g.nowrap&&(f.style.whiteSpace="nowrap"),y.appendChild(f)}),r||a||o||d.length>0){let g=document.createElement("td");g.className="actions-cell";let f=document.createElement("div");if(f.className="btn-group",o){let v=document.createElement("button");v.className="btn btn-xs btn-ghost",v.innerHTML="\u{1F441}",v.title="Lihat",v.addEventListener("click",()=>o(m)),f.appendChild(v)}if(r){let v=document.createElement("button");v.className="btn btn-xs btn-secondary",v.innerHTML="\u270F\uFE0F",v.title="Edit",v.addEventListener("click",()=>r(m)),f.appendChild(v)}d.forEach(v=>{let x=document.createElement("button");x.className=`btn btn-xs ${v.class||"btn-ghost"}`,x.innerHTML=v.icon||v.label,x.title=v.label,x.addEventListener("click",()=>v.handler(m)),f.appendChild(x)}),g.appendChild(f),y.appendChild(g)}p.appendChild(y)}),l.appendChild(p),s.appendChild(l),s}function Ae({page:t,pages:e,total:r,limit:a,onPage:o}){if(e<=1)return null;let d=document.createElement("div");d.className="pagination";let i=document.createElement("span");i.className="pagination-info",i.textContent=`Total: ${r} data`,d.appendChild(i);let n=document.createElement("div");n.className="pagination-btns";let s=(c,p,m=!1,y=!1)=>{let g=document.createElement("button");g.className=`btn btn-sm ${y?"btn-primary":"btn-ghost"} pagination-btn`,g.textContent=c,g.disabled=m,g.addEventListener("click",()=>o(p)),n.appendChild(g)};s("\xAB",1,t===1),s("\u2039",t-1,t===1);let l=Math.max(1,t-2),b=Math.min(e,t+2);for(let c=l;c<=b;c++)s(c,c,!1,c===t);return s("\u203A",t+1,t===e),s("\xBB",e,t===e),d.appendChild(n),d}Se();function Te(t){return t.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="html")return e.html||"";if(e.type==="row")return`<div class="form-row">${Te(e.fields)}</div>`;let r=e.required?"required":"",a=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",o="";switch(e.type){case"textarea":o=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${r} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let i=(e.options||[]).map(c=>{let p=typeof c=="object"?c.value:c,m=typeof c=="object"?c.label:c,y=e.value==p?"selected":"";return`<option value="${p}" ${y}>${m}</option>`}).join("");o=`<select name="${e.name}" class="form-control" ${r}><option value="">-- Pilih ${e.label||""} --</option>${i}</select>`;break;case"combobox":let n=`dl-${e.name}-${Math.random().toString(36).substring(7)}`,s=(e.options||[]).map(c=>{let p=typeof c=="object"?c.value:c,m=typeof c=="object"?c.label||c.value||"":c||"";return(m==="undefined"||m==="[object Object]"||m==="null")&&(m=""),m?`<option value="${m}"></option>`:""}).join(""),l=e.value||"";if(e.value){let c=(e.options||[]).find(p=>(typeof p=="object"?p.value:p)==e.value);if(c){let p=typeof c=="object"?c.label||c.value||"":c||"";p&&p!=="undefined"&&p!=="[object Object]"&&p!=="null"&&(l=p)}}o=`
    ...
    <div class="filter-bar card ${s?"has-mobile-sheet":""}" style="padding: 1rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
        ${i.filter(u=>u.type==="search"||u.type==="search-combo").map(u=>{if(u.type==="search")return`<div class="filter-search" style="flex:1; min-width:120px;"><input type="text" class="form-control" autocomplete="off" placeholder="${u.placeholder||"Cari..."}" id="filter-search" value="${L.search||""}"></div>`;if(u.type==="search-combo"){let h="dl-filter-search",S=(u.options||[]).map(w=>`<option value="${typeof w=="object"?w.label:w}"></option>`).join("");return`<div class="filter-search" style="flex:1; min-width:120px;"><input type="text" list="${h}" class="form-control" autocomplete="off" placeholder="${u.placeholder||"Cari..."}" id="filter-search" value="${L.search||""}"><datalist id="${h}">${S}</datalist></div>`}return""}).join("")}
        ...
        <div class="filter-options" id="filter-options-wrapper">
          ...
          ${i.filter(u=>u.type!=="search"&&u.type!=="search-combo").map(u=>{if(u.type==="select")return`<select class="form-control filter-select" style="flex:1; min-width:100px;" name="${u.name}" id="filter-${u.name}"><option value="">Pilih ${u.label}</option>${(u.options||[]).map(h=>`<option value="${typeof h=="object"?h.value:h}" ${L[u.name]===(typeof h=="object"?h.value:h)?"selected":""}>${typeof h=="object"?h.label:h}</option>`).join("")}</select>`;if(u.type==="combobox"){let h=`dl-filter-${u.name}`,S=(u.options||[]).map(T=>{let _=typeof T=="object"?T.label||T.value||"":T||"";return(_==="undefined"||_==="[object Object]"||_==="null")&&(_=""),_?`<option value="${_}"></option>`:""}).join(""),w=L[u.name]||"";if(L[u.name]){let T=(u.options||[]).find(_=>String(typeof _=="object"?_.value:_)==String(L[u.name]));if(T){let _=typeof T=="object"?T.label||T.value||"":T||"";_&&_!=="undefined"&&_!=="[object Object]"&&_!=="null"&&(w=_)}}return`<div class="filter-combobox" style="flex:1; min-width:120px;">
                <input type="text" name="${u.name}" id="filter-${u.name}" list="${h}" class="form-control filter-combobox-input" value="${w}" placeholder="Pilih ${u.label}..." autocomplete="off">
                <datalist id="${h}">${S}</datalist>
              </div>`}return""}).join("")}
  ...
  `;function F(){if(!document.getElementById("bulk-toolbar"))return;let h=document.getElementById("bulk-count"),S=document.getElementById("btn-bulk-delete"),w=document.getElementById("btn-bulk-cancel");h.textContent=`${E.size} item dipilih`,E.size>0?(S.disabled=!1,w.disabled=!1):(S.disabled=!0,w.disabled=!0)}document.getElementById("btn-bulk-cancel")?.addEventListener("click",()=>{E.clear(),document.querySelectorAll(".row-checkbox").forEach(h=>h.checked=!1);let u=document.getElementById("select-all-checkbox");u&&(u.checked=!1),F()}),document.getElementById("btn-bulk-delete")?.addEventListener("click",()=>{if(E.size===0)return;let u=[...E],h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9999;display:flex;align-items:center;justify-content:center",h.innerHTML=`
      <div style="background:var(--bg-card);border-radius:var(--radius-xl);padding:28px;max-width:420px;width:90%;box-shadow:var(--shadow-lg);animation:fadeInUp .2s ease">
        <h3 style="margin:0 0 8px;color:var(--text-1);font-size:1rem;font-weight:700">\u26A0\uFE0F Hapus ${u.length} ${l}?</h3>
        ...
        <div style="display:flex;gap:8px;justify-content:flex-end">
          ...
          <button id="bulk-confirm-btn" class="btn btn-danger">Hapus ${u.length} Data</button>
        </div>
      </div>
    `,document.body.appendChild(h),h.querySelector("#bulk-cancel-btn").addEventListener("click",()=>h.remove()),h.querySelector("#bulk-confirm-btn").addEventListener("click",async()=>{let S=h.querySelector("#bulk-confirm-btn");S.disabled=!0,S.textContent="Menghapus...";let w=await k(`${a}/bulk`,{method:"DELETE",body:JSON.stringify({ids:u})});h.remove(),w.ok?(ne(`${u.length} ${l} berhasil dihapus.`),E.clear(),F(),q()):z(w.data?.error||"Gagal menghapus data.")})});let K=document.getElementById("filter-search"),ue;K?.addEventListener("input",u=>{clearTimeout(ue),ue=setTimeout(()=>{L.search=u.target.value,$=1,E.clear(),q()},400)}),i?.forEach(u=>{u.type==="select"&&document.getElementById(`filter-${u.name}`)?.addEventListener("change",h=>{L[u.name]=h.target.value,$=1,E.clear(),q()}),u.type==="combobox"&&document.getElementById(`filter-${u.name}`)?.addEventListener("change",h=>{let S=h.target.value,w=(u.options||[]).find(T=>{let _=String(typeof T=="object"?T.value:T),B=String(typeof T=="object"?T.label:T);return _===S||B===S});S?L[u.name]=w?typeof w=="object"?w.value:w:S:L[u.name]="",$=1,E.clear(),q()})}),document.getElementById("btn-reset-filter")?.addEventListener("click",()=>{L={...n},K&&(K.value=""),i?.forEach(u=>{let h=document.getElementById(`filter-${u.name}`);h&&(h.value="")}),$=1,E.clear(),q()});let me=document.getElementById("btn-mobile-filter"),se=document.getElementById("filter-options-wrapper"),ge=document.getElementById("btn-close-filter-sheet");me&&se&&(me.addEventListener("click",u=>{u.preventDefault(),se.classList.add("sheet-open")}),ge&&ge.addEventListener("click",u=>{u.preventDefault(),se.classList.remove("sheet-open")}));let pe=document.getElementById("btn-mobile-aksi"),be=document.getElementById("excel-actions-wrapper"),_e=document.getElementById("btn-close-aksi-sheet");if(pe&&be&&(pe.addEventListener("click",u=>{u.preventDefault(),be.classList.add("sheet-open")}),_e&&_e.addEventListener("click",u=>{u.preventDefault(),be.classList.remove("sheet-open")})),document.getElementById("btn-create")?.addEventListener("click",()=>Ce(null)),x){document.getElementById(`btn-export-${x.moduleName}`)?.addEventListener("click",async h=>{let S=h.target,w=S.innerHTML;S.innerHTML="\u23F3 Loading...",S.disabled=!0;try{await x.onExport()}catch{z("Gagal export data")}finally{S.innerHTML=w,S.disabled=!1}}),document.getElementById(`btn-template-${x.moduleName}`)?.addEventListener("click",()=>{x.onTemplate()});let u=document.getElementById(`input-import-${x.moduleName}`);u?.addEventListener("change",async h=>{let S=h.target.files[0];if(!S)return;u.disabled=!0;let w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.7);z-index:9999;display:flex;align-items:center;justify-content:center",w.innerHTML=`
      ...
      `,document.body.appendChild(w);let T=w.querySelector("#import-progress-text"),_=w.querySelector("#import-progress-bar"),B=w.querySelector("#import-summary"),A=w.querySelector("#import-close-btn");A.addEventListener("click",()=>{w.remove(),q()});try{let W=await De(S);if(W.length===0)throw new Error("File kosong atau format salah");let V=500,ae=0,Z=0,N=0,M=W.length;T.textContent=`Ditemukan ${M} baris data. Memulai import...`;for(let I=0;I<M;I+=V){let J=W.slice(I,I+V);T.textContent=`Mengimport baris ${I+1} - ${Math.min(I+V,M)} dari ${M}...`,_.style.width=`${Math.round(I/M*100)}%`;try{let O=await x.onImport(J);O?(ae+=O.inserted||O.metrics?.inserted||J.length,Z+=O.skipped||O.metrics?.updated||0):ae+=J.length}catch(O){console.error("Chunk import failed:",O),N+=J.length}}_.style.width="100%",T.innerHTML='<strong style="color:var(--success)">\u2705 Import Selesai!</strong>',B.style.display="block",B.innerHTML=`
        ...
        `,N>0&&(B.innerHTML+='<p style="margin-top:12px;font-size:0.8rem;color:var(--danger)">Sebagian data gagal diimport. Pastikan format kolom sesuai template dan tidak ada data kosong pada kolom wajib.</p>'),A.style.display="block",u.value=""}catch(W){T.innerHTML=`<strong style="color:var(--danger)">\u274C Gagal Memproses File</strong><br>${W.message}`,_.style.background="var(--danger)",_.style.width="100%",A.style.display="block",u.value=""}finally{u.disabled=!1}})}async function q(){F();let u=document.getElementById("table-container");if(!u)return;u.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';let h=C==="client",S=h?1:$,w=h?xe:20,T=new URLSearchParams({page:S,limit:w,...Object.fromEntries(Object.entries(L).filter(([,N])=>N))}),_=await k(`${a}?${T}`);if(!_.ok){u.innerHTML=`<div class="empty-state"><p class="text-danger">Gagal memuat data: ${_.data?.error||"Error"}</p></div>`;return}let B=_.data?.data||_.data||[],A=_.data?.pagination,W=B.length,V=B;if(h){B=g(B),V=B;let N=B.length,M=20,I=Math.ceil(N/M);$>I&&I>0&&($=I);let J=($-1)*M,O=$*M;B=B.slice(J,O),A={page:$,limit:M,total:N,pages:I}}!1,y&&y(B);let ae=Pe({columns:o,data:B,fullData:V,onEdit:c?N=>Ce(N):null,actions:f.map(N=>({...N,handler:M=>N.handler(M,q)})),emptyText:`Tidak ada ${String(l||"").toLowerCase()}`,bulkSelect:D?{selectedIds:E,onToggle:F}:null});u.innerHTML="",u.appendChild(ae);let Z=document.getElementById("pagination-container");if(Z&&(Z.innerHTML="",A&&A.pages>1)){let N=Ae({page:A.page,pages:A.pages,total:A.total,limit:A.limit,onPage:M=>{$=M,q()}});N&&Z.appendChild(N)}}function Ge(u){let h=typeof d=="function"?d(u):d;return Te(h)}function Ce(u){let h=!!u,S=document.createElement("form");if(S.noValidate=!0,S.innerHTML=Ge(u),h){let T=typeof d=="function"?d(u):d;Me(S,u)}let{close:w}=de({title:h?`Edit ${l}`:`Tambah ${l}`,content:S,size:"lg",confirmText:h?"Simpan Perubahan":`Tambah ${l}`,onConfirm:async(T,_)=>{if(!S.reportValidity())return;let B=T.querySelector(".modal-confirm");B.disabled=!0,B.textContent="Menyimpan...";let A=Ne(S),W=typeof d=="function"?d(u):d,V=async M=>{for(let I of M)if(I.type==="row")await V(I.fields);else if(I.type==="combobox"&&A[I.name]){let J=A[I.name],O=(I.options||[]).find(U=>{let ee=String(typeof U=="object"?U.value:U),ze=String(typeof U=="object"?U.label:U);return ee===J||ze===J});if(O)A[I.name]=typeof O=="object"?O.value:O;else if(I.createApi){let U={};U[I.createApi.field]=J,I.createApi.extra&&Object.assign(U,I.createApi.extra);let ee=await k(I.createApi.path,{method:"POST",body:JSON.stringify(U)});if(ee.ok&&ee.data?.id)A[I.name]=ee.data.id;else if(ee.ok&&!ee.data?.id)A[I.name]=J;else throw new Error(`Gagal membuat master data: ${ee.data?.error||"Unknown error"}`)}}};try{await V(W)}catch(M){z(M.message),B.disabled=!1,B.textContent=h?"Simpan Perubahan":`Tambah ${l}`;return}m&&(A=await m(A,u));let ae=h?"PUT":"POST",Z=h?`${a}/${u.id}`:a,N=await k(Z,{method:ae,body:JSON.stringify(A)});N.ok?(ne(h?`${l} berhasil diperbarui.`:`${l} berhasil ditambahkan.`),_(),q()):(z(N.data?.error||"Gagal menyimpan data."),B.disabled=!1,B.textContent=h?"Simpan Perubahan":`Tambah ${l}`)}})}function $t(u){Ee(`Hapus ${l} ini? Tindakan tidak dapat dibatalkan.`,async()=>{let h=await k(`${a}/${u.id}`,{method:"DELETE"});h.ok?(ne(`${l} berhasil dihapus.`),q()):z(h.data?.error||"Gagal menghapus.")},`Hapus ${l}`)}return q(),q}j();j();var Fe=null,nt=null;async function Oe(t=!1){if(Fe&&!t)return console.log("Employees Raw (Cache Hit)",Fe.slice(0,5)),Fe;let e=await k(`/api/employees?limit=${xe}&status=Aktif`);return Fe=(e.data?.data||[]).map(r=>({value:r.id,label:r.full_name})),console.log("Employees Raw",e.data?.data?.slice(0,5)),console.log("Employees Mapped (ID)",Fe.slice(0,5)),Fe}async function ie(t=!1){let r=(await Oe(t)).map(a=>({value:a.label,label:a.label}));return console.log("Employee Options",r.slice(0,5)),r}async function Q(t=!1){return nt&&!t||(nt=((await k("/api/branches?all=1")).data?.data||[]).map(r=>({value:r.id,label:r.full_name}))),nt}function X(t){let e={Done:"badge-success",Aktif:"badge-success",Open:"badge-warning","In Progress":"badge-info",Pending:"badge-warning",Diproses:"badge-info",Selesai:"badge-success","Tidak Aktif":"badge-neutral",Resign:"badge-neutral",Cut:"badge-danger","Tidak Datang":"badge-danger"};return!t||t==="-"||String(t).trim()===""?"":`<span class="badge ${e[t]||"badge-neutral"}">${t}</span>`}function bt(t){return t==null?'<span class="badge badge-neutral">-</span>':t<0?`<span class="badge badge-danger">Expired (${Math.abs(t)}h)</span>`:t<=14?`<span class="badge badge-danger">${t} hari</span>`:t<=30?`<span class="badge badge-warning">${t} hari</span>`:`<span class="badge badge-success">${t} hari</span>`}function Re(t){return`<span class="badge ${{"FACILITY CARE":"badge-info",SECURITY:"badge-secondary"}[t]||"badge-neutral"}">${t||"-"}</span>`}function ht(t){return`<span class="badge ${{"Inspeksi Hygiene & Aset Bangunan":"badge-info","General Cleaning":"badge-success","Deep Cleaning":"badge-purple",Fogging:"badge-warning"}[t]||"badge-neutral"}">${t||"-"}</span>`}function he(t){return`<span class="badge ${{Q1:"badge-info",Q2:"badge-success",Q3:"badge-warning",Q4:"badge-danger"}[t]||"badge-neutral"}">${t||"-"}</span>`}G();function yt(t,e){let r=new Date,a=`${r.getFullYear()}-${String(r.getMonth()+1).padStart(2,"0")}`;if(!(t.target_date||t.opening_date||"").startsWith(a))return!1;let d=String(t.status||"").toLowerCase();if(d!=="selesai"&&d!=="completed"&&d!=="done")return!1;let i=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?i.includes("inspeksi"):e==="gcdc"?i.includes("general cleaning")||i.includes("deep cleaning"):!1}j();Se();G();function H({container:t,title:e,icon:r,apiPath:a,columns:o,formFields:d,filterFields:i,defaultFilters:n={},enableMobileFilterSheet:s=!1,itemLabel:l="Data",canCreate:b=!0,canEdit:c=!0,canDelete:p=!0,onBeforeSubmit:m,onAfterLoad:y,onDataLoaded:g,extraActions:f=[],initialSearch:v="",exportOptions:x=null,bulkDelete:D=!1,paginationMode:C="server"}){let P=oe();P&&typeof P=="object"&&P.role==="viewer"&&(b=!1,c=!1,p=!1,D=!1,x=null);let $=1,L={...n};v&&(L.search=v);let E=new Set;t.innerHTML=`
    <div class="crud-layout-wrapper ${s?"mobile-active":""}">
      <div class="page-header">
      <h1 class="page-title">${r} ${e}</h1>
      <div class="page-actions">
  ...
  `;function F(){if(!document.getElementById("bulk-toolbar"))return;let h=document.getElementById("bulk-count"),S=document.getElementById("btn-bulk-delete"),w=document.getElementById("btn-bulk-cancel");h.textContent=`${E.size} item dipilih`,E.size>0?(S.disabled=!1,w.disabled=!1):(S.disabled=!0,w.disabled=!0)}document.getElementById("btn-bulk-cancel")?.addEventListener("click",()=>{E.clear(),document.querySelectorAll(".row-checkbox").forEach(h=>h.checked=!1);let u=document.getElementById("select-all-checkbox");u&&(u.checked=!1),F()}),document.getElementById("btn-bulk-delete")?.addEventListener("click",()=>{if(E.size===0)return;let u=[...E],h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9999;display:flex;align-items:center;justify-content:center",h.innerHTML=`
    ...
    `,document.body.appendChild(h),h.querySelector("#bulk-cancel-btn").addEventListener("click",()=>h.remove()),h.querySelector("#bulk-confirm-btn").addEventListener("click",async()=>{let S=h.querySelector("#bulk-confirm-btn");S.disabled=!0,S.textContent="Menghapus...";let w=await k(`${a}/bulk`,{method:"DELETE",body:JSON.stringify({ids:u})});h.remove(),w.ok?(ne(`${u.length} ${l} berhasil dihapus.`),E.clear(),F(),q()):z(w.data?.error||"Gagal menghapus data.")})});let K=document.getElementById("filter-search"),ue;K?.addEventListener("input",u=>{clearTimeout(ue),ue=setTimeout(()=>{L.search=u.target.value,$=1,E.clear(),q()},400)}),i?.forEach(u=>{u.type==="select"&&document.getElementById(`filter-${u.name}`)?.addEventListener("change",h=>{L[u.name]=h.target.value,$=1,E.clear(),q()}),u.type==="combobox"&&document.getElementById(`filter-${u.name}`)?.addEventListener("change",h=>{let S=h.target.value,w=(u.options||[]).find(T=>{let _=String(typeof T=="object"?T.value:T),B=String(typeof T=="object"?T.label:T);return _===S||B===S});S?L[u.name]=w?typeof w=="object"?w.value:w:S:L[u.name]="",$=1,E.clear(),q()})}),document.getElementById("btn-reset-filter")?.addEventListener("click",()=>{L={...n},K&&(K.value=""),i?.forEach(u=>{let h=document.getElementById(`filter-${u.name}`);h&&(h.value="")}),$=1,E.clear(),q()});let me=document.getElementById("btn-mobile-filter"),se=document.getElementById("filter-options-wrapper"),ge=document.getElementById("btn-close-filter-sheet");me&&se&&(me.addEventListener("click",u=>{u.preventDefault(),se.classList.add("sheet-open")}),ge&&ge.addEventListener("click",u=>{u.preventDefault(),se.classList.remove("sheet-open")}));let pe=document.getElementById("btn-mobile-aksi"),be=document.getElementById("excel-actions-wrapper"),_e=document.getElementById("btn-close-aksi-sheet");if(pe&&be&&(pe.addEventListener("click",u=>{u.preventDefault(),be.classList.add("sheet-open")}),_e&&_e.addEventListener("click",u=>{u.preventDefault(),be.classList.remove("sheet-open")})),document.getElementById("btn-create")?.addEventListener("click",()=>Ce(null)),x){document.getElementById(`btn-export-${x.moduleName}`)?.addEventListener("click",async h=>{let S=h.target,w=S.innerHTML;S.innerHTML="\u23F3 Loading...",S.disabled=!0;try{await x.onExport()}catch{z("Gagal export data")}finally{S.innerHTML=w,S.disabled=!1}}),document.getElementById(`btn-template-${x.moduleName}`)?.addEventListener("click",()=>{x.onTemplate()});let u=document.getElementById(`input-import-${x.moduleName}`);u?.addEventListener("change",async h=>{let S=h.target.files[0];if(!S)return;u.disabled=!0;let w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.7);z-index:9999;display:flex;align-items:center;justify-content:center",w.innerHTML=`
      ...
      `,document.body.appendChild(w);let T=w.querySelector("#import-progress-text"),_=w.querySelector("#import-progress-bar"),B=w.querySelector("#import-summary"),A=w.querySelector("#import-close-btn");A.addEventListener("click",()=>{w.remove(),q()});try{let W=await De(S);if(W.length===0)throw new Error("File kosong atau format salah");let V=500,ae=0,Z=0,N=0,M=W.length;T.textContent=`Ditemukan ${M} baris data. Memulai import...`;for(let I=0;I<M;I+=V){let J=W.slice(I,I+V);T.textContent=`Mengimport baris ${I+1} - ${Math.min(I+V,M)} dari ${M}...`,_.style.width=`${Math.round(I/M*100)}%`;try{let O=await x.onImport(J);O?(ae+=O.inserted||O.metrics?.inserted||J.length,Z+=O.skipped||O.metrics?.updated||0):ae+=J.length}catch(O){console.error("Chunk import failed:",O),N+=J.length}}_.style.width="100%",T.innerHTML='<strong style="color:var(--success)">\u2705 Import Selesai!</strong>',B.style.display="block",B.innerHTML=`
          ...
          <div style="display:flex;justify-content:space-between;margin-bottom:8px;color:var(--warning)"><span>Dilewati (Duplikat):</span> <strong>${Z}</strong></div>
          <div style="display:flex;justify-content:space-between;color:var(--danger)"><span>Gagal:</span> <strong>${N}</strong></div>
        `,N>0&&(B.innerHTML+='<p style="margin-top:12px;font-size:0.8rem;color:var(--danger)">Sebagian data gagal diimport. Pastikan format kolom sesuai template dan tidak ada data kosong pada kolom wajib.</p>'),A.style.display="block",u.value=""}catch(W){T.innerHTML=`<strong style="color:var(--danger)">\u274C Gagal Memproses File</strong><br>${W.message}`,_.style.background="var(--danger)",_.style.width="100%",A.style.display="block",u.value=""}finally{u.disabled=!1}})}async function q(){F();let u=document.getElementById("table-container");if(!u)return;u.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';let h=C==="client",S=h?1:$,w=h?xe:20,T=new URLSearchParams({page:S,limit:w,...Object.fromEntries(Object.entries(L).filter(([,N])=>N))}),_=await k(`${a}?${T}`);if(!_.ok){u.innerHTML=`<div class="empty-state"><p class="text-danger">Gagal memuat data: ${_.data?.error||"Error"}</p></div>`;return}let B=_.data?.data||_.data||[],A=_.data?.pagination,W=B.length,V=B;if(h){B=g(B),V=B;let N=B.length,M=20,I=Math.ceil(N/M);$>I&&I>0&&($=I);let J=($-1)*M,O=$*M;B=B.slice(J,O),A={page:$,limit:M,total:N,pages:I}}!1,y&&y(B);let ae=Pe({columns:o,data:B,fullData:V,onEdit:c?N=>Ce(N):null,actions:f.map(N=>({...N,handler:M=>N.handler(M,q)})),emptyText:`Tidak ada ${String(l||"").toLowerCase()}`,bulkSelect:D?{selectedIds:E,onToggle:F}:null});u.innerHTML="",u.appendChild(ae);let Z=document.getElementById("pagination-container");if(Z&&(Z.innerHTML="",A&&A.pages>1)){let N=Ae({page:A.page,pages:A.pages,total:A.total,limit:A.limit,onPage:M=>{$=M,q()}});N&&Z.appendChild(N)}}function Ge(u){let h=typeof d=="function"?d(u):d;return Te(h)}function Ce(u){let h=!!u,S=document.createElement("form");if(S.noValidate=!0,S.innerHTML=Ge(u),h){let T=typeof d=="function"?d(u):d;Me(S,u)}let{close:w}=de({title:h?`Edit ${l}`:`Tambah ${l}`,content:S,size:"lg",confirmText:h?"Simpan Perubahan":`Tambah ${l}`,onConfirm:async(T,_)=>{if(!S.reportValidity())return;let B=T.querySelector(".modal-confirm");B.disabled=!0,B.textContent="Menyimpan...";let A=Ne(S),W=typeof d=="function"?d(u):d,V=async M=>{for(let I of M)if(I.type==="row")await V(I.fields);else if(I.type==="combobox"&&A[I.name]){let J=A[I.name],O=(I.options||[]).find(U=>{let ee=String(typeof U=="object"?U.value:U),ze=String(typeof U=="object"?U.label:U);return ee===J||ze===J});if(O)A[I.name]=typeof O=="object"?O.value:O;else if(I.createApi){let U={};U[I.createApi.field]=J,I.createApi.extra&&Object.assign(U,I.createApi.extra);let ee=await k(I.createApi.path,{method:"POST",body:JSON.stringify(U)});if(ee.ok&&ee.data?.id)A[I.name]=ee.data.id;else if(ee.ok&&!ee.data?.id)A[I.name]=J;else throw new Error(`Gagal membuat master data: ${ee.data?.error||"Unknown error"}`)}}};try{await V(W)}catch(M){z(M.message),B.disabled=!1,B.textContent=h?"Simpan Perubahan":`Tambah ${l}`;return}m&&(A=await m(A,u));let ae=h?"PUT":"POST",Z=h?`${a}/${u.id}`:a,N=await k(Z,{method:ae,body:JSON.stringify(A)});N.ok?(ne(h?`${l} berhasil diperbarui.`:`${l} berhasil ditambahkan.`),_(),q()):(z(N.data?.error||"Gagal menyimpan data."),B.disabled=!1,B.textContent=h?"Simpan Perubahan":`Tambah ${l}`)}})}function $t(u){Ee(`Hapus ${l} ini? Tindakan tidak dapat dibatalkan.`,async()=>{let h=await k(`${a}/${u.id}`,{method:"DELETE"});h.ok?(ne(`${l} berhasil dihapus.`),q()):z(h.data?.error||"Gagal menghapus.")},`Hapus ${l}`)}return q(),q}j();G();function It(t,e){let r=String(t.status||"").toLowerCase();return e==="active"?r==="aktif":e==="reliefer"?t.division==="FC - RELIEFER"&&r==="aktif":!1}j();G();function ft(t,e){if(String(t.status||"").toLowerCase()!=="aktif")return!1;if(e==="active")return!0;if(e==="expiring30"){if(!t.end_date)return!1;let a=new Date;a.setHours(0,0,0,0);let o=new Date(a);o.setDate(a.getDate()+30);let d=new Date(t.end_date);return d.setHours(0,0,0,0),d>=a&&d<=o}return!1}j();G();function Lt(t,e){let r=String(t.status||"").toLowerCase();return e==="open"?r==="open":!1}j();function Bt(t,e){let r=String(t.status||"").toLowerCase();return e==="pending"?r==="pending":!1}var we={};function He(t){if(we[t]){try{we[t].destroy()}catch{}delete we[t]}}function xa(){Object.keys(we).forEach(He)}var ve=(t,e=0)=>{let r=Number(t);return isNaN(r)||t===null||t===void 0?e:r},Ke=(t,e="\u2014")=>{if(t==null||t==="")return e;let r=String(t).trim();return r===""||r==="[object Object]"?e:r};function At(t,e,r=900){if(!t)return;let a=Math.max(0,Math.round(ve(e)));if(a===0){t.textContent="0";return}let o=Date.now(),d=()=>{let i=Math.min((Date.now()-o)/r,1),n=1-Math.pow(1-i,3);t.textContent=Math.round(n*a).toLocaleString("id-ID"),i<1?requestAnimationFrame(d):t.textContent=a.toLocaleString("id-ID")};requestAnimationFrame(d)}var Sa={Done:"pill-success",Aktif:"pill-success",Selesai:"pill-success",Open:"pill-danger",Pending:"pill-warning","In Progress":"pill-info","Tidak Aktif":"pill-neutral",Resign:"pill-neutral",Cut:"pill-neutral"},wa=t=>{let e=Ke(t,"\u2014");return`<span class="status-pill ${Sa[e]||"pill-neutral"}">${e}</span>`};var ye={family:"Inter",size:11},ke="#94A3B8",je="#F1F5F9",vt=["#2563EB","#10B981","#F59E0B","#EF4444","#8B5CF6","#0EA5E9","#F97316","#14B8A6","#6366F1","#EC4899"],_a=()=>window.innerWidth<768;function it(t={}){return{responsive:!0,maintainAspectRatio:!1,animation:{duration:700,easing:"easeOutQuart"},plugins:{legend:{position:_a()?"bottom":"top",labels:{font:ye,color:"#64748B",usePointStyle:!0,padding:10,boxWidth:8,boxHeight:8}},tooltip:{mode:"index",intersect:!1,bodyFont:ye,titleFont:{...ye,weight:"700"}}},scales:{x:{grid:{color:je},ticks:{font:ye,color:ke,maxRotation:0}},y:{grid:{color:je},ticks:{font:ye,color:ke},beginAtZero:!0}},...t}}var Ca=()=>Array(5).fill(0).map(()=>`
  ...
  `,n=[{id:"mini-jadwal",icon:"\u{1F4C5}",label:"Jadwal",dropdown:`
    ...
    </a>`).join(""),e.querySelectorAll(".mini-stat-value").forEach(c=>At(c,parseInt(c.dataset.target)||0,700));let s=document.getElementById("dash-jadwal-period");s&&s.addEventListener("change",c=>{let p=c.target.value,m=(window.dashboardSchedules||[]).filter(f=>f.period===p).length,y=document.querySelector("#mini-jadwal .mini-stat-value");y&&(y.dataset.target=m,y.textContent=m);let g=document.getElementById("mini-jadwal");g&&(g.href=`#/timeline?dash_filter=period_${p.toLowerCase()}`)});let l=(c,p,m,y,g)=>{let f=document.getElementById(c);f&&f.addEventListener("change",v=>{let x=v.target.value,D=(m||[]).filter($=>y($,x)).length,C=document.querySelector(`#${p} .mini-stat-value`);C&&(C.dataset.target=D,C.textContent=D);let P=document.getElementById(p);P&&(P.href=`${g}&month=${x}`)})},b=c=>{let p=String(c.status||"").toLowerCase();return p==="done"||p==="selesai"||p==="completed"};l("dash-reliefer-month","mini-reliefer",window.dashboardRelievers,(c,p)=>window.parseFlexibleDate(c.backup_date).startsWith(p)&&b(c),"#/relievers?dash_filter=reliever"),l("dash-inspeksi-month","mini-inspeksi",window.dashboardSchedules,(c,p)=>c.activity_type==="Inspeksi Hygiene"&&b(c)&&window.parseFlexibleDate(c.opening_date||c.target_date).startsWith(p),"#/timeline?dash_filter=inspeksi"),l("dash-gcdc-month","mini-gcdc",window.dashboardSchedules,(c,p)=>(c.activity_type==="General Cleaning"||c.activity_type==="Deep Cleaning")&&b(c)&&window.parseFlexibleDate(c.opening_date||c.target_date).startsWith(p),"#/timeline?dash_filter=gcdc"),l("dash-fogging-month","mini-fogging",window.dashboardFogging,(c,p)=>b(c)&&window.parseFlexibleDate(c.activity_date).startsWith(p),"#/reports/fogging?dash_filter=fogging")}function Ta(t){fe("skel-donut","chart-donut");let e=document.getElementById("chart-donut"),r=document.getElementById("donut-legend");if(!e||!r)return;He("donut");let a=(t||[]).filter(s=>ve(s.count)>0);if(!a.length){Xe(e,"Belum ada data permasalahan");return}let o=a.map(s=>`${Ke(s.category,"Lainnya")}`),d=a.map(s=>ve(s.count)),i=d.reduce((s,l)=>s+l,0);r.innerHTML=a.map((s,l)=>{let b=vt[l%vt.length],c=i>0?Math.round(s.count/i*100):0;return`
    ...
    `}).join("");let n={id:"centerText",beforeDraw:function(s){let l=s.width,b=s.height,c=s.ctx;c.restore();let p=(b/80).toFixed(2);c.font="bold "+p+"em Inter",c.textBaseline="middle",c.fillStyle="#1E293B";let m=i.toString(),y=Math.round((l-c.measureText(m).width)/2),g=b/2;c.fillText(m,y,g-4),c.font="600 "+(p*.35).toFixed(2)+"em Inter",c.fillStyle="#64748B";let f="Total",v=Math.round((l-c.measureText(f).width)/2);c.fillText(f,v,g+10),c.save()}};we.donut=new Chart(e,{type:"doughnut",data:{labels:o,datasets:[{data:d,backgroundColor:vt,borderWidth:2,borderColor:"#fff",hoverBorderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,animation:{duration:700},plugins:{legend:{display:!1},tooltip:{bodyFont:ye,titleFont:{...ye,weight:"700"},callbacks:{label:s=>` ${s.label}: ${s.parsed} kasus`}}},cutout:"75%"},plugins:[n]})}function Da(t){fe("skel-trend","chart-trend");let e=document.getElementById("chart-trend");if(!e)return;He("trend"),t=t||{};let r=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],a=(t.labels||[]).map(i=>{if(!i||typeof i!="string")return"";try{let[n,s]=i.split("-");return(r[Number(s)-1]||s)+" "+String(n).slice(-2)}catch{return i}}),o=(t.open||[]).map(i=>ve(i)),d=(t.closed||[]).map(i=>ve(i));if(!a.length){Xe(e,"Belum ada data trend");return}we.trend=new Chart(e,{type:"line",data:{labels:a,datasets:[{label:"Open",data:o,borderColor:"#EF4444",backgroundColor:"rgba(239,68,68,.08)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#EF4444",borderWidth:2},{label:"Closed",data:d,borderColor:"#10B981",backgroundColor:"rgba(16,185,129,.1)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#10B981",borderWidth:2}]},options:it({plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{family:"Inter",size:9},color:ke,maxRotation:0,autoSkip:!1}},y:{grid:{color:je},ticks:{font:{family:"Inter",size:9},color:ke},beginAtZero:!0}}})})}function Ot(t){fe("skel-jadwal","chart-jadwal");let e=document.getElementById("chart-jadwal");if(!e)return;He("jadwal"),t=t||{};let r=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"];if(!Object.values(t).some(s=>Array.isArray(s)&&s.some(l=>l>0))){Xe(e,"Belum ada data jadwal");return}let o=t["Inspeksi Hygiene"]||Array(12).fill(0),d=t["General Cleaning"]||Array(12).fill(0),i=t["Deep Cleaning"]||Array(12).fill(0),n=t.Fogging||Array(12).fill(0);we.jadwal=new Chart(e,{type:"bar",data:{labels:r,datasets:[{label:"Inspeksi",data:o,backgroundColor:"#3B82F6"},{label:"General Cleaning",data:d,backgroundColor:"#10B981"},{label:"Deep Cleaning",data:i,backgroundColor:"#F59E0B"},{label:"Fogging",data:n,backgroundColor:"#EF4444"}]},options:it({plugins:{legend:{display:!1}},datasets:{bar:{barPercentage:.85,categoryPercentage:.9}},scales:{x:{stacked:!0,grid:{display:!1},ticks:{font:{family:"Inter",size:9},color:ke,maxRotation:0,autoSkip:!1}},y:{stacked:!0,grid:{color:je},ticks:{font:{family:"Inter",size:9},color:ke},min:0}}})})}function Rt(t){fe("skel-insp","chart-insp");let e=document.getElementById("chart-insp");if(!e)return;He("inspBar"),t=t||{};let r=t.labels||[],a=(t.fc||[]).map(d=>ve(d)),o=(t.spv||[]).map(d=>ve(d));if(!r.length){Xe(e,"Belum ada data inspeksi");return}we.inspBar=new Chart(e,{type:"bar",data:{labels:r,datasets:[{label:"Skor FC",data:a,backgroundColor:"rgba(37,99,235,.75)",borderRadius:4,borderSkipped:!1},{label:"Skor SPV",data:o,backgroundColor:"rgba(16,185,129,.75)",borderRadius:4,borderSkipped:!1}]},options:it({plugins:{legend:{position:"top"}},scales:{x:{grid:{display:!1},ticks:{font:ye,color:ke,maxRotation:45,minRotation:30}},y:{grid:{color:je},ticks:{font:ye,color:ke},min:0,max:100}}})})}function Ia(t){fe("skel-contract-mini","chart-contract-mini");let e=document.getElementById("chart-contract-mini");if(!e)return;He("contractMiniBar"),t=t||{};let r={"06":"Jun","07":"Jul","08":"Agu","09":"Sep",10:"Okt",11:"Nov",12:"Des"},a=(t.labels||[]).map(i=>{let n=i.split("-")[1];return r[n]||i}),o=(t.data||[]).map(i=>ve(i));if(!a.length){Xe(e,"Belum ada data");return}let d=e.getContext("2d");we.contractMiniBar=new Chart(e,{type:"bar",data:{labels:a,datasets:[{label:"Kontrak Habis",data:o,backgroundColor:"#3B82F6",borderRadius:4,borderSkipped:!1,barPercentage:.6,categoryPercentage:.7}]},options:it({onClick:(i,n)=>{if(n&&n.length>0){let s=n[0].index,l=(t.labels||[])[s];l&&(window.location.hash="#/contracts?month_expiry="+l)}},plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:ye,color:ke,maxRotation:0,autoSkip:!1}},y:{grid:{color:je,borderDash:[4,4],drawBorder:!1},ticks:{font:ye,color:ke,precision:0,maxTicksLimit:5},min:0}},animation:{y:{duration:1e3,easing:"easeOutQuart"}}})})}function La(t){let e=document.getElementById("table-issues");if(!e)return;let r=(t||[]).slice(0,8);if(!r.length){e.innerHTML='<div class="chart-empty">\u2705 Tidak ada permasalahan terbuka</div>';return}e.innerHTML=`
    <div class="dash-list">
      ${r.map(a=>`
...
`)}let P=l(x,v),$=null;return P||($="Karyawan tidak ditemukan di Database"),{isValid:!!P,invalidReason:$,rowNum:v,data:{employee_id:P,branch_id:s(String(g.Cabang||"").trim()),division:String(g["Div / Bagian"]||"").trim()||"FACILITY CARE",start_date:C,end_date:b(g["Tanggal Selesai"])||"2099-12-31",status:String(g.Status||"").trim(),_rawName:x}}}),p=[],m=[];if(c.forEach(g=>{g.isValid?p.push(g.data):m.push({rowNum:g.rowNum,name:g.data._rawName,reason:g.invalidReason})}),console.log(`Split Validation - Valid: ${p.length}, Invalid: ${m.length}`),p.length===0)return{inserted:0,skipped:a.length,failed:a.length};let y=await k("/api/import/contracts",{method:"POST",body:JSON.stringify({rows:p,onDuplicate:"update"})});if(!y.ok)throw new Error(y.data?.error||"Import gagal");return y.data}}})}j();G();var wt=[],Ze=[];function Oa(t){if(!Array.isArray(t))return"Q3";let e=["Q4","Q3","Q2","Q1"];for(let r of e)if(t.some(a=>a.period===r))return r;return"Q3"}async function Jt(t,e){wt=await Q();let r=await ie();Ze=["Berlin Ariansyah","Ade Surahman"];let a=m=>m&&!Ze.find(y=>String(typeof y=="object"?y.value:y).toLowerCase()===String(m).toLowerCase())?[...Ze,m]:Ze,o=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`),d=m=>{if(!m||m==="-"||String(m).trim()==="")return"";let y=String(m).split("-");return y.length===3&&y[0].length===4?`${y[2]}-${y[1]}-${y[0]}`:m},i=o.data?.data||[],n=Oa(i),s=e?e.get("dash_filter"):null,l=new Date,b=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}`,c={},p=e&&e.get("month")?e.get("month"):null;s==="inspeksi"?c={status:"Done",activity_type:"Inspeksi Hygiene",month:p}:s==="gcdc"?c={status:"Done",activity_type:"GCDC",month:p}:s&&s.startsWith("period_")&&(c={period:s.replace("period_","").toUpperCase()}),gt({container:t,title:"Jadwal Kegiatan",icon:"\u{1F4C5}",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",paginationMode:"client",enableMobileFilterSheet:!0,defaultFilters:c,onDataLoaded:m=>m.sort((y,g)=>{let f=y.opening_date?new Date(y.opening_date).getTime():0;return(g.opening_date?new Date(g.opening_date).getTime():0)-f}),columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:m=>ht(m)},{key:"period",label:"Periode",render:m=>he(m)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:m=>d(m)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:m=>d(m)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:m=>d(m)},{key:"status",label:"Status",render:m=>X(m)}],filterFields:[{type:"combobox",name:"branch_id",label:"Cabang",options:wt},{type:"select",name:"activity_type",label:"Kegiatan",options:[{value:"Inspeksi Hygiene",label:"Inspeksi Hygiene"},{value:"General Cleaning",label:"General Cleaning"},{value:"Deep Cleaning",label:"Deep Cleaning"},{value:"Fogging",label:"Fogging"},{value:"GCDC",label:"GCDC (GC & DC)"}]},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"combobox",name:"pic",label:"PIC",options:Ze}],formFields:m=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:wt,value:m?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"],value:m?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:m?.period},{name:"pic",label:"PIC",type:"combobox",options:a(m?.pic),value:m?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:m?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:m?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:m?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:m?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:m?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let m=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`);if(m.ok){let y=m.data.data.map(g=>({Cabang:g.branch_name||"",Kegiatan:g.activity_type||"",Periode:g.period||"",PIC:g.pic||"","Tgl Opening":g.opening_date||"","Tgl Target":g.target_date||"","Tgl Selesai":g.completion_date||"",Status:g.status||""}));R(y,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{R([{Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done"}],"Template_Import_Jadwal")},onImport:async m=>{let g=(await k("/api/branches?all=1")).data?.data||[],f=C=>{if(!C)return null;let P=String(C||"").toLowerCase(),$=g.find(L=>String(L.full_name||"").toLowerCase()===P||String(L.code||"").toLowerCase()===P||String(L.name||"").toLowerCase()===P);return $?$.id:null},v=C=>{if(C==null||C==="")return"";if(C instanceof Date&&!isNaN(C.getTime()))return C.toISOString().slice(0,10);let P=String(C).trim();if(P===""||P==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(P))return P.slice(0,10);if(/^\d{4,5}$/.test(P)){let L=Number(P);if(L>2e4&&L<99999){let E=new Date(Date.UTC(1899,11,30)+L*864e5);return isNaN(E.getTime())?"":E.toISOString().slice(0,10)}}let $=P.split(/[\/\-\.]/);if($.length===3){let[L,E,F]=$.map(K=>K.trim());if(L.length===4&&E.length<=2&&F.length<=2)return`${L}-${E.padStart(2,"0")}-${F.padStart(2,"0")}`;if(F.length===4&&E.length<=2&&L.length<=2)return`${F}-${E.padStart(2,"0")}-${L.padStart(2,"0")}`}return P},x=m.map(C=>({branch_id:f(String(C.Cabang||"").trim()),activity_type:String(C.Kegiatan||"").trim(),period:String(C.Periode||"").trim(),pic:String(C.PIC||C.Pic||"").trim(),opening_date:v(C["Tgl Opening"]||C["Tanggal Opening"]||C["Tgl Openir"]),target_date:v(C["Tgl Target"]||C["Tanggal Target"]),completion_date:v(C["Tgl Selesai"]||C["Tanggal Selesai"]),status:String(C.Status||"").trim(),notes:String(C.Catatan||C.Keterangan||"").trim()})).filter(C=>C.activity_type&&C.period),D=await k("/api/import/schedule",{method:"POST",body:JSON.stringify({rows:x,onDuplicate:"update"})});if(!D.ok)throw new Error(D.data?.error||"Import gagal");return D.data}}})}j();G();var _t=[],rt=[];function Ra(t,e){let r=String(t.status||"").toLowerCase();return e==="open"?r==="open":!1}async function Ut(t,e){let r=e?e.get("dash_filter"):null;_t=await Q(),rt=await ie();let a=i=>i&&!rt.find(n=>n.value===i)?[...rt,{value:i,label:i}]:rt,o=new Date().getFullYear();H({container:t,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,itemLabel:"Permasalahan",paginationMode:"client",onDataLoaded:i=>r?i.filter(n=>Ra(n,r)):i,columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:i=>window.formatDate(i)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:i=>`<span class="badge badge-secondary">${i}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:i=>`<span title="${i}">${i?.length>50?i.slice(0,50)+"\u2026":i}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:i=>`<span title="${i||""}">${i?.length>40?i.slice(0,40)+"\u2026":i||"-"}</span>`},{key:"status",label:"Status",render:i=>X(i)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:i=>window.formatDate(i)},{key:"day_count",label:"Hari",render:i=>i??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"combobox",name:"branch_id",label:"Cabang",options:_t},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:["2025","2026","2027","2028","2029","2030"]}],formFields:i=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:i?.report_date},{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:_t,value:i?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:i?.category},{name:"source",label:"Sumber Laporan",type:"combobox",options:["SPV","AM","RCP","Perawat","FC","Berlin","Ade","Pattrel","Dentrel"],value:i?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:i?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"combobox",options:a(i?.employee_name),value:i?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"combobox",options:a(i?.fc_specialist),value:i?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:i?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:i?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:i?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let i=await k(`/api/issues${window.location.search?window.location.search+"&":"?"}limit=10000`);if(i.ok){let n=i.data.data.map(s=>({Tanggal:s.report_date||"",Cabang:s.branch_name||"",Kategori:s.category||"",Sumber:s.source||"",Keluhan:s.complaint||"","Nama FC":s.employee_name||"","FC Spesialis":s.fc_specialist||"",Solusi:s.solution||"","Tgl Selesai":s.completion_date||"",Status:s.status||""}));R(n,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{R([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async i=>{let s=(await k("/api/branches?all=1")).data?.data||[],l=p=>{if(!p)return null;let m=String(p||"").toLowerCase(),y=s.find(g=>String(g.full_name||"").toLowerCase()===m||String(g.code||"").toLowerCase()===m||String(g.name||"").toLowerCase()===m);return y?y.id:null},b=i.map(p=>({branch_id:l(String(p.Cabang||"").trim()),report_date:String(p.Tanggal||"").trim(),category:String(p.Kategori||"").trim(),source:String(p.Sumber||"").trim(),complaint:String(p.Keluhan||"").trim(),employee_name:String(p["Nama FC"]||"").trim(),fc_specialist:String(p["FC Spesialis"]||"").trim(),solution:String(p.Solusi||"").trim(),completion_date:String(p["Tgl Selesai"]||"").trim(),status:String(p.Status||"").trim()})).filter(p=>p.report_date&&p.complaint&&p.category),c=await k("/api/import/issues",{method:"POST",body:JSON.stringify({rows:b,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}}})}j();var qe=[];function Ka(t,e){let r=String(t.status||"").toLowerCase();return e==="pending"?r==="pending":!1}async function Gt(t,e){let r=e?e.get("dash_filter"):null;qe=await Q();let a=await ie(),o=["Ade","Berlin"],d=n=>n&&!a.find(s=>s.value===n)?[...a,{value:n,label:n}]:a,i=n=>n&&!o.find(s=>(typeof s=="object"?s.value:s)===n)?[...o,n]:o;H({container:t,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,itemLabel:"One on One",paginationMode:"client",onDataLoaded:n=>r?n.filter(s=>Ka(s,r)):n,columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:n=>window.formatDate(n)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:n=>`<span title="${n||""}">${n?.length>50?n.slice(0,50)+"\u2026":n||"-"}</span>`},{key:"solution",label:"Solusi",render:n=>`<span title="${n||""}">${n?.length>40?n.slice(0,40)+"\u2026":n||"-"}</span>`},{key:"status",label:"Status",render:n=>X(n)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:n=>window.formatDate(n)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:n=>n?`<a href="${n}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"combobox",name:"branch_id",label:"Cabang",options:qe},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async n=>{let s=new URLSearchParams(n||{}).toString(),l=await k(`/api/one-on-one?limit=10000&${s}`);if(l.ok){let b=l.data.data.map(p=>({Tanggal:p.meeting_date||"",Cabang:p.branch_name||"","Nama Karyawan":p.employee_name||"",PIC:p.pic||"",Masalah:p.problem||"",Solusi:p.solution||"",Status:p.status||"","Tgl Selesai":p.completion_date||"",Dokumen:p.document_link||""})),{downloadExcel:c}=await Promise.resolve().then(()=>(G(),ce));c(b,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let n=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:s}=await Promise.resolve().then(()=>(G(),ce));s(n,"Template_Import_OneOnOne")},onImport:async n=>{let s=p=>{if(!p)return null;let m=String(p||"").toLowerCase(),y=qe.find(g=>String(g.label||"").toLowerCase()===m);return y?y.value:null},l=p=>{if(!p)return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let m=String(p).trim();if(/^\d{4,5}$/.test(m)){let g=Number(m);if(g>2e4&&g<99999){let f=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(f.getTime())?"":f.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(m))return m.slice(0,10);let y=m.split(/[\/\-\.]/);if(y.length===3){let[g,f,v]=y.map(x=>x.trim());if(g.length===4&&f.length<=2&&v.length<=2)return`${g}-${f.padStart(2,"0")}-${v.padStart(2,"0")}`;if(v.length===4&&f.length<=2&&g.length<=2)return`${v}-${f.padStart(2,"0")}-${g.padStart(2,"0")}`}return m},b=n.map(p=>({meeting_date:l(p.Tanggal),employee_name:String(p["Nama Karyawan"]||"").trim(),branch_id:s(String(p.Cabang||"").trim()),pic:String(p.PIC||"").trim(),problem:String(p.Masalah||"").trim(),solution:String(p.Solusi||"").trim(),status:String(p.Status||"").trim(),completion_date:l(p["Tgl Selesai"]),document_link:String(p.Dokumen||"").trim()})).filter(p=>p.meeting_date&&p.employee_name&&p.branch_id),c=await k("/api/import/one_on_one",{method:"POST",body:JSON.stringify({rows:b,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}},formFields:n=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:n?.meeting_date},{name:"branch_id",label:"Cabang",type:"combobox",options:n?.branch_id&&!qe.find(s=>s.value==n.branch_id)?[...qe,{value:n.branch_id,label:n.branch_name||n.branch_id}]:qe,createApi:{path:"/api/branches",field:"full_name"},value:n?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"combobox",required:!0,options:d(n?.employee_name),value:n?.employee_name},{name:"pic",label:"PIC",type:"combobox",options:i(n?.pic),createApi:{path:"/api/pic",field:"name"},value:n?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:n?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:n?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:n?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:n?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:n?.document_link}]})}j();async function zt(t){let e=await Q(),r=await ie(),a=["Ade","Berlin"],o=n=>n&&!r.find(s=>s.value===n)?[...r,{value:n,label:n}]:r,d=n=>n&&!a.find(s=>(typeof s=="object"?s.value:s)===n)?[...a,n]:a,i=Array.from({length:5},(n,s)=>String(new Date().getFullYear()-s));H({container:t,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:n=>window.formatDate(n)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:n=>{try{let s=JSON.parse(n);return Array.isArray(s)?s.join(", "):n||"-"}catch{return n||"-"}}},{key:"score",label:"Nilai",render:n=>n!=null?`<strong>${n}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:n=>n?`<a href="${n}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer..."},{type:"select",name:"year",label:"Tahun",options:i}],exportOptions:{moduleName:"training",onExport:async n=>{let s=new URLSearchParams(n||{}).toString(),l=await k(`/api/training?limit=10000&${s}`);if(l.ok){let b=l.data.data.map(p=>{let m=p.participants||"";try{let y=JSON.parse(m);m=Array.isArray(y)?y.join(", "):m}catch{}return{Tanggal:p.training_date||"",Batch:p.batch||"",Materi:p.subject||"",Cabang:p.branch_name||"",Trainer:p.trainer||"",Peserta:m,Nilai:p.score!==null&&p.score!==void 0?p.score:"",Dokumen:p.document_link||""}}),{downloadExcel:c}=await Promise.resolve().then(()=>(G(),ce));c(b,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let n=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:s}=await Promise.resolve().then(()=>(G(),ce));s(n,"Template_Import_Training")},onImport:async n=>{let s=p=>{if(!p)return null;let m=String(p||"").toLowerCase(),y=e.find(g=>String(g.label||"").toLowerCase()===m);return y?y.value:null},l=p=>{if(!p)return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let m=String(p).trim();if(/^\d{4,5}$/.test(m)){let g=Number(m);if(g>2e4&&g<99999){let f=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(f.getTime())?"":f.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(m))return m.slice(0,10);let y=m.split(/[\/\-\.]/);if(y.length===3){let[g,f,v]=y.map(x=>x.trim());if(g.length===4&&f.length<=2&&v.length<=2)return`${g}-${f.padStart(2,"0")}-${v.padStart(2,"0")}`;if(v.length===4&&f.length<=2&&g.length<=2)return`${v}-${f.padStart(2,"0")}-${g.padStart(2,"0")}`}return m},b=n.map(p=>({training_date:l(p.Tanggal),batch:String(p.Batch||"").trim(),subject:String(p.Materi||"").trim(),branch_id:s(String(p.Cabang||"").trim()),trainer:String(p.Trainer||"").trim(),participants:String(p.Peserta||"").trim(),score:p.Nilai?Number(p.Nilai):null,document_link:String(p.Dokumen||"").trim()})).filter(p=>p.training_date&&p.subject&&p.branch_id),c=await k("/api/import/training",{method:"POST",body:JSON.stringify({rows:b,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}},formFields:n=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:n?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:n?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:n?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",options:e,value:n?.branch_id},{name:"trainer",label:"Trainer",type:"combobox",options:d(n?.trainer),value:n?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let s=JSON.parse(n?.participants);return Array.isArray(s)?s.join(", "):n?.participants||""}catch{return n?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:n?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:n?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:n?.notes}],onBeforeSubmit:async n=>(n.participants&&(n.participants=JSON.stringify(n.participants.split(",").map(s=>s.trim()).filter(Boolean))),n)})}j();Se();G();function Qt({container:t,title:e,icon:r,apiPath:a,columns:o,formFields:d,filterFields:i,defaultFilters:n={},enableMobileFilterSheet:s=!1,itemLabel:l="Data",canCreate:b=!0,canEdit:c=!0,canDelete:p=!0,onBeforeSubmit:m,onAfterLoad:y,onDataLoaded:g,extraActions:f=[],initialSearch:v="",exportOptions:x=null,bulkDelete:D=!1,paginationMode:C="server"}){let P=oe();P&&typeof P=="object"&&P.role==="viewer"&&(b=!1,c=!1,p=!1,D=!1,x=null);let $=1,L={...n};v&&(L.search=v);let E=new Set;t.innerHTML=`
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),o()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),o()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.querySelectorAll(".cal-filter").forEach(d=>d.addEventListener("change",o));async function a(){try{let d=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`;r=(await k(`/api/dashboard/calendar?month=${d}`)).data?.data||[]}catch(d){console.warn("[Calendar] Failed to load events, rendering empty grid:",d),r=[]}}async function o(){let d=document.getElementById("calendar-grid");if(d){d.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
      ${Array(35).fill('<div style="background:#f8fafc;min-height:70px;"></div>').join("")}
    </div>`,await a();try{let i=e.getFullYear(),n=e.getMonth(),s=e.toLocaleDateString("id-ID",{month:"long",year:"numeric"}),l=document.getElementById("cal-month-label");l&&(l.textContent=s);let b=new Set(Array.from(document.querySelectorAll(".cal-filter:checked")).map(C=>C.value)),c=r.filter(C=>b.has(C.type)),p={};c.forEach(C=>{let P=(C.event_date||"").slice(0,10);p[P]||(p[P]=[]),p[P].push(C)});let m=new Date(i,n,1).getDay(),y=new Date(i,n+1,0).getDate(),g=["Min","Sen","Sel","Rab","Kam","Jum","Sab"],f=new Date().toISOString().slice(0,10),v='<div class="calendar-grid">';g.forEach(C=>{v+=`<div class="cal-day-header">${C}</div>`});for(let C=0;C<m;C++)v+='<div class="cal-cell cal-cell-empty"></div>';for(let C=1;C<=y;C++){let P=`${i}-${String(n+1).padStart(2,"0")}-${String(C).padStart(2,"0")}`,$=p[P]||[],L=P===f;v+=`
          ...
          `).join(""),L.style.display="block"})})}catch(i){console.error("[Calendar] Render error:",i),d&&(d.innerHTML=`
          <div style="padding:40px;text-align:center;color:var(--text-3)">
            <div style="font-size:2rem;margin-bottom:8px">\u{1F4C5}</div>
            <div>Gagal memuat kalender. Silakan refresh.</div>
          </div>`)}}}o()}function qa(t,e){return t?t.length>e?t.slice(0,e)+"\u2026":t:""}function lt(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function Ja(t){return{schedule:"\u{1F5D3} Jadwal",issue:"\u26A0\uFE0F Permasalahan",reliever:"\u{1F504} Reliefer",training:"\u{1F393} Training",contract_expiry:"\u{1F4CB} Kontrak Habis"}[t]||t}j();async function la(t){let e=oe(),r=(e?.full_name||e?.username||"U")[0].toUpperCase(),o={superadmin:"#7C3AED",admin:"#2563EB",manager:"#0891B2",spv:"#059669",viewer:"#64748B"}[e?.role]||"#64748B";t.innerHTML=`
    <div class="page-header">
  ...
  `;let e=null,r=null,a=0,o={upload:document.getElementById("step-upload"),validating:document.getElementById("step-validating"),preview:document.getElementById("step-preview"),importing:document.getElementById("step-importing"),summary:document.getElementById("step-summary")};function d(g){Object.entries(o).forEach(([f,v])=>{v.style.display=f===g?"":"none"})}document.getElementById("btn-backup-db")?.addEventListener("click",async()=>{let g=document.getElementById("btn-backup-db");g.disabled=!0,g.textContent="\u23F3 Memproses Backup...";try{let f=await k("/api/import/backup");if(f.ok){if(!window.XLSX){z("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");return}let v=window.XLSX,x=v.utils.book_new();Object.entries(f.data.database).forEach(([D,C])=>{let P=C.length>0?C:[{}],$=v.utils.json_to_sheet(P);v.utils.book_append_sheet(x,$,D.substring(0,31))}),v.writeFile(x,`FCMS_Database_Backup_${new Date().toISOString().slice(0,10)}.xlsx`),ne("Backup berhasil diunduh!")}else z("Gagal memproses backup: "+(f.data?.error||"Unknown error"))}catch(f){z("Gagal memproses backup: "+f.message)}finally{g.disabled=!1,g.textContent="\u{1F4E6} Backup Database"}});let i=document.getElementById("btn-sync-google");i&&i.addEventListener("click",async()=>{if(!confirm("Peringatan: Mensinkronkan data dengan Google Sheets akan memperbarui dan menambahkan data baru dari Google Sheets ke dalam FCMS. Data yang sudah Anda buat di FCMS TIDAK akan terhapus. Lanjutkan?"))return;let g=i.innerHTML;i.innerHTML='<span class="spinner"></span> Menyinkronkan...',i.disabled=!0;try{let f=await k("/api/sync/google-sheets",{method:"POST"});f.ok?alert("Sinkronisasi Berhasil: "+(f.data?.message||"Data Karyawan & PIC telah diperbarui.")):alert("Gagal Sinkronisasi: "+(f.data?.error||"Unknown error"))}catch{alert("Terjadi kesalahan koneksi.")}finally{i.innerHTML=g,i.disabled=!1}}),document.getElementById("btn-download-template").addEventListener("click",()=>{da(),ne("Template Excel berhasil didownload!")});let n=document.getElementById("file-input"),s=document.getElementById("upload-zone");document.getElementById("btn-browse").addEventListener("click",g=>{g.stopPropagation(),n.click()}),n.addEventListener("change",g=>{g.target.files[0]&&l(g.target.files[0])}),s.addEventListener("dragover",g=>{g.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",g=>{g.preventDefault(),s.classList.remove("drag-over");let f=g.dataTransfer.files[0];f&&f.name.match(/\.xlsx?$/i)?l(f):z("Hanya file .xlsx atau .xls yang didukung.")}),document.getElementById("btn-clear-file").addEventListener("click",()=>{e=null,n.value="",document.getElementById("file-info").style.display="none",s.style.display="",d("upload")});async function l(g){e=g,document.getElementById("file-name-display").textContent=`\u{1F4C4} ${g.name} (${(g.size/1024).toFixed(1)} KB)`,document.getElementById("file-info").style.display="flex",s.style.display="none",await b(g)}async function b(g){d("validating");let f=document.getElementById("validation-status"),v=document.getElementById("validation-bar");try{if(!window.XLSX)throw new Error("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");f.textContent="Membaca file Excel...",v.style.width="20%",await et(200);let x=await g.arrayBuffer(),D=window.XLSX.read(x,{type:"array",cellDates:!0});f.textContent=`Memvalidasi ${D.SheetNames.length} sheet...`,v.style.width="50%",await et(100),r=oa(D),v.style.width="100%",f.textContent="Validasi selesai!",await et(300),c()}catch(x){d("upload"),z("Gagal memproses file: "+x.message),document.getElementById("file-info").style.display="flex",s.style.display="none"}}function c(){d("preview");let g=r.filter(E=>!E.skipped).length,f=r.reduce((E,F)=>E+F.total,0),v=r.reduce((E,F)=>E+F.valid,0),x=r.reduce((E,F)=>E+F.errorCount,0),D=f>0?Math.round(v/f*100):0;document.getElementById("preview-summary-badges").innerHTML=`
    ...
    `,C.querySelectorAll(".btn-detail-error").forEach(E=>{E.addEventListener("click",()=>{let F=r[Number(E.dataset.idx)];p(F)})});let P=document.getElementById("error-detail-section"),$=document.getElementById("error-detail-container");$.innerHTML="",P.style.display="none";let L=document.getElementById("btn-start-import");v===0?(L.disabled=!0,L.innerHTML="\u26A0\uFE0F Tidak Ada Data Valid"):(L.disabled=!1,x>0?(L.innerHTML=`\u{1F680} Import ${v} Data Valid (${x} dilewati)`,L.title="Baris error akan dilewati, baris valid tetap diimport"):L.innerHTML=`\u{1F680} Mulai Import ${v} Data`)}function p(g){let f=document.getElementById("error-detail-section"),v=document.getElementById("error-detail-container");f.style.display="";let x=g.errors.slice(0,100).map(D=>(Array.isArray(D.errors)?D.errors:[]).map(P=>{let $=typeof P=="object";return`
          <tr>
    ...
    `).join("");let x=document.getElementById("import-bar"),D=document.getElementById("import-current-status"),C={totalSheets:f.length,totalRows:f.reduce((P,$)=>P+$.mapped.length,0),inserted:0,skipped:0,failed:0,moduleResults:[]};for(let P=0;P<f.length;P++){let $=f[P],L=document.getElementById(`step-icon-${$.module}`),E=document.getElementById(`step-status-${$.module}`);L.textContent="\u{1F504}",E.textContent="Mengimport...",D.textContent=`Mengimport ${$.label}...`,x.style.width=`${Math.round(P/f.length*100)}%`;try{let F=await k(`/api/import/${$.module}`,{method:"POST",body:JSON.stringify({rows:$.mapped,onDuplicate:g})});if(F.ok){let K=F.data;C.inserted+=K.inserted||0,C.skipped+=K.skipped||0,C.moduleResults.push({label:$.label,inserted:K.inserted||0,skipped:K.skipped||0,status:"ok"}),L.textContent="\u2705",E.innerHTML=`<span class="badge badge-success">${K.inserted||0} berhasil</span>${K.skipped>0?` <span class="badge badge-neutral">${K.skipped} skip</span>`:""}`}else C.failed++,C.moduleResults.push({label:$.label,inserted:0,skipped:0,status:"error",error:F.data?.error}),L.textContent="\u274C",E.innerHTML='<span class="badge badge-danger">Gagal</span>'}catch(F){C.failed++,C.moduleResults.push({label:$.label,inserted:0,skipped:0,status:"error",error:F.message}),L.textContent="\u274C",E.innerHTML='<span class="badge badge-danger">Gagal</span>'}await et(150)}x.style.width="100%",D.textContent="Selesai!",await et(400),y(C)}function y(g){d("summary");let f=((Date.now()-a)/1e3).toFixed(1),v=g.failed===0;document.getElementById("summary-status-icon").innerHTML=`
  ...
  `;let e=document.getElementById("btnRefreshSync"),r=document.getElementById("queueStatusFilter");e.addEventListener("click",o),r.addEventListener("change",n),document.getElementById("btnRetryAll").addEventListener("click",()=>a("retry",{allFailed:!0})),document.getElementById("btnResetStuck").addEventListener("click",()=>a("reset-stuck",{})),document.getElementById("btnPauseSync").addEventListener("click",()=>a("pause",{})),document.getElementById("btnResumeSync").addEventListener("click",()=>a("resume",{})),document.getElementById("btnReconcile").addEventListener("click",()=>a("reconcile",{module:"ALL",repairMode:!0})),document.getElementById("btnRetrySelected").addEventListener("click",()=>{let l=Array.from(document.querySelectorAll(".chk-queue:checked")).map(b=>b.value);if(l.length===0)return alert("No items selected");a("retry",{ids:l})}),document.getElementById("chkAllQueue").addEventListener("change",l=>{document.querySelectorAll(".chk-queue").forEach(b=>b.checked=l.target.checked)});async function a(l,b){if(confirm(`Are you sure you want to execute action: ${l}?`)){showLoading();try{let c=await k(`/api/sync/actions/${l}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(b)});c.ok?(alert(c.data?.message||"Success"),o()):z(c.error||"Action failed")}catch(c){z(c.message)}hideLoading()}}await o();async function o(){showLoading(),await Promise.all([i(),n(),d(),s()]),hideLoading()}async function d(){try{let l=await k("/api/sync/performance");if(!l.ok)return;let{webhook:b,google_api:c,d1:p,queue:m,throughput:y}=l.data;document.getElementById("latencyHistograms").innerHTML=`
      ...
      `,document.getElementById("lblSnapshotStatus").innerHTML='Checked 10 modules. Status: <b>COMPLETED</b><br><span class="text-xs text-gray-500">Run today at 02:00</span>'}catch(l){console.error(l)}}async function i(){try{let l=await k("/api/sync/health");if(!l.ok)return z("Failed to fetch sync health");let{status:b,queue:c,circuit_breaker:p}=l.data,m=`
      ...
      `;document.getElementById("syncOverviewCards").innerHTML=m;let y=document.getElementById("cbStateBadge"),g=document.getElementById("cbStateDesc"),f=document.getElementById("cbStatusCard");f.className="bg-white rounded-lg shadow p-6 border-l-4",p==="CLOSED"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800",y.textContent="CLOSED",g.textContent="Traffic is flowing normally to Google Sheets.",f.classList.add("border-green-500")):p==="OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800",y.textContent="OPEN",g.textContent="Failing fast. Traffic to Google Sheets is paused due to repeated failures.",f.classList.add("border-red-500")):p==="HALF_OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",y.textContent="HALF-OPEN",g.textContent="Testing recovery. Permitting limited traffic to verify stability.",f.classList.add("border-yellow-500")):y.textContent=p||"UNKNOWN"}catch(l){console.error(l)}}async function n(){try{let l=document.getElementById("queueStatusFilter").value,b=await k("/api/sync/queue?limit=15"+(l?"&status="+l:""));if(!b.ok)return;let c=document.getElementById("queueTableBody"),p=b.data?.data||b.data||[];if(p.length===0){c.innerHTML='<tr><td colspan="6" class="px-4 py-4 text-center text-gray-500">No events found</td></tr>';return}c.innerHTML=p.map(m=>`
