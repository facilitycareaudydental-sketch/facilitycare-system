    ...
    <div class="dashboard-wrap" id="dash-root">
      ...
      <div class="charts-row" style="grid-template-columns: repeat(3, minmax(0, 1fr));">
        ...
        <div class="chart-card">
          ...
          <div id="jadwal-legend" style="display:flex;justify-content:center;gap:8px;margin-top:10px;font-size:0.6rem;font-weight:600;color:var(--text-2);flex-wrap:wrap">
            ...
            <div style="display:flex;align-items:center;gap:3px"><div style="width:10px;height:8px;border-radius:2px;background:#10B981"></div> G.Cleaning</div>
            <div style="display:flex;align-items:center;gap:3px"><div style="width:10px;height:8px;border-radius:2px;background:#F59E0B"></div> D.Cleaning</div>
        ...
        <div class="chart-card">
          ...
          <div style="display:flex; gap:10px; align-items:center; height:190px; margin-top:10px">
