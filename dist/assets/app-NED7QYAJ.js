      ...
      <div class="charts-row">
        ...
        <div class="chart-card">
          <div class="chart-card-header" style="align-items:flex-start">
            ...
            <div class="chart-canvas-wrap" style="height:280px;position:relative;margin-top:10px;padding: 10px 0;">
