var oa=Object.defineProperty;var at=(t,e)=>()=>(t&&(e=t(t=0)),e);var nt=(t,e)=>{for(var r in e)oa(t,r,{get:e[r],enumerable:!0})};var ke={};nt(ke,{API:()=>yt,CLIENT_SIDE_MAX_ROWS:()=>be,IS_DEVELOPMENT:()=>Pe,apiFetch:()=>k,clearToken:()=>Le,getToken:()=>Be,getUser:()=>he,setToken:()=>it,setUser:()=>Ne});function Be(){return localStorage.getItem("fm_token")}function it(t){localStorage.setItem("fm_token",t)}function Le(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function he(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Ne(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function k(t,e={}){let r=Be(),a={"Content-Type":"application/json",...r?{Authorization:`Bearer ${r}`}:{},...e.headers||{}};try{let l=`cb=${Date.now()}`,d=t.includes("?")?"&":"?",s=`${yt}${t}${d}${l}`,i=await fetch(s,{...e,headers:a}),n;try{let o=await i.text();try{n=JSON.parse(o)}catch{n={error:`Server Error (${i.status}): ${o.substring(0,80)}...`}}}catch{n={error:"Gagal membaca respon dari server"}}return i.status===401&&(Le(),window.location.hash="#/login"),{ok:i.ok,status:i.status,data:n}}catch(l){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${l.message})`}}}}var Pe,da,yt,be,F=at(()=>{Pe=!1,da="https://fm-operations-api.facilitycare-audydental.workers.dev",yt=da,be=1e4});var kt={};nt(kt,{confirmDialog:()=>Fe,createModal:()=>se});function se({title:t,content:e,onConfirm:r,onCancel:a,confirmText:l="Simpan",cancelText:d="Batal",size:s="md",confirmClass:i="btn-primary"}){let n={sm:"400px",md:"560px",lg:"720px",xl:"900px"},o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
  ...
  `}var K=at(()=>{});F();var rt={},Je=null;function J(t,e){rt[t]=e}function Se(t){window.location.hash=t}function ft(){async function t(){let e=window.location.hash.replace("#","")||"/dashboard",[r,...a]=e.split("?"),l=rt[r];if(!l){for(let[s,i]of Object.entries(rt))if(s.endsWith("/*")&&r.startsWith(s.slice(0,-2))){l=i;break}}Je&&(Je(),Je=null);let d=document.getElementById("main-content");if(d&&(d.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),l){let s=new URLSearchParams(a.join("?")),i=r.split("/").filter(Boolean),n=await l({path:r,params:s,segments:i,main:d});n&&(Je=n)}else{let s=d||document.getElementById("app");s&&(s.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",t),t()}var Ae;function ca(){return Ae||(Ae=document.createElement("div"),Ae.id="toast-container",document.body.appendChild(Ae)),Ae}function vt(t,e="info",r=3500){let a=ca(),l=document.createElement("div");l.className=`toast toast-${e}`;let d={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};l.innerHTML=`<span class="toast-icon">${d[e]||"\u2139"}</span><span class="toast-msg">${t}</span>`,a.appendChild(l),requestAnimationFrame(()=>l.classList.add("show")),setTimeout(()=>{l.classList.remove("show"),setTimeout(()=>l.remove(),350)},r)}var Z=t=>vt(t,"success"),G=t=>vt(t,"error");ye();F();F();ye();function Ue({columns:t,data:e,onEdit:r,onDelete:a,onView:l,actions:d=[],emptyText:s="Tidak ada data",bulkSelect:i=null}){let n=document.createElement("div");if(n.className="table-wrapper",!e||e.length===0)return n.innerHTML=`<div class="empty-state"><p>${s}</p></div>`,n;let o=document.createElement("table");o.className="data-table";let u=document.createElement("thead"),p=document.createElement("tr");if(i){let g=document.createElement("th");g.style.width="40px",g.style.textAlign="center";let y=document.createElement("input");y.type="checkbox",y.id="select-all-checkbox",y.title="Pilih semua",y.addEventListener("change",()=>{e.forEach(m=>{y.checked?i.selectedIds.add(m.id):i.selectedIds.delete(m.id)}),n.querySelectorAll(".row-checkbox").forEach(m=>m.checked=y.checked),i.onToggle()}),g.appendChild(y),p.appendChild(g)}if(t.forEach(g=>{let y=document.createElement("th");y.textContent=g.label,g.width&&(y.style.width=g.width),p.appendChild(y)}),r||a||l||d.length>0){let g=document.createElement("th");g.textContent="Aksi",g.style.width="120px",p.appendChild(g)}u.appendChild(p),o.appendChild(u);let c=document.createElement("tbody");return e.forEach(g=>{let y=document.createElement("tr");if(i){let m=document.createElement("td");m.style.textAlign="center",m.style.width="40px";let b=document.createElement("input");b.type="checkbox",b.className="row-checkbox",b.checked=i.selectedIds.has(g.id),b.addEventListener("change",()=>{if(b.checked)i.selectedIds.add(g.id);else{i.selectedIds.delete(g.id);let h=document.getElementById("select-all-checkbox");h&&(h.checked=!1)}i.onToggle()}),m.appendChild(b),y.appendChild(m)}if(t.forEach(m=>{let b=document.createElement("td");if(m.render){let h=m.render(g[m.key],g);h instanceof HTMLElement?b.appendChild(h):b.innerHTML=h||""}else b.textContent=g[m.key]!==null&&g[m.key]!==void 0&&g[m.key]!==""?g[m.key]:"";m.nowrap&&(b.style.whiteSpace="nowrap"),y.appendChild(b)}),r||a||l||d.length>0){let m=document.createElement("td");m.className="actions-cell";let b=document.createElement("div");if(b.className="btn-group",l){let h=document.createElement("button");h.className="btn btn-xs btn-ghost",h.innerHTML="\u{1F441}",h.title="Lihat",h.addEventListener("click",()=>l(g)),b.appendChild(h)}if(r){let h=document.createElement("button");h.className="btn btn-xs btn-secondary",h.innerHTML="\u270F\uFE0F",h.title="Edit",h.addEventListener("click",()=>r(g)),b.appendChild(h)}d.forEach(h=>{let _=document.createElement("button");_.className=`btn btn-xs ${h.class||"btn-ghost"}`,_.innerHTML=h.icon||h.label,_.title=h.label,_.addEventListener("click",()=>h.handler(g)),b.appendChild(_)}),m.appendChild(b),y.appendChild(m)}c.appendChild(y)}),o.appendChild(c),n.appendChild(o),n}function Ge({page:t,pages:e,total:r,limit:a,onPage:l}){if(e<=1)return null;let d=document.createElement("div");d.className="pagination";let s=document.createElement("span");s.className="pagination-info",s.textContent=`Total: ${r} data`,d.appendChild(s);let i=document.createElement("div");i.className="pagination-btns";let n=(p,c,g=!1,y=!1)=>{let m=document.createElement("button");m.className=`btn btn-sm ${y?"btn-primary":"btn-ghost"} pagination-btn`,m.textContent=p,m.disabled=g,m.addEventListener("click",()=>l(c)),i.appendChild(m)};n("\xAB",1,t===1),n("\u2039",t-1,t===1);let o=Math.max(1,t-2),u=Math.min(e,t+2);for(let p=o;p<=u;p++)n(p,p,!1,p===t);return n("\u203A",t+1,t===e),n("\xBB",e,t===e),d.appendChild(i),d}ye();function Me(t){return t.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="html")return e.html||"";if(e.type==="row")return`<div class="form-row">${Me(e.fields)}</div>`;let r=e.required?"required":"",a=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",l="";switch(e.type){case"textarea":l=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${r} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let s=(e.options||[]).map(p=>{let c=typeof p=="object"?p.value:p,g=typeof p=="object"?p.label:p,y=e.value==c?"selected":"";return`<option value="${c}" ${y}>${g}</option>`}).join("");l=`<select name="${e.name}" class="form-control" ${r}><option value="">-- Pilih ${e.label||""} --</option>${s}</select>`;break;case"combobox":let i=`dl-${e.name}-${Math.random().toString(36).substring(7)}`,n=(e.options||[]).map(p=>{let c=typeof p=="object"?p.value:p,g=typeof p=="object"?p.label||p.value||"":p||"";return(g==="undefined"||g==="[object Object]"||g==="null")&&(g=""),g?`<option value="${g}"></option>`:""}).join(""),o=e.value||"";if(e.value){let p=(e.options||[]).find(c=>(typeof c=="object"?c.value:c)==e.value);if(p){let c=typeof p=="object"?p.label||p.value||"":p||"";c&&c!=="undefined"&&c!=="[object Object]"&&c!=="null"&&(o=c)}}l=`
          <input type="text" name="${e.name}" list="${i}" class="form-control" value="${o}" placeholder="Pilih atau ketik baru..." ${r} autocomplete="off">
          <datalist id="${i}">${n}</datalist>
        `;break;case"checkbox":l=`<label class="checkbox-label"><input type="checkbox" name="${e.name}" value="1" ${e.value?"checked":""}> ${e.checkLabel||e.label}</label>`;break;case"date":let u=window.parseFlexibleDate&&e.value?window.parseFlexibleDate(e.value):e.value||"";l=`<input type="date" name="${e.name}" class="form-control" value="${u}" ${r}>`;break;case"number":l=`<input type="number" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" min="${e.min||""}" max="${e.max||""}" step="${e.step||"1"}" ${r}>`;break;case"email":l=`<input type="email" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${r}>`;break;case"url":l=`<input type="url" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||"https://..."}" ${r}>`;break;default:l=`<input type="${e.type||"text"}" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${r} autocomplete="off">`}let d=e.hint?`<div class="form-hint">${e.hint}</div>`:"";return`<div class="form-group ${e.class||""}">${a}${l}${d}</div>`}).join("")}function Qe(t){let e={},r=new FormData(t);for(let[a,l]of r.entries())e[a]=l===""?null:l;return t.querySelectorAll("input[type=checkbox]").forEach(a=>{a.checked||(e[a.name]=null)}),e}function ze(t,e){e&&Object.entries(e).forEach(([r,a])=>{let l=t.querySelector(`[name="${r}"]`);l&&(l.hasAttribute("list")||(l.type==="checkbox"?l.checked=!!a:l.type==="date"&&a&&window.parseFlexibleDate?l.value=window.parseFlexibleDate(a):l.value=a??""))})}K();function L({container:t,title:e,icon:r,apiPath:a,columns:l,formFields:d,filterFields:s,defaultFilters:i={},itemLabel:n="Data",canCreate:o=!0,canEdit:u=!0,canDelete:p=!0,onBeforeSubmit:c,onAfterLoad:g,onDataLoaded:y,extraActions:m=[],initialSearch:b="",exportOptions:h=null,bulkDelete:_=!1,paginationMode:C="server"}){let S=1,x={...i};b&&(x.search=b);let w=new Set;t.innerHTML=`
  ...
  `;function R(){if(!document.getElementById("bulk-toolbar"))return;let f=document.getElementById("bulk-count"),$=document.getElementById("btn-bulk-delete"),P=document.getElementById("btn-bulk-cancel");f.textContent=`${w.size} item dipilih`,w.size>0?($.disabled=!1,P.disabled=!1):($.disabled=!0,P.disabled=!0)}document.getElementById("btn-bulk-cancel")?.addEventListener("click",()=>{w.clear(),document.querySelectorAll(".row-checkbox").forEach(f=>f.checked=!1);let v=document.getElementById("select-all-checkbox");v&&(v.checked=!1),R()}),document.getElementById("btn-bulk-delete")?.addEventListener("click",()=>{if(w.size===0)return;let v=[...w],f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9999;display:flex;align-items:center;justify-content:center",f.innerHTML=`
    ...
    `,document.body.appendChild(f),f.querySelector("#bulk-cancel-btn").addEventListener("click",()=>f.remove()),f.querySelector("#bulk-confirm-btn").addEventListener("click",async()=>{let $=f.querySelector("#bulk-confirm-btn");$.disabled=!0,$.textContent="Menghapus...";let P=await k(`${a}/bulk`,{method:"DELETE",body:JSON.stringify({ids:v})});f.remove(),P.ok?(Z(`${v.length} ${n} berhasil dihapus.`),w.clear(),R(),M()):G(P.data?.error||"Gagal menghapus data.")})});let E=document.getElementById("filter-search"),O;if(E?.addEventListener("input",v=>{clearTimeout(O),O=setTimeout(()=>{x.search=v.target.value,S=1,w.clear(),M()},400)}),s?.forEach(v=>{v.type==="select"&&document.getElementById(`filter-${v.name}`)?.addEventListener("change",f=>{x[v.name]=f.target.value,S=1,w.clear(),M()})}),document.getElementById("btn-reset-filter")?.addEventListener("click",()=>{x={...i},E&&(E.value=""),s?.forEach(v=>{let f=document.getElementById(`filter-${v.name}`);f&&(f.value="")}),S=1,w.clear(),M()}),document.getElementById("btn-create")?.addEventListener("click",()=>ge(null)),h){document.getElementById(`btn-export-${h.moduleName}`)?.addEventListener("click",async f=>{let $=f.target,P=$.innerHTML;$.innerHTML="\u23F3 Loading...",$.disabled=!0;try{await h.onExport()}catch{G("Gagal export data")}finally{$.innerHTML=P,$.disabled=!1}}),document.getElementById(`btn-template-${h.moduleName}`)?.addEventListener("click",()=>{h.onTemplate()});let v=document.getElementById(`input-import-${h.moduleName}`);v?.addEventListener("change",async f=>{let $=f.target.files[0];if(!$)return;v.disabled=!0;let P=document.createElement("div");P.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.7);z-index:9999;display:flex;align-items:center;justify-content:center",P.innerHTML=`
  ...
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>pt(t)),document.getElementById("filter-jadwal-year")?.addEventListener("change",async r=>{let a=r.target.value;document.getElementById("jadwal-year-label").textContent=a;let l=document.getElementById("skel-jadwal"),d=document.getElementById("chart-jadwal");l&&(l.style.display="block",l.style.position="absolute"),d&&(d.style.display="none");let s=await re(`/api/dashboard/schedule-chart?year=${a}`,{},8e3);try{Dt(s)}catch(i){console.warn("ScheduleChart render:",i),ce("skel-jadwal","chart-jadwal")}}),document.getElementById("filter-insp-month")?.addEventListener("change",async r=>{let a=r.target.value,l=a?`/api/dashboard/inspection-bar?month=${a}`:"/api/dashboard/inspection-bar",d=document.getElementById("skel-insp"),s=document.getElementById("chart-insp");d&&(d.style.display="block",d.style.position="absolute"),s&&(s.style.display="none");let i=await re(l,{},8e3);try{It(i)}catch(n){console.warn("InspBar render:",n),ce("skel-insp","chart-insp")}}),t._skelTimeout=setTimeout(()=>ya(),5e3),await pt(t),t._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?pt(t):clearInterval(t._dashRefresh)},6e4)}async function pt(t){t._skelTimeout&&(clearTimeout(t._skelTimeout),t._skelTimeout=null);let[e,r,a,l,d,s,i,n,o,u,p,c]=await Promise.all([re("/api/dashboard/kpi",{},8e3),re("/api/dashboard/issues-trend",{},8e3),re("/api/dashboard/issues-summary",{},8e3),re("/api/dashboard/stats",{},8e3),re("/api/dashboard/calendar",[],8e3),re("/api/schedule?limit=10000",{data:[]},8e3),re("/api/employees?limit=10000",{data:[]},8e3),re("/api/contracts?limit=10000",{data:[]},8e3),re("/api/issues?limit=10000",{data:[]},8e3),re("/api/one-on-one?limit=10000",{data:[]},8e3),re("/api/dashboard/contracts-chart",{labels:[],data:[]},8e3),re(`/api/dashboard/schedule-chart?year=${document.getElementById("filter-jadwal-year")?.value||new Date().getFullYear()}`,{},8e3)]),g=document.getElementById("filter-insp-month"),y=g?g.value:"",m=y?`/api/dashboard/inspection-bar?month=${y}`:"/api/dashboard/inspection-bar",b=await re(m,{},8e3);if(e){let h=Array.isArray(s?.data)?s.data:Array.isArray(s)?s:[],_=Array.isArray(i?.data)?i.data:Array.isArray(i)?i:[],C=Array.isArray(n?.data)?n.data:Array.isArray(n)?n:[],S=Array.isArray(o?.data)?o.data:Array.isArray(o)?o:[],x=Array.isArray(u?.data)?u.data:Array.isArray(u)?u:[];e.employees&&(e.employees.current=_.filter(w=>St(w,"active")).length),e.contracts&&(e.contracts.current=C.filter(w=>dt(w,"active")).length),e.expiring30&&(e.expiring30={current:C.filter(w=>dt(w,"expiring30")).length}),e.issues&&(e.issues.current=S.filter(w=>xt(w,"open")).length),e.one_on_one&&(e.one_on_one.current=x.filter(w=>wt(w,"pending")).length),e.inspection_month&&(e.inspection_month.current=h.filter(w=>ot(w,"inspeksi")).length),e.cleaning_month&&(e.cleaning_month.current=h.filter(w=>ot(w,"gcdc")).length)}try{Et(e)}catch(h){console.warn("KPI render:",h)}try{$t(e)}catch(h){console.warn("MiniStats render:",h)}try{Dt(c)}catch(h){console.warn("ScheduleChart render:",h),ce("skel-jadwal","chart-jadwal")}try{fa(Array.isArray(a?.by_category)?a.by_category:[])}catch(h){console.warn("Donut render:",h),ce("skel-donut","chart-donut")}try{va(r)}catch(h){console.warn("Trend render:",h),ce("skel-trend","chart-trend")}try{It(b)}catch(h){console.warn("InspBar render:",h),ce("skel-insp","chart-insp")}try{let h=Array.isArray(l)?l:Array.isArray(l?.recent_issues)?l.recent_issues:[];Sa(h)}catch(h){console.warn("IssuesTable render:",h)}try{let h=Array.isArray(l?.expiring_contracts)?l.expiring_contracts:[];ka(p)}catch(h){console.warn("ContractsTable render:",h)}try{xa(Array.isArray(d)?d:[])}catch(h){console.warn("Agenda render:",h)}try{wa()}catch(h){console.warn("Quick Actions render:",h)}}function Et(t){let e=document.getElementById("kpi-row");if(!e)return;t=t||{};let r=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees?dash_filter=active",color:"kpi-blue",key:"employees",trendPct:"+2%",trendColor:"#10B981",points:"0,20 10,18 20,22 30,12 40,15 50,8 60,10 70,5 80,6 90,2 100,0"},{icon:"\u{1F504}",label:"Reliefer Aktif",sub:"Karyawan reliefer",href:"#/employees?dash_filter=reliefer",color:"kpi-purple",key:"reliever_total",trendPct:"0%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts?dash_filter=active",color:"kpi-green",key:"contracts",trendPct:"+1%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u23F3",label:"Kontrak Habis 30 Hari",sub:"Akan segera berakhir",href:"#/contracts?dash_filter=expiring30",color:"kpi-warn",key:"expiring30",trendPct:"+25%",trendColor:"#F59E0B",points:"0,25 20,22 40,24 60,15 80,18 100,5"},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues?dash_filter=open",color:"kpi-red",key:"issues",trendPct:"0%",trendColor:"#EF4444",points:"0,20 20,18 40,22 60,19 80,21 100,20"},{icon:"\u{1F4AC}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one?dash_filter=pending",color:"kpi-purple",key:"one_on_one",trendPct:"+8%",trendColor:"#10B981",points:"0,25 20,15 40,18 60,8 80,10 100,2"}];e.innerHTML=r.map(a=>{let l=pe(t[a.key]?.current,0);return`
    ...
    <div style="display:flex;flex-direction:column;gap:12px;padding-right:8px">
      ${d.map(s=>{let i="#3B82F6",n="#EFF6FF",o="Agenda",u=(s.title||"").toLowerCase();return u.includes("inspeksi")?(i="#10B981",n="#ECFDF5",o="Inspeksi"):u.includes("cleaning")||u.includes("gcdc")?(i="#3B82F6",n="#EFF6FF",o="Cleaning"):u.includes("reliefer")?(i="#F59E0B",n="#FFFBEB",o="Reliefer"):u.includes("fogging")&&(i="#8B5CF6",n="#F5F3FF",o="Fogging"),`
        <div style="display:flex;gap:12px;align-items:flex-start;padding-bottom:12px;border-bottom:1px solid var(--border)">
          ...
          <div style="flex-shrink:0;font-size:0.7rem;font-weight:600;padding:2px 8px;border-radius:6px;background:${n};color:${i}">${o}</div>
        </div>
      `}).join("")}
    </div>
...
`)}let x=o(_,h),w=null;return x||(w="Karyawan tidak ditemukan di Database"),{isValid:!!x,invalidReason:w,rowNum:h,data:{employee_id:x,branch_id:n(String(m.Cabang||"").trim()),division:String(m["Div / Bagian"]||"").trim()||"FACILITY CARE",start_date:S,end_date:u(m["Tanggal Selesai"])||"2099-12-31",status:String(m.Status||"").trim(),_rawName:_}}}),c=[],g=[];if(p.forEach(m=>{m.isValid?c.push(m.data):g.push({rowNum:m.rowNum,name:m.data._rawName,reason:m.invalidReason})}),console.log(`Split Validation - Valid: ${c.length}, Invalid: ${g.length}`),c.length===0)return{inserted:0,skipped:a.length,failed:a.length};let y=await k("/api/import/contracts",{method:"POST",body:JSON.stringify({rows:c,onDuplicate:"update"})});if(!y.ok)throw new Error(y.data?.error||"Import gagal");return y.data}}})}F();K();var gt=[],He=[];function $a(t){if(!Array.isArray(t))return"Q3";let e=["Q4","Q3","Q2","Q1"];for(let r of e)if(t.some(a=>a.period===r))return r;return"Q3"}function Da(t,e){if(t.period!=="Q3")return!1;let r=String(t.status||"").toLowerCase();if(r!=="selesai"&&r!=="completed"&&r!=="done")return!1;let a=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?a.includes("inspeksi"):e==="gcdc"?a.includes("general cleaning")||a.includes("deep cleaning"):!1}async function At(t,e){gt=await H();let r=await ee();He=["BERLIN ARIANSYAH","ADE SURAHMAN"];let a=o=>o&&!He.find(u=>(typeof u=="object"?u.value:u)===o)?[...He,o]:He,l=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`),d=o=>{if(!o||o==="-"||String(o).trim()==="")return"";let u=String(o).split("-");return u.length===3&&u[0].length===4?`${u[2]}-${u[1]}-${u[0]}`:o},s=l.data?.data||[],i=$a(s),n=e?e.get("dash_filter"):null;L({container:t,title:"Jadwal Kegiatan",icon:"\u{1F4C5}",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",paginationMode:"client",defaultFilters:n?{period:"Q3"}:{period:i},onDataLoaded:o=>(n&&(o=o.filter(u=>Da(u,n))),o.sort((u,p)=>{let c=u.opening_date?new Date(u.opening_date).getTime():0;return(p.opening_date?new Date(p.opening_date).getTime():0)-c})),columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:o=>st(o)},{key:"period",label:"Periode",render:o=>oe(o)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:o=>d(o)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:o=>d(o)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:o=>d(o)},{key:"status",label:"Status",render:o=>q(o)}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:gt},{type:"select",name:"activity_type",label:"Kegiatan",options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"]},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"select",name:"pic",label:"PIC",options:He}],formFields:o=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:gt,value:o?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"],value:o?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:o?.period},{name:"pic",label:"PIC",type:"combobox",options:a(o?.pic),value:o?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:o?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:o?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:o?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:o?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:o?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let o=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`);if(o.ok){let u=o.data.data.map(p=>({Cabang:p.branch_name||"",Kegiatan:p.activity_type||"",Periode:p.period||"",PIC:p.pic||"","Tgl Opening":p.opening_date||"","Tgl Target":p.target_date||"","Tgl Selesai":p.completion_date||"",Status:p.status||""}));B(u,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{B([{Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done"}],"Template_Import_Jadwal")},onImport:async o=>{let p=(await k("/api/branches?all=1")).data?.data||[],c=b=>{if(!b)return null;let h=String(b||"").toLowerCase(),_=p.find(C=>String(C.full_name||"").toLowerCase()===h||String(C.code||"").toLowerCase()===h||String(C.name||"").toLowerCase()===h);return _?_.id:null},g=b=>{if(b==null||b==="")return"";if(b instanceof Date&&!isNaN(b.getTime()))return b.toISOString().slice(0,10);let h=String(b).trim();if(h===""||h==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(h))return h.slice(0,10);if(/^\d{4,5}$/.test(h)){let C=Number(h);if(C>2e4&&C<99999){let S=new Date(Date.UTC(1899,11,30)+C*864e5);return isNaN(S.getTime())?"":S.toISOString().slice(0,10)}}let _=h.split(/[\/\-\.]/);if(_.length===3){let[C,S,x]=_.map(w=>w.trim());if(C.length===4&&S.length<=2&&x.length<=2)return`${C}-${S.padStart(2,"0")}-${x.padStart(2,"0")}`;if(x.length===4&&S.length<=2&&C.length<=2)return`${x}-${S.padStart(2,"0")}-${C.padStart(2,"0")}`}return h},y=o.map(b=>({branch_id:c(String(b.Cabang||"").trim()),activity_type:String(b.Kegiatan||"").trim(),period:String(b.Periode||"").trim(),pic:String(b.PIC||b.Pic||"").trim(),opening_date:g(b["Tgl Opening"]||b["Tanggal Opening"]||b["Tgl Openir"]),target_date:g(b["Tgl Target"]||b["Tanggal Target"]),completion_date:g(b["Tgl Selesai"]||b["Tanggal Selesai"]),status:String(b.Status||"").trim(),notes:String(b.Catatan||b.Keterangan||"").trim()})).filter(b=>b.activity_type&&b.period),m=await k("/api/import/schedule",{method:"POST",body:JSON.stringify({rows:y,onDuplicate:"update"})});if(!m.ok)throw new Error(m.data?.error||"Import gagal");return m.data}}})}F();K();var bt=[],Ye=[];function Ia(t,e){let r=String(t.status||"").toLowerCase();return e==="open"?r==="open":!1}async function Ft(t,e){let r=e?e.get("dash_filter"):null;bt=await H(),Ye=await ee();let a=s=>s&&!Ye.find(i=>i.value===s)?[...Ye,{value:s,label:s}]:Ye,l=new Date().getFullYear();L({container:t,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,itemLabel:"Permasalahan",paginationMode:"client",onDataLoaded:s=>r?s.filter(i=>Ia(i,r)):s,columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:s=>window.formatDate(s)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:s=>`<span class="badge badge-secondary">${s}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:s=>`<span title="${s}">${s?.length>50?s.slice(0,50)+"\u2026":s}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:s=>`<span title="${s||""}">${s?.length>40?s.slice(0,40)+"\u2026":s||"-"}</span>`},{key:"status",label:"Status",render:s=>q(s)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:s=>window.formatDate(s)},{key:"day_count",label:"Hari",render:s=>s??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"select",name:"branch_id",label:"Cabang",options:bt},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:["2025","2026","2027","2028","2029","2030"]}],formFields:s=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:s?.report_date},{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:bt,value:s?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:s?.category},{name:"source",label:"Sumber Laporan",type:"combobox",options:["SPV","AM","RCP","Perawat","FC","Berlin","Ade","Pattrel","Dentrel"],value:s?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:s?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"combobox",options:a(s?.employee_name),value:s?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"combobox",options:a(s?.fc_specialist),value:s?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:s?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:s?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:s?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let s=await k(`/api/issues${window.location.search?window.location.search+"&":"?"}limit=10000`);if(s.ok){let i=s.data.data.map(n=>({Tanggal:n.report_date||"",Cabang:n.branch_name||"",Kategori:n.category||"",Sumber:n.source||"",Keluhan:n.complaint||"","Nama FC":n.employee_name||"","FC Spesialis":n.fc_specialist||"",Solusi:n.solution||"","Tgl Selesai":n.completion_date||"",Status:n.status||""}));B(i,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{B([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async s=>{let n=(await k("/api/branches?all=1")).data?.data||[],o=c=>{if(!c)return null;let g=String(c||"").toLowerCase(),y=n.find(m=>String(m.full_name||"").toLowerCase()===g||String(m.code||"").toLowerCase()===g||String(m.name||"").toLowerCase()===g);return y?y.id:null},u=s.map(c=>({branch_id:o(String(c.Cabang||"").trim()),report_date:String(c.Tanggal||"").trim(),category:String(c.Kategori||"").trim(),source:String(c.Sumber||"").trim(),complaint:String(c.Keluhan||"").trim(),employee_name:String(c["Nama FC"]||"").trim(),fc_specialist:String(c["FC Spesialis"]||"").trim(),solution:String(c.Solusi||"").trim(),completion_date:String(c["Tgl Selesai"]||"").trim(),status:String(c.Status||"").trim()})).filter(c=>c.report_date&&c.complaint&&c.category),p=await k("/api/import/issues",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!p.ok)throw new Error(p.data?.error||"Import gagal");return p.data}}})}F();var $e=[];function Pa(t,e){let r=String(t.status||"").toLowerCase();return e==="pending"?r==="pending":!1}async function Mt(t,e){let r=e?e.get("dash_filter"):null;$e=await H();let a=await ee(),l=["Ade","Berlin"],d=i=>i&&!a.find(n=>n.value===i)?[...a,{value:i,label:i}]:a,s=i=>i&&!l.find(n=>(typeof n=="object"?n.value:n)===i)?[...l,i]:l;L({container:t,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,itemLabel:"One on One",paginationMode:"client",onDataLoaded:i=>r?i.filter(n=>Pa(n,r)):i,columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:i=>window.formatDate(i)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:i=>`<span title="${i||""}">${i?.length>50?i.slice(0,50)+"\u2026":i||"-"}</span>`},{key:"solution",label:"Solusi",render:i=>`<span title="${i||""}">${i?.length>40?i.slice(0,40)+"\u2026":i||"-"}</span>`},{key:"status",label:"Status",render:i=>q(i)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:i=>window.formatDate(i)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:i=>i?`<a href="${i}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"combobox",name:"branch_id",label:"Cabang",options:$e},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async i=>{let n=new URLSearchParams(i||{}).toString(),o=await k(`/api/one-on-one?limit=10000&${n}`);if(o.ok){let u=o.data.data.map(c=>({Tanggal:c.meeting_date||"",Cabang:c.branch_name||"","Nama Karyawan":c.employee_name||"",PIC:c.pic||"",Masalah:c.problem||"",Solusi:c.solution||"",Status:c.status||"","Tgl Selesai":c.completion_date||"",Dokumen:c.document_link||""})),{downloadExcel:p}=await Promise.resolve().then(()=>(K(),le));p(u,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let i=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(K(),le));n(i,"Template_Import_OneOnOne")},onImport:async i=>{let n=c=>{if(!c)return null;let g=String(c||"").toLowerCase(),y=$e.find(m=>String(m.label||"").toLowerCase()===g);return y?y.value:null},o=c=>{if(!c)return"";if(c instanceof Date&&!isNaN(c.getTime()))return c.toISOString().slice(0,10);let g=String(c).trim();if(/^\d{4,5}$/.test(g)){let m=Number(g);if(m>2e4&&m<99999){let b=new Date(Date.UTC(1899,11,30)+m*864e5);return isNaN(b.getTime())?"":b.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(g))return g.slice(0,10);let y=g.split(/[\/\-\.]/);if(y.length===3){let[m,b,h]=y.map(_=>_.trim());if(m.length===4&&b.length<=2&&h.length<=2)return`${m}-${b.padStart(2,"0")}-${h.padStart(2,"0")}`;if(h.length===4&&b.length<=2&&m.length<=2)return`${h}-${b.padStart(2,"0")}-${m.padStart(2,"0")}`}return g},u=i.map(c=>({meeting_date:o(c.Tanggal),employee_name:String(c["Nama Karyawan"]||"").trim(),branch_id:n(String(c.Cabang||"").trim()),pic:String(c.PIC||"").trim(),problem:String(c.Masalah||"").trim(),solution:String(c.Solusi||"").trim(),status:String(c.Status||"").trim(),completion_date:o(c["Tgl Selesai"]),document_link:String(c.Dokumen||"").trim()})).filter(c=>c.meeting_date&&c.employee_name&&c.branch_id),p=await k("/api/import/one_on_one",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!p.ok)throw new Error(p.data?.error||"Import gagal");return p.data}},formFields:i=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:i?.meeting_date},{name:"branch_id",label:"Cabang",type:"combobox",options:i?.branch_id&&!$e.find(n=>n.value==i.branch_id)?[...$e,{value:i.branch_id,label:i.branch_name||i.branch_id}]:$e,createApi:{path:"/api/branches",field:"full_name"},value:i?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"combobox",required:!0,options:d(i?.employee_name),value:i?.employee_name},{name:"pic",label:"PIC",type:"combobox",options:s(i?.pic),createApi:{path:"/api/pic",field:"name"},value:i?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:i?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:i?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:i?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:i?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:i?.document_link}]})}F();async function Ot(t){let e=await H(),r=await ee(),a=["Ade","Berlin"],l=i=>i&&!r.find(n=>n.value===i)?[...r,{value:i,label:i}]:r,d=i=>i&&!a.find(n=>(typeof n=="object"?n.value:n)===i)?[...a,i]:a,s=Array.from({length:5},(i,n)=>String(new Date().getFullYear()-n));L({container:t,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:i=>window.formatDate(i)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:i=>{try{let n=JSON.parse(i);return Array.isArray(n)?n.join(", "):i||"-"}catch{return i||"-"}}},{key:"score",label:"Nilai",render:i=>i!=null?`<strong>${i}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:i=>i?`<a href="${i}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer..."},{type:"select",name:"year",label:"Tahun",options:s}],exportOptions:{moduleName:"training",onExport:async i=>{let n=new URLSearchParams(i||{}).toString(),o=await k(`/api/training?limit=10000&${n}`);if(o.ok){let u=o.data.data.map(c=>{let g=c.participants||"";try{let y=JSON.parse(g);g=Array.isArray(y)?y.join(", "):g}catch{}return{Tanggal:c.training_date||"",Batch:c.batch||"",Materi:c.subject||"",Cabang:c.branch_name||"",Trainer:c.trainer||"",Peserta:g,Nilai:c.score!==null&&c.score!==void 0?c.score:"",Dokumen:c.document_link||""}}),{downloadExcel:p}=await Promise.resolve().then(()=>(K(),le));p(u,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let i=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(K(),le));n(i,"Template_Import_Training")},onImport:async i=>{let n=c=>{if(!c)return null;let g=String(c||"").toLowerCase(),y=e.find(m=>String(m.label||"").toLowerCase()===g);return y?y.value:null},o=c=>{if(!c)return"";if(c instanceof Date&&!isNaN(c.getTime()))return c.toISOString().slice(0,10);let g=String(c).trim();if(/^\d{4,5}$/.test(g)){let m=Number(g);if(m>2e4&&m<99999){let b=new Date(Date.UTC(1899,11,30)+m*864e5);return isNaN(b.getTime())?"":b.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(g))return g.slice(0,10);let y=g.split(/[\/\-\.]/);if(y.length===3){let[m,b,h]=y.map(_=>_.trim());if(m.length===4&&b.length<=2&&h.length<=2)return`${m}-${b.padStart(2,"0")}-${h.padStart(2,"0")}`;if(h.length===4&&b.length<=2&&m.length<=2)return`${h}-${b.padStart(2,"0")}-${m.padStart(2,"0")}`}return g},u=i.map(c=>({training_date:o(c.Tanggal),batch:String(c.Batch||"").trim(),subject:String(c.Materi||"").trim(),branch_id:n(String(c.Cabang||"").trim()),trainer:String(c.Trainer||"").trim(),participants:String(c.Peserta||"").trim(),score:c.Nilai?Number(c.Nilai):null,document_link:String(c.Dokumen||"").trim()})).filter(c=>c.training_date&&c.subject&&c.branch_id),p=await k("/api/import/training",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!p.ok)throw new Error(p.data?.error||"Import gagal");return p.data}},formFields:i=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:i?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:i?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:i?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",options:e,value:i?.branch_id},{name:"trainer",label:"Trainer",type:"combobox",options:d(i?.trainer),value:i?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let n=JSON.parse(i?.participants);return Array.isArray(n)?n.join(", "):i?.participants||""}catch{return i?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:i?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:i?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:i?.notes}],onBeforeSubmit:async i=>(i.participants&&(i.participants=JSON.stringify(i.participants.split(",").map(n=>n.trim()).filter(Boolean))),i)})}F();ye();K();function Rt({container:t,title:e,icon:r,apiPath:a,columns:l,formFields:d,filterFields:s,defaultFilters:i={},itemLabel:n="Data",canCreate:o=!0,canEdit:u=!0,canDelete:p=!0,onBeforeSubmit:c,onAfterLoad:g,onDataLoaded:y,extraActions:m=[],initialSearch:b="",exportOptions:h=null,bulkDelete:_=!1,paginationMode:C="server"}){let S=1,x={...i};b&&(x.search=b);let w=new Set;t.innerHTML=`
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),l()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),l()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.querySelectorAll(".cal-filter").forEach(d=>d.addEventListener("change",l));async function a(){try{let d=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`;r=(await k(`/api/dashboard/calendar?month=${d}`)).data?.data||[]}catch(d){console.warn("[Calendar] Failed to load events, rendering empty grid:",d),r=[]}}async function l(){let d=document.getElementById("calendar-grid");if(d){d.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
      ${Array(35).fill('<div style="background:#f8fafc;min-height:70px;"></div>').join("")}
    </div>`,await a();try{let s=e.getFullYear(),i=e.getMonth(),n=e.toLocaleDateString("id-ID",{month:"long",year:"numeric"}),o=document.getElementById("cal-month-label");o&&(o.textContent=n);let u=new Set(Array.from(document.querySelectorAll(".cal-filter:checked")).map(S=>S.value)),p=r.filter(S=>u.has(S.type)),c={};p.forEach(S=>{let x=(S.event_date||"").slice(0,10);c[x]||(c[x]=[]),c[x].push(S)});let g=new Date(s,i,1).getDay(),y=new Date(s,i+1,0).getDate(),m=["Min","Sen","Sel","Rab","Kam","Jum","Sab"],b=new Date().toISOString().slice(0,10),h='<div class="calendar-grid">';m.forEach(S=>{h+=`<div class="cal-day-header">${S}</div>`});for(let S=0;S<g;S++)h+='<div class="cal-cell cal-cell-empty"></div>';for(let S=1;S<=y;S++){let x=`${s}-${String(i+1).padStart(2,"0")}-${String(S).padStart(2,"0")}`,w=c[x]||[],R=x===b;h+=`
          ...
          `).join(""),R.style.display="block"})})}catch(s){console.error("[Calendar] Render error:",s),d&&(d.innerHTML=`
  ...
  `;let e=null,r=null,a=0,l={upload:document.getElementById("step-upload"),validating:document.getElementById("step-validating"),preview:document.getElementById("step-preview"),importing:document.getElementById("step-importing"),summary:document.getElementById("step-summary")};function d(m){Object.entries(l).forEach(([b,h])=>{h.style.display=b===m?"":"none"})}document.getElementById("btn-backup-db")?.addEventListener("click",async()=>{let m=document.getElementById("btn-backup-db");m.disabled=!0,m.textContent="\u23F3 Memproses Backup...";try{let b=await k("/api/import/backup");if(b.ok){if(!window.XLSX){G("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");return}let h=window.XLSX,_=h.utils.book_new();Object.entries(b.data.database).forEach(([C,S])=>{let x=S.length>0?S:[{}],w=h.utils.json_to_sheet(x);h.utils.book_append_sheet(_,w,C.substring(0,31))}),h.writeFile(_,`FCMS_Database_Backup_${new Date().toISOString().slice(0,10)}.xlsx`),Z("Backup berhasil diunduh!")}else G("Gagal memproses backup: "+(b.data?.error||"Unknown error"))}catch(b){G("Gagal memproses backup: "+b.message)}finally{m.disabled=!1,m.textContent="\u{1F4E6} Backup Database"}});let s=document.getElementById("btn-sync-google");s&&s.addEventListener("click",async()=>{if(!confirm("Peringatan: Mensinkronkan data dengan Google Sheets akan memperbarui dan menambahkan data baru dari Google Sheets ke dalam FCMS. Data yang sudah Anda buat di FCMS TIDAK akan terhapus. Lanjutkan?"))return;let m=s.innerHTML;s.innerHTML='<span class="spinner"></span> Menyinkronkan...',s.disabled=!0;try{let b=await k("/api/sync/google-sheets",{method:"POST"});b.ok?alert("Sinkronisasi Berhasil: "+(b.data?.message||"Data Karyawan & PIC telah diperbarui.")):alert("Gagal Sinkronisasi: "+(b.data?.error||"Unknown error"))}catch{alert("Terjadi kesalahan koneksi.")}finally{s.innerHTML=m,s.disabled=!1}}),document.getElementById("btn-download-template").addEventListener("click",()=>{Zt(),Z("Template Excel berhasil didownload!")});let i=document.getElementById("file-input"),n=document.getElementById("upload-zone");document.getElementById("btn-browse").addEventListener("click",m=>{m.stopPropagation(),i.click()}),i.addEventListener("change",m=>{m.target.files[0]&&o(m.target.files[0])}),n.addEventListener("dragover",m=>{m.preventDefault(),n.classList.add("drag-over")}),n.addEventListener("dragleave",()=>n.classList.remove("drag-over")),n.addEventListener("drop",m=>{m.preventDefault(),n.classList.remove("drag-over");let b=m.dataTransfer.files[0];b&&b.name.match(/\.xlsx?$/i)?o(b):G("Hanya file .xlsx atau .xls yang didukung.")}),document.getElementById("btn-clear-file").addEventListener("click",()=>{e=null,i.value="",document.getElementById("file-info").style.display="none",n.style.display="",d("upload")});async function o(m){e=m,document.getElementById("file-name-display").textContent=`\u{1F4C4} ${m.name} (${(m.size/1024).toFixed(1)} KB)`,document.getElementById("file-info").style.display="flex",n.style.display="none",await u(m)}async function u(m){d("validating");let b=document.getElementById("validation-status"),h=document.getElementById("validation-bar");try{if(!window.XLSX)throw new Error("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");b.textContent="Membaca file Excel...",h.style.width="20%",await je(200);let _=await m.arrayBuffer(),C=window.XLSX.read(_,{type:"array",cellDates:!0});b.textContent=`Memvalidasi ${C.SheetNames.length} sheet...`,h.style.width="50%",await je(100),r=Xt(C),h.style.width="100%",b.textContent="Validasi selesai!",await je(300),p()}catch(_){d("upload"),G("Gagal memproses file: "+_.message),document.getElementById("file-info").style.display="flex",n.style.display="none"}}function p(){d("preview");let m=r.filter(E=>!E.skipped).length,b=r.reduce((E,O)=>E+O.total,0),h=r.reduce((E,O)=>E+O.valid,0),_=r.reduce((E,O)=>E+O.errorCount,0),C=b>0?Math.round(h/b*100):0;document.getElementById("preview-summary-badges").innerHTML=`
    ...
    `,S.querySelectorAll(".btn-detail-error").forEach(E=>{E.addEventListener("click",()=>{let O=r[Number(E.dataset.idx)];c(O)})});let x=document.getElementById("error-detail-section"),w=document.getElementById("error-detail-container");w.innerHTML="",x.style.display="none";let R=document.getElementById("btn-start-import");h===0?(R.disabled=!0,R.innerHTML="\u26A0\uFE0F Tidak Ada Data Valid"):(R.disabled=!1,_>0?(R.innerHTML=`\u{1F680} Import ${h} Data Valid (${_} dilewati)`,R.title="Baris error akan dilewati, baris valid tetap diimport"):R.innerHTML=`\u{1F680} Mulai Import ${h} Data`)}function c(m){let b=document.getElementById("error-detail-section"),h=document.getElementById("error-detail-container");b.style.display="";let _=m.errors.slice(0,100).map(C=>(Array.isArray(C.errors)?C.errors:[]).map(x=>{let w=typeof x=="object";return`
          <tr>
  ...
  `;let e=document.getElementById("btnRefreshSync"),r=document.getElementById("queueStatusFilter");e.addEventListener("click",l),r.addEventListener("change",i),document.getElementById("btnRetryAll").addEventListener("click",()=>a("retry",{allFailed:!0})),document.getElementById("btnResetStuck").addEventListener("click",()=>a("reset-stuck",{})),document.getElementById("btnPauseSync").addEventListener("click",()=>a("pause",{})),document.getElementById("btnResumeSync").addEventListener("click",()=>a("resume",{})),document.getElementById("btnReconcile").addEventListener("click",()=>a("reconcile",{module:"ALL",repairMode:!0})),document.getElementById("btnRetrySelected").addEventListener("click",()=>{let o=Array.from(document.querySelectorAll(".chk-queue:checked")).map(u=>u.value);if(o.length===0)return alert("No items selected");a("retry",{ids:o})}),document.getElementById("chkAllQueue").addEventListener("change",o=>{document.querySelectorAll(".chk-queue").forEach(u=>u.checked=o.target.checked)});async function a(o,u){if(confirm(`Are you sure you want to execute action: ${o}?`)){showLoading();try{let p=await k(`/api/sync/actions/${o}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(u)});p.ok?(alert(p.data?.message||"Success"),l()):G(p.error||"Action failed")}catch(p){G(p.message)}hideLoading()}}await l();async function l(){showLoading(),await Promise.all([s(),i(),d(),n()]),hideLoading()}async function d(){try{let o=await k("/api/sync/performance");if(!o.ok)return;let{webhook:u,google_api:p,d1:c,queue:g,throughput:y}=o.data;document.getElementById("latencyHistograms").innerHTML=`
      ...
      `;document.getElementById("syncOverviewCards").innerHTML=g;let y=document.getElementById("cbStateBadge"),m=document.getElementById("cbStateDesc"),b=document.getElementById("cbStatusCard");b.className="bg-white rounded-lg shadow p-6 border-l-4",c==="CLOSED"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800",y.textContent="CLOSED",m.textContent="Traffic is flowing normally to Google Sheets.",b.classList.add("border-green-500")):c==="OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800",y.textContent="OPEN",m.textContent="Failing fast. Traffic to Google Sheets is paused due to repeated failures.",b.classList.add("border-red-500")):c==="HALF_OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",y.textContent="HALF-OPEN",m.textContent="Testing recovery. Permitting limited traffic to verify stability.",b.classList.add("border-yellow-500")):y.textContent=c||"UNKNOWN"}catch(o){console.error(o)}}async function i(){try{let o=document.getElementById("queueStatusFilter").value,u=await k("/api/sync/queue?limit=15"+(o?"&status="+o:""));if(!u.ok)return;let p=document.getElementById("queueTableBody"),c=u.data?.data||u.data||[];if(c.length===0){p.innerHTML='<tr><td colspan="6" class="px-4 py-4 text-center text-gray-500">No events found</td></tr>';return}p.innerHTML=c.map(g=>`
      ...
      `).join("")}catch(o){console.error(o)}}async function n(){try{let o=await k("/api/sync/metrics");if(!o.ok)return;let u=document.getElementById("metricsTableBody"),p=o.data||[];if(p.length===0){u.innerHTML='<tr><td colspan="5" class="px-4 py-4 text-center text-gray-500">No metrics found in last 24h</td></tr>';return}u.innerHTML=p.map(c=>`
        <tr class="hover:bg-gray-50">
