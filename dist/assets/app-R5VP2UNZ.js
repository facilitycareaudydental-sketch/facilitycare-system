var la=Object.defineProperty;var tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var at=(t,e)=>{for(var i in e)la(t,i,{get:e[i],enumerable:!0})};var ve={};at(ve,{API:()=>yt,CLIENT_SIDE_MAX_ROWS:()=>ge,IS_DEVELOPMENT:()=>De,apiFetch:()=>S,clearToken:()=>Pe,getToken:()=>Ie,getUser:()=>be,setToken:()=>nt,setUser:()=>Le});function Ie(){return localStorage.getItem("fm_token")}function nt(t){localStorage.setItem("fm_token",t)}function Pe(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function be(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Le(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function S(t,e={}){let i=Ie(),a={"Content-Type":"application/json",...i?{Authorization:`Bearer ${i}`}:{},...e.headers||{}};try{let l=`cb=${Date.now()}`,o=t.includes("?")?"&":"?",r=`${yt}${t}${o}${l}`,s=await fetch(r,{...e,headers:a}),n;try{let d=await s.text();try{n=JSON.parse(d)}catch{n={error:`Server Error (${s.status}): ${d.substring(0,80)}...`}}}catch{n={error:"Gagal membaca respon dari server"}}return s.status===401&&(Pe(),window.location.hash="#/login"),{ok:s.ok,status:s.status,data:n}}catch(l){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${l.message})`}}}}var De,oa,yt,ge,M=tt(()=>{De=!1,oa="https://fm-operations-api.facilitycare-audydental.workers.dev",yt=oa,ge=1e4});var kt={};at(kt,{confirmDialog:()=>Ne,createModal:()=>le});function le({title:t,content:e,onConfirm:i,onCancel:a,confirmText:l="Simpan",cancelText:o="Batal",size:r="md",confirmClass:s="btn-primary"}){let n={sm:"400px",md:"560px",lg:"720px",xl:"900px"},d=document.createElement("div");d.className="modal-overlay",d.innerHTML=`
  ...
  `,e instanceof HTMLElement&&d.querySelector(".modal-body").appendChild(e);let u=()=>{d.classList.remove("show"),setTimeout(()=>d.remove(),250)};return d.querySelector(".modal-close").addEventListener("click",()=>{a&&a(),u()}),d.querySelector(".modal-cancel").addEventListener("click",()=>{a&&a(),u()}),i&&d.querySelector(".modal-confirm").addEventListener("click",()=>i(d,u)),d.addEventListener("click",c=>{c.target===d&&(a&&a(),u())}),document.body.appendChild(d),requestAnimationFrame(()=>d.classList.add("show")),{overlay:d,close:u}}function Ne(t,e,i="Konfirmasi"){return le({title:i,content:`<p>${t}</p>`,onConfirm:(a,l)=>{e(),l()},confirmText:"Ya, Lanjutkan",confirmClass:"btn-danger"})}var he=tt(()=>{});var re={};at(re,{downloadExcel:()=>L,parseExcel:()=>Fe,renderExcelButtons:()=>Me});function Fe(t){return new Promise((e,i)=>{let a=new FileReader;a.onload=l=>{try{let o=new Uint8Array(l.target.result),r=XLSX.read(o,{type:"array"}),s=r.SheetNames[0],n=r.Sheets[s];console.log("--- START EXCEL PARSING ---"),console.log(`File Name: ${t.name}`),console.log(`File Size: ${(t.size/1024).toFixed(2)} KB`),console.log(`File Type: ${t.type||"unknown"}`),console.log(`Sheets Found: ${r.SheetNames.join(", ")}`),console.log(`Sheet Used: ${s}`);let d=XLSX.utils.decode_range(n["!ref"]||"A1:A1"),u=d.e.r-d.s.r+1,c=d.e.c-d.s.c+1;console.log(`Total Rows (including empty): ${u}`),console.log(`Total Columns: ${c}`);let p=[];for(let b=d.s.c;b<=d.e.c;++b){let g=n[XLSX.utils.encode_cell({c:b,r:d.s.r})];g&&g.v&&p.push(g.v)}console.log(`Headers Found: ${p.join(", ")}`),console.log("---------------------------");let m=XLSX.utils.sheet_to_json(n,{defval:""});Object.defineProperty(m,"__worksheet",{value:n,enumerable:!1}),Object.defineProperty(m,"__headers",{value:p,enumerable:!1}),e(m)}catch(o){i(o)}},a.onerror=l=>i(l),a.readAsArrayBuffer(t)})}function L(t,e){try{let i=XLSX.utils.json_to_sheet(t),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,i,"Data"),XLSX.writeFile(a,`${e}.xlsx`)}catch(i){throw console.error("Error generating Excel file:",i),i}}function Me(t){return`
  ...
  `}var K=tt(()=>{});M();var it={},qe=null;function J(t,e){it[t]=e}function ke(t){window.location.hash=t}function ft(){async function t(){let e=window.location.hash.replace("#","")||"/dashboard",[i,...a]=e.split("?"),l=it[i];if(!l){for(let[r,s]of Object.entries(it))if(r.endsWith("/*")&&i.startsWith(r.slice(0,-2))){l=s;break}}qe&&(qe(),qe=null);let o=document.getElementById("main-content");if(o&&(o.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),l){let r=new URLSearchParams(a.join("?")),s=i.split("/").filter(Boolean),n=await l({path:i,params:r,segments:s,main:o});n&&(qe=n)}else{let r=o||document.getElementById("app");r&&(r.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",t),t()}var Be;function ca(){return Be||(Be=document.createElement("div"),Be.id="toast-container",document.body.appendChild(Be)),Be}function vt(t,e="info",i=3500){let a=ca(),l=document.createElement("div");l.className=`toast toast-${e}`;let o={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};l.innerHTML=`<span class="toast-icon">${o[e]||"\u2139"}</span><span class="toast-msg">${t}</span>`,a.appendChild(l),requestAnimationFrame(()=>l.classList.add("show")),setTimeout(()=>{l.classList.remove("show"),setTimeout(()=>l.remove(),350)},i)}var Z=t=>vt(t,"success"),G=t=>vt(t,"error");he();M();M();he();function je({columns:t,data:e,onEdit:i,onDelete:a,onView:l,actions:o=[],emptyText:r="Tidak ada data",bulkSelect:s=null}){let n=document.createElement("div");if(n.className="table-wrapper",!e||e.length===0)return n.innerHTML=`<div class="empty-state"><p>${r}</p></div>`,n;let d=document.createElement("table");d.className="data-table";let u=document.createElement("thead"),c=document.createElement("tr");if(s){let m=document.createElement("th");m.style.width="40px",m.style.textAlign="center";let b=document.createElement("input");b.type="checkbox",b.id="select-all-checkbox",b.title="Pilih semua",b.addEventListener("change",()=>{e.forEach(g=>{b.checked?s.selectedIds.add(g.id):s.selectedIds.delete(g.id)}),n.querySelectorAll(".row-checkbox").forEach(g=>g.checked=b.checked),s.onToggle()}),m.appendChild(b),c.appendChild(m)}if(t.forEach(m=>{let b=document.createElement("th");b.textContent=m.label,m.width&&(b.style.width=m.width),c.appendChild(b)}),i||a||l||o.length>0){let m=document.createElement("th");m.textContent="Aksi",m.style.width="120px",c.appendChild(m)}u.appendChild(c),d.appendChild(u);let p=document.createElement("tbody");return e.forEach(m=>{let b=document.createElement("tr");if(s){let g=document.createElement("td");g.style.textAlign="center",g.style.width="40px";let h=document.createElement("input");h.type="checkbox",h.className="row-checkbox",h.checked=s.selectedIds.has(m.id),h.addEventListener("change",()=>{if(h.checked)s.selectedIds.add(m.id);else{s.selectedIds.delete(m.id);let y=document.getElementById("select-all-checkbox");y&&(y.checked=!1)}s.onToggle()}),g.appendChild(h),b.appendChild(g)}if(t.forEach(g=>{let h=document.createElement("td");if(g.render){let y=g.render(m[g.key],m);y instanceof HTMLElement?h.appendChild(y):h.innerHTML=y||""}else h.textContent=m[g.key]!==null&&m[g.key]!==void 0&&m[g.key]!==""?m[g.key]:"";g.nowrap&&(h.style.whiteSpace="nowrap"),b.appendChild(h)}),i||a||l||o.length>0){let g=document.createElement("td");g.className="actions-cell";let h=document.createElement("div");if(h.className="btn-group",l){let y=document.createElement("button");y.className="btn btn-xs btn-ghost",y.innerHTML="\u{1F441}",y.title="Lihat",y.addEventListener("click",()=>l(m)),h.appendChild(y)}if(i){let y=document.createElement("button");y.className="btn btn-xs btn-secondary",y.innerHTML="\u270F\uFE0F",y.title="Edit",y.addEventListener("click",()=>i(m)),h.appendChild(y)}o.forEach(y=>{let k=document.createElement("button");k.className=`btn btn-xs ${y.class||"btn-ghost"}`,k.innerHTML=y.icon||y.label,k.title=y.label,k.addEventListener("click",()=>y.handler(m)),h.appendChild(k)}),g.appendChild(h),b.appendChild(g)}p.appendChild(b)}),d.appendChild(p),n.appendChild(d),n}function Je({page:t,pages:e,total:i,limit:a,onPage:l}){if(e<=1)return null;let o=document.createElement("div");o.className="pagination";let r=document.createElement("span");r.className="pagination-info",r.textContent=`Total: ${i} data`,o.appendChild(r);let s=document.createElement("div");s.className="pagination-btns";let n=(c,p,m=!1,b=!1)=>{let g=document.createElement("button");g.className=`btn btn-sm ${b?"btn-primary":"btn-ghost"} pagination-btn`,g.textContent=c,g.disabled=m,g.addEventListener("click",()=>l(p)),s.appendChild(g)};n("\xAB",1,t===1),n("\u2039",t-1,t===1);let d=Math.max(1,t-2),u=Math.min(e,t+2);for(let c=d;c<=u;c++)n(c,c,!1,c===t);return n("\u203A",t+1,t===e),n("\xBB",e,t===e),o.appendChild(s),o}he();function Ae(t){return t.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="html")return e.html||"";if(e.type==="row")return`<div class="form-row">${Ae(e.fields)}</div>`;let i=e.required?"required":"",a=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",l="";switch(e.type){case"textarea":l=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${i} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let r=(e.options||[]).map(c=>{let p=typeof c=="object"?c.value:c,m=typeof c=="object"?c.label:c,b=e.value==p?"selected":"";return`<option value="${p}" ${b}>${m}</option>`}).join("");l=`<select name="${e.name}" class="form-control" ${i}><option value="">-- Pilih ${e.label||""} --</option>${r}</select>`;break;case"combobox":let s=`dl-${e.name}-${Math.random().toString(36).substring(7)}`,n=(e.options||[]).map(c=>{let p=typeof c=="object"?c.value:c,m=typeof c=="object"?c.label||c.value||"":c||"";return(m==="undefined"||m==="[object Object]"||m==="null")&&(m=""),m?`<option value="${m}"></option>`:""}).join(""),d=e.value||"";if(e.value){let c=(e.options||[]).find(p=>(typeof p=="object"?p.value:p)==e.value);if(c){let p=typeof c=="object"?c.label||c.value||"":c||"";p&&p!=="undefined"&&p!=="[object Object]"&&p!=="null"&&(d=p)}}l=`
          <input type="text" name="${e.name}" list="${s}" class="form-control" value="${d}" placeholder="Pilih atau ketik baru..." ${i} autocomplete="off">
          <datalist id="${s}">${n}</datalist>
        `;break;case"checkbox":l=`<label class="checkbox-label"><input type="checkbox" name="${e.name}" value="1" ${e.value?"checked":""}> ${e.checkLabel||e.label}</label>`;break;case"date":let u=window.parseFlexibleDate&&e.value?window.parseFlexibleDate(e.value):e.value||"";l=`<input type="date" name="${e.name}" class="form-control" value="${u}" ${i}>`;break;case"number":l=`<input type="number" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" min="${e.min||""}" max="${e.max||""}" step="${e.step||"1"}" ${i}>`;break;case"email":l=`<input type="email" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${i}>`;break;case"url":l=`<input type="url" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||"https://..."}" ${i}>`;break;default:l=`<input type="${e.type||"text"}" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${i} autocomplete="off">`}let o=e.hint?`<div class="form-hint">${e.hint}</div>`:"";return`<div class="form-group ${e.class||""}">${a}${l}${o}</div>`}).join("")}function Ue(t){let e={},i=new FormData(t);for(let[a,l]of i.entries())e[a]=l===""?null:l;return t.querySelectorAll("input[type=checkbox]").forEach(a=>{a.checked||(e[a.name]=null)}),e}function Ge(t,e){e&&Object.entries(e).forEach(([i,a])=>{let l=t.querySelector(`[name="${i}"]`);l&&(l.hasAttribute("list")||(l.type==="checkbox"?l.checked=!!a:l.type==="date"&&a&&window.parseFlexibleDate?l.value=window.parseFlexibleDate(a):l.value=a??""))})}K();function B({container:t,title:e,icon:i,apiPath:a,columns:l,formFields:o,filterFields:r,defaultFilters:s={},itemLabel:n="Data",canCreate:d=!0,canEdit:u=!0,canDelete:c=!0,onBeforeSubmit:p,onAfterLoad:m,onDataLoaded:b,extraActions:g=[],initialSearch:h="",exportOptions:y=null,bulkDelete:k=!1,paginationMode:C="server"}){let x=1,w={...s};h&&(w.search=h);let _=new Set;t.innerHTML=`
  ...
  `;function F(){if(!document.getElementById("bulk-toolbar"))return;let f=document.getElementById("bulk-count"),$=document.getElementById("btn-bulk-delete"),P=document.getElementById("btn-bulk-cancel");f.textContent=`${_.size} item dipilih`,_.size>0?($.disabled=!1,P.disabled=!1):($.disabled=!0,P.disabled=!0)}document.getElementById("btn-bulk-cancel")?.addEventListener("click",()=>{_.clear(),document.querySelectorAll(".row-checkbox").forEach(f=>f.checked=!1);let v=document.getElementById("select-all-checkbox");v&&(v.checked=!1),F()}),document.getElementById("btn-bulk-delete")?.addEventListener("click",()=>{if(_.size===0)return;let v=[..._],f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9999;display:flex;align-items:center;justify-content:center",f.innerHTML=`
  ...
  </div>`).join("");function _t(t=3){return Array(t).fill(0).map((e,i)=>`<div class="skeleton skeleton-text" style="height:38px;margin-bottom:${i<t-1?"6px":"0"};border-radius:6px"></div>`).join("")}async function se(t,e,i=8e3){try{let a=new AbortController,l=setTimeout(()=>a.abort(),i),o=await S(t,{signal:a.signal}).catch(()=>null);if(clearTimeout(l),!o||!o.ok)return e;let r=o.data;return r?r.data!==void 0?r.data??e:r:e}catch{return e}}function ya(){["skel-donut","skel-trend","skel-insp","skel-contract"].forEach(a=>{let l=document.getElementById(a);l&&(l.style.display="none")}),["chart-donut","chart-trend","chart-insp","chart-contract"].forEach(a=>{let l=document.getElementById(a);if(l&&l.style.display==="none"){l.style.display="block";let o=l.parentElement;if(o&&!o.querySelector(".chart-empty")){let r=document.createElement("div");r.className="chart-empty",r.textContent="Belum ada data",l.style.display="none",o.appendChild(r)}}});let t=document.getElementById("kpi-row");t&&t.querySelector(".skeleton")&&Et({});let e=document.getElementById("mini-stats-row");e&&e.querySelector(".skeleton")&&$t({}),["table-contracts","table-issues"].forEach(a=>{let l=document.getElementById(a);l&&l.querySelector(".skeleton")&&(l.innerHTML='<div class="chart-empty">Belum ada data</div>')});let i=document.getElementById("activity-log");i&&i.querySelector(".skeleton")&&(i.innerHTML='<div class="chart-empty">Belum ada aktivitas</div>')}async function Tt(t){da(),t._dashRefresh&&clearInterval(t._dashRefresh),t._skelTimeout&&clearTimeout(t._skelTimeout);let e=new Date().toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});t.innerHTML=`
  ...
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>dt(t)),document.getElementById("filter-insp-month")?.addEventListener("change",async i=>{let a=i.target.value,l=a?`/api/dashboard/inspection-bar?month=${a}`:"/api/dashboard/inspection-bar",o=document.getElementById("skel-insp"),r=document.getElementById("chart-insp");o&&(o.style.display="block",o.style.position="absolute"),r&&(r.style.display="none");let s=await se(l,{},8e3);try{Dt(s)}catch(n){console.warn("InspBar render:",n),ue("skel-insp","chart-insp")}}),t._skelTimeout=setTimeout(()=>ya(),5e3),await dt(t),t._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?dt(t):clearInterval(t._dashRefresh)},6e4)}async function dt(t){t._skelTimeout&&(clearTimeout(t._skelTimeout),t._skelTimeout=null);let[e,i,a,l,o,r,s,n,d,u,c,p]=await Promise.all([se("/api/dashboard/kpi",{},8e3),se("/api/dashboard/issues-trend",{},8e3),se("/api/dashboard/issues-summary",{},8e3),se("/api/dashboard/inspection-bar",{},8e3),se("/api/dashboard/stats",{},8e3),se("/api/dashboard/calendar",[],8e3),se("/api/schedule?limit=10000",{data:[]},8e3),se("/api/employees?limit=10000",{data:[]},8e3),se("/api/contracts?limit=10000",{data:[]},8e3),se("/api/issues?limit=10000",{data:[]},8e3),se("/api/one-on-one?limit=10000",{data:[]},8e3),se("/api/dashboard/contracts-chart",{labels:[],data:[]},8e3)]);if(e){let m=Array.isArray(s?.data)?s.data:Array.isArray(s)?s:[],b=Array.isArray(n?.data)?n.data:Array.isArray(n)?n:[],g=Array.isArray(d?.data)?d.data:Array.isArray(d)?d:[],h=Array.isArray(u?.data)?u.data:Array.isArray(u)?u:[],y=Array.isArray(c?.data)?c.data:Array.isArray(c)?c:[];e.employees&&(e.employees.current=b.filter(k=>St(k,"active")).length),e.contracts&&(e.contracts.current=g.filter(k=>ot(k,"active")).length),e.expiring30&&(e.expiring30={current:g.filter(k=>ot(k,"expiring30")).length}),e.issues&&(e.issues.current=h.filter(k=>xt(k,"open")).length),e.one_on_one&&(e.one_on_one.current=y.filter(k=>wt(k,"pending")).length),e.inspection_month&&(e.inspection_month.current=m.filter(k=>lt(k,"inspeksi")).length),e.cleaning_month&&(e.cleaning_month.current=m.filter(k=>lt(k,"gcdc")).length)}try{Et(e)}catch(m){console.warn("KPI render:",m)}try{$t(e)}catch(m){console.warn("MiniStats render:",m)}try{fa(Array.isArray(a?.by_category)?a.by_category:[])}catch(m){console.warn("Donut render:",m),ue("skel-donut","chart-donut")}try{va(i)}catch(m){console.warn("Trend render:",m),ue("skel-trend","chart-trend")}try{Dt(l)}catch(m){console.warn("InspBar render:",m),ue("skel-insp","chart-insp")}try{let m=Array.isArray(o)?o:Array.isArray(o?.recent_issues)?o.recent_issues:[];Sa(m)}catch(m){console.warn("IssuesTable render:",m)}try{let m=Array.isArray(o?.expiring_contracts)?o.expiring_contracts:[];ka(p)}catch(m){console.warn("ContractsTable render:",m)}try{xa(Array.isArray(r)?r:[])}catch(m){console.warn("Agenda render:",m)}try{wa()}catch(m){console.warn("Quick Actions render:",m)}}function Et(t){let e=document.getElementById("kpi-row");if(!e)return;t=t||{};let i=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees?dash_filter=active",color:"kpi-blue",key:"employees",trendPct:"+2%",trendColor:"#10B981",points:"0,20 10,18 20,22 30,12 40,15 50,8 60,10 70,5 80,6 90,2 100,0"},{icon:"\u{1F504}",label:"Reliefer Aktif",sub:"Karyawan reliefer",href:"#/employees?dash_filter=reliefer",color:"kpi-purple",key:"reliever_total",trendPct:"0%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts?dash_filter=active",color:"kpi-green",key:"contracts",trendPct:"+1%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u23F3",label:"Kontrak Habis 30 Hari",sub:"Akan segera berakhir",href:"#/contracts?dash_filter=expiring30",color:"kpi-warn",key:"expiring30",trendPct:"+25%",trendColor:"#F59E0B",points:"0,25 20,22 40,24 60,15 80,18 100,5"},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues?dash_filter=open",color:"kpi-red",key:"issues",trendPct:"0%",trendColor:"#EF4444",points:"0,20 20,18 40,22 60,19 80,21 100,20"},{icon:"\u{1F4AC}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one?dash_filter=pending",color:"kpi-purple",key:"one_on_one",trendPct:"+8%",trendColor:"#10B981",points:"0,25 20,15 40,18 60,8 80,10 100,2"}];e.innerHTML=i.map(a=>{let l=de(t[a.key]?.current,0);return`
    ...
    <a href="${a.href}" class="mini-stat ${a.color}" style="text-decoration:none">
      ...
      <div class="mini-stat-body">
        <div class="mini-stat-value" data-target="${de(a.val)}">0</div>
        <div class="mini-stat-text">${a.label}</div>
      </div>
    </a>`).join(""),e.querySelectorAll(".mini-stat-value").forEach(a=>Ct(a,parseInt(a.dataset.target)||0,700))}function fa(t){ue("skel-donut","chart-donut");let e=document.getElementById("chart-donut"),i=document.getElementById("donut-legend");if(!e||!i)return;Oe("donut");let a=(t||[]).filter(n=>de(n.count)>0);if(!a.length){Ve(e,"Belum ada data permasalahan");return}let l=a.map(n=>`${_e(n.category,"Lainnya")}`),o=a.map(n=>de(n.count)),r=o.reduce((n,d)=>n+d,0);i.innerHTML=a.map((n,d)=>{let u=ct[d%ct.length],c=r>0?Math.round(n.count/r*100):0;return`
    ...
    `}).join("");let s={id:"centerText",beforeDraw:function(n){let d=n.width,u=n.height,c=n.ctx;c.restore();let p=(u/80).toFixed(2);c.font="bold "+p+"em Inter",c.textBaseline="middle",c.fillStyle="#1E293B";let m=r.toString(),b=Math.round((d-c.measureText(m).width)/2),g=u/2;c.fillText(m,b,g-10),c.font="600 "+(p*.35).toFixed(2)+"em Inter",c.fillStyle="#64748B";let h="Total",y=Math.round((d-c.measureText(h).width)/2);c.fillText(h,y,g+15),c.save()}};me.donut=new Chart(e,{type:"doughnut",data:{labels:l,datasets:[{data:o,backgroundColor:ct,borderWidth:2,borderColor:"#fff",hoverBorderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,animation:{duration:700},plugins:{legend:{display:!1},tooltip:{bodyFont:ce,titleFont:{...ce,weight:"700"},callbacks:{label:n=>` ${n.label}: ${n.parsed} kasus`}}},cutout:"75%"},plugins:[s]})}function va(t){ue("skel-trend","chart-trend");let e=document.getElementById("chart-trend");if(!e)return;Oe("trend"),t=t||{};let i=(t.labels||[]).map(pa),a=(t.open||[]).map(o=>de(o)),l=(t.closed||[]).map(o=>de(o));if(!i.length){Ve(e,"Belum ada data trend");return}me.trend=new Chart(e,{type:"line",data:{labels:i,datasets:[{label:"Open",data:a,borderColor:"#EF4444",backgroundColor:"rgba(239,68,68,.08)",fill:!0,tension:.4,pointRadius:2,pointHoverRadius:4,pointBackgroundColor:"#EF4444",borderWidth:2},{label:"Closed",data:l,borderColor:"#10B981",backgroundColor:"rgba(16,185,129,.08)",fill:!0,tension:.4,pointRadius:2,pointHoverRadius:4,pointBackgroundColor:"#10B981",borderWidth:2}]},options:pt({plugins:{legend:{display:!1}}})})}function Dt(t){ue("skel-insp","chart-insp");let e=document.getElementById("chart-insp");if(!e)return;Oe("inspBar"),t=t||{};let i=t.labels||[],a=(t.fc||[]).map(o=>de(o)),l=(t.spv||[]).map(o=>de(o));if(!i.length){Ve(e,"Belum ada data inspeksi");return}me.inspBar=new Chart(e,{type:"bar",data:{labels:i,datasets:[{label:"Skor FC",data:a,backgroundColor:"rgba(37,99,235,.75)",borderRadius:4,borderSkipped:!1},{label:"Skor SPV",data:l,backgroundColor:"rgba(16,185,129,.75)",borderRadius:4,borderSkipped:!1}]},options:pt({plugins:{legend:{position:"top"}},scales:{x:{grid:{display:!1},ticks:{font:ce,color:Ce,maxRotation:45,minRotation:30}},y:{grid:{color:ze},ticks:{font:ce,color:Ce},min:0,max:100}}})})}function ka(t){ue("skel-contract-mini","chart-contract-mini");let e=document.getElementById("chart-contract-mini");if(!e)return;Oe("contractMiniBar"),t=t||{};let i={"06":"Jun","07":"Jul","08":"Agu","09":"Sep",10:"Okt",11:"Nov",12:"Des"},a=(t.labels||[]).map(r=>{let s=r.split("-")[1];return i[s]||r}),l=(t.data||[]).map(r=>de(r));if(!a.length){Ve(e,"Belum ada data");return}let o=e.getContext("2d");me.contractMiniBar=new Chart(e,{type:"bar",data:{labels:a,datasets:[{label:"Kontrak Habis",data:l,backgroundColor:"#3B82F6",borderRadius:4,borderSkipped:!1,barPercentage:.6,categoryPercentage:.7}]},options:pt({onClick:(r,s)=>{if(s&&s.length>0){let n=s[0].index,d=(t.labels||[])[n];d&&(window.location.hash="#/contracts?month_expiry="+d)}},plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:ce,color:Ce,maxRotation:0,autoSkip:!1}},y:{grid:{color:ze,borderDash:[4,4],drawBorder:!1},ticks:{font:ce,color:Ce,precision:0,maxTicksLimit:5},min:0}},animation:{y:{duration:1e3,easing:"easeOutQuart"}}})})}function Sa(t){let e=document.getElementById("table-issues");if(!e)return;let i=(t||[]).slice(0,8);if(!i.length){e.innerHTML='<div class="chart-empty">\u2705 Tidak ada permasalahan terbuka</div>';return}e.innerHTML=`
    <div class="dash-list">
      ${i.map(a=>`
      ...
      `).join("")}
    </div>`}function xa(t){let e=document.getElementById("widget-agenda");if(!e)return;let i=new Date,a=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}-${String(i.getDate()).padStart(2,"0")}`,o=(t||[]).filter(r=>(r.event_date||"").startsWith(a)).slice(0,10);if(!o.length){e.innerHTML="";return}e.innerHTML=`
    <div style="display:flex;flex-direction:column;gap:12px;padding-right:8px">
      ${o.map(r=>{let s="#3B82F6",n="#EFF6FF",d="Agenda",u=(r.title||"").toLowerCase();return u.includes("inspeksi")?(s="#10B981",n="#ECFDF5",d="Inspeksi"):u.includes("cleaning")||u.includes("gcdc")?(s="#3B82F6",n="#EFF6FF",d="Cleaning"):u.includes("reliefer")?(s="#F59E0B",n="#FFFBEB",d="Reliefer"):u.includes("fogging")&&(s="#8B5CF6",n="#F5F3FF",d="Fogging"),`
        <div style="display:flex;gap:12px;align-items:flex-start;padding-bottom:12px;border-bottom:1px solid var(--border)">
          ...
          <div style="flex-shrink:0;font-size:0.7rem;font-weight:600;padding:2px 8px;border-radius:6px;background:${n};color:${s}">${d}</div>
        </div>
      `}).join("")}
    </div>
  ...
  `;let e=document.getElementById("login-form"),i=document.getElementById("login-error"),a=document.getElementById("login-btn"),l=document.getElementById("toggle-password"),o=document.getElementById("login-password");l?.addEventListener("click",()=>{let r=o.type==="text";o.type=r?"password":"text",l.style.color=r?"":"var(--primary)"}),e?.addEventListener("submit",async r=>{r.preventDefault(),i.style.display="none";let s=e.username.value.trim(),n=e.password.value;if(!s||!n){i.textContent="Username dan password wajib diisi.",i.style.display="block";return}a.querySelector(".btn-text").style.display="none",a.querySelector(".btn-spinner").style.display="",a.disabled=!0;try{let d=await S("/api/auth/login",{method:"POST",body:JSON.stringify({username:s,password:n})});d.ok&&d.data.success?(nt(d.data.data.token),Le(d.data.data.user),Z("Login berhasil! Selamat datang \u{1F44B}"),window.dispatchEvent(new Event("fm:login"))):(i.textContent=d.data.error||"Username atau password salah.",i.style.display="block",a.classList.add("shake"),setTimeout(()=>a.classList.remove("shake"),600))}catch{i.textContent="Gagal terhubung ke server. Periksa koneksi internet.",i.style.display="block"}finally{a.querySelector(".btn-text").style.display="",a.querySelector(".btn-spinner").style.display="none",a.disabled=!1}})}M();K();async function _a(){return await H()}function Ca(t,e){let i=String(t.status||"").toLowerCase();return e==="active"?i==="aktif":e==="reliefer"?t.division==="FC - RELIEFER"&&i==="aktif":!1}async function Pt(t,e){let i=await _a(),a=e?e.get("dash_filter"):null;B({container:t,title:"Karyawan",icon:"\u{1F465}",apiPath:"/api/employees",itemLabel:"Karyawan",bulkDelete:!0,paginationMode:"client",onDataLoaded:l=>a?l.filter(o=>Ca(o,a)):l,columns:[{key:"full_name",label:"Nama Lengkap"},{key:"branch_name",label:"Cabang"},{key:"division",label:"Divisi",render:l=>we(l)},{key:"phone",label:"No. HP",render:l=>l?`<a href="tel:${l}">${l}</a>`:"-"},{key:"join_date",label:"Tgl Masuk",render:l=>window.formatDate(l)},{key:"status",label:"Status",render:l=>j(l)}],filterFields:[{type:"search",placeholder:"Cari nama karyawan..."},{type:"combobox",name:"branch_id",label:"Cabang",options:i},{type:"select",name:"division",label:"Divisi",options:["FACILITY CARE","SECURITY","FC - RELIEFER"]},{type:"select",name:"status",label:"Status",options:["Aktif","Tidak Aktif","Resign","Cut"]}],formFields:l=>[{type:"row",fields:[{name:"full_name",label:"Nama Lengkap",required:!0,placeholder:"Nama lengkap karyawan",value:l?.full_name},{name:"phone",label:"No. HP",placeholder:"08xx-xxxx-xxxx",value:l?.phone}]},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",options:i,value:l?.branch_id},{name:"division",label:"Divisi",type:"select",required:!0,options:["FACILITY CARE","SECURITY","FC - RELIEFER"],value:l?.division||"FACILITY CARE"}]},{type:"row",fields:[{name:"join_date",label:"Tanggal Masuk",type:"date",value:l?.join_date},{name:"status",label:"Status",type:"select",required:!0,options:["Aktif","Tidak Aktif","Resign","Cut"],value:l?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:l?.notes}],exportOptions:{moduleName:"employees",onExport:async()=>{let l=await S(`/api/employees${window.location.search?window.location.search+"&":"?"}limit=10000`);if(l.ok){let o=l.data.data.map(r=>({"Nama Lengkap":r.full_name,Cabang:r.branch_name||"",Divisi:r.division||"","No. HP":r.phone||"","Tgl Masuk":r.join_date||"",Status:r.status||""}));L(o,"Data_Karyawan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{L([{"Nama Lengkap":"Budi Santoso",Cabang:"001. Pondok Bambu",Divisi:"FACILITY CARE","No. HP":"08123456789","Tgl Masuk":"2024-01-15",Status:"Aktif"},{"Nama Lengkap":"Andi Saputra",Cabang:"002. Bintaro",Divisi:"SECURITY","No. HP":"08987654321","Tgl Masuk":"2023-11-01",Status:"Aktif"}],"Template_Import_Karyawan")},onImport:async l=>{let o=n=>{if(!n)return null;let d=String(n||"").toLowerCase(),u=i.find(c=>String(c.label||"").toLowerCase()===d);return u?u.value:null},r=l.map(n=>({full_name:String(n["Nama Lengkap"]||"").trim(),branch_id:o(String(n.Cabang||"").trim()),division:String(n.Divisi||"").trim()||"FACILITY CARE",phone:String(n["No. HP"]||"").trim(),join_date:String(n["Tgl Masuk"]||"").trim(),status:String(n.Status||"").trim(),notes:String(n.Catatan||"").trim()})).filter(n=>n.full_name),s=await S("/api/import/employees",{method:"POST",body:JSON.stringify({rows:r,onDuplicate:"update"})});if(!s.ok)throw new Error(s.data?.error||"Import gagal");return s.data}}})}M();K();var ut=[],Lt=[];async function Ta(){ut=await H(),Lt=await xe()}var mt=async t=>{let e=[],i=1;for(;;){let l=await(await Promise.resolve().then(()=>(M(),ve))).apiFetch(`${t}${t.includes("?")?"&":"?"}limit=100&page=${i}`);if(!l.ok)break;let o=l.data?.data||l.data||[],r=Array.isArray(o)?o:[];if(e=e.concat(r),r.length<100||l.data?.pagination&&i>=l.data.pagination.pages)break;i++}return e};function Ea(t,e){if(String(t.status||"").toLowerCase()!=="aktif")return!1;if(e==="active")return!0;if(e==="expiring30"){if(!t.end_date)return!1;let a=new Date;a.setHours(0,0,0,0);let l=new Date(a);l.setDate(a.getDate()+30);let o=new Date(t.end_date);return o.setHours(0,0,0,0),o>=a&&o<=l}return!1}async function Bt(t,e){await Ta();let i=e?e.get("dash_filter"):null;B({container:t,title:"Data Kontrak",icon:"\u{1F4CB}",apiPath:"/api/contracts",bulkDelete:!0,itemLabel:"Kontrak",paginationMode:"client",onDataLoaded:a=>i?a.filter(l=>Ea(l,i)):a,columns:[{key:"employee_name",label:"Nama Lengkap"},{key:"branch_name",label:"Cabang"},{key:"division",label:"Div / Bagian",render:a=>we(a)},{key:"start_date",label:"Tanggal Mulai",nowrap:!0,render:a=>window.formatDate(a)},{key:"end_date",label:"Tanggal Selesai",nowrap:!0,render:a=>!a||String(a).startsWith("2099")?"Tetap / PKWTT":window.formatDate(a)},{key:"days_remaining",label:"Sisa Kontrak",render:(a,l)=>l.end_date&&String(l.end_date).startsWith("2099")?'<span class="badge badge-success" style="background:#10B981;color:white;padding:4px 8px;border-radius:6px;font-size:0.75rem;font-weight:600">Tetap</span>':rt(a)},{key:"status",label:"Status",render:a=>j(a)}],filterFields:[{type:"search",placeholder:"Cari nama karyawan..."},{type:"combobox",name:"branch_id",label:"Cabang",options:ut},{type:"select",name:"status",label:"Status",options:["Aktif","Tidak Aktif","Resign","Cut"]},{type:"select",name:"month_expiry",label:"Bulan Habis",options:[{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"},{value:"2027-01",label:"Jan 2027"},{value:"2027-02",label:"Feb 2027"},{value:"2027-03",label:"Mar 2027"},{value:"2027-04",label:"Apr 2027"},{value:"2027-05",label:"Mei 2027"},{value:"2027-06",label:"Jun 2027"},{value:"2027-07",label:"Jul 2027"}]},{type:"select",name:"expiring_days",label:"Akan Habis",options:[{value:"7",label:"7 Hari"},{value:"14",label:"14 Hari"},{value:"30",label:"30 Hari"},{value:"60",label:"60 Hari"}]}],onBeforeSubmit:a=>(a.end_date||(a.end_date="2099-12-31"),a),onAfterLoad:()=>{if(!document.getElementById("btn-find-missing")){let a=document.createElement("button");a.id="btn-find-missing",a.className="btn btn-ghost",a.innerHTML="\u{1F50D} Cek Selisih Karyawan",a.style.marginLeft="8px",a.style.color="#EF4444",a.style.border="1px solid currentColor",a.onclick=async()=>{a.innerHTML="\u231B Mencari...",a.disabled=!0;try{let[o,r]=await Promise.all([mt("/api/employees?status=Aktif"),mt("/api/contracts")]);if(o.length>0){let s=r.filter(c=>c.status==="Aktif"),n=new Set(s.map(c=>c.employee_id)),d=o.filter(c=>!n.has(c.id)),u=`<p style="margin-bottom:12px">Data yang terbaca: <b>${o.length}</b> Karyawan Aktif, dan <b>${s.length}</b> Kontrak Aktif.</p>
              <p style="margin-bottom:12px">Terdapat <b>${d.length}</b> karyawan aktif yang tidak memiliki "Kontrak Aktif". Berikut daftarnya:</p><ul style="padding-left:20px; max-height:400px; overflow-y:auto">`;d.forEach(c=>{let p=r.filter(b=>b.employee_id===c.id),m='<span style="color:#F59E0B">Belum pernah di-input kontrak</span>';if(p.length>0){let b=p[0];m=`Pernah ada kontrak (Status: <b style="color:#EF4444">${b.status}</b>, Selesai: ${window.formatDate(b.end_date)})`}u+=`<li style="margin-bottom:8px"><b>${c.full_name}</b> <br><span style="font-size:0.85em;color:var(--text-2)">Cabang: ${c.branch_name||"-"} | ${m}</span></li>`}),u+="</ul>",Promise.resolve().then(()=>(he(),kt)).then(c=>c.createModal({title:"Karyawan Tanpa Kontrak Aktif",content:u,cancelText:"Tutup"}))}}catch(o){console.error(o)}a.innerHTML="\u{1F50D} Cek Selisih Karyawan",a.disabled=!1};let l=document.querySelector(".page-actions");l&&l.appendChild(a)}},formFields:a=>[{type:"row",fields:[{name:"employee_id",label:"Nama Lengkap",type:"combobox",required:!0,options:Lt,value:a?.employee_id},{name:"branch_id",label:"Cabang",type:"combobox",options:ut,value:a?.branch_id}]},{type:"row",fields:[{name:"division",label:"Div / Bagian",type:"select",required:!0,options:["FACILITY CARE","SECURITY"],value:a?.division||"FACILITY CARE"},{name:"status",label:"Status",type:"select",required:!0,options:["Aktif","Tidak Aktif","Resign","Cut"],value:a?.status||""}]},{type:"row",fields:[{name:"start_date",label:"Tanggal Mulai",type:"date",value:a?.start_date},{name:"end_date",label:"Tanggal Selesai",type:"date",value:a?.end_date&&!String(a.end_date).startsWith("2099")?a.end_date:""}]},{type:"row",fields:[{name:"contract_type",label:"Tipe Kontrak",type:"select",options:["KONTRAK 6 BULAN","KONTRAK 1 TAHUN","KONTRAK 2 TAHUN"],value:a?.contract_type},{name:"pkwt_number",label:"No. PKWT",type:"select",options:["PKWT 1","PKWT 2","PKWT 3","PKWT 4","PKWT 5","PKWT 6"],value:a?.pkwt_number}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:a?.notes}],exportOptions:{moduleName:"contracts",onExport:async()=>{let a=await S(`/api/contracts${window.location.search?window.location.search+"&":"?"}limit=10000`);if(a.ok){let l=a.data.data.map(o=>({"Nama Lengkap":o.employee_name,Cabang:o.branch_name||"","Div / Bagian":o.division||"","Tanggal Mulai":o.start_date||"","Tanggal Selesai":o.end_date&&String(o.end_date).startsWith("2099")?"":o.end_date||"","Sisa Kontrak":o.end_date&&String(o.end_date).startsWith("2099")?"Tetap":o.days_remaining!==null&&o.days_remaining!==void 0?`${o.days_remaining} Hari`:"",Status:o.status||""}));L(l,"Data_Kontrak")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{L([{"Nama Lengkap":"Budi Santoso",Cabang:"001. Pondok Bambu","Div / Bagian":"FACILITY CARE","Tanggal Mulai":"2024-01-01","Tanggal Selesai":"2024-12-31","Sisa Kontrak":"365 Hari",Status:"Aktif"}],"Template_Import_Kontrak")},onImport:async a=>{let[l,o]=await Promise.all([S("/api/branches?limit=10000"),mt("/api/employees")]),r=l.data?.data||[],s=o||[];console.log(`Total employee yang berhasil dimuat dari database : ${s.length}`),s.length>0&&(console.log("Contoh 5 employee pertama:"),s.slice(0,5).forEach((g,h)=>{console.log(`${h+1}. ID: ${g.id}, Name: ${g.full_name}, Status: ${g.status}`)}));let n=g=>{if(!g)return null;let h=String(g||"").replace(/\s+/g," ").toLowerCase().trim(),y=r.find(k=>String(k.full_name||"").replace(/\s+/g," ").toLowerCase().trim()===h||String(k.code||"").replace(/\s+/g," ").toLowerCase().trim()===h||String(k.name||"").replace(/\s+/g," ").toLowerCase().trim()===h);return y?y.id:null},d=(g,h)=>{if(console.log("------------------------------------------------"),console.log(`Row Excel : ${h}`),console.log(`Nama dari Excel : "${g}"`),!g)return console.log("Alasan gagal mapping : Nama kosong"),null;let y=String(g||"").replace(/\s+/g," ").toLowerCase().trim();console.log(`Nama setelah normalisasi : "${y}"`),console.log(`Jumlah employee di database : ${s.length}`);let k=s.find(C=>String(C.full_name||"").replace(/\s+/g," ").toLowerCase().trim()===y);return k?(console.log("Employee ditemukan atau tidak : Ditemukan"),console.log(`Employee ID jika ditemukan : ${k.id}`),k.id):(console.log("Employee ditemukan atau tidak : TIDAK Ditemukan"),console.log("Alasan gagal mapping : Tidak ada kecocokan full_name setelah normalisasi"),null)},u=g=>{if(!g)return"";if(g instanceof Date&&!isNaN(g.getTime()))return g.toISOString().slice(0,10);let h=String(g).trim();if(/^\d{4,5}(\.\d+)?$/.test(h)){let k=Math.floor(Number(h));if(k>2e4&&k<99999){let C=new Date(Date.UTC(1899,11,30)+k*864e5);return isNaN(C.getTime())?"":C.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(h))return h.slice(0,10);let y=h.split(/[\/\-\.]/);if(y.length===3){let[k,C,x]=y.map(w=>w.trim());if(k.length===4&&C.length<=2&&x.length<=2)return`${k}-${C.padStart(2,"0")}-${x.padStart(2,"0")}`;if(x.length===4&&C.length<=2&&k.length<=2)return`${x}-${C.padStart(2,"0")}-${k.padStart(2,"0")}`}return h},c=a.map((g,h)=>{let y=h+2,k=String(g["Nama Lengkap"]||"").trim(),C=g["Tanggal Mulai"],x=u(C);if(!x){let F=a.__worksheet,E=a.__headers||[],R=E.indexOf("Tanggal Mulai"),O="N/A",ye="N/A",pe="N/A";if(R!==-1&&F&&window.XLSX){let v=window.XLSX.utils.encode_cell({c:R,r:y-1});pe=v;let f=F[v];f?(O=f.t||"undefined",ye=f.w||"undefined"):O="CELL KOSONG/TIDAK ADA DI WORKSHEET"}let fe="Unknown";C==null||C===""?fe="Kondisi IF: Nilai murni undefined, null, atau string kosong dari parsed JSON.":C instanceof Date&&isNaN(C.getTime())?fe="Kondisi IF: Nilai adalah object Date namun invalid (isNaN).":fe="Kondisi IF: Tidak lolos Regex YYYY-MM-DD maupun konversi serial number Excel.",console.log("=========================="),console.log("[DEBUG] DATE PARSING FAILED"),console.log("=========================="),console.log(`Excel Row Number : ${y}`),console.log(`Employee Name : ${k}`),console.log(`Column Header Used : "Tanggal Mulai" (Index: ${R})`),console.log(`Raw Cell Value : "${C}"`),console.log(`JavaScript Type : ${typeof C}`),console.log(`SheetJS Cell Type : ${O}`),console.log(`SheetJS Formatted Value : "${ye}"`),console.log(`Value After Trim : "${String(C||"").trim()}"`),console.log(`Value After Date Parser : "${x}"`),console.log(`Is Empty : ${!C}`),console.log(`Is Invalid Date : ${C instanceof Date?isNaN(C.getTime()):"Bukan JS Date Object"}`),console.log(`Reason : ${fe}`),console.log(`Workbook Sheet : ${F?"Ada":"Tidak Ditemukan"}`),console.log(`Excel Cell Address : ${pe}`),console.log(`
...
`)}let w=d(k,y),_=null;return w||(_="Karyawan tidak ditemukan di Database"),{isValid:!!w,invalidReason:_,rowNum:y,data:{employee_id:w,branch_id:n(String(g.Cabang||"").trim()),division:String(g["Div / Bagian"]||"").trim()||"FACILITY CARE",start_date:x,end_date:u(g["Tanggal Selesai"])||"2099-12-31",status:String(g.Status||"").trim(),_rawName:k}}}),p=[],m=[];if(c.forEach(g=>{g.isValid?p.push(g.data):m.push({rowNum:g.rowNum,name:g.data._rawName,reason:g.invalidReason})}),console.log(`Split Validation - Valid: ${p.length}, Invalid: ${m.length}`),p.length===0)return{inserted:0,skipped:a.length,failed:a.length};let b=await S("/api/import/contracts",{method:"POST",body:JSON.stringify({rows:p,onDuplicate:"update"})});if(!b.ok)throw new Error(b.data?.error||"Import gagal");return b.data}}})}M();K();var gt=[],Re=[];function $a(t){if(!Array.isArray(t))return"Q3";let e=["Q4","Q3","Q2","Q1"];for(let i of e)if(t.some(a=>a.period===i))return i;return"Q3"}function Da(t,e){if(t.period!=="Q3")return!1;let i=String(t.status||"").toLowerCase();if(i!=="selesai"&&i!=="completed"&&i!=="done")return!1;let a=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?a.includes("inspeksi"):e==="gcdc"?a.includes("general cleaning")||a.includes("deep cleaning"):!1}async function Nt(t,e){gt=await H();let i=await ee(),l=(await S(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`)).data?.data||[],o=new Set;l.forEach(c=>{c.pic&&c.pic.trim()&&o.add(c.pic.trim())}),Re=Array.from(o).sort();let r=c=>c&&!Re.find(p=>(typeof p=="object"?p.value:p)===c)?[...Re,c]:Re,s=c=>{if(!c||c==="-"||String(c).trim()==="")return"";let p=String(c).split("-");return p.length===3&&p[0].length===4?`${p[2]}-${p[1]}-${p[0]}`:c},d=$a(l),u=e?e.get("dash_filter"):null;B({container:t,title:"Jadwal Kegiatan",icon:"\u{1F4C5}",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",paginationMode:"client",defaultFilters:u?{period:"Q3"}:{period:d},onDataLoaded:c=>(u&&(c=c.filter(p=>Da(p,u))),c.sort((p,m)=>{let b=p.opening_date?new Date(p.opening_date).getTime():0;return(m.opening_date?new Date(m.opening_date).getTime():0)-b})),columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:c=>st(c)},{key:"period",label:"Periode",render:c=>oe(c)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:c=>s(c)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:c=>s(c)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:c=>s(c)},{key:"status",label:"Status",render:c=>j(c)}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:gt},{type:"select",name:"activity_type",label:"Kegiatan",options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"]},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"select",name:"pic",label:"PIC",options:Re}],formFields:c=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:gt,value:c?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"],value:c?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:c?.period},{name:"pic",label:"PIC",type:"combobox",options:r(c?.pic),value:c?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:c?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:c?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:c?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:c?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:c?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let c=await S(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`);if(c.ok){let p=c.data.data.map(m=>({Cabang:m.branch_name||"",Kegiatan:m.activity_type||"",Periode:m.period||"",PIC:m.pic||"","Tgl Opening":m.opening_date||"","Tgl Target":m.target_date||"","Tgl Selesai":m.completion_date||"",Status:m.status||""}));L(p,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{L([{Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done"}],"Template_Import_Jadwal")},onImport:async c=>{let m=(await S("/api/branches?all=1")).data?.data||[],b=k=>{if(!k)return null;let C=String(k||"").toLowerCase(),x=m.find(w=>String(w.full_name||"").toLowerCase()===C||String(w.code||"").toLowerCase()===C||String(w.name||"").toLowerCase()===C);return x?x.id:null},g=k=>{if(k==null||k==="")return"";if(k instanceof Date&&!isNaN(k.getTime()))return k.toISOString().slice(0,10);let C=String(k).trim();if(C===""||C==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(C))return C.slice(0,10);if(/^\d{4,5}$/.test(C)){let w=Number(C);if(w>2e4&&w<99999){let _=new Date(Date.UTC(1899,11,30)+w*864e5);return isNaN(_.getTime())?"":_.toISOString().slice(0,10)}}let x=C.split(/[\/\-\.]/);if(x.length===3){let[w,_,F]=x.map(E=>E.trim());if(w.length===4&&_.length<=2&&F.length<=2)return`${w}-${_.padStart(2,"0")}-${F.padStart(2,"0")}`;if(F.length===4&&_.length<=2&&w.length<=2)return`${F}-${_.padStart(2,"0")}-${w.padStart(2,"0")}`}return C},h=c.map(k=>({branch_id:b(String(k.Cabang||"").trim()),activity_type:String(k.Kegiatan||"").trim(),period:String(k.Periode||"").trim(),pic:String(k.PIC||k.Pic||"").trim(),opening_date:g(k["Tgl Opening"]||k["Tanggal Opening"]||k["Tgl Openir"]),target_date:g(k["Tgl Target"]||k["Tanggal Target"]),completion_date:g(k["Tgl Selesai"]||k["Tanggal Selesai"]),status:String(k.Status||"").trim(),notes:String(k.Catatan||k.Keterangan||"").trim()})).filter(k=>k.activity_type&&k.period),y=await S("/api/import/schedule",{method:"POST",body:JSON.stringify({rows:h,onDuplicate:"update"})});if(!y.ok)throw new Error(y.data?.error||"Import gagal");return y.data}}})}M();K();var bt=[],We=[];function Ia(t,e){let i=String(t.status||"").toLowerCase();return e==="open"?i==="open":!1}async function At(t,e){let i=e?e.get("dash_filter"):null;bt=await H(),We=await ee();let a=r=>r&&!We.find(s=>s.value===r)?[...We,{value:r,label:r}]:We,l=new Date().getFullYear();B({container:t,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,itemLabel:"Permasalahan",paginationMode:"client",onDataLoaded:r=>i?r.filter(s=>Ia(s,i)):r,columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:r=>window.formatDate(r)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:r=>`<span class="badge badge-secondary">${r}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:r=>`<span title="${r}">${r?.length>50?r.slice(0,50)+"\u2026":r}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:r=>`<span title="${r||""}">${r?.length>40?r.slice(0,40)+"\u2026":r||"-"}</span>`},{key:"status",label:"Status",render:r=>j(r)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:r=>window.formatDate(r)},{key:"day_count",label:"Hari",render:r=>r??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"select",name:"branch_id",label:"Cabang",options:bt},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:["2025","2026","2027","2028","2029","2030"]}],formFields:r=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:r?.report_date},{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:bt,value:r?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:r?.category},{name:"source",label:"Sumber Laporan",type:"combobox",options:["SPV","AM","RCP","Perawat","FC","Berlin","Ade","Pattrel","Dentrel"],value:r?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:r?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"combobox",options:a(r?.employee_name),value:r?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"combobox",options:a(r?.fc_specialist),value:r?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:r?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:r?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:r?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let r=await S(`/api/issues${window.location.search?window.location.search+"&":"?"}limit=10000`);if(r.ok){let s=r.data.data.map(n=>({Tanggal:n.report_date||"",Cabang:n.branch_name||"",Kategori:n.category||"",Sumber:n.source||"",Keluhan:n.complaint||"","Nama FC":n.employee_name||"","FC Spesialis":n.fc_specialist||"",Solusi:n.solution||"","Tgl Selesai":n.completion_date||"",Status:n.status||""}));L(s,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{L([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async r=>{let n=(await S("/api/branches?all=1")).data?.data||[],d=p=>{if(!p)return null;let m=String(p||"").toLowerCase(),b=n.find(g=>String(g.full_name||"").toLowerCase()===m||String(g.code||"").toLowerCase()===m||String(g.name||"").toLowerCase()===m);return b?b.id:null},u=r.map(p=>({branch_id:d(String(p.Cabang||"").trim()),report_date:String(p.Tanggal||"").trim(),category:String(p.Kategori||"").trim(),source:String(p.Sumber||"").trim(),complaint:String(p.Keluhan||"").trim(),employee_name:String(p["Nama FC"]||"").trim(),fc_specialist:String(p["FC Spesialis"]||"").trim(),solution:String(p.Solusi||"").trim(),completion_date:String(p["Tgl Selesai"]||"").trim(),status:String(p.Status||"").trim()})).filter(p=>p.report_date&&p.complaint&&p.category),c=await S("/api/import/issues",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}}})}M();var Te=[];function Pa(t,e){let i=String(t.status||"").toLowerCase();return e==="pending"?i==="pending":!1}async function Ft(t,e){let i=e?e.get("dash_filter"):null;Te=await H();let a=await ee(),l=["Ade","Berlin"],o=s=>s&&!a.find(n=>n.value===s)?[...a,{value:s,label:s}]:a,r=s=>s&&!l.find(n=>(typeof n=="object"?n.value:n)===s)?[...l,s]:l;B({container:t,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,itemLabel:"One on One",paginationMode:"client",onDataLoaded:s=>i?s.filter(n=>Pa(n,i)):s,columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:s=>window.formatDate(s)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:s=>`<span title="${s||""}">${s?.length>50?s.slice(0,50)+"\u2026":s||"-"}</span>`},{key:"solution",label:"Solusi",render:s=>`<span title="${s||""}">${s?.length>40?s.slice(0,40)+"\u2026":s||"-"}</span>`},{key:"status",label:"Status",render:s=>j(s)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:s=>window.formatDate(s)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:s=>s?`<a href="${s}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"combobox",name:"branch_id",label:"Cabang",options:Te},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async s=>{let n=new URLSearchParams(s||{}).toString(),d=await S(`/api/one-on-one?limit=10000&${n}`);if(d.ok){let u=d.data.data.map(p=>({Tanggal:p.meeting_date||"",Cabang:p.branch_name||"","Nama Karyawan":p.employee_name||"",PIC:p.pic||"",Masalah:p.problem||"",Solusi:p.solution||"",Status:p.status||"","Tgl Selesai":p.completion_date||"",Dokumen:p.document_link||""})),{downloadExcel:c}=await Promise.resolve().then(()=>(K(),re));c(u,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let s=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(K(),re));n(s,"Template_Import_OneOnOne")},onImport:async s=>{let n=p=>{if(!p)return null;let m=String(p||"").toLowerCase(),b=Te.find(g=>String(g.label||"").toLowerCase()===m);return b?b.value:null},d=p=>{if(!p)return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let m=String(p).trim();if(/^\d{4,5}$/.test(m)){let g=Number(m);if(g>2e4&&g<99999){let h=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(h.getTime())?"":h.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(m))return m.slice(0,10);let b=m.split(/[\/\-\.]/);if(b.length===3){let[g,h,y]=b.map(k=>k.trim());if(g.length===4&&h.length<=2&&y.length<=2)return`${g}-${h.padStart(2,"0")}-${y.padStart(2,"0")}`;if(y.length===4&&h.length<=2&&g.length<=2)return`${y}-${h.padStart(2,"0")}-${g.padStart(2,"0")}`}return m},u=s.map(p=>({meeting_date:d(p.Tanggal),employee_name:String(p["Nama Karyawan"]||"").trim(),branch_id:n(String(p.Cabang||"").trim()),pic:String(p.PIC||"").trim(),problem:String(p.Masalah||"").trim(),solution:String(p.Solusi||"").trim(),status:String(p.Status||"").trim(),completion_date:d(p["Tgl Selesai"]),document_link:String(p.Dokumen||"").trim()})).filter(p=>p.meeting_date&&p.employee_name&&p.branch_id),c=await S("/api/import/one_on_one",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}},formFields:s=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:s?.meeting_date},{name:"branch_id",label:"Cabang",type:"combobox",options:s?.branch_id&&!Te.find(n=>n.value==s.branch_id)?[...Te,{value:s.branch_id,label:s.branch_name||s.branch_id}]:Te,createApi:{path:"/api/branches",field:"full_name"},value:s?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"combobox",required:!0,options:o(s?.employee_name),value:s?.employee_name},{name:"pic",label:"PIC",type:"combobox",options:r(s?.pic),createApi:{path:"/api/pic",field:"name"},value:s?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:s?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:s?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:s?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:s?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:s?.document_link}]})}M();async function Mt(t){let e=await H(),i=await ee(),a=["Ade","Berlin"],l=s=>s&&!i.find(n=>n.value===s)?[...i,{value:s,label:s}]:i,o=s=>s&&!a.find(n=>(typeof n=="object"?n.value:n)===s)?[...a,s]:a,r=Array.from({length:5},(s,n)=>String(new Date().getFullYear()-n));B({container:t,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:s=>window.formatDate(s)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:s=>{try{let n=JSON.parse(s);return Array.isArray(n)?n.join(", "):s||"-"}catch{return s||"-"}}},{key:"score",label:"Nilai",render:s=>s!=null?`<strong>${s}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:s=>s?`<a href="${s}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer..."},{type:"select",name:"year",label:"Tahun",options:r}],exportOptions:{moduleName:"training",onExport:async s=>{let n=new URLSearchParams(s||{}).toString(),d=await S(`/api/training?limit=10000&${n}`);if(d.ok){let u=d.data.data.map(p=>{let m=p.participants||"";try{let b=JSON.parse(m);m=Array.isArray(b)?b.join(", "):m}catch{}return{Tanggal:p.training_date||"",Batch:p.batch||"",Materi:p.subject||"",Cabang:p.branch_name||"",Trainer:p.trainer||"",Peserta:m,Nilai:p.score!==null&&p.score!==void 0?p.score:"",Dokumen:p.document_link||""}}),{downloadExcel:c}=await Promise.resolve().then(()=>(K(),re));c(u,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let s=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(K(),re));n(s,"Template_Import_Training")},onImport:async s=>{let n=p=>{if(!p)return null;let m=String(p||"").toLowerCase(),b=e.find(g=>String(g.label||"").toLowerCase()===m);return b?b.value:null},d=p=>{if(!p)return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let m=String(p).trim();if(/^\d{4,5}$/.test(m)){let g=Number(m);if(g>2e4&&g<99999){let h=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(h.getTime())?"":h.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(m))return m.slice(0,10);let b=m.split(/[\/\-\.]/);if(b.length===3){let[g,h,y]=b.map(k=>k.trim());if(g.length===4&&h.length<=2&&y.length<=2)return`${g}-${h.padStart(2,"0")}-${y.padStart(2,"0")}`;if(y.length===4&&h.length<=2&&g.length<=2)return`${y}-${h.padStart(2,"0")}-${g.padStart(2,"0")}`}return m},u=s.map(p=>({training_date:d(p.Tanggal),batch:String(p.Batch||"").trim(),subject:String(p.Materi||"").trim(),branch_id:n(String(p.Cabang||"").trim()),trainer:String(p.Trainer||"").trim(),participants:String(p.Peserta||"").trim(),score:p.Nilai?Number(p.Nilai):null,document_link:String(p.Dokumen||"").trim()})).filter(p=>p.training_date&&p.subject&&p.branch_id),c=await S("/api/import/training",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}},formFields:s=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:s?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:s?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:s?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",options:e,value:s?.branch_id},{name:"trainer",label:"Trainer",type:"combobox",options:o(s?.trainer),value:s?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let n=JSON.parse(s?.participants);return Array.isArray(n)?n.join(", "):s?.participants||""}catch{return s?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:s?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:s?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:s?.notes}],onBeforeSubmit:async s=>(s.participants&&(s.participants=JSON.stringify(s.participants.split(",").map(n=>n.trim()).filter(Boolean))),s)})}M();he();K();function Ot({container:t,title:e,icon:i,apiPath:a,columns:l,formFields:o,filterFields:r,defaultFilters:s={},itemLabel:n="Data",canCreate:d=!0,canEdit:u=!0,canDelete:c=!0,onBeforeSubmit:p,onAfterLoad:m,onDataLoaded:b,extraActions:g=[],initialSearch:h="",exportOptions:y=null,bulkDelete:k=!1,paginationMode:C="server"}){let x=1,w={...s};h&&(w.search=h);let _=new Set;t.innerHTML=`
    <div class="page-header">
      <h1 class="page-title">${i} ${e}</h1>
      <div class="page-actions">
        ${d?`<button class="btn btn-primary" id="btn-create">+ Tambah ${n}</button>`:""}
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),l()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),l()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.querySelectorAll(".cal-filter").forEach(o=>o.addEventListener("change",l));async function a(){try{let o=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`;i=(await S(`/api/dashboard/calendar?month=${o}`)).data?.data||[]}catch(o){console.warn("[Calendar] Failed to load events, rendering empty grid:",o),i=[]}}async function l(){let o=document.getElementById("calendar-grid");if(o){o.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
      ${Array(35).fill('<div style="background:#f8fafc;min-height:70px;"></div>').join("")}
          ...
          </div>`}let C=(m+b)%7;if(C!==0)for(let x=0;x<7-C;x++)y+='<div class="cal-cell cal-cell-empty"></div>';y+="</div>",o.innerHTML=y,o.querySelectorAll(".cal-cell[data-date]").forEach(x=>{x.addEventListener("click",()=>{let w=x.dataset.date,_=p[w]||[];if(!_.length)return;let F=document.getElementById("cal-event-list"),E=new Date(w+"T00:00:00").toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});document.getElementById("cal-event-date").textContent=E,document.getElementById("cal-event-items").innerHTML=_.map(R=>`
            <div class="cal-event-item cal-color-border-${R.color||"gray"}">
              <div class="cal-event-type">${Aa(R.type)}</div>
              <div class="cal-event-title">${Ye(R.title||"-")}</div>
              <div class="cal-event-branch">${Ye(R.branch_name||"")}</div>
              ${R.status?`<div class="cal-event-status">${Ye(R.status)}</div>`:""}
              ${R.days_remaining!==void 0?`<div class="cal-event-extra">Sisa: ${R.days_remaining} hari</div>`:""}
            </div>
          `).join(""),F.style.display="block"})})}catch(r){console.error("[Calendar] Render error:",r),o&&(o.innerHTML=`
          <div style="padding:40px;text-align:center;color:var(--text-3)">
            <div style="font-size:2rem;margin-bottom:8px">\u{1F4C5}</div>
            <div>Gagal memuat kalender. Silakan refresh.</div>
          </div>`)}}}l()}function Na(t,e){return t?t.length>e?t.slice(0,e)+"\u2026":t:""}function Ye(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function Aa(t){return{schedule:"\u{1F5D3} Jadwal",issue:"\u26A0\uFE0F Permasalahan",reliever:"\u{1F504} Reliefer",training:"\u{1F393} Training",contract_expiry:"\u{1F4CB} Kontrak Habis"}[t]||t}M();async function Vt(t){let e=be(),i=(e?.full_name||e?.username||"U")[0].toUpperCase(),l={superadmin:"#7C3AED",admin:"#2563EB",manager:"#0891B2",spv:"#059669",viewer:"#64748B"}[e?.role]||"#64748B";t.innerHTML=`
    <div class="page-header">
  ...
  `;let e=null,i=null,a=0,l={upload:document.getElementById("step-upload"),validating:document.getElementById("step-validating"),preview:document.getElementById("step-preview"),importing:document.getElementById("step-importing"),summary:document.getElementById("step-summary")};function o(g){Object.entries(l).forEach(([h,y])=>{y.style.display=h===g?"":"none"})}document.getElementById("btn-backup-db")?.addEventListener("click",async()=>{let g=document.getElementById("btn-backup-db");g.disabled=!0,g.textContent="\u23F3 Memproses Backup...";try{let h=await S("/api/import/backup");if(h.ok){if(!window.XLSX){G("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");return}let y=window.XLSX,k=y.utils.book_new();Object.entries(h.data.database).forEach(([C,x])=>{let w=x.length>0?x:[{}],_=y.utils.json_to_sheet(w);y.utils.book_append_sheet(k,_,C.substring(0,31))}),y.writeFile(k,`FCMS_Database_Backup_${new Date().toISOString().slice(0,10)}.xlsx`),Z("Backup berhasil diunduh!")}else G("Gagal memproses backup: "+(h.data?.error||"Unknown error"))}catch(h){G("Gagal memproses backup: "+h.message)}finally{g.disabled=!1,g.textContent="\u{1F4E6} Backup Database"}});let r=document.getElementById("btn-sync-google");r&&r.addEventListener("click",async()=>{if(!confirm("Peringatan: Mensinkronkan data dengan Google Sheets akan memperbarui dan menambahkan data baru dari Google Sheets ke dalam FCMS. Data yang sudah Anda buat di FCMS TIDAK akan terhapus. Lanjutkan?"))return;let g=r.innerHTML;r.innerHTML='<span class="spinner"></span> Menyinkronkan...',r.disabled=!0;try{let h=await S("/api/sync/google-sheets",{method:"POST"});h.ok?alert("Sinkronisasi Berhasil: "+(h.data?.message||"Data Karyawan & PIC telah diperbarui.")):alert("Gagal Sinkronisasi: "+(h.data?.error||"Unknown error"))}catch{alert("Terjadi kesalahan koneksi.")}finally{r.innerHTML=g,r.disabled=!1}}),document.getElementById("btn-download-template").addEventListener("click",()=>{Xt(),Z("Template Excel berhasil didownload!")});let s=document.getElementById("file-input"),n=document.getElementById("upload-zone");document.getElementById("btn-browse").addEventListener("click",g=>{g.stopPropagation(),s.click()}),s.addEventListener("change",g=>{g.target.files[0]&&d(g.target.files[0])}),n.addEventListener("dragover",g=>{g.preventDefault(),n.classList.add("drag-over")}),n.addEventListener("dragleave",()=>n.classList.remove("drag-over")),n.addEventListener("drop",g=>{g.preventDefault(),n.classList.remove("drag-over");let h=g.dataTransfer.files[0];h&&h.name.match(/\.xlsx?$/i)?d(h):G("Hanya file .xlsx atau .xls yang didukung.")}),document.getElementById("btn-clear-file").addEventListener("click",()=>{e=null,s.value="",document.getElementById("file-info").style.display="none",n.style.display="",o("upload")});async function d(g){e=g,document.getElementById("file-name-display").textContent=`\u{1F4C4} ${g.name} (${(g.size/1024).toFixed(1)} KB)`,document.getElementById("file-info").style.display="flex",n.style.display="none",await u(g)}async function u(g){o("validating");let h=document.getElementById("validation-status"),y=document.getElementById("validation-bar");try{if(!window.XLSX)throw new Error("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");h.textContent="Membaca file Excel...",y.style.width="20%",await Ke(200);let k=await g.arrayBuffer(),C=window.XLSX.read(k,{type:"array",cellDates:!0});h.textContent=`Memvalidasi ${C.SheetNames.length} sheet...`,y.style.width="50%",await Ke(100),i=Yt(C),y.style.width="100%",h.textContent="Validasi selesai!",await Ke(300),c()}catch(k){o("upload"),G("Gagal memproses file: "+k.message),document.getElementById("file-info").style.display="flex",n.style.display="none"}}function c(){o("preview");let g=i.filter(E=>!E.skipped).length,h=i.reduce((E,R)=>E+R.total,0),y=i.reduce((E,R)=>E+R.valid,0),k=i.reduce((E,R)=>E+R.errorCount,0),C=h>0?Math.round(y/h*100):0;document.getElementById("preview-summary-badges").innerHTML=`
    ...
    `,x.querySelectorAll(".btn-detail-error").forEach(E=>{E.addEventListener("click",()=>{let R=i[Number(E.dataset.idx)];p(R)})});let w=document.getElementById("error-detail-section"),_=document.getElementById("error-detail-container");_.innerHTML="",w.style.display="none";let F=document.getElementById("btn-start-import");y===0?(F.disabled=!0,F.innerHTML="\u26A0\uFE0F Tidak Ada Data Valid"):(F.disabled=!1,k>0?(F.innerHTML=`\u{1F680} Import ${y} Data Valid (${k} dilewati)`,F.title="Baris error akan dilewati, baris valid tetap diimport"):F.innerHTML=`\u{1F680} Mulai Import ${y} Data`)}function p(g){let h=document.getElementById("error-detail-section"),y=document.getElementById("error-detail-container");h.style.display="";let k=g.errors.slice(0,100).map(C=>(Array.isArray(C.errors)?C.errors:[]).map(w=>{let _=typeof w=="object";return`
          <tr>
    ...
    `,h.scrollIntoView({behavior:"smooth",block:"start"})}document.getElementById("btn-back-to-upload").addEventListener("click",()=>{o("upload"),document.getElementById("file-info").style.display="none",n.style.display="",e=null,s.value=""}),document.getElementById("btn-download-log").addEventListener("click",()=>{if(!i)return;Zt(i)?Z("Log error berhasil didownload."):Z("Tidak ada error untuk didownload.")}),document.getElementById("btn-start-import").addEventListener("click",()=>{let g=document.querySelector('input[name="dup-strategy"]:checked')?.value||"skip";m(g)});async function m(g){o("importing"),a=Date.now();let h=[];Oa.forEach(w=>{let _=i?.find(F=>F.module===w&&F.mapped?.length>0);_&&h.push(_)});let y=document.getElementById("import-steps-list");y.innerHTML=h.map(w=>`
    ...
    `).join("");let k=document.getElementById("import-bar"),C=document.getElementById("import-current-status"),x={totalSheets:h.length,totalRows:h.reduce((w,_)=>w+_.mapped.length,0),inserted:0,skipped:0,failed:0,moduleResults:[]};for(let w=0;w<h.length;w++){let _=h[w],F=document.getElementById(`step-icon-${_.module}`),E=document.getElementById(`step-status-${_.module}`);F.textContent="\u{1F504}",E.textContent="Mengimport...",C.textContent=`Mengimport ${_.label}...`,k.style.width=`${Math.round(w/h.length*100)}%`;try{let R=await S(`/api/import/${_.module}`,{method:"POST",body:JSON.stringify({rows:_.mapped,onDuplicate:g})});if(R.ok){let O=R.data;x.inserted+=O.inserted||0,x.skipped+=O.skipped||0,x.moduleResults.push({label:_.label,inserted:O.inserted||0,skipped:O.skipped||0,status:"ok"}),F.textContent="\u2705",E.innerHTML=`<span class="badge badge-success">${O.inserted||0} berhasil</span>${O.skipped>0?` <span class="badge badge-neutral">${O.skipped} skip</span>`:""}`}else x.failed++,x.moduleResults.push({label:_.label,inserted:0,skipped:0,status:"error",error:R.data?.error}),F.textContent="\u274C",E.innerHTML='<span class="badge badge-danger">Gagal</span>'}catch(R){x.failed++,x.moduleResults.push({label:_.label,inserted:0,skipped:0,status:"error",error:R.message}),F.textContent="\u274C",E.innerHTML='<span class="badge badge-danger">Gagal</span>'}await Ke(150)}k.style.width="100%",C.textContent="Selesai!",await Ke(400),b(x)}function b(g){o("summary");let h=((Date.now()-a)/1e3).toFixed(1),y=g.failed===0;document.getElementById("summary-status-icon").innerHTML=`
  ...
  `;let e=document.getElementById("btnRefreshSync"),i=document.getElementById("queueStatusFilter");e.addEventListener("click",l),i.addEventListener("change",s),document.getElementById("btnRetryAll").addEventListener("click",()=>a("retry",{allFailed:!0})),document.getElementById("btnResetStuck").addEventListener("click",()=>a("reset-stuck",{})),document.getElementById("btnPauseSync").addEventListener("click",()=>a("pause",{})),document.getElementById("btnResumeSync").addEventListener("click",()=>a("resume",{})),document.getElementById("btnReconcile").addEventListener("click",()=>a("reconcile",{module:"ALL",repairMode:!0})),document.getElementById("btnRetrySelected").addEventListener("click",()=>{let d=Array.from(document.querySelectorAll(".chk-queue:checked")).map(u=>u.value);if(d.length===0)return alert("No items selected");a("retry",{ids:d})}),document.getElementById("chkAllQueue").addEventListener("change",d=>{document.querySelectorAll(".chk-queue").forEach(u=>u.checked=d.target.checked)});async function a(d,u){if(confirm(`Are you sure you want to execute action: ${d}?`)){showLoading();try{let c=await S(`/api/sync/actions/${d}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(u)});c.ok?(alert(c.data?.message||"Success"),l()):G(c.error||"Action failed")}catch(c){G(c.message)}hideLoading()}}await l();async function l(){showLoading(),await Promise.all([r(),s(),o(),n()]),hideLoading()}async function o(){try{let d=await S("/api/sync/performance");if(!d.ok)return;let{webhook:u,google_api:c,d1:p,queue:m,throughput:b}=d.data;document.getElementById("latencyHistograms").innerHTML=`
      ...
      `;document.getElementById("syncOverviewCards").innerHTML=m;let b=document.getElementById("cbStateBadge"),g=document.getElementById("cbStateDesc"),h=document.getElementById("cbStatusCard");h.className="bg-white rounded-lg shadow p-6 border-l-4",p==="CLOSED"?(b.className="px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800",b.textContent="CLOSED",g.textContent="Traffic is flowing normally to Google Sheets.",h.classList.add("border-green-500")):p==="OPEN"?(b.className="px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800",b.textContent="OPEN",g.textContent="Failing fast. Traffic to Google Sheets is paused due to repeated failures.",h.classList.add("border-red-500")):p==="HALF_OPEN"?(b.className="px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",b.textContent="HALF-OPEN",g.textContent="Testing recovery. Permitting limited traffic to verify stability.",h.classList.add("border-yellow-500")):b.textContent=p||"UNKNOWN"}catch(d){console.error(d)}}async function s(){try{let d=document.getElementById("queueStatusFilter").value,u=await S("/api/sync/queue?limit=15"+(d?"&status="+d:""));if(!u.ok)return;let c=document.getElementById("queueTableBody"),p=u.data?.data||u.data||[];if(p.length===0){c.innerHTML='<tr><td colspan="6" class="px-4 py-4 text-center text-gray-500">No events found</td></tr>';return}c.innerHTML=p.map(m=>`
      ...
      `).join("")}catch(d){console.error(d)}}async function n(){try{let d=await S("/api/sync/metrics");if(!d.ok)return;let u=document.getElementById("metricsTableBody"),c=d.data||[];if(c.length===0){u.innerHTML='<tr><td colspan="5" class="px-4 py-4 text-center text-gray-500">No metrics found in last 24h</td></tr>';return}u.innerHTML=c.map(p=>`
        <tr class="hover:bg-gray-50">
  ...
  `;let i=document.getElementById("sidebar"),a=document.getElementById("sidebar-overlay"),l=document.getElementById("topbar-menu-btn"),o=document.getElementById("sidebar-close"),r=()=>{i.classList.add("open"),a.classList.add("show")},s=()=>{i.classList.remove("open"),a.classList.remove("show")};l?.addEventListener("click",r),o?.addEventListener("click",s),a?.addEventListener("click",s),document.querySelectorAll(".nav-item").forEach(d=>d.addEventListener("click",s));function n(){let d=window.location.hash.replace("#","")||"/dashboard";document.querySelectorAll(".nav-item").forEach(p=>{let m=p.dataset.route;p.classList.toggle("active",d===m||m!=="/dashboard"&&d.startsWith(m))});let u=document.getElementById("topbar-title"),c=document.querySelector(".nav-item.active .nav-label");u&&c&&(u.textContent=c.textContent)}window.addEventListener("hashchange",n),n(),Ra(),document.getElementById("btn-fullscreen")?.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.()}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await S("/api/auth/logout",{method:"POST"}),Pe(),He&&clearInterval(He),ke("/login")}),Ka(),Ha(),document.getElementById("btn-notif")?.addEventListener("click",d=>{d.preventDefault(),qa()})}async function ja(){J("/login",({main:e})=>It(e)),J("/dashboard",Q(({main:e})=>Tt(e))),J("/calendar",Q(({main:e})=>zt(e))),J("/employees",Q(({main:e,params:i})=>Pt(e,i))),J("/contracts",Q(({main:e,params:i})=>Bt(e,i))),J("/sp",Q(({main:e})=>aa(e))),J("/mutasi",Q(({main:e})=>ia(e))),J("/sync-dashboard",Q(({main:e})=>ra(e))),J("/timeline",Q(({main:e,params:i})=>Nt(e,i))),J("/issues",Q(({main:e,params:i})=>At(e,i))),J("/one-on-one",Q(({main:e,params:i})=>Ft(e,i))),J("/training",Q(({main:e})=>Mt(e))),J("/relievers",Q(({main:e,params:i})=>Rt(e,i))),J("/reports/inspection",Q(({main:e})=>Kt(e))),J("/reports/cleaning",Q(({main:e})=>Ht(e))),J("/reports/fogging",Q(({main:e})=>qt(e))),J("/reports/basecamp",Q(({main:e})=>jt(e))),J("/reports/supply",Q(({main:e})=>ht(e,"supply"))),J("/sop",Q(({main:e})=>Jt(e))),J("/checklist",Q(({main:e})=>Ut(e))),J("/forms",Q(({main:e})=>ht(e))),J("/users",Q(({main:e})=>Gt(e))),J("/branches",Q(({main:e})=>Qt(e))),J("/profile",Q(({main:e})=>Vt(e))),J("/settings/import",Q(({main:e})=>ea(e)));let t=Ie();if(!t&&window.location.hash!=="#/login"&&ke("/login"),t){let e=await S("/api/auth/me");e.ok?(Le(e.data.data),sa()):(Pe(),ke("/login"))}window.addEventListener("fm:login",()=>{sa(),ke("/dashboard")}),ft()}ja();
