var it=Object.defineProperty;var Ge=(a,e)=>()=>(a&&(e=a(a=0)),e);var Qe=(a,e)=>{for(var r in e)it(a,r,{get:e[r],enumerable:!0})};var de={};Qe(de,{API:()=>ga,CLIENT_SIDE_MAX_ROWS:()=>_e,IS_DEVELOPMENT:()=>Ne,apiFetch:()=>f,clearToken:()=>Ce,getToken:()=>xe,getUser:()=>oe,setToken:()=>Ve,setUser:()=>Te});function xe(){return localStorage.getItem("fm_token")}function Ve(a){localStorage.setItem("fm_token",a)}function Ce(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function oe(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Te(a){localStorage.setItem("fm_user",JSON.stringify(a))}async function f(a,e={}){let r=xe(),t={"Content-Type":"application/json",...r?{Authorization:`Bearer ${r}`}:{},...e.headers||{}};try{let o=`cb=${Date.now()}`,l=a.includes("?")?"&":"?",n=`${ga}${a}${l}${o}`,s=await fetch(n,{...e,headers:t}),i;try{let d=await s.text();try{i=JSON.parse(d)}catch{i={error:`Server Error (${s.status}): ${d.substring(0,80)}...`}}}catch{i={error:"Gagal membaca respon dari server"}}return s.status===401&&(Ce(),window.location.hash="#/login"),{ok:s.ok,status:s.status,data:i}}catch(o){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${o.message})`}}}}var Ne,rt,ga,_e,D=Ge(()=>{Ne=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1",rt=Ne?"http://localhost:8787":"",ga=rt,_e=1e4});var ya={};Qe(ya,{confirmDialog:()=>Ye,createModal:()=>te});function te({title:a,content:e,onConfirm:r,onCancel:t,confirmText:o="Simpan",cancelText:l="Batal",size:n="md",confirmClass:s="btn-primary"}){let i={sm:"400px",md:"560px",lg:"720px",xl:"900px"},d=document.createElement("div");d.className="modal-overlay",d.innerHTML=`
  ...
  </div>`).join("");function ra(a=3){return Array(a).fill(0).map((e,r)=>`<div class="skeleton skeleton-text" style="height:38px;margin-bottom:${r<a-1?"6px":"0"};border-radius:6px"></div>`).join("")}async function X(a,e,r=8e3){try{let t=new AbortController,o=setTimeout(()=>t.abort(),r),l=await f(a,{signal:t.signal}).catch(()=>null);if(clearTimeout(o),!l||!l.ok)return e;let n=l.data;return n?n.data!==void 0?n.data??e:n:e}catch{return e}}function gt(){["skel-donut","skel-trend","skel-insp","skel-contract"].forEach(t=>{let o=document.getElementById(t);o&&(o.style.display="none")}),["chart-donut","chart-trend","chart-insp","chart-contract"].forEach(t=>{let o=document.getElementById(t);if(o&&o.style.display==="none"){o.style.display="block";let l=o.parentElement;if(l&&!l.querySelector(".chart-empty")){let n=document.createElement("div");n.className="chart-empty",n.textContent="Belum ada data",o.style.display="none",l.appendChild(n)}}});let a=document.getElementById("kpi-row");a&&a.querySelector(".skeleton")&&$a({});let e=document.getElementById("mini-stats-row");e&&e.querySelector(".skeleton")&&Ea({}),["table-contracts","table-issues"].forEach(t=>{let o=document.getElementById(t);o&&o.querySelector(".skeleton")&&(o.innerHTML='<div class="chart-empty">Belum ada data</div>')});let r=document.getElementById("activity-log");r&&r.querySelector(".skeleton")&&(r.innerHTML='<div class="chart-empty">Belum ada aktivitas</div>')}async function Ta(a){ot(),a._dashRefresh&&clearInterval(a._dashRefresh),a._skelTimeout&&clearTimeout(a._skelTimeout),a.innerHTML=`
      ...
      ${r.map(t=>{let o="#3B82F6",l="#EFF6FF",n="Agenda",s=(t.title||"").toLowerCase();return s.includes("inspeksi")?(o="#10B981",l="#ECFDF5",n="Inspeksi"):s.includes("cleaning")||s.includes("gcdc")?(o="#3B82F6",l="#EFF6FF",n="Cleaning"):s.includes("reliefer")?(o="#F59E0B",l="#FFFBEB",n="Reliefer"):s.includes("fogging")&&(o="#8B5CF6",l="#F5F3FF",n="Fogging"),`
        <div style="display:flex;gap:16px;align-items:flex-start;padding-bottom:12px;border-bottom:1px solid var(--border)">
          ...
          <div style="flex:1">
            ...
            <div style="font-size:0.75rem;color:var(--text-3)">${be(t.branch_name)}</div>
          </div>
          <div style="font-size:0.7rem;font-weight:600;padding:2px 8px;border-radius:6px;background:${l};color:${o}">${n}</div>
        </div>
      `}).join("")}
    </div>
