      ...
      <div class="charts-row" style="grid-template-columns: 5fr 3fr 5fr;">
        ...
        <div class="chart-card" style="display:flex; flex-direction:column;">
          ...
          <div style="flex:1; display:flex; flex-direction:column; justify-content:center;">
            <div style="display:flex; align-items:center; justify-content:center; gap:0px; min-height:130px">
              <div class="chart-canvas-wrap" style="width:115px;height:115px;position:relative">
