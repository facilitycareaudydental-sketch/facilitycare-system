    ...
    <div class="dashboard-wrap" id="dash-root">
      ...
      <div class="charts-row" style="grid-template-columns: 4fr 3fr 4fr;">
        ...
        <div class="chart-card">
          ...
          <div class="chart-canvas-wrap" style="height:175px;position:relative;margin-top:10px">
        ...
        <div class="chart-card" style="display:flex; flex-direction:column;">
          ...
          <div style="flex:1; display:flex; flex-direction:column; justify-content:center;">
            <div style="display:flex; align-items:center; justify-content:center; gap:0px; min-height:160px">
              ...
              <div id="donut-legend" class="donut-legend" style="width:80px; margin-left:15px"></div>
            </div>
          </div>
