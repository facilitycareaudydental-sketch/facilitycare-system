var ca=Object.defineProperty;var ze=(t,e)=>()=>(t&&(e=t(t=0)),e);var We=(t,e)=>{for(var i in e)ca(t,i,{get:e[i],enumerable:!0})};var he={};We(he,{API:()=>yt,CLIENT_SIDE_MAX_ROWS:()=>$e,IS_DEVELOPMENT:()=>Ye,apiFetch:()=>v,clearToken:()=>De,getToken:()=>Ee,getUser:()=>ue,setToken:()=>Xe,setUser:()=>Ie});function Ee(){return localStorage.getItem("fm_token")}function Xe(t){localStorage.setItem("fm_token",t)}function De(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function ue(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Ie(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function v(t,e={}){let i=Ee(),a={"Content-Type":"application/json",...i?{Authorization:`Bearer ${i}`}:{},...e.headers||{}};try{let l=t;l.startsWith("/api/")&&!l.startsWith("/api/v1/")&&(l="/api/v1/"+l.substring(5));let c=`cb=${Date.now()}`,s=l.includes("?")?"&":"?",r=`${yt}${l}${s}${c}`,n=await fetch(r,{...e,headers:a}),o;try{let m=await n.text();try{o=JSON.parse(m)}catch{o={error:`Server Error (${n.status}): ${m.substring(0,80)}...`}}}catch{o={error:"Gagal membaca respon dari server"}}return n.status===401&&(De(),window.location.hash="#/login"),{ok:n.ok,status:n.status,data:o}}catch(l){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${l.message})`}}}}var Ye,da,yt,$e,I=ze(()=>{Ye=!1,da="https://fm-operations-api.facilitycare-audydental.workers.dev",yt=da,$e=1e4});var kt={};We(kt,{confirmDialog:()=>et,createModal:()=>se});function se({title:t,content:e,onConfirm:i,onCancel:a,confirmText:l="Simpan",cancelText:c="Batal",size:s="md",confirmClass:r="btn-primary"}){let n={sm:"400px",md:"560px",lg:"720px",xl:"900px"},o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
    <div class="modal" style="max-width:${n[s]||n.md}">
      ...
      <div class="modal-footer">
        ...
        ${i?`<button class="btn ${r} modal-confirm">${l}</button>`:""}
      </div>
    </div>
  `,e instanceof HTMLElement&&o.querySelector(".modal-body").appendChild(e);let m=()=>{o.classList.remove("show"),setTimeout(()=>o.remove(),250)};return o.querySelector(".modal-close").addEventListener("click",()=>{a&&a(),m()}),o.querySelector(".modal-cancel").addEventListener("click",()=>{a&&a(),m()}),i&&o.querySelector(".modal-confirm").addEventListener("click",()=>i(o,m)),o.addEventListener("click",p=>{p.target===o&&(a&&a(),m())}),document.body.appendChild(o),requestAnimationFrame(()=>o.classList.add("show")),{overlay:o,close:m}}function et(t,e,i="Konfirmasi"){return se({title:i,content:`<p>${t}</p>`,onConfirm:(a,l)=>{e(),l()},confirmText:"Ya, Lanjutkan",confirmClass:"btn-danger"})}var Be=ze(()=>{});var X={};We(X,{downloadExcel:()=>E,parseExcel:()=>at,renderExcelButtons:()=>nt});function at(t){return new Promise((e,i)=>{let a=new FileReader;a.onload=l=>{try{let c=new Uint8Array(l.target.result),s=XLSX.read(c,{type:"array"}),r=s.SheetNames[0],n=s.Sheets[r];console.log("--- START EXCEL PARSING ---"),console.log(`File Name: ${t.name}`),console.log(`File Size: ${(t.size/1024).toFixed(2)} KB`),console.log(`File Type: ${t.type||"unknown"}`),console.log(`Sheets Found: ${s.SheetNames.join(", ")}`),console.log(`Sheet Used: ${r}`);let o=XLSX.utils.decode_range(n["!ref"]||"A1:A1"),m=o.e.r-o.s.r+1,p=o.e.c-o.s.c+1;console.log(`Total Rows (including empty): ${m}`),console.log(`Total Columns: ${p}`);let d=[];for(let h=o.s.c;h<=o.e.c;++h){let b=n[XLSX.utils.encode_cell({c:h,r:o.s.r})];b&&b.v&&d.push(b.v)}console.log(`Headers Found: ${d.join(", ")}`),console.log("---------------------------");let g=XLSX.utils.sheet_to_json(n,{defval:""});Object.defineProperty(g,"__worksheet",{value:n,enumerable:!1}),Object.defineProperty(g,"__headers",{value:d,enumerable:!1}),e(g)}catch(c){i(c)}},a.onerror=l=>i(l),a.readAsArrayBuffer(t)})}function E(t,e){try{let i=XLSX.utils.json_to_sheet(t),a=XLSX.utils.book_new();XLSX.utils.book_append_sheet(a,i,"Data"),XLSX.writeFile(a,`${e}.xlsx`)}catch(i){throw console.error("Error generating Excel file:",i),i}}function nt(t){return`
  ...
  `}var L=ze(()=>{});I();var Ze={},Re=null;function M(t,e){Ze[t]=e}function ye(t){window.location.hash=t}function ft(){async function t(){let e=window.location.hash.replace("#","")||"/dashboard",[i,...a]=e.split("?"),l=Ze[i];if(!l){for(let[s,r]of Object.entries(Ze))if(s.endsWith("/*")&&i.startsWith(s.slice(0,-2))){l=r;break}}Re&&(Re(),Re=null);let c=document.getElementById("main-content");if(c&&(c.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),l){let s=new URLSearchParams(a.join("?")),r=i.split("/").filter(Boolean),n=await l({path:i,params:s,segments:r,main:c});n&&(Re=n)}else{let s=c||document.getElementById("app");s&&(s.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",t),t()}var Pe;function pa(){return Pe||(Pe=document.createElement("div"),Pe.id="toast-container",document.body.appendChild(Pe)),Pe}function vt(t,e="info",i=3500){let a=pa(),l=document.createElement("div");l.className=`toast toast-${e}`;let c={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};l.innerHTML=`<span class="toast-icon">${c[e]||"\u2139"}</span><span class="toast-msg">${t}</span>`,a.appendChild(l),requestAnimationFrame(()=>l.classList.add("show")),setTimeout(()=>{l.classList.remove("show"),setTimeout(()=>l.remove(),350)},i)}var V=t=>vt(t,"success"),W=t=>vt(t,"error");Be();I();I();function St({columns:t,data:e,onEdit:i,onDelete:a,onView:l,actions:c=[],emptyText:s="Tidak ada data",bulkSelect:r=null}){let n=document.createElement("div");if(n.className="table-wrapper",!e||e.length===0)return n.innerHTML=`<div class="empty-state"><p>${s}</p></div>`,n;let o=document.createElement("table");o.className="data-table";let m=document.createElement("thead"),p=document.createElement("tr");if(r){let g=document.createElement("th");g.style.width="40px",g.style.textAlign="center";let h=document.createElement("input");h.type="checkbox",h.id="select-all-checkbox",h.title="Pilih semua",h.addEventListener("change",()=>{e.forEach(b=>{h.checked?r.selectedIds.add(b.id):r.selectedIds.delete(b.id)}),n.querySelectorAll(".row-checkbox").forEach(b=>b.checked=h.checked),r.onToggle()}),g.appendChild(h),p.appendChild(g)}if(t.forEach(g=>{let h=document.createElement("th");h.textContent=g.label,g.width&&(h.style.width=g.width),p.appendChild(h)}),i||a||l||c.length>0){let g=document.createElement("th");g.textContent="Aksi",g.style.width="120px",p.appendChild(g)}m.appendChild(p),o.appendChild(m);let d=document.createElement("tbody");return e.forEach(g=>{let h=document.createElement("tr");if(r){let b=document.createElement("td");b.style.textAlign="center",b.style.width="40px";let u=document.createElement("input");u.type="checkbox",u.className="row-checkbox",u.value=g.id,u.checked=r.selectedIds.has(g.id),u.addEventListener("change",()=>{if(u.checked)r.selectedIds.add(g.id);else{r.selectedIds.delete(g.id);let y=document.getElementById("select-all-checkbox");y&&(y.checked=!1)}r.onToggle()}),b.appendChild(u),h.appendChild(b)}if(t.forEach(b=>{let u=document.createElement("td");if(b.render){let y=b.render(g[b.key],g);y instanceof HTMLElement?u.appendChild(y):u.innerHTML=y||""}else u.textContent=g[b.key]!==null&&g[b.key]!==void 0&&g[b.key]!==""?g[b.key]:"";b.nowrap&&(u.style.whiteSpace="nowrap"),h.appendChild(u)}),i||a||l||c.length>0){let b=document.createElement("td");b.className="actions-cell";let u=document.createElement("div");if(u.className="btn-group",l){let y=document.createElement("button");y.className="btn btn-xs btn-ghost",y.innerHTML="\u{1F441}",y.title="Lihat",y.addEventListener("click",()=>l(g)),u.appendChild(y)}if(i){let y=document.createElement("button");y.className="btn btn-xs btn-secondary",y.innerHTML="\u270F\uFE0F",y.title="Edit",y.addEventListener("click",()=>i(g)),u.appendChild(y)}c.forEach(y=>{let S=document.createElement("button");S.className=`btn btn-xs ${y.class||"btn-ghost"}`,S.innerHTML=y.icon||y.label,S.title=y.label,S.addEventListener("click",()=>y.handler(g)),u.appendChild(S)}),b.appendChild(u),h.appendChild(b)}d.appendChild(h)}),o.appendChild(d),n.appendChild(o),n}function wt({page:t,pages:e,total:i,limit:a,onPage:l}){if(e<=1)return null;let c=document.createElement("div");c.className="pagination";let s=document.createElement("span");s.className="pagination-info",s.textContent=`Total: ${i} data`,c.appendChild(s);let r=document.createElement("div");r.className="pagination-btns";let n=(p,d,g=!1,h=!1)=>{let b=document.createElement("button");b.className=`btn btn-sm ${h?"btn-primary":"btn-ghost"} pagination-btn`,b.textContent=p,b.disabled=g,b.addEventListener("click",()=>l(d)),r.appendChild(b)};n("\xAB",1,t===1),n("\u2039",t-1,t===1);let o=Math.max(1,t-2),m=Math.min(e,t+2);for(let p=o;p<=m;p++)n(p,p,!1,p===t);return n("\u203A",t+1,t===e),n("\xBB",e,t===e),c.appendChild(r),c}Be();function tt(t){return t.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="html")return e.html||"";if(e.type==="row")return`<div class="form-row">${tt(e.fields)}</div>`;let i=e.required?"required":"",a=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",l="";switch(e.type){case"textarea":l=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${i} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let s=(e.options||[]).map(p=>{let d=typeof p=="object"?p.value:p,g=typeof p=="object"?p.label:p,h=e.value==d?"selected":"";return`<option value="${d}" ${h}>${g}</option>`}).join("");l=`<select name="${e.name}" class="form-control" ${i}><option value="">-- Pilih ${e.label||""} --</option>${s}</select>`;break;case"combobox":let r=`dl-${e.name}-${Math.random().toString(36).substring(7)}`,n=(e.options||[]).map(p=>{let d=typeof p=="object"?p.value:p,g=typeof p=="object"?p.label||p.value||"":p||"";return(g==="undefined"||g==="[object Object]"||g==="null")&&(g=""),g?`<option value="${g}"></option>`:""}).join(""),o=e.value||"";if(e.value){let p=(e.options||[]).find(d=>(typeof d=="object"?d.value:d)==e.value);if(p){let d=typeof p=="object"?p.label||p.value||"":p||"";d&&d!=="undefined"&&d!=="[object Object]"&&d!=="null"&&(o=d)}}l=`
          <input type="text" name="${e.name}" list="${r}" class="form-control" value="${o}" placeholder="Pilih atau ketik baru..." ${i} autocomplete="off">
          <datalist id="${r}">${n}</datalist>
        `;break;case"checkbox":l=`<label class="checkbox-label"><input type="checkbox" name="${e.name}" value="1" ${e.value?"checked":""}> ${e.checkLabel||e.label}</label>`;break;case"date":let m=window.parseFlexibleDate&&e.value?window.parseFlexibleDate(e.value):e.value||"";l=`<input type="date" name="${e.name}" class="form-control" value="${m}" ${i}>`;break;case"number":l=`<input type="number" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" min="${e.min||""}" max="${e.max||""}" step="${e.step||"1"}" ${i}>`;break;case"email":l=`<input type="email" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${i}>`;break;case"url":l=`<input type="url" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||"https://..."}" ${i}>`;break;default:l=`<input type="${e.type||"text"}" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${i} autocomplete="off">`}let c=e.hint?`<div class="form-hint">${e.hint}</div>`:"";return`<div class="form-group ${e.class||""}">${a}${l}${c}</div>`}).join("")}function _t(t){let e={},i=new FormData(t);for(let[a,l]of i.entries())e[a]=l===""?null:l;return t.querySelectorAll("input[type=checkbox]").forEach(a=>{a.checked||(e[a.name]=null)}),e}function xt(t,e){e&&Object.entries(e).forEach(([i,a])=>{let l=t.querySelector(`[name="${i}"]`);l&&(l.hasAttribute("list")||(l.type==="checkbox"?l.checked=!!a:l.type==="date"&&a&&window.parseFlexibleDate?l.value=window.parseFlexibleDate(a):l.value=a??""))})}L();var le={},Le={on(t,e){le[t]||(le[t]=new Set),le[t].add(e)},off(t,e){le[t]&&le[t].delete(e)},emit(t,e){le[t]&&le[t].forEach(i=>{try{i(e)}catch(a){console.warn("[calendarBus] Handler error:",a)}})},clear(){Object.keys(le).forEach(t=>delete le[t])}},ma=new Set(["schedule","cleaning","cleaning_reports","inspection","inspection_reports","fogging","fogging_reports","reliever","relievers","contract","contracts","issue","issues","training","one_on_one","sp","sp_data","mutasi","basecamp","basecamp_reports","supply"]);function ge(t){if(!t){Le.emit("data:changed",{module:"unknown"});return}let e=String(t).toLowerCase().replace(/^\/api\//,"").replace(/^reports\//,"");Le.emit("data:changed",{module:e,relevant:ma.has(e)})}function $({container:t,title:e,icon:i,apiPath:a,columns:l,formFields:c,filterFields:s,defaultFilters:r={},itemLabel:n="Data",canCreate:o=!0,canEdit:m=!0,canDelete:p=!0,onBeforeSubmit:d,onAfterLoad:g,onDataLoaded:h,extraActions:b=[],initialSearch:u="",exportOptions:y=null,bulkDelete:S=!1,paginationMode:k="server"}){let w=1,f={...r};u&&(f.search=u);let C=new Set;t.innerHTML=`
  ...
  </div>`).join("");function ct(t=3){return Array(t).fill(0).map((e,i)=>`<div class="skeleton skeleton-text" style="height:38px;margin-bottom:${i<t-1?"6px":"0"};border-radius:6px"></div>`).join("")}async function Z(t,e,i=8e3){try{let a=new AbortController,l=setTimeout(()=>a.abort(),i),c=await v(t,{signal:a.signal}).catch(()=>null);if(clearTimeout(l),!c||!c.ok)return e;let s=c.data;return s?s.data!==void 0?s.data??e:s:e}catch{return e}}function va(){["skel-donut","skel-trend","skel-insp","skel-contract"].forEach(a=>{let l=document.getElementById(a);l&&(l.style.display="none")}),["chart-donut","chart-trend","chart-insp","chart-contract"].forEach(a=>{let l=document.getElementById(a);if(l&&l.style.display==="none"){l.style.display="block";let c=l.parentElement;if(c&&!c.querySelector(".chart-empty")){let s=document.createElement("div");s.className="chart-empty",s.textContent="Belum ada data",l.style.display="none",c.appendChild(s)}}});let t=document.getElementById("kpi-row");t&&t.querySelector(".skeleton")&&Bt({});let e=document.getElementById("mini-stats-row");e&&e.querySelector(".skeleton")&&Lt({}),["table-contracts","table-issues"].forEach(a=>{let l=document.getElementById(a);l&&l.querySelector(".skeleton")&&(l.innerHTML='<div class="chart-empty">Belum ada data</div>')});let i=document.getElementById("activity-log");i&&i.querySelector(".skeleton")&&(i.innerHTML='<div class="chart-empty">Belum ada aktivitas</div>')}async function Pt(t){ua(),t._dashRefresh&&clearInterval(t._dashRefresh),t._skelTimeout&&clearTimeout(t._skelTimeout);let e=new Date().toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});t.innerHTML=`
  ...
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>dt(t)),t._skelTimeout=setTimeout(()=>va(),5e3),await dt(t),t._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?dt(t):clearInterval(t._dashRefresh)},6e4)}async function dt(t){t._skelTimeout&&(clearTimeout(t._skelTimeout),t._skelTimeout=null);let[e,i,a,l,c,s,r,n,o,m,p,d]=await Promise.all([Z("/api/dashboard/kpi",{},8e3),Z("/api/dashboard/issues-trend",{},8e3),Z("/api/dashboard/issues-summary",{},8e3),Z("/api/dashboard/inspection-bar",{},8e3),Z("/api/dashboard/stats",{},8e3),Z("/api/dashboard/calendar",[],8e3),Z("/api/schedule?limit=10000",{data:[]},8e3),Z("/api/employees?limit=10000",{data:[]},8e3),Z("/api/contracts?limit=10000",{data:[]},8e3),Z("/api/issues?limit=10000",{data:[]},8e3),Z("/api/one_on_one?limit=10000",{data:[]},8e3),Z("/api/dashboard/contracts-chart",{},8e3)]);if(e){let h=Array.isArray(r?.data)?r.data:Array.isArray(r)?r:[],b=Array.isArray(n?.data)?n.data:Array.isArray(n)?n:[],u=Array.isArray(o?.data)?o.data:Array.isArray(o)?o:[],y=Array.isArray(m?.data)?m.data:Array.isArray(m)?m:[],S=Array.isArray(p?.data)?p.data:Array.isArray(p)?p:[];e.employees&&(e.employees.current=b.filter(k=>Ct(k,"active")).length),e.contracts&&(e.contracts.current=u.filter(k=>lt(k,"active")).length),e.expiring30&&(e.expiring30={current:u.filter(k=>lt(k,"expiring30")).length}),e.issues&&(e.issues.current=y.filter(k=>Tt(k,"open")).length),e.one_on_one&&(e.one_on_one.current=S.filter(k=>$t(k,"pending")).length),e.inspection_month&&(e.inspection_month.current=h.filter(k=>st(k,"inspeksi")).length),e.cleaning_month&&(e.cleaning_month.current=h.filter(k=>st(k,"gcdc")).length)}try{Bt(e)}catch(h){console.warn("KPI render:",h)}try{Lt(e)}catch(h){console.warn("MiniStats render:",h)}try{ka(Array.isArray(a?.by_category)?a.by_category:[])}catch(h){console.warn("Donut render:",h),de("skel-donut","chart-donut")}try{Sa(i)}catch(h){console.warn("Trend render:",h),de("skel-trend","chart-trend")}try{Et(l)}catch(h){console.warn("InspBar render:",h),de("skel-insp","chart-insp")}try{let h=Array.isArray(c)?c:Array.isArray(c?.recent_issues)?c.recent_issues:[];_a(h)}catch(h){console.warn("IssuesTable render:",h)}try{wa(d)}catch(h){console.warn("ContractsTable render:",h)}try{xa(Array.isArray(s)?s:[])}catch(h){console.warn("Agenda render:",h)}try{let h=Array.isArray(r?.data)?r.data:Array.isArray(r)?r:[],b=Array.isArray(m?.data)?m.data:Array.isArray(m)?m:[];Ca(h,b,l)}catch(h){console.warn("KPI Kebersihan render:",h)}try{Ta()}catch(h){console.warn("Quick Actions render:",h)}let g=document.getElementById("insp-month-filter");if(g){let h=["Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember"];g.innerHTML='<option value="">12 Bulan Terakhir</option>';let b=new Date().getFullYear();h.forEach((u,y)=>{let S=`${b}-${String(y+1).padStart(2,"0")}`,k=document.createElement("option");k.value=S,k.textContent=u+" "+b,g.appendChild(k)}),g.addEventListener("change",async u=>{let y=u.target.value,S=document.getElementById("skel-insp"),k=document.getElementById("chart-insp");S&&(S.style.display="block"),k&&(k.style.display="none");let w=y?`?month=${y}`:"",f=await v("/api/dashboard/inspection-bar"+w);if(f&&f.ok){let C=f.data?.data!==void 0?f.data.data:f.data;Et(C)}else de("skel-insp","chart-insp")})}}function Bt(t){let e=document.getElementById("kpi-row");if(!e)return;t=t||{};let i=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees?dash_filter=active",color:"kpi-blue",key:"employees",trendPct:"+2%",trendColor:"#10B981",points:"0,20 10,18 20,22 30,12 40,15 50,8 60,10 70,5 80,6 90,2 100,0"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts?dash_filter=active",color:"kpi-green",key:"contracts",trendPct:"+1%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u23F3",label:"Kontrak Habis 30 Hari",sub:"Akan segera berakhir",href:"#/contracts?dash_filter=expiring30",color:"kpi-warn",key:"expiring30",trendPct:"+25%",trendColor:"#F59E0B",points:"0,25 20,22 40,24 60,15 80,18 100,5"},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues?dash_filter=open",color:"kpi-red",key:"issues",trendPct:"0%",trendColor:"#EF4444",points:"0,20 20,18 40,22 60,19 80,21 100,20"},{icon:"\u{1F4AC}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one?dash_filter=pending",color:"kpi-purple",key:"one_on_one",trendPct:"+8%",trendColor:"#10B981",points:"0,25 20,15 40,18 60,8 80,10 100,2"}];e.innerHTML=i.map(a=>{let l=ie(t[a.key]?.current,0);return`
    ...
    <div style="display:flex;flex-direction:column;gap:12px;padding-right:8px">
      ${c.map(s=>{let r="#3B82F6",n="#EFF6FF",o="Agenda",m=(s.title||"").toLowerCase();return m.includes("inspeksi")?(r="#10B981",n="#ECFDF5",o="Inspeksi"):m.includes("cleaning")||m.includes("gcdc")?(r="#3B82F6",n="#EFF6FF",o="Cleaning"):m.includes("reliefer")?(r="#F59E0B",n="#FFFBEB",o="Reliefer"):m.includes("fogging")&&(r="#8B5CF6",n="#F5F3FF",o="Fogging"),`
  ...
  `).join("")}function de(t,e){let i=document.getElementById(t),a=document.getElementById(e);i&&(i.style.display="none",i.style.position=""),a&&(a.style.display="block")}function je(t,e="Belum ada data"){if(!t)return;t.style.display="none";let i=t.parentElement;if(!i)return;if(!i.querySelector(".chart-empty")){let l=document.createElement("div");l.className="chart-empty",l.textContent=e,i.appendChild(l)}}I();async function At(t){document.getElementById("app").innerHTML=`
...
`})),alert(b),typeof Ue=="function"&&Ue()}}})}I();L();var gt=[],Ne=[];function Da(t){if(!Array.isArray(t))return"Q3";let e=["Q4","Q3","Q2","Q1"];for(let i of e)if(t.some(a=>a.period===i))return i;return"Q3"}function Ia(t,e){if(t.period!=="Q3")return!1;let i=String(t.status||"").toLowerCase();if(i!=="selesai"&&i!=="completed"&&i!=="done")return!1;let a=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?a.includes("inspeksi"):e==="gcdc"?a.includes("general cleaning")||a.includes("deep cleaning"):!1}async function Ft(t,e){gt=await B();let i=await H();Ne=["Ade Surahman","Berlin Ariansyah","Mizwar","Fajar","Ade","Berlin"];let a=o=>o&&!Ne.find(m=>(typeof m=="object"?m.value:m)===o)?[...Ne,o]:Ne,l=await v(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`),c=o=>{if(!o||o==="-"||String(o).trim()==="")return"";let m=String(o).split("-");return m.length===3&&m[0].length===4?`${m[2]}-${m[1]}-${m[0]}`:o},s=l.data?.data||[],r=Da(s),n=e?e.get("dash_filter"):null;$({container:t,title:"Jadwal Kegiatan",icon:"\u{1F4C5}",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",paginationMode:"client",defaultFilters:n?{period:"Q3"}:{},onDataLoaded:o=>(n&&(o=o.filter(m=>Ia(m,n))),o.sort((m,p)=>{let d=m.target_date?new Date(m.target_date).getTime():m.opening_date?new Date(m.opening_date).getTime():0;return(p.target_date?new Date(p.target_date).getTime():p.opening_date?new Date(p.opening_date).getTime():0)-d})),columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:o=>rt(o)},{key:"period",label:"Periode",render:o=>ne(o)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:o=>c(o)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:o=>c(o)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:o=>c(o)},{key:"status",label:"Status",render:o=>N(o)}],filterFields:[{type:"combobox",name:"branch_id",label:"Cabang",options:gt},{type:"select",name:"activity_type",label:"Kegiatan",options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"combobox",name:"pic",label:"PIC",options:Ne}],formFields:o=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:gt,value:o?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"],value:o?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:o?.period},{name:"pic",label:"PIC",type:"combobox",options:a(o?.pic),value:o?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:o?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:o?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:o?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:o?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:o?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let o=await v(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`);if(o.ok){let m=o.data.data.map(p=>({ID:p.id||"",Cabang:p.branch_name||"",Kegiatan:p.activity_type||"",Periode:p.period||"",PIC:p.pic||"","Tgl Opening":p.opening_date||"","Tgl Target":p.target_date||"","Tgl Selesai":p.completion_date||"",Status:p.status||""}));E(m,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{ID:"",Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done"}],"Template_Import_Jadwal")},onImport:async o=>{let p=(await v("/api/branches?all=1")).data?.data||[],d=u=>{if(!u)return null;let y=String(u||"").toLowerCase(),S=p.find(k=>String(k.full_name||"").toLowerCase()===y||String(k.code||"").toLowerCase()===y||String(k.name||"").toLowerCase()===y);return S?S.id:null},g=u=>{if(u==null||u==="")return"";if(u instanceof Date&&!isNaN(u.getTime()))return u.toISOString().slice(0,10);let y=String(u).trim();if(y===""||y==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(y))return y.slice(0,10);if(/^\d{4,5}$/.test(y)){let k=Number(y);if(k>2e4&&k<99999){let w=new Date(Date.UTC(1899,11,30)+k*864e5);return isNaN(w.getTime())?"":w.toISOString().slice(0,10)}}let S=y.split(/[\/\-\.]/);if(S.length===3){let[k,w,f]=S.map(C=>C.trim());if(k.length===4&&w.length<=2&&f.length<=2)return`${k}-${w.padStart(2,"0")}-${f.padStart(2,"0")}`;if(f.length===4&&w.length<=2&&k.length<=2)return`${f}-${w.padStart(2,"0")}-${k.padStart(2,"0")}`}return y},h=o.map(u=>({id:u.ID||null,branch_id:d(String(u.Cabang||"").trim()),activity_type:String(u.Kegiatan||"").trim(),period:String(u.Periode||"").trim(),pic:String(u.PIC||u.Pic||"").trim(),opening_date:g(u["Tgl Opening"]||u["Tanggal Opening"]||u["Tgl Openir"]),target_date:g(u["Tgl Target"]||u["Tanggal Target"]),completion_date:g(u["Tgl Selesai"]||u["Tanggal Selesai"]),status:String(u.Status||"").trim(),notes:String(u.Catatan||u.Keterangan||"").trim()})).filter(u=>u.activity_type&&u.period),b=await v("/api/schedule/import",{method:"POST",body:JSON.stringify(h)});if(!b.ok)throw new Error(b.data?.error||"Import gagal")}}})}I();L();var bt=[],Je=[];async function Mt(t,e){let i=e?e.get("dash_filter"):null;bt=await B(),Je=await H();let a=s=>s&&!Je.find(r=>r.value===s)?[...Je,{value:s,label:s}]:Je,l=new Date().getFullYear(),c=Array.from({length:5},(s,r)=>String(l-r));$({container:t,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,itemLabel:"Permasalahan",paginationMode:"client",defaultFilters:{status:i==="open"?"Open":""},onDataLoaded:s=>s,columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:s=>window.formatDate(s)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:s=>`<span class="badge badge-secondary">${s}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:s=>`<span title="${s}">${s?.length>50?s.slice(0,50)+"\u2026":s}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:s=>`<span title="${s||""}">${s?.length>40?s.slice(0,40)+"\u2026":s||"-"}</span>`},{key:"status",label:"Status",render:s=>N(s)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:s=>window.formatDate(s)},{key:"day_count",label:"Hari",render:s=>s??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"combobox",name:"branch_id",label:"Cabang",options:bt},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:c}],formFields:s=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:s?.report_date},{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:bt,value:s?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:s?.category},{name:"source",label:"Sumber Laporan",type:"combobox",options:["SPV","AM","RCP","Perawat","FC","Berlin","Ade","Pattrel","Dentrel"],value:s?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:s?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"combobox",options:a(s?.employee_name),value:s?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"combobox",options:a(s?.fc_specialist),value:s?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:s?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:s?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:s?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let s=await v(`/api/issues${window.location.search?window.location.search+"&":"?"}limit=10000`);if(s.ok){let r=s.data.data.map(n=>({Tanggal:n.report_date||"",Cabang:n.branch_name||"",Kategori:n.category||"",Sumber:n.source||"",Keluhan:n.complaint||"","Nama FC":n.employee_name||"","FC Spesialis":n.fc_specialist||"",Solusi:n.solution||"","Tgl Selesai":n.completion_date||"",Status:n.status||""}));E(r,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async s=>{let n=(await v("/api/branches?all=1")).data?.data||[],o=d=>{if(!d)return null;let g=String(d||"").toLowerCase(),h=n.find(b=>String(b.full_name||"").toLowerCase()===g||String(b.code||"").toLowerCase()===g||String(b.name||"").toLowerCase()===g);return h?h.id:null},m=s.map(d=>({branch_id:o(String(d.Cabang||"").trim()),report_date:String(d.Tanggal||"").trim(),category:String(d.Kategori||"").trim(),source:String(d.Sumber||"").trim(),complaint:String(d.Keluhan||"").trim(),employee_name:String(d["Nama FC"]||"").trim(),fc_specialist:String(d["FC Spesialis"]||"").trim(),solution:String(d.Solusi||"").trim(),completion_date:String(d["Tgl Selesai"]||"").trim(),status:String(d.Status||"").trim()})).filter(d=>d.report_date&&d.complaint&&d.category),p=await v("/api/issues/import",{method:"POST",body:JSON.stringify(m)});if(!p.ok)throw new Error(p.data?.error||"Import gagal")}}})}I();var _e=[];async function Kt(t,e){let i=e?e.get("dash_filter"):null;_e=await B();let a=await H(),l=["Ade Surahman","Berlin Ariansyah","Mizwar","Fajar","Ade","Berlin"],c=r=>r&&!a.find(n=>n.value===r)?[...a,{value:r,label:r}]:a,s=r=>r&&!l.find(n=>(typeof n=="object"?n.value:n)===r)?[...l,r]:l;$({container:t,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,itemLabel:"One on One",paginationMode:"client",defaultFilters:{status:i==="pending"?"Open":""},onDataLoaded:r=>r,columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:r=>window.formatDate(r)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:r=>`<span title="${r||""}">${r?.length>50?r.slice(0,50)+"\u2026":r||"-"}</span>`},{key:"solution",label:"Solusi",render:r=>`<span title="${r||""}">${r?.length>40?r.slice(0,40)+"\u2026":r||"-"}</span>`},{key:"status",label:"Status",render:r=>N(r)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:r=>window.formatDate(r)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:r=>r?`<a href="${r}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"combobox",name:"branch_id",label:"Cabang",options:_e},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async r=>{let n=new URLSearchParams(r||{}).toString(),o=await v(`/api/one-on-one?limit=10000&${n}`);if(o.ok){let m=o.data.data.map(d=>({Tanggal:d.meeting_date||"",Cabang:d.branch_name||"","Nama Karyawan":d.employee_name||"",PIC:d.pic||"",Masalah:d.problem||"",Solusi:d.solution||"",Status:d.status||"","Tgl Selesai":d.completion_date||"",Dokumen:d.document_link||""})),{downloadExcel:p}=await Promise.resolve().then(()=>(L(),X));p(m,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let r=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(L(),X));n(r,"Template_Import_OneOnOne")},onImport:async r=>{let n=d=>{if(!d)return null;let g=String(d||"").toLowerCase(),h=_e.find(b=>String(b.label||"").toLowerCase()===g);return h?h.value:null},o=d=>{if(!d)return"";if(d instanceof Date&&!isNaN(d.getTime()))return d.toISOString().slice(0,10);let g=String(d).trim();if(/^\d{4,5}$/.test(g)){let b=Number(g);if(b>2e4&&b<99999){let u=new Date(Date.UTC(1899,11,30)+b*864e5);return isNaN(u.getTime())?"":u.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(g))return g.slice(0,10);let h=g.split(/[\/\-\.]/);if(h.length===3){let[b,u,y]=h.map(S=>S.trim());if(b.length===4&&u.length<=2&&y.length<=2)return`${b}-${u.padStart(2,"0")}-${y.padStart(2,"0")}`;if(y.length===4&&u.length<=2&&b.length<=2)return`${y}-${u.padStart(2,"0")}-${b.padStart(2,"0")}`}return g},m=r.map(d=>({meeting_date:o(d.Tanggal),employee_name:String(d["Nama Karyawan"]||"").trim(),branch_id:n(String(d.Cabang||"").trim()),pic:String(d.PIC||"").trim(),problem:String(d.Masalah||"").trim(),solution:String(d.Solusi||"").trim(),status:String(d.Status||"").trim(),completion_date:o(d["Tgl Selesai"]),document_link:String(d.Dokumen||"").trim()})).filter(d=>d.meeting_date&&d.employee_name&&d.branch_id),p=await v("/api/one-on-one/import",{method:"POST",body:JSON.stringify(m)});if(!p.ok)throw new Error(p.data?.error||"Import gagal")}},formFields:r=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:r?.meeting_date},{name:"branch_id",label:"Cabang",type:"combobox",options:r?.branch_id&&!_e.find(n=>n.value==r.branch_id)?[..._e,{value:r.branch_id,label:r.branch_name||r.branch_id}]:_e,createApi:{path:"/api/branches",field:"full_name"},value:r?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"combobox",required:!0,options:c(r?.employee_name),value:r?.employee_name},{name:"pic",label:"PIC",type:"combobox",options:s(r?.pic),createApi:{path:"/api/pic",field:"name"},value:r?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:r?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:r?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:r?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:r?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:r?.document_link}]})}I();async function Rt(t){let e=await B(),i=await H(),a=["Ade Surahman","Berlin Ariansyah","Mizwar","Fajar","Ade","Berlin"],l=r=>r&&!i.find(n=>n.value===r)?[...i,{value:r,label:r}]:i,c=r=>r&&!a.find(n=>(typeof n=="object"?n.value:n)===r)?[...a,r]:a,s=Array.from({length:5},(r,n)=>String(new Date().getFullYear()-n));$({container:t,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:r=>window.formatDate(r)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:r=>{try{let n=JSON.parse(r);return Array.isArray(n)?n.join(", "):r||"-"}catch{return r||"-"}}},{key:"score",label:"Nilai",render:r=>r!=null?`<strong>${r}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:r=>r?`<a href="${r}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer..."},{type:"select",name:"year",label:"Tahun",options:s}],exportOptions:{moduleName:"training",onExport:async r=>{let n=new URLSearchParams(r||{}).toString(),o=await v(`/api/training?limit=10000&${n}`);if(o.ok){let m=o.data.data.map(d=>{let g=d.participants||"";try{let h=JSON.parse(g);g=Array.isArray(h)?h.join(", "):g}catch{}return{Tanggal:d.training_date||"",Batch:d.batch||"",Materi:d.subject||"",Cabang:d.branch_name||"",Trainer:d.trainer||"",Peserta:g,Nilai:d.score!==null&&d.score!==void 0?d.score:"",Dokumen:d.document_link||""}}),{downloadExcel:p}=await Promise.resolve().then(()=>(L(),X));p(m,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let r=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(L(),X));n(r,"Template_Import_Training")},onImport:async r=>{let n=d=>{if(!d)return null;let g=String(d||"").toLowerCase(),h=e.find(b=>String(b.label||"").toLowerCase()===g);return h?h.value:null},o=d=>{if(!d)return"";if(d instanceof Date&&!isNaN(d.getTime()))return d.toISOString().slice(0,10);let g=String(d).trim();if(/^\d{4,5}$/.test(g)){let b=Number(g);if(b>2e4&&b<99999){let u=new Date(Date.UTC(1899,11,30)+b*864e5);return isNaN(u.getTime())?"":u.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(g))return g.slice(0,10);let h=g.split(/[\/\-\.]/);if(h.length===3){let[b,u,y]=h.map(S=>S.trim());if(b.length===4&&u.length<=2&&y.length<=2)return`${b}-${u.padStart(2,"0")}-${y.padStart(2,"0")}`;if(y.length===4&&u.length<=2&&b.length<=2)return`${y}-${u.padStart(2,"0")}-${b.padStart(2,"0")}`}return g},m=r.map(d=>({training_date:o(d.Tanggal),batch:String(d.Batch||"").trim(),subject:String(d.Materi||"").trim(),branch_id:n(String(d.Cabang||"").trim()),trainer:String(d.Trainer||"").trim(),participants:String(d.Peserta||"").trim(),score:d.Nilai?Number(d.Nilai):null,document_link:String(d.Dokumen||"").trim()})).filter(d=>d.training_date&&d.subject&&d.branch_id),p=await v("/api/training/import",{method:"POST",body:JSON.stringify(m)});if(!p.ok)throw new Error(p.data?.error||"Import gagal")}},formFields:r=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:r?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:r?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:r?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",options:e,value:r?.branch_id},{name:"trainer",label:"Trainer",type:"combobox",options:c(r?.trainer),value:r?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let n=JSON.parse(r?.participants);return Array.isArray(n)?n.join(", "):r?.participants||""}catch{return r?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:r?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:r?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:r?.notes}],onBeforeSubmit:async r=>(r.participants&&(r.participants=JSON.stringify(r.participants.split(",").map(n=>n.trim()).filter(Boolean))),r)})}I();L();async function qt(t,e){window.__RELIEVER_BUILD__="V3",console.log("RELIEVER PAGE LOADED");let i=await B(),a=await H(),l=e?e.get("dash_filter"):null;console.log("RAW",await ve()),console.log("OPTIONS",a);let c=n=>n&&!a.find(o=>o.value===n)?[...a,{value:n,label:n}]:a,s=["Agung Septiadi","Wasrikin","IQBAL AL BANNA","Muhammad Tri Ismandanu"],r=n=>n&&!s.includes(n)?[...s,n]:s;$({container:t,title:"Jadwal Reliefer",icon:"\u{1F504}",apiPath:"/api/relievers",bulkDelete:!0,itemLabel:"Reliefer",paginationMode:"client",onDataLoaded:n=>{if(l==="reliever"){let o=new Date,m=o.getFullYear(),p=String(o.getMonth()+1).padStart(2,"0");return n.filter(d=>{if(String(d.status||"").toLowerCase()!=="done")return!1;let g=d.backup_date||"";if(g.includes("/")){let h=g.split("/");if(h.length===3&&(h[2].length===4?h[2]:`20${h[2]}`)==m&&h[1].padStart(2,"0")==p)return!0}else if(g.includes("-")&&g.startsWith(`${m}-${p}`))return!0;return!1})}return n},columns:[{key:"branch_name",label:"Cabang"},{key:"original_fc_name",label:"Nama Facility care"},{key:"period",label:"Periode",render:n=>ne(n)},{key:"reliever_name",label:"Relifer"},{key:"backup_date",label:"Tanggal Back Up",nowrap:!0,render:n=>window.formatDate(n)},{key:"completion_date",label:"Tanggal Selesai",nowrap:!0,render:n=>window.formatDate(n)},{key:"reason",label:"Keterangan"},{key:"shift",label:"Shift",render:n=>n?`<span class="badge badge-info">${n}</span>`:"-"},{key:"status",label:"Status",render:n=>N(n)}],filterFields:[{type:"search",placeholder:"Cari reliefer / FC..."},{type:"combobox",name:"branch_id",label:"Cabang",options:i},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done","Tidak Datang"]}],formFields:n=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:i,value:n?.branch_id},{name:"period",label:"Periode",type:"combobox",options:["Q1","Q2","Q3","Q4"],value:n?.period}]},{type:"row",fields:[{name:"original_fc_name",label:"Nama Facility care",type:"combobox",options:c(n?.original_fc_name),value:n?.original_fc_name},{name:"reliever_name",label:"Relifer",type:"combobox",required:!0,options:r(n?.reliever_name),value:n?.reliever_name}]},{type:"row",fields:[{name:"backup_date",label:"Tanggal Back Up",type:"date",required:!0,value:n?.backup_date},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:n?.completion_date}]},{type:"row",fields:[{name:"reason",label:"Keterangan",type:"combobox",options:["Cuti","Mengisi Kekosongan","Back Up Training","Deep Cleaning","Training Praktek Skill","Sakit","Lainnya"],value:n?.reason},{name:"shift",label:"Shift",type:"combobox",options:["Pagi","Siang","Full Shift","Middle"],value:n?.shift}]},{name:"status",label:"Status",type:"combobox",required:!0,options:["Pending","Done","Tidak Datang"],value:n?.status||""}],exportOptions:{moduleName:"relievers",onExport:async()=>{let n=await v(`/api/relievers${window.location.search?window.location.search+"&":"?"}limit=10000`);if(n.ok){let o=n.data.data.map(m=>({Cabang:m.branch_name||"","Nama Facility care":m.original_fc_name||"",Periode:m.period||"",Relifer:m.reliever_name||"","Tanggal Back Up":m.backup_date||"","Tanggal Selesai":m.completion_date||"",Keterangan:m.reason||"",Shift:m.shift||"",Status:m.status||""}));o.length===0&&o.push({Cabang:"","Nama Facility care":"",Periode:"",Relifer:"","Tanggal Back Up":"","Tanggal Selesai":"",Keterangan:"",Shift:"",Status:""}),E(o,"Data_Reliefer")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Cabang:"001. Pondok Bambu","Nama Facility care":"Budi Santoso",Periode:"Q1",Relifer:"Andi","Tanggal Back Up":"2024-03-10","Tanggal Selesai":"2024-03-10",Keterangan:"Sakit",Shift:"Pagi",Status:"Done"}],"Template_Import_Reliefer")},onImport:async n=>{let m=(await v("/api/branches?all=1")).data?.data||[],p=h=>{if(!h)return null;let b=String(h||"").toLowerCase(),u=m.find(y=>String(y.full_name||"").toLowerCase()===b||String(y.code||"").toLowerCase()===b||String(y.name||"").toLowerCase()===b);return u?u.id:null},d=n.map(h=>({branch_name:String(h.Cabang||"").trim(),backup_date:String(h["Tanggal Back Up"]||h["Tanggal Backup"]||"").trim(),original_fc_name:String(h["Nama Facility care"]||h["FC Digantikan"]||"").trim(),reliever_name:String(h.Relifer||h.Reliefer||"").trim(),period:String(h.Periode||"").trim(),reason:String(h.Keterangan||"").trim(),shift:String(h.Shift||"").trim(),completion_date:String(h["Tanggal Selesai"]||"").trim(),status:String(h.Status||"").trim()})).filter(h=>h.reliever_name&&h.backup_date),g=await v("/api/import/relievers",{method:"POST",body:JSON.stringify({rows:d})});if(!g.ok)throw new Error(g.data?.error||"Import gagal")}}})}I();L();async function Ht(t){let e=await B(),i=Array.from({length:4},(a,l)=>String(new Date().getFullYear()-l));$({container:t,title:"Laporan Inspeksi Hygiene",icon:"\u{1F50D}",apiPath:"/api/reports/inspection",itemLabel:"Laporan Inspeksi",bulkDelete:!0,columns:[{key:"branch_name",label:"Cabang"},{key:"period",label:"Periode",render:a=>ne(a)},{key:"inspection_date",label:"Tanggal",nowrap:!0,render:a=>window.formatDate(a)},{key:"fc_score",label:"Point FC",render:a=>a!=null?`<strong class="${a>=80?"text-success":a>=60?"text-warning":"text-danger"}">${a}</strong>`:"-"},{key:"spv_score",label:"Point SPV",render:a=>a!=null?`<strong>${a}</strong>`:"-"},{key:"status",label:"Status",render:a=>N(a)},{key:"document_link",label:"Dokumen",render:a=>a?`<a href="${a}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari cabang / PIC..."},{type:"combobox",name:"branch_id",label:"Cabang",options:e},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done"]},{type:"select",name:"year",label:"Tahun",options:i}],formFields:a=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:e,value:a?.branch_id},{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:a?.period}]},{type:"row",fields:[{name:"inspection_date",label:"Tanggal Inspeksi",type:"date",required:!0,value:a?.inspection_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done"],value:a?.status||""}]},{type:"row",fields:[{name:"fc_score",label:"Point FC",type:"number",step:"0.1",min:"0",max:"100",value:a?.fc_score},{name:"spv_score",label:"Point SPV",type:"number",step:"0.1",min:"0",max:"100",value:a?.spv_score}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:a?.document_link},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:a?.notes}],exportOptions:{moduleName:"inspection_reports",onExport:async a=>{let l=new URLSearchParams(a||{}).toString(),c=await v(`/api/reports/inspection?limit=10000&${l}`);if(c.ok){let s=c.data.data.map(r=>({Cabang:r.branch_name||"",Periode:r.period||"",Tanggal:r.inspection_date||"","Point FC":r.fc_score!==null&&r.fc_score!==void 0?r.fc_score:"","Point SPV":r.spv_score!==null&&r.spv_score!==void 0?r.spv_score:"",Status:r.status||"","Link Dokumen":r.document_link||""}));E(s,`Laporan_Inspeksi_Hygiene_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Cabang:"001. Pondok Bambu",Periode:"Q1",Tanggal:"2026-01-08","Point FC":85,"Point SPV":90,Status:"Done","Link Dokumen":"https://drive.google.com/..."}],"Template_Import_Inspeksi")},onImport:async a=>{let l=n=>{if(!n)return null;let o=String(n||"").toLowerCase(),m=e.find(p=>String(p.label||"").toLowerCase()===o);return m?m.value:null},c=n=>{if(n==null||n==="")return"";if(n instanceof Date&&!isNaN(n.getTime()))return n.toISOString().slice(0,10);let o=String(n).trim();if(o===""||o==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(o))return o.slice(0,10);if(/^\d{4,5}$/.test(o)){let p=Number(o);if(p>2e4&&p<99999){let d=new Date(Date.UTC(1899,11,30)+p*864e5);return isNaN(d.getTime())?"":d.toISOString().slice(0,10)}}let m=o.split(/[\/\-\.]/);if(m.length===3){let[p,d,g]=m.map(h=>h.trim());if(p.length===4&&d.length<=2&&g.length<=2)return`${p}-${d.padStart(2,"0")}-${g.padStart(2,"0")}`;if(g.length===4&&d.length<=2&&p.length<=2)return`${g}-${d.padStart(2,"0")}-${p.padStart(2,"0")}`}return o},s=a.map(n=>({branch_id:l(String(n.Cabang||"").trim()),period:String(n.Periode||"").trim(),inspection_date:c(n.Tanggal),fc_score:n["Point FC"]!==void 0&&n["Point FC"]!==""?Number(n["Point FC"]):null,spv_score:n["Point SPV"]!==void 0&&n["Point SPV"]!==""?Number(n["Point SPV"]):null,status:String(n.Status||"").trim(),document_link:String(n["Link Dokumen"]||"").trim(),notes:String(n.Catatan||n.Keterangan||"").trim()})).filter(n=>n.branch_id&&n.period&&n.inspection_date),r=await v("/api/reports/inspection/import",{method:"POST",body:JSON.stringify(s)});if(!r.ok)throw new Error(r.data?.error||"Import gagal")}}})}I();L();async function jt(t){let e=await B(),i=Array.from({length:4},(a,l)=>String(new Date().getFullYear()-l));$({container:t,title:"Laporan General Cleaning & Deep Cleaning",icon:"\u{1F9F9}",apiPath:"/api/reports/cleaning",itemLabel:"Laporan GC/DC",bulkDelete:!0,columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Jenis",render:a=>`<span class="badge ${a==="Deep Cleaning"?"badge-purple":"badge-success"}">${a}</span>`},{key:"period",label:"Periode",render:a=>ne(a)},{key:"activity_date",label:"Tanggal",nowrap:!0,render:a=>window.formatDate(a)},{key:"status",label:"Status",render:a=>N(a)},{key:"document_link",label:"Dokumen",render:a=>a?`<a href="${a}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama cabang/lokasi..."},{type:"combobox",name:"branch_id",label:"Cabang",options:e},{type:"select",name:"activity_type",label:"Jenis",options:["General Cleaning","Deep Cleaning"]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done"]},{type:"select",name:"year",label:"Tahun",options:i}],formFields:a=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:e,value:a?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["General Cleaning","Deep Cleaning"],value:a?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:a?.period},{name:"activity_date",label:"Tanggal",type:"date",required:!0,value:a?.activity_date}]},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done"],value:a?.status||""},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:a?.document_link},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:a?.notes}],exportOptions:{moduleName:"cleaning_reports",onExport:async a=>{let l=new URLSearchParams(a||{}).toString(),c=await v(`/api/reports/cleaning?limit=10000&${l}`);if(c.ok){let s=c.data.data.map(r=>({Cabang:r.branch_name||"",Jenis:r.activity_type||"",Periode:r.period||"",Tanggal:r.activity_date||"",Status:r.status||"","Link Dokumen":r.document_link||""}));E(s,`Laporan_GCDC_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Cabang:"001. Pondok Bambu",Jenis:"General Cleaning",Periode:"Q1",Tanggal:"2026-01-08",Status:"Done","Link Dokumen":"https://drive.google.com/..."}],"Template_Import_GCDC")},onImport:async a=>{let l=n=>{if(!n)return null;let o=String(n||"").toLowerCase(),m=e.find(p=>String(p.label||"").toLowerCase()===o);return m?m.value:null},c=n=>{if(n==null||n==="")return"";if(n instanceof Date&&!isNaN(n.getTime()))return n.toISOString().slice(0,10);let o=String(n).trim();if(o===""||o==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(o))return o.slice(0,10);if(/^\d{4,5}$/.test(o)){let p=Number(o);if(p>2e4&&p<99999){let d=new Date(Date.UTC(1899,11,30)+p*864e5);return isNaN(d.getTime())?"":d.toISOString().slice(0,10)}}let m=o.split(/[\/\-\.]/);if(m.length===3){let[p,d,g]=m.map(h=>h.trim());if(p.length===4&&d.length<=2&&g.length<=2)return`${p}-${d.padStart(2,"0")}-${g.padStart(2,"0")}`;if(g.length===4&&d.length<=2&&p.length<=2)return`${g}-${d.padStart(2,"0")}-${p.padStart(2,"0")}`}return o},s=a.map(n=>({branch_id:l(String(n.Cabang||"").trim()),activity_type:String(n.Jenis||n.Kegiatan||"").trim(),period:String(n.Periode||"").trim(),activity_date:c(n.Tanggal),status:String(n.Status||"").trim(),document_link:String(n["Link Dokumen"]||"").trim(),notes:String(n.Catatan||n.Keterangan||"").trim()})).filter(n=>n.branch_id&&n.activity_type&&n.period&&n.activity_date),r=await v("/api/reports/cleaning/import",{method:"POST",body:JSON.stringify(s)});if(!r.ok)throw new Error(r.data?.error||"Import gagal")}}})}I();L();async function Ut(t){let e=await B(),i=Array.from({length:4},(a,l)=>String(new Date().getFullYear()-l));$({container:t,title:"Rekap Fogging",icon:"\u{1F4A8}",apiPath:"/api/reports/fogging",itemLabel:"Fogging",bulkDelete:!0,columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Jenis",render:a=>`<span class="badge badge-warning">${a}</span>`},{key:"period",label:"Periode",render:a=>ne(a)},{key:"activity_date",label:"Tanggal",nowrap:!0,render:a=>window.formatDate(a)},{key:"status",label:"Status",render:a=>N(a)},{key:"document_link",label:"Dokumen",render:a=>a?`<a href="${a}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"},{key:"notes",label:"Catatan",render:a=>a||"-"}],filterFields:[{type:"search",placeholder:"Cari nama cabang/lokasi..."},{type:"combobox",name:"branch_id",label:"Cabang",options:e},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done"]},{type:"select",name:"year",label:"Tahun",options:i}],formFields:a=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:e,value:a?.branch_id},{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:a?.period}]},{type:"row",fields:[{name:"activity_date",label:"Tanggal",type:"date",value:a?.activity_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done"],value:a?.status||""}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:a?.document_link},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:a?.notes}],exportOptions:{moduleName:"fogging_reports",onExport:async a=>{let l=new URLSearchParams(a||{}).toString(),c=await v(`/api/reports/fogging?limit=10000&${l}`);if(c.ok){let s=c.data.data.map(r=>({Cabang:r.branch_name||"",Jenis:r.activity_type||"Fogging",Periode:r.period||"",Tanggal:r.activity_date||"",Status:r.status||"","Link Dokumen":r.document_link||""}));E(s,`Laporan_Fogging_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Cabang:"001. Pondok Bambu",Jenis:"Fogging",Periode:"Q1",Tanggal:"2026-01-08",Status:"Done","Link Dokumen":"https://drive.google.com/..."}],"Template_Import_Fogging")},onImport:async a=>{let l=n=>{if(!n)return null;let o=String(n||"").toLowerCase(),m=e.find(p=>String(p.label||"").toLowerCase()===o);return m?m.value:null},c=n=>{if(n==null||n==="")return"";if(n instanceof Date&&!isNaN(n.getTime()))return n.toISOString().slice(0,10);let o=String(n).trim();if(o===""||o==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(o))return o.slice(0,10);if(/^\d{4,5}$/.test(o)){let p=Number(o);if(p>2e4&&p<99999){let d=new Date(Date.UTC(1899,11,30)+p*864e5);return isNaN(d.getTime())?"":d.toISOString().slice(0,10)}}let m=o.split(/[\/\-\.]/);if(m.length===3){let[p,d,g]=m.map(h=>h.trim());if(p.length===4&&d.length<=2&&g.length<=2)return`${p}-${d.padStart(2,"0")}-${g.padStart(2,"0")}`;if(g.length===4&&d.length<=2&&p.length<=2)return`${g}-${d.padStart(2,"0")}-${p.padStart(2,"0")}`}return o},s=a.map(n=>({branch_id:l(String(n.Cabang||"").trim()),activity_type:String(n.Jenis||n.Kegiatan||"Fogging").trim(),period:String(n.Periode||"").trim(),activity_date:c(n.Tanggal),status:String(n.Status||"").trim(),document_link:String(n["Link Dokumen"]||"").trim(),notes:String(n.Catatan||n.Keterangan||"").trim()})).filter(n=>n.branch_id&&n.period&&n.activity_date),r=await v("/api/reports/fogging/import",{method:"POST",body:JSON.stringify(s)});if(!r.ok)throw new Error(r.data?.error||"Import gagal")}}})}I();L();async function Jt(t){let e=await B(),i=await H(),a=i,l=s=>s&&!i.find(r=>r.value===s)?[...i,{value:s,label:s}]:i,c=s=>s&&!a.find(r=>r.value===s)?[...a,{value:s,label:s}]:a;$({container:t,title:"Rekap Laporan Basecamp",icon:"\u{1F4DD}",apiPath:"/api/reports/basecamp",bulkDelete:!0,itemLabel:"Laporan Basecamp",columns:[{key:"info_date",label:"Tgl Info",nowrap:!0,render:s=>window.formatDate(s)},{key:"branch_name",label:"Cabang"},{key:"problem",label:"Permasalahan",render:s=>`<span title="${s||""}">${s?.length>60?s.slice(0,60)+"\u2026":s||"-"}</span>`},{key:"pic",label:"PIC"},{key:"done_date",label:"Tgl Done",nowrap:!0,render:s=>window.formatDate(s)},{key:"status",label:"Status",render:s=>N(s)},{key:"notes",label:"Keterangan",render:s=>s?.length>40?s.slice(0,40)+"\u2026":s||"-"}],filterFields:[{type:"search",placeholder:"Cari permasalahan / PIC..."},{type:"combobox",name:"branch_id",label:"Cabang",options:e},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]}],formFields:s=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:e,value:s?.branch_id},{name:"pic",label:"PIC",type:"combobox",options:c(s?.pic),value:s?.pic}]},{name:"problem",label:"Permasalahan",type:"textarea",required:!0,rows:3,value:s?.problem},{type:"row",fields:[{name:"info_date",label:"Tanggal Info",type:"date",required:!0,value:s?.info_date},{name:"done_date",label:"Tanggal Done",type:"date",value:s?.done_date}]},{name:"status",label:"Status",type:"select",options:["Open","In Progress","Done"],value:s?.status||"Open"},{name:"notes",label:"Keterangan / Tindak Lanjut",type:"textarea",rows:2,value:s?.notes}],exportOptions:{moduleName:"basecamp_reports",onExport:async s=>{let r=new URLSearchParams(s||{}).toString(),n=await v(`/api/reports/basecamp?limit=10000&${r}`);if(n.ok){let o=n.data.data.map(m=>({"Tgl Info":m.info_date||"",Cabang:m.branch_name||"",Permasalahan:m.problem||"",PIC:m.pic||"","Tgl Done":m.done_date||"",Status:m.status||"",Keterangan:m.notes||""}));E(o,`Rekap_Laporan_Basecamp_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{"Tgl Info":"2026-01-08",Cabang:"001. Pondok Bambu",Permasalahan:"Request fogging karena banyak nyamuk",PIC:"Fajar","Tgl Done":"2026-01-10",Status:"Done",Keterangan:"Sudah difogging"}],"Template_Import_Basecamp")},onImport:async s=>{let r=p=>{if(!p)return null;let d=String(p||"").toLowerCase(),g=e.find(h=>String(h.label||"").toLowerCase()===d);return g?g.value:null},n=p=>{if(p==null||p==="")return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let d=String(p).trim();if(d===""||d==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(d))return d.slice(0,10);if(/^\d{4,5}$/.test(d)){let h=Number(d);if(h>2e4&&h<99999){let b=new Date(Date.UTC(1899,11,30)+h*864e5);return isNaN(b.getTime())?"":b.toISOString().slice(0,10)}}let g=d.split(/[\/\-\.]/);if(g.length===3){let[h,b,u]=g.map(y=>y.trim());if(h.length===4&&b.length<=2&&u.length<=2)return`${h}-${b.padStart(2,"0")}-${u.padStart(2,"0")}`;if(u.length===4&&b.length<=2&&h.length<=2)return`${u}-${b.padStart(2,"0")}-${h.padStart(2,"0")}`}return d},o=s.map(p=>({info_date:n(p["Tgl Info"]||p["Tanggal Info"]),branch_id:r(String(p.Cabang||"").trim()),problem:String(p.Permasalahan||"").trim(),pic:String(p.PIC||"").trim(),done_date:n(p["Tgl Done"]||p["Tanggal Done"]),status:String(p.Status||"").trim(),notes:String(p.Keterangan||p.Catatan||"").trim()})).filter(p=>p.info_date&&p.branch_id&&p.problem),m=await v("/api/reports/basecamp/import",{method:"POST",body:JSON.stringify(o)});if(!m.ok)throw new Error(m.data?.error||"Import gagal")}}})}async function Gt(t){$({container:t,title:"SOP",icon:"\u{1F4D6}",apiPath:"/api/sop",bulkDelete:!0,itemLabel:"SOP",columns:[{key:"name",label:"Nama SOP"},{key:"category",label:"Kategori"},{key:"document_link",label:"Dokumen",render:e=>e?`<a href="${e}" target="_blank" rel="noopener" class="btn btn-sm btn-primary">\u{1F4C4} Buka Dokumen</a>`:"-"},{key:"notes",label:"Catatan"}],filterFields:[{type:"search",placeholder:"Cari nama SOP..."}],exportOptions:{moduleName:"sop",onExport:async e=>{let i=new URLSearchParams(e||{}).toString(),{apiFetch:a}=await Promise.resolve().then(()=>(I(),he)),l=await a(`/api/sop?limit=10000&${i}`);if(l.ok){let c=l.data.data.map(r=>({"Nama SOP":r.name||"",Kategori:r.category||"",Dokumen:r.document_link||"",Catatan:r.notes||r.description||""})),{downloadExcel:s}=await Promise.resolve().then(()=>(L(),X));s(c,`Master_SOP_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let e=[{"Nama SOP":"SOP Cuci Tangan",Kategori:"Ketentuan & Basic",Dokumen:"https://link.com",Catatan:"Catatan singkat"}],{downloadExcel:i}=await Promise.resolve().then(()=>(L(),X));i(e,"Template_Import_SOP")},onImport:async e=>{let i=e.map(c=>({name:String(c["Nama SOP"]||"").trim(),category:String(c.Kategori||"").trim(),document_link:String(c.Dokumen||"").trim(),description:String(c.Catatan||"").trim()})).filter(c=>c.name),{apiFetch:a}=await Promise.resolve().then(()=>(I(),he)),l=await a("/api/sop/import",{method:"POST",body:JSON.stringify(i)});if(!l.ok)throw new Error(l.data?.error||"Import gagal")}},formFields:e=>[{name:"name",label:"Nama SOP",required:!0,placeholder:"Nama SOP",value:e?.name},{name:"category",label:"Kategori",placeholder:"Ketentuan & Basic, Kualitas & Grooming, dst.",value:e?.category},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://docs.google.com/...",value:e?.document_link},{name:"description",label:"Deskripsi / Catatan",type:"textarea",rows:3,value:e?.description}]})}async function Qt(t){$({container:t,title:"Master Checklist",icon:"\u2705",apiPath:"/api/checklist",bulkDelete:!0,itemLabel:"Checklist",columns:[{key:"name",label:"Nama Checklist"},{key:"category",label:"Kategori"},{key:"document_link",label:"Dokumen",render:e=>e?`<a href="${e}" target="_blank" rel="noopener" class="btn btn-sm btn-primary">\u{1F4C4} Buka Dokumen</a>`:"-"},{key:"description",label:"Deskripsi"}],filterFields:[{type:"search",placeholder:"Cari checklist..."}],exportOptions:{moduleName:"checklist",onExport:async e=>{let i=new URLSearchParams(e||{}).toString(),{apiFetch:a}=await Promise.resolve().then(()=>(I(),he)),l=await a(`/api/checklist?limit=10000&${i}`);if(l.ok){let c=l.data.data.map(r=>({"Nama Checklist":r.name||"",Kategori:r.category||"",Dokumen:r.document_link||"",Deskripsi:r.description||""})),{downloadExcel:s}=await Promise.resolve().then(()=>(L(),X));s(c,`Master_Checklist_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let e=[{"Nama Checklist":"Checklist Kebersihan Mingguan",Kategori:"Master Cleaning Program",Dokumen:"https://link.com",Deskripsi:"Deskripsi singkat"}],{downloadExcel:i}=await Promise.resolve().then(()=>(L(),X));i(e,"Template_Import_Checklist")},onImport:async e=>{let i=e.map(c=>({name:String(c["Nama Checklist"]||"").trim(),category:String(c.Kategori||"").trim(),document_link:String(c.Dokumen||"").trim(),description:String(c.Deskripsi||"").trim()})).filter(c=>c.name),{apiFetch:a}=await Promise.resolve().then(()=>(I(),he)),l=await a("/api/checklist/import",{method:"POST",body:JSON.stringify(i)});if(!l.ok)throw new Error(l.data?.error||"Import gagal")}},formFields:e=>[{name:"name",label:"Nama Checklist",required:!0,placeholder:"Nama checklist",value:e?.name},{name:"category",label:"Kategori",placeholder:"Master Cleaning Program, dll.",value:e?.category},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://docs.google.com/...",value:e?.document_link},{name:"description",label:"Deskripsi",type:"textarea",rows:3,value:e?.description}]})}I();Be();L();async function ht(t,e="forms"){if(e==="supply")return Ba(t);Pa(t)}function Pa(t){$({container:t,title:"Master Form",icon:"\u{1F4C4}",apiPath:"/api/forms",bulkDelete:!0,itemLabel:"Form",columns:[{key:"name",label:"Nama Form"},{key:"category",label:"Kategori"},{key:"document_link",label:"Dokumen",render:e=>e?`<a href="${e}" target="_blank" rel="noopener" class="btn btn-sm btn-primary">\u{1F4C4} Buka</a>`:"-"},{key:"is_public",label:"Publik",render:e=>e?'<span class="badge badge-success">Ya</span>':'<span class="badge badge-neutral">Tidak</span>'},{key:"description",label:"Deskripsi"}],filterFields:[{type:"search",placeholder:"Cari form..."}],formFields:e=>[{name:"name",label:"Nama Form",required:!0,placeholder:"Nama form",value:e?.name},{name:"category",label:"Kategori",placeholder:"Permintaan Barang, Penilaian, dll.",value:e?.category},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:e?.document_link},{name:"description",label:"Deskripsi",type:"textarea",rows:2,value:e?.description},{name:"is_public",label:"Akses Publik",type:"checkbox",checkLabel:"Form dapat diakses tanpa login",value:e?.is_public}]})}async function Ba(t){let i=((await v("/api/branches?all=1")).data?.data||[]).map(a=>({value:a.id,label:a.full_name}));$({container:t,title:"Permintaan Barang & Chemical",icon:"\u{1F4E6}",apiPath:"/api/reports/supply",bulkDelete:!0,itemLabel:"Permintaan",canCreate:!0,columns:[{key:"submitted_at",label:"Waktu",nowrap:!0,render:a=>a?new Date(a).toLocaleString("id-ID"):"-"},{key:"submitter_name",label:"Pengirim"},{key:"branch_name",label:"Cabang",render:(a,l)=>l.branch_name_ref||l.branch_name||"-"},{key:"tools_items",label:"Alat/Barang",render:a=>{try{let l=JSON.parse(a);return Array.isArray(l)?l.join(", "):a}catch{return a||"-"}}},{key:"chemical_items",label:"Chemical",render:a=>{try{let l=JSON.parse(a);return Array.isArray(l)?l.join(", "):a}catch{return a||"-"}}},{key:"additional_notes",label:"Catatan",render:a=>a?.length>40?a.slice(0,40)+"\u2026":a||"-"},{key:"status",label:"Status",render:a=>N(a)},{key:"processed_by",label:"Diproses Oleh"}],filterFields:[{type:"select",name:"status",label:"Status",options:["Pending","Diproses","Selesai"]}],formFields:a=>{let l=a?.tools_items;try{l=Array.isArray(JSON.parse(l))?JSON.parse(l).join(", "):l}catch{}let c=a?.chemical_items;try{c=Array.isArray(JSON.parse(c))?JSON.parse(c).join(", "):c}catch{}return[{type:"row",fields:[{name:"submitter_name",label:"Nama Pengirim",required:!0,value:a?.submitter_name},{name:"branch_id",label:"Cabang",type:"combobox",options:a?.branch_id&&!i.find(s=>s.value==a.branch_id)?[...i,{value:a.branch_id,label:a.branch_name||a.branch_id}]:i,createApi:{path:"/api/branches",field:"full_name"},value:a?.branch_id}]},{type:"row",fields:[{name:"tools_items",label:"Alat / Barang",placeholder:"Pisahkan dengan koma (Sapu, Mop)",value:l},{name:"tools_quantity",label:"Jumlah Alat",type:"number",value:a?.tools_quantity}]},{type:"row",fields:[{name:"chemical_items",label:"Chemical",placeholder:"Pisahkan dengan koma",value:c},{name:"chemical_quantity",label:"Jumlah Chemical",type:"number",value:a?.chemical_quantity}]},{name:"additional_notes",label:"Catatan",type:"textarea",rows:2,value:a?.additional_notes},{name:"status",label:"Status",type:"select",options:["Pending","Diproses","Selesai"],value:a?.status||""},{name:"processed_by",label:"Diproses Oleh",value:a?.processed_by}]},exportOptions:{moduleName:"supply_requests",onExport:async a=>{let l=new URLSearchParams(a||{}).toString(),c=await v(`/api/reports/supply?limit=10000&${l}`);if(c.ok){let s=c.data.data.map(r=>{let n=r.tools_items;try{n=Array.isArray(JSON.parse(n))?JSON.parse(n).join(", "):n}catch{}let o=r.chemical_items;try{o=Array.isArray(JSON.parse(o))?JSON.parse(o).join(", "):o}catch{}return{Waktu:r.submitted_at||"",Pengirim:r.submitter_name||"",Cabang:r.branch_name_ref||r.branch_name||"","Alat/Barang":n||"",Chemical:o||"",Catatan:r.additional_notes||"",Status:r.status||"","Diproses Oleh":r.processed_by||""}});E(s,`Permintaan_Barang_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{Waktu:"2026-01-08",Pengirim:"Fajar",Cabang:"001. Pondok Bambu","Alat/Barang":"Sapu, Mop",Chemical:"Karbol",Catatan:"Mendesak",Status:"Pending","Diproses Oleh":""}],"Template_Import_Permintaan")},onImport:async a=>{let c=(await v("/api/branches?all=1")).data?.data||[],s=m=>{if(!m)return null;let p=String(m||"").toLowerCase(),d=c.find(g=>String(g.full_name||"").toLowerCase()===p||String(g.code||"").toLowerCase()===p||String(g.name||"").toLowerCase()===p);return d?d.id:null},r=m=>{if(m==null||m==="")return"";if(m instanceof Date&&!isNaN(m.getTime()))return m.toISOString().slice(0,10);let p=String(m).trim();if(p===""||p==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(p))return p.slice(0,10);if(/^\d{4,5}$/.test(p)){let g=Number(p);if(g>2e4&&g<99999){let h=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(h.getTime())?"":h.toISOString().slice(0,10)}}let d=p.split(/[\/\-\.]/);if(d.length===3){let[g,h,b]=d.map(u=>u.trim());if(g.length===4&&h.length<=2&&b.length<=2)return`${g}-${h.padStart(2,"0")}-${b.padStart(2,"0")}`;if(b.length===4&&h.length<=2&&g.length<=2)return`${b}-${h.padStart(2,"0")}-${g.padStart(2,"0")}`}return p},n=a.map(m=>({submitted_at:r(m.Waktu||m.Tanggal),submitter_name:String(m.Pengirim||"").trim(),branch_id:s(String(m.Cabang||"").trim()),tools_items:String(m["Alat/Barang"]||m.Alat||"").trim(),chemical_items:String(m.Chemical||"").trim(),additional_notes:String(m.Catatan||m.Keterangan||"").trim(),status:String(m.Status||"").trim(),processed_by:String(m["Diproses Oleh"]||m.PIC||"").trim()})).filter(m=>m.submitted_at&&m.submitter_name&&m.branch_id),o=await v("/api/reports/supply/import",{method:"POST",body:JSON.stringify(n)});if(!o.ok)throw new Error(o.data?.error||"Import gagal")}},extraActions:[{label:"Update Status",icon:"\u{1F504}",class:"btn-secondary",handler:(a,l)=>{let c=se({title:"Update Status Permintaan",content:`
            ...
            `,onConfirm:async(s,r)=>{let n=s.querySelector("#supply-status").value,o=s.querySelector("#supply-processed-by").value;(await v(`/api/reports/supply/${a.id}`,{method:"PUT",body:JSON.stringify({status:n,processed_by:o})})).ok?(V("Status diperbarui."),r(),l()):W("Gagal update status.")}})}}]})}I();L();async function Vt(t){let e=ue();if(!e||!["superadmin","admin"].includes(e.role)){t.innerHTML='<div class="empty-state"><p class="text-danger">Akses ditolak.</p></div>';return}$({container:t,title:"Manajemen User",icon:"\u{1F510}",apiPath:"/api/users",bulkDelete:!0,itemLabel:"User",columns:[{key:"full_name",label:"Nama Lengkap"},{key:"username",label:"Username"},{key:"email",label:"Email"},{key:"role",label:"Role",render:i=>`<span class="badge ${{superadmin:"badge-danger",admin:"badge-purple",manager:"badge-info",spv:"badge-secondary",viewer:"badge-neutral"}[i]||"badge-neutral"}">${i}</span>`},{key:"is_active",label:"Status",render:i=>i?'<span class="badge badge-success">Aktif</span>':'<span class="badge badge-neutral">Nonaktif</span>'},{key:"created_at",label:"Dibuat",nowrap:!0,render:i=>i?new Date(i).toLocaleDateString("id-ID"):"-"}],filterFields:[{type:"search",placeholder:"Cari nama / username..."}],formFields:i=>{let a=!!i;return[{type:"row",fields:[{name:"full_name",label:"Nama Lengkap",required:!0,placeholder:"Nama lengkap",value:i?.full_name},{name:"username",label:"Username",required:!a,placeholder:"username",value:i?.username}]},{type:"row",fields:[{name:"email",label:"Email",type:"email",required:!a,placeholder:"email@contoh.com",value:i?.email},{name:"role",label:"Role",type:"select",required:!0,options:[{value:"superadmin",label:"Super Admin"},{value:"admin",label:"Admin"},{value:"manager",label:"Manager"},{value:"spv",label:"Supervisor"},{value:"viewer",label:"Viewer"}],value:i?.role||"viewer"}]},{type:"row",fields:[{name:"password",label:a?"Password Baru (kosongkan jika tidak diubah)":"Password",type:"password",required:!a,placeholder:"Min. 6 karakter"},{name:"is_active",label:"Status Aktif",type:"checkbox",checkLabel:"User aktif",value:a?i?.is_active:1}]}]},exportOptions:{moduleName:"users",onExport:async()=>{let i=await v(`/api/users${window.location.search?window.location.search+"&":"?"}limit=10000`);if(i.ok){let a=i.data.data.map(l=>({"Nama Lengkap":l.full_name||"",Username:l.username||"",Email:l.email||"",Role:l.role||"",Status:l.is_active?"Aktif":"Nonaktif"}));E(a,"Data_Users")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{"Nama Lengkap":"Admin Cabang",Username:"admin01",Email:"admin@contoh.com",Role:"admin",Password:"password123"}],"Template_Import_Users")},onImport:async i=>{let a=i.map(c=>({full_name:String(c["Nama Lengkap"]||"").trim(),username:String(c.Username||"").trim(),email:String(c.Email||"").trim(),role:String(c.Role||"").trim()||"viewer",password:String(c.Password||"").trim()})).filter(c=>c.username&&c.password&&c.email&&c.full_name),l=await v("/api/users/import",{method:"POST",body:JSON.stringify(a)});if(!l.ok)throw new Error(l.data?.error||"Import gagal")}}})}I();L();async function zt(t){$({container:t,title:"Manajemen Cabang",icon:"\u{1F3E2}",apiPath:"/api/branches",itemLabel:"Cabang",bulkDelete:!0,columns:[{key:"code",label:"Kode",width:"60px"},{key:"full_name",label:"Nama Cabang"},{key:"city",label:"Kota"},{key:"is_active",label:"Status",render:e=>e?'<span class="badge badge-success">Aktif</span>':'<span class="badge badge-neutral">Nonaktif</span>'}],filterFields:[{type:"search",placeholder:"Cari nama / kode cabang..."}],formFields:e=>[{type:"row",fields:[{name:"code",label:"Kode Cabang",required:!0,placeholder:"001, A01, ...",value:e?.code},{name:"name",label:"Nama Pendek",required:!0,placeholder:"Pondok Bambu",value:e?.name}]},{name:"full_name",label:"Nama Lengkap",required:!0,placeholder:"001. Pondok Bambu",value:e?.full_name},{type:"row",fields:[{name:"city",label:"Kota",placeholder:"Jakarta",value:e?.city},{name:"is_active",label:"Status",type:"checkbox",checkLabel:"Cabang aktif",value:e?.is_active!==void 0?e.is_active:1}]}],exportOptions:{moduleName:"branches",onExport:async()=>{let e=await v(`/api/branches${window.location.search?window.location.search+"&":"?"}limit=10000`);if(e.ok)E(e.data.data,"Data_Cabang");else throw new Error("Gagal mengambil data")},onTemplate:()=>{E([{"Kode Cabang":"001","Nama Pendek":"Pondok Bambu","Nama Lengkap":"001. Pondok Bambu",Kota:"Jakarta Timur"},{"Kode Cabang":"002","Nama Pendek":"Bintaro","Nama Lengkap":"002. Bintaro",Kota:"Tangerang Selatan"}],"Template_Import_Cabang")},onImport:async e=>{let i=e.map(l=>({code:String(l["Kode Cabang"]||"").trim(),name:String(l["Nama Pendek"]||"").trim(),full_name:String(l["Nama Lengkap"]||"").trim(),city:String(l.Kota||"").trim()})).filter(l=>l.code&&l.name),a=await v("/api/branches/import",{method:"POST",body:JSON.stringify(i)});if(!a.ok)throw new Error(a.data?.error||"Import gagal")}}})}I();async function Wt(t){let e=new Date,i=[],a=!1,l=null,c=null;t.innerHTML=`
    <div class="page-header">
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),m()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),m()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.getElementById("cal-refresh-btn").addEventListener("click",()=>{o(),m(!0)}),document.querySelectorAll(".cal-filter").forEach(d=>d.addEventListener("change",()=>m()));let s=d=>{a||(clearTimeout(l),l=setTimeout(()=>{a||(o(),n().then(()=>p()))},300))};Le.on("data:changed",s),c=setInterval(()=>{a||n().then(()=>p())},6e4);let r=()=>{a=!0,clearTimeout(l),clearInterval(c),Le.off("data:changed",s)};async function n(){try{let d=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`,g=await v(`/api/dashboard/calendar?month=${d}`);a||(i=g.data?.data||[])}catch(d){console.warn("[Calendar] Failed to load events:",d)}}function o(){let d=document.getElementById("cal-sync-status");d&&(d.textContent="\u{1F504} Memuat...",d.className="cal-sync-badge sync-loading",setTimeout(()=>{a||(d.textContent="\u{1F7E2} Real-Time Live",d.className="cal-sync-badge sync-live")},1200))}async function m(d=!1){let g=document.getElementById("calendar-grid");g&&((d||i.length===0)&&(g.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
  ...
  `;se({title:`Notifikasi (${Ce.length})`,content:t,confirmText:"Tutup",onConfirm:(e,i)=>i()})}function la(){let t=ue(),e=(t?.full_name||"U")[0].toUpperCase();document.getElementById("app").innerHTML=`
  ...
  `;let i=document.getElementById("sidebar"),a=document.getElementById("sidebar-overlay"),l=document.getElementById("topbar-menu-btn"),c=document.getElementById("sidebar-close"),s=()=>{i.classList.add("open"),a.classList.add("show")},r=()=>{i.classList.remove("open"),a.classList.remove("show")};l?.addEventListener("click",s),c?.addEventListener("click",r),a?.addEventListener("click",r),document.querySelectorAll(".nav-item").forEach(o=>o.addEventListener("click",r));function n(){let o=window.location.hash.replace("#","")||"/dashboard";document.querySelectorAll(".nav-item").forEach(d=>{let g=d.dataset.route;d.classList.toggle("active",o===g||g!=="/dashboard"&&o.startsWith(g))});let m=document.getElementById("topbar-title"),p=document.querySelector(".nav-item.active .nav-label");m&&p&&(m.textContent=p.textContent)}window.addEventListener("hashchange",n),n(),Ma(),document.getElementById("btn-fullscreen")?.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.()}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await v("/api/auth/logout",{method:"POST"}),De(),Fe&&clearInterval(Fe),ye("/login")}),Ka(),Ra(),document.getElementById("btn-notif")?.addEventListener("click",o=>{o.preventDefault(),qa()})}async function Ha(){M("/login",({main:e})=>At(e)),M("/dashboard",K(({main:e})=>Pt(e))),M("/calendar",K(({main:e})=>Wt(e))),M("/employees",K(({main:e,params:i})=>Nt(e,i))),M("/contracts",K(({main:e,params:i})=>Ue(e,i))),M("/sp",K(({main:e})=>ia(e))),M("/mutasi",K(({main:e})=>sa(e))),M("/timeline",K(({main:e,params:i})=>Ft(e,i))),M("/issues",K(({main:e,params:i})=>Mt(e,i))),M("/one-on-one",K(({main:e,params:i})=>Kt(e,i))),M("/training",K(({main:e})=>Rt(e))),M("/relievers",K(({main:e,params:i})=>qt(e,i))),M("/reports/inspection",K(({main:e})=>Ht(e))),M("/reports/cleaning",K(({main:e})=>jt(e))),M("/reports/fogging",K(({main:e})=>Ut(e))),M("/reports/basecamp",K(({main:e})=>Jt(e))),M("/reports/supply",K(({main:e})=>ht(e,"supply"))),M("/sop",K(({main:e})=>Gt(e))),M("/checklist",K(({main:e})=>Qt(e))),M("/forms",K(({main:e})=>ht(e))),M("/users",K(({main:e})=>Vt(e))),M("/branches",K(({main:e})=>zt(e))),M("/profile",K(({main:e})=>Yt(e))),M("/settings/import",K(({main:e})=>aa(e)));let t=Ee();if(!t&&window.location.hash!=="#/login"&&ye("/login"),t){let e=await v("/api/auth/me");e.ok?(Ie(e.data.data),la()):(De(),ye("/login"))}window.addEventListener("fm:login",()=>{la(),ye("/dashboard")}),ft()}Ha();
