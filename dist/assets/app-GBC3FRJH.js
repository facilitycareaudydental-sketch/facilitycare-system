var oa=Object.defineProperty;var at=(t,e)=>()=>(t&&(e=t(t=0)),e);var nt=(t,e)=>{for(var l in e)oa(t,l,{get:e[l],enumerable:!0})};var ke={};nt(ke,{API:()=>yt,CLIENT_SIDE_MAX_ROWS:()=>be,IS_DEVELOPMENT:()=>Pe,apiFetch:()=>k,clearToken:()=>Le,getToken:()=>Be,getUser:()=>he,setToken:()=>it,setUser:()=>Ne});function Be(){return localStorage.getItem("fm_token")}function it(t){localStorage.setItem("fm_token",t)}function Le(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function he(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Ne(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function k(t,e={}){let l=Be(),a={"Content-Type":"application/json",...l?{Authorization:`Bearer ${l}`}:{},...e.headers||{}};try{let s=`cb=${Date.now()}`,d=t.includes("?")?"&":"?",i=`${yt}${t}${d}${s}`,r=await fetch(i,{...e,headers:a}),n;try{let o=await r.text();try{n=JSON.parse(o)}catch{n={error:`Server Error (${r.status}): ${o.substring(0,80)}...`}}}catch{n={error:"Gagal membaca respon dari server"}}return r.status===401&&(Le(),window.location.hash="#/login"),{ok:r.ok,status:r.status,data:n}}catch(s){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${s.message})`}}}}var Pe,da,yt,be,F=at(()=>{Pe=!1,da="https://fm-operations-api.facilitycare-audydental.workers.dev",yt=da,be=1e4});var kt={};nt(kt,{confirmDialog:()=>Fe,createModal:()=>se});function se({title:t,content:e,onConfirm:l,onCancel:a,confirmText:s="Simpan",cancelText:d="Batal",size:i="md",confirmClass:r="btn-primary"}){let n={sm:"400px",md:"560px",lg:"720px",xl:"900px"},o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
  ...
  `}var K=at(()=>{});F();var rt={},Je=null;function J(t,e){rt[t]=e}function Se(t){window.location.hash=t}function ft(){async function t(){let e=window.location.hash.replace("#","")||"/dashboard",[l,...a]=e.split("?"),s=rt[l];if(!s){for(let[i,r]of Object.entries(rt))if(i.endsWith("/*")&&l.startsWith(i.slice(0,-2))){s=r;break}}Je&&(Je(),Je=null);let d=document.getElementById("main-content");if(d&&(d.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),s){let i=new URLSearchParams(a.join("?")),r=l.split("/").filter(Boolean),n=await s({path:l,params:i,segments:r,main:d});n&&(Je=n)}else{let i=d||document.getElementById("app");i&&(i.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",t),t()}var Ae;function ca(){return Ae||(Ae=document.createElement("div"),Ae.id="toast-container",document.body.appendChild(Ae)),Ae}function vt(t,e="info",l=3500){let a=ca(),s=document.createElement("div");s.className=`toast toast-${e}`;let d={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};s.innerHTML=`<span class="toast-icon">${d[e]||"\u2139"}</span><span class="toast-msg">${t}</span>`,a.appendChild(s),requestAnimationFrame(()=>s.classList.add("show")),setTimeout(()=>{s.classList.remove("show"),setTimeout(()=>s.remove(),350)},l)}var Z=t=>vt(t,"success"),G=t=>vt(t,"error");ye();F();F();ye();function Ue({columns:t,data:e,onEdit:l,onDelete:a,onView:s,actions:d=[],emptyText:i="Tidak ada data",bulkSelect:r=null}){let n=document.createElement("div");if(n.className="table-wrapper",!e||e.length===0)return n.innerHTML=`<div class="empty-state"><p>${i}</p></div>`,n;let o=document.createElement("table");o.className="data-table";let u=document.createElement("thead"),c=document.createElement("tr");if(r){let g=document.createElement("th");g.style.width="40px",g.style.textAlign="center";let y=document.createElement("input");y.type="checkbox",y.id="select-all-checkbox",y.title="Pilih semua",y.addEventListener("change",()=>{e.forEach(m=>{y.checked?r.selectedIds.add(m.id):r.selectedIds.delete(m.id)}),n.querySelectorAll(".row-checkbox").forEach(m=>m.checked=y.checked),r.onToggle()}),g.appendChild(y),c.appendChild(g)}if(t.forEach(g=>{let y=document.createElement("th");y.textContent=g.label,g.width&&(y.style.width=g.width),c.appendChild(y)}),l||a||s||d.length>0){let g=document.createElement("th");g.textContent="Aksi",g.style.width="120px",c.appendChild(g)}u.appendChild(c),o.appendChild(u);let p=document.createElement("tbody");return e.forEach(g=>{let y=document.createElement("tr");if(r){let m=document.createElement("td");m.style.textAlign="center",m.style.width="40px";let b=document.createElement("input");b.type="checkbox",b.className="row-checkbox",b.checked=r.selectedIds.has(g.id),b.addEventListener("change",()=>{if(b.checked)r.selectedIds.add(g.id);else{r.selectedIds.delete(g.id);let h=document.getElementById("select-all-checkbox");h&&(h.checked=!1)}r.onToggle()}),m.appendChild(b),y.appendChild(m)}if(t.forEach(m=>{let b=document.createElement("td");if(m.render){let h=m.render(g[m.key],g);h instanceof HTMLElement?b.appendChild(h):b.innerHTML=h||""}else b.textContent=g[m.key]!==null&&g[m.key]!==void 0&&g[m.key]!==""?g[m.key]:"";m.nowrap&&(b.style.whiteSpace="nowrap"),y.appendChild(b)}),l||a||s||d.length>0){let m=document.createElement("td");m.className="actions-cell";let b=document.createElement("div");if(b.className="btn-group",s){let h=document.createElement("button");h.className="btn btn-xs btn-ghost",h.innerHTML="\u{1F441}",h.title="Lihat",h.addEventListener("click",()=>s(g)),b.appendChild(h)}if(l){let h=document.createElement("button");h.className="btn btn-xs btn-secondary",h.innerHTML="\u270F\uFE0F",h.title="Edit",h.addEventListener("click",()=>l(g)),b.appendChild(h)}d.forEach(h=>{let _=document.createElement("button");_.className=`btn btn-xs ${h.class||"btn-ghost"}`,_.innerHTML=h.icon||h.label,_.title=h.label,_.addEventListener("click",()=>h.handler(g)),b.appendChild(_)}),m.appendChild(b),y.appendChild(m)}p.appendChild(y)}),o.appendChild(p),n.appendChild(o),n}function Ge({page:t,pages:e,total:l,limit:a,onPage:s}){if(e<=1)return null;let d=document.createElement("div");d.className="pagination";let i=document.createElement("span");i.className="pagination-info",i.textContent=`Total: ${l} data`,d.appendChild(i);let r=document.createElement("div");r.className="pagination-btns";let n=(c,p,g=!1,y=!1)=>{let m=document.createElement("button");m.className=`btn btn-sm ${y?"btn-primary":"btn-ghost"} pagination-btn`,m.textContent=c,m.disabled=g,m.addEventListener("click",()=>s(p)),r.appendChild(m)};n("\xAB",1,t===1),n("\u2039",t-1,t===1);let o=Math.max(1,t-2),u=Math.min(e,t+2);for(let c=o;c<=u;c++)n(c,c,!1,c===t);return n("\u203A",t+1,t===e),n("\xBB",e,t===e),d.appendChild(r),d}ye();function Me(t){return t.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="html")return e.html||"";if(e.type==="row")return`<div class="form-row">${Me(e.fields)}</div>`;let l=e.required?"required":"",a=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",s="";switch(e.type){case"textarea":s=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${l} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let i=(e.options||[]).map(c=>{let p=typeof c=="object"?c.value:c,g=typeof c=="object"?c.label:c,y=e.value==p?"selected":"";return`<option value="${p}" ${y}>${g}</option>`}).join("");s=`<select name="${e.name}" class="form-control" ${l}><option value="">-- Pilih ${e.label||""} --</option>${i}</select>`;break;case"combobox":let r=`dl-${e.name}-${Math.random().toString(36).substring(7)}`,n=(e.options||[]).map(c=>{let p=typeof c=="object"?c.value:c,g=typeof c=="object"?c.label||c.value||"":c||"";return(g==="undefined"||g==="[object Object]"||g==="null")&&(g=""),g?`<option value="${g}"></option>`:""}).join(""),o=e.value||"";if(e.value){let c=(e.options||[]).find(p=>(typeof p=="object"?p.value:p)==e.value);if(c){let p=typeof c=="object"?c.label||c.value||"":c||"";p&&p!=="undefined"&&p!=="[object Object]"&&p!=="null"&&(o=p)}}s=`
          <input type="text" name="${e.name}" list="${r}" class="form-control" value="${o}" placeholder="Pilih atau ketik baru..." ${l} autocomplete="off">
          <datalist id="${r}">${n}</datalist>
        `;break;case"checkbox":s=`<label class="checkbox-label"><input type="checkbox" name="${e.name}" value="1" ${e.value?"checked":""}> ${e.checkLabel||e.label}</label>`;break;case"date":let u=window.parseFlexibleDate&&e.value?window.parseFlexibleDate(e.value):e.value||"";s=`<input type="date" name="${e.name}" class="form-control" value="${u}" ${l}>`;break;case"number":s=`<input type="number" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" min="${e.min||""}" max="${e.max||""}" step="${e.step||"1"}" ${l}>`;break;case"email":s=`<input type="email" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${l}>`;break;case"url":s=`<input type="url" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||"https://..."}" ${l}>`;break;default:s=`<input type="${e.type||"text"}" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${l} autocomplete="off">`}let d=e.hint?`<div class="form-hint">${e.hint}</div>`:"";return`<div class="form-group ${e.class||""}">${a}${s}${d}</div>`}).join("")}function Qe(t){let e={},l=new FormData(t);for(let[a,s]of l.entries())e[a]=s===""?null:s;return t.querySelectorAll("input[type=checkbox]").forEach(a=>{a.checked||(e[a.name]=null)}),e}function ze(t,e){e&&Object.entries(e).forEach(([l,a])=>{let s=t.querySelector(`[name="${l}"]`);s&&(s.hasAttribute("list")||(s.type==="checkbox"?s.checked=!!a:s.type==="date"&&a&&window.parseFlexibleDate?s.value=window.parseFlexibleDate(a):s.value=a??""))})}K();function L({container:t,title:e,icon:l,apiPath:a,columns:s,formFields:d,filterFields:i,defaultFilters:r={},itemLabel:n="Data",canCreate:o=!0,canEdit:u=!0,canDelete:c=!0,onBeforeSubmit:p,onAfterLoad:g,onDataLoaded:y,extraActions:m=[],initialSearch:b="",exportOptions:h=null,bulkDelete:_=!1,paginationMode:C="server"}){let S=1,x={...r};b&&(x.search=b);let w=new Set;t.innerHTML=`
  ...
  </div>`).join("");function _t(t=3){return Array(t).fill(0).map((e,l)=>`<div class="skeleton skeleton-text" style="height:38px;margin-bottom:${l<t-1?"6px":"0"};border-radius:6px"></div>`).join("")}async function re(t,e,l=8e3){try{let a=new AbortController,s=setTimeout(()=>a.abort(),l),d=await k(t,{signal:a.signal}).catch(()=>null);if(clearTimeout(s),!d||!d.ok)return e;let i=d.data;return i?i.data!==void 0?i.data??e:i:e}catch{return e}}function ya(){["skel-donut","skel-trend","skel-insp","skel-contract","skel-jadwal"].forEach(a=>{let s=document.getElementById(a);s&&(s.style.display="none")}),["chart-donut","chart-trend","chart-insp","chart-contract","chart-jadwal"].forEach(a=>{let s=document.getElementById(a);if(s&&s.style.display==="none"){s.style.display="block";let d=s.parentElement;if(d&&!d.querySelector(".chart-empty")){let i=document.createElement("div");i.className="chart-empty",i.textContent="Belum ada data",s.style.display="none",d.appendChild(i)}}});let t=document.getElementById("kpi-row");t&&t.querySelector(".skeleton")&&Et({});let e=document.getElementById("mini-stats-row");e&&e.querySelector(".skeleton")&&$t({}),["table-contracts","table-issues"].forEach(a=>{let s=document.getElementById(a);s&&s.querySelector(".skeleton")&&(s.innerHTML='<div class="chart-empty">Belum ada data</div>')});let l=document.getElementById("activity-log");l&&l.querySelector(".skeleton")&&(l.innerHTML='<div class="chart-empty">Belum ada aktivitas</div>')}async function Tt(t){pa(),t._dashRefresh&&clearInterval(t._dashRefresh),t._skelTimeout&&clearTimeout(t._skelTimeout);let e=new Date().toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});t.innerHTML=`
  ...
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>pt(t)),document.getElementById("filter-jadwal-year")?.addEventListener("change",async l=>{let a=l.target.value;document.getElementById("jadwal-year-label").textContent=a;let s=document.getElementById("skel-jadwal"),d=document.getElementById("chart-jadwal");s&&(s.style.display="block",s.style.position="absolute"),d&&(d.style.display="none");let i=await re(`/api/dashboard/schedule-chart?year=${a}`,{},8e3);try{Dt(i)}catch(r){console.warn("ScheduleChart render:",r),ce("skel-jadwal","chart-jadwal")}}),document.getElementById("filter-insp-month")?.addEventListener("change",async l=>{let a=l.target.value,s=a?`/api/dashboard/inspection-bar?month=${a}`:"/api/dashboard/inspection-bar",d=document.getElementById("skel-insp"),i=document.getElementById("chart-insp");d&&(d.style.display="block",d.style.position="absolute"),i&&(i.style.display="none");let r=await re(s,{},8e3);try{It(r)}catch(n){console.warn("InspBar render:",n),ce("skel-insp","chart-insp")}}),t._skelTimeout=setTimeout(()=>ya(),5e3),await pt(t),t._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?pt(t):clearInterval(t._dashRefresh)},6e4)}async function pt(t){t._skelTimeout&&(clearTimeout(t._skelTimeout),t._skelTimeout=null);let[e,l,a,s,d,i,r,n,o,u,c,p]=await Promise.all([re("/api/dashboard/kpi",{},8e3),re("/api/dashboard/issues-trend",{},8e3),re("/api/dashboard/issues-summary",{},8e3),re("/api/dashboard/stats",{},8e3),re("/api/dashboard/calendar",[],8e3),re("/api/schedule?limit=10000",{data:[]},8e3),re("/api/employees?limit=10000",{data:[]},8e3),re("/api/contracts?limit=10000",{data:[]},8e3),re("/api/issues?limit=10000",{data:[]},8e3),re("/api/one-on-one?limit=10000",{data:[]},8e3),re("/api/dashboard/contracts-chart",{labels:[],data:[]},8e3),re(`/api/dashboard/schedule-chart?year=${document.getElementById("filter-jadwal-year")?.value||new Date().getFullYear()}`,{},8e3)]),g=document.getElementById("filter-insp-month"),y=g?g.value:"",m=y?`/api/dashboard/inspection-bar?month=${y}`:"/api/dashboard/inspection-bar",b=await re(m,{},8e3);if(e){let h=Array.isArray(i?.data)?i.data:Array.isArray(i)?i:[],_=Array.isArray(r?.data)?r.data:Array.isArray(r)?r:[],C=Array.isArray(n?.data)?n.data:Array.isArray(n)?n:[],S=Array.isArray(o?.data)?o.data:Array.isArray(o)?o:[],x=Array.isArray(u?.data)?u.data:Array.isArray(u)?u:[];e.employees&&(e.employees.current=_.filter(w=>St(w,"active")).length),e.contracts&&(e.contracts.current=C.filter(w=>dt(w,"active")).length),e.expiring30&&(e.expiring30={current:C.filter(w=>dt(w,"expiring30")).length}),e.issues&&(e.issues.current=S.filter(w=>xt(w,"open")).length),e.one_on_one&&(e.one_on_one.current=x.filter(w=>wt(w,"pending")).length),e.inspection_month&&(e.inspection_month.current=h.filter(w=>ot(w,"inspeksi")).length),e.cleaning_month&&(e.cleaning_month.current=h.filter(w=>ot(w,"gcdc")).length)}try{Et(e)}catch(h){console.warn("KPI render:",h)}try{$t(e)}catch(h){console.warn("MiniStats render:",h)}try{Dt(p)}catch(h){console.warn("ScheduleChart render:",h),ce("skel-jadwal","chart-jadwal")}try{fa(Array.isArray(a?.by_category)?a.by_category:[])}catch(h){console.warn("Donut render:",h),ce("skel-donut","chart-donut")}try{va(l)}catch(h){console.warn("Trend render:",h),ce("skel-trend","chart-trend")}try{It(b)}catch(h){console.warn("InspBar render:",h),ce("skel-insp","chart-insp")}try{let h=Array.isArray(s)?s:Array.isArray(s?.recent_issues)?s.recent_issues:[];Sa(h)}catch(h){console.warn("IssuesTable render:",h)}try{let h=Array.isArray(s?.expiring_contracts)?s.expiring_contracts:[];ka(c)}catch(h){console.warn("ContractsTable render:",h)}try{xa(Array.isArray(d)?d:[])}catch(h){console.warn("Agenda render:",h)}try{wa()}catch(h){console.warn("Quick Actions render:",h)}}function Et(t){let e=document.getElementById("kpi-row");if(!e)return;t=t||{};let l=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees?dash_filter=active",color:"kpi-blue",key:"employees",trendPct:"+2%",trendColor:"#10B981",points:"0,20 10,18 20,22 30,12 40,15 50,8 60,10 70,5 80,6 90,2 100,0"},{icon:"\u{1F504}",label:"Reliefer Aktif",sub:"Karyawan reliefer",href:"#/employees?dash_filter=reliefer",color:"kpi-purple",key:"reliever_total",trendPct:"0%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts?dash_filter=active",color:"kpi-green",key:"contracts",trendPct:"+1%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u23F3",label:"Kontrak Habis 30 Hari",sub:"Akan segera berakhir",href:"#/contracts?dash_filter=expiring30",color:"kpi-warn",key:"expiring30",trendPct:"+25%",trendColor:"#F59E0B",points:"0,25 20,22 40,24 60,15 80,18 100,5"},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues?dash_filter=open",color:"kpi-red",key:"issues",trendPct:"0%",trendColor:"#EF4444",points:"0,20 20,18 40,22 60,19 80,21 100,20"},{icon:"\u{1F4AC}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one?dash_filter=pending",color:"kpi-purple",key:"one_on_one",trendPct:"+8%",trendColor:"#10B981",points:"0,25 20,15 40,18 60,8 80,10 100,2"}];e.innerHTML=l.map(a=>{let s=pe(t[a.key]?.current,0);return`
      ...
      </a>`}).join(""),e.querySelectorAll(".kpi-value").forEach(a=>{Ct(a,parseInt(a.dataset.target)||0)})}function $t(t){let e=document.getElementById("mini-stats-row");if(!e)return;t=t||{};let l=[{icon:"\u{1F4C5}",label:"Jadwal",val:t.schedule?.current,href:"#/timeline",color:"mini-blue"},{icon:"\u{1F393}",label:"Training",val:t.training_month?.current,href:"#/training",color:"mini-gray"},{icon:"\u{1F504}",label:"Reliefer",val:t.reliever_completed?.current,href:"#/relievers?dash_filter=reliever",color:"mini-teal"},{icon:"\u{1F50D}",label:"Inspeksi",val:t.inspection_month?.current,href:"#/timeline?dash_filter=inspeksi",color:"mini-blue"},{icon:"\u{1F9F9}",label:"GCDC",val:t.cleaning_month?.current,href:"#/timeline?dash_filter=gcdc",color:"mini-green"},{icon:"\u{1F4A8}",label:"Fogging",val:t.fogging_month?.current,href:"#/reports/fogging",color:"mini-purple"},{icon:"\u{1F3E2}",label:"Cabang",val:t.branches?.current,href:"#/branches",color:"mini-teal"}];e.innerHTML=l.map(a=>`
    ...
    </a>`).join(""),e.querySelectorAll(".mini-stat-value").forEach(a=>Ct(a,parseInt(a.dataset.target)||0,700))}function fa(t){ce("skel-donut","chart-donut");let e=document.getElementById("chart-donut"),l=document.getElementById("donut-legend");if(!e||!l)return;Ee("donut");let a=(t||[]).filter(n=>pe(n.count)>0);if(!a.length){Ke(e,"Belum ada data permasalahan");return}let s=a.map(n=>`${Ce(n.category,"Lainnya")}`),d=a.map(n=>pe(n.count)),i=d.reduce((n,o)=>n+o,0);l.innerHTML=a.map((n,o)=>{let u=ct[o%ct.length],c=i>0?Math.round(n.count/i*100):0;return`
    ...
    <div class="dash-list">
      ...
      `).join("")}
    </div>`}function xa(t){let e=document.getElementById("widget-agenda");if(!e)return;let l=new Date,a=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}-${String(l.getDate()).padStart(2,"0")}`,d=(t||[]).filter(i=>(i.event_date||"").startsWith(a)).slice(0,10);if(!d.length){e.innerHTML="";return}e.innerHTML=`
    <div style="display:flex;flex-direction:column;gap:12px;padding-right:8px">
      ${d.map(i=>{let r="#3B82F6",n="#EFF6FF",o="Agenda",u=(i.title||"").toLowerCase();return u.includes("inspeksi")?(r="#10B981",n="#ECFDF5",o="Inspeksi"):u.includes("cleaning")||u.includes("gcdc")?(r="#3B82F6",n="#EFF6FF",o="Cleaning"):u.includes("reliefer")?(r="#F59E0B",n="#FFFBEB",o="Reliefer"):u.includes("fogging")&&(r="#8B5CF6",n="#F5F3FF",o="Fogging"),`
  ...
  `).join("")}function ce(t,e){let l=document.getElementById(t),a=document.getElementById(e);if(l&&(l.style.display="none",l.style.position=""),a){a.style.display="block";let s=a.parentElement;if(s){let d=s.querySelector(".chart-empty");d&&d.remove()}}}function Ke(t,e="Belum ada data"){if(!t)return;t.style.display="none";let l=t.parentElement;if(!l)return;if(!l.querySelector(".chart-empty")){let s=document.createElement("div");s.className="chart-empty",s.textContent=e,l.appendChild(s)}}F();async function Pt(t){document.getElementById("app").innerHTML=`
...
`)}let x=o(_,h),w=null;return x||(w="Karyawan tidak ditemukan di Database"),{isValid:!!x,invalidReason:w,rowNum:h,data:{employee_id:x,branch_id:n(String(m.Cabang||"").trim()),division:String(m["Div / Bagian"]||"").trim()||"FACILITY CARE",start_date:S,end_date:u(m["Tanggal Selesai"])||"2099-12-31",status:String(m.Status||"").trim(),_rawName:_}}}),p=[],g=[];if(c.forEach(m=>{m.isValid?p.push(m.data):g.push({rowNum:m.rowNum,name:m.data._rawName,reason:m.invalidReason})}),console.log(`Split Validation - Valid: ${p.length}, Invalid: ${g.length}`),p.length===0)return{inserted:0,skipped:a.length,failed:a.length};let y=await k("/api/import/contracts",{method:"POST",body:JSON.stringify({rows:p,onDuplicate:"update"})});if(!y.ok)throw new Error(y.data?.error||"Import gagal");return y.data}}})}F();K();var gt=[],He=[];function $a(t){if(!Array.isArray(t))return"Q3";let e=["Q4","Q3","Q2","Q1"];for(let l of e)if(t.some(a=>a.period===l))return l;return"Q3"}function Da(t,e){if(t.period!=="Q3")return!1;let l=String(t.status||"").toLowerCase();if(l!=="selesai"&&l!=="completed"&&l!=="done")return!1;let a=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?a.includes("inspeksi"):e==="gcdc"?a.includes("general cleaning")||a.includes("deep cleaning"):!1}async function At(t,e){gt=await H();let l=await ee();He=["BERLIN ARIANSYAH","ADE SURAHMAN"];let a=o=>o&&!He.find(u=>(typeof u=="object"?u.value:u)===o)?[...He,o]:He,s=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`),d=o=>{if(!o||o==="-"||String(o).trim()==="")return"";let u=String(o).split("-");return u.length===3&&u[0].length===4?`${u[2]}-${u[1]}-${u[0]}`:o},i=s.data?.data||[],r=$a(i),n=e?e.get("dash_filter"):null;L({container:t,title:"Jadwal Kegiatan",icon:"\u{1F4C5}",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",paginationMode:"client",defaultFilters:n?{period:"Q3"}:{period:r},onDataLoaded:o=>(n&&(o=o.filter(u=>Da(u,n))),o.sort((u,c)=>{let p=u.opening_date?new Date(u.opening_date).getTime():0;return(c.opening_date?new Date(c.opening_date).getTime():0)-p})),columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:o=>st(o)},{key:"period",label:"Periode",render:o=>oe(o)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:o=>d(o)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:o=>d(o)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:o=>d(o)},{key:"status",label:"Status",render:o=>q(o)}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:gt},{type:"select",name:"activity_type",label:"Kegiatan",options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"]},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"select",name:"pic",label:"PIC",options:He}],formFields:o=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:gt,value:o?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"],value:o?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:o?.period},{name:"pic",label:"PIC",type:"combobox",options:a(o?.pic),value:o?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:o?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:o?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:o?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:o?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:o?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let o=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`);if(o.ok){let u=o.data.data.map(c=>({Cabang:c.branch_name||"",Kegiatan:c.activity_type||"",Periode:c.period||"",PIC:c.pic||"","Tgl Opening":c.opening_date||"","Tgl Target":c.target_date||"","Tgl Selesai":c.completion_date||"",Status:c.status||""}));B(u,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{B([{Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done"}],"Template_Import_Jadwal")},onImport:async o=>{let c=(await k("/api/branches?all=1")).data?.data||[],p=b=>{if(!b)return null;let h=String(b||"").toLowerCase(),_=c.find(C=>String(C.full_name||"").toLowerCase()===h||String(C.code||"").toLowerCase()===h||String(C.name||"").toLowerCase()===h);return _?_.id:null},g=b=>{if(b==null||b==="")return"";if(b instanceof Date&&!isNaN(b.getTime()))return b.toISOString().slice(0,10);let h=String(b).trim();if(h===""||h==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(h))return h.slice(0,10);if(/^\d{4,5}$/.test(h)){let C=Number(h);if(C>2e4&&C<99999){let S=new Date(Date.UTC(1899,11,30)+C*864e5);return isNaN(S.getTime())?"":S.toISOString().slice(0,10)}}let _=h.split(/[\/\-\.]/);if(_.length===3){let[C,S,x]=_.map(w=>w.trim());if(C.length===4&&S.length<=2&&x.length<=2)return`${C}-${S.padStart(2,"0")}-${x.padStart(2,"0")}`;if(x.length===4&&S.length<=2&&C.length<=2)return`${x}-${S.padStart(2,"0")}-${C.padStart(2,"0")}`}return h},y=o.map(b=>({branch_id:p(String(b.Cabang||"").trim()),activity_type:String(b.Kegiatan||"").trim(),period:String(b.Periode||"").trim(),pic:String(b.PIC||b.Pic||"").trim(),opening_date:g(b["Tgl Opening"]||b["Tanggal Opening"]||b["Tgl Openir"]),target_date:g(b["Tgl Target"]||b["Tanggal Target"]),completion_date:g(b["Tgl Selesai"]||b["Tanggal Selesai"]),status:String(b.Status||"").trim(),notes:String(b.Catatan||b.Keterangan||"").trim()})).filter(b=>b.activity_type&&b.period),m=await k("/api/import/schedule",{method:"POST",body:JSON.stringify({rows:y,onDuplicate:"update"})});if(!m.ok)throw new Error(m.data?.error||"Import gagal");return m.data}}})}F();K();var bt=[],Ye=[];function Ia(t,e){let l=String(t.status||"").toLowerCase();return e==="open"?l==="open":!1}async function Ft(t,e){let l=e?e.get("dash_filter"):null;bt=await H(),Ye=await ee();let a=i=>i&&!Ye.find(r=>r.value===i)?[...Ye,{value:i,label:i}]:Ye,s=new Date().getFullYear();L({container:t,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,itemLabel:"Permasalahan",paginationMode:"client",onDataLoaded:i=>l?i.filter(r=>Ia(r,l)):i,columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:i=>window.formatDate(i)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:i=>`<span class="badge badge-secondary">${i}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:i=>`<span title="${i}">${i?.length>50?i.slice(0,50)+"\u2026":i}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:i=>`<span title="${i||""}">${i?.length>40?i.slice(0,40)+"\u2026":i||"-"}</span>`},{key:"status",label:"Status",render:i=>q(i)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:i=>window.formatDate(i)},{key:"day_count",label:"Hari",render:i=>i??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"select",name:"branch_id",label:"Cabang",options:bt},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:["2025","2026","2027","2028","2029","2030"]}],formFields:i=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:i?.report_date},{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:bt,value:i?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:i?.category},{name:"source",label:"Sumber Laporan",type:"combobox",options:["SPV","AM","RCP","Perawat","FC","Berlin","Ade","Pattrel","Dentrel"],value:i?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:i?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"combobox",options:a(i?.employee_name),value:i?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"combobox",options:a(i?.fc_specialist),value:i?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:i?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:i?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:i?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let i=await k(`/api/issues${window.location.search?window.location.search+"&":"?"}limit=10000`);if(i.ok){let r=i.data.data.map(n=>({Tanggal:n.report_date||"",Cabang:n.branch_name||"",Kategori:n.category||"",Sumber:n.source||"",Keluhan:n.complaint||"","Nama FC":n.employee_name||"","FC Spesialis":n.fc_specialist||"",Solusi:n.solution||"","Tgl Selesai":n.completion_date||"",Status:n.status||""}));B(r,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{B([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async i=>{let n=(await k("/api/branches?all=1")).data?.data||[],o=p=>{if(!p)return null;let g=String(p||"").toLowerCase(),y=n.find(m=>String(m.full_name||"").toLowerCase()===g||String(m.code||"").toLowerCase()===g||String(m.name||"").toLowerCase()===g);return y?y.id:null},u=i.map(p=>({branch_id:o(String(p.Cabang||"").trim()),report_date:String(p.Tanggal||"").trim(),category:String(p.Kategori||"").trim(),source:String(p.Sumber||"").trim(),complaint:String(p.Keluhan||"").trim(),employee_name:String(p["Nama FC"]||"").trim(),fc_specialist:String(p["FC Spesialis"]||"").trim(),solution:String(p.Solusi||"").trim(),completion_date:String(p["Tgl Selesai"]||"").trim(),status:String(p.Status||"").trim()})).filter(p=>p.report_date&&p.complaint&&p.category),c=await k("/api/import/issues",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}}})}F();var $e=[];function Pa(t,e){let l=String(t.status||"").toLowerCase();return e==="pending"?l==="pending":!1}async function Mt(t,e){let l=e?e.get("dash_filter"):null;$e=await H();let a=await ee(),s=["Ade","Berlin"],d=r=>r&&!a.find(n=>n.value===r)?[...a,{value:r,label:r}]:a,i=r=>r&&!s.find(n=>(typeof n=="object"?n.value:n)===r)?[...s,r]:s;L({container:t,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,itemLabel:"One on One",paginationMode:"client",onDataLoaded:r=>l?r.filter(n=>Pa(n,l)):r,columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:r=>window.formatDate(r)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:r=>`<span title="${r||""}">${r?.length>50?r.slice(0,50)+"\u2026":r||"-"}</span>`},{key:"solution",label:"Solusi",render:r=>`<span title="${r||""}">${r?.length>40?r.slice(0,40)+"\u2026":r||"-"}</span>`},{key:"status",label:"Status",render:r=>q(r)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:r=>window.formatDate(r)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:r=>r?`<a href="${r}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"combobox",name:"branch_id",label:"Cabang",options:$e},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async r=>{let n=new URLSearchParams(r||{}).toString(),o=await k(`/api/one-on-one?limit=10000&${n}`);if(o.ok){let u=o.data.data.map(p=>({Tanggal:p.meeting_date||"",Cabang:p.branch_name||"","Nama Karyawan":p.employee_name||"",PIC:p.pic||"",Masalah:p.problem||"",Solusi:p.solution||"",Status:p.status||"","Tgl Selesai":p.completion_date||"",Dokumen:p.document_link||""})),{downloadExcel:c}=await Promise.resolve().then(()=>(K(),le));c(u,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let r=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(K(),le));n(r,"Template_Import_OneOnOne")},onImport:async r=>{let n=p=>{if(!p)return null;let g=String(p||"").toLowerCase(),y=$e.find(m=>String(m.label||"").toLowerCase()===g);return y?y.value:null},o=p=>{if(!p)return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let g=String(p).trim();if(/^\d{4,5}$/.test(g)){let m=Number(g);if(m>2e4&&m<99999){let b=new Date(Date.UTC(1899,11,30)+m*864e5);return isNaN(b.getTime())?"":b.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(g))return g.slice(0,10);let y=g.split(/[\/\-\.]/);if(y.length===3){let[m,b,h]=y.map(_=>_.trim());if(m.length===4&&b.length<=2&&h.length<=2)return`${m}-${b.padStart(2,"0")}-${h.padStart(2,"0")}`;if(h.length===4&&b.length<=2&&m.length<=2)return`${h}-${b.padStart(2,"0")}-${m.padStart(2,"0")}`}return g},u=r.map(p=>({meeting_date:o(p.Tanggal),employee_name:String(p["Nama Karyawan"]||"").trim(),branch_id:n(String(p.Cabang||"").trim()),pic:String(p.PIC||"").trim(),problem:String(p.Masalah||"").trim(),solution:String(p.Solusi||"").trim(),status:String(p.Status||"").trim(),completion_date:o(p["Tgl Selesai"]),document_link:String(p.Dokumen||"").trim()})).filter(p=>p.meeting_date&&p.employee_name&&p.branch_id),c=await k("/api/import/one_on_one",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}},formFields:r=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:r?.meeting_date},{name:"branch_id",label:"Cabang",type:"combobox",options:r?.branch_id&&!$e.find(n=>n.value==r.branch_id)?[...$e,{value:r.branch_id,label:r.branch_name||r.branch_id}]:$e,createApi:{path:"/api/branches",field:"full_name"},value:r?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"combobox",required:!0,options:d(r?.employee_name),value:r?.employee_name},{name:"pic",label:"PIC",type:"combobox",options:i(r?.pic),createApi:{path:"/api/pic",field:"name"},value:r?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:r?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:r?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:r?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:r?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:r?.document_link}]})}F();async function Ot(t){let e=await H(),l=await ee(),a=["Ade","Berlin"],s=r=>r&&!l.find(n=>n.value===r)?[...l,{value:r,label:r}]:l,d=r=>r&&!a.find(n=>(typeof n=="object"?n.value:n)===r)?[...a,r]:a,i=Array.from({length:5},(r,n)=>String(new Date().getFullYear()-n));L({container:t,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:r=>window.formatDate(r)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:r=>{try{let n=JSON.parse(r);return Array.isArray(n)?n.join(", "):r||"-"}catch{return r||"-"}}},{key:"score",label:"Nilai",render:r=>r!=null?`<strong>${r}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:r=>r?`<a href="${r}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer..."},{type:"select",name:"year",label:"Tahun",options:i}],exportOptions:{moduleName:"training",onExport:async r=>{let n=new URLSearchParams(r||{}).toString(),o=await k(`/api/training?limit=10000&${n}`);if(o.ok){let u=o.data.data.map(p=>{let g=p.participants||"";try{let y=JSON.parse(g);g=Array.isArray(y)?y.join(", "):g}catch{}return{Tanggal:p.training_date||"",Batch:p.batch||"",Materi:p.subject||"",Cabang:p.branch_name||"",Trainer:p.trainer||"",Peserta:g,Nilai:p.score!==null&&p.score!==void 0?p.score:"",Dokumen:p.document_link||""}}),{downloadExcel:c}=await Promise.resolve().then(()=>(K(),le));c(u,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let r=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(K(),le));n(r,"Template_Import_Training")},onImport:async r=>{let n=p=>{if(!p)return null;let g=String(p||"").toLowerCase(),y=e.find(m=>String(m.label||"").toLowerCase()===g);return y?y.value:null},o=p=>{if(!p)return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let g=String(p).trim();if(/^\d{4,5}$/.test(g)){let m=Number(g);if(m>2e4&&m<99999){let b=new Date(Date.UTC(1899,11,30)+m*864e5);return isNaN(b.getTime())?"":b.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(g))return g.slice(0,10);let y=g.split(/[\/\-\.]/);if(y.length===3){let[m,b,h]=y.map(_=>_.trim());if(m.length===4&&b.length<=2&&h.length<=2)return`${m}-${b.padStart(2,"0")}-${h.padStart(2,"0")}`;if(h.length===4&&b.length<=2&&m.length<=2)return`${h}-${b.padStart(2,"0")}-${m.padStart(2,"0")}`}return g},u=r.map(p=>({training_date:o(p.Tanggal),batch:String(p.Batch||"").trim(),subject:String(p.Materi||"").trim(),branch_id:n(String(p.Cabang||"").trim()),trainer:String(p.Trainer||"").trim(),participants:String(p.Peserta||"").trim(),score:p.Nilai?Number(p.Nilai):null,document_link:String(p.Dokumen||"").trim()})).filter(p=>p.training_date&&p.subject&&p.branch_id),c=await k("/api/import/training",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}},formFields:r=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:r?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:r?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:r?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",options:e,value:r?.branch_id},{name:"trainer",label:"Trainer",type:"combobox",options:d(r?.trainer),value:r?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let n=JSON.parse(r?.participants);return Array.isArray(n)?n.join(", "):r?.participants||""}catch{return r?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:r?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:r?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:r?.notes}],onBeforeSubmit:async r=>(r.participants&&(r.participants=JSON.stringify(r.participants.split(",").map(n=>n.trim()).filter(Boolean))),r)})}F();ye();K();function Rt({container:t,title:e,icon:l,apiPath:a,columns:s,formFields:d,filterFields:i,defaultFilters:r={},itemLabel:n="Data",canCreate:o=!0,canEdit:u=!0,canDelete:c=!0,onBeforeSubmit:p,onAfterLoad:g,onDataLoaded:y,extraActions:m=[],initialSearch:b="",exportOptions:h=null,bulkDelete:_=!1,paginationMode:C="server"}){let S=1,x={...r};b&&(x.search=b);let w=new Set;t.innerHTML=`
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),s()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),s()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.querySelectorAll(".cal-filter").forEach(d=>d.addEventListener("change",s));async function a(){try{let d=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`;l=(await k(`/api/dashboard/calendar?month=${d}`)).data?.data||[]}catch(d){console.warn("[Calendar] Failed to load events, rendering empty grid:",d),l=[]}}async function s(){let d=document.getElementById("calendar-grid");if(d){d.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
      ${Array(35).fill('<div style="background:#f8fafc;min-height:70px;"></div>').join("")}
    </div>`,await a();try{let i=e.getFullYear(),r=e.getMonth(),n=e.toLocaleDateString("id-ID",{month:"long",year:"numeric"}),o=document.getElementById("cal-month-label");o&&(o.textContent=n);let u=new Set(Array.from(document.querySelectorAll(".cal-filter:checked")).map(S=>S.value)),c=l.filter(S=>u.has(S.type)),p={};c.forEach(S=>{let x=(S.event_date||"").slice(0,10);p[x]||(p[x]=[]),p[x].push(S)});let g=new Date(i,r,1).getDay(),y=new Date(i,r+1,0).getDate(),m=["Min","Sen","Sel","Rab","Kam","Jum","Sab"],b=new Date().toISOString().slice(0,10),h='<div class="calendar-grid">';m.forEach(S=>{h+=`<div class="cal-day-header">${S}</div>`});for(let S=0;S<g;S++)h+='<div class="cal-cell cal-cell-empty"></div>';for(let S=1;S<=y;S++){let x=`${i}-${String(r+1).padStart(2,"0")}-${String(S).padStart(2,"0")}`,w=p[x]||[],R=x===b;h+=`
          ...
          </div>`)}}}s()}function Na(t,e){return t?t.length>e?t.slice(0,e)+"\u2026":t:""}function Xe(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function Aa(t){return{schedule:"\u{1F5D3} Jadwal",issue:"\u26A0\uFE0F Permasalahan",reliever:"\u{1F504} Reliefer",training:"\u{1F393} Training",contract_expiry:"\u{1F4CB} Kontrak Habis"}[t]||t}F();async function Wt(t){let e=he(),l=(e?.full_name||e?.username||"U")[0].toUpperCase(),s={superadmin:"#7C3AED",admin:"#2563EB",manager:"#0891B2",spv:"#059669",viewer:"#64748B"}[e?.role]||"#64748B";t.innerHTML=`
    <div class="page-header">
        ...
        <div class="card-body">
          <div class="import-info-box">
            ...
            <div class="import-sheet-list">
              ${Object.entries(Ze).map(([m,{label:b}])=>`<span class="import-sheet-tag">\u{1F4C4} ${m} \u2192 ${b}</span>`).join("")}
            </div>
          </div>
  ...
  `;let e=null,l=null,a=0,s={upload:document.getElementById("step-upload"),validating:document.getElementById("step-validating"),preview:document.getElementById("step-preview"),importing:document.getElementById("step-importing"),summary:document.getElementById("step-summary")};function d(m){Object.entries(s).forEach(([b,h])=>{h.style.display=b===m?"":"none"})}document.getElementById("btn-backup-db")?.addEventListener("click",async()=>{let m=document.getElementById("btn-backup-db");m.disabled=!0,m.textContent="\u23F3 Memproses Backup...";try{let b=await k("/api/import/backup");if(b.ok){if(!window.XLSX){G("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");return}let h=window.XLSX,_=h.utils.book_new();Object.entries(b.data.database).forEach(([C,S])=>{let x=S.length>0?S:[{}],w=h.utils.json_to_sheet(x);h.utils.book_append_sheet(_,w,C.substring(0,31))}),h.writeFile(_,`FCMS_Database_Backup_${new Date().toISOString().slice(0,10)}.xlsx`),Z("Backup berhasil diunduh!")}else G("Gagal memproses backup: "+(b.data?.error||"Unknown error"))}catch(b){G("Gagal memproses backup: "+b.message)}finally{m.disabled=!1,m.textContent="\u{1F4E6} Backup Database"}});let i=document.getElementById("btn-sync-google");i&&i.addEventListener("click",async()=>{if(!confirm("Peringatan: Mensinkronkan data dengan Google Sheets akan memperbarui dan menambahkan data baru dari Google Sheets ke dalam FCMS. Data yang sudah Anda buat di FCMS TIDAK akan terhapus. Lanjutkan?"))return;let m=i.innerHTML;i.innerHTML='<span class="spinner"></span> Menyinkronkan...',i.disabled=!0;try{let b=await k("/api/sync/google-sheets",{method:"POST"});b.ok?alert("Sinkronisasi Berhasil: "+(b.data?.message||"Data Karyawan & PIC telah diperbarui.")):alert("Gagal Sinkronisasi: "+(b.data?.error||"Unknown error"))}catch{alert("Terjadi kesalahan koneksi.")}finally{i.innerHTML=m,i.disabled=!1}}),document.getElementById("btn-download-template").addEventListener("click",()=>{Zt(),Z("Template Excel berhasil didownload!")});let r=document.getElementById("file-input"),n=document.getElementById("upload-zone");document.getElementById("btn-browse").addEventListener("click",m=>{m.stopPropagation(),r.click()}),r.addEventListener("change",m=>{m.target.files[0]&&o(m.target.files[0])}),n.addEventListener("dragover",m=>{m.preventDefault(),n.classList.add("drag-over")}),n.addEventListener("dragleave",()=>n.classList.remove("drag-over")),n.addEventListener("drop",m=>{m.preventDefault(),n.classList.remove("drag-over");let b=m.dataTransfer.files[0];b&&b.name.match(/\.xlsx?$/i)?o(b):G("Hanya file .xlsx atau .xls yang didukung.")}),document.getElementById("btn-clear-file").addEventListener("click",()=>{e=null,r.value="",document.getElementById("file-info").style.display="none",n.style.display="",d("upload")});async function o(m){e=m,document.getElementById("file-name-display").textContent=`\u{1F4C4} ${m.name} (${(m.size/1024).toFixed(1)} KB)`,document.getElementById("file-info").style.display="flex",n.style.display="none",await u(m)}async function u(m){d("validating");let b=document.getElementById("validation-status"),h=document.getElementById("validation-bar");try{if(!window.XLSX)throw new Error("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");b.textContent="Membaca file Excel...",h.style.width="20%",await je(200);let _=await m.arrayBuffer(),C=window.XLSX.read(_,{type:"array",cellDates:!0});b.textContent=`Memvalidasi ${C.SheetNames.length} sheet...`,h.style.width="50%",await je(100),l=Xt(C),h.style.width="100%",b.textContent="Validasi selesai!",await je(300),c()}catch(_){d("upload"),G("Gagal memproses file: "+_.message),document.getElementById("file-info").style.display="flex",n.style.display="none"}}function c(){d("preview");let m=l.filter(E=>!E.skipped).length,b=l.reduce((E,O)=>E+O.total,0),h=l.reduce((E,O)=>E+O.valid,0),_=l.reduce((E,O)=>E+O.errorCount,0),C=b>0?Math.round(h/b*100):0;document.getElementById("preview-summary-badges").innerHTML=`
    ...
    `,S.querySelectorAll(".btn-detail-error").forEach(E=>{E.addEventListener("click",()=>{let O=l[Number(E.dataset.idx)];p(O)})});let x=document.getElementById("error-detail-section"),w=document.getElementById("error-detail-container");w.innerHTML="",x.style.display="none";let R=document.getElementById("btn-start-import");h===0?(R.disabled=!0,R.innerHTML="\u26A0\uFE0F Tidak Ada Data Valid"):(R.disabled=!1,_>0?(R.innerHTML=`\u{1F680} Import ${h} Data Valid (${_} dilewati)`,R.title="Baris error akan dilewati, baris valid tetap diimport"):R.innerHTML=`\u{1F680} Mulai Import ${h} Data`)}function p(m){let b=document.getElementById("error-detail-section"),h=document.getElementById("error-detail-container");b.style.display="";let _=m.errors.slice(0,100).map(C=>(Array.isArray(C.errors)?C.errors:[]).map(x=>{let w=typeof x=="object";return`
          <tr>
    ...
    `,b.scrollIntoView({behavior:"smooth",block:"start"})}document.getElementById("btn-back-to-upload").addEventListener("click",()=>{d("upload"),document.getElementById("file-info").style.display="none",n.style.display="",e=null,r.value=""}),document.getElementById("btn-download-log").addEventListener("click",()=>{if(!l)return;ea(l)?Z("Log error berhasil didownload."):Z("Tidak ada error untuk didownload.")}),document.getElementById("btn-start-import").addEventListener("click",()=>{let m=document.querySelector('input[name="dup-strategy"]:checked')?.value||"skip";g(m)});async function g(m){d("importing"),a=Date.now();let b=[];Oa.forEach(x=>{let w=l?.find(R=>R.module===x&&R.mapped?.length>0);w&&b.push(w)});let h=document.getElementById("import-steps-list");h.innerHTML=b.map(x=>`
    ...
    `).join("");let _=document.getElementById("import-bar"),C=document.getElementById("import-current-status"),S={totalSheets:b.length,totalRows:b.reduce((x,w)=>x+w.mapped.length,0),inserted:0,skipped:0,failed:0,moduleResults:[]};for(let x=0;x<b.length;x++){let w=b[x],R=document.getElementById(`step-icon-${w.module}`),E=document.getElementById(`step-status-${w.module}`);R.textContent="\u{1F504}",E.textContent="Mengimport...",C.textContent=`Mengimport ${w.label}...`,_.style.width=`${Math.round(x/b.length*100)}%`;try{let O=await k(`/api/import/${w.module}`,{method:"POST",body:JSON.stringify({rows:w.mapped,onDuplicate:m})});if(O.ok){let M=O.data;S.inserted+=M.inserted||0,S.skipped+=M.skipped||0,S.moduleResults.push({label:w.label,inserted:M.inserted||0,skipped:M.skipped||0,status:"ok"}),R.textContent="\u2705",E.innerHTML=`<span class="badge badge-success">${M.inserted||0} berhasil</span>${M.skipped>0?` <span class="badge badge-neutral">${M.skipped} skip</span>`:""}`}else S.failed++,S.moduleResults.push({label:w.label,inserted:0,skipped:0,status:"error",error:O.data?.error}),R.textContent="\u274C",E.innerHTML='<span class="badge badge-danger">Gagal</span>'}catch(O){S.failed++,S.moduleResults.push({label:w.label,inserted:0,skipped:0,status:"error",error:O.message}),R.textContent="\u274C",E.innerHTML='<span class="badge badge-danger">Gagal</span>'}await je(150)}_.style.width="100%",C.textContent="Selesai!",await je(400),y(S)}function y(m){d("summary");let b=((Date.now()-a)/1e3).toFixed(1),h=m.failed===0;document.getElementById("summary-status-icon").innerHTML=`
  ...
  `;let e=document.getElementById("btnRefreshSync"),l=document.getElementById("queueStatusFilter");e.addEventListener("click",s),l.addEventListener("change",r),document.getElementById("btnRetryAll").addEventListener("click",()=>a("retry",{allFailed:!0})),document.getElementById("btnResetStuck").addEventListener("click",()=>a("reset-stuck",{})),document.getElementById("btnPauseSync").addEventListener("click",()=>a("pause",{})),document.getElementById("btnResumeSync").addEventListener("click",()=>a("resume",{})),document.getElementById("btnReconcile").addEventListener("click",()=>a("reconcile",{module:"ALL",repairMode:!0})),document.getElementById("btnRetrySelected").addEventListener("click",()=>{let o=Array.from(document.querySelectorAll(".chk-queue:checked")).map(u=>u.value);if(o.length===0)return alert("No items selected");a("retry",{ids:o})}),document.getElementById("chkAllQueue").addEventListener("change",o=>{document.querySelectorAll(".chk-queue").forEach(u=>u.checked=o.target.checked)});async function a(o,u){if(confirm(`Are you sure you want to execute action: ${o}?`)){showLoading();try{let c=await k(`/api/sync/actions/${o}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(u)});c.ok?(alert(c.data?.message||"Success"),s()):G(c.error||"Action failed")}catch(c){G(c.message)}hideLoading()}}await s();async function s(){showLoading(),await Promise.all([i(),r(),d(),n()]),hideLoading()}async function d(){try{let o=await k("/api/sync/performance");if(!o.ok)return;let{webhook:u,google_api:c,d1:p,queue:g,throughput:y}=o.data;document.getElementById("latencyHistograms").innerHTML=`
      ...
      `,document.getElementById("lblSnapshotStatus").innerHTML='Checked 10 modules. Status: <b>COMPLETED</b><br><span class="text-xs text-gray-500">Run today at 02:00</span>'}catch(o){console.error(o)}}async function i(){try{let o=await k("/api/sync/health");if(!o.ok)return G("Failed to fetch sync health");let{status:u,queue:c,circuit_breaker:p}=o.data,g=`
      ...
      `;document.getElementById("syncOverviewCards").innerHTML=g;let y=document.getElementById("cbStateBadge"),m=document.getElementById("cbStateDesc"),b=document.getElementById("cbStatusCard");b.className="bg-white rounded-lg shadow p-6 border-l-4",p==="CLOSED"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800",y.textContent="CLOSED",m.textContent="Traffic is flowing normally to Google Sheets.",b.classList.add("border-green-500")):p==="OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800",y.textContent="OPEN",m.textContent="Failing fast. Traffic to Google Sheets is paused due to repeated failures.",b.classList.add("border-red-500")):p==="HALF_OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",y.textContent="HALF-OPEN",m.textContent="Testing recovery. Permitting limited traffic to verify stability.",b.classList.add("border-yellow-500")):y.textContent=p||"UNKNOWN"}catch(o){console.error(o)}}async function r(){try{let o=document.getElementById("queueStatusFilter").value,u=await k("/api/sync/queue?limit=15"+(o?"&status="+o:""));if(!u.ok)return;let c=document.getElementById("queueTableBody"),p=u.data?.data||u.data||[];if(p.length===0){c.innerHTML='<tr><td colspan="6" class="px-4 py-4 text-center text-gray-500">No events found</td></tr>';return}c.innerHTML=p.map(g=>`
      ...
      `).join("")}catch(o){console.error(o)}}async function n(){try{let o=await k("/api/sync/metrics");if(!o.ok)return;let u=document.getElementById("metricsTableBody"),c=o.data||[];if(c.length===0){u.innerHTML='<tr><td colspan="5" class="px-4 py-4 text-center text-gray-500">No metrics found in last 24h</td></tr>';return}u.innerHTML=c.map(p=>`
        <tr class="hover:bg-gray-50">
