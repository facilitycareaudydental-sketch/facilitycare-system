var fa=Object.defineProperty;var dt=(t,e)=>()=>(t&&(e=t(t=0)),e);var ct=(t,e)=>{for(var i in e)fa(t,i,{get:e[i],enumerable:!0})};var Le={};ct(Le,{API:()=>Et,CLIENT_SIDE_MAX_ROWS:()=>xe,IS_DEVELOPMENT:()=>$e,apiFetch:()=>k,clearToken:()=>We,getToken:()=>Qe,getUser:()=>oe,setToken:()=>pt,setUser:()=>Ve});function Qe(){return localStorage.getItem("fm_token")}function pt(t){localStorage.setItem("fm_token",t)}function We(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function oe(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Ve(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function k(t,e={}){let i=Qe(),a={"Content-Type":"application/json",...i?{Authorization:`Bearer ${i}`}:{},...e.headers||{}};try{let o=`cb=${Date.now()}`,d=t.includes("?")?"&":"?",r=`${Et}${t}${d}${o}`,n=await fetch(r,{...e,headers:a}),s;try{let l=await n.text();try{s=JSON.parse(l)}catch{s={error:`Server Error (${n.status}): ${l.substring(0,80)}...`}}}catch{s={error:"Gagal membaca respon dari server"}}return n.status===401&&(We(),window.location.hash="#/login"),{ok:n.ok,status:n.status,data:s}}catch(o){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${o.message})`}}}}var $e,va,Et,xe,j=dt(()=>{$e=!1,va="https://fm-operations-api.facilitycare-audydental.workers.dev",Et=va,xe=1e4});var mt={};ct(mt,{confirmDialog:()=>Ee,createModal:()=>de});function de({title:t,content:e,onConfirm:i,onCancel:a,confirmText:o="Simpan",cancelText:d="Batal",size:r="md",confirmClass:n="btn-primary"}){let s={sm:"400px",md:"560px",lg:"720px",xl:"900px"},l=document.createElement("div");l.className="modal-overlay",l.innerHTML=`
  ...
  `}var z=dt(()=>{});j();var ut={},at=null;function Y(t,e){ut[t]=e}function Be(t){window.location.hash=t}function Tt(){async function t(){let e=window.location.hash.replace("#","")||"/dashboard",[i,...a]=e.split("?"),o=ut[i];if(!o){for(let[r,n]of Object.entries(ut))if(r.endsWith("/*")&&i.startsWith(r.slice(0,-2))){o=n;break}}at&&(at(),at=null);let d=document.getElementById("main-content");if(d&&(d.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),o){let r=new URLSearchParams(a.join("?")),n=i.split("/").filter(Boolean),s=await o({path:i,params:r,segments:n,main:d});s&&(at=s)}else{let r=d||document.getElementById("app");r&&(r.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",t),t()}var Ye;function ka(){return Ye||(Ye=document.createElement("div"),Ye.id="toast-container",document.body.appendChild(Ye)),Ye}function Dt(t,e="info",i=3500){let a=ka(),o=document.createElement("div");o.className=`toast toast-${e}`;let d={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};o.innerHTML=`<span class="toast-icon">${d[e]||"\u2139"}</span><span class="toast-msg">${t}</span>`,a.appendChild(o),requestAnimationFrame(()=>o.classList.add("show")),setTimeout(()=>{o.classList.remove("show"),setTimeout(()=>o.remove(),350)},i)}var ne=t=>Dt(t,"success"),G=t=>Dt(t,"error");we();j();j();we();function Pe({columns:t,data:e,onEdit:i,onDelete:a,onView:o,actions:d=[],emptyText:r="Tidak ada data",bulkSelect:n=null}){let s=document.createElement("div");if(s.className="table-wrapper",!e||e.length===0)return s.innerHTML=`<div class="empty-state"><p>${r}</p></div>`,s;let l=document.createElement("table");l.className="data-table";let b=document.createElement("thead"),p=document.createElement("tr");if(n){let m=document.createElement("th");m.style.width="40px",m.style.textAlign="center";let y=document.createElement("input");y.type="checkbox",y.id="select-all-checkbox",y.title="Pilih semua",y.addEventListener("change",()=>{e.forEach(g=>{y.checked?n.selectedIds.add(g.id):n.selectedIds.delete(g.id)}),s.querySelectorAll(".row-checkbox").forEach(g=>g.checked=y.checked),n.onToggle()}),m.appendChild(y),p.appendChild(m)}if(t.forEach(m=>{let y=document.createElement("th");y.textContent=m.label,m.width&&(y.style.width=m.width),p.appendChild(y)}),i||a||o||d.length>0){let m=document.createElement("th");m.textContent="Aksi",m.style.width="120px",p.appendChild(m)}b.appendChild(p),l.appendChild(b);let u=document.createElement("tbody");return e.forEach(m=>{let y=document.createElement("tr");if(n){let g=document.createElement("td");g.style.textAlign="center",g.style.width="40px";let f=document.createElement("input");f.type="checkbox",f.className="row-checkbox",f.checked=n.selectedIds.has(m.id),f.addEventListener("change",()=>{if(f.checked)n.selectedIds.add(m.id);else{n.selectedIds.delete(m.id);let v=document.getElementById("select-all-checkbox");v&&(v.checked=!1)}n.onToggle()}),g.appendChild(f),y.appendChild(g)}if(t.forEach(g=>{let f=document.createElement("td");if(g.render){let v=g.render(m[g.key],m);v instanceof HTMLElement?f.appendChild(v):f.innerHTML=v||""}else f.textContent=m[g.key]!==null&&m[g.key]!==void 0&&m[g.key]!==""?m[g.key]:"";g.nowrap&&(f.style.whiteSpace="nowrap"),y.appendChild(f)}),i||a||o||d.length>0){let g=document.createElement("td");g.className="actions-cell";let f=document.createElement("div");if(f.className="btn-group",o){let v=document.createElement("button");v.className="btn btn-xs btn-ghost",v.innerHTML="\u{1F441}",v.title="Lihat",v.addEventListener("click",()=>o(m)),f.appendChild(v)}if(i){let v=document.createElement("button");v.className="btn btn-xs btn-secondary",v.innerHTML="\u270F\uFE0F",v.title="Edit",v.addEventListener("click",()=>i(m)),f.appendChild(v)}d.forEach(v=>{let S=document.createElement("button");S.className=`btn btn-xs ${v.class||"btn-ghost"}`,S.innerHTML=v.icon||v.label,S.title=v.label,S.addEventListener("click",()=>v.handler(m)),f.appendChild(S)}),g.appendChild(f),y.appendChild(g)}u.appendChild(y)}),l.appendChild(u),s.appendChild(l),s}function Ae({page:t,pages:e,total:i,limit:a,onPage:o}){if(e<=1)return null;let d=document.createElement("div");d.className="pagination";let r=document.createElement("span");r.className="pagination-info",r.textContent=`Total: ${i} data`,d.appendChild(r);let n=document.createElement("div");n.className="pagination-btns";let s=(p,u,m=!1,y=!1)=>{let g=document.createElement("button");g.className=`btn btn-sm ${y?"btn-primary":"btn-ghost"} pagination-btn`,g.textContent=p,g.disabled=m,g.addEventListener("click",()=>o(u)),n.appendChild(g)};s("\xAB",1,t===1),s("\u2039",t-1,t===1);let l=Math.max(1,t-2),b=Math.min(e,t+2);for(let p=l;p<=b;p++)s(p,p,!1,p===t);return s("\u203A",t+1,t===e),s("\xBB",e,t===e),d.appendChild(n),d}we();function Te(t){return t.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="html")return e.html||"";if(e.type==="row")return`<div class="form-row">${Te(e.fields)}</div>`;let i=e.required?"required":"",a=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",o="";switch(e.type){case"textarea":o=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${i} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let r=(e.options||[]).map(p=>{let u=typeof p=="object"?p.value:p,m=typeof p=="object"?p.label:p,y=e.value==u?"selected":"";return`<option value="${u}" ${y}>${m}</option>`}).join("");o=`<select name="${e.name}" class="form-control" ${i}><option value="">-- Pilih ${e.label||""} --</option>${r}</select>`;break;case"combobox":let n=`dl-${e.name}-${Math.random().toString(36).substring(7)}`,s=(e.options||[]).map(p=>{let u=typeof p=="object"?p.value:p,m=typeof p=="object"?p.label||p.value||"":p||"";return(m==="undefined"||m==="[object Object]"||m==="null")&&(m=""),m?`<option value="${m}"></option>`:""}).join(""),l=e.value||"";if(e.value){let p=(e.options||[]).find(u=>(typeof u=="object"?u.value:u)==e.value);if(p){let u=typeof p=="object"?p.label||p.value||"":p||"";u&&u!=="undefined"&&u!=="[object Object]"&&u!=="null"&&(l=u)}}o=`
    ...
    <div class="filter-bar card ${s?"has-mobile-sheet":""}" style="padding: 1rem; display: flex; gap: 0.5rem; flex-wrap: wrap;">
        ${r.filter(c=>c.type==="search"||c.type==="search-combo").map(c=>{if(c.type==="search")return`<div class="filter-search" style="flex:1; min-width:120px;"><input type="text" class="form-control" autocomplete="off" placeholder="${c.placeholder||"Cari..."}" id="filter-search" value="${L.search||""}"></div>`;if(c.type==="search-combo"){let h="dl-filter-search",x=(c.options||[]).map(w=>`<option value="${typeof w=="object"?w.label:w}"></option>`).join("");return`<div class="filter-search" style="flex:1; min-width:120px;"><input type="text" list="${h}" class="form-control" autocomplete="off" placeholder="${c.placeholder||"Cari..."}" id="filter-search" value="${L.search||""}"><datalist id="${h}">${x}</datalist></div>`}return""}).join("")}
        ...
        <div class="filter-options" id="filter-options-wrapper">
          ...
          ${r.filter(c=>c.type!=="search"&&c.type!=="search-combo").map(c=>{if(c.type==="select")return`<select class="form-control filter-select" style="flex:1; min-width:100px;" name="${c.name}" id="filter-${c.name}"><option value="">Pilih ${c.label}</option>${(c.options||[]).map(h=>`<option value="${typeof h=="object"?h.value:h}" ${L[c.name]===(typeof h=="object"?h.value:h)?"selected":""}>${typeof h=="object"?h.label:h}</option>`).join("")}</select>`;if(c.type==="combobox"){let h=`dl-filter-${c.name}`,x=(c.options||[]).map(C=>{let _=typeof C=="object"?C.label||C.value||"":C||"";return(_==="undefined"||_==="[object Object]"||_==="null")&&(_=""),_?`<option value="${_}"></option>`:""}).join(""),w=L[c.name]||"";if(L[c.name]){let C=(c.options||[]).find(_=>String(typeof _=="object"?_.value:_)==String(L[c.name]));if(C){let _=typeof C=="object"?C.label||C.value||"":C||"";_&&_!=="undefined"&&_!=="[object Object]"&&_!=="null"&&(w=_)}}return`<div class="filter-combobox" style="flex:1; min-width:120px;">
                <input type="text" name="${c.name}" id="filter-${c.name}" list="${h}" class="form-control filter-combobox-input" value="${w}" placeholder="Pilih ${c.label}..." autocomplete="off">
                <datalist id="${h}">${x}</datalist>
              </div>`}return""}).join("")}
  ...
  `;function F(){let c=document.getElementById("bulk-toolbar");if(!c)return;let h=document.getElementById("bulk-count"),x=document.getElementById("btn-bulk-delete"),w=document.getElementById("btn-bulk-cancel");h.textContent=`${T.size} item dipilih`;let C=window.innerWidth<=768;T.size>0?(c.classList.add("has-items"),x.disabled=!1,w.disabled=!1,C?(c.style.cssText=`
          display: flex;
          position: fixed;
          bottom: 0;
          top: auto;
        ...
        `,h&&(h.style.cssText="color:white; font-weight:600; font-size:1rem; flex:1; text-align:center;"),x&&(x.style.cssText="background:rgba(255,255,255,0.2); border:none; border-radius:50%; width:36px; height:36px; color:white; font-size:1.1rem; cursor:pointer; display:flex; align-items:center; justify-content:center; padding:0;",x.textContent="\u{1F5D1}\uFE0F"),w&&(w.style.cssText="background:rgba(255,255,255,0.2); border:none; border-radius:50%; width:36px; height:36px; color:white; font-size:1.1rem; cursor:pointer; display:flex; align-items:center; justify-content:center; padding:0;",w.textContent="\u2715")):c.style.cssText=`
          display: flex;
          align-items: center;
          gap: 1rem;
          ...
          margin-bottom: 1rem;
        `):(c.classList.remove("has-items"),x.disabled=!0,w.disabled=!0,c.style.display="none")}document.getElementById("btn-bulk-cancel")?.addEventListener("click",()=>{T.clear(),document.querySelectorAll(".row-checkbox").forEach(h=>h.checked=!1);let c=document.getElementById("select-all-checkbox");c&&(c.checked=!1),F()}),document.getElementById("btn-bulk-delete")?.addEventListener("click",()=>{if(T.size===0)return;let c=[...T],h=document.createElement("div");h.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9999;display:flex;align-items:center;justify-content:center",h.innerHTML=`
      <div style="background:var(--bg-card);border-radius:var(--radius-xl);padding:28px;max-width:420px;width:90%;box-shadow:var(--shadow-lg);animation:fadeInUp .2s ease">
        <h3 style="margin:0 0 8px;color:var(--text-1);font-size:1rem;font-weight:700">\u26A0\uFE0F Hapus ${c.length} ${l}?</h3>
    ...
    `,document.body.appendChild(h),h.querySelector("#bulk-cancel-btn").addEventListener("click",()=>h.remove()),h.querySelector("#bulk-confirm-btn").addEventListener("click",async()=>{let x=h.querySelector("#bulk-confirm-btn");x.disabled=!0,x.textContent="Menghapus...";let w=await k(`${a}/bulk`,{method:"DELETE",body:JSON.stringify({ids:c})});h.remove(),w.ok?(ne(`${c.length} ${l} berhasil dihapus.`),T.clear(),F(),q()):G(w.data?.error||"Gagal menghapus data.")})});let K=document.getElementById("filter-search"),ue;K?.addEventListener("input",c=>{clearTimeout(ue),ue=setTimeout(()=>{L.search=c.target.value,E=1,T.clear(),q()},400)}),r?.forEach(c=>{c.type==="select"&&document.getElementById(`filter-${c.name}`)?.addEventListener("change",h=>{L[c.name]=h.target.value,E=1,T.clear(),q()}),c.type==="combobox"&&document.getElementById(`filter-${c.name}`)?.addEventListener("change",h=>{let x=h.target.value,w=(c.options||[]).find(C=>{let _=String(typeof C=="object"?C.value:C),B=String(typeof C=="object"?C.label:C);return _===x||B===x});x?L[c.name]=w?typeof w=="object"?w.value:w:x:L[c.name]="",E=1,T.clear(),q()})}),document.getElementById("btn-reset-filter")?.addEventListener("click",()=>{L={...n},K&&(K.value=""),r?.forEach(c=>{let h=document.getElementById(`filter-${c.name}`);h&&(h.value="")}),E=1,T.clear(),q()});let me=document.getElementById("btn-mobile-filter"),se=document.getElementById("filter-options-wrapper"),ge=document.getElementById("btn-close-filter-sheet");me&&se&&(me.addEventListener("click",c=>{c.preventDefault(),se.classList.add("sheet-open")}),ge&&ge.addEventListener("click",c=>{c.preventDefault(),se.classList.remove("sheet-open")}));let pe=document.getElementById("btn-mobile-aksi"),be=document.getElementById("excel-actions-wrapper"),_e=document.getElementById("btn-close-aksi-sheet");if(pe&&be&&(pe.addEventListener("click",c=>{c.preventDefault(),be.classList.add("sheet-open")}),_e&&_e.addEventListener("click",c=>{c.preventDefault(),be.classList.remove("sheet-open")})),document.getElementById("btn-create")?.addEventListener("click",()=>Ce(null)),S){document.getElementById(`btn-export-${S.moduleName}`)?.addEventListener("click",async h=>{let x=h.target,w=x.innerHTML;x.innerHTML="\u23F3 Loading...",x.disabled=!0;try{await S.onExport()}catch{G("Gagal export data")}finally{x.innerHTML=w,x.disabled=!1}}),document.getElementById(`btn-template-${S.moduleName}`)?.addEventListener("click",()=>{S.onTemplate()});let c=document.getElementById(`input-import-${S.moduleName}`);c?.addEventListener("change",async h=>{let x=h.target.files[0];if(!x)return;c.disabled=!0;let w=document.createElement("div");w.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.7);z-index:9999;display:flex;align-items:center;justify-content:center",w.innerHTML=`
      ...
      `,document.body.appendChild(w);let C=w.querySelector("#import-progress-text"),_=w.querySelector("#import-progress-bar"),B=w.querySelector("#import-summary"),A=w.querySelector("#import-close-btn");A.addEventListener("click",()=>{w.remove(),q()});try{let W=await De(x);if(W.length===0)throw new Error("File kosong atau format salah");let V=500,ae=0,Z=0,N=0,M=W.length;C.textContent=`Ditemukan ${M} baris data. Memulai import...`;for(let I=0;I<M;I+=V){let J=W.slice(I,I+V);C.textContent=`Mengimport baris ${I+1} - ${Math.min(I+V,M)} dari ${M}...`,_.style.width=`${Math.round(I/M*100)}%`;try{let O=await S.onImport(J);O?(ae+=O.inserted||O.metrics?.inserted||J.length,Z+=O.skipped||O.metrics?.updated||0):ae+=J.length}catch(O){console.error("Chunk import failed:",O),N+=J.length}}_.style.width="100%",C.innerHTML='<strong style="color:var(--success)">\u2705 Import Selesai!</strong>',B.style.display="block",B.innerHTML=`
        ...
        `,N>0&&(B.innerHTML+='<p style="margin-top:12px;font-size:0.8rem;color:var(--danger)">Sebagian data gagal diimport. Pastikan format kolom sesuai template dan tidak ada data kosong pada kolom wajib.</p>'),A.style.display="block",c.value=""}catch(W){C.innerHTML=`<strong style="color:var(--danger)">\u274C Gagal Memproses File</strong><br>${W.message}`,_.style.background="var(--danger)",_.style.width="100%",A.style.display="block",c.value=""}finally{c.disabled=!1}})}async function q(){F();let c=document.getElementById("table-container");if(!c)return;c.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';let h=$==="client",x=h?1:E,w=h?xe:20,C=new URLSearchParams({page:x,limit:w,...Object.fromEntries(Object.entries(L).filter(([,N])=>N))}),_=await k(`${a}?${C}`);if(!_.ok){c.innerHTML=`<div class="empty-state"><p class="text-danger">Gagal memuat data: ${_.data?.error||"Error"}</p></div>`;return}let B=_.data?.data||_.data||[],A=_.data?.pagination,W=B.length,V=B;if(h){B=g(B),V=B;let N=B.length,M=20,I=Math.ceil(N/M);E>I&&I>0&&(E=I);let J=(E-1)*M,O=E*M;B=B.slice(J,O),A={page:E,limit:M,total:N,pages:I}}!1,y&&y(B);let ae=Pe({columns:o,data:B,fullData:V,onEdit:p?N=>Ce(N):null,actions:f.map(N=>({...N,handler:M=>N.handler(M,q)})),emptyText:`Tidak ada ${String(l||"").toLowerCase()}`,bulkSelect:D?{selectedIds:T,onToggle:F}:null});c.innerHTML="",c.appendChild(ae);let Z=document.getElementById("pagination-container");if(Z&&(Z.innerHTML="",A&&A.pages>1)){let N=Ae({page:A.page,pages:A.pages,total:A.total,limit:A.limit,onPage:M=>{E=M,q()}});N&&Z.appendChild(N)}}function ze(c){let h=typeof d=="function"?d(c):d;return Te(h)}function Ce(c){let h=!!c,x=document.createElement("form");if(x.noValidate=!0,x.innerHTML=ze(c),h){let C=typeof d=="function"?d(c):d;Me(x,c)}let{close:w}=de({title:h?`Edit ${l}`:`Tambah ${l}`,content:x,size:"lg",confirmText:h?"Simpan Perubahan":`Tambah ${l}`,onConfirm:async(C,_)=>{if(!x.reportValidity())return;let B=C.querySelector(".modal-confirm");B.disabled=!0,B.textContent="Menyimpan...";let A=Ne(x),W=typeof d=="function"?d(c):d,V=async M=>{for(let I of M)if(I.type==="row")await V(I.fields);else if(I.type==="combobox"&&A[I.name]){let J=A[I.name],O=(I.options||[]).find(U=>{let ee=String(typeof U=="object"?U.value:U),Ge=String(typeof U=="object"?U.label:U);return ee===J||Ge===J});if(O)A[I.name]=typeof O=="object"?O.value:O;else if(I.createApi){let U={};U[I.createApi.field]=J,I.createApi.extra&&Object.assign(U,I.createApi.extra);let ee=await k(I.createApi.path,{method:"POST",body:JSON.stringify(U)});if(ee.ok&&ee.data?.id)A[I.name]=ee.data.id;else if(ee.ok&&!ee.data?.id)A[I.name]=J;else throw new Error(`Gagal membuat master data: ${ee.data?.error||"Unknown error"}`)}}};try{await V(W)}catch(M){G(M.message),B.disabled=!1,B.textContent=h?"Simpan Perubahan":`Tambah ${l}`;return}m&&(A=await m(A,c));let ae=h?"PUT":"POST",Z=h?`${a}/${c.id}`:a,N=await k(Z,{method:ae,body:JSON.stringify(A)});N.ok?(ne(h?`${l} berhasil diperbarui.`:`${l} berhasil ditambahkan.`),_(),q()):(G(N.data?.error||"Gagal menyimpan data."),B.disabled=!1,B.textContent=h?"Simpan Perubahan":`Tambah ${l}`)}})}function $t(c){Ee(`Hapus ${l} ini? Tindakan tidak dapat dibatalkan.`,async()=>{let h=await k(`${a}/${c.id}`,{method:"DELETE"});h.ok?(ne(`${l} berhasil dihapus.`),q()):G(h.data?.error||"Gagal menghapus.")},`Hapus ${l}`)}return q(),q}j();j();var Fe=null,nt=null;async function Oe(t=!1){if(Fe&&!t)return console.log("Employees Raw (Cache Hit)",Fe.slice(0,5)),Fe;let e=await k(`/api/employees?limit=${xe}&status=Aktif`);return Fe=(e.data?.data||[]).map(i=>({value:i.id,label:i.full_name})),console.log("Employees Raw",e.data?.data?.slice(0,5)),console.log("Employees Mapped (ID)",Fe.slice(0,5)),Fe}async function ie(t=!1){let i=(await Oe(t)).map(a=>({value:a.label,label:a.label}));return console.log("Employee Options",i.slice(0,5)),i}async function Q(t=!1){return nt&&!t||(nt=((await k("/api/branches?all=1")).data?.data||[]).map(i=>({value:i.id,label:i.full_name}))),nt}function X(t){let e={Done:"badge-success",Aktif:"badge-success",Open:"badge-warning","In Progress":"badge-info",Pending:"badge-warning",Diproses:"badge-info",Selesai:"badge-success","Tidak Aktif":"badge-neutral",Resign:"badge-neutral",Cut:"badge-danger","Tidak Datang":"badge-danger"};return!t||t==="-"||String(t).trim()===""?"":`<span class="badge ${e[t]||"badge-neutral"}">${t}</span>`}function bt(t){return t==null?'<span class="badge badge-neutral">-</span>':t<0?`<span class="badge badge-danger">Expired (${Math.abs(t)}h)</span>`:t<=14?`<span class="badge badge-danger">${t} hari</span>`:t<=30?`<span class="badge badge-warning">${t} hari</span>`:`<span class="badge badge-success">${t} hari</span>`}function Re(t){return`<span class="badge ${{"FACILITY CARE":"badge-info",SECURITY:"badge-secondary"}[t]||"badge-neutral"}">${t||"-"}</span>`}function ht(t){return`<span class="badge ${{"Inspeksi Hygiene & Aset Bangunan":"badge-info","General Cleaning":"badge-success","Deep Cleaning":"badge-purple",Fogging:"badge-warning"}[t]||"badge-neutral"}">${t||"-"}</span>`}function he(t){return`<span class="badge ${{Q1:"badge-info",Q2:"badge-success",Q3:"badge-warning",Q4:"badge-danger"}[t]||"badge-neutral"}">${t||"-"}</span>`}z();function yt(t,e){let i=new Date,a=`${i.getFullYear()}-${String(i.getMonth()+1).padStart(2,"0")}`;if(!(t.target_date||t.opening_date||"").startsWith(a))return!1;let d=String(t.status||"").toLowerCase();if(d!=="selesai"&&d!=="completed"&&d!=="done")return!1;let r=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?r.includes("inspeksi"):e==="gcdc"?r.includes("general cleaning")||r.includes("deep cleaning"):!1}j();we();z();function H({container:t,title:e,icon:i,apiPath:a,columns:o,formFields:d,filterFields:r,defaultFilters:n={},enableMobileFilterSheet:s=!1,itemLabel:l="Data",canCreate:b=!0,canEdit:p=!0,canDelete:u=!0,onBeforeSubmit:m,onAfterLoad:y,onDataLoaded:g,extraActions:f=[],initialSearch:v="",exportOptions:S=null,bulkDelete:D=!1,paginationMode:$="server"}){let P=oe();P&&typeof P=="object"&&P.role==="viewer"&&(b=!1,p=!1,u=!1,D=!1,S=null);let E=1,L={...n};v&&(L.search=v);let T=new Set;t.innerHTML=`
    <div class="crud-layout-wrapper ${s?"mobile-active":""}">
      <div class="page-header">
      <h1 class="page-title">${i} ${e}</h1>
      <div class="page-actions">
  ...
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>kt(t)),document.getElementById("filter-jadwal-year")?.addEventListener("change",async i=>{let a=i.target.value,o=document.getElementById("jadwal-year-label");o&&(o.textContent=a);let d=document.getElementById("skel-jadwal"),r=document.getElementById("chart-jadwal");d&&(d.style.display="block",d.style.position="absolute"),r&&(r.style.display="none");let n=await le(`/api/dashboard/schedule-chart?year=${a}`,{},8e3);try{Ot(n)}catch(s){console.warn("ScheduleChart render:",s),fe("skel-jadwal","chart-jadwal")}}),document.getElementById("filter-insp-month")?.addEventListener("change",async i=>{let a=i.target.value,o=a?`/api/dashboard/inspection-bar?month=${a}`:"/api/dashboard/inspection-bar",d=document.getElementById("skel-insp"),r=document.getElementById("chart-insp");d&&(d.style.display="block",d.style.position="absolute"),r&&(r.style.display="none");let n=await le(o,{},8e3);try{Rt(n)}catch(s){console.warn("InspBar render:",s),fe("skel-insp","chart-insp")}}),t._skelTimeout=setTimeout(()=>Ea(),5e3),await kt(t),t._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?kt(t):clearInterval(t._dashRefresh)},6e4)}async function kt(t){t._skelTimeout&&(clearTimeout(t._skelTimeout),t._skelTimeout=null);let[e,i,a,o,d,r,n,s,l,b,p,u,m,y]=await Promise.all([le("/api/dashboard/kpi",{},8e3),le("/api/dashboard/issues-trend",{},8e3),le("/api/dashboard/issues-summary",{},8e3),le("/api/dashboard/stats",{},8e3),le("/api/dashboard/calendar",[],8e3),le("/api/schedule?limit=10000",{data:[]},8e3),le("/api/employees?limit=10000",{data:[]},8e3),le("/api/contracts?limit=10000",{data:[]},8e3),le("/api/issues?limit=10000",{data:[]},8e3),le("/api/one-on-one?limit=10000",{data:[]},8e3),le("/api/dashboard/contracts-chart",{labels:[],data:[]},8e3),le(`/api/dashboard/schedule-chart?year=${document.getElementById("filter-jadwal-year")?.value||new Date().getFullYear()}`,{},8e3),le("/api/relievers?limit=10000",{data:[]},8e3),le("/api/reports/fogging?limit=10000",{data:[]},8e3)]),g=document.getElementById("filter-insp-month"),f=g?g.value:"",v=f?`/api/dashboard/inspection-bar?month=${f}`:"/api/dashboard/inspection-bar",S=await le(v,{},8e3);if(e){let D=Array.isArray(r?.data)?r.data:Array.isArray(r)?r:[];window.dashboardSchedules=D;let $=Array.isArray(n?.data)?n.data:Array.isArray(n)?n:[],P=Array.isArray(s?.data)?s.data:Array.isArray(s)?s:[],E=Array.isArray(l?.data)?l.data:Array.isArray(l)?l:[],L=Array.isArray(b?.data)?b.data:Array.isArray(b)?b:[],T=Array.isArray(m?.data)?m.data:Array.isArray(m)?m:[];window.dashboardRelievers=T;let F=Array.isArray(y?.data)?y.data:Array.isArray(y)?y:[];window.dashboardFogging=F,e.employees&&(e.employees.current=$.filter(K=>It(K,"active")).length),e.contracts&&(e.contracts.current=P.filter(K=>ft(K,"active")).length),e.expiring30&&(e.expiring30={current:P.filter(K=>ft(K,"expiring30")).length}),e.issues&&(e.issues.current=E.filter(K=>Lt(K,"open")).length),e.one_on_one&&(e.one_on_one.current=L.filter(K=>Bt(K,"pending")).length),e.inspection_month&&(e.inspection_month.current=D.filter(K=>yt(K,"inspeksi")).length),e.cleaning_month&&(e.cleaning_month.current=D.filter(K=>yt(K,"gcdc")).length)}try{Mt(e)}catch(D){console.warn("KPI render:",D)}try{Ft(e)}catch(D){console.warn("MiniStats render:",D)}try{Ot(u)}catch(D){console.warn("ScheduleChart render:",D),fe("skel-jadwal","chart-jadwal")}try{Ta(Array.isArray(a?.by_category)?a.by_category:[])}catch(D){console.warn("Donut render:",D),fe("skel-donut","chart-donut")}try{Da(i)}catch(D){console.warn("Trend render:",D),fe("skel-trend","chart-trend")}try{Rt(S)}catch(D){console.warn("InspBar render:",D),fe("skel-insp","chart-insp")}try{let D=Array.isArray(o)?o:Array.isArray(o?.recent_issues)?o.recent_issues:[];La(D)}catch(D){console.warn("IssuesTable render:",D)}try{let D=Array.isArray(o?.expiring_contracts)?o.expiring_contracts:[];Ia(p)}catch(D){console.warn("ContractsTable render:",D)}try{Ba(Array.isArray(d)?d:[])}catch(D){console.warn("Agenda render:",D)}try{Pa()}catch(D){console.warn("Quick Actions render:",D)}}function Mt(t){let e=document.getElementById("kpi-row");if(!e)return;t=t||{};let i=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees?dash_filter=active",color:"kpi-blue",key:"employees",trendPct:"+2%",trendColor:"#10B981",points:"0,20 10,18 20,22 30,12 40,15 50,8 60,10 70,5 80,6 90,2 100,0"},{icon:"\u{1F504}",label:"Reliefer Aktif",sub:"Karyawan reliefer",href:"#/employees?dash_filter=reliefer",color:"kpi-purple",key:"reliever_total",trendPct:"0%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts?dash_filter=active",color:"kpi-green",key:"contracts",trendPct:"+1%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u23F3",label:"Kontrak Habis 30 Hari",sub:"Akan segera berakhir",href:"#/contracts?dash_filter=expiring30",color:"kpi-warn",key:"expiring30",trendPct:"+25%",trendColor:"#F59E0B",points:"0,25 20,22 40,24 60,15 80,18 100,5"},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues?dash_filter=open",color:"kpi-red",key:"issues",trendPct:"0%",trendColor:"#EF4444",points:"0,20 20,18 40,22 60,19 80,21 100,20"},{icon:"\u{1F4AC}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one?dash_filter=pending",color:"kpi-purple",key:"one_on_one",trendPct:"+8%",trendColor:"#10B981",points:"0,25 20,15 40,18 60,8 80,10 100,2"}];e.innerHTML=i.map(a=>{let o=ve(t[a.key]?.current,0);return`
      ...
      </a>`}).join(""),e.querySelectorAll(".kpi-value").forEach(a=>{At(a,parseInt(a.dataset.target)||0)})}function Ft(t){let e=document.getElementById("mini-stats-row");if(!e)return;t=t||{};let i=`Q${Math.ceil((new Date().getMonth()+1)/3)}`,a=new Date().getFullYear(),o=String(new Date().getMonth()+1).padStart(2,"0"),d=`${a}-${o}`,r=p=>`
  ...
  `,n=[{id:"mini-jadwal",icon:"\u{1F4C5}",label:"Jadwal",dropdown:`
    ...
    </a>`).join(""),e.querySelectorAll(".mini-stat-value").forEach(p=>At(p,parseInt(p.dataset.target)||0,700));let s=document.getElementById("dash-jadwal-period");s&&s.addEventListener("change",p=>{let u=p.target.value,m=(window.dashboardSchedules||[]).filter(f=>f.period===u).length,y=document.querySelector("#mini-jadwal .mini-stat-value");y&&(y.dataset.target=m,y.textContent=m);let g=document.getElementById("mini-jadwal");g&&(g.href=`#/timeline?dash_filter=period_${u.toLowerCase()}`)});let l=(p,u,m,y,g)=>{let f=document.getElementById(p);f&&f.addEventListener("change",v=>{let S=v.target.value,D=(m||[]).filter(E=>y(E,S)).length,$=document.querySelector(`#${u} .mini-stat-value`);$&&($.dataset.target=D,$.textContent=D);let P=document.getElementById(u);P&&(P.href=`${g}&month=${S}`)})},b=p=>{let u=String(p.status||"").toLowerCase();return u==="done"||u==="selesai"||u==="completed"};l("dash-reliefer-month","mini-reliefer",window.dashboardRelievers,(p,u)=>window.parseFlexibleDate(p.backup_date).startsWith(u)&&b(p),"#/relievers?dash_filter=reliever"),l("dash-inspeksi-month","mini-inspeksi",window.dashboardSchedules,(p,u)=>p.activity_type==="Inspeksi Hygiene"&&b(p)&&window.parseFlexibleDate(p.opening_date||p.target_date).startsWith(u),"#/timeline?dash_filter=inspeksi"),l("dash-gcdc-month","mini-gcdc",window.dashboardSchedules,(p,u)=>(p.activity_type==="General Cleaning"||p.activity_type==="Deep Cleaning")&&b(p)&&window.parseFlexibleDate(p.opening_date||p.target_date).startsWith(u),"#/timeline?dash_filter=gcdc"),l("dash-fogging-month","mini-fogging",window.dashboardFogging,(p,u)=>b(p)&&window.parseFlexibleDate(p.activity_date).startsWith(u),"#/reports/fogging?dash_filter=fogging")}function Ta(t){fe("skel-donut","chart-donut");let e=document.getElementById("chart-donut"),i=document.getElementById("donut-legend");if(!e||!i)return;He("donut");let a=(t||[]).filter(s=>ve(s.count)>0);if(!a.length){Xe(e,"Belum ada data permasalahan");return}let o=a.map(s=>`${Ke(s.category,"Lainnya")}`),d=a.map(s=>ve(s.count)),r=d.reduce((s,l)=>s+l,0);i.innerHTML=a.map((s,l)=>{let b=vt[l%vt.length],p=r>0?Math.round(s.count/r*100):0;return`
...
`)}let P=l(S,v),E=null;return P||(E="Karyawan tidak ditemukan di Database"),{isValid:!!P,invalidReason:E,rowNum:v,data:{employee_id:P,branch_id:s(String(g.Cabang||"").trim()),division:String(g["Div / Bagian"]||"").trim()||"FACILITY CARE",start_date:$,end_date:b(g["Tanggal Selesai"])||"2099-12-31",status:String(g.Status||"").trim(),_rawName:S}}}),u=[],m=[];if(p.forEach(g=>{g.isValid?u.push(g.data):m.push({rowNum:g.rowNum,name:g.data._rawName,reason:g.invalidReason})}),console.log(`Split Validation - Valid: ${u.length}, Invalid: ${m.length}`),u.length===0)return{inserted:0,skipped:a.length,failed:a.length};let y=await k("/api/import/contracts",{method:"POST",body:JSON.stringify({rows:u,onDuplicate:"update"})});if(!y.ok)throw new Error(y.data?.error||"Import gagal");return y.data}}})}j();z();var St=[],Ze=[];function Oa(t){if(!Array.isArray(t))return"Q3";let e=["Q4","Q3","Q2","Q1"];for(let i of e)if(t.some(a=>a.period===i))return i;return"Q3"}async function Jt(t,e){St=await Q();let i=await ie();Ze=["Berlin Ariansyah","Ade Surahman"];let a=m=>m&&!Ze.find(y=>String(typeof y=="object"?y.value:y).toLowerCase()===String(m).toLowerCase())?[...Ze,m]:Ze,o=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`),d=m=>{if(!m||m==="-"||String(m).trim()==="")return"";let y=String(m).split("-");return y.length===3&&y[0].length===4?`${y[2]}-${y[1]}-${y[0]}`:m},r=o.data?.data||[],n=Oa(r),s=e?e.get("dash_filter"):null,l=new Date,b=`${l.getFullYear()}-${String(l.getMonth()+1).padStart(2,"0")}`,p={},u=e&&e.get("month")?e.get("month"):null;s==="inspeksi"?p={status:"Done",activity_type:"Inspeksi Hygiene",month:u}:s==="gcdc"?p={status:"Done",activity_type:"GCDC",month:u}:s&&s.startsWith("period_")&&(p={period:s.replace("period_","").toUpperCase()}),gt({container:t,title:"Jadwal Kegiatan",icon:"\u{1F4C5}",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",paginationMode:"client",enableMobileFilterSheet:!0,defaultFilters:p,onDataLoaded:m=>m.sort((y,g)=>{let f=y.opening_date?new Date(y.opening_date).getTime():0;return(g.opening_date?new Date(g.opening_date).getTime():0)-f}),columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:m=>ht(m)},{key:"period",label:"Periode",render:m=>he(m)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:m=>d(m)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:m=>d(m)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:m=>d(m)},{key:"status",label:"Status",render:m=>X(m)}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:St},{type:"select",name:"activity_type",label:"Kegiatan",options:[{value:"Inspeksi Hygiene",label:"Inspeksi Hygiene"},{value:"General Cleaning",label:"General Cleaning"},{value:"Deep Cleaning",label:"Deep Cleaning"},{value:"Fogging",label:"Fogging"},{value:"GCDC",label:"GCDC (GC & DC)"}]},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"select",name:"pic",label:"PIC",options:Ze}],formFields:m=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",required:!0,options:St,value:m?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"],value:m?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:m?.period},{name:"pic",label:"PIC",type:"select",options:a(m?.pic),value:m?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:m?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:m?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:m?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:m?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:m?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let m=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`);if(m.ok){let y=m.data.data.map(g=>({Cabang:g.branch_name||"",Kegiatan:g.activity_type||"",Periode:g.period||"",PIC:g.pic||"","Tgl Opening":g.opening_date||"","Tgl Target":g.target_date||"","Tgl Selesai":g.completion_date||"",Status:g.status||""}));R(y,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{R([{Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done"}],"Template_Import_Jadwal")},onImport:async m=>{let g=(await k("/api/branches?all=1")).data?.data||[],f=$=>{if(!$)return null;let P=String($||"").toLowerCase(),E=g.find(L=>String(L.full_name||"").toLowerCase()===P||String(L.code||"").toLowerCase()===P||String(L.name||"").toLowerCase()===P);return E?E.id:null},v=$=>{if($==null||$==="")return"";if($ instanceof Date&&!isNaN($.getTime()))return $.toISOString().slice(0,10);let P=String($).trim();if(P===""||P==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(P))return P.slice(0,10);if(/^\d{4,5}$/.test(P)){let L=Number(P);if(L>2e4&&L<99999){let T=new Date(Date.UTC(1899,11,30)+L*864e5);return isNaN(T.getTime())?"":T.toISOString().slice(0,10)}}let E=P.split(/[\/\-\.]/);if(E.length===3){let[L,T,F]=E.map(K=>K.trim());if(L.length===4&&T.length<=2&&F.length<=2)return`${L}-${T.padStart(2,"0")}-${F.padStart(2,"0")}`;if(F.length===4&&T.length<=2&&L.length<=2)return`${F}-${T.padStart(2,"0")}-${L.padStart(2,"0")}`}return P},S=m.map($=>({branch_id:f(String($.Cabang||"").trim()),activity_type:String($.Kegiatan||"").trim(),period:String($.Periode||"").trim(),pic:String($.PIC||$.Pic||"").trim(),opening_date:v($["Tgl Opening"]||$["Tanggal Opening"]||$["Tgl Openir"]),target_date:v($["Tgl Target"]||$["Tanggal Target"]),completion_date:v($["Tgl Selesai"]||$["Tanggal Selesai"]),status:String($.Status||"").trim(),notes:String($.Catatan||$.Keterangan||"").trim()})).filter($=>$.activity_type&&$.period),D=await k("/api/import/schedule",{method:"POST",body:JSON.stringify({rows:S,onDuplicate:"update"})});if(!D.ok)throw new Error(D.data?.error||"Import gagal");return D.data}}})}j();z();var _t=[],rt=[];function Ra(t,e){let i=String(t.status||"").toLowerCase();return e==="open"?i==="open":!1}async function Ut(t,e){let i=e?e.get("dash_filter"):null;_t=await Q(),rt=await ie();let a=r=>r&&!rt.find(n=>n.value===r)?[...rt,{value:r,label:r}]:rt,o=new Date().getFullYear();H({container:t,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,itemLabel:"Permasalahan",paginationMode:"client",onDataLoaded:r=>i?r.filter(n=>Ra(n,i)):r,columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:r=>window.formatDate(r)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:r=>`<span class="badge badge-secondary">${r}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:r=>`<span title="${r}">${r?.length>50?r.slice(0,50)+"\u2026":r}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:r=>`<span title="${r||""}">${r?.length>40?r.slice(0,40)+"\u2026":r||"-"}</span>`},{key:"status",label:"Status",render:r=>X(r)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:r=>window.formatDate(r)},{key:"day_count",label:"Hari",render:r=>r??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"select",name:"branch_id",label:"Cabang",options:_t},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:["2025","2026","2027","2028","2029","2030"]}],formFields:r=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:r?.report_date},{name:"branch_id",label:"Cabang",type:"select",required:!0,options:_t,value:r?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:r?.category},{name:"source",label:"Sumber Laporan",type:"select",options:["SPV","AM","RCP","Perawat","FC","Berlin","Ade","Pattrel","Dentrel"],value:r?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:r?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"select",options:a(r?.employee_name),value:r?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"select",options:a(r?.fc_specialist),value:r?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:r?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:r?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:r?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let r=await k(`/api/issues${window.location.search?window.location.search+"&":"?"}limit=10000`);if(r.ok){let n=r.data.data.map(s=>({Tanggal:s.report_date||"",Cabang:s.branch_name||"",Kategori:s.category||"",Sumber:s.source||"",Keluhan:s.complaint||"","Nama FC":s.employee_name||"","FC Spesialis":s.fc_specialist||"",Solusi:s.solution||"","Tgl Selesai":s.completion_date||"",Status:s.status||""}));R(n,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{R([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async r=>{let s=(await k("/api/branches?all=1")).data?.data||[],l=u=>{if(!u)return null;let m=String(u||"").toLowerCase(),y=s.find(g=>String(g.full_name||"").toLowerCase()===m||String(g.code||"").toLowerCase()===m||String(g.name||"").toLowerCase()===m);return y?y.id:null},b=r.map(u=>({branch_id:l(String(u.Cabang||"").trim()),report_date:String(u.Tanggal||"").trim(),category:String(u.Kategori||"").trim(),source:String(u.Sumber||"").trim(),complaint:String(u.Keluhan||"").trim(),employee_name:String(u["Nama FC"]||"").trim(),fc_specialist:String(u["FC Spesialis"]||"").trim(),solution:String(u.Solusi||"").trim(),completion_date:String(u["Tgl Selesai"]||"").trim(),status:String(u.Status||"").trim()})).filter(u=>u.report_date&&u.complaint&&u.category),p=await k("/api/import/issues",{method:"POST",body:JSON.stringify({rows:b,onDuplicate:"update"})});if(!p.ok)throw new Error(p.data?.error||"Import gagal");return p.data}}})}j();var qe=[];function Ka(t,e){let i=String(t.status||"").toLowerCase();return e==="pending"?i==="pending":!1}async function zt(t,e){let i=e?e.get("dash_filter"):null;qe=await Q();let a=await ie(),o=["Ade","Berlin"],d=n=>n&&!a.find(s=>s.value===n)?[...a,{value:n,label:n}]:a,r=n=>n&&!o.find(s=>(typeof s=="object"?s.value:s)===n)?[...o,n]:o;H({container:t,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,itemLabel:"One on One",paginationMode:"client",onDataLoaded:n=>i?n.filter(s=>Ka(s,i)):n,columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:n=>window.formatDate(n)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:n=>`<span title="${n||""}">${n?.length>50?n.slice(0,50)+"\u2026":n||"-"}</span>`},{key:"solution",label:"Solusi",render:n=>`<span title="${n||""}">${n?.length>40?n.slice(0,40)+"\u2026":n||"-"}</span>`},{key:"status",label:"Status",render:n=>X(n)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:n=>window.formatDate(n)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:n=>n?`<a href="${n}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"select",name:"branch_id",label:"Cabang",options:qe},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async n=>{let s=new URLSearchParams(n||{}).toString(),l=await k(`/api/one-on-one?limit=10000&${s}`);if(l.ok){let b=l.data.data.map(u=>({Tanggal:u.meeting_date||"",Cabang:u.branch_name||"","Nama Karyawan":u.employee_name||"",PIC:u.pic||"",Masalah:u.problem||"",Solusi:u.solution||"",Status:u.status||"","Tgl Selesai":u.completion_date||"",Dokumen:u.document_link||""})),{downloadExcel:p}=await Promise.resolve().then(()=>(z(),ce));p(b,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let n=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:s}=await Promise.resolve().then(()=>(z(),ce));s(n,"Template_Import_OneOnOne")},onImport:async n=>{let s=u=>{if(!u)return null;let m=String(u||"").toLowerCase(),y=qe.find(g=>String(g.label||"").toLowerCase()===m);return y?y.value:null},l=u=>{if(!u)return"";if(u instanceof Date&&!isNaN(u.getTime()))return u.toISOString().slice(0,10);let m=String(u).trim();if(/^\d{4,5}$/.test(m)){let g=Number(m);if(g>2e4&&g<99999){let f=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(f.getTime())?"":f.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(m))return m.slice(0,10);let y=m.split(/[\/\-\.]/);if(y.length===3){let[g,f,v]=y.map(S=>S.trim());if(g.length===4&&f.length<=2&&v.length<=2)return`${g}-${f.padStart(2,"0")}-${v.padStart(2,"0")}`;if(v.length===4&&f.length<=2&&g.length<=2)return`${v}-${f.padStart(2,"0")}-${g.padStart(2,"0")}`}return m},b=n.map(u=>({meeting_date:l(u.Tanggal),employee_name:String(u["Nama Karyawan"]||"").trim(),branch_id:s(String(u.Cabang||"").trim()),pic:String(u.PIC||"").trim(),problem:String(u.Masalah||"").trim(),solution:String(u.Solusi||"").trim(),status:String(u.Status||"").trim(),completion_date:l(u["Tgl Selesai"]),document_link:String(u.Dokumen||"").trim()})).filter(u=>u.meeting_date&&u.employee_name&&u.branch_id),p=await k("/api/import/one_on_one",{method:"POST",body:JSON.stringify({rows:b,onDuplicate:"update"})});if(!p.ok)throw new Error(p.data?.error||"Import gagal");return p.data}},formFields:n=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:n?.meeting_date},{name:"branch_id",label:"Cabang",type:"select",options:n?.branch_id&&!qe.find(s=>s.value==n.branch_id)?[...qe,{value:n.branch_id,label:n.branch_name||n.branch_id}]:qe,createApi:{path:"/api/branches",field:"full_name"},value:n?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"select",required:!0,options:d(n?.employee_name),value:n?.employee_name},{name:"pic",label:"PIC",type:"select",options:r(n?.pic),createApi:{path:"/api/pic",field:"name"},value:n?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:n?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:n?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:n?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:n?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:n?.document_link}]})}j();async function Gt(t){let e=await Q(),i=await ie(),a=["Ade","Berlin"],o=n=>n&&!i.find(s=>s.value===n)?[...i,{value:n,label:n}]:i,d=n=>n&&!a.find(s=>(typeof s=="object"?s.value:s)===n)?[...a,n]:a,r=Array.from({length:5},(n,s)=>String(new Date().getFullYear()-s));H({container:t,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:n=>window.formatDate(n)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:n=>{try{let s=JSON.parse(n);return Array.isArray(s)?s.join(", "):n||"-"}catch{return n||"-"}}},{key:"score",label:"Nilai",render:n=>n!=null?`<strong>${n}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:n=>n?`<a href="${n}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer..."},{type:"select",name:"year",label:"Tahun",options:r}],exportOptions:{moduleName:"training",onExport:async n=>{let s=new URLSearchParams(n||{}).toString(),l=await k(`/api/training?limit=10000&${s}`);if(l.ok){let b=l.data.data.map(u=>{let m=u.participants||"";try{let y=JSON.parse(m);m=Array.isArray(y)?y.join(", "):m}catch{}return{Tanggal:u.training_date||"",Batch:u.batch||"",Materi:u.subject||"",Cabang:u.branch_name||"",Trainer:u.trainer||"",Peserta:m,Nilai:u.score!==null&&u.score!==void 0?u.score:"",Dokumen:u.document_link||""}}),{downloadExcel:p}=await Promise.resolve().then(()=>(z(),ce));p(b,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let n=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:s}=await Promise.resolve().then(()=>(z(),ce));s(n,"Template_Import_Training")},onImport:async n=>{let s=u=>{if(!u)return null;let m=String(u||"").toLowerCase(),y=e.find(g=>String(g.label||"").toLowerCase()===m);return y?y.value:null},l=u=>{if(!u)return"";if(u instanceof Date&&!isNaN(u.getTime()))return u.toISOString().slice(0,10);let m=String(u).trim();if(/^\d{4,5}$/.test(m)){let g=Number(m);if(g>2e4&&g<99999){let f=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(f.getTime())?"":f.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(m))return m.slice(0,10);let y=m.split(/[\/\-\.]/);if(y.length===3){let[g,f,v]=y.map(S=>S.trim());if(g.length===4&&f.length<=2&&v.length<=2)return`${g}-${f.padStart(2,"0")}-${v.padStart(2,"0")}`;if(v.length===4&&f.length<=2&&g.length<=2)return`${v}-${f.padStart(2,"0")}-${g.padStart(2,"0")}`}return m},b=n.map(u=>({training_date:l(u.Tanggal),batch:String(u.Batch||"").trim(),subject:String(u.Materi||"").trim(),branch_id:s(String(u.Cabang||"").trim()),trainer:String(u.Trainer||"").trim(),participants:String(u.Peserta||"").trim(),score:u.Nilai?Number(u.Nilai):null,document_link:String(u.Dokumen||"").trim()})).filter(u=>u.training_date&&u.subject&&u.branch_id),p=await k("/api/import/training",{method:"POST",body:JSON.stringify({rows:b,onDuplicate:"update"})});if(!p.ok)throw new Error(p.data?.error||"Import gagal");return p.data}},formFields:n=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:n?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:n?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:n?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",options:e,value:n?.branch_id},{name:"trainer",label:"Trainer",type:"select",options:d(n?.trainer),value:n?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let s=JSON.parse(n?.participants);return Array.isArray(s)?s.join(", "):n?.participants||""}catch{return n?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:n?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:n?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:n?.notes}],onBeforeSubmit:async n=>(n.participants&&(n.participants=JSON.stringify(n.participants.split(",").map(s=>s.trim()).filter(Boolean))),n)})}j();we();z();function Qt({container:t,title:e,icon:i,apiPath:a,columns:o,formFields:d,filterFields:r,defaultFilters:n={},enableMobileFilterSheet:s=!1,itemLabel:l="Data",canCreate:b=!0,canEdit:p=!0,canDelete:u=!0,onBeforeSubmit:m,onAfterLoad:y,onDataLoaded:g,extraActions:f=[],initialSearch:v="",exportOptions:S=null,bulkDelete:D=!1,paginationMode:$="server"}){let P=oe();P&&typeof P=="object"&&P.role==="viewer"&&(b=!1,p=!1,u=!1,D=!1,S=null);let E=1,L={...n};v&&(L.search=v);let T=new Set;t.innerHTML=`
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),o()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),o()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.querySelectorAll(".cal-filter").forEach(d=>d.addEventListener("change",o));async function a(){try{let d=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`;i=(await k(`/api/dashboard/calendar?month=${d}`)).data?.data||[]}catch(d){console.warn("[Calendar] Failed to load events, rendering empty grid:",d),i=[]}}async function o(){let d=document.getElementById("calendar-grid");if(d){d.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
    ...
    </div>`,await a();try{let r=e.getFullYear(),n=e.getMonth(),s=e.toLocaleDateString("id-ID",{month:"long",year:"numeric"}),l=document.getElementById("cal-month-label");l&&(l.textContent=s);let b=new Set(Array.from(document.querySelectorAll(".cal-filter:checked")).map($=>$.value)),p=i.filter($=>b.has($.type)),u={};p.forEach($=>{let P=($.event_date||"").slice(0,10);u[P]||(u[P]=[]),u[P].push($)});let m=new Date(r,n,1).getDay(),y=new Date(r,n+1,0).getDate(),g=["Min","Sen","Sel","Rab","Kam","Jum","Sab"],f=new Date().toISOString().slice(0,10),v='<div class="calendar-grid">';g.forEach($=>{v+=`<div class="cal-day-header">${$}</div>`});for(let $=0;$<m;$++)v+='<div class="cal-cell cal-cell-empty"></div>';for(let $=1;$<=y;$++){let P=`${r}-${String(n+1).padStart(2,"0")}-${String($).padStart(2,"0")}`,E=u[P]||[],L=P===f;v+=`
          <div class="cal-cell ${L?"cal-today":""} ${E.length?"cal-has-events":""}"
               data-date="${P}" tabindex="0" role="button" aria-label="${P}">
            <div class="cal-day-num ${L?"today-num":""}">${$}</div>
            <div class="cal-events-preview">
              ${E.slice(0,3).map(T=>`
                <div class="cal-event-dot cal-color-${T.color||"gray"}" title="${lt(T.title||T.type)}">
                  <span class="cal-event-dot-label">${qa(T.title||T.branch_name||T.type,18)}</span>
                </div>
              `).join("")}
              ${E.length>3?`<div class="cal-more">+${E.length-3} lagi</div>`:""}
            </div>
          </div>`}let D=(m+y)%7;if(D!==0)for(let $=0;$<7-D;$++)v+='<div class="cal-cell cal-cell-empty"></div>';v+="</div>",d.innerHTML=v,d.querySelectorAll(".cal-cell[data-date]").forEach($=>{$.addEventListener("click",()=>{let P=$.dataset.date,E=u[P]||[];if(!E.length)return;let L=document.getElementById("cal-event-list"),T=new Date(P+"T00:00:00").toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});document.getElementById("cal-event-date").textContent=T,document.getElementById("cal-event-items").innerHTML=E.map(F=>`
  ...
  `;let e=null,i=null,a=0,o={upload:document.getElementById("step-upload"),validating:document.getElementById("step-validating"),preview:document.getElementById("step-preview"),importing:document.getElementById("step-importing"),summary:document.getElementById("step-summary")};function d(g){Object.entries(o).forEach(([f,v])=>{v.style.display=f===g?"":"none"})}document.getElementById("btn-backup-db")?.addEventListener("click",async()=>{let g=document.getElementById("btn-backup-db");g.disabled=!0,g.textContent="\u23F3 Memproses Backup...";try{let f=await k("/api/import/backup");if(f.ok){if(!window.XLSX){G("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");return}let v=window.XLSX,S=v.utils.book_new();Object.entries(f.data.database).forEach(([D,$])=>{let P=$.length>0?$:[{}],E=v.utils.json_to_sheet(P);v.utils.book_append_sheet(S,E,D.substring(0,31))}),v.writeFile(S,`FCMS_Database_Backup_${new Date().toISOString().slice(0,10)}.xlsx`),ne("Backup berhasil diunduh!")}else G("Gagal memproses backup: "+(f.data?.error||"Unknown error"))}catch(f){G("Gagal memproses backup: "+f.message)}finally{g.disabled=!1,g.textContent="\u{1F4E6} Backup Database"}});let r=document.getElementById("btn-sync-google");r&&r.addEventListener("click",async()=>{if(!confirm("Peringatan: Mensinkronkan data dengan Google Sheets akan memperbarui dan menambahkan data baru dari Google Sheets ke dalam FCMS. Data yang sudah Anda buat di FCMS TIDAK akan terhapus. Lanjutkan?"))return;let g=r.innerHTML;r.innerHTML='<span class="spinner"></span> Menyinkronkan...',r.disabled=!0;try{let f=await k("/api/sync/google-sheets",{method:"POST"});f.ok?alert("Sinkronisasi Berhasil: "+(f.data?.message||"Data Karyawan & PIC telah diperbarui.")):alert("Gagal Sinkronisasi: "+(f.data?.error||"Unknown error"))}catch{alert("Terjadi kesalahan koneksi.")}finally{r.innerHTML=g,r.disabled=!1}}),document.getElementById("btn-download-template").addEventListener("click",()=>{da(),ne("Template Excel berhasil didownload!")});let n=document.getElementById("file-input"),s=document.getElementById("upload-zone");document.getElementById("btn-browse").addEventListener("click",g=>{g.stopPropagation(),n.click()}),n.addEventListener("change",g=>{g.target.files[0]&&l(g.target.files[0])}),s.addEventListener("dragover",g=>{g.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",g=>{g.preventDefault(),s.classList.remove("drag-over");let f=g.dataTransfer.files[0];f&&f.name.match(/\.xlsx?$/i)?l(f):G("Hanya file .xlsx atau .xls yang didukung.")}),document.getElementById("btn-clear-file").addEventListener("click",()=>{e=null,n.value="",document.getElementById("file-info").style.display="none",s.style.display="",d("upload")});async function l(g){e=g,document.getElementById("file-name-display").textContent=`\u{1F4C4} ${g.name} (${(g.size/1024).toFixed(1)} KB)`,document.getElementById("file-info").style.display="flex",s.style.display="none",await b(g)}async function b(g){d("validating");let f=document.getElementById("validation-status"),v=document.getElementById("validation-bar");try{if(!window.XLSX)throw new Error("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");f.textContent="Membaca file Excel...",v.style.width="20%",await et(200);let S=await g.arrayBuffer(),D=window.XLSX.read(S,{type:"array",cellDates:!0});f.textContent=`Memvalidasi ${D.SheetNames.length} sheet...`,v.style.width="50%",await et(100),i=oa(D),v.style.width="100%",f.textContent="Validasi selesai!",await et(300),p()}catch(S){d("upload"),G("Gagal memproses file: "+S.message),document.getElementById("file-info").style.display="flex",s.style.display="none"}}function p(){d("preview");let g=i.filter(T=>!T.skipped).length,f=i.reduce((T,F)=>T+F.total,0),v=i.reduce((T,F)=>T+F.valid,0),S=i.reduce((T,F)=>T+F.errorCount,0),D=f>0?Math.round(v/f*100):0;document.getElementById("preview-summary-badges").innerHTML=`
    ...
    `;let $=document.getElementById("preview-table-container");$.innerHTML=`
    ...
    `,$.querySelectorAll(".btn-detail-error").forEach(T=>{T.addEventListener("click",()=>{let F=i[Number(T.dataset.idx)];u(F)})});let P=document.getElementById("error-detail-section"),E=document.getElementById("error-detail-container");E.innerHTML="",P.style.display="none";let L=document.getElementById("btn-start-import");v===0?(L.disabled=!0,L.innerHTML="\u26A0\uFE0F Tidak Ada Data Valid"):(L.disabled=!1,S>0?(L.innerHTML=`\u{1F680} Import ${v} Data Valid (${S} dilewati)`,L.title="Baris error akan dilewati, baris valid tetap diimport"):L.innerHTML=`\u{1F680} Mulai Import ${v} Data`)}function u(g){let f=document.getElementById("error-detail-section"),v=document.getElementById("error-detail-container");f.style.display="";let S=g.errors.slice(0,100).map(D=>(Array.isArray(D.errors)?D.errors:[]).map(P=>{let E=typeof P=="object";return`
          <tr>
            <td style="text-align:center"><span class="badge badge-danger">Baris ${D.row}</span></td>
            <td><strong>${E?P.column:"\u2014"}</strong></td>
            <td><code style="font-size:.78rem;color:var(--text-secondary)">${E&&P.originalValue!==void 0?P.originalValue||"(kosong)":"\u2014"}</code></td>
            <td class="error-msg">${E?P.reason:P}</td>
            <td style="font-size:.78rem;color:var(--success)">
              ${E&&P.aliases?`Gunakan salah satu nama kolom:<br><em>${P.aliases}</em>`:E&&P.hint?P.hint:""}
            </td>
          </tr>
    ...
    `,f.scrollIntoView({behavior:"smooth",block:"start"})}document.getElementById("btn-back-to-upload").addEventListener("click",()=>{d("upload"),document.getElementById("file-info").style.display="none",s.style.display="",e=null,n.value=""}),document.getElementById("btn-download-log").addEventListener("click",()=>{if(!i)return;ca(i)?ne("Log error berhasil didownload."):ne("Tidak ada error untuk didownload.")}),document.getElementById("btn-start-import").addEventListener("click",()=>{let g=document.querySelector('input[name="dup-strategy"]:checked')?.value||"skip";m(g)});async function m(g){d("importing"),a=Date.now();let f=[];Ga.forEach(P=>{let E=i?.find(L=>L.module===P&&L.mapped?.length>0);E&&f.push(E)});let v=document.getElementById("import-steps-list");v.innerHTML=f.map(P=>`
    ...
    `).join("");let S=document.getElementById("import-bar"),D=document.getElementById("import-current-status"),$={totalSheets:f.length,totalRows:f.reduce((P,E)=>P+E.mapped.length,0),inserted:0,skipped:0,failed:0,moduleResults:[]};for(let P=0;P<f.length;P++){let E=f[P],L=document.getElementById(`step-icon-${E.module}`),T=document.getElementById(`step-status-${E.module}`);L.textContent="\u{1F504}",T.textContent="Mengimport...",D.textContent=`Mengimport ${E.label}...`,S.style.width=`${Math.round(P/f.length*100)}%`;try{let F=await k(`/api/import/${E.module}`,{method:"POST",body:JSON.stringify({rows:E.mapped,onDuplicate:g})});if(F.ok){let K=F.data;$.inserted+=K.inserted||0,$.skipped+=K.skipped||0,$.moduleResults.push({label:E.label,inserted:K.inserted||0,skipped:K.skipped||0,status:"ok"}),L.textContent="\u2705",T.innerHTML=`<span class="badge badge-success">${K.inserted||0} berhasil</span>${K.skipped>0?` <span class="badge badge-neutral">${K.skipped} skip</span>`:""}`}else $.failed++,$.moduleResults.push({label:E.label,inserted:0,skipped:0,status:"error",error:F.data?.error}),L.textContent="\u274C",T.innerHTML='<span class="badge badge-danger">Gagal</span>'}catch(F){$.failed++,$.moduleResults.push({label:E.label,inserted:0,skipped:0,status:"error",error:F.message}),L.textContent="\u274C",T.innerHTML='<span class="badge badge-danger">Gagal</span>'}await et(150)}S.style.width="100%",D.textContent="Selesai!",await et(400),y($)}function y(g){d("summary");let f=((Date.now()-a)/1e3).toFixed(1),v=g.failed===0;document.getElementById("summary-status-icon").innerHTML=`
  ...
  `;let e=document.getElementById("btnRefreshSync"),i=document.getElementById("queueStatusFilter");e.addEventListener("click",o),i.addEventListener("change",n),document.getElementById("btnRetryAll").addEventListener("click",()=>a("retry",{allFailed:!0})),document.getElementById("btnResetStuck").addEventListener("click",()=>a("reset-stuck",{})),document.getElementById("btnPauseSync").addEventListener("click",()=>a("pause",{})),document.getElementById("btnResumeSync").addEventListener("click",()=>a("resume",{})),document.getElementById("btnReconcile").addEventListener("click",()=>a("reconcile",{module:"ALL",repairMode:!0})),document.getElementById("btnRetrySelected").addEventListener("click",()=>{let l=Array.from(document.querySelectorAll(".chk-queue:checked")).map(b=>b.value);if(l.length===0)return alert("No items selected");a("retry",{ids:l})}),document.getElementById("chkAllQueue").addEventListener("change",l=>{document.querySelectorAll(".chk-queue").forEach(b=>b.checked=l.target.checked)});async function a(l,b){if(confirm(`Are you sure you want to execute action: ${l}?`)){showLoading();try{let p=await k(`/api/sync/actions/${l}`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(b)});p.ok?(alert(p.data?.message||"Success"),o()):G(p.error||"Action failed")}catch(p){G(p.message)}hideLoading()}}await o();async function o(){showLoading(),await Promise.all([r(),n(),d(),s()]),hideLoading()}async function d(){try{let l=await k("/api/sync/performance");if(!l.ok)return;let{webhook:b,google_api:p,d1:u,queue:m,throughput:y}=l.data;document.getElementById("latencyHistograms").innerHTML=`
      ...
      `,document.getElementById("lblSnapshotStatus").innerHTML='Checked 10 modules. Status: <b>COMPLETED</b><br><span class="text-xs text-gray-500">Run today at 02:00</span>'}catch(l){console.error(l)}}async function r(){try{let l=await k("/api/sync/health");if(!l.ok)return G("Failed to fetch sync health");let{status:b,queue:p,circuit_breaker:u}=l.data,m=`
      ...
      `;document.getElementById("syncOverviewCards").innerHTML=m;let y=document.getElementById("cbStateBadge"),g=document.getElementById("cbStateDesc"),f=document.getElementById("cbStatusCard");f.className="bg-white rounded-lg shadow p-6 border-l-4",u==="CLOSED"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800",y.textContent="CLOSED",g.textContent="Traffic is flowing normally to Google Sheets.",f.classList.add("border-green-500")):u==="OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800",y.textContent="OPEN",g.textContent="Failing fast. Traffic to Google Sheets is paused due to repeated failures.",f.classList.add("border-red-500")):u==="HALF_OPEN"?(y.className="px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800",y.textContent="HALF-OPEN",g.textContent="Testing recovery. Permitting limited traffic to verify stability.",f.classList.add("border-yellow-500")):y.textContent=u||"UNKNOWN"}catch(l){console.error(l)}}async function n(){try{let l=document.getElementById("queueStatusFilter").value,b=await k("/api/sync/queue?limit=15"+(l?"&status="+l:""));if(!b.ok)return;let p=document.getElementById("queueTableBody"),u=b.data?.data||b.data||[];if(u.length===0){p.innerHTML='<tr><td colspan="6" class="px-4 py-4 text-center text-gray-500">No events found</td></tr>';return}p.innerHTML=u.map(m=>`
      ...
      `).join("")}catch(l){console.error(l)}}async function s(){try{let l=await k("/api/sync/metrics");if(!l.ok)return;let b=document.getElementById("metricsTableBody"),p=l.data||[];if(p.length===0){b.innerHTML='<tr><td colspan="5" class="px-4 py-4 text-center text-gray-500">No metrics found in last 24h</td></tr>';return}b.innerHTML=p.map(u=>`
        <tr class="hover:bg-gray-50">
