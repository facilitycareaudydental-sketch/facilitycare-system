    ...
    <div class="dashboard-wrap" id="dash-root">
      ...
      <div class="charts-row" style="grid-template-columns: 2fr 1fr 1fr;">
        ...
        <div class="chart-card" style="display:flex; flex-direction:column;">
          ...
          <div style="display:flex; flex-direction:column; gap:20px; align-items:center; justify-content:center; padding: 10px 0; margin-bottom: auto;">
            <div class="chart-canvas-wrap" style="width:160px; height:160px; position:relative">
            ...
            <div id="donut-legend" class="donut-legend" style="width:100%; display:flex; justify-content:center; flex-wrap:wrap; gap:15px;"></div>
          </div>
        ...
        <div class="chart-card" style="display:flex; flex-direction:column;">
          ...
          <div class="chart-canvas-wrap" style="width:100%; height:200px; position:relative; margin-top:auto; margin-bottom:auto;">
