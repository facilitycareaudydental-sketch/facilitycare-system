var Ba=Object.defineProperty;var Fe=(a,e)=>()=>(a&&(e=a(a=0)),e);var Re=(a,e)=>{for(var n in e)Ba(a,n,{get:e[n],enumerable:!0})};var ce={};Re(ce,{API:()=>Ke,apiFetch:()=>f,clearToken:()=>le,getToken:()=>re,getUser:()=>ae,setToken:()=>_e,setUser:()=>oe});function re(){return localStorage.getItem("fm_token")}function _e(a){localStorage.setItem("fm_token",a)}function le(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function ae(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function oe(a){localStorage.setItem("fm_user",JSON.stringify(a))}async function f(a,e={}){let n=re(),i={"Content-Type":"application/json",...n?{Authorization:`Bearer ${n}`}:{},...e.headers||{}};try{let t=`cb=${Date.now()}`,c=a.includes("?")?"&":"?",u=`${Ke}${a}${c}${t}`,m=await fetch(u,{...e,headers:i}),s;try{let r=await m.text();try{s=JSON.parse(r)}catch{s={error:`Server Error (${m.status}): ${r.substring(0,80)}...`}}}catch{s={error:"Gagal membaca respon dari server"}}return m.status===401&&(le(),window.location.hash="#/login"),{ok:m.ok,status:m.status,data:s}}catch(t){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${t.message})`}}}}var Na,Ke,P=Fe(()=>{Na="",Ke=Na});var U={};Re(U,{downloadExcel:()=>T,parseExcel:()=>Ee,renderExcelButtons:()=>$e});function Ee(a){return new Promise((e,n)=>{let i=new FileReader;i.onload=t=>{try{let c=new Uint8Array(t.target.result),u=XLSX.read(c,{type:"array"}),m=u.SheetNames[0],s=u.Sheets[m],r=XLSX.utils.sheet_to_json(s,{defval:""});e(r)}catch(c){n(c)}},i.onerror=t=>n(t),i.readAsArrayBuffer(a)})}function T(a,e){try{let n=XLSX.utils.json_to_sheet(a),i=XLSX.utils.book_new();XLSX.utils.book_append_sheet(i,n,"Data"),XLSX.writeFile(i,`${e}.xlsx`)}catch(n){throw console.error("Error generating Excel file:",n),n}}function $e(a){return`
  ...
  `}var I=Fe(()=>{});P();var we={},be=null;function D(a,e){we[a]=e}function te(a){window.location.hash=a}function qe(){async function a(){let e=window.location.hash.replace("#","")||"/dashboard",[n,...i]=e.split("?"),t=we[n];if(!t){for(let[u,m]of Object.entries(we))if(u.endsWith("/*")&&n.startsWith(u.slice(0,-2))){t=m;break}}be&&(be(),be=null);let c=document.getElementById("main-content");if(c&&(c.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),t){let u=new URLSearchParams(i.join("?")),m=n.split("/").filter(Boolean),s=await t({path:n,params:u,segments:m,main:c});s&&(be=s)}else{let u=c||document.getElementById("app");u&&(u.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",a),a()}var de;function Oa(){return de||(de=document.createElement("div"),de.id="toast-container",document.body.appendChild(de)),de}function He(a,e="info",n=3500){let i=Oa(),t=document.createElement("div");t.className=`toast toast-${e}`;let c={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};t.innerHTML=`<span class="toast-icon">${c[e]||"\u2139"}</span><span class="toast-msg">${a}</span>`,i.appendChild(t),requestAnimationFrame(()=>t.classList.add("show")),setTimeout(()=>{t.classList.remove("show"),setTimeout(()=>t.remove(),350)},n)}var F=a=>He(a,"success"),H=a=>He(a,"error");function Y({title:a,content:e,onConfirm:n,onCancel:i,confirmText:t="Simpan",cancelText:c="Batal",size:u="md",confirmClass:m="btn-primary"}){let s={sm:"400px",md:"560px",lg:"720px",xl:"900px"},r=document.createElement("div");r.className="modal-overlay",r.innerHTML=`
  ...
  `,e instanceof HTMLElement&&r.querySelector(".modal-body").appendChild(e);let o=()=>{r.classList.remove("show"),setTimeout(()=>r.remove(),250)};return r.querySelector(".modal-close").addEventListener("click",()=>{i&&i(),o()}),r.querySelector(".modal-cancel").addEventListener("click",()=>{i&&i(),o()}),n&&r.querySelector(".modal-confirm").addEventListener("click",()=>n(r,o)),r.addEventListener("click",l=>{l.target===r&&(i&&i(),o())}),document.body.appendChild(r),requestAnimationFrame(()=>r.classList.add("show")),{overlay:r,close:o}}function je(a,e,n="Konfirmasi"){return Y({title:n,content:`<p>${a}</p>`,onConfirm:(i,t)=>{e(),t()},confirmText:"Ya, Lanjutkan",confirmClass:"btn-danger"})}P();var ee={};function pe(a){if(ee[a]){try{ee[a].destroy()}catch{}delete ee[a]}}function Ma(){Object.keys(ee).forEach(pe)}var q=(a,e=0)=>{let n=Number(a);return isNaN(n)||a===null||a===void 0?e:n},j=(a,e="\u2014")=>{if(a==null||a==="")return e;let n=String(a).trim();return n===""||n==="[object Object]"?e:n},Je=a=>{if(!a)return"\u2014";try{let e=new Date(a);return isNaN(e)?j(a):e.toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric"})}catch{return j(a)}},Aa=a=>{if(!a)return"";try{let e=Date.now()-new Date(a).getTime();if(e<0)return"Baru saja";let n=Math.floor(e/6e4);if(n<1)return"Baru saja";if(n<60)return`${n} menit lalu`;let i=Math.floor(n/60);return i<24?`${i} jam lalu`:`${Math.floor(i/24)} hari lalu`}catch{return""}},Ge=a=>{if(!a||typeof a!="string")return"";try{let[e,n]=a.split("-");return new Date(Number(e),Number(n)-1).toLocaleDateString("id-ID",{month:"short",year:"2-digit"})}catch{return a}};function Qe(a,e,n=900){if(!a)return;let i=Math.max(0,Math.round(q(e)));if(i===0){a.textContent="0";return}let t=Date.now(),c=()=>{let u=Math.min((Date.now()-t)/n,1),m=1-Math.pow(1-u,3);a.textContent=Math.round(m*i).toLocaleString("id-ID"),u<1?requestAnimationFrame(c):a.textContent=i.toLocaleString("id-ID")};requestAnimationFrame(c)}function Fa(a,e){if(a=q(a),e=q(e),e===0)return"";let n=a-e,i=Math.abs(Math.round(n/e*100));return n>0?`<span class="kpi-trend up">\u25B2 ${i}%</span>`:n<0?`<span class="kpi-trend down">\u25BC ${i}%</span>`:'<span class="kpi-trend neutral">= Sama</span>'}var Ra={Done:"pill-success",Aktif:"pill-success",Selesai:"pill-success",Open:"pill-danger",Pending:"pill-warning","In Progress":"pill-info","Tidak Aktif":"pill-neutral",Resign:"pill-neutral",Cut:"pill-neutral"},Ve=a=>{let e=j(a,"\u2014");return`<span class="status-pill ${Ra[e]||"pill-neutral"}">${e}</span>`},Ka=a=>{let e=q(a,999);return e<=7?`<span class="days-badge days-critical">${e} hari</span>`:e<=14?`<span class="days-badge days-warning">${e} hari</span>`:e<=30?`<span class="days-badge days-soon">${e} hari</span>`:`<span class="days-badge days-ok">${e} hari</span>`},qa={issue:{emoji:"\u26A0\uFE0F",dot:"dot-danger",label:"Permasalahan"},contract:{emoji:"\u{1F4C4}",dot:"dot-info",label:"Kontrak"},employee:{emoji:"\u{1F464}",dot:"dot-success",label:"Karyawan"},one_on_one:{emoji:"\u{1F91D}",dot:"dot-purple",label:"One on One"},training:{emoji:"\u{1F393}",dot:"dot-primary",label:"Training"},supply:{emoji:"\u{1F4E6}",dot:"dot-warning",label:"Permintaan Barang"},reliever:{emoji:"\u{1F504}",dot:"dot-teal",label:"Reliefer"},inspection:{emoji:"\u{1F50D}",dot:"dot-blue",label:"Laporan Inspeksi"}},Ha=a=>qa[a]||{emoji:"\u{1F4CC}",dot:"dot-neutral",label:j(a,"Aktivitas")},G={family:"Inter",size:11},ne="#94A3B8",he="#F1F5F9",ja=["#2563EB","#10B981","#F59E0B","#EF4444","#8B5CF6","#0EA5E9","#F97316","#14B8A6","#6366F1","#EC4899"],Ua=()=>window.innerWidth<768;function xe(a={}){return{responsive:!0,maintainAspectRatio:!1,animation:{duration:700,easing:"easeOutQuart"},plugins:{legend:{position:Ua()?"bottom":"top",labels:{font:G,color:"#64748B",usePointStyle:!0,padding:10,boxWidth:8,boxHeight:8}},tooltip:{mode:"index",intersect:!1,bodyFont:G,titleFont:{...G,weight:"700"}}},scales:{x:{grid:{color:he},ticks:{font:G,color:ne,maxRotation:0}},y:{grid:{color:he},ticks:{font:G,color:ne},beginAtZero:!0}},...a}}var Ja=()=>Array(5).fill(0).map(()=>`
  ...
  <div class="mini-stat" style="pointer-events:none">
  ...
  </div>`).join("");function Ue(a=3){return Array(a).fill(0).map((e,n)=>`<div class="skeleton skeleton-text" style="height:38px;margin-bottom:${n<a-1?"6px":"0"};border-radius:6px"></div>`).join("")}function Qa(){return Array(5).fill(0).map(()=>`
    ...
    </div>`).join("")}async function X(a,e,n=8e3){try{let i=new AbortController,t=setTimeout(()=>i.abort(),n),c=await f(a,{signal:i.signal}).catch(()=>null);if(clearTimeout(t),!c||!c.ok)return e;let u=c.data;return u?u.data!==void 0?u.data??e:u:e}catch{return e}}function Va(){["skel-donut","skel-trend","skel-insp","skel-contract"].forEach(i=>{let t=document.getElementById(i);t&&(t.style.display="none")}),["chart-donut","chart-trend","chart-insp","chart-contract"].forEach(i=>{let t=document.getElementById(i);if(t&&t.style.display==="none"){t.style.display="block";let c=t.parentElement;if(c&&!c.querySelector(".chart-empty")){let u=document.createElement("div");u.className="chart-empty",u.textContent="Belum ada data",t.style.display="none",c.appendChild(u)}}});let a=document.getElementById("kpi-row");a&&a.querySelector(".skeleton")&&ze({});let e=document.getElementById("mini-stats-row");e&&e.querySelector(".skeleton")&&Ye({}),["table-contracts","table-issues"].forEach(i=>{let t=document.getElementById(i);t&&t.querySelector(".skeleton")&&(t.innerHTML='<div class="chart-empty">Belum ada data</div>')});let n=document.getElementById("activity-log");n&&n.querySelector(".skeleton")&&(n.innerHTML='<div class="chart-empty">Belum ada aktivitas</div>')}async function We(a){Ma(),a._dashRefresh&&clearInterval(a._dashRefresh),a._skelTimeout&&clearTimeout(a._skelTimeout),a.innerHTML=`
    <div class="dashboard-wrap" id="dash-root">
      ...
      <!-- KPI -->
      <div class="kpi-row" id="kpi-row">${Ja()}</div>
      ...
      <div class="chart-card">
        ...
        <div id="activity-log">${Qa()}</div>
      </div>

    </div>
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>Ce(a)),a._skelTimeout=setTimeout(()=>Va(),5e3),await Ce(a),a._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?Ce(a):clearInterval(a._dashRefresh)},6e4)}async function Ce(a){a._skelTimeout&&(clearTimeout(a._skelTimeout),a._skelTimeout=null);let[e,n,i,t,c,u,m,s]=await Promise.all([X("/api/dashboard/kpi",{},8e3),X("/api/dashboard/issues-trend",{},8e3),X("/api/dashboard/contracts-chart",{},8e3),X("/api/dashboard/issues-summary",{},8e3),X("/api/dashboard/inspection-bar",{},8e3),X("/api/dashboard/contracts-expiring",[],8e3),X("/api/dashboard/stats",{},8e3),X("/api/dashboard/activity-log",[],8e3)]);try{ze(e)}catch(o){console.warn("KPI render:",o)}try{Ye(e)}catch(o){console.warn("MiniStats render:",o)}try{Wa(Array.isArray(t?.by_category)?t.by_category:[])}catch(o){console.warn("Donut render:",o),Z("skel-donut","chart-donut")}try{za(n)}catch(o){console.warn("Trend render:",o),Z("skel-trend","chart-trend")}try{Ya(c)}catch(o){console.warn("InspBar render:",o),Z("skel-insp","chart-insp")}try{Xa(i)}catch(o){console.warn("ContractBar render:",o),Z("skel-contract","chart-contract")}try{let o=Array.isArray(u)?u:[];Za(o)}catch(o){console.warn("ContractsTable render:",o)}try{let o=Array.isArray(m)?m:Array.isArray(m?.recent_issues)?m.recent_issues:[];et(o)}catch(o){console.warn("IssuesTable render:",o)}try{at(Array.isArray(s)?s:[])}catch(o){console.warn("ActivityLog render:",o)}let r=document.getElementById("dash-updated");r&&(r.textContent=`Diperbarui: ${new Date().toLocaleTimeString("id-ID")}`)}function ze(a){let e=document.getElementById("kpi-row");if(!e)return;a=a||{};let n=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees",color:"kpi-blue",key:"employees"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts",color:"kpi-green",key:"contracts"},{icon:"\u23F0",label:"Kontrak Habis 30 Hari",sub:"",href:"#/contracts",color:"",key:"expiring30",warn:!0},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues",color:"",key:"issues",warnIfGT0:!0},{icon:"\u{1F91D}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one",color:"kpi-purple",key:"one_on_one"}];e.innerHTML=n.map(i=>{let t=q(a[i.key]?.current,0),c=a[i.key]?.prev,u=c!=null?Fa(t,c):"",m=i.color||"",s=i.sub||"";return i.warn&&(m=t>0?"kpi-amber":"kpi-green",s=t>0?`\u26A0\uFE0F ${t} kontrak segera berakhir`:"\u2705 Semua kontrak aman"),i.warnIfGT0&&(m=t>0?"kpi-red":"kpi-green"),`
    ...
    <a href="${i.href}" class="mini-stat ${i.color}" style="text-decoration:none">
      ...
      <div class="mini-stat-body">
        <div class="mini-stat-value" data-target="${q(i.val)}">0</div>
        <div class="mini-stat-label">${i.label}</div>
      </div>
    </a>`).join(""),e.querySelectorAll(".mini-stat-value").forEach(i=>Qe(i,parseInt(i.dataset.target)||0,700))}function Wa(a){Z("skel-donut","chart-donut");let e=document.getElementById("chart-donut");if(!e)return;pe("donut");let n=(a||[]).filter(c=>q(c.count)>0);if(!n.length){ye(e,"Belum ada data permasalahan");return}let i=n.map(c=>j(c.category,"Lainnya")),t=n.map(c=>q(c.count));ee.donut=new Chart(e,{type:"doughnut",data:{labels:i,datasets:[{data:t,backgroundColor:ja.slice(0,n.length),borderWidth:2,borderColor:"#fff",hoverBorderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,animation:{duration:700},plugins:{legend:{position:window.innerWidth<768?"bottom":"right",labels:{font:G,color:"#475569",usePointStyle:!0,padding:10,boxWidth:8,boxHeight:8}},tooltip:{bodyFont:G,titleFont:{...G,weight:"700"},callbacks:{label:c=>` ${c.label}: ${c.parsed} kasus`}}},cutout:"65%"}})}function za(a){Z("skel-trend","chart-trend");let e=document.getElementById("chart-trend");if(!e)return;pe("trend"),a=a||{};let n=(a.labels||[]).map(Ge),i=(a.open||[]).map(c=>q(c)),t=(a.closed||[]).map(c=>q(c));if(!n.length){ye(e,"Belum ada data trend");return}ee.trend=new Chart(e,{type:"line",data:{labels:n,datasets:[{label:"Open",data:i,borderColor:"#EF4444",backgroundColor:"rgba(239,68,68,.08)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#EF4444",borderWidth:2},{label:"Closed",data:t,borderColor:"#10B981",backgroundColor:"rgba(16,185,129,.08)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#10B981",borderWidth:2}]},options:xe({plugins:{legend:{position:"top"}}})})}function Ya(a){Z("skel-insp","chart-insp");let e=document.getElementById("chart-insp");if(!e)return;pe("inspBar"),a=a||{};let n=a.labels||[],i=(a.fc||[]).map(c=>q(c)),t=(a.spv||[]).map(c=>q(c));if(!n.length){ye(e,"Belum ada data inspeksi");return}ee.inspBar=new Chart(e,{type:"bar",data:{labels:n,datasets:[{label:"Skor FC",data:i,backgroundColor:"rgba(37,99,235,.75)",borderRadius:4,borderSkipped:!1},{label:"Skor SPV",data:t,backgroundColor:"rgba(16,185,129,.75)",borderRadius:4,borderSkipped:!1}]},options:xe({plugins:{legend:{position:"top"}},scales:{x:{grid:{display:!1},ticks:{font:G,color:ne,maxRotation:45,minRotation:30}},y:{grid:{color:he},ticks:{font:G,color:ne},min:0,max:100}}})})}function Xa(a){Z("skel-contract","chart-contract");let e=document.getElementById("chart-contract");if(!e)return;pe("contractBar"),a=a||{};let n=(a.labels||[]).map(Ge),i=(a.counts||[]).map(c=>q(c));if(!n.length){ye(e,"Belum ada data kontrak");return}let t=i.map(c=>c>5?"rgba(239,68,68,.75)":c>2?"rgba(245,158,11,.75)":"rgba(37,99,235,.65)");ee.contractBar=new Chart(e,{type:"bar",data:{labels:n,datasets:[{label:"Kontrak Berakhir",data:i,backgroundColor:t,borderRadius:6,borderSkipped:!1}]},options:xe({plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:G,color:ne}},y:{grid:{color:he},ticks:{font:G,color:ne,precision:0},beginAtZero:!0}}})})}function Za(a){let e=document.getElementById("table-contracts");if(!e)return;let n=(a||[]).filter(i=>q(i.days_remaining,999)<=30).slice(0,10);if(!n.length){e.innerHTML='<div class="chart-empty">\u2705 Tidak ada kontrak yang habis dalam 30 hari</div>';return}e.innerHTML=`
    <table class="dash-table">
      ...
      <tbody>${n.map((i,t)=>`
        <tr>
          ...
          <td>${Ka(i.days_remaining)}</td>
          <td>${Ve(i.status)}</td>
        </tr>`).join("")}
      </tbody>
    </table>`}function et(a){let e=document.getElementById("table-issues");if(!e)return;let n=(a||[]).slice(0,8);if(!n.length){e.innerHTML='<div class="chart-empty">\u2705 Tidak ada permasalahan terbuka</div>';return}e.innerHTML=`
    <table class="dash-table">
      <thead><tr>
    ...
    </table>`}function at(a){let e=document.getElementById("activity-log");if(!e)return;let n=(a||[]).slice(0,15);if(!n.length){e.innerHTML='<div class="chart-empty">Belum ada aktivitas tercatat</div>';return}e.innerHTML=`<div class="activity-list">${n.map(i=>{let t=Ha(i.type),c=j(i.label),u=i.branch?` \u2022 ${j(i.branch)}`:"",m=Aa(i.created_at);return`
      <div class="activity-item">
  ...
  `;let e=document.getElementById("login-form"),n=document.getElementById("login-error"),i=document.getElementById("login-btn"),t=document.getElementById("toggle-password"),c=document.getElementById("login-password");t?.addEventListener("click",()=>{let u=c.type==="text";c.type=u?"password":"text",t.style.color=u?"":"var(--primary)"}),e?.addEventListener("submit",async u=>{u.preventDefault(),n.style.display="none";let m=e.username.value.trim(),s=e.password.value;if(!m||!s){n.textContent="Username dan password wajib diisi.",n.style.display="block";return}i.querySelector(".btn-text").style.display="none",i.querySelector(".btn-spinner").style.display="",i.disabled=!0;try{let r=await f("/api/auth/login",{method:"POST",body:JSON.stringify({username:m,password:s})});r.ok&&r.data.success?(_e(r.data.data.token),oe(r.data.data.user),F("Login berhasil! Selamat datang \u{1F44B}"),window.dispatchEvent(new Event("fm:login"))):(n.textContent=r.data.error||"Username atau password salah.",n.style.display="block",i.classList.add("shake"),setTimeout(()=>i.classList.remove("shake"),600))}catch{n.textContent="Gagal terhubung ke server. Periksa koneksi internet.",n.style.display="block"}finally{i.querySelector(".btn-text").style.display="",i.querySelector(".btn-spinner").style.display="none",i.disabled=!1}})}P();function Ze({columns:a,data:e,onEdit:n,onDelete:i,onView:t,actions:c=[],emptyText:u="Tidak ada data",bulkSelect:m=null}){let s=document.createElement("div");if(s.className="table-wrapper",!e||e.length===0)return s.innerHTML=`<div class="empty-state"><p>${u}</p></div>`,s;let r=document.createElement("table");r.className="data-table";let o=document.createElement("thead"),l=document.createElement("tr");if(m){let b=document.createElement("th");b.style.width="40px",b.style.textAlign="center";let g=document.createElement("input");g.type="checkbox",g.id="select-all-checkbox",g.title="Pilih semua",g.addEventListener("change",()=>{e.forEach(d=>{g.checked?m.selectedIds.add(d.id):m.selectedIds.delete(d.id)}),s.querySelectorAll(".row-checkbox").forEach(d=>d.checked=g.checked),m.onToggle()}),b.appendChild(g),l.appendChild(b)}if(a.forEach(b=>{let g=document.createElement("th");g.textContent=b.label,b.width&&(g.style.width=b.width),l.appendChild(g)}),n||i||t||c.length>0){let b=document.createElement("th");b.textContent="Aksi",b.style.width="120px",l.appendChild(b)}o.appendChild(l),r.appendChild(o);let y=document.createElement("tbody");return e.forEach(b=>{let g=document.createElement("tr");if(m){let d=document.createElement("td");d.style.textAlign="center",d.style.width="40px";let p=document.createElement("input");p.type="checkbox",p.className="row-checkbox",p.checked=m.selectedIds.has(b.id),p.addEventListener("change",()=>{if(p.checked)m.selectedIds.add(b.id);else{m.selectedIds.delete(b.id);let h=document.getElementById("select-all-checkbox");h&&(h.checked=!1)}m.onToggle()}),d.appendChild(p),g.appendChild(d)}if(a.forEach(d=>{let p=document.createElement("td");if(d.render){let h=d.render(b[d.key],b);h instanceof HTMLElement?p.appendChild(h):p.innerHTML=h||""}else p.textContent=b[d.key]!==null&&b[d.key]!==void 0&&b[d.key]!==""?b[d.key]:"";d.nowrap&&(p.style.whiteSpace="nowrap"),g.appendChild(p)}),n||i||t||c.length>0){let d=document.createElement("td");d.className="actions-cell";let p=document.createElement("div");if(p.className="btn-group",t){let h=document.createElement("button");h.className="btn btn-xs btn-ghost",h.innerHTML="\u{1F441}",h.title="Lihat",h.addEventListener("click",()=>t(b)),p.appendChild(h)}if(n){let h=document.createElement("button");h.className="btn btn-xs btn-secondary",h.innerHTML="\u270F\uFE0F",h.title="Edit",h.addEventListener("click",()=>n(b)),p.appendChild(h)}if(c.forEach(h=>{let v=document.createElement("button");v.className=`btn btn-xs ${h.class||"btn-ghost"}`,v.innerHTML=h.icon||h.label,v.title=h.label,v.addEventListener("click",()=>h.handler(b)),p.appendChild(v)}),i){let h=document.createElement("button");h.className="btn btn-xs btn-danger",h.innerHTML="\u{1F5D1}\uFE0F",h.title="Hapus",h.addEventListener("click",()=>i(b)),p.appendChild(h)}d.appendChild(p),g.appendChild(d)}y.appendChild(g)}),r.appendChild(y),s.appendChild(r),s}function ea({page:a,pages:e,total:n,limit:i,onPage:t}){if(e<=1)return null;let c=document.createElement("div");c.className="pagination";let u=document.createElement("span");u.className="pagination-info",u.textContent=`Total: ${n} data`,c.appendChild(u);let m=document.createElement("div");m.className="pagination-btns";let s=(l,y,b=!1,g=!1)=>{let d=document.createElement("button");d.className=`btn btn-sm ${g?"btn-primary":"btn-ghost"} pagination-btn`,d.textContent=l,d.disabled=b,d.addEventListener("click",()=>t(y)),m.appendChild(d)};s("\xAB",1,a===1),s("\u2039",a-1,a===1);let r=Math.max(1,a-2),o=Math.min(e,a+2);for(let l=r;l<=o;l++)s(l,l,!1,l===a);return s("\u203A",a+1,a===e),s("\xBB",e,a===e),c.appendChild(m),c}function Te(a){return a.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="row")return`<div class="form-row">${Te(e.fields)}</div>`;let n=e.required?"required":"",i=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",t="";switch(e.type){case"textarea":t=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${n} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let u=(e.options||[]).map(m=>{let s=typeof m=="object"?m.value:m,r=typeof m=="object"?m.label:m,o=e.value==s?"selected":"";return`<option value="${s}" ${o}>${r}</option>`}).join("");t=`<select name="${e.name}" class="form-control" ${n}><option value="">-- Pilih ${e.label||""} --</option>${u}</select>`;break;case"checkbox":t=`<label class="checkbox-label"><input type="checkbox" name="${e.name}" value="1" ${e.value?"checked":""}> ${e.checkLabel||e.label}</label>`;break;case"date":t=`<input type="date" name="${e.name}" class="form-control" value="${e.value||""}" ${n}>`;break;case"number":t=`<input type="number" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" min="${e.min||""}" max="${e.max||""}" step="${e.step||"1"}" ${n}>`;break;case"email":t=`<input type="email" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${n}>`;break;case"url":t=`<input type="url" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||"https://..."}" ${n}>`;break;default:t=`<input type="${e.type||"text"}" name="${e.name}" class="form-control" value="${e.value||""}" placeholder="${e.placeholder||""}" ${n} autocomplete="off">`}let c=e.hint?`<div class="form-hint">${e.hint}</div>`:"";return`<div class="form-group ${e.class||""}">${i}${t}${c}</div>`}).join("")}function aa(a){let e={},n=new FormData(a);for(let[i,t]of n.entries())e[i]=t===""?null:t;return a.querySelectorAll("input[type=checkbox]").forEach(i=>{i.checked||(e[i.name]=null)}),e}function ta(a,e){e&&Object.entries(e).forEach(([n,i])=>{let t=a.querySelector(`[name="${n}"]`);t&&(t.type==="checkbox"?t.checked=!!i:t.value=i??"")})}I();function E({container:a,title:e,icon:n,apiPath:i,columns:t,formFields:c,filterFields:u,defaultFilters:m={},itemLabel:s="Data",canCreate:r=!0,canEdit:o=!0,canDelete:l=!0,onBeforeSubmit:y,onAfterLoad:b,extraActions:g=[],initialSearch:d="",exportOptions:p=null,bulkDelete:h=!1}){let v=1,S={...m};d&&(S.search=d);let k=new Set;a.innerHTML=`
    ...
    <div class="bulk-toolbar" id="bulk-toolbar" style="display:none">
      ...
      <button class="btn btn-danger btn-sm" id="btn-bulk-delete">\u{1F5D1}\uFE0F Hapus Terpilih</button>
  ...
  `;function _(){let C=document.getElementById("bulk-toolbar");if(!C)return;let x=document.getElementById("bulk-count");k.size>0?(C.style.display="flex",x.textContent=`${k.size} item dipilih`):C.style.display="none"}document.getElementById("btn-bulk-cancel")?.addEventListener("click",()=>{k.clear(),document.querySelectorAll(".row-checkbox").forEach(x=>x.checked=!1);let C=document.getElementById("select-all-checkbox");C&&(C.checked=!1),_()}),document.getElementById("btn-bulk-delete")?.addEventListener("click",()=>{if(k.size===0)return;let C=[...k],x=document.createElement("div");x.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9999;display:flex;align-items:center;justify-content:center",x.innerHTML=`
    ...
    `,document.body.appendChild(x),x.querySelector("#bulk-cancel-btn").addEventListener("click",()=>x.remove()),x.querySelector("#bulk-confirm-btn").addEventListener("click",async()=>{let B=x.querySelector("#bulk-confirm-btn");B.disabled=!0,B.textContent="Menghapus...";let K=await f(`${i}/bulk`,{method:"DELETE",body:JSON.stringify({ids:C})});x.remove(),K.ok?(F(`${C.length} ${s} berhasil dihapus.`),k.clear(),_(),w()):H(K.data?.error||"Gagal menghapus data.")})});let $=document.getElementById("filter-search"),O;if($?.addEventListener("input",C=>{clearTimeout(O),O=setTimeout(()=>{S.search=C.target.value,v=1,w()},400)}),u?.forEach(C=>{C.type==="select"&&document.getElementById(`filter-${C.name}`)?.addEventListener("change",x=>{S[C.name]=x.target.value,v=1,w()})}),document.getElementById("btn-reset-filter")?.addEventListener("click",()=>{S={...m},$&&($.value=""),u?.forEach(C=>{let x=document.getElementById(`filter-${C.name}`);x&&(x.value="")}),v=1,w()}),document.getElementById("btn-create")?.addEventListener("click",()=>Q(null)),p){document.getElementById(`btn-export-${p.moduleName}`)?.addEventListener("click",async x=>{let B=x.target,K=B.innerHTML;B.innerHTML="\u23F3 Loading...",B.disabled=!0;try{await p.onExport()}catch{H("Gagal export data")}finally{B.innerHTML=K,B.disabled=!1}}),document.getElementById(`btn-template-${p.moduleName}`)?.addEventListener("click",()=>{p.onTemplate()});let C=document.getElementById(`input-import-${p.moduleName}`);C?.addEventListener("change",async x=>{let B=x.target.files[0];if(!B)return;let K=C.parentElement,J=K.innerHTML;K.innerHTML="\u23F3 Memproses...",K.style.pointerEvents="none",C.disabled=!0;try{let W=await Ee(B);if(W.length===0)throw new Error("File kosong atau format salah");await p.onImport(W),F("Import berhasil!"),w()}catch(W){H(W.message||"Gagal import data")}finally{K.innerHTML=J,K.style.pointerEvents="auto",C.disabled=!1,C.value=""}})}async function w(){let C=document.getElementById("table-container");if(!C)return;C.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';let x=new URLSearchParams({page:v,limit:20,...Object.fromEntries(Object.entries(S).filter(([,R])=>R))}),B=await f(`${i}?${x}`);if(!B.ok){C.innerHTML=`<div class="empty-state"><p class="text-danger">Gagal memuat data: ${B.data?.error||"Error"}</p></div>`;return}let K=B.data?.data||[],J=B.data?.pagination;b&&b(K);let W=Ze({columns:t,data:K,onEdit:o?R=>Q(R):null,onDelete:l?R=>Ia(R):null,actions:g.map(R=>({...R,handler:se=>R.handler(se,w)})),emptyText:`Tidak ada ${s.toLowerCase()}`,bulkSelect:h?{selectedIds:k,onToggle:_}:null});C.innerHTML="",C.appendChild(W);let z=document.getElementById("pagination-container");if(z&&(z.innerHTML="",J&&J.pages>1)){let R=ea({page:J.page,pages:J.pages,total:J.total,limit:J.limit,onPage:se=>{v=se,w()}});R&&z.appendChild(R)}}function L(C){let x=typeof c=="function"?c(C):c;return Te(x)}function Q(C){let x=!!C,B=document.createElement("form");if(B.noValidate=!0,B.innerHTML=L(C),x){let J=typeof c=="function"?c(C):c;ta(B,C)}let{close:K}=Y({title:x?`Edit ${s}`:`Tambah ${s}`,content:B,size:"lg",confirmText:x?"Simpan Perubahan":`Tambah ${s}`,onConfirm:async(J,W)=>{if(!B.reportValidity())return;let z=J.querySelector(".modal-confirm");z.disabled=!0,z.textContent="Menyimpan...";let R=aa(B);y&&(R=await y(R,C));let se=x?"PUT":"POST",Da=x?`${i}/${C.id}`:i,Ae=await f(Da,{method:se,body:JSON.stringify(R)});Ae.ok?(F(x?`${s} berhasil diperbarui.`:`${s} berhasil ditambahkan.`),W(),w()):(H(Ae.data?.error||"Gagal menyimpan data."),z.disabled=!1,z.textContent=x?"Simpan Perubahan":`Tambah ${s}`)}})}function Ia(C){je(`Hapus ${s} ini? Tindakan tidak dapat dibatalkan.`,async()=>{let x=await f(`${i}/${C.id}`,{method:"DELETE"});x.ok?(F(`${s} berhasil dihapus.`),w()):H(x.data?.error||"Gagal menghapus.")},`Hapus ${s}`)}return w(),w}P();function M(a){let e={Done:"badge-success",Aktif:"badge-success",Open:"badge-warning","In Progress":"badge-info",Pending:"badge-warning",Diproses:"badge-info",Selesai:"badge-success","Tidak Aktif":"badge-neutral",Resign:"badge-neutral",Cut:"badge-danger","Tidak Datang":"badge-danger"};return!a||a==="-"||String(a).trim()===""?"":`<span class="badge ${e[a]||"badge-neutral"}">${a}</span>`}function na(a){return a==null?'<span class="badge badge-neutral">-</span>':a<0?`<span class="badge badge-danger">Expired (${Math.abs(a)}h)</span>`:a<=14?`<span class="badge badge-danger">${a} hari</span>`:a<=30?`<span class="badge badge-warning">${a} hari</span>`:`<span class="badge badge-success">${a} hari</span>`}function fe(a){return`<span class="badge ${{"FACILITY CARE":"badge-info",SECURITY:"badge-secondary"}[a]||"badge-neutral"}">${a||"-"}</span>`}function ia(a){return`<span class="badge ${{"Inspeksi Hygiene & Aset Bangunan":"badge-info","General Cleaning":"badge-success","Deep Cleaning":"badge-purple",Fogging:"badge-warning"}[a]||"badge-neutral"}">${a||"-"}</span>`}function V(a){return`<span class="badge ${{Q1:"badge-info",Q2:"badge-success",Q3:"badge-warning",Q4:"badge-danger"}[a]||"badge-neutral"}">${a||"-"}</span>`}I();var Pe=[],Le=[];async function tt(){Le=(await f("/api/branches?all=1")).data?.data||[],Pe=Le.map(e=>({value:e.id,label:e.full_name}))}async function sa(a){await tt(),E({container:a,title:"Karyawan",icon:"\u{1F465}",apiPath:"/api/employees",itemLabel:"Karyawan",bulkDelete:!0,columns:[{key:"full_name",label:"Nama Lengkap"},{key:"branch_name",label:"Cabang"},{key:"division",label:"Divisi",render:e=>fe(e)},{key:"phone",label:"No. HP",render:e=>e?`<a href="tel:${e}">${e}</a>`:"-"},{key:"join_date",label:"Tgl Masuk",render:e=>window.formatDate(e)},{key:"status",label:"Status",render:e=>M(e)}],filterFields:[{type:"search",placeholder:"Cari nama karyawan..."},{type:"select",name:"branch_id",label:"Cabang",options:Pe},{type:"select",name:"division",label:"Divisi",options:["FACILITY CARE","SECURITY"]},{type:"select",name:"status",label:"Status",options:["Aktif","Tidak Aktif","Resign","Cut"]}],formFields:e=>[{type:"row",fields:[{name:"full_name",label:"Nama Lengkap",required:!0,placeholder:"Nama lengkap karyawan",value:e?.full_name},{name:"phone",label:"No. HP",placeholder:"08xx-xxxx-xxxx",value:e?.phone}]},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",options:Pe,value:e?.branch_id},{name:"division",label:"Divisi",type:"select",required:!0,options:["FACILITY CARE","SECURITY"],value:e?.division||"FACILITY CARE"}]},{type:"row",fields:[{name:"join_date",label:"Tanggal Masuk",type:"date",value:e?.join_date},{name:"status",label:"Status",type:"select",required:!0,options:["Aktif","Tidak Aktif","Resign","Cut"],value:e?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:e?.notes}],exportOptions:{moduleName:"employees",onExport:async()=>{let e=await f("/api/employees?limit=10000");if(e.ok){let n=e.data.data.map(i=>({"Nama Lengkap":i.full_name,Cabang:i.branch_name||"",Divisi:i.division||"","No. HP":i.phone||"","Tgl Masuk":i.join_date||"",Status:i.status||"",Catatan:i.notes||""}));T(n,"Data_Karyawan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{"Nama Lengkap":"Budi Santoso",Cabang:"001. Pondok Bambu",Divisi:"FACILITY CARE","No. HP":"08123456789","Tgl Masuk":"2024-01-15",Status:"Aktif",Catatan:""},{"Nama Lengkap":"Andi Saputra",Cabang:"002. Bintaro",Divisi:"SECURITY","No. HP":"08987654321","Tgl Masuk":"2023-11-01",Status:"Aktif",Catatan:""}],"Template_Import_Karyawan")},onImport:async e=>{let n=c=>{if(!c)return null;let u=c.toLowerCase(),m=Le.find(s=>s.full_name.toLowerCase()===u||s.code.toLowerCase()===u||s.name.toLowerCase()===u);return m?m.id:null},i=e.map(c=>({full_name:String(c["Nama Lengkap"]||"").trim(),branch_id:n(String(c.Cabang||"").trim()),division:String(c.Divisi||"").trim()||"FACILITY CARE",phone:String(c["No. HP"]||"").trim(),join_date:String(c["Tgl Masuk"]||"").trim(),status:String(c.Status||"").trim(),notes:String(c.Catatan||"").trim()})).filter(c=>c.full_name),t=await f("/api/employees/import",{method:"POST",body:JSON.stringify(i)});if(!t.ok)throw new Error(t.data?.error||"Import gagal")}}})}P();I();var Ie=[],ra=[];async function nt(){let[a,e]=await Promise.all([f("/api/branches?all=1"),f("/api/employees?limit=10000&status=Aktif")]);Ie=(a.data?.data||[]).map(n=>({value:n.id,label:n.full_name})),ra=(e.data?.data||[]).map(n=>({value:n.id,label:n.full_name}))}async function la(a){await nt(),E({container:a,title:"Data Kontrak",icon:"\u{1F4CB}",apiPath:"/api/contracts",bulkDelete:!0,itemLabel:"Kontrak",columns:[{key:"employee_name",label:"Nama Karyawan"},{key:"branch_name",label:"Cabang"},{key:"division",label:"Divisi",render:e=>fe(e)},{key:"start_date",label:"Tgl Mulai",nowrap:!0,render:e=>window.formatDate(e)},{key:"end_date",label:"Tgl Selesai",nowrap:!0,render:e=>window.formatDate(e)},{key:"days_remaining",label:"Sisa",render:e=>na(e)},{key:"contract_type",label:"Tipe Kontrak"},{key:"pkwt_number",label:"PKWT"},{key:"status",label:"Status",render:e=>M(e)}],filterFields:[{type:"search",placeholder:"Cari nama karyawan..."},{type:"select",name:"branch_id",label:"Cabang",options:Ie},{type:"select",name:"status",label:"Status",options:["Aktif","Tidak Aktif"]},{type:"select",name:"expiring_days",label:"Akan Habis",options:[{value:"7",label:"7 Hari"},{value:"14",label:"14 Hari"},{value:"30",label:"30 Hari"},{value:"60",label:"60 Hari"}]}],formFields:e=>[{type:"row",fields:[{name:"employee_id",label:"Karyawan",type:"select",required:!0,options:ra,value:e?.employee_id},{name:"branch_id",label:"Cabang",type:"select",options:Ie,value:e?.branch_id}]},{type:"row",fields:[{name:"division",label:"Divisi",type:"select",required:!0,options:["FACILITY CARE","SECURITY"],value:e?.division||"FACILITY CARE"},{name:"status",label:"Status",type:"select",required:!0,options:["Aktif","Tidak Aktif"],value:e?.status||""}]},{type:"row",fields:[{name:"start_date",label:"Tanggal Mulai",type:"date",required:!0,value:e?.start_date},{name:"end_date",label:"Tanggal Selesai",type:"date",required:!0,value:e?.end_date}]},{type:"row",fields:[{name:"contract_type",label:"Tipe Kontrak",type:"select",options:["KONTRAK 6 BULAN","KONTRAK 1 TAHUN","KONTRAK 2 TAHUN"],value:e?.contract_type},{name:"pkwt_number",label:"No. PKWT",type:"select",options:["PKWT 1","PKWT 2","PKWT 3","PKWT 4","PKWT 5","PKWT 6"],value:e?.pkwt_number}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:e?.notes}],exportOptions:{moduleName:"contracts",onExport:async()=>{let e=await f("/api/contracts?limit=10000");if(e.ok){let n=e.data.data.map(i=>({"Nama Karyawan":i.employee_name,Cabang:i.branch_name||"",Divisi:i.division||"","Tgl Mulai":i.start_date||"","Tgl Selesai":i.end_date||"","Tipe Kontrak":i.contract_type||"",PKWT:i.pkwt_number||"",Status:i.status||"",Catatan:i.notes||""}));T(n,"Data_Kontrak")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{"Nama Karyawan":"Budi Santoso",Cabang:"001. Pondok Bambu",Divisi:"FACILITY CARE","Tgl Mulai":"2024-01-01","Tgl Selesai":"2024-12-31","Tipe Kontrak":"KONTRAK 1 TAHUN",PKWT:"PKWT 1",Status:"Aktif",Catatan:""}],"Template_Import_Kontrak")},onImport:async e=>{let[n,i]=await Promise.all([f("/api/branches?all=1"),f("/api/employees?limit=10000")]),t=n.data?.data||[],c=i.data?.data||[],u=o=>{if(!o)return null;let l=o.toLowerCase(),y=t.find(b=>b.full_name.toLowerCase()===l||b.code.toLowerCase()===l||b.name.toLowerCase()===l);return y?y.id:null},m=o=>{if(!o)return null;let l=o.toLowerCase(),y=c.find(b=>b.full_name.toLowerCase()===l);return y?y.id:null},s=e.map(o=>({employee_id:m(String(o["Nama Karyawan"]||"").trim()),branch_id:u(String(o.Cabang||"").trim()),division:String(o.Divisi||"").trim()||"FACILITY CARE",start_date:String(o["Tgl Mulai"]||"").trim(),end_date:String(o["Tgl Selesai"]||"").trim(),contract_type:String(o["Tipe Kontrak"]||"").trim(),pkwt_number:String(o.PKWT||"").trim(),status:String(o.Status||"").trim(),notes:String(o.Catatan||"").trim()})).filter(o=>o.employee_id&&o.start_date&&o.end_date),r=await f("/api/contracts/import",{method:"POST",body:JSON.stringify(s)});if(!r.ok)throw new Error(r.data?.error||"Import gagal")}}})}P();I();var De=[],Be=[];async function oa(a){let[e,n,i]=await Promise.all([f("/api/branches?all=1"),f("/api/employees?limit=10000"),f("/api/pic")]);De=(e.data?.data||[]).map(s=>({value:s.id,label:s.full_name}));let t=(n.data?.data||[]).map(s=>({value:s.full_name,label:s.full_name}));Be=[...(i.data?.data||[]).filter(s=>s.role==="FC Spesialis").map(s=>({value:s.name,label:s.name}))];let u=s=>s&&!t.find(r=>r.value===s)?[...t,{value:s,label:s}]:t,m=s=>{if(!s||s==="-"||String(s).trim()==="")return"";let r=String(s).split("-");return r.length===3&&r[0].length===4?`${r[2]}-${r[1]}-${r[0]}`:s};E({container:a,title:"Jadwal Kegiatan",icon:"\u{1F5D3}\uFE0F",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:s=>ia(s)},{key:"period",label:"Periode",render:s=>V(s)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:s=>m(s)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:s=>m(s)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:s=>m(s)},{key:"status",label:"Status",render:s=>M(s)}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:De},{type:"select",name:"activity_type",label:"Kegiatan",options:["Inspeksi Hygiene & Aset Bangunan","General Cleaning","Deep Cleaning","Fogging"]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"select",name:"pic",label:"PIC",options:Be}],formFields:s=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",required:!0,options:De,value:s?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene & Aset Bangunan","General Cleaning","Deep Cleaning","Fogging"],value:s?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:s?.period},{name:"pic",label:"PIC",type:"select",options:Be,value:s?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:s?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:s?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:s?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:s?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:s?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let s=await f("/api/schedule?limit=10000");if(s.ok){let r=s.data.data.map(o=>({Cabang:o.branch_name||"",Kegiatan:o.activity_type||"",Periode:o.period||"",PIC:o.pic||"","Tgl Opening":o.opening_date||"","Tgl Target":o.target_date||"","Tgl Selesai":o.completion_date||"",Status:o.status||"",Catatan:o.notes||""}));T(r,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done",Catatan:""}],"Template_Import_Jadwal")},onImport:async s=>{let o=(await f("/api/branches?all=1")).data?.data||[],l=d=>{if(!d)return null;let p=d.toLowerCase(),h=o.find(v=>v.full_name.toLowerCase()===p||v.code.toLowerCase()===p||v.name.toLowerCase()===p);return h?h.id:null},y=d=>{if(d==null||d==="")return"";if(d instanceof Date&&!isNaN(d.getTime()))return d.toISOString().slice(0,10);let p=String(d).trim();if(p===""||p==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(p))return p.slice(0,10);if(/^\d{4,5}$/.test(p)){let v=Number(p);if(v>2e4&&v<99999){let S=new Date(Date.UTC(1899,11,30)+v*864e5);return isNaN(S.getTime())?"":S.toISOString().slice(0,10)}}let h=p.split(/[\/\-\.]/);if(h.length===3){let[v,S,k]=h.map(_=>_.trim());if(v.length===4&&S.length<=2&&k.length<=2)return`${v}-${S.padStart(2,"0")}-${k.padStart(2,"0")}`;if(k.length===4&&S.length<=2&&v.length<=2)return`${k}-${S.padStart(2,"0")}-${v.padStart(2,"0")}`}return p},b=s.map(d=>({branch_id:l(String(d.Cabang||"").trim()),activity_type:String(d.Kegiatan||"").trim(),period:String(d.Periode||"").trim(),pic:String(d.PIC||d.Pic||"").trim(),opening_date:y(d["Tgl Opening"]||d["Tanggal Opening"]),target_date:y(d["Tgl Target"]||d["Tanggal Target"]),completion_date:y(d["Tgl Selesai"]||d["Tanggal Selesai"]),status:String(d.Status||"").trim(),notes:String(d.Catatan||d.Keterangan||"").trim()})).filter(d=>d.activity_type&&d.period),g=await f("/api/schedule/import",{method:"POST",body:JSON.stringify(b)});if(!g.ok)throw new Error(g.data?.error||"Import gagal")}}})}P();I();var Ne=[],ve=[];async function ca(a){let[e,n,i]=await Promise.all([f("/api/branches?all=1"),f("/api/employees?limit=10000"),f("/api/pic")]);Ne=(e.data?.data||[]).map(l=>({value:l.id,label:l.full_name})),ve=(n.data?.data||[]).map(l=>({value:l.full_name,label:l.full_name}));let t=(i.data?.data||[]).filter(l=>l.role==="FC Spesialis").map(l=>({value:l.name,label:l.name})),c=(i.data?.data||[]).filter(l=>l.role==="Pelapor").map(l=>({value:l.name,label:l.name})),u=l=>l&&!ve.find(y=>y.value===l)?[...ve,{value:l,label:l}]:ve,m=l=>l&&!t.find(y=>y.value===l)?[...t,{value:l,label:l}]:t,s=l=>l&&!c.find(y=>y.value===l)?[...c,{value:l,label:l}]:c,r=new Date().getFullYear(),o=Array.from({length:5},(l,y)=>String(r-y));E({container:a,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,itemLabel:"Permasalahan",columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:l=>window.formatDate(l)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:l=>`<span class="badge badge-secondary">${l}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:l=>`<span title="${l}">${l?.length>50?l.slice(0,50)+"\u2026":l}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:l=>`<span title="${l||""}">${l?.length>40?l.slice(0,40)+"\u2026":l||"-"}</span>`},{key:"status",label:"Status",render:l=>M(l)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:l=>window.formatDate(l)},{key:"day_count",label:"Hari",render:l=>l??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"select",name:"branch_id",label:"Cabang",options:Ne},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:o}],formFields:l=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:l?.report_date},{name:"branch_id",label:"Cabang",type:"select",required:!0,options:Ne,value:l?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:l?.category},{name:"source",label:"Sumber Laporan",type:"select",options:[...s(l?.source),{value:"Lainnya",label:"Lainnya"}],value:l?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:l?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"select",options:u(l?.employee_name),value:l?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"select",options:m(l?.fc_specialist),value:l?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:l?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:l?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:l?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let l=await f("/api/issues?limit=10000");if(l.ok){let y=l.data.data.map(b=>({Tanggal:b.report_date||"",Cabang:b.branch_name||"",Kategori:b.category||"",Sumber:b.source||"",Keluhan:b.complaint||"","Nama FC":b.employee_name||"","FC Spesialis":b.fc_specialist||"",Solusi:b.solution||"","Tgl Selesai":b.completion_date||"",Status:b.status||""}));T(y,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async l=>{let b=(await f("/api/branches?all=1")).data?.data||[],g=h=>{if(!h)return null;let v=h.toLowerCase(),S=b.find(k=>k.full_name.toLowerCase()===v||k.code.toLowerCase()===v||k.name.toLowerCase()===v);return S?S.id:null},d=l.map(h=>({branch_id:g(String(h.Cabang||"").trim()),report_date:String(h.Tanggal||"").trim(),category:String(h.Kategori||"").trim(),source:String(h.Sumber||"").trim(),complaint:String(h.Keluhan||"").trim(),employee_name:String(h["Nama FC"]||"").trim(),fc_specialist:String(h["FC Spesialis"]||"").trim(),solution:String(h.Solusi||"").trim(),completion_date:String(h["Tgl Selesai"]||"").trim(),status:String(h.Status||"").trim()})).filter(h=>h.report_date&&h.complaint&&h.category),p=await f("/api/issues/import",{method:"POST",body:JSON.stringify(d)});if(!p.ok)throw new Error(p.data?.error||"Import gagal")}}})}P();async function da(a){let[e,n,i]=await Promise.all([f("/api/branches?all=1"),f("/api/employees?limit=10000"),f("/api/pic")]),t=(e.data?.data||[]).map(r=>({value:r.id,label:r.full_name})),c=(n.data?.data||[]).map(r=>({value:r.full_name,label:r.full_name})),u=(i.data?.data||[]).filter(r=>r.role==="FC Spesialis").map(r=>({value:r.name,label:r.name})),m=r=>r&&!c.find(o=>o.value===r)?[...c,{value:r,label:r}]:c,s=r=>r&&!u.find(o=>o.value===r)?[...u,{value:r,label:r}]:u;E({container:a,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,itemLabel:"One on One",columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:r=>window.formatDate(r)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:r=>`<span title="${r||""}">${r?.length>50?r.slice(0,50)+"\u2026":r||"-"}</span>`},{key:"solution",label:"Solusi",render:r=>`<span title="${r||""}">${r?.length>40?r.slice(0,40)+"\u2026":r||"-"}</span>`},{key:"status",label:"Status",render:r=>M(r)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:r=>window.formatDate(r)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:r=>r?`<a href="${r}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"select",name:"branch_id",label:"Cabang",options:t},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async r=>{let o=new URLSearchParams(r||{}).toString(),l=await f(`/api/one-on-one?limit=10000&${o}`);if(l.ok){let y=l.data.data.map(g=>({Tanggal:g.meeting_date||"",Cabang:g.branch_name||"","Nama Karyawan":g.employee_name||"",PIC:g.pic||"",Masalah:g.problem||"",Solusi:g.solution||"",Status:g.status||"","Tgl Selesai":g.completion_date||"",Dokumen:g.document_link||""})),{downloadExcel:b}=await Promise.resolve().then(()=>(I(),U));b(y,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let r=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:o}=await Promise.resolve().then(()=>(I(),U));o(r,"Template_Import_OneOnOne")},onImport:async r=>{let o=g=>{if(!g)return null;let d=g.toLowerCase(),p=e.data?.data.find(h=>h.full_name.toLowerCase()===d||h.code.toLowerCase()===d||h.name.toLowerCase()===d);return p?p.id:null},l=g=>{if(!g)return"";if(g instanceof Date&&!isNaN(g.getTime()))return g.toISOString().slice(0,10);let d=String(g).trim();if(/^\d{4,5}$/.test(d)){let h=Number(d);if(h>2e4&&h<99999){let v=new Date(Date.UTC(1899,11,30)+h*864e5);return isNaN(v.getTime())?"":v.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(d))return d.slice(0,10);let p=d.split(/[\/\-\.]/);if(p.length===3){let[h,v,S]=p.map(k=>k.trim());if(h.length===4&&v.length<=2&&S.length<=2)return`${h}-${v.padStart(2,"0")}-${S.padStart(2,"0")}`;if(S.length===4&&v.length<=2&&h.length<=2)return`${S}-${v.padStart(2,"0")}-${h.padStart(2,"0")}`}return d},y=r.map(g=>({meeting_date:l(g.Tanggal),employee_name:String(g["Nama Karyawan"]||"").trim(),branch_id:o(String(g.Cabang||"").trim()),pic:String(g.PIC||"").trim(),problem:String(g.Masalah||"").trim(),solution:String(g.Solusi||"").trim(),status:String(g.Status||"").trim(),completion_date:l(g["Tgl Selesai"]),document_link:String(g.Dokumen||"").trim()})).filter(g=>g.meeting_date&&g.employee_name&&g.branch_id),b=await f("/api/one-on-one/import",{method:"POST",body:JSON.stringify(y)});if(!b.ok)throw new Error(b.data?.error||"Import gagal")}},formFields:r=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:r?.meeting_date},{name:"branch_id",label:"Cabang",type:"select",options:t,value:r?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"select",required:!0,options:m(r?.employee_name),value:r?.employee_name},{name:"pic",label:"PIC",type:"select",options:s(r?.pic),value:r?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:r?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:r?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:r?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:r?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:r?.document_link}]})}P();async function pa(a){let[e,n,i]=await Promise.all([f("/api/branches?all=1"),f("/api/employees?limit=10000"),f("/api/pic")]),t=(e.data?.data||[]).map(o=>({value:o.id,label:o.full_name})),c=(n.data?.data||[]).map(o=>({value:o.full_name,label:o.full_name})),u=(i.data?.data||[]).filter(o=>o.role==="FC Spesialis").map(o=>({value:o.name,label:o.name})),m=o=>o&&!c.find(l=>l.value===o)?[...c,{value:o,label:o}]:c,s=o=>o&&!u.find(l=>l.value===o)?[...u,{value:o,label:o}]:u,r=Array.from({length:5},(o,l)=>String(new Date().getFullYear()-l));E({container:a,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:o=>window.formatDate(o)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:o=>{try{let l=JSON.parse(o);return Array.isArray(l)?l.join(", "):o||"-"}catch{return o||"-"}}},{key:"score",label:"Nilai",render:o=>o!=null?`<strong>${o}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:o=>o?`<a href="${o}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer..."},{type:"select",name:"year",label:"Tahun",options:r}],exportOptions:{moduleName:"training",onExport:async o=>{let l=new URLSearchParams(o||{}).toString(),y=await f(`/api/training?limit=10000&${l}`);if(y.ok){let b=y.data.data.map(d=>{let p=d.participants||"";try{let h=JSON.parse(p);p=Array.isArray(h)?h.join(", "):p}catch{}return{Tanggal:d.training_date||"",Batch:d.batch||"",Materi:d.subject||"",Cabang:d.branch_name||"",Trainer:d.trainer||"",Peserta:p,Nilai:d.score!==null&&d.score!==void 0?d.score:"",Dokumen:d.document_link||""}}),{downloadExcel:g}=await Promise.resolve().then(()=>(I(),U));g(b,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let o=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:l}=await Promise.resolve().then(()=>(I(),U));l(o,"Template_Import_Training")},onImport:async o=>{let l=d=>{if(!d)return null;let p=d.toLowerCase(),h=e.data?.data.find(v=>v.full_name.toLowerCase()===p||v.code.toLowerCase()===p||v.name.toLowerCase()===p);return h?h.id:null},y=d=>{if(!d)return"";if(d instanceof Date&&!isNaN(d.getTime()))return d.toISOString().slice(0,10);let p=String(d).trim();if(/^\d{4,5}$/.test(p)){let v=Number(p);if(v>2e4&&v<99999){let S=new Date(Date.UTC(1899,11,30)+v*864e5);return isNaN(S.getTime())?"":S.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(p))return p.slice(0,10);let h=p.split(/[\/\-\.]/);if(h.length===3){let[v,S,k]=h.map(_=>_.trim());if(v.length===4&&S.length<=2&&k.length<=2)return`${v}-${S.padStart(2,"0")}-${k.padStart(2,"0")}`;if(k.length===4&&S.length<=2&&v.length<=2)return`${k}-${S.padStart(2,"0")}-${v.padStart(2,"0")}`}return p},b=o.map(d=>({training_date:y(d.Tanggal),batch:String(d.Batch||"").trim(),subject:String(d.Materi||"").trim(),branch_id:l(String(d.Cabang||"").trim()),trainer:String(d.Trainer||"").trim(),participants:String(d.Peserta||"").trim(),score:d.Nilai?Number(d.Nilai):null,document_link:String(d.Dokumen||"").trim()})).filter(d=>d.training_date&&d.subject&&d.branch_id),g=await f("/api/training/import",{method:"POST",body:JSON.stringify(b)});if(!g.ok)throw new Error(g.data?.error||"Import gagal")}},formFields:o=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:o?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:o?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:o?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",options:t,value:o?.branch_id},{name:"trainer",label:"Trainer",type:"select",options:s(o?.trainer),value:o?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let l=JSON.parse(o?.participants);return Array.isArray(l)?l.join(", "):o?.participants||""}catch{return o?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:o?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:o?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:o?.notes}],onBeforeSubmit:async o=>(o.participants&&(o.participants=JSON.stringify(o.participants.split(",").map(l=>l.trim()).filter(Boolean))),o)})}P();I();async function ma(a){let[e,n]=await Promise.all([f("/api/branches?all=1"),f("/api/employees?limit=10000")]),i=(e.data?.data||[]).map(s=>({value:s.id,label:s.full_name})),t=(n.data?.data||[]).map(s=>({value:s.full_name,label:s.full_name})),c=s=>s&&!t.find(r=>r.value===s)?[...t,{value:s,label:s}]:t,u=["Krishna Aryaan Permana","Agung Septiadi","Indra Saputro","Wariskin","Iqbal"],m=s=>{let r=u.map(o=>({value:o,label:o}));return s&&!r.find(o=>o.value===s)?[...r,{value:s,label:s}]:r};E({container:a,title:"Jadwal Reliefer",icon:"\u{1F504}",apiPath:"/api/relievers",bulkDelete:!0,itemLabel:"Reliefer",columns:[{key:"backup_date",label:"Tanggal Backup",nowrap:!0,render:s=>window.formatDate(s)},{key:"branch_name",label:"Cabang"},{key:"original_fc_name",label:"FC Digantikan"},{key:"period",label:"Periode",render:s=>V(s)},{key:"reliever_name",label:"Reliefer"},{key:"reason",label:"Keterangan"},{key:"shift",label:"Shift",render:s=>s?`<span class="badge badge-info">${s}</span>`:"-"},{key:"status",label:"Status",render:s=>M(s)}],filterFields:[{type:"search",placeholder:"Cari reliefer / FC..."},{type:"select",name:"branch_id",label:"Cabang",options:i},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done","Tidak Datang"]}],formFields:s=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",required:!0,options:i,value:s?.branch_id},{name:"period",label:"Periode",type:"select",options:["Q1","Q2","Q3","Q4"],value:s?.period}]},{type:"row",fields:[{name:"original_fc_name",label:"FC yang Digantikan",type:"select",options:[{value:"",label:"BELUM ADA FC"},...c(s?.original_fc_name)],value:s?.original_fc_name},{name:"reliever_name",label:"Nama Reliefer",type:"select",required:!0,options:m(s?.reliever_name),value:s?.reliever_name}]},{type:"row",fields:[{name:"backup_date",label:"Tanggal Backup",type:"date",required:!0,value:s?.backup_date},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:s?.completion_date}]},{type:"row",fields:[{name:"reason",label:"Keterangan",type:"select",options:["Cuti","Mengisi Kekosongan","Back Up Training","Deep Cleaning","Training Praktek Skill","Sakit","Lainnya"],value:s?.reason},{name:"shift",label:"Shift",type:"select",options:["Pagi","Siang","Full Shift","Middle"],value:s?.shift}]},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done","Tidak Datang"],value:s?.status||""}],exportOptions:{moduleName:"relievers",onExport:async()=>{let s=await f("/api/relievers?limit=10000");if(s.ok){let r=s.data.data.map(o=>({"Tanggal Backup":o.backup_date||"",Cabang:o.branch_name||"","FC Digantikan":o.original_fc_name||"",Periode:o.period||"",Reliefer:o.reliever_name||"",Keterangan:o.reason||"",Shift:o.shift||"","Tanggal Selesai":o.completion_date||"",Status:o.status||""}));T(r,"Data_Reliefer")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{"Tanggal Backup":"2024-03-10",Cabang:"001. Pondok Bambu","FC Digantikan":"Budi Santoso",Periode:"Q1",Reliefer:"Andi",Keterangan:"Sakit",Shift:"Pagi","Tanggal Selesai":"2024-03-10",Status:"Done"}],"Template_Import_Reliefer")},onImport:async s=>{let o=(await f("/api/branches?all=1")).data?.data||[],l=g=>{if(!g)return null;let d=g.toLowerCase(),p=o.find(h=>h.full_name.toLowerCase()===d||h.code.toLowerCase()===d||h.name.toLowerCase()===d);return p?p.id:null},y=s.map(g=>({branch_id:l(String(g.Cabang||"").trim()),backup_date:String(g["Tanggal Backup"]||"").trim(),original_fc_name:String(g["FC Digantikan"]||"").trim(),reliever_name:String(g.Reliefer||"").trim(),period:String(g.Periode||"").trim(),reason:String(g.Keterangan||"").trim(),shift:String(g.Shift||"").trim(),completion_date:String(g["Tanggal Selesai"]||"").trim(),status:String(g.Status||"").trim()})).filter(g=>g.reliever_name&&g.backup_date),b=await f("/api/relievers/import",{method:"POST",body:JSON.stringify(y)});if(!b.ok)throw new Error(b.data?.error||"Import gagal")}}})}P();I();async function ua(a){let n=((await f("/api/branches?all=1")).data?.data||[]).map(t=>({value:t.id,label:t.full_name})),i=Array.from({length:4},(t,c)=>String(new Date().getFullYear()-c));E({container:a,title:"Laporan Inspeksi Hygiene",icon:"\u{1F50D}",apiPath:"/api/reports/inspection",itemLabel:"Laporan Inspeksi",bulkDelete:!0,columns:[{key:"branch_name",label:"Cabang"},{key:"period",label:"Periode",render:t=>V(t)},{key:"inspection_date",label:"Tanggal",nowrap:!0,render:t=>window.formatDate(t)},{key:"fc_score",label:"Point FC",render:t=>t!=null?`<strong class="${t>=80?"text-success":t>=60?"text-warning":"text-danger"}">${t}</strong>`:"-"},{key:"spv_score",label:"Point SPV",render:t=>t!=null?`<strong>${t}</strong>`:"-"},{key:"status",label:"Status",render:t=>M(t)},{key:"document_link",label:"Dokumen",render:t=>t?`<a href="${t}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:n},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done"]},{type:"select",name:"year",label:"Tahun",options:i}],formFields:t=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",required:!0,options:n,value:t?.branch_id},{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:t?.period}]},{type:"row",fields:[{name:"inspection_date",label:"Tanggal Inspeksi",type:"date",required:!0,value:t?.inspection_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done"],value:t?.status||""}]},{type:"row",fields:[{name:"fc_score",label:"Point FC",type:"number",step:"0.1",min:"0",max:"100",value:t?.fc_score},{name:"spv_score",label:"Point SPV",type:"number",step:"0.1",min:"0",max:"100",value:t?.spv_score}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:t?.document_link},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:t?.notes}],exportOptions:{moduleName:"inspection_reports",onExport:async t=>{let c=new URLSearchParams(t||{}).toString(),u=await f(`/api/reports/inspection?limit=10000&${c}`);if(u.ok){let m=u.data.data.map(s=>({Cabang:s.branch_name||"",Periode:s.period||"",Tanggal:s.inspection_date||"","Point FC":s.fc_score!==null&&s.fc_score!==void 0?s.fc_score:"","Point SPV":s.spv_score!==null&&s.spv_score!==void 0?s.spv_score:"",Status:s.status||"","Link Dokumen":s.document_link||"",Catatan:s.notes||""}));T(m,`Laporan_Inspeksi_Hygiene_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{Cabang:"001. Pondok Bambu",Periode:"Q1",Tanggal:"2026-01-08","Point FC":85,"Point SPV":90,Status:"Done","Link Dokumen":"https://drive.google.com/...",Catatan:"Semua area bersih"}],"Template_Import_Inspeksi")},onImport:async t=>{let u=(await f("/api/branches?all=1")).data?.data||[],m=l=>{if(!l)return null;let y=l.toLowerCase(),b=u.find(g=>g.full_name.toLowerCase()===y||g.code.toLowerCase()===y||g.name.toLowerCase()===y);return b?b.id:null},s=l=>{if(l==null||l==="")return"";if(l instanceof Date&&!isNaN(l.getTime()))return l.toISOString().slice(0,10);let y=String(l).trim();if(y===""||y==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(y))return y.slice(0,10);if(/^\d{4,5}$/.test(y)){let g=Number(y);if(g>2e4&&g<99999){let d=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(d.getTime())?"":d.toISOString().slice(0,10)}}let b=y.split(/[\/\-\.]/);if(b.length===3){let[g,d,p]=b.map(h=>h.trim());if(g.length===4&&d.length<=2&&p.length<=2)return`${g}-${d.padStart(2,"0")}-${p.padStart(2,"0")}`;if(p.length===4&&d.length<=2&&g.length<=2)return`${p}-${d.padStart(2,"0")}-${g.padStart(2,"0")}`}return y},r=t.map(l=>({branch_id:m(String(l.Cabang||"").trim()),period:String(l.Periode||"").trim(),inspection_date:s(l.Tanggal),fc_score:l["Point FC"]!==void 0&&l["Point FC"]!==""?Number(l["Point FC"]):null,spv_score:l["Point SPV"]!==void 0&&l["Point SPV"]!==""?Number(l["Point SPV"]):null,status:String(l.Status||"").trim(),document_link:String(l["Link Dokumen"]||"").trim(),notes:String(l.Catatan||l.Keterangan||"").trim()})).filter(l=>l.branch_id&&l.period&&l.inspection_date),o=await f("/api/reports/inspection/import",{method:"POST",body:JSON.stringify(r)});if(!o.ok)throw new Error(o.data?.error||"Import gagal")}}})}P();I();async function ga(a){let n=((await f("/api/branches?all=1")).data?.data||[]).map(t=>({value:t.id,label:t.full_name})),i=Array.from({length:4},(t,c)=>String(new Date().getFullYear()-c));E({container:a,title:"Laporan General Cleaning & Deep Cleaning",icon:"\u{1F9F9}",apiPath:"/api/reports/cleaning",itemLabel:"Laporan GC/DC",bulkDelete:!0,columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Jenis",render:t=>`<span class="badge ${t==="Deep Cleaning"?"badge-purple":"badge-success"}">${t}</span>`},{key:"period",label:"Periode",render:t=>V(t)},{key:"activity_date",label:"Tanggal",nowrap:!0,render:t=>window.formatDate(t)},{key:"status",label:"Status",render:t=>M(t)},{key:"document_link",label:"Dokumen",render:t=>t?`<a href="${t}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:n},{type:"select",name:"activity_type",label:"Jenis",options:["General Cleaning","Deep Cleaning"]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done"]},{type:"select",name:"year",label:"Tahun",options:i}],formFields:t=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",required:!0,options:n,value:t?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["General Cleaning","Deep Cleaning"],value:t?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:t?.period},{name:"activity_date",label:"Tanggal",type:"date",required:!0,value:t?.activity_date}]},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done"],value:t?.status||""},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:t?.document_link},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:t?.notes}],exportOptions:{moduleName:"cleaning_reports",onExport:async t=>{let c=new URLSearchParams(t||{}).toString(),u=await f(`/api/reports/cleaning?limit=10000&${c}`);if(u.ok){let m=u.data.data.map(s=>({Cabang:s.branch_name||"",Jenis:s.activity_type||"",Periode:s.period||"",Tanggal:s.activity_date||"",Status:s.status||"","Link Dokumen":s.document_link||"",Catatan:s.notes||""}));T(m,`Laporan_GCDC_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{Cabang:"001. Pondok Bambu",Jenis:"General Cleaning",Periode:"Q1",Tanggal:"2026-01-08",Status:"Done","Link Dokumen":"https://drive.google.com/...",Catatan:"Pembersihan lantai"}],"Template_Import_GCDC")},onImport:async t=>{let u=(await f("/api/branches?all=1")).data?.data||[],m=l=>{if(!l)return null;let y=l.toLowerCase(),b=u.find(g=>g.full_name.toLowerCase()===y||g.code.toLowerCase()===y||g.name.toLowerCase()===y);return b?b.id:null},s=l=>{if(l==null||l==="")return"";if(l instanceof Date&&!isNaN(l.getTime()))return l.toISOString().slice(0,10);let y=String(l).trim();if(y===""||y==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(y))return y.slice(0,10);if(/^\d{4,5}$/.test(y)){let g=Number(y);if(g>2e4&&g<99999){let d=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(d.getTime())?"":d.toISOString().slice(0,10)}}let b=y.split(/[\/\-\.]/);if(b.length===3){let[g,d,p]=b.map(h=>h.trim());if(g.length===4&&d.length<=2&&p.length<=2)return`${g}-${d.padStart(2,"0")}-${p.padStart(2,"0")}`;if(p.length===4&&d.length<=2&&g.length<=2)return`${p}-${d.padStart(2,"0")}-${g.padStart(2,"0")}`}return y},r=t.map(l=>({branch_id:m(String(l.Cabang||"").trim()),activity_type:String(l.Jenis||l.Kegiatan||"").trim(),period:String(l.Periode||"").trim(),activity_date:s(l.Tanggal),status:String(l.Status||"").trim(),document_link:String(l["Link Dokumen"]||"").trim(),notes:String(l.Catatan||l.Keterangan||"").trim()})).filter(l=>l.branch_id&&l.activity_type&&l.period&&l.activity_date),o=await f("/api/reports/cleaning/import",{method:"POST",body:JSON.stringify(r)});if(!o.ok)throw new Error(o.data?.error||"Import gagal")}}})}P();I();async function ba(a){let n=((await f("/api/branches?all=1")).data?.data||[]).map(t=>({value:t.id,label:t.full_name})),i=Array.from({length:4},(t,c)=>String(new Date().getFullYear()-c));E({container:a,title:"Rekap Fogging",icon:"\u{1F4A8}",apiPath:"/api/reports/fogging",itemLabel:"Fogging",bulkDelete:!0,columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Jenis",render:t=>`<span class="badge badge-warning">${t}</span>`},{key:"period",label:"Periode",render:t=>V(t)},{key:"activity_date",label:"Tanggal",nowrap:!0,render:t=>window.formatDate(t)},{key:"status",label:"Status",render:t=>M(t)},{key:"document_link",label:"Dokumen",render:t=>t?`<a href="${t}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"},{key:"notes",label:"Catatan",render:t=>t||"-"}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:n},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","Done"]},{type:"select",name:"year",label:"Tahun",options:i}],formFields:t=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",required:!0,options:n,value:t?.branch_id},{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:t?.period}]},{type:"row",fields:[{name:"activity_date",label:"Tanggal",type:"date",value:t?.activity_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","Done"],value:t?.status||""}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:t?.document_link},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:t?.notes}],exportOptions:{moduleName:"fogging_reports",onExport:async t=>{let c=new URLSearchParams(t||{}).toString(),u=await f(`/api/reports/fogging?limit=10000&${c}`);if(u.ok){let m=u.data.data.map(s=>({Cabang:s.branch_name||"",Jenis:s.activity_type||"Fogging",Periode:s.period||"",Tanggal:s.activity_date||"",Status:s.status||"","Link Dokumen":s.document_link||"",Catatan:s.notes||""}));T(m,`Laporan_Fogging_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{Cabang:"001. Pondok Bambu",Jenis:"Fogging",Periode:"Q1",Tanggal:"2026-01-08",Status:"Done","Link Dokumen":"https://drive.google.com/...",Catatan:"Tuntas"}],"Template_Import_Fogging")},onImport:async t=>{let u=(await f("/api/branches?all=1")).data?.data||[],m=l=>{if(!l)return null;let y=l.toLowerCase(),b=u.find(g=>g.full_name.toLowerCase()===y||g.code.toLowerCase()===y||g.name.toLowerCase()===y);return b?b.id:null},s=l=>{if(l==null||l==="")return"";if(l instanceof Date&&!isNaN(l.getTime()))return l.toISOString().slice(0,10);let y=String(l).trim();if(y===""||y==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(y))return y.slice(0,10);if(/^\d{4,5}$/.test(y)){let g=Number(y);if(g>2e4&&g<99999){let d=new Date(Date.UTC(1899,11,30)+g*864e5);return isNaN(d.getTime())?"":d.toISOString().slice(0,10)}}let b=y.split(/[\/\-\.]/);if(b.length===3){let[g,d,p]=b.map(h=>h.trim());if(g.length===4&&d.length<=2&&p.length<=2)return`${g}-${d.padStart(2,"0")}-${p.padStart(2,"0")}`;if(p.length===4&&d.length<=2&&g.length<=2)return`${p}-${d.padStart(2,"0")}-${g.padStart(2,"0")}`}return y},r=t.map(l=>({branch_id:m(String(l.Cabang||"").trim()),activity_type:String(l.Jenis||l.Kegiatan||"Fogging").trim(),period:String(l.Periode||"").trim(),activity_date:s(l.Tanggal),status:String(l.Status||"").trim(),document_link:String(l["Link Dokumen"]||"").trim(),notes:String(l.Catatan||l.Keterangan||"").trim()})).filter(l=>l.branch_id&&l.period&&l.activity_date),o=await f("/api/reports/fogging/import",{method:"POST",body:JSON.stringify(r)});if(!o.ok)throw new Error(o.data?.error||"Import gagal")}}})}P();I();async function ha(a){let[e,n,i]=await Promise.all([f("/api/branches?all=1"),f("/api/employees?limit=10000"),f("/api/pic")]),t=(e.data?.data||[]).map(r=>({value:r.id,label:r.full_name})),c=(n.data?.data||[]).map(r=>({value:r.full_name,label:r.full_name})),u=(i.data?.data||[]).filter(r=>r.role==="FC Spesialis").map(r=>({value:r.name,label:r.name})),m=r=>r&&!c.find(o=>o.value===r)?[...c,{value:r,label:r}]:c,s=r=>r&&!u.find(o=>o.value===r)?[...u,{value:r,label:r}]:u;E({container:a,title:"Rekap Laporan Basecamp",icon:"\u{1F4DD}",apiPath:"/api/reports/basecamp",bulkDelete:!0,itemLabel:"Laporan Basecamp",columns:[{key:"info_date",label:"Tgl Info",nowrap:!0,render:r=>window.formatDate(r)},{key:"branch_name",label:"Cabang"},{key:"problem",label:"Permasalahan",render:r=>`<span title="${r||""}">${r?.length>60?r.slice(0,60)+"\u2026":r||"-"}</span>`},{key:"pic",label:"PIC"},{key:"done_date",label:"Tgl Done",nowrap:!0,render:r=>window.formatDate(r)},{key:"status",label:"Status",render:r=>M(r)},{key:"notes",label:"Keterangan",render:r=>r?.length>40?r.slice(0,40)+"\u2026":r||"-"}],filterFields:[{type:"search",placeholder:"Cari permasalahan / PIC..."},{type:"select",name:"branch_id",label:"Cabang",options:t},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]}],formFields:r=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"select",required:!0,options:t,value:r?.branch_id},{name:"pic",label:"PIC",type:"select",options:s(r?.pic),value:r?.pic}]},{name:"problem",label:"Permasalahan",type:"textarea",required:!0,rows:3,value:r?.problem},{type:"row",fields:[{name:"info_date",label:"Tanggal Info",type:"date",required:!0,value:r?.info_date},{name:"done_date",label:"Tanggal Done",type:"date",value:r?.done_date}]},{name:"status",label:"Status",type:"select",options:["Open","In Progress","Done"],value:r?.status||"Open"},{name:"notes",label:"Keterangan / Tindak Lanjut",type:"textarea",rows:2,value:r?.notes}],exportOptions:{moduleName:"basecamp_reports",onExport:async r=>{let o=new URLSearchParams(r||{}).toString(),l=await f(`/api/reports/basecamp?limit=10000&${o}`);if(l.ok){let y=l.data.data.map(b=>({"Tgl Info":b.info_date||"",Cabang:b.branch_name||"",Permasalahan:b.problem||"",PIC:b.pic||"","Tgl Done":b.done_date||"",Status:b.status||"",Keterangan:b.notes||""}));T(y,`Rekap_Laporan_Basecamp_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{"Tgl Info":"2026-01-08",Cabang:"001. Pondok Bambu",Permasalahan:"Request fogging karena banyak nyamuk",PIC:"Fajar","Tgl Done":"2026-01-10",Status:"Done",Keterangan:"Sudah difogging"}],"Template_Import_Basecamp")},onImport:async r=>{let l=(await f("/api/branches?all=1")).data?.data||[],y=p=>{if(!p)return null;let h=p.toLowerCase(),v=l.find(S=>S.full_name.toLowerCase()===h||S.code.toLowerCase()===h||S.name.toLowerCase()===h);return v?v.id:null},b=p=>{if(p==null||p==="")return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let h=String(p).trim();if(h===""||h==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(h))return h.slice(0,10);if(/^\d{4,5}$/.test(h)){let S=Number(h);if(S>2e4&&S<99999){let k=new Date(Date.UTC(1899,11,30)+S*864e5);return isNaN(k.getTime())?"":k.toISOString().slice(0,10)}}let v=h.split(/[\/\-\.]/);if(v.length===3){let[S,k,_]=v.map($=>$.trim());if(S.length===4&&k.length<=2&&_.length<=2)return`${S}-${k.padStart(2,"0")}-${_.padStart(2,"0")}`;if(_.length===4&&k.length<=2&&S.length<=2)return`${_}-${k.padStart(2,"0")}-${S.padStart(2,"0")}`}return h},g=r.map(p=>({info_date:b(p["Tgl Info"]||p["Tanggal Info"]),branch_id:y(String(p.Cabang||"").trim()),problem:String(p.Permasalahan||"").trim(),pic:String(p.PIC||"").trim(),done_date:b(p["Tgl Done"]||p["Tanggal Done"]),status:String(p.Status||"").trim(),notes:String(p.Keterangan||p.Catatan||"").trim()})).filter(p=>p.info_date&&p.branch_id&&p.problem),d=await f("/api/reports/basecamp/import",{method:"POST",body:JSON.stringify(g)});if(!d.ok)throw new Error(d.data?.error||"Import gagal")}}})}async function ya(a){E({container:a,title:"SOP",icon:"\u{1F4D6}",apiPath:"/api/sop",bulkDelete:!0,itemLabel:"SOP",columns:[{key:"name",label:"Nama SOP"},{key:"category",label:"Kategori"},{key:"document_link",label:"Dokumen",render:e=>e?`<a href="${e}" target="_blank" rel="noopener" class="btn btn-sm btn-primary">\u{1F4C4} Buka Dokumen</a>`:"-"},{key:"notes",label:"Catatan"}],filterFields:[{type:"search",placeholder:"Cari nama SOP..."}],exportOptions:{moduleName:"sop",onExport:async e=>{let n=new URLSearchParams(e||{}).toString(),{apiFetch:i}=await Promise.resolve().then(()=>(P(),ce)),t=await i(`/api/sop?limit=10000&${n}`);if(t.ok){let c=t.data.data.map(m=>({"Nama SOP":m.name||"",Kategori:m.category||"",Dokumen:m.document_link||"",Catatan:m.notes||m.description||""})),{downloadExcel:u}=await Promise.resolve().then(()=>(I(),U));u(c,`Master_SOP_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let e=[{"Nama SOP":"SOP Cuci Tangan",Kategori:"Ketentuan & Basic",Dokumen:"https://link.com",Catatan:"Catatan singkat"}],{downloadExcel:n}=await Promise.resolve().then(()=>(I(),U));n(e,"Template_Import_SOP")},onImport:async e=>{let n=e.map(c=>({name:String(c["Nama SOP"]||"").trim(),category:String(c.Kategori||"").trim(),document_link:String(c.Dokumen||"").trim(),description:String(c.Catatan||"").trim()})).filter(c=>c.name),{apiFetch:i}=await Promise.resolve().then(()=>(P(),ce)),t=await i("/api/sop/import",{method:"POST",body:JSON.stringify(n)});if(!t.ok)throw new Error(t.data?.error||"Import gagal")}},formFields:e=>[{name:"name",label:"Nama SOP",required:!0,placeholder:"Nama SOP",value:e?.name},{name:"category",label:"Kategori",placeholder:"Ketentuan & Basic, Kualitas & Grooming, dst.",value:e?.category},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://docs.google.com/...",value:e?.document_link},{name:"description",label:"Deskripsi / Catatan",type:"textarea",rows:3,value:e?.description}]})}async function fa(a){E({container:a,title:"Master Checklist",icon:"\u2705",apiPath:"/api/checklist",bulkDelete:!0,itemLabel:"Checklist",columns:[{key:"name",label:"Nama Checklist"},{key:"category",label:"Kategori"},{key:"document_link",label:"Dokumen",render:e=>e?`<a href="${e}" target="_blank" rel="noopener" class="btn btn-sm btn-primary">\u{1F4C4} Buka Dokumen</a>`:"-"},{key:"description",label:"Deskripsi"}],filterFields:[{type:"search",placeholder:"Cari checklist..."}],exportOptions:{moduleName:"checklist",onExport:async e=>{let n=new URLSearchParams(e||{}).toString(),{apiFetch:i}=await Promise.resolve().then(()=>(P(),ce)),t=await i(`/api/checklist?limit=10000&${n}`);if(t.ok){let c=t.data.data.map(m=>({"Nama Checklist":m.name||"",Kategori:m.category||"",Dokumen:m.document_link||"",Deskripsi:m.description||""})),{downloadExcel:u}=await Promise.resolve().then(()=>(I(),U));u(c,`Master_Checklist_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let e=[{"Nama Checklist":"Checklist Kebersihan Mingguan",Kategori:"Master Cleaning Program",Dokumen:"https://link.com",Deskripsi:"Deskripsi singkat"}],{downloadExcel:n}=await Promise.resolve().then(()=>(I(),U));n(e,"Template_Import_Checklist")},onImport:async e=>{let n=e.map(c=>({name:String(c["Nama Checklist"]||"").trim(),category:String(c.Kategori||"").trim(),document_link:String(c.Dokumen||"").trim(),description:String(c.Deskripsi||"").trim()})).filter(c=>c.name),{apiFetch:i}=await Promise.resolve().then(()=>(P(),ce)),t=await i("/api/checklist/import",{method:"POST",body:JSON.stringify(n)});if(!t.ok)throw new Error(t.data?.error||"Import gagal")}},formFields:e=>[{name:"name",label:"Nama Checklist",required:!0,placeholder:"Nama checklist",value:e?.name},{name:"category",label:"Kategori",placeholder:"Master Cleaning Program, dll.",value:e?.category},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://docs.google.com/...",value:e?.document_link},{name:"description",label:"Deskripsi",type:"textarea",rows:3,value:e?.description}]})}P();I();async function Oe(a,e="forms"){if(e==="supply")return st(a);it(a)}function it(a){E({container:a,title:"Master Form",icon:"\u{1F4C4}",apiPath:"/api/forms",bulkDelete:!0,itemLabel:"Form",columns:[{key:"name",label:"Nama Form"},{key:"category",label:"Kategori"},{key:"document_link",label:"Dokumen",render:e=>e?`<a href="${e}" target="_blank" rel="noopener" class="btn btn-sm btn-primary">\u{1F4C4} Buka</a>`:"-"},{key:"is_public",label:"Publik",render:e=>e?'<span class="badge badge-success">Ya</span>':'<span class="badge badge-neutral">Tidak</span>'},{key:"description",label:"Deskripsi"}],filterFields:[{type:"search",placeholder:"Cari form..."}],formFields:e=>[{name:"name",label:"Nama Form",required:!0,placeholder:"Nama form",value:e?.name},{name:"category",label:"Kategori",placeholder:"Permintaan Barang, Penilaian, dll.",value:e?.category},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:e?.document_link},{name:"description",label:"Deskripsi",type:"textarea",rows:2,value:e?.description},{name:"is_public",label:"Akses Publik",type:"checkbox",checkLabel:"Form dapat diakses tanpa login",value:e?.is_public}]})}async function st(a){let n=((await f("/api/branches?all=1")).data?.data||[]).map(i=>({value:i.id,label:i.full_name}));E({container:a,title:"Permintaan Barang & Chemical",icon:"\u{1F4E6}",apiPath:"/api/reports/supply",bulkDelete:!0,itemLabel:"Permintaan",canCreate:!0,columns:[{key:"submitted_at",label:"Waktu",nowrap:!0,render:i=>i?new Date(i).toLocaleString("id-ID"):"-"},{key:"submitter_name",label:"Pengirim"},{key:"branch_name",label:"Cabang",render:(i,t)=>t.branch_name_ref||t.branch_name||"-"},{key:"tools_items",label:"Alat/Barang",render:i=>{try{let t=JSON.parse(i);return Array.isArray(t)?t.join(", "):i}catch{return i||"-"}}},{key:"chemical_items",label:"Chemical",render:i=>{try{let t=JSON.parse(i);return Array.isArray(t)?t.join(", "):i}catch{return i||"-"}}},{key:"additional_notes",label:"Catatan",render:i=>i?.length>40?i.slice(0,40)+"\u2026":i||"-"},{key:"status",label:"Status",render:i=>M(i)},{key:"processed_by",label:"Diproses Oleh"}],filterFields:[{type:"select",name:"status",label:"Status",options:["Pending","Diproses","Selesai"]}],formFields:i=>{let t=i?.tools_items;try{t=Array.isArray(JSON.parse(t))?JSON.parse(t).join(", "):t}catch{}let c=i?.chemical_items;try{c=Array.isArray(JSON.parse(c))?JSON.parse(c).join(", "):c}catch{}return[{type:"row",fields:[{name:"submitter_name",label:"Nama Pengirim",required:!0,value:i?.submitter_name},{name:"branch_id",label:"Cabang",type:"select",options:n,value:i?.branch_id}]},{type:"row",fields:[{name:"tools_items",label:"Alat / Barang",placeholder:"Pisahkan dengan koma (Sapu, Mop)",value:t},{name:"tools_quantity",label:"Jumlah Alat",type:"number",value:i?.tools_quantity}]},{type:"row",fields:[{name:"chemical_items",label:"Chemical",placeholder:"Pisahkan dengan koma",value:c},{name:"chemical_quantity",label:"Jumlah Chemical",type:"number",value:i?.chemical_quantity}]},{name:"additional_notes",label:"Catatan",type:"textarea",rows:2,value:i?.additional_notes},{name:"status",label:"Status",type:"select",options:["Pending","Diproses","Selesai"],value:i?.status||""},{name:"processed_by",label:"Diproses Oleh",value:i?.processed_by}]},exportOptions:{moduleName:"supply_requests",onExport:async i=>{let t=new URLSearchParams(i||{}).toString(),c=await f(`/api/reports/supply?limit=10000&${t}`);if(c.ok){let u=c.data.data.map(m=>{let s=m.tools_items;try{s=Array.isArray(JSON.parse(s))?JSON.parse(s).join(", "):s}catch{}let r=m.chemical_items;try{r=Array.isArray(JSON.parse(r))?JSON.parse(r).join(", "):r}catch{}return{Waktu:m.submitted_at||"",Pengirim:m.submitter_name||"",Cabang:m.branch_name_ref||m.branch_name||"","Alat/Barang":s||"",Chemical:r||"",Catatan:m.additional_notes||"",Status:m.status||"","Diproses Oleh":m.processed_by||""}});T(u,`Permintaan_Barang_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:()=>{T([{Waktu:"2026-01-08",Pengirim:"Fajar",Cabang:"001. Pondok Bambu","Alat/Barang":"Sapu, Mop",Chemical:"Karbol",Catatan:"Mendesak",Status:"Pending","Diproses Oleh":""}],"Template_Import_Permintaan")},onImport:async i=>{let c=(await f("/api/branches?all=1")).data?.data||[],u=o=>{if(!o)return null;let l=o.toLowerCase(),y=c.find(b=>b.full_name.toLowerCase()===l||b.code.toLowerCase()===l||b.name.toLowerCase()===l);return y?y.id:null},m=o=>{if(o==null||o==="")return"";if(o instanceof Date&&!isNaN(o.getTime()))return o.toISOString().slice(0,10);let l=String(o).trim();if(l===""||l==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(l))return l.slice(0,10);if(/^\d{4,5}$/.test(l)){let b=Number(l);if(b>2e4&&b<99999){let g=new Date(Date.UTC(1899,11,30)+b*864e5);return isNaN(g.getTime())?"":g.toISOString().slice(0,10)}}let y=l.split(/[\/\-\.]/);if(y.length===3){let[b,g,d]=y.map(p=>p.trim());if(b.length===4&&g.length<=2&&d.length<=2)return`${b}-${g.padStart(2,"0")}-${d.padStart(2,"0")}`;if(d.length===4&&g.length<=2&&b.length<=2)return`${d}-${g.padStart(2,"0")}-${b.padStart(2,"0")}`}return l},s=i.map(o=>({submitted_at:m(o.Waktu||o.Tanggal),submitter_name:String(o.Pengirim||"").trim(),branch_id:u(String(o.Cabang||"").trim()),tools_items:String(o["Alat/Barang"]||o.Alat||"").trim(),chemical_items:String(o.Chemical||"").trim(),additional_notes:String(o.Catatan||o.Keterangan||"").trim(),status:String(o.Status||"").trim(),processed_by:String(o["Diproses Oleh"]||o.PIC||"").trim()})).filter(o=>o.submitted_at&&o.submitter_name&&o.branch_id),r=await f("/api/reports/supply/import",{method:"POST",body:JSON.stringify(s)});if(!r.ok)throw new Error(r.data?.error||"Import gagal")}},extraActions:[{label:"Update Status",icon:"\u{1F504}",class:"btn-secondary",handler:(i,t)=>{let c=Y({title:"Update Status Permintaan",content:`
              <div class="form-group">
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),t()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),t()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.querySelectorAll(".cal-filter").forEach(c=>c.addEventListener("change",t));async function i(){try{let c=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`;n=(await f(`/api/dashboard/calendar?month=${c}`)).data?.data||[]}catch(c){console.warn("[Calendar] Failed to load events, rendering empty grid:",c),n=[]}}async function t(){let c=document.getElementById("calendar-grid");if(c){c.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
    ...
    </div>`,await i();try{let u=e.getFullYear(),m=e.getMonth(),s=e.toLocaleDateString("id-ID",{month:"long",year:"numeric"}),r=document.getElementById("cal-month-label");r&&(r.textContent=s);let o=new Set(Array.from(document.querySelectorAll(".cal-filter:checked")).map(k=>k.value)),l=n.filter(k=>o.has(k.type)),y={};l.forEach(k=>{let _=(k.event_date||"").slice(0,10);y[_]||(y[_]=[]),y[_].push(k)});let b=new Date(u,m,1).getDay(),g=new Date(u,m+1,0).getDate(),d=["Min","Sen","Sel","Rab","Kam","Jum","Sab"],p=new Date().toISOString().slice(0,10),h='<div class="calendar-grid">';d.forEach(k=>{h+=`<div class="cal-day-header">${k}</div>`});for(let k=0;k<b;k++)h+='<div class="cal-cell cal-cell-empty"></div>';for(let k=1;k<=g;k++){let _=`${u}-${String(m+1).padStart(2,"0")}-${String(k).padStart(2,"0")}`,$=y[_]||[],O=_===p;h+=`
            ...
            <div class="cal-events-preview">
              ${$.slice(0,3).map(w=>`
                <div class="cal-event-dot cal-color-${w.color||"gray"}" title="${ke(w.title||w.type)}">
                  <span class="cal-event-dot-label">${rt(w.title||w.branch_name||w.type,18)}</span>
                </div>
              `).join("")}
              ${$.length>3?`<div class="cal-more">+${$.length-3} lagi</div>`:""}
            </div>
          </div>`}let S=(b+g)%7;if(S!==0)for(let k=0;k<7-S;k++)h+='<div class="cal-cell cal-cell-empty"></div>';h+="</div>",c.innerHTML=h,c.querySelectorAll(".cal-cell[data-date]").forEach(k=>{k.addEventListener("click",()=>{let _=k.dataset.date,$=y[_]||[];if(!$.length)return;let O=document.getElementById("cal-event-list"),w=new Date(_+"T00:00:00").toLocaleDateString("id-ID",{weekday:"long",day:"numeric",month:"long",year:"numeric"});document.getElementById("cal-event-date").textContent=w,document.getElementById("cal-event-items").innerHTML=$.map(L=>`
            <div class="cal-event-item cal-color-border-${L.color||"gray"}">
              <div class="cal-event-type">${lt(L.type)}</div>
              <div class="cal-event-title">${ke(L.title||"-")}</div>
              <div class="cal-event-branch">${ke(L.branch_name||"")}</div>
              ${L.status?`<div class="cal-event-status">${ke(L.status)}</div>`:""}
              ${L.days_remaining!==void 0?`<div class="cal-event-extra">Sisa: ${L.days_remaining} hari</div>`:""}
            </div>
          `).join(""),O.style.display="block"})})}catch(u){console.error("[Calendar] Render error:",u),c&&(c.innerHTML=`
          <div style="padding:40px;text-align:center;color:var(--text-3)">
            <div style="font-size:2rem;margin-bottom:8px">\u{1F4C5}</div>
            <div>Gagal memuat kalender. Silakan refresh.</div>
          </div>`)}}}t()}function rt(a,e){return a?a.length>e?a.slice(0,e)+"\u2026":a:""}function ke(a){return a?String(a).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function lt(a){return{schedule:"\u{1F5D3} Jadwal",issue:"\u26A0\uFE0F Permasalahan",reliever:"\u{1F504} Reliefer",training:"\u{1F393} Training",contract_expiry:"\u{1F4CB} Kontrak Habis"}[a]||a}P();async function _a(a){let e=ae(),n=(e?.full_name||e?.username||"U")[0].toUpperCase(),t={superadmin:"#7C3AED",admin:"#2563EB",manager:"#0891B2",spv:"#059669",viewer:"#64748B"}[e?.role]||"#64748B";a.innerHTML=`
    <div class="page-header">
        ...
        <div class="card-body">
          <div class="import-info-box">
            ...
            <div class="import-sheet-list">
              ${Object.entries(Se).map(([d,{label:p}])=>`<span class="import-sheet-tag">\u{1F4C4} ${d} \u2192 ${p}</span>`).join("")}
            </div>
          </div>
  ...
  `;let e=null,n=null,i=0,t={upload:document.getElementById("step-upload"),validating:document.getElementById("step-validating"),preview:document.getElementById("step-preview"),importing:document.getElementById("step-importing"),summary:document.getElementById("step-summary")};function c(d){Object.entries(t).forEach(([p,h])=>{h.style.display=p===d?"":"none"})}document.getElementById("btn-backup-db")?.addEventListener("click",async()=>{let d=document.getElementById("btn-backup-db");d.disabled=!0,d.textContent="\u23F3 Memproses Backup...";try{let p=await f("/api/import/backup");if(p.ok){let h=new Blob([JSON.stringify(p.data,null,2)],{type:"application/json"}),v=URL.createObjectURL(h),S=document.createElement("a");S.href=v,S.download=`FCMS_Database_Backup_${new Date().toISOString().slice(0,10)}.json`,document.body.appendChild(S),S.click(),document.body.removeChild(S),URL.revokeObjectURL(v),F("Backup berhasil diunduh!")}else H("Gagal memproses backup: "+(p.data?.error||"Unknown error"))}catch(p){H("Gagal memproses backup: "+p.message)}finally{d.disabled=!1,d.textContent="\u{1F4E6} Backup Database"}});let u=document.getElementById("btn-sync-google");u&&u.addEventListener("click",async()=>{if(!confirm("Peringatan: Mensinkronkan data dengan Google Sheets akan memperbarui dan menambahkan data baru dari Google Sheets ke dalam FCMS. Data yang sudah Anda buat di FCMS TIDAK akan terhapus. Lanjutkan?"))return;let d=u.innerHTML;u.innerHTML='<span class="spinner"></span> Menyinkronkan...',u.disabled=!0;try{let p=await f("/api/sync/google-sheets",{method:"POST"});p.ok?alert("Sinkronisasi Berhasil: "+(p.data?.message||"Data Karyawan & PIC telah diperbarui.")):alert("Gagal Sinkronisasi: "+(p.data?.error||"Unknown error"))}catch{alert("Terjadi kesalahan koneksi.")}finally{u.innerHTML=d,u.disabled=!1}}),document.getElementById("btn-download-template").addEventListener("click",()=>{xa(),F("Template Excel berhasil didownload!")});let m=document.getElementById("file-input"),s=document.getElementById("upload-zone");document.getElementById("btn-browse").addEventListener("click",d=>{d.stopPropagation(),m.click()}),m.addEventListener("change",d=>{d.target.files[0]&&r(d.target.files[0])}),s.addEventListener("dragover",d=>{d.preventDefault(),s.classList.add("drag-over")}),s.addEventListener("dragleave",()=>s.classList.remove("drag-over")),s.addEventListener("drop",d=>{d.preventDefault(),s.classList.remove("drag-over");let p=d.dataTransfer.files[0];p&&p.name.match(/\.xlsx?$/i)?r(p):H("Hanya file .xlsx atau .xls yang didukung.")}),document.getElementById("btn-clear-file").addEventListener("click",()=>{e=null,m.value="",document.getElementById("file-info").style.display="none",s.style.display="",c("upload")});async function r(d){e=d,document.getElementById("file-name-display").textContent=`\u{1F4C4} ${d.name} (${(d.size/1024).toFixed(1)} KB)`,document.getElementById("file-info").style.display="flex",s.style.display="none",await o(d)}async function o(d){c("validating");let p=document.getElementById("validation-status"),h=document.getElementById("validation-bar");try{if(!window.XLSX)throw new Error("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");p.textContent="Membaca file Excel...",h.style.width="20%",await me(200);let v=await d.arrayBuffer(),S=window.XLSX.read(v,{type:"array",cellDates:!0});p.textContent=`Memvalidasi ${S.SheetNames.length} sheet...`,h.style.width="50%",await me(100),n=Ca(S),h.style.width="100%",p.textContent="Validasi selesai!",await me(300),l()}catch(v){c("upload"),H("Gagal memproses file: "+v.message),document.getElementById("file-info").style.display="flex",s.style.display="none"}}function l(){c("preview");let d=n.filter(w=>!w.skipped).length,p=n.reduce((w,L)=>w+L.total,0),h=n.reduce((w,L)=>w+L.valid,0),v=n.reduce((w,L)=>w+L.errorCount,0),S=p>0?Math.round(h/p*100):0;document.getElementById("preview-summary-badges").innerHTML=`
        ...
        <tbody>
          ${n.map((w,L)=>`
            <tr class="${w.errorCount>0?"row-error":w.skipped?"row-skipped":"row-ok"}">
              ...
              <td style="text-align:center">
                ${w.errorCount>0?`<button class="btn btn-ghost btn-sm btn-detail-error" data-idx="${L}">\u{1F50D} ${w.errorCount} Error</button>`:'<span class="text-muted">\u2013</span>'}
              </td>
            </tr>
          `).join("")}
        </tbody>
      </table>
    `,k.querySelectorAll(".btn-detail-error").forEach(w=>{w.addEventListener("click",()=>{let L=n[Number(w.dataset.idx)];y(L)})});let _=document.getElementById("error-detail-section"),$=document.getElementById("error-detail-container");$.innerHTML="",_.style.display="none";let O=document.getElementById("btn-start-import");h===0?(O.disabled=!0,O.innerHTML="\u26A0\uFE0F Tidak Ada Data Valid"):(O.disabled=!1,v>0?(O.innerHTML=`\u{1F680} Import ${h} Data Valid (${v} dilewati)`,O.title="Baris error akan dilewati, baris valid tetap diimport"):O.innerHTML=`\u{1F680} Mulai Import ${h} Data`)}function y(d){let p=document.getElementById("error-detail-section"),h=document.getElementById("error-detail-container");p.style.display="";let v=d.errors.slice(0,100).map(S=>(Array.isArray(S.errors)?S.errors:[]).map(_=>{let $=typeof _=="object";return`
          <tr>
    ...
    `,p.scrollIntoView({behavior:"smooth",block:"start"})}document.getElementById("btn-back-to-upload").addEventListener("click",()=>{c("upload"),document.getElementById("file-info").style.display="none",s.style.display="",e=null,m.value=""}),document.getElementById("btn-download-log").addEventListener("click",()=>{if(!n)return;Ta(n)?F("Log error berhasil didownload."):F("Tidak ada error untuk didownload.")}),document.getElementById("btn-start-import").addEventListener("click",()=>{let d=document.querySelector('input[name="dup-strategy"]:checked')?.value||"skip";b(d)});async function b(d){c("importing"),i=Date.now();let p=[];dt.forEach(_=>{let $=n?.find(O=>O.module===_&&O.mapped?.length>0);$&&p.push($)});let h=document.getElementById("import-steps-list");h.innerHTML=p.map(_=>`
    ...
    `).join("");let v=document.getElementById("import-bar"),S=document.getElementById("import-current-status"),k={totalSheets:p.length,totalRows:p.reduce((_,$)=>_+$.mapped.length,0),inserted:0,skipped:0,failed:0,moduleResults:[]};for(let _=0;_<p.length;_++){let $=p[_],O=document.getElementById(`step-icon-${$.module}`),w=document.getElementById(`step-status-${$.module}`);O.textContent="\u{1F504}",w.textContent="Mengimport...",S.textContent=`Mengimport ${$.label}...`,v.style.width=`${Math.round(_/p.length*100)}%`;try{let L=await f(`/api/import/${$.module}`,{method:"POST",body:JSON.stringify({rows:$.mapped,onDuplicate:d})});if(L.ok){let Q=L.data;k.inserted+=Q.inserted||0,k.skipped+=Q.skipped||0,k.moduleResults.push({label:$.label,inserted:Q.inserted||0,skipped:Q.skipped||0,status:"ok"}),O.textContent="\u2705",w.innerHTML=`<span class="badge badge-success">${Q.inserted||0} berhasil</span>${Q.skipped>0?` <span class="badge badge-neutral">${Q.skipped} skip</span>`:""}`}else k.failed++,k.moduleResults.push({label:$.label,inserted:0,skipped:0,status:"error",error:L.data?.error}),O.textContent="\u274C",w.innerHTML='<span class="badge badge-danger">Gagal</span>'}catch(L){k.failed++,k.moduleResults.push({label:$.label,inserted:0,skipped:0,status:"error",error:L.message}),O.textContent="\u274C",w.innerHTML='<span class="badge badge-danger">Gagal</span>'}await me(150)}v.style.width="100%",S.textContent="Selesai!",await me(400),g(k)}function g(d){c("summary");let p=((Date.now()-i)/1e3).toFixed(1),h=d.failed===0;document.getElementById("summary-status-icon").innerHTML=`
  ...
  `;Y({title:`Notifikasi (${ie.length})`,content:a,confirmText:"Tutup",onConfirm:(e,n)=>n()})}function La(){let a=ae(),e=(a?.full_name||"U")[0].toUpperCase();document.getElementById("app").innerHTML=`
  ...
  `;let n=document.getElementById("sidebar"),i=document.getElementById("sidebar-overlay"),t=document.getElementById("topbar-menu-btn"),c=document.getElementById("sidebar-close"),u=()=>{n.classList.add("open"),i.classList.add("show")},m=()=>{n.classList.remove("open"),i.classList.remove("show")};t?.addEventListener("click",u),c?.addEventListener("click",m),i?.addEventListener("click",m),document.querySelectorAll(".nav-item").forEach(r=>r.addEventListener("click",m));function s(){let r=window.location.hash.replace("#","")||"/dashboard";document.querySelectorAll(".nav-item").forEach(y=>{let b=y.dataset.route;y.classList.toggle("active",r===b||b!=="/dashboard"&&r.startsWith(b))});let o=document.getElementById("topbar-title"),l=document.querySelector(".nav-item.active .nav-label");o&&l&&(o.textContent=l.textContent)}window.addEventListener("hashchange",s),s(),pt(),document.getElementById("btn-fullscreen")?.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.()}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await f("/api/auth/logout",{method:"POST"}),le(),ge&&clearInterval(ge),te("/login")}),mt(),ut(),document.getElementById("btn-notif")?.addEventListener("click",r=>{r.preventDefault(),gt()})}async function bt(){D("/login",({main:e})=>Xe(e)),D("/dashboard",N(({main:e})=>We(e))),D("/calendar",N(({main:e})=>Sa(e))),D("/employees",N(({main:e})=>sa(e))),D("/contracts",N(({main:e})=>la(e))),D("/sp",N(({main:e})=>$a(e))),D("/mutasi",N(({main:e})=>Pa(e))),D("/timeline",N(({main:e})=>oa(e))),D("/issues",N(({main:e})=>ca(e))),D("/one-on-one",N(({main:e})=>da(e))),D("/training",N(({main:e})=>pa(e))),D("/relievers",N(({main:e})=>ma(e))),D("/reports/inspection",N(({main:e})=>ua(e))),D("/reports/cleaning",N(({main:e})=>ga(e))),D("/reports/fogging",N(({main:e})=>ba(e))),D("/reports/basecamp",N(({main:e})=>ha(e))),D("/reports/supply",N(({main:e})=>Oe(e,"supply"))),D("/sop",N(({main:e})=>ya(e))),D("/checklist",N(({main:e})=>fa(e))),D("/forms",N(({main:e})=>Oe(e))),D("/users",N(({main:e})=>va(e))),D("/branches",N(({main:e})=>ka(e))),D("/profile",N(({main:e})=>_a(e))),D("/settings/import",N(({main:e})=>Ea(e)));let a=re();if(!a&&window.location.hash!=="#/login"&&te("/login"),a){let e=await f("/api/auth/me");e.ok?(oe(e.data.data),La()):(le(),te("/login"))}window.addEventListener("fm:login",()=>{La(),te("/dashboard")}),qe()}bt();
