var la=Object.defineProperty;var tt=(t,e)=>()=>(t&&(e=t(t=0)),e);var at=(t,e)=>{for(var s in e)la(t,s,{get:e[s],enumerable:!0})};var ke={};at(ke,{API:()=>yt,CLIENT_SIDE_MAX_ROWS:()=>be,IS_DEVELOPMENT:()=>De,apiFetch:()=>k,clearToken:()=>Pe,getToken:()=>Ie,getUser:()=>he,setToken:()=>nt,setUser:()=>Le});function Ie(){return localStorage.getItem("fm_token")}function nt(t){localStorage.setItem("fm_token",t)}function Pe(){localStorage.removeItem("fm_token"),localStorage.removeItem("fm_user")}function he(){try{return JSON.parse(localStorage.getItem("fm_user")||"null")}catch{return null}}function Le(t){localStorage.setItem("fm_user",JSON.stringify(t))}async function k(t,e={}){let s=Ie(),a={"Content-Type":"application/json",...s?{Authorization:`Bearer ${s}`}:{},...e.headers||{}};try{let l=`cb=${Date.now()}`,d=t.includes("?")?"&":"?",i=`${yt}${t}${d}${l}`,r=await fetch(i,{...e,headers:a}),n;try{let o=await r.text();try{n=JSON.parse(o)}catch{n={error:`Server Error (${r.status}): ${o.substring(0,80)}...`}}}catch{n={error:"Gagal membaca respon dari server"}}return r.status===401&&(Pe(),window.location.hash="#/login"),{ok:r.ok,status:r.status,data:n}}catch(l){return{ok:!1,status:0,data:{error:`Koneksi terputus. Periksa jaringan Anda. (${l.message})`}}}}var De,oa,yt,be,F=tt(()=>{De=!1,oa="https://fm-operations-api.facilitycare-audydental.workers.dev",yt=oa,be=1e4});var kt={};at(kt,{confirmDialog:()=>Ne,createModal:()=>le});function le({title:t,content:e,onConfirm:s,onCancel:a,confirmText:l="Simpan",cancelText:d="Batal",size:i="md",confirmClass:r="btn-primary"}){let n={sm:"400px",md:"560px",lg:"720px",xl:"900px"},o=document.createElement("div");o.className="modal-overlay",o.innerHTML=`
  ...
  `}var K=tt(()=>{});F();var it={},je=null;function J(t,e){it[t]=e}function Se(t){window.location.hash=t}function ft(){async function t(){let e=window.location.hash.replace("#","")||"/dashboard",[s,...a]=e.split("?"),l=it[s];if(!l){for(let[i,r]of Object.entries(it))if(i.endsWith("/*")&&s.startsWith(i.slice(0,-2))){l=r;break}}je&&(je(),je=null);let d=document.getElementById("main-content");if(d&&(d.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>'),l){let i=new URLSearchParams(a.join("?")),r=s.split("/").filter(Boolean),n=await l({path:s,params:i,segments:r,main:d});n&&(je=n)}else{let i=d||document.getElementById("app");i&&(i.innerHTML='<div class="empty-state"><h2>404 - Halaman tidak ditemukan</h2></div>')}}window.addEventListener("hashchange",t),t()}var Be;function da(){return Be||(Be=document.createElement("div"),Be.id="toast-container",document.body.appendChild(Be)),Be}function vt(t,e="info",s=3500){let a=da(),l=document.createElement("div");l.className=`toast toast-${e}`;let d={success:"\u2713",error:"\u2715",warning:"\u26A0",info:"\u2139"};l.innerHTML=`<span class="toast-icon">${d[e]||"\u2139"}</span><span class="toast-msg">${t}</span>`,a.appendChild(l),requestAnimationFrame(()=>l.classList.add("show")),setTimeout(()=>{l.classList.remove("show"),setTimeout(()=>l.remove(),350)},s)}var Z=t=>vt(t,"success"),G=t=>vt(t,"error");ye();F();F();ye();function Je({columns:t,data:e,onEdit:s,onDelete:a,onView:l,actions:d=[],emptyText:i="Tidak ada data",bulkSelect:r=null}){let n=document.createElement("div");if(n.className="table-wrapper",!e||e.length===0)return n.innerHTML=`<div class="empty-state"><p>${i}</p></div>`,n;let o=document.createElement("table");o.className="data-table";let m=document.createElement("thead"),c=document.createElement("tr");if(r){let g=document.createElement("th");g.style.width="40px",g.style.textAlign="center";let h=document.createElement("input");h.type="checkbox",h.id="select-all-checkbox",h.title="Pilih semua",h.addEventListener("change",()=>{e.forEach(u=>{h.checked?r.selectedIds.add(u.id):r.selectedIds.delete(u.id)}),n.querySelectorAll(".row-checkbox").forEach(u=>u.checked=h.checked),r.onToggle()}),g.appendChild(h),c.appendChild(g)}if(t.forEach(g=>{let h=document.createElement("th");h.textContent=g.label,g.width&&(h.style.width=g.width),c.appendChild(h)}),s||a||l||d.length>0){let g=document.createElement("th");g.textContent="Aksi",g.style.width="120px",c.appendChild(g)}m.appendChild(c),o.appendChild(m);let p=document.createElement("tbody");return e.forEach(g=>{let h=document.createElement("tr");if(r){let u=document.createElement("td");u.style.textAlign="center",u.style.width="40px";let b=document.createElement("input");b.type="checkbox",b.className="row-checkbox",b.checked=r.selectedIds.has(g.id),b.addEventListener("change",()=>{if(b.checked)r.selectedIds.add(g.id);else{r.selectedIds.delete(g.id);let y=document.getElementById("select-all-checkbox");y&&(y.checked=!1)}r.onToggle()}),u.appendChild(b),h.appendChild(u)}if(t.forEach(u=>{let b=document.createElement("td");if(u.render){let y=u.render(g[u.key],g);y instanceof HTMLElement?b.appendChild(y):b.innerHTML=y||""}else b.textContent=g[u.key]!==null&&g[u.key]!==void 0&&g[u.key]!==""?g[u.key]:"";u.nowrap&&(b.style.whiteSpace="nowrap"),h.appendChild(b)}),s||a||l||d.length>0){let u=document.createElement("td");u.className="actions-cell";let b=document.createElement("div");if(b.className="btn-group",l){let y=document.createElement("button");y.className="btn btn-xs btn-ghost",y.innerHTML="\u{1F441}",y.title="Lihat",y.addEventListener("click",()=>l(g)),b.appendChild(y)}if(s){let y=document.createElement("button");y.className="btn btn-xs btn-secondary",y.innerHTML="\u270F\uFE0F",y.title="Edit",y.addEventListener("click",()=>s(g)),b.appendChild(y)}d.forEach(y=>{let w=document.createElement("button");w.className=`btn btn-xs ${y.class||"btn-ghost"}`,w.innerHTML=y.icon||y.label,w.title=y.label,w.addEventListener("click",()=>y.handler(g)),b.appendChild(w)}),u.appendChild(b),h.appendChild(u)}p.appendChild(h)}),o.appendChild(p),n.appendChild(o),n}function Ue({page:t,pages:e,total:s,limit:a,onPage:l}){if(e<=1)return null;let d=document.createElement("div");d.className="pagination";let i=document.createElement("span");i.className="pagination-info",i.textContent=`Total: ${s} data`,d.appendChild(i);let r=document.createElement("div");r.className="pagination-btns";let n=(c,p,g=!1,h=!1)=>{let u=document.createElement("button");u.className=`btn btn-sm ${h?"btn-primary":"btn-ghost"} pagination-btn`,u.textContent=c,u.disabled=g,u.addEventListener("click",()=>l(p)),r.appendChild(u)};n("\xAB",1,t===1),n("\u2039",t-1,t===1);let o=Math.max(1,t-2),m=Math.min(e,t+2);for(let c=o;c<=m;c++)n(c,c,!1,c===t);return n("\u203A",t+1,t===e),n("\xBB",e,t===e),d.appendChild(r),d}ye();function Ae(t){return t.map(e=>{if(e.type==="hidden")return`<input type="hidden" name="${e.name}" value="${e.value||""}">`;if(e.type==="html")return e.html||"";if(e.type==="row")return`<div class="form-row">${Ae(e.fields)}</div>`;let s=e.required?"required":"",a=e.label?`<label class="form-label">${e.label}${e.required?' <span class="required">*</span>':""}</label>`:"",l="";switch(e.type){case"textarea":l=`<textarea name="${e.name}" class="form-control" placeholder="${e.placeholder||""}" ${s} rows="${e.rows||3}">${e.value||""}</textarea>`;break;case"select":let i=(e.options||[]).map(c=>{let p=typeof c=="object"?c.value:c,g=typeof c=="object"?c.label:c,h=e.value==p?"selected":"";return`<option value="${p}" ${h}>${g}</option>`}).join("");l=`<select name="${e.name}" class="form-control" ${s}><option value="">-- Pilih ${e.label||""} --</option>${i}</select>`;break;case"combobox":let r=`dl-${e.name}-${Math.random().toString(36).substring(7)}`,n=(e.options||[]).map(c=>{let p=typeof c=="object"?c.value:c,g=typeof c=="object"?c.label||c.value||"":c||"";return(g==="undefined"||g==="[object Object]"||g==="null")&&(g=""),g?`<option value="${g}"></option>`:""}).join(""),o=e.value||"";if(e.value){let c=(e.options||[]).find(p=>(typeof p=="object"?p.value:p)==e.value);if(c){let p=typeof c=="object"?c.label||c.value||"":c||"";p&&p!=="undefined"&&p!=="[object Object]"&&p!=="null"&&(o=p)}}l=`
  ...
  `;function R(){if(!document.getElementById("bulk-toolbar"))return;let f=document.getElementById("bulk-count"),$=document.getElementById("btn-bulk-delete"),P=document.getElementById("btn-bulk-cancel");f.textContent=`${C.size} item dipilih`,C.size>0?($.disabled=!1,P.disabled=!1):($.disabled=!0,P.disabled=!0)}document.getElementById("btn-bulk-cancel")?.addEventListener("click",()=>{C.clear(),document.querySelectorAll(".row-checkbox").forEach(f=>f.checked=!1);let v=document.getElementById("select-all-checkbox");v&&(v.checked=!1),R()}),document.getElementById("btn-bulk-delete")?.addEventListener("click",()=>{if(C.size===0)return;let v=[...C],f=document.createElement("div");f.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:9999;display:flex;align-items:center;justify-content:center",f.innerHTML=`
    ...
    `,document.body.appendChild(f),f.querySelector("#bulk-cancel-btn").addEventListener("click",()=>f.remove()),f.querySelector("#bulk-confirm-btn").addEventListener("click",async()=>{let $=f.querySelector("#bulk-confirm-btn");$.disabled=!0,$.textContent="Menghapus...";let P=await k(`${a}/bulk`,{method:"DELETE",body:JSON.stringify({ids:v})});f.remove(),P.ok?(Z(`${v.length} ${n} berhasil dihapus.`),C.clear(),R(),M()):G(P.data?.error||"Gagal menghapus data.")})});let E=document.getElementById("filter-search"),O;if(E?.addEventListener("input",v=>{clearTimeout(O),O=setTimeout(()=>{x.search=v.target.value,S=1,C.clear(),M()},400)}),i?.forEach(v=>{v.type==="select"&&document.getElementById(`filter-${v.name}`)?.addEventListener("change",f=>{x[v.name]=f.target.value,S=1,C.clear(),M()})}),document.getElementById("btn-reset-filter")?.addEventListener("click",()=>{x={...r},E&&(E.value=""),i?.forEach(v=>{let f=document.getElementById(`filter-${v.name}`);f&&(f.value="")}),S=1,C.clear(),M()}),document.getElementById("btn-create")?.addEventListener("click",()=>pe(null)),y){document.getElementById(`btn-export-${y.moduleName}`)?.addEventListener("click",async f=>{let $=f.target,P=$.innerHTML;$.innerHTML="\u23F3 Loading...",$.disabled=!0;try{await y.onExport()}catch{G("Gagal export data")}finally{$.innerHTML=P,$.disabled=!1}}),document.getElementById(`btn-template-${y.moduleName}`)?.addEventListener("click",()=>{y.onTemplate()});let v=document.getElementById(`input-import-${y.moduleName}`);v?.addEventListener("change",async f=>{let $=f.target.files[0];if(!$)return;v.disabled=!0;let P=document.createElement("div");P.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.7);z-index:9999;display:flex;align-items:center;justify-content:center",P.innerHTML=`
      ...
      `,document.body.appendChild(P);let V=P.querySelector("#import-progress-text"),U=P.querySelector("#import-progress-bar"),D=P.querySelector("#import-summary"),I=P.querySelector("#import-close-btn");I.addEventListener("click",()=>{P.remove(),M()});try{let Y=await Fe($);if(Y.length===0)throw new Error("File kosong atau format salah");let X=500,ie=0,ae=0,N=0,A=Y.length;V.textContent=`Ditemukan ${A} baris data. Memulai import...`;for(let T=0;T<A;T+=X){let z=Y.slice(T,T+X);V.textContent=`Mengimport baris ${T+1} - ${Math.min(T+X,A)} dari ${A}...`,U.style.width=`${Math.round(T/A*100)}%`;try{let q=await y.onImport(z);q?(ie+=q.inserted||q.metrics?.inserted||z.length,ae+=q.skipped||q.metrics?.updated||0):ie+=z.length}catch(q){console.error("Chunk import failed:",q),N+=z.length}}U.style.width="100%",V.innerHTML='<strong style="color:var(--success)">\u2705 Import Selesai!</strong>',D.style.display="block",D.innerHTML=`
        ...
        `,N>0&&(D.innerHTML+='<p style="margin-top:12px;font-size:0.8rem;color:var(--danger)">Sebagian data gagal diimport. Pastikan format kolom sesuai template dan tidak ada data kosong pada kolom wajib.</p>'),I.style.display="block",v.value=""}catch(Y){V.innerHTML=`<strong style="color:var(--danger)">\u274C Gagal Memproses File</strong><br>${Y.message}`,U.style.background="var(--danger)",U.style.width="100%",I.style.display="block",v.value=""}finally{v.disabled=!1}})}async function M(){R();let v=document.getElementById("table-container");if(!v)return;v.innerHTML='<div class="loading-spinner"><div class="spinner"></div></div>';let f=_==="client",$=f?1:S,P=f?be:20,V=new URLSearchParams({page:$,limit:P,...Object.fromEntries(Object.entries(x).filter(([,N])=>N))}),U=await k(`${a}?${V}`);if(!U.ok){v.innerHTML=`<div class="empty-state"><p class="text-danger">Gagal memuat data: ${U.data?.error||"Error"}</p></div>`;return}let D=U.data?.data||U.data||[],I=U.data?.pagination,Y=D.length,X=D;if(f){D=h(D),X=D;let N=D.length,A=20,T=Math.ceil(N/A);S>T&&T>0&&(S=T);let z=(S-1)*A,q=S*A;D=D.slice(z,q),I={page:S,limit:A,total:N,pages:T}}!1,g&&g(D);let ie=Je({columns:l,data:D,fullData:X,onEdit:m?N=>pe(N):null,actions:u.map(N=>({...N,handler:A=>N.handler(A,M)})),emptyText:`Tidak ada ${String(n||"").toLowerCase()}`,bulkSelect:w?{selectedIds:C,onToggle:R}:null});v.innerHTML="",v.appendChild(ie);let ae=document.getElementById("pagination-container");if(ae&&(ae.innerHTML="",I&&I.pages>1)){let N=Ue({page:I.page,pages:I.pages,total:I.total,limit:I.limit,onPage:A=>{S=A,M()}});N&&ae.appendChild(N)}}function fe(v){let f=typeof d=="function"?d(v):d;return Ae(f)}function pe(v){let f=!!v,$=document.createElement("form");if($.noValidate=!0,$.innerHTML=fe(v),f){let V=typeof d=="function"?d(v):d;Qe($,v)}let{close:P}=le({title:f?`Edit ${n}`:`Tambah ${n}`,content:$,size:"lg",confirmText:f?"Simpan Perubahan":`Tambah ${n}`,onConfirm:async(V,U)=>{if(!$.reportValidity())return;let D=V.querySelector(".modal-confirm");D.disabled=!0,D.textContent="Menyimpan...";let I=Ge($),Y=typeof d=="function"?d(v):d,X=async A=>{for(let T of A)if(T.type==="row")await X(T.fields);else if(T.type==="combobox"&&I[T.name]){let z=I[T.name],q=(T.options||[]).find(W=>{let ne=String(typeof W=="object"?W.value:W),et=String(typeof W=="object"?W.label:W);return ne===z||et===z});if(q)I[T.name]=typeof q=="object"?q.value:q;else if(T.createApi){let W={};W[T.createApi.field]=z,T.createApi.extra&&Object.assign(W,T.createApi.extra);let ne=await k(T.createApi.path,{method:"POST",body:JSON.stringify(W)});if(ne.ok&&ne.data?.id)I[T.name]=ne.data.id;else if(ne.ok&&!ne.data?.id)I[T.name]=z;else throw new Error(`Gagal membuat master data: ${ne.data?.error||"Unknown error"}`)}}};try{await X(Y)}catch(A){G(A.message),D.disabled=!1,D.textContent=f?"Simpan Perubahan":`Tambah ${n}`;return}p&&(I=await p(I,v));let ie=f?"PUT":"POST",ae=f?`${a}/${v.id}`:a,N=await k(ae,{method:ie,body:JSON.stringify(I)});N.ok?(Z(f?`${n} berhasil diperbarui.`:`${n} berhasil ditambahkan.`),U(),M()):(G(N.data?.error||"Gagal menyimpan data."),D.disabled=!1,D.textContent=f?"Simpan Perubahan":`Tambah ${n}`)}})}function ve(v){Ne(`Hapus ${n} ini? Tindakan tidak dapat dibatalkan.`,async()=>{let f=await k(`${a}/${v.id}`,{method:"DELETE"});f.ok?(Z(`${n} berhasil dihapus.`),M()):G(f.data?.error||"Gagal menghapus.")},`Hapus ${n}`)}return M(),M}F();F();var xe=null,ze=null;async function we(t=!1){if(xe&&!t)return console.log("Employees Raw (Cache Hit)",xe.slice(0,5)),xe;let e=await k(`/api/employees?limit=${be}&status=Aktif`);return xe=(e.data?.data||[]).map(s=>({value:s.id,label:s.full_name})),console.log("Employees Raw",e.data?.data?.slice(0,5)),console.log("Employees Mapped (ID)",xe.slice(0,5)),xe}async function ee(t=!1){let s=(await we(t)).map(a=>({value:a.label,label:a.label}));return console.log("Employee Options",s.slice(0,5)),s}async function H(t=!1){return ze&&!t||(ze=((await k("/api/branches?all=1")).data?.data||[]).map(s=>({value:s.id,label:s.full_name}))),ze}function j(t){let e={Done:"badge-success",Aktif:"badge-success",Open:"badge-warning","In Progress":"badge-info",Pending:"badge-warning",Diproses:"badge-info",Selesai:"badge-success","Tidak Aktif":"badge-neutral",Resign:"badge-neutral",Cut:"badge-danger","Tidak Datang":"badge-danger"};return!t||t==="-"||String(t).trim()===""?"":`<span class="badge ${e[t]||"badge-neutral"}">${t}</span>`}function rt(t){return t==null?'<span class="badge badge-neutral">-</span>':t<0?`<span class="badge badge-danger">Expired (${Math.abs(t)}h)</span>`:t<=14?`<span class="badge badge-danger">${t} hari</span>`:t<=30?`<span class="badge badge-warning">${t} hari</span>`:`<span class="badge badge-success">${t} hari</span>`}function _e(t){return`<span class="badge ${{"FACILITY CARE":"badge-info",SECURITY:"badge-secondary"}[t]||"badge-neutral"}">${t||"-"}</span>`}function st(t){return`<span class="badge ${{"Inspeksi Hygiene & Aset Bangunan":"badge-info","General Cleaning":"badge-success","Deep Cleaning":"badge-purple",Fogging:"badge-warning"}[t]||"badge-neutral"}">${t||"-"}</span>`}function oe(t){return`<span class="badge ${{Q1:"badge-info",Q2:"badge-success",Q3:"badge-warning",Q4:"badge-danger"}[t]||"badge-neutral"}">${t||"-"}</span>`}K();function lt(t,e){if(t.period!=="Q3")return!1;let s=String(t.status||"").toLowerCase();if(s!=="selesai"&&s!=="completed"&&s!=="done")return!1;let a=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?a.includes("inspeksi"):e==="gcdc"?a.includes("general cleaning")||a.includes("deep cleaning"):!1}F();K();function St(t,e){let s=String(t.status||"").toLowerCase();return e==="active"?s==="aktif":e==="reliefer"?t.division==="FC - RELIEFER"&&s==="aktif":!1}F();K();function ot(t,e){if(String(t.status||"").toLowerCase()!=="aktif")return!1;if(e==="active")return!0;if(e==="expiring30"){if(!t.end_date)return!1;let a=new Date;a.setHours(0,0,0,0);let l=new Date(a);l.setDate(a.getDate()+30);let d=new Date(t.end_date);return d.setHours(0,0,0,0),d>=a&&d<=l}return!1}F();K();function xt(t,e){let s=String(t.status||"").toLowerCase();return e==="open"?s==="open":!1}F();function wt(t,e){let s=String(t.status||"").toLowerCase();return e==="pending"?s==="pending":!1}var me={};function Re(t){if(me[t]){try{me[t].destroy()}catch{}delete me[t]}}function ca(){Object.keys(me).forEach(Re)}var ce=(t,e=0)=>{let s=Number(t);return isNaN(s)||t===null||t===void 0?e:s},Ce=(t,e="\u2014")=>{if(t==null||t==="")return e;let s=String(t).trim();return s===""||s==="[object Object]"?e:s};function Ct(t,e,s=900){if(!t)return;let a=Math.max(0,Math.round(ce(e)));if(a===0){t.textContent="0";return}let l=Date.now(),d=()=>{let i=Math.min((Date.now()-l)/s,1),r=1-Math.pow(1-i,3);t.textContent=Math.round(r*a).toLocaleString("id-ID"),i<1?requestAnimationFrame(d):t.textContent=a.toLocaleString("id-ID")};requestAnimationFrame(d)}var pa={Done:"pill-success",Aktif:"pill-success",Selesai:"pill-success",Open:"pill-danger",Pending:"pill-warning","In Progress":"pill-info","Tidak Aktif":"pill-neutral",Resign:"pill-neutral",Cut:"pill-neutral"},ma=t=>{let e=Ce(t,"\u2014");return`<span class="status-pill ${pa[e]||"pill-neutral"}">${e}</span>`};var de={family:"Inter",size:11},ge="#94A3B8",Oe="#F1F5F9",dt=["#2563EB","#10B981","#F59E0B","#EF4444","#8B5CF6","#0EA5E9","#F97316","#14B8A6","#6366F1","#EC4899"],ua=()=>window.innerWidth<768;function pt(t={}){return{responsive:!0,maintainAspectRatio:!1,animation:{duration:700,easing:"easeOutQuart"},plugins:{legend:{position:ua()?"bottom":"top",labels:{font:de,color:"#64748B",usePointStyle:!0,padding:10,boxWidth:8,boxHeight:8}},tooltip:{mode:"index",intersect:!1,bodyFont:de,titleFont:{...de,weight:"700"}}},scales:{x:{grid:{color:Oe},ticks:{font:de,color:ge,maxRotation:0}},y:{grid:{color:Oe},ticks:{font:de,color:ge},beginAtZero:!0}},...t}}var ga=()=>Array(5).fill(0).map(()=>`
    ...
    <div class="dashboard-wrap" id="dash-root">
      ...
      <div class="charts-row" style="grid-template-columns: repeat(2, minmax(0, 1fr));">
        <div class="chart-card">
          ...
          <div style="display:flex; gap:20px; align-items:center; height:160px">
            <div class="chart-canvas-wrap" style="flex:1;height:100%;position:relative;margin-top:10px">
  ...
  `,document.getElementById("btn-dash-refresh")?.addEventListener("click",()=>ct(t)),document.getElementById("filter-insp-month")?.addEventListener("change",async s=>{let a=s.target.value,l=a?`/api/dashboard/inspection-bar?month=${a}`:"/api/dashboard/inspection-bar",d=document.getElementById("skel-insp"),i=document.getElementById("chart-insp");d&&(d.style.display="block",d.style.position="absolute"),i&&(i.style.display="none");let r=await se(l,{},8e3);try{Dt(r)}catch(n){console.warn("InspBar render:",n),ue("skel-insp","chart-insp")}}),t._skelTimeout=setTimeout(()=>ha(),5e3),await ct(t),t._dashRefresh=setInterval(()=>{document.getElementById("dash-root")?ct(t):clearInterval(t._dashRefresh)},6e4)}async function ct(t){t._skelTimeout&&(clearTimeout(t._skelTimeout),t._skelTimeout=null);let[e,s,a,l,d,i,r,n,o,m,c]=await Promise.all([se("/api/dashboard/kpi",{},8e3),se("/api/dashboard/issues-trend",{},8e3),se("/api/dashboard/issues-summary",{},8e3),se("/api/dashboard/stats",{},8e3),se("/api/dashboard/calendar",[],8e3),se("/api/schedule?limit=10000",{data:[]},8e3),se("/api/employees?limit=10000",{data:[]},8e3),se("/api/contracts?limit=10000",{data:[]},8e3),se("/api/issues?limit=10000",{data:[]},8e3),se("/api/one-on-one?limit=10000",{data:[]},8e3),se("/api/dashboard/contracts-chart",{labels:[],data:[]},8e3)]),p=document.getElementById("filter-insp-month"),g=p?p.value:"",h=g?`/api/dashboard/inspection-bar?month=${g}`:"/api/dashboard/inspection-bar",u=await se(h,{},8e3);if(e){let b=Array.isArray(i?.data)?i.data:Array.isArray(i)?i:[],y=Array.isArray(r?.data)?r.data:Array.isArray(r)?r:[],w=Array.isArray(n?.data)?n.data:Array.isArray(n)?n:[],_=Array.isArray(o?.data)?o.data:Array.isArray(o)?o:[],S=Array.isArray(m?.data)?m.data:Array.isArray(m)?m:[];e.employees&&(e.employees.current=y.filter(x=>St(x,"active")).length),e.contracts&&(e.contracts.current=w.filter(x=>ot(x,"active")).length),e.expiring30&&(e.expiring30={current:w.filter(x=>ot(x,"expiring30")).length}),e.issues&&(e.issues.current=_.filter(x=>xt(x,"open")).length),e.one_on_one&&(e.one_on_one.current=S.filter(x=>wt(x,"pending")).length),e.inspection_month&&(e.inspection_month.current=b.filter(x=>lt(x,"inspeksi")).length),e.cleaning_month&&(e.cleaning_month.current=b.filter(x=>lt(x,"gcdc")).length)}try{Et(e)}catch(b){console.warn("KPI render:",b)}try{$t(e)}catch(b){console.warn("MiniStats render:",b)}try{ya(Array.isArray(a?.by_category)?a.by_category:[])}catch(b){console.warn("Donut render:",b),ue("skel-donut","chart-donut")}try{fa(s)}catch(b){console.warn("Trend render:",b),ue("skel-trend","chart-trend")}try{Dt(u)}catch(b){console.warn("InspBar render:",b),ue("skel-insp","chart-insp")}try{let b=Array.isArray(l)?l:Array.isArray(l?.recent_issues)?l.recent_issues:[];ka(b)}catch(b){console.warn("IssuesTable render:",b)}try{let b=Array.isArray(l?.expiring_contracts)?l.expiring_contracts:[];va(c)}catch(b){console.warn("ContractsTable render:",b)}try{Sa(Array.isArray(d)?d:[])}catch(b){console.warn("Agenda render:",b)}try{xa()}catch(b){console.warn("Quick Actions render:",b)}}function Et(t){let e=document.getElementById("kpi-row");if(!e)return;t=t||{};let s=[{icon:"\u{1F465}",label:"Karyawan Aktif",sub:"Total karyawan aktif",href:"#/employees?dash_filter=active",color:"kpi-blue",key:"employees",trendPct:"+2%",trendColor:"#10B981",points:"0,20 10,18 20,22 30,12 40,15 50,8 60,10 70,5 80,6 90,2 100,0"},{icon:"\u{1F504}",label:"Reliefer Aktif",sub:"Karyawan reliefer",href:"#/employees?dash_filter=reliefer",color:"kpi-purple",key:"reliever_total",trendPct:"0%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u{1F4C4}",label:"Kontrak Aktif",sub:"Kontrak yang masih berjalan",href:"#/contracts?dash_filter=active",color:"kpi-green",key:"contracts",trendPct:"+1%",trendColor:"#10B981",points:"0,15 20,18 40,10 60,12 80,5 100,2"},{icon:"\u23F3",label:"Kontrak Habis 30 Hari",sub:"Akan segera berakhir",href:"#/contracts?dash_filter=expiring30",color:"kpi-warn",key:"expiring30",trendPct:"+25%",trendColor:"#F59E0B",points:"0,25 20,22 40,24 60,15 80,18 100,5"},{icon:"\u26A0\uFE0F",label:"Permasalahan Open",sub:"Belum diselesaikan",href:"#/issues?dash_filter=open",color:"kpi-red",key:"issues",trendPct:"0%",trendColor:"#EF4444",points:"0,20 20,18 40,22 60,19 80,21 100,20"},{icon:"\u{1F4AC}",label:"One on One Pending",sub:"Menunggu tindak lanjut",href:"#/one-on-one?dash_filter=pending",color:"kpi-purple",key:"one_on_one",trendPct:"+8%",trendColor:"#10B981",points:"0,25 20,15 40,18 60,8 80,10 100,2"}];e.innerHTML=s.map(a=>{let l=ce(t[a.key]?.current,0);return`
    ...
    </a>`).join(""),e.querySelectorAll(".mini-stat-value").forEach(a=>Ct(a,parseInt(a.dataset.target)||0,700))}function ya(t){ue("skel-donut","chart-donut");let e=document.getElementById("chart-donut"),s=document.getElementById("donut-legend");if(!e||!s)return;Re("donut");let a=(t||[]).filter(n=>ce(n.count)>0);if(!a.length){Ve(e,"Belum ada data permasalahan");return}let l=a.map(n=>`${Ce(n.category,"Lainnya")}`),d=a.map(n=>ce(n.count)),i=d.reduce((n,o)=>n+o,0);s.innerHTML=a.map((n,o)=>{let m=dt[o%dt.length],c=i>0?Math.round(n.count/i*100):0;return`
    ...
    `}).join("");let r={id:"centerText",beforeDraw:function(n){let o=n.width,m=n.height,c=n.ctx;c.restore();let p=(m/80).toFixed(2);c.font="bold "+p+"em Inter",c.textBaseline="middle",c.fillStyle="#1E293B";let g=i.toString(),h=Math.round((o-c.measureText(g).width)/2),u=m/2;c.fillText(g,h,u-10),c.font="600 "+(p*.35).toFixed(2)+"em Inter",c.fillStyle="#64748B";let b="Total",y=Math.round((o-c.measureText(b).width)/2);c.fillText(b,y,u+15),c.save()}};me.donut=new Chart(e,{type:"doughnut",data:{labels:l,datasets:[{data:d,backgroundColor:dt,borderWidth:2,borderColor:"#fff",hoverBorderColor:"#fff"}]},options:{responsive:!0,maintainAspectRatio:!1,animation:{duration:700},plugins:{legend:{display:!1},tooltip:{bodyFont:de,titleFont:{...de,weight:"700"},callbacks:{label:n=>` ${n.label}: ${n.parsed} kasus`}}},cutout:"75%"},plugins:[r]})}function fa(t){ue("skel-trend","chart-trend");let e=document.getElementById("chart-trend");if(!e)return;Re("trend"),t=t||{};let s=["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agu","Sep","Okt","Nov","Des"],a=(t.labels||[]).map(i=>{if(!i||typeof i!="string")return"";try{let[r,n]=i.split("-");return(s[Number(n)-1]||n)+" "+String(r).slice(-2)}catch{return i}}),l=(t.open||[]).map(i=>ce(i)),d=(t.closed||[]).map(i=>ce(i));if(!a.length){Ve(e,"Belum ada data trend");return}me.trend=new Chart(e,{type:"line",data:{labels:a,datasets:[{label:"Open",data:l,borderColor:"#EF4444",backgroundColor:"rgba(239,68,68,.08)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#EF4444",borderWidth:2},{label:"Closed",data:d,borderColor:"#10B981",backgroundColor:"rgba(16,185,129,.1)",fill:!0,tension:.4,pointRadius:3,pointHoverRadius:5,pointBackgroundColor:"#10B981",borderWidth:2}]},options:pt({plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:{family:"Inter",size:9},color:ge,maxRotation:0,autoSkip:!1}},y:{grid:{color:Oe},ticks:{font:{family:"Inter",size:9},color:ge},beginAtZero:!0}}})})}function Dt(t){ue("skel-insp","chart-insp");let e=document.getElementById("chart-insp");if(!e)return;Re("inspBar"),t=t||{};let s=t.labels||[],a=(t.fc||[]).map(d=>ce(d)),l=(t.spv||[]).map(d=>ce(d));if(!s.length){Ve(e,"Belum ada data inspeksi");return}me.inspBar=new Chart(e,{type:"bar",data:{labels:s,datasets:[{label:"Skor FC",data:a,backgroundColor:"rgba(37,99,235,.75)",borderRadius:4,borderSkipped:!1},{label:"Skor SPV",data:l,backgroundColor:"rgba(16,185,129,.75)",borderRadius:4,borderSkipped:!1}]},options:pt({plugins:{legend:{position:"top"}},scales:{x:{grid:{display:!1},ticks:{font:de,color:ge,maxRotation:45,minRotation:30}},y:{grid:{color:Oe},ticks:{font:de,color:ge},min:0,max:100}}})})}function va(t){ue("skel-contract-mini","chart-contract-mini");let e=document.getElementById("chart-contract-mini");if(!e)return;Re("contractMiniBar"),t=t||{};let s={"06":"Jun","07":"Jul","08":"Agu","09":"Sep",10:"Okt",11:"Nov",12:"Des"},a=(t.labels||[]).map(i=>{let r=i.split("-")[1];return s[r]||i}),l=(t.data||[]).map(i=>ce(i));if(!a.length){Ve(e,"Belum ada data");return}let d=e.getContext("2d");me.contractMiniBar=new Chart(e,{type:"bar",data:{labels:a,datasets:[{label:"Kontrak Habis",data:l,backgroundColor:"#3B82F6",borderRadius:4,borderSkipped:!1,barPercentage:.6,categoryPercentage:.7}]},options:pt({onClick:(i,r)=>{if(r&&r.length>0){let n=r[0].index,o=(t.labels||[])[n];o&&(window.location.hash="#/contracts?month_expiry="+o)}},plugins:{legend:{display:!1}},scales:{x:{grid:{display:!1},ticks:{font:de,color:ge,maxRotation:0,autoSkip:!1}},y:{grid:{color:Oe,borderDash:[4,4],drawBorder:!1},ticks:{font:de,color:ge,precision:0,maxTicksLimit:5},min:0}},animation:{y:{duration:1e3,easing:"easeOutQuart"}}})})}function ka(t){let e=document.getElementById("table-issues");if(!e)return;let s=(t||[]).slice(0,8);if(!s.length){e.innerHTML='<div class="chart-empty">\u2705 Tidak ada permasalahan terbuka</div>';return}e.innerHTML=`
    <div class="dash-list">
      ${s.map(a=>`
      ...
      `).join("")}
    </div>`}function Sa(t){let e=document.getElementById("widget-agenda");if(!e)return;let s=new Date,a=`${s.getFullYear()}-${String(s.getMonth()+1).padStart(2,"0")}-${String(s.getDate()).padStart(2,"0")}`,d=(t||[]).filter(i=>(i.event_date||"").startsWith(a)).slice(0,10);if(!d.length){e.innerHTML="";return}e.innerHTML=`
  ...
  `).join("")}function ue(t,e){let s=document.getElementById(t),a=document.getElementById(e);if(s&&(s.style.display="none",s.style.position=""),a){a.style.display="block";let l=a.parentElement;if(l){let d=l.querySelector(".chart-empty");d&&d.remove()}}}function Ve(t,e="Belum ada data"){if(!t)return;t.style.display="none";let s=t.parentElement;if(!s)return;if(!s.querySelector(".chart-empty")){let l=document.createElement("div");l.className="chart-empty",l.textContent=e,s.appendChild(l)}}F();async function It(t){document.getElementById("app").innerHTML=`
...
`)}let x=o(w,y),C=null;return x||(C="Karyawan tidak ditemukan di Database"),{isValid:!!x,invalidReason:C,rowNum:y,data:{employee_id:x,branch_id:n(String(u.Cabang||"").trim()),division:String(u["Div / Bagian"]||"").trim()||"FACILITY CARE",start_date:S,end_date:m(u["Tanggal Selesai"])||"2099-12-31",status:String(u.Status||"").trim(),_rawName:w}}}),p=[],g=[];if(c.forEach(u=>{u.isValid?p.push(u.data):g.push({rowNum:u.rowNum,name:u.data._rawName,reason:u.invalidReason})}),console.log(`Split Validation - Valid: ${p.length}, Invalid: ${g.length}`),p.length===0)return{inserted:0,skipped:a.length,failed:a.length};let h=await k("/api/import/contracts",{method:"POST",body:JSON.stringify({rows:p,onDuplicate:"update"})});if(!h.ok)throw new Error(h.data?.error||"Import gagal");return h.data}}})}F();K();var gt=[],Ke=[];function Ea(t){if(!Array.isArray(t))return"Q3";let e=["Q4","Q3","Q2","Q1"];for(let s of e)if(t.some(a=>a.period===s))return s;return"Q3"}function $a(t,e){if(t.period!=="Q3")return!1;let s=String(t.status||"").toLowerCase();if(s!=="selesai"&&s!=="completed"&&s!=="done")return!1;let a=String(t.activity_type||"").toLowerCase();return e==="inspeksi"?a.includes("inspeksi"):e==="gcdc"?a.includes("general cleaning")||a.includes("deep cleaning"):!1}async function Nt(t,e){gt=await H();let s=await ee();Ke=["BERLIN ARIANSYAH","ADE SURAHMAN"];let a=o=>o&&!Ke.find(m=>(typeof m=="object"?m.value:m)===o)?[...Ke,o]:Ke,l=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`),d=o=>{if(!o||o==="-"||String(o).trim()==="")return"";let m=String(o).split("-");return m.length===3&&m[0].length===4?`${m[2]}-${m[1]}-${m[0]}`:o},i=l.data?.data||[],r=Ea(i),n=e?e.get("dash_filter"):null;B({container:t,title:"Jadwal Kegiatan",icon:"\u{1F4C5}",apiPath:"/api/schedule",bulkDelete:!0,itemLabel:"Jadwal",paginationMode:"client",defaultFilters:n?{period:"Q3"}:{period:r},onDataLoaded:o=>(n&&(o=o.filter(m=>$a(m,n))),o.sort((m,c)=>{let p=m.opening_date?new Date(m.opening_date).getTime():0;return(c.opening_date?new Date(c.opening_date).getTime():0)-p})),columns:[{key:"branch_name",label:"Cabang"},{key:"activity_type",label:"Kegiatan",render:o=>st(o)},{key:"period",label:"Periode",render:o=>oe(o)},{key:"pic",label:"PIC"},{key:"opening_date",label:"Tgl Opening",nowrap:!0,render:o=>d(o)},{key:"target_date",label:"Tgl Target",nowrap:!0,render:o=>d(o)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:o=>d(o)},{key:"status",label:"Status",render:o=>j(o)}],filterFields:[{type:"select",name:"branch_id",label:"Cabang",options:gt},{type:"select",name:"activity_type",label:"Kegiatan",options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"]},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"period",label:"Periode",options:["Q1","Q2","Q3","Q4"]},{type:"select",name:"status",label:"Status",options:["Pending","In Progress","Done"]},{type:"select",name:"pic",label:"PIC",options:Ke}],formFields:o=>[{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:gt,value:o?.branch_id},{name:"activity_type",label:"Jenis Kegiatan",type:"select",required:!0,options:["Inspeksi Hygiene","General Cleaning","Deep Cleaning","Fogging"],value:o?.activity_type}]},{type:"row",fields:[{name:"period",label:"Periode",type:"select",required:!0,options:["Q1","Q2","Q3","Q4"],value:o?.period},{name:"pic",label:"PIC",type:"combobox",options:a(o?.pic),value:o?.pic}]},{type:"row",fields:[{name:"opening_date",label:"Tanggal Opening",type:"date",value:o?.opening_date},{name:"target_date",label:"Tanggal Target",type:"date",value:o?.target_date}]},{type:"row",fields:[{name:"completion_date",label:"Tanggal Selesai",type:"date",value:o?.completion_date},{name:"status",label:"Status",type:"select",required:!0,options:["Pending","In Progress","Done"],value:o?.status||""}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:o?.notes}],exportOptions:{moduleName:"schedule",onExport:async()=>{let o=await k(`/api/schedule${window.location.search?window.location.search+"&":"?"}limit=10000`);if(o.ok){let m=o.data.data.map(c=>({Cabang:c.branch_name||"",Kegiatan:c.activity_type||"",Periode:c.period||"",PIC:c.pic||"","Tgl Opening":c.opening_date||"","Tgl Target":c.target_date||"","Tgl Selesai":c.completion_date||"",Status:c.status||""}));L(m,"Data_Jadwal_Kegiatan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{L([{Cabang:"001. Pondok Bambu",Kegiatan:"General Cleaning",Periode:"Q1",PIC:"Fajar","Tgl Opening":"2024-02-01","Tgl Target":"2024-02-15","Tgl Selesai":"2024-02-14",Status:"Done"}],"Template_Import_Jadwal")},onImport:async o=>{let c=(await k("/api/branches?all=1")).data?.data||[],p=b=>{if(!b)return null;let y=String(b||"").toLowerCase(),w=c.find(_=>String(_.full_name||"").toLowerCase()===y||String(_.code||"").toLowerCase()===y||String(_.name||"").toLowerCase()===y);return w?w.id:null},g=b=>{if(b==null||b==="")return"";if(b instanceof Date&&!isNaN(b.getTime()))return b.toISOString().slice(0,10);let y=String(b).trim();if(y===""||y==="0")return"";if(/^\d{4}-\d{2}-\d{2}/.test(y))return y.slice(0,10);if(/^\d{4,5}$/.test(y)){let _=Number(y);if(_>2e4&&_<99999){let S=new Date(Date.UTC(1899,11,30)+_*864e5);return isNaN(S.getTime())?"":S.toISOString().slice(0,10)}}let w=y.split(/[\/\-\.]/);if(w.length===3){let[_,S,x]=w.map(C=>C.trim());if(_.length===4&&S.length<=2&&x.length<=2)return`${_}-${S.padStart(2,"0")}-${x.padStart(2,"0")}`;if(x.length===4&&S.length<=2&&_.length<=2)return`${x}-${S.padStart(2,"0")}-${_.padStart(2,"0")}`}return y},h=o.map(b=>({branch_id:p(String(b.Cabang||"").trim()),activity_type:String(b.Kegiatan||"").trim(),period:String(b.Periode||"").trim(),pic:String(b.PIC||b.Pic||"").trim(),opening_date:g(b["Tgl Opening"]||b["Tanggal Opening"]||b["Tgl Openir"]),target_date:g(b["Tgl Target"]||b["Tanggal Target"]),completion_date:g(b["Tgl Selesai"]||b["Tanggal Selesai"]),status:String(b.Status||"").trim(),notes:String(b.Catatan||b.Keterangan||"").trim()})).filter(b=>b.activity_type&&b.period),u=await k("/api/import/schedule",{method:"POST",body:JSON.stringify({rows:h,onDuplicate:"update"})});if(!u.ok)throw new Error(u.data?.error||"Import gagal");return u.data}}})}F();K();var bt=[],We=[];function Da(t,e){let s=String(t.status||"").toLowerCase();return e==="open"?s==="open":!1}async function At(t,e){let s=e?e.get("dash_filter"):null;bt=await H(),We=await ee();let a=i=>i&&!We.find(r=>r.value===i)?[...We,{value:i,label:i}]:We,l=new Date().getFullYear();B({container:t,title:"Permasalahan",icon:"\u26A0\uFE0F",apiPath:"/api/issues",bulkDelete:!0,itemLabel:"Permasalahan",paginationMode:"client",onDataLoaded:i=>s?i.filter(r=>Da(r,s)):i,columns:[{key:"report_date",label:"Tanggal",nowrap:!0,render:i=>window.formatDate(i)},{key:"branch_name",label:"Cabang"},{key:"category",label:"Kategori",render:i=>`<span class="badge badge-secondary">${i}</span>`},{key:"source",label:"Sumber"},{key:"complaint",label:"Keluhan",render:i=>`<span title="${i}">${i?.length>50?i.slice(0,50)+"\u2026":i}</span>`},{key:"employee_name",label:"Nama FC"},{key:"fc_specialist",label:"FC Spesialis"},{key:"solution",label:"Solusi",render:i=>`<span title="${i||""}">${i?.length>40?i.slice(0,40)+"\u2026":i||"-"}</span>`},{key:"status",label:"Status",render:i=>j(i)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:i=>window.formatDate(i)},{key:"day_count",label:"Hari",render:i=>i??"-"}],filterFields:[{type:"search",placeholder:"Cari keluhan / nama FC..."},{type:"select",name:"branch_id",label:"Cabang",options:bt},{type:"select",name:"month",label:"Bulan",options:[{value:"2026-01",label:"Jan 2026"},{value:"2026-02",label:"Feb 2026"},{value:"2026-03",label:"Mar 2026"},{value:"2026-04",label:"Apr 2026"},{value:"2026-05",label:"Mei 2026"},{value:"2026-06",label:"Jun 2026"},{value:"2026-07",label:"Jul 2026"},{value:"2026-08",label:"Agu 2026"},{value:"2026-09",label:"Sep 2026"},{value:"2026-10",label:"Okt 2026"},{value:"2026-11",label:"Nov 2026"},{value:"2026-12",label:"Des 2026"}]},{type:"select",name:"category",label:"Kategori",options:["SDM","Cleaning","Aset","K3","Lainnya"]},{type:"select",name:"status",label:"Status",options:["Open","In Progress","Done"]},{type:"select",name:"year",label:"Tahun",options:["2025","2026","2027","2028","2029","2030"]}],formFields:i=>[{type:"row",fields:[{name:"report_date",label:"Tanggal Info",type:"date",required:!0,value:i?.report_date},{name:"branch_id",label:"Cabang",type:"combobox",required:!0,options:bt,value:i?.branch_id}]},{type:"row",fields:[{name:"category",label:"Kategori",type:"select",required:!0,options:["SDM","Cleaning","Aset","K3","Lainnya"],value:i?.category},{name:"source",label:"Sumber Laporan",type:"combobox",options:["SPV","AM","RCP","Perawat","FC","Berlin","Ade","Pattrel","Dentrel"],value:i?.source}]},{name:"complaint",label:"Keluhan",type:"textarea",required:!0,rows:3,value:i?.complaint},{type:"row",fields:[{name:"employee_name",label:"Nama FC / Security",type:"combobox",options:a(i?.employee_name),value:i?.employee_name},{name:"fc_specialist",label:"FC Spesialis",type:"combobox",options:a(i?.fc_specialist),value:i?.fc_specialist}]},{name:"solution",label:"Solusi / Tindakan",type:"textarea",rows:3,value:i?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","In Progress","Done"],value:i?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:i?.completion_date}]}],exportOptions:{moduleName:"issues",onExport:async()=>{let i=await k(`/api/issues${window.location.search?window.location.search+"&":"?"}limit=10000`);if(i.ok){let r=i.data.data.map(n=>({Tanggal:n.report_date||"",Cabang:n.branch_name||"",Kategori:n.category||"",Sumber:n.source||"",Keluhan:n.complaint||"","Nama FC":n.employee_name||"","FC Spesialis":n.fc_specialist||"",Solusi:n.solution||"","Tgl Selesai":n.completion_date||"",Status:n.status||""}));L(r,"Data_Permasalahan")}else throw new Error("Gagal mengambil data")},onTemplate:()=>{L([{Tanggal:"2024-03-01",Cabang:"001. Pondok Bambu",Kategori:"Cleaning",Sumber:"SPV",Keluhan:"Lantai kotor","Nama FC":"Budi Santoso","FC Spesialis":"Fajar",Solusi:"Teguran lisan","Tgl Selesai":"2024-03-02",Status:"Done"}],"Template_Import_Permasalahan")},onImport:async i=>{let n=(await k("/api/branches?all=1")).data?.data||[],o=p=>{if(!p)return null;let g=String(p||"").toLowerCase(),h=n.find(u=>String(u.full_name||"").toLowerCase()===g||String(u.code||"").toLowerCase()===g||String(u.name||"").toLowerCase()===g);return h?h.id:null},m=i.map(p=>({branch_id:o(String(p.Cabang||"").trim()),report_date:String(p.Tanggal||"").trim(),category:String(p.Kategori||"").trim(),source:String(p.Sumber||"").trim(),complaint:String(p.Keluhan||"").trim(),employee_name:String(p["Nama FC"]||"").trim(),fc_specialist:String(p["FC Spesialis"]||"").trim(),solution:String(p.Solusi||"").trim(),completion_date:String(p["Tgl Selesai"]||"").trim(),status:String(p.Status||"").trim()})).filter(p=>p.report_date&&p.complaint&&p.category),c=await k("/api/import/issues",{method:"POST",body:JSON.stringify({rows:m,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}}})}F();var Te=[];function Ia(t,e){let s=String(t.status||"").toLowerCase();return e==="pending"?s==="pending":!1}async function Ft(t,e){let s=e?e.get("dash_filter"):null;Te=await H();let a=await ee(),l=["Ade","Berlin"],d=r=>r&&!a.find(n=>n.value===r)?[...a,{value:r,label:r}]:a,i=r=>r&&!l.find(n=>(typeof n=="object"?n.value:n)===r)?[...l,r]:l;B({container:t,title:"One on One",icon:"\u{1F91D}",apiPath:"/api/one-on-one",bulkDelete:!0,itemLabel:"One on One",paginationMode:"client",onDataLoaded:r=>s?r.filter(n=>Ia(n,s)):r,columns:[{key:"meeting_date",label:"Tanggal",nowrap:!0,render:r=>window.formatDate(r)},{key:"branch_name",label:"Cabang"},{key:"employee_name",label:"Nama Karyawan"},{key:"pic",label:"PIC"},{key:"problem",label:"Masalah",render:r=>`<span title="${r||""}">${r?.length>50?r.slice(0,50)+"\u2026":r||"-"}</span>`},{key:"solution",label:"Solusi",render:r=>`<span title="${r||""}">${r?.length>40?r.slice(0,40)+"\u2026":r||"-"}</span>`},{key:"status",label:"Status",render:r=>j(r)},{key:"completion_date",label:"Tgl Selesai",nowrap:!0,render:r=>window.formatDate(r)},{key:"day_count",label:"Hari"},{key:"document_link",label:"Dokumen",render:r=>r?`<a href="${r}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari nama / masalah..."},{type:"combobox",name:"branch_id",label:"Cabang",options:Te},{type:"select",name:"status",label:"Status",options:["Open","Done"]}],exportOptions:{moduleName:"one_on_one",onExport:async r=>{let n=new URLSearchParams(r||{}).toString(),o=await k(`/api/one-on-one?limit=10000&${n}`);if(o.ok){let m=o.data.data.map(p=>({Tanggal:p.meeting_date||"",Cabang:p.branch_name||"","Nama Karyawan":p.employee_name||"",PIC:p.pic||"",Masalah:p.problem||"",Solusi:p.solution||"",Status:p.status||"","Tgl Selesai":p.completion_date||"",Dokumen:p.document_link||""})),{downloadExcel:c}=await Promise.resolve().then(()=>(K(),re));c(m,`Data_One_on_One_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let r=[{Tanggal:"2026-01-08",Cabang:"001. Pondok Bambu","Nama Karyawan":"Widya Astuti",PIC:"Rina",Masalah:"Terlambat terus",Solusi:"Teguran",Status:"Open","Tgl Selesai":"",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(K(),re));n(r,"Template_Import_OneOnOne")},onImport:async r=>{let n=p=>{if(!p)return null;let g=String(p||"").toLowerCase(),h=Te.find(u=>String(u.label||"").toLowerCase()===g);return h?h.value:null},o=p=>{if(!p)return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let g=String(p).trim();if(/^\d{4,5}$/.test(g)){let u=Number(g);if(u>2e4&&u<99999){let b=new Date(Date.UTC(1899,11,30)+u*864e5);return isNaN(b.getTime())?"":b.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(g))return g.slice(0,10);let h=g.split(/[\/\-\.]/);if(h.length===3){let[u,b,y]=h.map(w=>w.trim());if(u.length===4&&b.length<=2&&y.length<=2)return`${u}-${b.padStart(2,"0")}-${y.padStart(2,"0")}`;if(y.length===4&&b.length<=2&&u.length<=2)return`${y}-${b.padStart(2,"0")}-${u.padStart(2,"0")}`}return g},m=r.map(p=>({meeting_date:o(p.Tanggal),employee_name:String(p["Nama Karyawan"]||"").trim(),branch_id:n(String(p.Cabang||"").trim()),pic:String(p.PIC||"").trim(),problem:String(p.Masalah||"").trim(),solution:String(p.Solusi||"").trim(),status:String(p.Status||"").trim(),completion_date:o(p["Tgl Selesai"]),document_link:String(p.Dokumen||"").trim()})).filter(p=>p.meeting_date&&p.employee_name&&p.branch_id),c=await k("/api/import/one_on_one",{method:"POST",body:JSON.stringify({rows:m,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}},formFields:r=>[{type:"row",fields:[{name:"meeting_date",label:"Tanggal",type:"date",required:!0,value:r?.meeting_date},{name:"branch_id",label:"Cabang",type:"combobox",options:r?.branch_id&&!Te.find(n=>n.value==r.branch_id)?[...Te,{value:r.branch_id,label:r.branch_name||r.branch_id}]:Te,createApi:{path:"/api/branches",field:"full_name"},value:r?.branch_id}]},{type:"row",fields:[{name:"employee_name",label:"Nama Karyawan",type:"combobox",required:!0,options:d(r?.employee_name),value:r?.employee_name},{name:"pic",label:"PIC",type:"combobox",options:i(r?.pic),createApi:{path:"/api/pic",field:"name"},value:r?.pic}]},{name:"problem",label:"Masalah",type:"textarea",required:!0,rows:3,value:r?.problem},{name:"solution",label:"Solusi",type:"textarea",rows:3,value:r?.solution},{type:"row",fields:[{name:"status",label:"Status",type:"select",required:!0,options:["Open","Done"],value:r?.status||""},{name:"completion_date",label:"Tanggal Selesai",type:"date",value:r?.completion_date}]},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://drive.google.com/...",value:r?.document_link}]})}F();async function Mt(t){let e=await H(),s=await ee(),a=["Ade","Berlin"],l=r=>r&&!s.find(n=>n.value===r)?[...s,{value:r,label:r}]:s,d=r=>r&&!a.find(n=>(typeof n=="object"?n.value:n)===r)?[...a,r]:a,i=Array.from({length:5},(r,n)=>String(new Date().getFullYear()-n));B({container:t,title:"Training",icon:"\u{1F393}",apiPath:"/api/training",bulkDelete:!0,itemLabel:"Training",columns:[{key:"training_date",label:"Tanggal",nowrap:!0,render:r=>window.formatDate(r)},{key:"batch",label:"Batch"},{key:"subject",label:"Materi"},{key:"branch_name",label:"Cabang"},{key:"trainer",label:"Trainer"},{key:"participants",label:"Peserta",render:r=>{try{let n=JSON.parse(r);return Array.isArray(n)?n.join(", "):r||"-"}catch{return r||"-"}}},{key:"score",label:"Nilai",render:r=>r!=null?`<strong>${r}</strong>`:"-"},{key:"document_link",label:"Dokumen",render:r=>r?`<a href="${r}" target="_blank" rel="noopener" class="btn btn-xs btn-ghost">\u{1F4C4} Buka</a>`:"-"}],filterFields:[{type:"search",placeholder:"Cari materi / trainer..."},{type:"select",name:"year",label:"Tahun",options:i}],exportOptions:{moduleName:"training",onExport:async r=>{let n=new URLSearchParams(r||{}).toString(),o=await k(`/api/training?limit=10000&${n}`);if(o.ok){let m=o.data.data.map(p=>{let g=p.participants||"";try{let h=JSON.parse(g);g=Array.isArray(h)?h.join(", "):g}catch{}return{Tanggal:p.training_date||"",Batch:p.batch||"",Materi:p.subject||"",Cabang:p.branch_name||"",Trainer:p.trainer||"",Peserta:g,Nilai:p.score!==null&&p.score!==void 0?p.score:"",Dokumen:p.document_link||""}}),{downloadExcel:c}=await Promise.resolve().then(()=>(K(),re));c(m,`Data_Training_${new Date().toISOString().slice(0,10)}`)}else throw new Error("Gagal mengambil data")},onTemplate:async()=>{let r=[{Tanggal:"2026-01-08",Batch:"Batch 1",Materi:"Standar Kebersihan",Cabang:"001. Pondok Bambu",Trainer:"Budi",Peserta:"Rina, Agus",Nilai:"85",Dokumen:"https://link.doc"}],{downloadExcel:n}=await Promise.resolve().then(()=>(K(),re));n(r,"Template_Import_Training")},onImport:async r=>{let n=p=>{if(!p)return null;let g=String(p||"").toLowerCase(),h=e.find(u=>String(u.label||"").toLowerCase()===g);return h?h.value:null},o=p=>{if(!p)return"";if(p instanceof Date&&!isNaN(p.getTime()))return p.toISOString().slice(0,10);let g=String(p).trim();if(/^\d{4,5}$/.test(g)){let u=Number(g);if(u>2e4&&u<99999){let b=new Date(Date.UTC(1899,11,30)+u*864e5);return isNaN(b.getTime())?"":b.toISOString().slice(0,10)}}if(/^\d{4}-\d{2}-\d{2}/.test(g))return g.slice(0,10);let h=g.split(/[\/\-\.]/);if(h.length===3){let[u,b,y]=h.map(w=>w.trim());if(u.length===4&&b.length<=2&&y.length<=2)return`${u}-${b.padStart(2,"0")}-${y.padStart(2,"0")}`;if(y.length===4&&b.length<=2&&u.length<=2)return`${y}-${b.padStart(2,"0")}-${u.padStart(2,"0")}`}return g},m=r.map(p=>({training_date:o(p.Tanggal),batch:String(p.Batch||"").trim(),subject:String(p.Materi||"").trim(),branch_id:n(String(p.Cabang||"").trim()),trainer:String(p.Trainer||"").trim(),participants:String(p.Peserta||"").trim(),score:p.Nilai?Number(p.Nilai):null,document_link:String(p.Dokumen||"").trim()})).filter(p=>p.training_date&&p.subject&&p.branch_id),c=await k("/api/import/training",{method:"POST",body:JSON.stringify({rows:m,onDuplicate:"update"})});if(!c.ok)throw new Error(c.data?.error||"Import gagal");return c.data}},formFields:r=>[{type:"row",fields:[{name:"training_date",label:"Tanggal Training",type:"date",required:!0,value:r?.training_date},{name:"batch",label:"Batch",placeholder:"Batch 1, Batch 2, ...",value:r?.batch}]},{name:"subject",label:"Materi / Topik Training",required:!0,placeholder:"Judul materi training",value:r?.subject},{type:"row",fields:[{name:"branch_id",label:"Cabang",type:"combobox",options:e,value:r?.branch_id},{name:"trainer",label:"Trainer",type:"combobox",options:d(r?.trainer),value:r?.trainer}]},{name:"participants",label:"Peserta (pisahkan dengan koma)",type:"textarea",rows:3,placeholder:"Nama Peserta 1, Nama Peserta 2, ...",value:(()=>{try{let n=JSON.parse(r?.participants);return Array.isArray(n)?n.join(", "):r?.participants||""}catch{return r?.participants||""}})()},{type:"row",fields:[{name:"score",label:"Nilai / Score",type:"number",step:"0.1",min:"0",max:"100",value:r?.score},{name:"document_link",label:"Link Dokumen",type:"url",placeholder:"https://...",value:r?.document_link}]},{name:"notes",label:"Catatan",type:"textarea",rows:2,value:r?.notes}],onBeforeSubmit:async r=>(r.participants&&(r.participants=JSON.stringify(r.participants.split(",").map(n=>n.trim()).filter(Boolean))),r)})}F();ye();K();function Ot({container:t,title:e,icon:s,apiPath:a,columns:l,formFields:d,filterFields:i,defaultFilters:r={},itemLabel:n="Data",canCreate:o=!0,canEdit:m=!0,canDelete:c=!0,onBeforeSubmit:p,onAfterLoad:g,onDataLoaded:h,extraActions:u=[],initialSearch:b="",exportOptions:y=null,bulkDelete:w=!1,paginationMode:_="server"}){let S=1,x={...r};b&&(x.search=b);let C=new Set;t.innerHTML=`
  ...
  `,document.getElementById("cal-prev").addEventListener("click",()=>{e.setMonth(e.getMonth()-1),l()}),document.getElementById("cal-next").addEventListener("click",()=>{e.setMonth(e.getMonth()+1),l()}),document.getElementById("cal-event-close").addEventListener("click",()=>{document.getElementById("cal-event-list").style.display="none"}),document.querySelectorAll(".cal-filter").forEach(d=>d.addEventListener("change",l));async function a(){try{let d=`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}`;s=(await k(`/api/dashboard/calendar?month=${d}`)).data?.data||[]}catch(d){console.warn("[Calendar] Failed to load events, rendering empty grid:",d),s=[]}}async function l(){let d=document.getElementById("calendar-grid");if(d){d.innerHTML=`<div style="display:grid;grid-template-columns:repeat(7,1fr);gap:1px;background:var(--border);">
      ${Array(35).fill('<div style="background:#f8fafc;min-height:70px;"></div>').join("")}
    </div>`,await a();try{let i=e.getFullYear(),r=e.getMonth(),n=e.toLocaleDateString("id-ID",{month:"long",year:"numeric"}),o=document.getElementById("cal-month-label");o&&(o.textContent=n);let m=new Set(Array.from(document.querySelectorAll(".cal-filter:checked")).map(S=>S.value)),c=s.filter(S=>m.has(S.type)),p={};c.forEach(S=>{let x=(S.event_date||"").slice(0,10);p[x]||(p[x]=[]),p[x].push(S)});let g=new Date(i,r,1).getDay(),h=new Date(i,r+1,0).getDate(),u=["Min","Sen","Sel","Rab","Kam","Jum","Sab"],b=new Date().toISOString().slice(0,10),y='<div class="calendar-grid">';u.forEach(S=>{y+=`<div class="cal-day-header">${S}</div>`});for(let S=0;S<g;S++)y+='<div class="cal-cell cal-cell-empty"></div>';for(let S=1;S<=h;S++){let x=`${i}-${String(r+1).padStart(2,"0")}-${String(S).padStart(2,"0")}`,C=p[x]||[],R=x===b;y+=`
            ...
            <div class="cal-events-preview">
              ${C.slice(0,3).map(E=>`
                <div class="cal-event-dot cal-color-${E.color||"gray"}" title="${Ye(E.title||E.type)}">
                  <span class="cal-event-dot-label">${Ba(E.title||E.branch_name||E.type,18)}</span>
                </div>
              `).join("")}
          ...
          </div>`)}}}l()}function Ba(t,e){return t?t.length>e?t.slice(0,e)+"\u2026":t:""}function Ye(t){return t?String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):""}function Na(t){return{schedule:"\u{1F5D3} Jadwal",issue:"\u26A0\uFE0F Permasalahan",reliever:"\u{1F504} Reliefer",training:"\u{1F393} Training",contract_expiry:"\u{1F4CB} Kontrak Habis"}[t]||t}F();async function Vt(t){let e=he(),s=(e?.full_name||e?.username||"U")[0].toUpperCase(),l={superadmin:"#7C3AED",admin:"#2563EB",manager:"#0891B2",spv:"#059669",viewer:"#64748B"}[e?.role]||"#64748B";t.innerHTML=`
    <div class="page-header">
  ...
  `;let e=null,s=null,a=0,l={upload:document.getElementById("step-upload"),validating:document.getElementById("step-validating"),preview:document.getElementById("step-preview"),importing:document.getElementById("step-importing"),summary:document.getElementById("step-summary")};function d(u){Object.entries(l).forEach(([b,y])=>{y.style.display=b===u?"":"none"})}document.getElementById("btn-backup-db")?.addEventListener("click",async()=>{let u=document.getElementById("btn-backup-db");u.disabled=!0,u.textContent="\u23F3 Memproses Backup...";try{let b=await k("/api/import/backup");if(b.ok){if(!window.XLSX){G("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");return}let y=window.XLSX,w=y.utils.book_new();Object.entries(b.data.database).forEach(([_,S])=>{let x=S.length>0?S:[{}],C=y.utils.json_to_sheet(x);y.utils.book_append_sheet(w,C,_.substring(0,31))}),y.writeFile(w,`FCMS_Database_Backup_${new Date().toISOString().slice(0,10)}.xlsx`),Z("Backup berhasil diunduh!")}else G("Gagal memproses backup: "+(b.data?.error||"Unknown error"))}catch(b){G("Gagal memproses backup: "+b.message)}finally{u.disabled=!1,u.textContent="\u{1F4E6} Backup Database"}});let i=document.getElementById("btn-sync-google");i&&i.addEventListener("click",async()=>{if(!confirm("Peringatan: Mensinkronkan data dengan Google Sheets akan memperbarui dan menambahkan data baru dari Google Sheets ke dalam FCMS. Data yang sudah Anda buat di FCMS TIDAK akan terhapus. Lanjutkan?"))return;let u=i.innerHTML;i.innerHTML='<span class="spinner"></span> Menyinkronkan...',i.disabled=!0;try{let b=await k("/api/sync/google-sheets",{method:"POST"});b.ok?alert("Sinkronisasi Berhasil: "+(b.data?.message||"Data Karyawan & PIC telah diperbarui.")):alert("Gagal Sinkronisasi: "+(b.data?.error||"Unknown error"))}catch{alert("Terjadi kesalahan koneksi.")}finally{i.innerHTML=u,i.disabled=!1}}),document.getElementById("btn-download-template").addEventListener("click",()=>{Xt(),Z("Template Excel berhasil didownload!")});let r=document.getElementById("file-input"),n=document.getElementById("upload-zone");document.getElementById("btn-browse").addEventListener("click",u=>{u.stopPropagation(),r.click()}),r.addEventListener("change",u=>{u.target.files[0]&&o(u.target.files[0])}),n.addEventListener("dragover",u=>{u.preventDefault(),n.classList.add("drag-over")}),n.addEventListener("dragleave",()=>n.classList.remove("drag-over")),n.addEventListener("drop",u=>{u.preventDefault(),n.classList.remove("drag-over");let b=u.dataTransfer.files[0];b&&b.name.match(/\.xlsx?$/i)?o(b):G("Hanya file .xlsx atau .xls yang didukung.")}),document.getElementById("btn-clear-file").addEventListener("click",()=>{e=null,r.value="",document.getElementById("file-info").style.display="none",n.style.display="",d("upload")});async function o(u){e=u,document.getElementById("file-name-display").textContent=`\u{1F4C4} ${u.name} (${(u.size/1024).toFixed(1)} KB)`,document.getElementById("file-info").style.display="flex",n.style.display="none",await m(u)}async function m(u){d("validating");let b=document.getElementById("validation-status"),y=document.getElementById("validation-bar");try{if(!window.XLSX)throw new Error("Library SheetJS belum termuat. Refresh halaman dan coba lagi.");b.textContent="Membaca file Excel...",y.style.width="20%",await He(200);let w=await u.arrayBuffer(),_=window.XLSX.read(w,{type:"array",cellDates:!0});b.textContent=`Memvalidasi ${_.SheetNames.length} sheet...`,y.style.width="50%",await He(100),s=Yt(_),y.style.width="100%",b.textContent="Validasi selesai!",await He(300),c()}catch(w){d("upload"),G("Gagal memproses file: "+w.message),document.getElementById("file-info").style.display="flex",n.style.display="none"}}function c(){d("preview");let u=s.filter(E=>!E.skipped).length,b=s.reduce((E,O)=>E+O.total,0),y=s.reduce((E,O)=>E+O.valid,0),w=s.reduce((E,O)=>E+O.errorCount,0),_=b>0?Math.round(y/b*100):0;document.getElementById("preview-summary-badges").innerHTML=`
    ...
    `,b.scrollIntoView({behavior:"smooth",block:"start"})}document.getElementById("btn-back-to-upload").addEventListener("click",()=>{d("upload"),document.getElementById("file-info").style.display="none",n.style.display="",e=null,r.value=""}),document.getElementById("btn-download-log").addEventListener("click",()=>{if(!s)return;Zt(s)?Z("Log error berhasil didownload."):Z("Tidak ada error untuk didownload.")}),document.getElementById("btn-start-import").addEventListener("click",()=>{let u=document.querySelector('input[name="dup-strategy"]:checked')?.value||"skip";g(u)});async function g(u){d("importing"),a=Date.now();let b=[];Ma.forEach(x=>{let C=s?.find(R=>R.module===x&&R.mapped?.length>0);C&&b.push(C)});let y=document.getElementById("import-steps-list");y.innerHTML=b.map(x=>`
    ...
    `).join("");let w=document.getElementById("import-bar"),_=document.getElementById("import-current-status"),S={totalSheets:b.length,totalRows:b.reduce((x,C)=>x+C.mapped.length,0),inserted:0,skipped:0,failed:0,moduleResults:[]};for(let x=0;x<b.length;x++){let C=b[x],R=document.getElementById(`step-icon-${C.module}`),E=document.getElementById(`step-status-${C.module}`);R.textContent="\u{1F504}",E.textContent="Mengimport...",_.textContent=`Mengimport ${C.label}...`,w.style.width=`${Math.round(x/b.length*100)}%`;try{let O=await k(`/api/import/${C.module}`,{method:"POST",body:JSON.stringify({rows:C.mapped,onDuplicate:u})});if(O.ok){let M=O.data;S.inserted+=M.inserted||0,S.skipped+=M.skipped||0,S.moduleResults.push({label:C.label,inserted:M.inserted||0,skipped:M.skipped||0,status:"ok"}),R.textContent="\u2705",E.innerHTML=`<span class="badge badge-success">${M.inserted||0} berhasil</span>${M.skipped>0?` <span class="badge badge-neutral">${M.skipped} skip</span>`:""}`}else S.failed++,S.moduleResults.push({label:C.label,inserted:0,skipped:0,status:"error",error:O.data?.error}),R.textContent="\u274C",E.innerHTML='<span class="badge badge-danger">Gagal</span>'}catch(O){S.failed++,S.moduleResults.push({label:C.label,inserted:0,skipped:0,status:"error",error:O.message}),R.textContent="\u274C",E.innerHTML='<span class="badge badge-danger">Gagal</span>'}await He(150)}w.style.width="100%",_.textContent="Selesai!",await He(400),h(S)}function h(u){d("summary");let b=((Date.now()-a)/1e3).toFixed(1),y=u.failed===0;document.getElementById("summary-status-icon").innerHTML=`
  ...
  `;le({title:`Notifikasi (${$e.length})`,content:t,confirmText:"Tutup",onConfirm:(e,s)=>s()})}function sa(){let t=he(),e=(t?.full_name||"U")[0].toUpperCase();document.getElementById("app").innerHTML=`
  ...
  `;let s=document.getElementById("sidebar"),a=document.getElementById("sidebar-overlay"),l=document.getElementById("topbar-menu-btn"),d=document.getElementById("sidebar-close"),i=()=>{s.classList.add("open"),a.classList.add("show")},r=()=>{s.classList.remove("open"),a.classList.remove("show")};l?.addEventListener("click",i),d?.addEventListener("click",r),a?.addEventListener("click",r),document.querySelectorAll(".nav-item").forEach(o=>o.addEventListener("click",r));function n(){let o=window.location.hash.replace("#","")||"/dashboard";document.querySelectorAll(".nav-item").forEach(p=>{let g=p.dataset.route;p.classList.toggle("active",o===g||g!=="/dashboard"&&o.startsWith(g))});let m=document.getElementById("topbar-title"),c=document.querySelector(".nav-item.active .nav-label");m&&c&&(m.textContent=c.textContent)}window.addEventListener("hashchange",n),n(),Oa(),document.getElementById("btn-fullscreen")?.addEventListener("click",()=>{document.fullscreenElement?document.exitFullscreen?.():document.documentElement.requestFullscreen?.()}),document.getElementById("logout-btn")?.addEventListener("click",async()=>{await k("/api/auth/logout",{method:"POST"}),Pe(),qe&&clearInterval(qe),Se("/login")}),Ra(),Ka(),document.getElementById("btn-notif")?.addEventListener("click",o=>{o.preventDefault(),Ha()})}async function qa(){J("/login",({main:e})=>It(e)),J("/dashboard",Q(({main:e})=>Tt(e))),J("/calendar",Q(({main:e})=>zt(e))),J("/employees",Q(({main:e,params:s})=>Pt(e,s))),J("/contracts",Q(({main:e,params:s})=>Bt(e,s))),J("/sp",Q(({main:e})=>aa(e))),J("/mutasi",Q(({main:e})=>ia(e))),J("/sync-dashboard",Q(({main:e})=>ra(e))),J("/timeline",Q(({main:e,params:s})=>Nt(e,s))),J("/issues",Q(({main:e,params:s})=>At(e,s))),J("/one-on-one",Q(({main:e,params:s})=>Ft(e,s))),J("/training",Q(({main:e})=>Mt(e))),J("/relievers",Q(({main:e,params:s})=>Rt(e,s))),J("/reports/inspection",Q(({main:e})=>Kt(e))),J("/reports/cleaning",Q(({main:e})=>Ht(e))),J("/reports/fogging",Q(({main:e})=>qt(e))),J("/reports/basecamp",Q(({main:e})=>jt(e))),J("/reports/supply",Q(({main:e})=>ht(e,"supply"))),J("/sop",Q(({main:e})=>Jt(e))),J("/checklist",Q(({main:e})=>Ut(e))),J("/forms",Q(({main:e})=>ht(e))),J("/users",Q(({main:e})=>Gt(e))),J("/branches",Q(({main:e})=>Qt(e))),J("/profile",Q(({main:e})=>Vt(e))),J("/settings/import",Q(({main:e})=>ea(e)));let t=Ie();if(!t&&window.location.hash!=="#/login"&&Se("/login"),t){let e=await k("/api/auth/me");e.ok?(Le(e.data.data),sa()):(Pe(),Se("/login"))}window.addEventListener("fm:login",()=>{sa(),Se("/dashboard")}),ft()}qa();
